...
DELETE FROM CATALOGUE_CONTEXTE;
DELETE FROM CATEGORIE;
DELETE FROM CEDER_OBJET;
DELETE FROM CESSION;
DELETE FROM CESSION_EXAMEN;
DELETE FROM CESSION_STATUT;
DELETE FROM CESSION_TYPE;
DELETE FROM CHAMP;
DELETE FROM CHAMP_ANNOTATION;
DELETE FROM CHAMP_DELEGUE;
DELETE FROM CHAMP_ENTITE;
...
DELETE FROM IMPRIMANTE_API;
DELETE FROM INCIDENT;
DELETE FROM ITEM;
DELETE FROM LABO_INTER;
DELETE FROM LIEN_FAMILIAL;
