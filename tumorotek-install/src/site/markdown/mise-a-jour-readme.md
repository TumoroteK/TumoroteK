#### Mise à jour de TumoroteK version 2.3.0.15-fix794
![TumoroteK version 2.3.0.15-fix794](https://img.shields.io/badge/TumoroteK-2.3.0.15-fix794-brightgreen.svg "TumoroteK version 2.3.0.15-fix794")
...
Renommer la copie en :
        ...
        tumorotek##2.3.0.15-fix794.xml
        
3. Modifier dans ce même fichier `tumorotek##2.3.0.15-fix794.xml`, les variables suivantes :
...
4. Télécharger le [Dossier d'installation](https://github.com/TumoroteK/TumoroteK/releases/download/v2.3.0.15-fix794/tumorotek-install-2.3.0.15-fix794.zip)

5. Dézipper le dossier

6. Copier/déplacer l'archive `tumorotek##2.3.0.15-fix794.war` sur le serveur Tomcat dans le dossier `<PATH_TOMCAT>/webapps`
    ...
    A cette étape de l'installation, le contenu du fichier `tumorotek##2.3.0.15-fix794.xml` est automatiquement reporté dans `tumorotek.properties` et le fichier `tumorotek##2.3.0.15-fix794.xml` est supprimé.
