#### Installation de TumoroteK version 2.2.5
...
[Dossier d'installation](https://github.com/TumoroteK/TumoroteK/releases/download/v2.2.5/tumorotek-install-2.2.5.zip)
...
4. Niveaux de logs Log4j
    ...
    Se référer à la documentation Log4j pour l'édition du fichier `<TOMCAT_PATH>/webapps/tumorotek##2.2.5/WEB-INF/classes/log4j.properties`

5. Déplacer la web archive `tumorotek##2.2.5.war` dans le dossier `<PATH_TOMCAT>/webapps`  
