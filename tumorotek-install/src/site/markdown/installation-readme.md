...
[Dossier d'installation](https://github.com/TumoroteK/TumoroteK/releases/download/v2.3.0.15/tumorotek-install-2.3.0.15.zip)
...
5. Déplacer la web archive `tumorotek##2.3.0.15.war` dans le dossier `<PATH_TOMCAT>/webapps`  
