...
###### Corrections
- YouTrack [TK-881](https://tumorotek.myjetbrains.com/youtrack/issue/TK-881) : lors de la création d'une ${cession}, le changement de type efface le numéro de la cession
- YouTrack [TK-897](https://tumorotek.myjetbrains.com/youtrack/issue/TK-897) : GATSBI > Erreur "date postérieure à la date actuelle" en voulant créer un ${prelevement} sur une collection avec un schéma de visites
...
###### Améliorations 
- YouTrack [TK-840](https://tumorotek.myjetbrains.com/youtrack/issue/TK-840) : ${export} des annotations de type ThesaurusM : trier les valeurs par ordre alphabétique avant de les concaténer
...
- YouTrack [TK-868](https://tumorotek.myjetbrains.com/youtrack/issue/TK-868) : ${administration} Fiche Collection en modification : trier les profils par ordre alphabétique
...
- YouTrack [TK-812](https://tumorotek.myjetbrains.com/youtrack/issue/TK-812) : Fiche ${prelevement} > Impression : dans la liste des échantillons, si la date de stockage n'est pas renseignée, "null" est affiché au lieu de "-"
- YouTrack [TK-794](https://tumorotek.myjetbrains.com/youtrack/issue/TK-794) : Modification ${prelevement} : Gatsbi > le préleveur est remis à vide
...
- YouTrack [TK-818](https://tumorotek.myjetbrains.com/youtrack/issue/TK-818) : Permutation au sein d'une boîte : l'objet à l'emplacement de destination n'a pas l'${stockage-evenement} 
...
###### Corrections dans TK
- YouTrack [TK-533](https://tumorotek.myjetbrains.com/youtrack/issue/TK-533) : Export ${prelevement} : pour le champ quantité du bloc "Arrivée au site de stockage" (page 2), l'unité n'est pas exportée
...
- YouTrack [TG-209](https://tumorotek.myjetbrains.com/youtrack/issue/TG-209) : [TK] - ${export} ${echantillon} plantage si évènements de stockage présents
