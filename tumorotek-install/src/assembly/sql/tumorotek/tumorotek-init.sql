...
/*!40000 ALTER TABLE `CATALOGUE_CONTEXTE`
  DISABLE KEYS */;
INSERT INTO `CATALOGUE_CONTEXTE` VALUES (1, 1), (2, 1), (3, 1), (4, 1);
/*!40000 ALTER TABLE `CATALOGUE_CONTEXTE`
  ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `CESSION_TYPE`
  DISABLE KEYS */;
INSERT INTO `CESSION_TYPE` VALUES (1, 'Sanitaire'), (2, 'Recherche'), (3, 'Destruction'), (4, 'Traitement');
/*!40000 ALTER TABLE `CESSION_TYPE`
  ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `CONTEXTE`
  DISABLE KEYS */;
INSERT INTO CONTEXTE (CONTEXTE_ID, NOM, LIBELLE) VALUES (1, 'DEFAUT', 'Anatomopathologie');
INSERT INTO CONTEXTE (CONTEXTE_ID, NOM, LIBELLE) VALUES (2, 'SEROLOGIE', 'Sérologie');
/*!40000 ALTER TABLE `CONTEXTE`
  ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'alphanum'), (2, 'boolean'), (3, 'datetime'), (5, 'num'), (6, 'texte'), (7, 'thesaurus'), (8, 'fichier'),
  (9, 'hyperlien'), (10, 'thesaurusM'), (11, 'date'), (12, 'calcule'), (13, 'duree');
/*!40000 ALTER TABLE `DATA_TYPE`
  ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'CERTAIN', NULL, 1), (2, 'PROBABLE', NULL, 1), (3, 'SUSPECTE', NULL, 1);
/*!40000 ALTER TABLE `DIAGNOSTIC`
  ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE TABLE_ANNOTATION (
  ...
  PLATEFORME_ID       INT(10)              DEFAULT NULL,
  INLINE_DISPLAY      BIT DEFAULT b'0'   NULL,
...
-- ------------------------------------------------------
-- DDL pour le système de validation pour le contexte BTO
-- ------------------------------------------------------
-- Création des tables
...
CREATE TABLE `VALIDATION` (
  ...
  KEY `FK_VALIDATION_NIVEAU_VALIDATION_ID` (`NIVEAU_VALIDATION_ID`),
...
CREATE TABLE `CRITERE_VALIDATION` (
  ...
  KEY `FK_CRITERE_VALIDATION_CHAMP_REF_ID` (`CHAMP_REF_ID`),
  KEY `FK_CRITERE_VALIDATION_CHAMP_ID` (`CHAMP_ID`),
...
CREATE TABLE `VALIDATION_CRITERE_VALIDATION` (
  ...
  KEY `FK_VALIDATION_CRITERE_VALIDATION_CRITERE_VALIDATION_ID` (`CRITERE_VALIDATION_ID`),
  KEY `FK_VALIDATION_CRITERE_VALIDATION_VALIDATION_ID` (`VALIDATION_ID`),
...
CREATE TABLE `SOUS_VALIDATION` (
  ...
  KEY `FK_SOUS_VALIDATION_SOUS_VALIDATION_ID` (`SOUS_VALIDATION_ID`),
  KEY `FK_SOUS_VALIDATION_VALIDATION_ID` (`VALIDATION_ID`),
...
CREATE TABLE `ACTION_VALIDATION` (
  ...
  `VALIDATION_ID` int(11) NOT NULL,
  KEY `ACTION_VALIDATION_VALIDATION_ID` (`VALIDATION_ID`),
  KEY `ACTION_VALIDATION_ACTION_ID` (`ACTION_ID`),
...
CREATE TABLE `DETAIL_VALIDATION` (
  ...
  KEY `FK_DETAIL_VALIDATION_NIVEAU_VALIDATION_ID` (`NIVEAU_VALIDATION_ID`),
  KEY `FK_DETAIL_VALIDATION_UTILISATEUR_ID` (`UTILISATEUR_ID`),
...
DROP TABLE IF EXISTS `CESSION_BTO`;
...
DROP TABLE IF EXISTS `ECHANTILLON_BTO`;
CREATE TABLE `ECHANTILLON_BTO` (
  `ECHANTILLON_DELEGATE_ID` int(11) NOT NULL,
  `DETAIL_VALIDATION_ID` int(11) DEFAULT NULL,
  UNIQUE KEY `ECHANTILLON_DELEGATE_ID` (`ECHANTILLON_DELEGATE_ID`),
  KEY `FK_ECHANTILLON_BTO_DETAIL_VALIDATION_ID` (`DETAIL_VALIDATION_ID`),
  CONSTRAINT `FK_ECHANTILLON_BTO_DETAIL_VALIDATION_ID` FOREIGN KEY (`DETAIL_VALIDATION_ID`) REFERENCES `DETAIL_VALIDATION` (`DETAIL_VALIDATION_ID`),
  CONSTRAINT `FK_ECHANTILLON_BTO_ECHANTILLON_DELEGATE_ID` FOREIGN KEY (`ECHANTILLON_DELEGATE_ID`) REFERENCES `ECHANTILLON_DELEGATE` (`ECHANTILLON_DELEGATE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `PATIENT_BTO` (
  ...
  KEY `FK_PATIENT_BTO_DETAIL_VALIDATION_ID` (`DETAIL_VALIDATION_ID`),
...
DROP TABLE IF EXISTS `PROD_DERIVE_BTO`;
CREATE TABLE `PROD_DERIVE_BTO` (
  `PROD_DERIVE_DELEGATE_ID` int(11) NOT NULL,
  `DETAIL_VALIDATION_ID` int(11) DEFAULT NULL,
  UNIQUE KEY `PROD_DERIVE_DELEGATE_ID` (`PROD_DERIVE_DELEGATE_ID`),
  KEY `FK_PROD_DERIVE_BTO_DETAIL_VALIDATION_ID` (`DETAIL_VALIDATION_ID`),
  CONSTRAINT `FK_PROD_DERIVE_BTO_DETAIL_VALIDATION_ID` FOREIGN KEY (`DETAIL_VALIDATION_ID`) REFERENCES `DETAIL_VALIDATION` (`DETAIL_VALIDATION_ID`),
  CONSTRAINT `FK_PROD_DERIVE_BTO_PROD_DERIVE_DELEGATE_ID` FOREIGN KEY (`PROD_DERIVE_DELEGATE_ID`) REFERENCES `PROD_DERIVE_DELEGATE` (`PROD_DERIVE_DELEGATE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
