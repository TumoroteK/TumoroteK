...
/*==============================================================*/
insert into CONFORMITE_TYPE values (1, 'Arrivee');
insert into CONFORMITE_TYPE values (2, 'Traitement');
insert into CONFORMITE_TYPE values (3, 'Cession');
