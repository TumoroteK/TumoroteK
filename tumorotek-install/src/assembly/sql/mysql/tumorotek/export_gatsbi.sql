...
DROP PROCEDURE IF EXISTS `create_tmp_anonyme_table_gatsbi`&&
CREATE PROCEDURE `create_tmp_anonyme_table_gatsbi`(IN etude_id INTEGER)
  BEGIN
...
DROP PROCEDURE IF EXISTS `fill_tmp_anonyme_table_gatsbi`&&
