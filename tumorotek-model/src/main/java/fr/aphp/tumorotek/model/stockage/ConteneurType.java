...
@NamedQueries(value = {@NamedQuery(name = "ConteneurType.findByType", 
			query = "SELECT c FROM ConteneurType c WHERE c.type = ?1"),
		@NamedQuery(name = "ConteneurType.findByExcludedId", 
			query = "SELECT c FROM ConteneurType c " 
				+ "WHERE c.conteneurTypeId != ?1"),
...
public class ConteneurType implements Serializable, TKThesaurusObject {
	...
	public void setConteneurTypeId(Integer id) {
	...
	public boolean equals(Object obj) {
		...
		ConteneurType test = (ConteneurType) obj;
