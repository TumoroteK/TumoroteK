...
@NamedQueries(value = {@NamedQuery(name = "BlocImpressionTemplate." 
		+ "findByTemplate", 
			query = "SELECT b FROM BlocImpressionTemplate b " 
				+ "WHERE b.pk.template = ?1 " 
				+ "ORDER BY b.ordre"),
		@NamedQuery(name = "BlocImpressionTemplate." 
				+ "findByExcludedPK", 
			query = "SELECT b FROM BlocImpressionTemplate b " 
				+ "WHERE b.pk != ?1") })
public class BlocImpressionTemplate implements Serializable {
	...
	public void setPk(BlocImpressionTemplatePK p) {
		this.pk = p;
	}
	...
	public boolean equals(Object obj) {
		...
		BlocImpressionTemplate test = (BlocImpressionTemplate) obj;
	...
	public BlocImpressionTemplate clone() {
		BlocImpressionTemplate clone = new BlocImpressionTemplate();
