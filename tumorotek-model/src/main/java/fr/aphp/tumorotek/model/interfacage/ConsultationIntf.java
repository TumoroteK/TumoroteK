...
@NamedQueries(value = {@NamedQuery(name = "ConsultationIntf.findByUtilisateurInDates", 
	query = "SELECT c FROM ConsultationIntf c " 
		...
		@NamedQuery(name = "ConsultationIntf.findByUtilisateurEmetteurInDates", 
			query = "SELECT c FROM ConsultationIntf c " 
...
public class ConsultationIntf implements Serializable {
	...
	public void setConsultationIntfId(Integer id) {
	...
	public void setIdentification(String _s) {
	...
	public void setEmetteurIdent(String _id) {
	...
	public boolean equals(Object obj) {
		...
		ConsultationIntf test = (ConsultationIntf) obj;
		return ((this.identification == test.identification || (this.identification != null 
			...
			&& (this.emetteurIdent == test.emetteurIdent 
					|| (this.emetteurIdent != null 
							&& this.emetteurIdent.equals(test.emetteurIdent)))
