 ...
 * accepté les termes.
 **/
package fr.aphp.tumorotek.model.coeur.prodderive.delegate;
 ...
 */
@Entity
@Table(name="PROD_DERIVE_BTO")
public class ProdDeriveBTO extends AbstractProdDeriveDelegate implements TKValidableObject
{
