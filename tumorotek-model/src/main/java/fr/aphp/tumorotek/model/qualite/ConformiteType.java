...
@NamedQueries(value = {
			@NamedQuery(name = "ConformiteType.findByEntiteAndType", 
				query = "SELECT c FROM ConformiteType c "  
					+ "WHERE c.conformiteType like ?1 "
					+ "AND c.entite = ?2")
				})
public class ConformiteType implements java.io.Serializable {
	...
	public void setConformiteTypeId(Integer id) {
	...
	public void setConformiteType(String cType) {
	...
	public void setNonConformites(Set<NonConformite> n) {
	...
	public boolean equals(Object obj) {
		...
		ConformiteType test = (ConformiteType) obj;
