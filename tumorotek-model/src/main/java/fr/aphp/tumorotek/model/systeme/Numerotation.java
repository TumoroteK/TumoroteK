...
public class Numerotation implements TKdataObject, Serializable
{
   ...
   public void setNumerotationId(final Integer id){
   ...
   public void setCodeFormula(final String formula){
   ...
   public void setCurrentIncrement(final Integer incr){
   ...
   public void setStartIncrement(final Integer incr){
   ...
   public void setNbChiffres(final Integer nb){
      this.nbChiffres = nb;
   }
   ...
   public void setZeroFill(final Boolean zero){
      this.zeroFill = zero;
   }
   ...
   public boolean equals(final Object obj){
      ...
      final Numerotation test = (Numerotation) obj;
   ...
   public Numerotation clone(){
      final Numerotation clone = new Numerotation();
