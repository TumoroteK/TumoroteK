...
public class TableAnnotationBanque implements Serializable {
	...
	public String toString() {
		if (this.getTableAnnotation() != null && this.getBanque() != null) {
			return "{" + this.getTableAnnotation() + " - " 
									+ this.getBanque() + "}";
		}
	...
	public void setPk(TableAnnotationBanquePK tbk) {
		this.pk = tbk;
	}
	...
	public void setTableAnnotation(TableAnnotation tab) {
	...
	public boolean equals(Object obj) {
		...
		TableAnnotationBanque test = (TableAnnotationBanque) obj;
		return (this.pk != null 
