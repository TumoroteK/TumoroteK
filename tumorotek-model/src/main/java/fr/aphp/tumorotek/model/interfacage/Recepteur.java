...
@NamedQueries(value = {
		@NamedQuery(name = "Recepteur.findByLogicielAndIdentification", 
				query = "SELECT r FROM Recepteur r "
					+ "WHERE r.logiciel = ?1 "
					+ "AND r.identification like ?2 "
					+ "ORDER BY r.identification"),
		@NamedQuery(name = "Recepteur.findByIdInList", 
				query = "SELECT r FROM Recepteur r "
					+ "WHERE r.recepteurId in (?1) "
					+ "ORDER BY r.identification")
		})
public class Recepteur implements java.io.Serializable {
	...
	public void setRecepteurId(Integer e) {
		this.recepteurId = e;
	}
	...
	public void setEnvoiNum(Integer o) {
		this.envoiNum = o;
	}
