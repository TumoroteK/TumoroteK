...
@NamedQueries(value = {@NamedQuery(name = "BlocExterne.findByDossierExterne", 
			query = "SELECT b FROM BlocExterne b "
				+ "WHERE b.dossierExterne = ?1 "
				+ "ORDER BY b.ordre"),
...
public class BlocExterne implements java.io.Serializable {
	...
	private List<ValeurExterne> valeurs = new ArrayList<ValeurExterne>();
	...
	public void setBlocExterneId(Integer b) {
	...
	public void setEntiteId(Integer e) {
		this.entiteId = e;
	}
	...
	public boolean equals(Object obj) {
		...
		BlocExterne test = (BlocExterne) obj;
		return ((this.dossierExterne == test.dossierExterne 
				|| (this.dossierExterne != null 
				&& this.dossierExterne.equals(test.dossierExterne))) 
		&& (this.entiteId == test.entiteId 
				|| (this.entiteId != null 
				&& this.entiteId.equals(test.entiteId)))
		&& (this.ordre == test.ordre 
				|| (this.ordre != null 
	...
	public String toString() {
		if (this.entiteId != null && this.ordre != null) {
			return "{" + this.ordre + ", " 
				+ this.entiteId + "(Entite) "
				+ dossierExterne.getIdentificationDossier() 
				+ "(DossierExterne)}";
		} else {
