...
@NamedQueries(value = {
		@NamedQuery(name = "CessionStatut.findByStatut", 
			query = "SELECT c FROM CessionStatut c " 
				+ "WHERE c.statut like ?1"),
		@NamedQuery(name = "CessionStatut.findByOrder", 
				query = "SELECT c FROM CessionStatut c " 
					+ "ORDER BY c.statut") })
public class CessionStatut implements Serializable {
	...
	public void setCessionStatutId(Integer id) {
	...
	public boolean equals(Object obj) {
		...
		CessionStatut test = (CessionStatut) obj;
		if (this.statut == null) {
