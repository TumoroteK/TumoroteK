...
@NamedQueries(value = {@NamedQuery(name = "TerminaleType.findByType", 
			query = "SELECT t FROM TerminaleType t WHERE t.type = ?1"),
		@NamedQuery(name = "TerminaleType.findByNbPlaces", 
			query = "SELECT t FROM TerminaleType t WHERE t.nbPlaces = ?1"),
		@NamedQuery(name = "TerminaleType.findByHauteur", 
			query = "SELECT t FROM TerminaleType t WHERE t.hauteur = ?1"),
		@NamedQuery(name = "TerminaleType.findByLongueur", 
			query = "SELECT t FROM TerminaleType t WHERE t.longueur = ?1"),
		@NamedQuery(name = "TerminaleType.findByScheme", 
			query = "SELECT t FROM TerminaleType t WHERE t.scheme = ?1"),
		@NamedQuery(name = "TerminaleType.findByExcludedId", 
			query = "SELECT t FROM TerminaleType t " 
				+ "WHERE t.terminaleTypeId != ?1"),
		@NamedQuery(name = "TerminaleType.findByOrder", 
			query = "SELECT t FROM TerminaleType t " 
				+ "ORDER BY t.type") })
public class TerminaleType implements TKdataObject, Serializable {
	...
	public void setTerminaleTypeId(Integer id) {
	...
	public void setHauteur(Integer haut) {
		this.hauteur = haut;
	}
	...
	public void setLongueur(Integer l) {
		this.longueur = l;
	}
	...
	public void setDepartNumHaut(Boolean depart) {
	...
	public boolean equals(Object obj) {
		...
		TerminaleType test = (TerminaleType) obj;
		if (this.type == null) {
	...
	public TerminaleType clone() {
		TerminaleType clone = new TerminaleType();
