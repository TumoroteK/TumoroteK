...
public class TableAnnotationTemplatePK implements Serializable {
	...
	public TableAnnotationTemplatePK(Template temp, 
	...
	public void setTableAnnotation(TableAnnotation t) {
	...
	public boolean equals(Object obj) {
		...
		TableAnnotationTemplatePK test = (TableAnnotationTemplatePK) obj;
	...
	public String toString() {
		if (this.template != null 
			...
			return "{" + template.toString() + " (Template), " 
					+ tableAnnotation.toString() + " (TableAnnotation)}";
		} else {
