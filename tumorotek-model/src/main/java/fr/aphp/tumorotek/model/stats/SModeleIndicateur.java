...
@AssociationOverrides({
	@AssociationOverride(name = "pk.sModele", 
				joinColumns = @JoinColumn(name = "STATS_MODELE_ID", 
							referencedColumnName = "STATS_MODELE_ID")),
	@AssociationOverride(name = "pk.indicateur", 
			joinColumns = @JoinColumn(name = "STATS_INDICATEUR_ID",
							referencedColumnName = "STATS_INDICATEUR_ID"))
    })
...
public class SModeleIndicateur implements Serializable {
	...
	public SModeleIndicateur(SModele sM, Indicateur i, Integer o) {
		pk.setIndicateur(i);
		pk.setsModele(sM);
		setOrdre(o);
	}
	...
	@EmbeddedId
	@AttributeOverrides({
		@AttributeOverride(name = "sModele", 
				column = @Column(name = "STATS_MODELE_ID")),
		@AttributeOverride(name = "indicateur", 
				column = @Column(name = "STATS_INDICATEUR_ID")) })
	public SModeleIndicateurPK getPk() {
		return pk;
	}
	 
	public void setPk(SModeleIndicateurPK pmk) {
		this.pk = pmk;
	}
	...
	public void setSModele(SModele sm) {
	...
	public void setIndicateur(Indicateur i) {
	...
	public boolean equals(Object obj) {
		...
		SModeleIndicateur test = (SModeleIndicateur) obj;
		return (this.pk != null 
