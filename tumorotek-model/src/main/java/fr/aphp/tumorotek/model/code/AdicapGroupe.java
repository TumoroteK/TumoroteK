...
/**
 * 
 * Objet persistant mappant la table ADICAP_GROUPE.
 * Classe créée le 02/06/10.
 * 
...
@NamedQueries(value = {@NamedQuery(name = "AdicapGroupe.findDictionnaires", 
...
public class AdicapGroupe implements Serializable {
	...
	private Set<AdicapGroupe> adicapGroupes = new HashSet<AdicapGroupe>();
	...
	public void setAdicapGroupeId(Integer id) {
	...
	public void setGroupeParent(AdicapGroupe parent) {
	...
	public void setAdicapGroupes(Set<AdicapGroupe> adis) {
	...
	public boolean equals(Object obj) {
		...
		AdicapGroupe test = (AdicapGroupe) obj;
