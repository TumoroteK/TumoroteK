...
public class Subdivision implements Serializable
{
   ...
   public void setSubdivisionId(final Integer _id){
   ...
   public void setIndicateurs(final List<Indicateur> indicateurs){
   ...
   public void setChampEntite(final ChampEntite chpE){
   ...
   public boolean equals(final Object obj){
      ...
      final Subdivision sub = (Subdivision) obj;
      return (this.nom == sub.nom || (this.nom != null && this.nom.equals(sub.nom)));
   }
