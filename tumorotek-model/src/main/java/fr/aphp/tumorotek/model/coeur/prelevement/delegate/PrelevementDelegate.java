...
public class PrelevementDelegate extends TKDelegateObject
{
   ...
   public void setPrelevementDelegateId(final Integer prelevementSeroId){
      this.prelevementDelegateId = prelevementSeroId;
   }
   ...
   public void setPrelevement(final Prelevement prelevement){
   ...
   public Object getDelegator(){
      return getPrelevement();
   }

   @Override
   public void setDelegator(final Object obj){
      setPrelevement((Prelevement) obj);
   }
