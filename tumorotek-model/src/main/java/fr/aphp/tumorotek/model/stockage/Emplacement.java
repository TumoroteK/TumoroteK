...
@NamedQueries(value = {@NamedQuery(
		name = "Emplacement.findByTerminaleWithOrder", 
			query = "SELECT e FROM Emplacement e " 
				+ "WHERE e.terminale = ?1 " 
				+ "ORDER BY e.position"),
		...
		@NamedQuery(name = "Emplacement.findByCountTerminaleAndVide", 
			query = "SELECT count(e) FROM Emplacement e " 
				+ "WHERE e.terminale = ?1 " 
				+ "AND e.vide = ?2"),
		...
		@NamedQuery(name = "Emplacement.findByExcludedIdTerminale", 
			query = "SELECT e FROM Emplacement e " 
				+ "WHERE e.emplacementId != ?1 " 
				+ "AND e.terminale = ?2"),
		@NamedQuery(name = "Emplacement.findByObjetId", 
			query = "SELECT e FROM Emplacement e WHERE e.objetId = ?1"),
		@NamedQuery(name = "Emplacement.findByEntite", 
			query = "SELECT e FROM Emplacement e WHERE e.entite = ?1"),
		@NamedQuery(name = "Emplacement.findByVide", 
			query = "SELECT e FROM Emplacement e WHERE e.vide = ?1"),
		@NamedQuery(name = "Emplacement.findByAdrp", 
			query = "SELECT e FROM Emplacement e WHERE e.adrp = ?1"),
		@NamedQuery(name = "Emplacement.findDouplon", 
			query = "SELECT e FROM Emplacement e WHERE e.adrl = ?1"),
		@NamedQuery(name = "Emplacement.findByIdWithFetch", 
			query = "SELECT e FROM Emplacement e LEFT JOIN FETCH " 
				+ "e.terminale WHERE e.emplacementId = ?1")
...
public class Emplacement implements Serializable {
	...
	public void setEmplacementId(Integer id) {
	...
	public void setTerminale(Terminale term) {
		this.terminale = term;
	}
	...
	public void setObjetId(Integer objet) {
		this.objetId = objet;
	}
	...
	public void setAdrp(String adr) {
		this.adrp = adr;
	}
	...
	public void setAdrl(String adr) {
		this.adrl = adr;
	}
...
//	}
	...
	public void setProdDerives(Set<ProdDerive> prodDers) {
	...
	public void setEchantillons(Set<Echantillon> echans) {
	...
	public boolean equals(Object obj) {
		...
		Emplacement test = (Emplacement) obj;
		return ((this.position == test.position 
				|| (this.position != null 
						&& this.position.equals(test.position))) 
				&& (this.terminale == test.terminale 
						|| (this.terminale != null 
						&& this.terminale.equals(test.terminale))));
	}
	...
	public Emplacement clone() {
		Emplacement clone = new Emplacement();
