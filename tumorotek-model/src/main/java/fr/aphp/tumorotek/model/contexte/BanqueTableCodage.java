...
@AssociationOverrides({
	@AssociationOverride(name = "pk.banque", 
				joinColumns = @JoinColumn(name = "BANQUE_ID", 
							referencedColumnName = "BANQUE_ID")),
	@AssociationOverride(name = "pk.tableCodage", 
			joinColumns = @JoinColumn(name = "TABLE_CODAGE_ID",
							referencedColumnName = "TABLE_CODAGE_ID"))
})	
@NamedQueries(value = {@NamedQuery(name = "BanqueTableCodage.findByBanque", 
			query = "SELECT b FROM BanqueTableCodage b "
				+ "WHERE b.pk.banque = ?1 ORDER BY b.pk.tableCodage.nom")
})
public class BanqueTableCodage {
	...
	public String toString() {
		if (this.getBanque() != null && this.getTableCodage() != null) {
			return "{" + this.getBanque().getNom() + " - " 
									+ this.getTableCodage().getNom() + "}";
		}
	...
	@AttributeOverrides({
		...
		@AttributeOverride(name = "tableCodage", 
				column = @Column(name = "TABLE_CODAGE_ID")) })
	public BanqueTableCodagePK getPk() {
		return pk;
	}
	 
	public void setPk(BanqueTableCodagePK btck) {
		this.pk = btck;
	}
	...
	public void setLibelleExport(Boolean l) {
	...
	public void setTableCodage(TableCodage t) {
	...
	public boolean equals(Object obj) {
		...
		BanqueTableCodage test = (BanqueTableCodage) obj;
		return (this.pk != null 
