...
@NamedQueries(value = {@NamedQuery(name = "NonConformite.findByTypeAndPf", 
				query = "SELECT n FROM NonConformite n "
					+ "WHERE n.conformiteType = ?1 "
					+ "AND n.plateforme = ?2 "
					+ "ORDER BY n.nom"),
...
public class NonConformite implements java.io.Serializable {
	...
	public void setNonConformiteId(Integer id) {
	...
	public void setConformiteType(ConformiteType c) {
	...
	public boolean equals(Object obj) {
		...
		NonConformite test = (NonConformite) obj;
		return ((this.nom == test.nom 
				|| (this.nom != null 
				&& this.nom.equals(test.nom))) 
		&& (this.conformiteType == test.conformiteType 
				|| (this.conformiteType != null 
				&& this.conformiteType.equals(test.conformiteType)))
	...
	public String toString() {
		if (this.nom != null) {
			return "{" + this.nom + ", " 
				+ conformiteType.getConformiteType() 
				+ "(ConformiteType), " 
				+ plateforme.getNom()
				+ "(Plateforme)}";
		} else {
	...
	public NonConformite clone() {
		NonConformite clone = new NonConformite();
