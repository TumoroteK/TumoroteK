...
public class ImportColonne implements java.io.Serializable {
	...
	@Id
	@Column(name = "IMPORT_COLONNE_ID", unique = true, 
			nullable = false)
	...
	public void setImportColonneId(Integer id) {
	...
	public boolean equals(Object obj) {
		...
		ImportColonne test = (ImportColonne) obj;
		return ((this.nom == test.nom || (this.nom != null 
				...
				&& (this.importTemplate == test.importTemplate 
						...
						&& this.importTemplate.equals(test.importTemplate)))
	...
	public ImportColonne clone() {
		ImportColonne clone = new ImportColonne();
	...
	public String toString() {
		...
		return "{" + this.nom + ", " + importTemplate.getNom() 
			+ "(ImportTemplate)}";	
		} else {
