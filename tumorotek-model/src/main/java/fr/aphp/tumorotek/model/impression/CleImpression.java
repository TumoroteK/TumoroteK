...
/**
 *
 * Objet persistant mappant la table CLE_IMPRESSION. Une cleImpression est
 * associée à un Champ. Utilisée pour remplacer le nom de la clé par la valeur
 * du champ, dans du texte ou un document.
 * 
...
//      result = prime * result + ((template == null) ? 0 : template.hashCode());
	...
	public boolean equals(final Object obj) {
		...
		if ((obj == null) || !(obj instanceof CleImpression)) {
			return false;
		}
		final CleImpression test = (CleImpression) obj;
		return Objects.equals(cleId, test.getCleId()) && Objects.equals(nom, test.getNom());
	}
