 ...
 * accepté les termes.
 **/
package fr.aphp.tumorotek.model.coeur.echantillon.delegate;
 ...
 */
@Entity
@Table(name = "ECHANTILLON_BTO")
public class EchantillonBTO extends AbstractEchantillonDelegate implements TKValidableObject
{
