...
@NamedQueries(value = {@NamedQuery(name = "TerminaleNumerotation.findByLigne", 
			query = "SELECT t FROM TerminaleNumerotation t WHERE t.ligne = ?1"),
		@NamedQuery(name = "TerminaleNumerotation.findByColonne", 
			query = "SELECT t FROM TerminaleNumerotation t " 
				+ "WHERE t.colonne = ?1") })
public class TerminaleNumerotation implements Serializable {
	...
	public void setTerminaleNumerotationId(Integer id) {
	...
	public void setLigne(String lig) {
		this.ligne = lig;
	}
	...
	public boolean equals(Object obj) {
		...
		TerminaleNumerotation test = (TerminaleNumerotation) obj;
		return ((this.colonne == test.colonne 
					|| (this.colonne != null 
							&& this.colonne.equals(test.colonne))) 
					&& (this.ligne == test.ligne 
							|| (this.ligne != null 
							&& this.ligne.equals(test.ligne))));
	}
