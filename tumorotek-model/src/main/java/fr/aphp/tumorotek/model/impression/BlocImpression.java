...
@NamedQueries(value = {@NamedQuery(name = "BlocImpression.findByEntite", 
			query = "SELECT b FROM BlocImpression b WHERE b.entite = ?1 " 
				+ "ORDER BY b.ordre") })
public class BlocImpression implements Serializable {
	...
	private Set<ChampImprime> champImprimes = 
		new HashSet<ChampImprime>();
	...
	public void setBlocImpressionId(Integer id) {
	...
	public void setIsListe(Boolean isL) {
		this.isListe = isL;
	}
	...
	public void setChampEntiteBlocs(Set<ChampEntiteBloc> champs) {
	...
	public void setBlocImpressionTemplates(
			Set<BlocImpressionTemplate> templates) {
	...
	public boolean equals(Object obj) {
		...
		BlocImpression test = (BlocImpression) obj;
		if (this.nom == null) {
			if (test.nom == null) {
				if (this.entite == null) {
	...
	public BlocImpression clone() {
		BlocImpression clone = new BlocImpression();
