...
@NamedQueries(value = {@NamedQuery(name = "ObjetNonConforme" 
		+ ".findByObjetAndEntite", 
				query = "SELECT o FROM ObjetNonConforme o "
					+ "WHERE o.objetId = ?1 "
					+ "AND o.entite = ?2"),
		@NamedQuery(name = "ObjetNonConforme.findByObjetEntiteAndType", 
				query = "SELECT o FROM ObjetNonConforme o "
					+ "WHERE o.objetId = ?1 "
					+ "AND o.entite = ?2 " 
					+ "AND o.nonConformite.conformiteType = ?3 "
					+ "ORDER BY o.nonConformite.nom"),
		@NamedQuery(name = "ObjetNonConforme.findByNonConformite", 
				query = "SELECT o FROM ObjetNonConforme o "
					+ "WHERE o.nonConformite = ?1"),
		@NamedQuery(name = "ObjetNonConforme.findObjetIdsByNonConformites", 
				query = "SELECT distinct o.objetId FROM ObjetNonConforme o "
					+ "LEFT JOIN o.nonConformite n WHERE n in (?1)")})
public class ObjetNonConforme implements java.io.Serializable {
	...
	public void setObjetNonConformeId(Integer id) {
	...
	public void setNonConformite(NonConformite n) {
	...
	public boolean equals(Object obj) {
		...
		ObjetNonConforme test = (ObjetNonConforme) obj;
		return ((this.nonConformite == test.nonConformite 
				|| (this.nonConformite != null 
				&& this.nonConformite.equals(test.nonConformite))) 
	...
	public ObjetNonConforme clone() {
		ObjetNonConforme clone = new ObjetNonConforme();
