...
public class CederObjetPK implements Serializable {
    ...
    public CederObjetPK(Cession cess, Entite ent, Integer id) {
    	this.cession = cess;
    	this.entite = ent;
    	this.objetId = id;
    }
	...
	public boolean equals(Object obj) {
		...
		CederObjetPK test = (CederObjetPK) obj;
		return ((this.cession == test.cession || (this.cession != null 
				&& this.cession.equals(test.cession))) 
	...
	public String toString() {
		if (this.entite != null 
				&& this.cession != null
				&& this.objetId != null) {
			return "{" + cession.toString() + " (Cession), " 
					+ entite.toString() + " (Entite), " 
					+ objetId + " (ObjetId)}";
		} else {
