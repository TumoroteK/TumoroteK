...
@AssociationOverrides({
	@AssociationOverride(name = "pk.collaborateur", 
				joinColumns = @JoinColumn(name = "COLLABORATEUR_ID", 
							referencedColumnName = "COLLABORATEUR_ID")),
...
public class PatientMedecin implements Serializable {
	...
	@EmbeddedId
	@AttributeOverrides({
		@AttributeOverride(name = "collaborateur", 
				column = @Column(name = "COLLABORATEUR_ID")),
		@AttributeOverride(name = "patient", 
				column = @Column(name = "PATIENT_ID")) })
	public PatientMedecinPK getPk() {
		return pk;
	}
	 
	public void setPk(PatientMedecinPK pmk) {
		this.pk = pmk;
	}
	...
	public boolean equals(Object obj) {
		...
		PatientMedecin test = (PatientMedecin) obj;
		return (this.pk != null 
