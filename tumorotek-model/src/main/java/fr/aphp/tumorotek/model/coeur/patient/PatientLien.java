...
@AssociationOverrides({
	@AssociationOverride(name = "pk.patient1", 
				joinColumns = @JoinColumn(name = "PATIENT1_ID", 
							referencedColumnName = "PATIENT_ID")),
	@AssociationOverride(name = "pk.patient2", 
			joinColumns = @JoinColumn(name = "PATIENT2_ID",
							referencedColumnName = "PATIENT_ID"))
    })
@AttributeOverride(column = 
	@Column(name = "LIEN_FAMILIAL_ID"), name = "lienFamilial")
public class PatientLien implements Serializable {
	...
	public String toString() {
		if (this.lienFamilial != null && this.getPatient1() != null 
									&& this.getPatient2() != null) {
			return "{" + this.getPatient1() + " - " + this.lienFamilial 
									+ " - " + this.getPatient2() + "}";
		}
	...
	@EmbeddedId
	@AttributeOverrides({
		@AttributeOverride(name = "patient1", 
				column = @Column(name = "PATIENT1_ID")),
		@AttributeOverride(name = "patient2", 
				column = @Column(name = "PATIENT2_ID")) })
	public PatientLienPK getPk() {
		return pk;
	}
	 
	public void setPk(PatientLienPK ppk) {
		this.pk = ppk;
	}
	...
	public void setLienFamilial(LienFamilial l1) {
	...
	public void setPatient1(Patient pat1) {
	...
	public void setPatient2(Patient pat2) {
	...
	public boolean equals(Object obj) {
		...
		PatientLien test = (PatientLien) obj;
		return (this.pk != null 
				&& (this.pk == test.pk
