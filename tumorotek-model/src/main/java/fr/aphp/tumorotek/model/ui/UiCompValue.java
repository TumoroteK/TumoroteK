...
public class UiCompValue implements java.io.Serializable {
	...
	public UiCompValue(Integer id, UiRequete req, String idC, String cC, 
						Integer iV, String tV, Boolean kV, Calendar cV) {
		setUiCompValueId(id);
		setUiRequete(req);
		setIdComponent(idC);
	...
	public void setUiCompValueId(Integer i) {
	...
	public void setUiRequete(UiRequete u) {
		this.uiRequete = u;
	}
	...
	public void setIdComponent(String i) {
		this.idComponent = i;
	}
	...
	public void setComponentClass(String c) {
	...
	public void setIndexValue(Integer x) {
		this.indexValue = x;
	}
	...
	public void setTextValue(String x) {
		this.textValue = x;
	}
	...
	public void setCheckValue(Boolean k) {
		this.checkValue = k;
	}
	...
	public void setCalendarValue(Calendar cal) {
		if (cal != null) {
	...
	public boolean equals(Object obj) {
		...
		UiCompValue test = (UiCompValue) obj;
		return ((this.uiRequete == test.uiRequete 
				|| (this.uiRequete != null 
						&& this.uiRequete.equals(test.uiRequete))) 
				&& (this.idComponent == test.idComponent 
						|| (this.idComponent != null 
						&& this.idComponent.equals(test.idComponent)))  
			);
	}
