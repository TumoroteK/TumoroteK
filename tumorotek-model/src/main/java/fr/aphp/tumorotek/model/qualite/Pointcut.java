...
@Entity
@Table(name = "POINTCUT")
@NamedQueries(value = {@NamedQuery(name = "Pointcut.findByNom", query = "SELECT p FROM Pointcut p WHERE p.nom = ?1")})
public class Pointcut implements Serializable
{
   ...
   public void setPointcutId(final Integer id){
      this.pointcutId = id;
   }
   ...
   public boolean equals(final Object obj){
      ...
      final Pointcut test = (Pointcut) obj;
