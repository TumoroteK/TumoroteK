...
@NamedQueries(value = {@NamedQuery(name = "OperationType.findByNom", 
...
public class OperationType implements Serializable {
	...
	private Set<DroitObjet> droitObjets = 
		new HashSet<DroitObjet>();
	...
	public OperationType(Integer operationTypeId, String nom, Boolean profilable) {
	...
	public void setOperationTypeId(Integer opeTypeId) {
	...
	public void setProfilable(Boolean prof) {
	...
	public void setEmetteur(Emetteur _e) {
		this.emetteur = _e;
	}
	...
	public boolean equals(Object obj) {
		...
		OperationType test = (OperationType) obj;
