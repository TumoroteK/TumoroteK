...
@AssociationOverrides({
	...
	@AssociationOverride(name = "pk.tableAnnotation", 
			joinColumns = @JoinColumn(name = "TABLE_ANNOTATION_ID",
					referencedColumnName = "TABLE_ANNOTATION_ID"))
        })
@NamedQueries(value = {@NamedQuery(name = "TableAnnotationTemplate." 
		+ "findByTemplate", 
			query = "SELECT t FROM TableAnnotationTemplate t " 
				+ "WHERE t.pk.template = ?1 " 
				+ "ORDER BY t.ordre"),
		@NamedQuery(name = "TableAnnotationTemplate." 
				+ "findByExcludedPK", 
			query = "SELECT t FROM TableAnnotationTemplate t " 
				+ "WHERE t.pk != ?1") })
public class TableAnnotationTemplate implements Serializable {
	...
	@AttributeOverrides({
		...
		@AttributeOverride(name = "tableAnnotation", 
				column = @Column(name = "TABLE_ANNOTATION_ID")) })
	public TableAnnotationTemplatePK getPk() {
		return pk;
	}

	public void setPk(TableAnnotationTemplatePK p) {
		this.pk = p;
	}
	...
	public boolean equals(Object obj) {
		...
		TableAnnotationTemplate test = (TableAnnotationTemplate) obj;
	...
	public TableAnnotationTemplate clone() {
		TableAnnotationTemplate clone = new TableAnnotationTemplate();
