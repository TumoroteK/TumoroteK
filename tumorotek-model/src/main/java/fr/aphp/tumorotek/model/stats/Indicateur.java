...
public class Indicateur implements Serializable, Comparable<Object>
{
   ...
   public Indicateur(final String nom, final String desc, final String call){
      super();
      this.nom = nom;
   ...
   public void setIndicateurId(final Integer _id){
   ...
   public void setsModeleIndicateurs(final Set<SModeleIndicateur> sModeleIndicateurs){
   ...
   public void setCallingProcedure(final String callingProcedure){
   ...
   public void setSubdivision(final Subdivision s){
      this.subdivision = s;
   }
   ...
   public Indicateur clone(){
      final Indicateur clone = new Indicateur();
   ...
   public boolean equals(final Object obj){
      ...
      final Indicateur st = (Indicateur) obj;

      return (this.nom == st.nom || (this.nom != null && this.nom.equals(st.nom)))
         && (this.entite == st.entite || (this.entite != null && this.entite.equals(st.entite)));
   }
   ...
   public int hashCode(){
      ...
      hashCode = 31 * hashCode + ((entite == null) ? 0 : entite.hashCode());
      return hashCode;
   }
