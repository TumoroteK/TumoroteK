...
/**
 *
 * Embedded Id pour la table PATIENT_IDENTIFIANT.
 *
 ...
 */
@Embeddable
public class PatientIdentifiantPK implements Serializable
{
   ...
   public PatientIdentifiantPK(){}

   public PatientIdentifiantPK(final Banque b, final Patient p){
      this.banque = b;
      this.patient = p;
   }
   ...
   public void setBanque(final Banque c){
      this.banque = c;
   }
   ...
   public boolean equals(final Object obj){
      ...
      final PatientIdentifiantPK pk = (PatientIdentifiantPK) obj;
      
      return Objects.equals(banque, pk.getBanque())
         && Objects.equals(patient, pk.getPatient()); 
   }
