 ...
 * accepté les termes.
 **/
package fr.aphp.tumorotek.model.cession.delegate;
 ...
 */
@Entity
@Table(name="CESSION_BTO")
public class CessionBTO extends AbstractCessionDelegate implements TKValidableObject
{

   private DetailValidation detailValidation;

   /* (non-Javadoc)
    * @see fr.aphp.tumorotek.model.TKValidableObject#getDetailValidation()
    */
   @Override
   ...
   /*
    * (non-Javadoc)
    * @see fr.aphp.tumorotek.model.TKDelegateObject#isEmpty()
    */
   @Override
   @Transient
