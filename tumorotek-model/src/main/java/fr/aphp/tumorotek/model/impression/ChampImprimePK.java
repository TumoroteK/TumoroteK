...
public class ChampImprimePK implements Serializable {
	...
	public ChampImprimePK(Template temp, ChampEntite champ, 
			BlocImpression bloc) {
		this.template = temp;
	...
	public String toString() {
		if (this.template != null 
				&& this.champEntite != null
				&& this.blocImpression != null) {
			return "{" + template.toString() + " (Template), " 
					+ champEntite.toString() + " (ChampEntite), "
