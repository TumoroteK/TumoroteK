...
@Entity
@Table(name = "COULEUR")
@NamedQueries(value = {@NamedQuery(name = "Couleur.findByCouleur",
		query = "SELECT c FROM Couleur c WHERE c.couleur like ?1"),
		@NamedQuery(name = "Couleur.findByVisotube",
			query = "SELECT c FROM Couleur c " 
				+ "WHERE c.ordreVisotube is not null " 
				+ "ORDER BY c.ordreVisotube")
		})
public class Couleur implements Serializable {
	...
	private Set<Banque> banquesEchantillons = new HashSet<Banque>();
	private Set<Banque> banquesProdDerives = new HashSet<Banque>();
	...
	public void setCouleurId(Integer cId) {
		this.couleurId = cId;
	}
	...
	public void setOrdreVisotube(Integer o) {
	...
	public void setBanquesEchantillons(Set<Banque> banques) {
	...
	public void setBanquesProdDerives(Set<Banque> banques) {
	...
	public void setEnceintes(Set<Enceinte> e) {
		this.enceintes = e;
	}
	...
	public void setTerminales(Set<Terminale> t) {
		this.terminales = t;
	}
	...
	public boolean equals(Object obj) {
		...
		Couleur test = (Couleur) obj;
		return ((this.couleur == test.couleur || (this.couleur != null 
							&& this.couleur.equals(test.couleur))) 
		);		
	}
