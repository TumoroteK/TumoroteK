...
@NamedQueries(value = {@NamedQuery(name = "ChampImprime.findByTemplate", 
			query = "SELECT c FROM ChampImprime c " 
				+ "WHERE c.pk.template = ?1 " 
				+ "ORDER BY c.ordre"),
		@NamedQuery(name = "ChampImprime.findByTemplateAndBloc", 
			query = "SELECT c FROM ChampImprime c " 
				+ "WHERE c.pk.template = ?1 " 
				+ "AND c.pk.blocImpression = ?2 " 
				+ "ORDER BY c.ordre"),
		@NamedQuery(name = "ChampImprime.findByExcludedPK", 
			query = "SELECT c FROM ChampImprime c " 
				+ "WHERE c.pk != ?1") })
public class ChampImprime implements Serializable {
	...
	@EmbeddedId
	@AttributeOverrides({
		@AttributeOverride(name = "template", 
	...
	public void setPk(ChampImprimePK p) {
		this.pk = p;
	}
	...
	public void setBlocImpression(BlocImpression bloc) {
	...
	public boolean equals(Object obj) {
		...
		ChampImprime test = (ChampImprime) obj;
	...
	public ChampImprime clone() {
		ChampImprime clone = new ChampImprime();
