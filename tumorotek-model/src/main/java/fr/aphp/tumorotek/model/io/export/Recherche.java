...
public class Recherche implements TKdataObject, Comparable<Recherche>
{
   ...
   public Recherche(final String i, final Affichage aff, final Requete req, final List<Banque> b){
      super();
      this.intitule = i;
      this.affichage = aff;
      this.requete = req;
   ...
   public Recherche(final String i, final Affichage aff, final Requete req, final List<Banque> b, final Utilisateur u){
      this(i, aff, req, b);
      this.createur = u;
   }
   ...
   public void setRechercheId(final Integer rId){
   ...
   public void setRequete(final Requete req){
      this.requete = req;
   }
   ...
   public boolean equals(final Object obj){
      ...
      final Recherche r = (Recherche) obj;
   ...
   public Recherche clone(){
      final Recherche clone = new Recherche();
   ...
   @Override
   public int compareTo(final Recherche rec){
