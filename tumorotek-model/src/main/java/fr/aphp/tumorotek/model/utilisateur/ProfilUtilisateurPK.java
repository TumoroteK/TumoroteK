...
public class ProfilUtilisateurPK implements Serializable
{
   ...
   public ProfilUtilisateurPK(final Profil prof, final Utilisateur util, final Banque bank){
      this.profil = prof;
   ...
   public void setUtilisateur(final Utilisateur user){
   ...
   public boolean equals(final Object obj){
      ...
      final ProfilUtilisateurPK test = (ProfilUtilisateurPK) obj;
