...
@NamedQueries(value = {@NamedQuery(name = "CessionType.findByType", 
				query = "SELECT c FROM CessionType c WHERE c.type like ?1"), 
		@NamedQuery(name = "CessionType.findByOrder", 
				query = "SELECT c FROM CessionType c " 
				+ "ORDER BY c.type") })
public class CessionType implements Serializable {
	...
	public void setCessionTypeId(Integer id) {
	...
	public boolean equals(Object obj) {
		...
		CessionType test = (CessionType) obj;
		if (this.type == null) {
