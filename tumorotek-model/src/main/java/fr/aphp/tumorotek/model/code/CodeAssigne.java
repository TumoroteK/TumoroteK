...
public class CodeAssigne implements CodeCommon, Serializable
{
   ...
   public boolean equals(final Object obj){
      ...
      return ((this.echantillon == test.echantillon || (this.echantillon != null && this.echantillon.equals(test.echantillon)))
         ...
         && (this.codeRefId == test.codeRefId || (this.codeRefId != null && this.codeRefId.equals(test.codeRefId)))
