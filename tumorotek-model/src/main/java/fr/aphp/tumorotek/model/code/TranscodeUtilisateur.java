...
public class TranscodeUtilisateur implements Serializable {
	...
	public void setTranscodeUtilisateurId(Integer id) {
	...
	public void setCodeUtilisateur(CodeUtilisateur codeU) {
	...
	public void setCodeId(Integer c) {
		this.codeId = c;
	}
	...
	public boolean equals(Object obj) {
		...
		TranscodeUtilisateur test = (TranscodeUtilisateur) obj;
		return ((this.codeId == test.codeId 
					|| (this.codeId != null 
							&& this.codeId.equals(test.codeId)))
				&& (this.codeUtilisateur == test.codeUtilisateur
					|| (this.codeUtilisateur != null 
						&& this.codeUtilisateur.equals(test.codeUtilisateur))) 
