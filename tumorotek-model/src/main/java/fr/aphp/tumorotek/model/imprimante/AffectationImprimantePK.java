...
public class AffectationImprimantePK implements Serializable {
	...
	public AffectationImprimantePK(Utilisateur u, Banque b,
			Imprimante i) {
		this.utilisateur = u;
		this.banque = b;
		this.imprimante = i;
	...
	public boolean equals(Object obj) {
		...
		AffectationImprimantePK test = (AffectationImprimantePK) obj;
		return ((this.utilisateur == test.utilisateur 
				...
				&& (this.imprimante == test.imprimante 
						|| (this.imprimante != null 
						&& this.imprimante.equals(test.imprimante))));
	}
	...
	public String toString() {
		if (this.imprimante != null 
				&& this.utilisateur != null
				&& this.banque != null) {
			return "{" + utilisateur.toString() + " (Utilisateur), " 
					+ banque.toString() + " (Banque), " 
					+ imprimante.toString() + " (Imprimante)}";
		} else {
