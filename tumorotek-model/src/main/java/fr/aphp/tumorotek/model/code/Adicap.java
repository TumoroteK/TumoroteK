...
public class Adicap implements CodeCommon, Serializable {
	...
	private Set<CimoMorpho> cimoMorphos = new HashSet<CimoMorpho>();	
	private Set<CimMaster> cimMasters = new HashSet<CimMaster>();
	...
	public void setAdicapId(Integer id) {
		this.adicapId = id;
	}
	...
	public void setAdicapGroupe(AdicapGroupe parent) {
	...
	public void setMorpho(Boolean morph) {
		this.morpho = morph;
	}
	...
	public void setAdicapParent(Adicap topo) {
	...
	@ManyToMany(
			targetEntity = CimoMorpho.class
	)
    @JoinTable(
    		name = "ADICAPCIMO_MORPHO",
            joinColumns = @JoinColumn(name = "ADICAP_ID"),
	...
	public void setCimoMorphos(Set<CimoMorpho> cimoMorphs) {
		this.cimoMorphos = cimoMorphs;
	}

	@ManyToMany(
	        mappedBy = "adicaps",
	        targetEntity = CimMaster.class
	)
	public Set<CimMaster> getCimMasters() {
		return this.cimMasters;
	}

	public void setCimMasters(Set<CimMaster> cims) {
