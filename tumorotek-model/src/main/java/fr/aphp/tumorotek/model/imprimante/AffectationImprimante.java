...
@AssociationOverrides({
	...
	@AssociationOverride(name = "pk.imprimante", 
			joinColumns = @JoinColumn(name = "IMPRIMANTE_ID"))
        })
@NamedQueries(value = {
		@NamedQuery(name = "AffectationImprimante.findByExcludedPK", 
			query = "SELECT a FROM AffectationImprimante a " 
				+ "WHERE a.pk != ?1"),
		@NamedQuery(name = "AffectationImprimante.findByBanqueUtilisateur", 
			query = "SELECT a FROM AffectationImprimante a " 
				+ "WHERE a.pk.banque = ?1 AND a.pk.utilisateur = ?2") })
public class AffectationImprimante implements Serializable {
	...
	@EmbeddedId
	@AttributeOverrides({
		@AttributeOverride(name = "imprimante", 
				column = @Column(name = "IMPRIMANTE_ID")),
		...
		@AttributeOverride(name = "modele", 
				column = @Column(name = "MODELE_ID")) })
	public AffectationImprimantePK getPk() {
		return pk;
	}

	public void setPk(AffectationImprimantePK p) {
		this.pk = p;
	}
	...
	public boolean equals(Object obj) {
		...
		AffectationImprimante test = (AffectationImprimante) obj;
	...
	public AffectationImprimante clone() {
		AffectationImprimante clone = new AffectationImprimante();
