...
/**
 * Classe parente deleguee à la maladie qui permet par heritage d'associer
...
public abstract class AbstractMaladieDelegate extends TKDelegateObject<Maladie>
{
   ...
   public AbstractMaladieDelegate(){}

   @Id
   @Column(name = "MALADIE_DELEGATE_ID", unique = true, nullable = false)
   @GeneratedValue(generator = "autoincrement")
   @GenericGenerator(name = "autoincrement", strategy = "increment")
   public Integer getMaladieDelegateId(){
      return maladieDelegateId;
   }
   ...
   @Override
   public void setDelegator(final Maladie _d){
      this.delegator = _d;
   }
