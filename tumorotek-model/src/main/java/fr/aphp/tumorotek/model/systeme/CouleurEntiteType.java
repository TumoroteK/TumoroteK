...
public class CouleurEntiteType implements Serializable
{
   ...
   public void setCouleurEntiteTypeId(final Integer cId){
   ...
   public void setEchantillonType(final EchantillonType eType){
   ...
   public void setProdType(final ProdType pType){
      this.prodType = pType;
   }
   ...
   public boolean equals(final Object obj){
      ...
      final CouleurEntiteType test = (CouleurEntiteType) obj;
      // 2 CouleurEntiteType sont egales si toutes leurs valeurs le sont
      return ((this.banque == test.banque || (this.banque != null && this.banque.equals(test.banque)))
         && (this.echantillonType == test.echantillonType
            || (this.echantillonType != null && this.echantillonType.equals(test.echantillonType)))
         && (this.prodType == test.prodType || (this.prodType != null && this.prodType.equals(test.prodType))));
   }
   ...
   public CouleurEntiteType clone(){
      final CouleurEntiteType clone = new CouleurEntiteType();
