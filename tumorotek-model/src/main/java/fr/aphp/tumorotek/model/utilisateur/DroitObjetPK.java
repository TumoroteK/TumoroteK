...
public class DroitObjetPK implements Serializable {
	...
	public DroitObjetPK(Profil prof, Entite ent, OperationType type) {
		this.profil = prof;
		this.entite = ent;
	...
	public boolean equals(Object obj) {
		...
		DroitObjetPK test = (DroitObjetPK) obj;
		return ((this.entite == test.entite || (this.entite != null 
						&& this.entite.equals(test.entite))) 
				&& (this.operationType == test.operationType 
						|| (this.operationType != null 
						&& this.operationType.
						equals(test.operationType))) 
