 ...
 * accepté les termes.
 **/
package fr.aphp.tumorotek.model.coeur.patient.delegate;
 ...
 */
@Entity
@Table(name = "PATIENT_BTO")
public class PatientBTO extends AbstractPatientDelegate implements TKValidableObject
{
