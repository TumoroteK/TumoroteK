...
@NamedQueries(value = {
		@NamedQuery(name = "ChampLigneEtiquette.findByLigneEtiquette", 
			query = "SELECT c FROM ChampLigneEtiquette c " 
				+ "WHERE c.ligneEtiquette = ?1 " 
				+ "ORDER BY c.ordre"),
		@NamedQuery(name = "ChampLigneEtiquette.findByLigneEtiquetteAndEntite", 
			query = "SELECT c FROM ChampLigneEtiquette c " 
				+ "WHERE c.ligneEtiquette = ?1 " 
				+ "AND c.entite = ?2 " 
				+ "ORDER BY c.ordre")
...
public class ChampLigneEtiquette implements Serializable {
	...
	@Id
	@Column(name = "CHAMP_LIGNE_ETIQUETTE_ID", 
	...
	public void setChampLigneEtiquetteId(Integer id) {
	...
	public void setExpReg(String e) {
		this.expReg = e;
	}
	...
	public boolean equals(Object obj) {
		...
		ChampLigneEtiquette test = (ChampLigneEtiquette) obj;
		return ((this.ordre == test.ordre || (this.ordre != null 
				&& this.ordre.equals(test.ordre))) 
		&& (this.ligneEtiquette == test.ligneEtiquette 
				|| (this.ligneEtiquette != null 
				&& this.ligneEtiquette.equals(test.ligneEtiquette)))
		&& (this.champ == test.champ 
				|| (this.champ != null 
				&& this.champ.equals(test.champ)))
	...
	public String toString() {
		if (this.ligneEtiquette != null && this.ordre != null
				&& this.champ != null && this.entite != null) {
			return "{" + this.ordre + ", " 
				+ this.ligneEtiquette.getOrdre() 
				+ "(LigneEtiquette) " 
				+ this.entite.getNom() + "(Entite)}";
		} else {
	...
	public ChampLigneEtiquette clone() {
		ChampLigneEtiquette clone = new ChampLigneEtiquette();
