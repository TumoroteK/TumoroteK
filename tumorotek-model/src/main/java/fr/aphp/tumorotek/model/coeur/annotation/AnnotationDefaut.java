...
@NamedQueries(value = {@NamedQuery(name = "AnnotationDefaut.findByChamp", 
				query = "SELECT a FROM AnnotationDefaut a WHERE "
					+ "a.champAnnotation = ?1 ORDER BY a.annotationDefautId"),
			@NamedQuery(name = "AnnotationDefaut.findByExcludedId", 
					query = "SELECT a FROM AnnotationDefaut a WHERE "
					+ "a.annotationDefautId != ?1") })
public class AnnotationDefaut extends AnnotationCommon implements Serializable {
	...
	public void setAnnotationDefautId(Integer id) {
	...
	public boolean equals(Object obj) {
		...
		AnnotationDefaut test = (AnnotationDefaut) obj;
		
		if (this.annotationDefautId != null 
				&& this.annotationDefautId.equals(test.annotationDefautId)) {
			return true;
		}
	...
	public AnnotationDefaut clone() {
		AnnotationDefaut clone = new AnnotationDefaut();
