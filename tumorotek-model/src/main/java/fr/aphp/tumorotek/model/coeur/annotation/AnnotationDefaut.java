...
public class AnnotationDefaut extends AnnotationCommon implements Serializable {
	...
	/**
	 * Override methode de AnnotationValeur car la cascade differe. En effet, les
	 * valeurs par defaut peuvent être enregistrees en même temps que les items,
	 * contrairement aux valeurs qui sont assignees aux objets ultérieurement.
	 */
	@Override
	@ManyToOne
	...
	/**
	 * Override methode de AnnotationValeur car la cascade differe. En effet, les
	 * valeurs par defaut peuvent être enregistrees en même temps que les champs,
	 * contrairement aux valeurs qui sont assignees aux objets ultérieurement.
	 */
	@Override
	@ManyToOne
	 ...
	 * le champ annotation auxqelles et la banque sont attribuees. La propriete item
	 * intervient pour differencier les valeurs defaut lors d'une selection
	 * multiple.
	 * 
	...
	/**
	 * Le hashcode est calculé sur les references vers le champ annotation, l'item
	 * auxquels la valeur est attribuee.
	 * 
