...
public class Fichier implements java.io.Serializable {
	 ...
	 * @param p .
	 */
	public Fichier(Integer id, String p) {
		this.fichierId = id;
		this.path = p;
	}
	...
	public void setFichierId(Integer fId) {
		this.fichierId = fId;
	}
	...
	public void setAnnotationValeur(AnnotationValeur val) {
		this.valeur = val;
	}
	...
	public boolean equals(Object obj) {
		...
		Fichier test = (Fichier) obj;
		return (((this.path != null 
				&& this.path.equals(test.path))
					|| this.path == test.path)
				&& (this.echantillon == test.echantillon 
					|| (this.echantillon != null 
					&& this.echantillon.equals(test.echantillon))) 
				&& (this.valeur == test.valeur || (this.valeur != null 
						&& this.valeur.equals(test.valeur)))
				);
	}
	...
	@Transient
	public void setTKFileSettableObject(TKFileSettableObject f) {
		if (f != null) {
