...
@NamedQueries(value = {@NamedQuery(name = "ObjetStatut.findByStatut", 
			query = "SELECT o FROM ObjetStatut o WHERE o.statut like ?1"),
		@NamedQuery(name = "ObjetStatut.findByOrder", 
...
public class ObjetStatut implements java.io.Serializable {
	...
	private List<Retour> retours = new ArrayList<Retour>();
	 ...
	 * @param s .
	 */
	public ObjetStatut(Integer id, String s) {
	...
	public void setObjetStatutId(Integer id) {
		this.objetStatutId = id;
	}
	...
	public void setRetours(List<Retour> r) {
		this.retours = r;
	}
	...
	public boolean equals(Object obj) {
		...
		ObjetStatut test = (ObjetStatut) obj;
		if (this.statut == null) {
