...
@NamedQueries(value = {
		@NamedQuery(name = "CessionExamen.findByExamen", 
			query = "SELECT c FROM CessionExamen c WHERE c.examen like ?1"),
		@NamedQuery(name = "CessionExamen.findByExamenEn", 
			query = "SELECT c FROM CessionExamen c " 
				+ "WHERE c.examenEn like ?1"),
		@NamedQuery(name = "CessionExamen.findByExcludedId", 
			query = "SELECT c FROM CessionExamen c " 
				+ "WHERE c.cessionExamenId != ?1"),
		@NamedQuery(name = "CessionExamen.findByOrder", 
				query = "SELECT c FROM CessionExamen c "
					+ "WHERE c.plateforme = ?1 ORDER BY c.examen") })
public class CessionExamen implements Serializable, TKThesaurusObject {
	...
	public void setCessionExamenId(Integer id) {
	...
	public void setExamenEn(String exEn) {
		this.examenEn = exEn;
	}
	...
	public boolean equals(Object obj) {
		...
		CessionExamen test = (CessionExamen) obj;
		return ((this.examen == test.examen || (this.examen != null 
				&& this.examen.equals(test.examen)))
