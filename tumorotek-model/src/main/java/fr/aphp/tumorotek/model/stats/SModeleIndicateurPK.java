...
public class SModeleIndicateurPK implements Serializable {
    ...
    public SModeleIndicateurPK(SModele m, Indicateur i) {
    	this.sModele = m;
    	this.indicateur = i;
    }
	...
	public void setsModele(SModele sModele) {
	...
	public boolean equals(Object obj) {
		...
		SModeleIndicateurPK test = (SModeleIndicateurPK) obj;
		return (((this.sModele != null 
				&& (this.sModele.equals(test.sModele))
					|| this.sModele == test.sModele) 
			&& ((this.indicateur != null 
					&& this.indicateur.equals(test.indicateur))
						|| this.indicateur == test.indicateur)));
	}
