...
public class VisitePrelevement implements Serializable
{
   ...
   public VisitePrelevement(Integer nbPrelevementMin, Integer nbPrelevementMax, Parametrage parametrage){
      super();
   ...
   public boolean equals(Object obj) {
      if (obj == this) {
        ...
        VisitePrelevement visPrel = (VisitePrelevement) obj;

        return Objects.equals(parametrage, visPrel.getParametrage());
   }
   ...
   @Override
    public int hashCode() {
        final int prime = 31;
        int result = 1;
      result = prime * result + ((parametrage == null) ? 0 : parametrage.hashCode());
      return result;
   }
