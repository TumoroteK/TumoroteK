...
public class ScanTube implements java.io.Serializable {
	...
	public void setScanTubeId(Integer _i) {
		this.scanTubeId = _i;
	}
	...
	public boolean equals(Object obj) {
		...
		ScanTube test = (ScanTube) obj;
		return ((this.scanTerminale == test.scanTerminale 
				|| (this.scanTerminale != null 
				&& this.scanTerminale.equals(test.scanTerminale)))
			&& (this.cell == test.cell 
				|| (this.cell != null 
				&& this.cell.equals(test.cell)))
		);
	}
