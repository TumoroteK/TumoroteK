...
@NamedQueries(value = {@NamedQuery(name = "TableCodage.findByNom",
...
public class TableCodage implements Serializable {
	...
	private Set<CodeAssigne> codeAssignes = new HashSet<CodeAssigne>();
	...
	public void setTableCodageId(Integer id) {
	...
	public void setCodeAssignes(Set<CodeAssigne> codes) {
...
//	}
	...
	public boolean equals(Object obj) {
		...
		TableCodage test = (TableCodage) obj;
		if (this.nom != null) {
	...
	public TableCodage clone() {
		TableCodage clone = new TableCodage();
