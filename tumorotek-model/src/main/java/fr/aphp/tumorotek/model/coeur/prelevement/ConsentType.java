...
@NamedQueries(value = {@NamedQuery(name = "ConsentType.findByType", 
			query = "SELECT c FROM ConsentType c WHERE c.type like ?1"),
		@NamedQuery(name = "ConsentType.findByExcludedId", 
			query = "SELECT c FROM ConsentType c " 
				+ "WHERE c.consentTypeId != ?1"),
		@NamedQuery(name = "ConsentType.findByOrder", 
			query = "SELECT c FROM ConsentType c "
				+ "WHERE c.plateforme = ?1 ORDER BY c.type") })
public class ConsentType implements Serializable, TKThesaurusObject, 
												Comparable<ConsentType> {
	...
	public void setConsentTypeId(Integer id) {
	...
	public boolean equals(Object obj) {
		...
		ConsentType test = (ConsentType) obj;
	...
	@Override
	public int compareTo(ConsentType arg0) {
