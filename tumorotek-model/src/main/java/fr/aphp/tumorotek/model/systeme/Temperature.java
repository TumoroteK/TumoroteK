...
@NamedQueries(value = {@NamedQuery(name = "Temperature.findByExcludedId", 
		query = "SELECT t FROM Temperature t " 
			+ "WHERE t.temperatureId != ?1") })
public class Temperature implements Serializable {
	...
	public void setTemperatureId(Integer id) {
	...
	public boolean equals(Object obj) {
		...
		Temperature test = (Temperature) obj;
		return ((this.temperature == test.temperature 
				|| (this.temperature != null 
				&& this.temperature.equals(test.temperature))) 
		);
	}
