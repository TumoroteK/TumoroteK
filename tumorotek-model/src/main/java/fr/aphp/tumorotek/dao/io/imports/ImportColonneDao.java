 ...
 * @version 2.0
 */
public interface ImportColonneDao 
	extends GenericDaoJpa<ImportColonne, Integer> {
	 ...
	 * @return Liste d'ImportColonnes.
	 */
	List<ImportColonne> findByTemplateAndEntite(ImportTemplate importTemplate,
			Entite entite);
	 ...
	 * @return Liste d'ImportColonnes.
	 */
	List<ImportColonne> findByTemplateAndDataType(ImportTemplate importTemplate,
			DataType dataType);
	 ...
	 */
	List<ImportColonne> findByExcludedIdWithTemplate(Integer excludedId,
	 ...
	 * @return Liste d'ImportColonnes.
	 */
	List<ImportColonne> findByTemplateAndThesaurus(
			ImportTemplate importTemplate);
	 ...
	 * @return Liste d'ImportColonnes.
	 */
	List<ImportColonne> findByTemplateAndAnnotationEntite(
			ImportTemplate importTemplate,
			Entite entite);
	 ...
	 * @return Liste d'ImportColonnes.
	 */
	List<ImportColonne> findByTemplateAndAnnotationDatatype(
			ImportTemplate importTemplate,
			DataType dataType);
	 ...
	 */
	List<String> findByTemplateWithOrderSelectNom(
			ImportTemplate importTemplate);
	 ...
	 */
	List<String> findByExcludedIdWithTemplateSelectNom(
			Integer excludedId,
			ImportTemplate importTemplate);	
}
