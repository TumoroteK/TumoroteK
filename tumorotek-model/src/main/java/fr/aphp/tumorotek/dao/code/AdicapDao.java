...
public interface AdicapDao extends GenericDaoJpa<Adicap, Integer> {
	 ...
	 * @return une liste de codes Adicap.
	 */
	List<Adicap> findByAdicapGroupeAndCodeOrLibelle(AdicapGroupe groupe, 
	 ...
	 * @return une liste de codes Adicap.
	 */
	List<Adicap> findByAdicapParentAndCodeOrLibelle(Adicap parent, 
			String codeOrLibelle);
	 ...
	 * @return liste de codes Adicap
	 */
	List<Adicap> findByDicoAndCodeOrLibelle(AdicapGroupe grp, 
											String codeOrLibelle);
}
