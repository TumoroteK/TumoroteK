...
public interface ConsultationIntfDao extends GenericDaoJpa<ConsultationIntf, Integer> {
	 ...
	 */
	List<ConsultationIntf> findByUtilisateurInDates(Utilisateur u, Calendar date1,
			Calendar date2);
	 ...
	 * @return Une liste de consultations.
	 */
	List<ConsultationIntf> findByEmetteurInDates(String e, Calendar date1,
			Calendar date2);
	 ...
	 * @return Une liste de consultations.
	 */
	List<ConsultationIntf> findByUtilisateurEmetteurInDates(Utilisateur u, 
