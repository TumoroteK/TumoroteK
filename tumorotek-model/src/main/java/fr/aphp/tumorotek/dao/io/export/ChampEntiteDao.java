...
public interface ChampEntiteDao extends GenericDaoJpa<ChampEntite, Integer> {
	 ...
	 * @return Liste de ChampEntités.
	 */
	List<ChampEntite> findByEntiteAndImport(Entite entite, 
			Boolean canImport);
	 ...
	 * @return Liste de ChampEntités.
	 */
	List<ChampEntite> findByEntiteImportObligatoire(Entite entite, 
			Boolean canImport, Boolean isNullable);
	 ...
	 * @since 2.0.12
	 */
	List<ChampEntite> findByImportTemplateAndEntite(ImportTemplate template, 
																Entite e);
}
