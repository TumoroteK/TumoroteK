 ...
 *
 */
public interface TableAnnotationDao 
					extends GenericDaoJpa<TableAnnotation, Integer> {
	 ...
	 * @return Liste de TableAnnotation.
	 */
	List<TableAnnotation> findByEntiteBanqueAndCatalogue(
			Entite entite, Banque banque, String catalogue);
