...
public interface TerminaleDao extends GenericDaoJpa<Terminale, Integer> {
	 ...
	 */
	List<Terminale> findByEnceinteAndPositionExcludedId(Enceinte enceinte,
	 ...
	 * @return Liste de Terminales.
	 */
	List<Terminale> findByEnceinteAndPosition(Enceinte enceinte,
			Integer position);
	 ...
	 * @return Liste de Terminales.
	 */
	List<Terminale> findByEnceinteAndNom(Enceinte enceinte,
			String nom);
	 ...
	 */
	List<Terminale> findByExcludedIdEnceinte(Integer terminaleId,
			Enceinte enceinte);
	 ...
	 * @return Liste de terminales.
	 */
	List<Terminale> findByTwoExcludedIdsWithEnceinte(Integer terminaleId,
			Integer terminaleId2, Enceinte enceinte);
