 ...
 *
 */
public interface CodeUtilisateurDao 
	extends GenericDaoJpa<CodeUtilisateur, Integer> {
	 ...
	 */
	List<CodeUtilisateur> findByTranscodage(TableCodage table, Integer codeId, 
															List<Banque> banks);
}
