 ...
 *
 */
public interface DossierExterneDao extends 
	GenericDaoJpa<DossierExterne, Integer> {
	 ...
	 * @return Une liste de dossiers.
	 */
	List<DossierExterne> findByEmetteurAndIdentification(Emetteur emetteur,
	 ...
	 * @return Une liste de dossiers.
	 */
	List<DossierExterne> findByEmetteurInListAndIdentification(
			List<Emetteur> emetteurs, String identification);
	
	
	List<String> findByEmetteurInListSelectIdentification(
