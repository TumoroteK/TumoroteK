 ...
 *
 */
public interface CleImpressionTemplateDao extends GenericDaoJpa<CleImpressionTemplate, CleImpressionTemplatePK>
{
    ...
    */
   List<CleImpressionTemplate> findByTemplate(Template template);
    ...
    * @return une liste de BlocImpressionTemplates.
    */
   List<CleImpressionTemplate> findByExcludedPK(CleImpressionTemplatePK pk);
