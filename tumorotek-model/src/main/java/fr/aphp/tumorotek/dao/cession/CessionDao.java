 ...
 *
 */
public interface CessionDao extends 
	GenericDaoJpa<Cession, Integer> {
	 ...
	 * @return une liste de Cessions.
	 */
	List<Integer> findByNumeroWithBanqueReturnIds(
			String numero, List<Banque> banques);
	 ...
	 * @return Liste de cessions.
	 */
	List<Integer> findByCessionStatutAndBanqueReturnIds(String statut, 
												List<Banque> banque);
	 ...
	 * @return Liste de cessions.
	 */
	List<Integer> findByEtatIncompletAndBanquesReturnIds(boolean etat, 
											List<Banque> banques);
