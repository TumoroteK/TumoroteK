...
public interface ProdDeriveDao extends GenericDaoJpa<ProdDerive, Integer> {
	 ...
	 * @return Liste de produits dérivés.
	 */
	List<Integer> findByCodeOrLaboWithBanqueReturnIds(
	 ...
	 * @return Liste de produits dérivés.
	 */
	List<ProdDerive> findByDateTransformationAfterDateWithBanque(
	 ...
	 * @return Une liste de ProdDerives.
	 */
	List<ProdDerive> findByParentAndType(Integer objetId,
			Entite entite, String prodType);
	 ...
	 * @return Liste de ProdDerives.
	 */
	List<Integer> findByEchantillonPatientNomReturnIds(
			String nom, Banque banque);
	 ...
	 * @return Liste de ProdDerives.
	 */
	List<Integer> findByPrelevementPatientNomreturnIds(
			String nom, Banque banque);
	 ...
	 * @return Liste de ProdDerives.
	 */
	List<Integer> findByEchantillonPatientNomInListReturnIds(
			List<String> criteres, List<Banque> banques);
	 ...
	 * @return Liste de ProdDerives.
	 */
	List<Integer> findByPrelevementPatientNomInListreturnIds(
			List<String> criteres, List<Banque> banques);
