 ...
 *
 */
public interface ChampLigneEtiquetteDao extends 
	GenericDaoJpa<ChampLigneEtiquette, Integer> {
	 ...
	 */
	List<ChampLigneEtiquette> findByLigneEtiquette(
	 ...
	 * @return Une liste de ChampLigneEtiquettes.
	 */
	List<ChampLigneEtiquette> findByLigneEtiquetteAndEntite(
