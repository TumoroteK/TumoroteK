...
public interface NonConformiteDao 
	extends GenericDaoJpa<NonConformite, Integer> {
	 ...
	 */
	List<NonConformite> findByTypeAndPf(ConformiteType conformiteType,
	 ...
	 * @return Une liste de NonConformites.
	 */
	List<NonConformite> findByTypePfAndNom(ConformiteType conformiteType,
			Plateforme plateforme, String nom);
