...
public interface OperationDao extends GenericDaoJpa<Operation, Integer> {
	 ...
	 * @return Liste des Operation.
	 */
	List<Operation> findByObjetIdAndEntiteForHistorique(
			Integer objetId, Entite entite);
	 ...
	 * @return Liste des Operation.
	 */
	List<Operation> findByObjetIdEntiteAndOperationType(
			Integer objetId, Entite entite, 
	 ...
	 * @return Liste d'opérations.
	 */
	List<Operation> findByBetweenDates(Calendar date1,
			Calendar date2);
