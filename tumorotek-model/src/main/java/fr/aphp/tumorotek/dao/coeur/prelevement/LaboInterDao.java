 ...
 *
 */
public interface LaboInterDao extends 
	GenericDaoJpa<LaboInter, Integer> {
	 ...
	 * @return Liste d'ordres de labos intermediaires.
	 */
	List<Integer> findByPrelevementWithOnlyOrderAndExcludedId(
			Prelevement prelevement, Integer laboInterId);
}
