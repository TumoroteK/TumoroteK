 ...
 *
 */
public interface ProfilUtilisateurDao extends 
	GenericDaoJpa<ProfilUtilisateur, ProfilUtilisateurPK> {
	 ...
	 */
	List<ProfilUtilisateur> findByUtilisateurProfil(
	 ...
	 * @return Liste ordonnée de ProfilUtilisateurs.
	 */
	List<ProfilUtilisateur> findByUtilisateurBanque(
	 ...
	 * @return Liste ordonnée de ProfilUtilisateurs.
	 */
	List<ProfilUtilisateur> findByBanqueProfil(
