 ...
 *
 */
public interface TableAnnotationTemplateDao extends 
	GenericDaoJpa<TableAnnotationTemplate, TableAnnotationTemplatePK> {
	 ...
	 * @return une liste de TableAnnotationTemplates.
	 */
	List<TableAnnotationTemplate> findByExcludedPK(
