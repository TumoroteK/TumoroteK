...
public interface PrelevementDao extends GenericDaoJpa<Prelevement, Integer> {
	 ...
	 * @return une liste de prelevements.
	 */
	List<Integer> findByCodeOrNumLaboWithBanqueReturnIds(
	 ...
	 * @return une liste de prelevement.
	 */
	List<Prelevement> findByDatePrelevementAfterDateWithBanque(
...
//	List<Prelevement> findByDateCongelationAfterDate(Date date);
	 ...
	 * @return compte
	 */
	List<Long> findCountEclConsentByDates(List<ConsentType> types, 
													Calendar cal1, 
													Calendar cal2, 
												List<Banque> banks);
	 ...
	 * @return compte
	 */
	List<Prelevement> findByOrganeByDates(List<String> codeOrLibelle, 
													Calendar cal1, 
													Calendar cal2, 
												List<Banque> banks);
	 ...
	 */
	List<Prelevement> findByOrganeByDatesConsent(List<String> codeOrLibelle, 
													Calendar cal1, 
													Calendar cal2, 
												List<Banque> banks,
	 ...
	 * @return liste de prélèvements
	 */
	List<Prelevement> findAssociatePrelsOfType(Maladie maladie,
												List<Nature> nats, 
												List<Banque> banks);	
	 ...
	 * @return une liste de prelevements.
	 */
	List<Prelevement> findByMaladieAndNature(Maladie mal, String nature, 
														Calendar date);
	 ...
	 * @return Liste de prélèvements.
	 */
	List<Prelevement> findByCodesAndBanquesInList(
			List<String> codes,
			List<Banque> banques);
	 ...
	 * @return Liste de prélèvements.
	 */
	List<Prelevement> findByComDiag(String libelle,
								List<Banque> banques);
	 ...
	 * @return une liste d'ids.
	 */
	List<Integer> findByCodeOrNumLaboInListWithBanque(
			List<String> criteres, List<Banque> banques);
