...
/**
 * 
 * Interface pour le DAO du bean de domaine DroitObjet.
 ...
 *
 */
public interface DroitObjetDao extends 
	GenericDaoJpa<DroitObjet, DroitObjetPK> {
	 ...
	 * @return Liste ordonnée de DroitObjets.
	 */
	List<DroitObjet> findByProfilOperation(Profil profil, 
