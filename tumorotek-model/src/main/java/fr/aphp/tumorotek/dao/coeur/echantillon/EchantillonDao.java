...
public interface EchantillonDao extends GenericDaoJpa<Echantillon, Integer> {
	 ...
	 * @return une liste d'échantillons.
	 */
	List<Integer> findByCodeWithBanqueReturnIds(
			String code, Banque banque);
	 ...
	 * @return une liste d'échantillons.
	 */
	List<Echantillon> findByDateStockAfterDateWithBanque(
...
//	List<Echantillon> findByCrAnapath(Fichier crAnapath);
	 ...
	 * @return une liste d'échantillons.
	 */
	List<Echantillon> findByPrelevementAndStatut(Prelevement prelevement,
			ObjetStatut statut);
	 ...
	 * @return une liste de codes d'échantillons.
	 */
	List<String> findByBanqueStatutSelectCode(
			Banque banque, ObjetStatut objetStatut);
	 ...
	 * @return une liste de codes d'échantillons.
	 */
	List<String> findByBanqueInListStatutSelectCode(
			List<Banque> banques, ObjetStatut objetStatut);
	 ...
	 * @return Une liste de Echantillons.
	 */
	List<Integer> findByPatientNomReturnIds(String nom, 
			Banque banque);
	 ...
	 */
	List<Long> findCountSamplesByDates(Calendar d1, Calendar d2, 
													List<Banque> banks);
	 ...
	 * @return Integer compte sous la forme d'une liste
	 */
	List<Long> findCountSamplesByDatesExt(Calendar d1, Calendar d2, 
								List<Banque> banks, List<Etablissement> exts);
	 ...
	 * @return compte
	 */
	List<Long> findCountEchansByCessTypes(CessionType cType, Date d1, 
											Date d2, List<Banque> banks);
...
<<<<<<< .working
	 ...
	 */
	List<Echantillon> findAssociateEchansOfType(Maladie maladie, 
												List<EchantillonType> types,
												List<Banque> banks,
	 ...
	 * @return Une liste de Echantillons.
	 */
	List<Echantillon> findByMaladieAndType(Maladie maladie, 
	 ...
	 */
	List<Integer> findByPatientNomOrNipInList(
	 ...
	 * @version 2.1
	 */
	List<Object[]> findByCodeInListWithBanque(
			List<String> criteres, List<Banque> banques);
