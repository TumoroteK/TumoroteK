 ...
 *
 */
public interface ObjetNonConformeDao 
	extends GenericDaoJpa<ObjetNonConforme, Integer> {
	 ...
	 */
	List<ObjetNonConforme> findByObjetAndEntite(
			Integer objetId,
			Entite entite);
	 ...
	 * @return Une liste de ObjetNonConformes.
	 */
	List<ObjetNonConforme> findByObjetEntiteAndType(Integer objetId,
			Entite entite,
			ConformiteType type);
	 ...
	 */
	List<ObjetNonConforme> findByNonConformite(
