...
public interface IncidentDao extends GenericDaoJpa<Incident, Integer> {
	 ...
	 */
	List<Incident> findByExcludedIdAndConteneur(
			Integer incidentId, Conteneur conteneur);
	 ...
	 * @since 2.0.10
	 */
	List<Incident> findByExcludedIdAndEnceinte(Integer incidentId, 
													Enceinte enceinte);
	 ...
	 * @since 2.0.10
	 */
	List<Incident> findByExcludedIdAndTerminale(Integer incidentId, 
													Terminale terminale);
