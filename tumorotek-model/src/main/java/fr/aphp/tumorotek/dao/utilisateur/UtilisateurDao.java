...
public interface UtilisateurDao extends GenericDaoJpa<Utilisateur, Integer> {
	 ...
	 * @return une liste d'utilisateurs.
	 */
	List<Utilisateur> findByLoginAndArchive(String login, 
	 ...
	 * @return une liste d'utilisateurs.
	 */
	List<Utilisateur> findByArchive(boolean archive, 
											List<Plateforme> pfs);
	 ...
	 * @return une liste d'utilisateurs.
	 */
	List<Utilisateur> findByOrderWithArchive(boolean archive, 
											List<Plateforme> pfs);
	 ...
	 * @return une liste d'utilisateurs.
	 */
	List<Utilisateur> findByLoginPassAndArchive(
			String login, String password, boolean archive);
