...
public interface PatientDao extends GenericDaoJpa<Patient, Integer> {
	 ...
	 * @return compte
	 */
	List<Long> findCountPrelevedByDatesSaisie(Calendar cal1, Calendar cal2, 
													List<Banque> banks);
	 ...
	 * @return compte
	 */
	List<Long> findCountPrelevedByDatesPrel(Calendar cal1, Calendar cal2, 
														List<Banque> banks);
	 ...
	 * @return compte
	 */
	List<Long> findCountPrelevedByDatesSaisieExt(Calendar cal1, Calendar cal2, 
							List<Banque> banks, List<Etablissement> etabs);
	 ...
	 * @return compte
	 */
	List<Long> findCountPrelevedByDatesPrelExt(Calendar cal1, Calendar cal2, 
							List<Banque> banks, List<Etablissement> etabs);
	 ...
	 */
	List<Integer> findByNomInList(List<String> criteres,
			List<Banque> banques);
	 ...
	 * @return une liste d'ids.
	 */
	List<Integer> findByNipInList(List<String> criteres, 
			List<Banque> banques);
