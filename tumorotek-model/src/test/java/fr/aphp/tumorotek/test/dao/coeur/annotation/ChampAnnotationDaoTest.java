...
/**
 *
 * Classe de test pour le DAO ChampAnnotationDao et le bean du domaine
 * ChampAnnotation. Classe de test créée le 28/01/10.
 *
...
public class ChampAnnotationDaoTest extends AbstractDaoTest {
	...
	public void testToString() throws ParseException {
		...
		c2.setTableAnnotation(tableAnnotationDao.findById(1).get());
		assertTrue(c2.toString().equals("{Empty ChampAnnotation}"));
	...
	public void testFindByTable() {
		TableAnnotation t = tableAnnotationDao.findById(3).get();
		List<ChampAnnotation> champs = champAnnotationDao.findByTable(t);
		assertTrue(champs.size() == 5);
		// verfie l'ordre
		assertTrue(champs.get(0).equals(champAnnotationDao.findById(4).get()));
		assertTrue(champs.get(1).equals(champAnnotationDao.findById(5).get()));
		assertTrue(champs.get(2).equals(champAnnotationDao.findById(7).get()));
		assertTrue(champs.get(3).equals(champAnnotationDao.findById(9).get()));
		assertTrue(champs.get(4).equals(champAnnotationDao.findById(11).get()));
		t = tableAnnotationDao.findById(1).get();
		champs = champAnnotationDao.findByTable(t);
		assertTrue(champs.size() == 2);
		assertTrue(champs.get(1).equals(champAnnotationDao.findById(13).get()));
		t = tableAnnotationDao.findById(6).get();
		champs = champAnnotationDao.findByTable(t);
		assertTrue(champs.size() == 2);
	...
	public void testCrudChampAnnotation() {
		...
		champ.setTableAnnotation(tableAnnotationDao.findById(6).get());
		...
		final ChampAnnotation champ2 = champAnnotationDao.findById(maxId).get();
		...
		assertTrue(champ2.getTableAnnotation().equals(tableAnnotationDao.findById(6).get()));
		...
		assertTrue(champAnnotationDao.findById(maxId).get().getNom().equals("testAnno2"));
		assertTrue(champAnnotationDao.findById(maxId).get().getOrdre() == 4);
		assertFalse(champAnnotationDao.findById(maxId).get().getCombine());
	...
	public void testFindChampsFichiersByTable() {
		final TableAnnotation t = tableAnnotationDao.findById(7).get();
		DataType dt = dataTypeDao.findById(7).get();
	...
	public void testFindImportColonnesByChampAnnotation() {
		ChampAnnotation c = champAnnotationDao.findById(1).get();
		List<ImportColonne> res = champAnnotationDao.findImportColonnesByChampAnnotation(c);
		assertTrue(res.isEmpty());
		c = champAnnotationDao.findById(2).get();
	...
	public void testfindByImportTemplateAndEntite() {
		List<ChampAnnotation> chpA = champAnnotationDao
				.findByImportTemplateAndEntite(importTemplateDao.findById(1).get(), entiteDao.findById(2).get());
		assertTrue(chpA.size() == 5);
		assertTrue(chpA.contains(champAnnotationDao.findById(2).get()));
		assertTrue(chpA.contains(champAnnotationDao.findById(3).get()));
		assertTrue(chpA.contains(champAnnotationDao.findById(15).get()));
		assertTrue(chpA.contains(champAnnotationDao.findById(27).get()));
		assertTrue(chpA.contains(champAnnotationDao.findById(39).get()));
		chpA = champAnnotationDao.findByImportTemplateAndEntite(importTemplateDao.findById(1).get(),
				entiteDao.findById(1).get());
		assertTrue(chpA.size() == 0);
		chpA = champAnnotationDao.findByImportTemplateAndEntite(importTemplateDao.findById(1).get(),
				entiteDao.findById(3).get());
		assertTrue(chpA.size() == 1);
		assertTrue(chpA.contains(champAnnotationDao.findById(12).get()));
		chpA = champAnnotationDao.findByImportTemplateAndEntite(importTemplateDao.findById(2).get(),
				entiteDao.findById(2).get());
		assertTrue(chpA.size() == 0);
		chpA = champAnnotationDao.findByImportTemplateAndEntite(importTemplateDao.findById(1).get(), null);
		assertTrue(chpA.size() == 0);
		chpA = champAnnotationDao.findByImportTemplateAndEntite(null, entiteDao.findById(3).get());
		assertTrue(chpA.size() == 0);
	}
}
