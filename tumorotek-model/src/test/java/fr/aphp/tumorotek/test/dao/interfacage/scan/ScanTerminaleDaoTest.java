 ...
 * accepté les termes.
 **/
package fr.aphp.tumorotek.test.dao.interfacage.scan;
...
/**
 *
 * Classe de test pour le DAO ScanTerminaleDao et le bean du domaine
 * ScanTerminale.
 *
...
public class ScanTerminaleDaoTest extends AbstractDaoTest {
	...
	public void testCrudScanTerminale() throws Exception {
		...
		final ScanTerminale st1 = new ScanTerminale();
		final ScanDevice visionMate = scanDeviceDao.findById(1).get();
		st1.setName("BT1");
		...
		final List<String> codes = scanTerminaleDao.findTKObjectCodes(st1);
		...
		final ScanTerminale st2 = scanTerminaleDao.findById(st1.getScanTerminaleId()).get();
