 ...
 * accepté les termes.
 **/
package fr.aphp.tumorotek.test.dao.imprimante;
...
public class LigneEtiquetteDaoTest extends AbstractDaoTest {
	...
	public void testFindById() {
		final LigneEtiquette le = ligneEtiquetteDao.findById(1).get();
		assertNotNull(le);

		assertFalse(ligneEtiquetteDao.findById(100).isPresent());
	}
	...
	public void testFindByModele() {
		final Modele m2 = modeleDao.findById(2).get();
	...
	public void testCrud() throws Exception {
		...
		final LigneEtiquette le2 = ligneEtiquetteDao.findById(new Integer(8)).get();
		...
		assertTrue(ligneEtiquetteDao.findById(new Integer(8)).get().getOrdre() == 2);
		assertFalse(ligneEtiquetteDao.findById(new Integer(8)).get().getIsBarcode());

		// Test de la délétion
		ligneEtiquetteDao.deleteById(new Integer(8));
		assertFalse(ligneEtiquetteDao.findById(new Integer(8)).isPresent());
	}
	...
	public void testToString() {
		final LigneEtiquette l1 = ligneEtiquetteDao.findById(1).get();
