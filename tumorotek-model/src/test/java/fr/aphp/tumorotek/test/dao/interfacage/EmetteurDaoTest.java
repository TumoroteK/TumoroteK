...
public class EmetteurDaoTest extends AbstractDaoTest {
	...
	public void testCrud() throws Exception {
		...
		final Emetteur e2 = emetteurDao.findById(new Integer(4)).get();
		...
		emetteurDao.save(e2);
		assertTrue(emetteurDao.findById(new Integer(4)).get().getIdentification().equals("ID2"));
		assertTrue(emetteurDao.findById(new Integer(4)).get().getService().equals("SERV"));
		assertTrue(emetteurDao.findById(new Integer(4)).get().getObservations().equals("OBS"));
