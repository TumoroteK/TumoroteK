...
public class ConformiteTypeDaoTest extends AbstractDaoTest
{
   ...
   public void testReadAll(){
      final List<ConformiteType> liste = conformiteTypeDao.findAll();
   ...
   public void testFindByEntiteAndType(){
      List<ConformiteType> liste = conformiteTypeDao.findByEntiteAndType("Arrivee", entiteDao.findById(2));
   ...
   public void testCrud() throws Exception{
      ...
      final ConformiteType c2 = conformiteTypeDao.findById(id);
   ...
   public void testHashCode(){
      final String nom = "NOM";
      final Entite e1 = entiteDao.findById(2);
      final ConformiteType c1 = new ConformiteType();
      c1.setConformiteType(nom);
      c1.setEntite(e1);
      final ConformiteType c2 = new ConformiteType();
   ...
   public void testToString(){
      final ConformiteType c1 = conformiteTypeDao.findById(1);
