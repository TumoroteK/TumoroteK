...
public class EchanQualiteDaoTest extends AbstractDaoTest {
	...
	public void testReadAllEchanQualites() {
		List<EchanQualite> qualites = echanQualiteDao.findAll();
	...
	public void testFindByOrder() {
		...
		List< ? extends TKThesaurusObject> list = 
								echanQualiteDao.findByOrder(pf);
	...
	public void testFindByQualite() {
		List<EchanQualite> qualites = echanQualiteDao.
				findByQualite("MELANGE MO");
	...
	public void testFindByExcludedId() {
		...
		EchanQualite qualite = liste.get(0);
	...
	public void testCrudEchanQualite() throws Exception {
		...
		EchanQualite e = new EchanQualite();
		...
		EchanQualite e2 = echanQualiteDao.findById(new Integer(4));
		assertNotNull(e2);
		assertTrue(e2.getEchanQualite().equals("MELANGE"));
		e2.setEchanQualite(updatedNom);
		echanQualiteDao.updateObject(e2);
		assertTrue(echanQualiteDao.findById(new Integer(4)).
				getEchanQualite().equals(updatedNom));
	...
	public void testEquals() {
		...
		EchanQualite e1 = new EchanQualite();
		e1.setEchanQualite(qualite);
		EchanQualite e2 = new EchanQualite();
	...
	public void testHashCode() {
		String qualite = "Qualite";
		EchanQualite e1 = new EchanQualite(1, qualite);
		e1.setEchanQualite(qualite);
		EchanQualite e2 = new EchanQualite(2, qualite);
		e2.setEchanQualite(qualite);
		EchanQualite e3 = new EchanQualite(3, null);
	...
	public void testToString() {
		EchanQualite qual1 = echanQualiteDao.findById(1);
		assertTrue(qual1.toString().
				equals("{" + qual1.getEchanQualite() + "}"));
		
		EchanQualite qual2 = new EchanQualite();
