...
public class BanqueDaoTest extends AbstractDaoTest {
	...
	private String updatedNom = "Banque mise a jour";
	...
	public void testFindByOrder() {
		List<Banque> list = banqueDao.findByOrder();
	...
	public void testFindByAutoriseCrossPatient() {
		List<Banque> banques = banqueDao.findByAutoriseCrossPatient(true);
	...
	public void testFindByArchive() {
		List<Banque> banques = banqueDao.findByArchive(false);
	...
	public void testFindByIdWithFetch() {
		List<Banque> banques = banqueDao.findByIdWithFetch(3);
	...
	public void testCrudBanque() throws Exception {
		Banque b = new Banque();
		Collaborateur c = collaborateurDao.findById(1);
		Service s2 = serviceDao.findById(2);
		Contexte co = contexteDao.findById(1);
		Plateforme p = plateformeDao.findById(1);
		Couleur coul1 = couleurDao.findById(1);
		Couleur coul2 = couleurDao.findById(2);
		...
		Banque b2 = banqueDao.findById(new Integer(5));
	...
	public void testClone() {
		...
		assertTrue(c1.getAutoriseCrossPatient() 
				== c2.getAutoriseCrossPatient());
		...
		assertTrue(c1.getEchantillonCouleur()
									.equals(c2.getEchantillonCouleur()));
		assertTrue(c1.getProdDeriveCouleur().equals(c2.getProdDeriveCouleur()));
		
		if (c1.getAffectationImprimantes() != null) {
			assertTrue(c1.getAffectationImprimantes()
					.equals(c2.getAffectationImprimantes()));
		} else {
			assertNull(c2.getAffectationImprimantes());
		}
		
		if (c1.getAnnotationDefauts() != null) {
			assertTrue(c1.getAnnotationDefauts()
		...
		if (c1.getNumerotations() != null) {
			assertTrue(c1.getNumerotations()
					.equals(c2.getNumerotations()));
		} else {
			assertNull(c2.getNumerotations());
		}
		
		if (c1.getTemplates() != null) {
			assertTrue(c1.getTemplates()
					.equals(c2.getTemplates()));
		} else {
			assertNull(c2.getTemplates());
		}
		if (c1.getCatalogues() != null) {
			assertTrue(c1.getCatalogues()
					.equals(c2.getCatalogues()));
		} else {
	...
	public void testFindContexteCatalogues() {
		List<Catalogue> cats = banqueDao.findContexteCatalogues(1);
	...
	public void testFindByEntiteConsultByUtilisateur() {
		...
		List<Banque> banks = banqueDao
				.findByEntiteConsultByUtilisateur(utilisateur, prel, pf);
		...
		banks = banqueDao
			.findByEntiteConsultByUtilisateur(utilisateurDao.findById(4), prel, pf);
		assertTrue(banks.size() == 0);
	}
	...
	public void testFindByEntiteModifByUtilisateur() {
		...
		Entite prel = entiteDao.findById(2);
		List<Banque> banks = banqueDao
			.findByEntiteModifByUtilisateur(utilisateur, prel, pf);
		assertTrue(banks.size() == 2);
		assertTrue(banks.contains(banqueDao.findById(1)));
		assertTrue(banks.contains(banqueDao.findById(2)));
		...
		// autorise cross patient
		banks = banqueDao
			.findByEntiteModifByUtilisateur(utilisateurDao.findById(4), 
															prel, pf);
		assertTrue(banks.size() == 0);
	}
	...
	public void testFindByUtilisateurIsAdmin() {
		...
		Plateforme pf = plateformeDao.findById(1);
		List<Banque> banks = banqueDao
			.findByUtilisateurIsAdmin(utilisateur, pf);
		assertTrue(banks.size() == 2);
		assertTrue(banks.contains(banqueDao.findById(1)));
		assertTrue(banks.contains(banqueDao.findById(2)));
