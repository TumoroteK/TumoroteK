...
public class ServiceDaoTest extends AbstractDaoTest {
	...
	public void testFindByEtablissement() {
		Etablissement e = etablissementDao.findById(2).get();
		List<Service> services = serviceDao.findByEtablissement(e);
		assertTrue(services.size() == 1);
		e = etablissementDao.findById(4).get();
	...
	public void testFindByEtablissementWithOrder() {
		Etablissement e = etablissementDao.findById(1).get();
	...
	public void testCrudService() throws Exception {
		...
		final Service s2 = serviceDao.findById(new Integer(5)).get();
		assertNotNull(s2);
		...
		serviceDao.save(s2);
		assertTrue(serviceDao.findById(new Integer(5)).get().getNom().equals(updatedNom));
	...
	public void testClone() {
		final Service s1 = serviceDao.findById(1).get();
