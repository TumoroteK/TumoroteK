...
public class AnnotationDefautDaoTest extends AbstractDaoTest {
	...
	public void setAnnotationDefautDao(AnnotationDefautDao adDao) {
	...
	public void testToString() throws ParseException {
		AnnotationDefaut ad1 = annotationDefautDao.findById(1);
		assertTrue(ad1.toString().
				equals("{Defaut: Alphanum1.AlphanumDefaut1}"));	
		AnnotationDefaut ad2 = new AnnotationDefaut();
		assertTrue(ad2.toString().
				equals("{Empty AnnotationDefaut}"));
		ad2.setChampAnnotation(champAnnotationDao.findById(1));
		assertTrue(ad2.toString().
				equals("{Empty AnnotationDefaut}"));
		ad2.setItem(itemDao.findById(1));
		assertTrue(ad2.toString().
				equals("{Defaut: Alphanum1.item1-1}"));
		ad2.setTexte("You and me always");
		assertTrue(ad2.toString().
				equals("{Defaut: Alphanum1.You a...}"));
		Calendar sDate = Calendar.getInstance();
		sDate.setTime(new SimpleDateFormat("dd/MM/yyyy HH:mm:ss")
											.parse("12/02/2006 12:02:45"));
		ad2.setDate(sDate);
		assertTrue(ad2.toString().
				equals("{Defaut: Alphanum1.12/02/2006 12:02:45}"));
		ad2.setBool(true);
	...
	public void testReadAllDefauts() {
		List<AnnotationDefaut> defauts = annotationDefautDao.findAll();
		assertTrue(defauts.size() == 11);
	}
	
	public void testFindByChamp() {
		List<AnnotationDefaut> defauts = annotationDefautDao
						.findByChamp(champAnnotationDao.findById(12));
		assertTrue(defauts.size() == 2);
		defauts = annotationDefautDao
						.findByChamp(champAnnotationDao.findById(8));
	...
	public void testFindByExcludedId() {
		...
		List<AnnotationDefaut> defauts = 
								annotationDefautDao.findByExcludedId(1);
	...
	public void testCrudDefaut() {
		...
		ChampAnnotation alpha = new ChampAnnotation();		
		...
		alpha.setOrdre(4);
		// defaut 
		AnnotationDefaut ad1 = new AnnotationDefaut();
		ad1.setAlphanum("defautValue1");
		ad1.setChampAnnotation(alpha);
		ad1.setObligatoire(true);
		Set<AnnotationDefaut> ads = new HashSet<AnnotationDefaut>();
		ads.add(ad1);
		...
		Integer maxId = alpha.getChampAnnotationId();
		
		// Test de l'insertion
		annotationDefautDao.createObject(ad1);
		ChampAnnotation alpha2 = champAnnotationDao.findById(maxId);
		assertNotNull(alpha2);
		Set<AnnotationDefaut> defauts = alpha2.getAnnotationDefauts();
		...
		assertTrue(annotationDefautDao
				.findByChamp(champAnnotationDao.findById(12)).size() == 3);
		assertTrue(annotationDefautDao.findById(13)
									.getItem().equals(itemDao.findById(3)));
	...
	public void testEqualsAndHashCode() {
		...
		Item i1 = itemDao.findById(1);
		Item i2 = itemDao.findById(2);
		Item i3 = new Item();
	...
	public void testClone() throws ParseException {
		...
		AnnotationDefaut clone = ad1.clone();
		
		assertTrue(ad1.equals(clone));
		assertTrue(ad1.hashCode() == clone.hashCode());
		assertTrue(clone.getAnnotationDefautId()
									.equals(ad1.getAnnotationDefautId()));
