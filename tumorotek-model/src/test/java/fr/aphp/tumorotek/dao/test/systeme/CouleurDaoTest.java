...
public class CouleurDaoTest extends AbstractDaoTest {
	...
	public void testFindAll() {
		List<Couleur> liste = couleurDao.findAll();
	...
	public void testFindByVisotube() {
		List<Couleur> liste = couleurDao.findByVisotube();
	...
	public void testCrudCouleur() throws Exception {
		...
		Couleur c2 = couleurDao.findById(new Integer(16));
		assertNotNull(c2);
		...
		assertTrue(couleurDao.findById(new Integer(16)).getCouleur()
				.equals(updatedCouleur));
