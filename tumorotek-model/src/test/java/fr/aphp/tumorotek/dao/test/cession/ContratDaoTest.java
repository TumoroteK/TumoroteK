...
public class ContratDaoTest extends AbstractDaoTest {
	...
	private String updatedNumero = "Mis a jour";
	...
	public void setCollaborateurDao(CollaborateurDao dao) {
	...
	public void setProtocoleTypeDao(ProtocoleTypeDao dao) {
	...
	public void testReadAllContrats() {
		List<Contrat> liste = contratDao.findAll();
	...
	public void testFindByNumero() {
		List<Contrat> liste = contratDao
			.findByNumero("CONTRAT 78551269");
	...
	public void testFindByOrder() {
		List<Contrat> liste = contratDao.findByOrder();
		assertTrue(liste.size() == 4);
	...
	public void testCrud() throws Exception {
		...
		Collaborateur collab = collaborateurDao.findById(1);
		Service serv = serviceDao.findById(1);
		Etablissement etab = etablissementDao.findById(2);
		ProtocoleType type = protocoleTypeDao.findById(1);
		...
		Date demandeRedac = new SimpleDateFormat(
				"dd/MM/yyyy").parse("05/09/2009");
		Date envoi = new SimpleDateFormat("dd/MM/yyyy").parse("10/09/2009");
		Date signature = new SimpleDateFormat("dd/MM/yyyy").parse("15/09/2009");
		Date upSignature = 
			new SimpleDateFormat("dd/MM/yyyy").parse("16/09/2009");
		Float montant = new Float(666);
		...
		Contrat contrat2 = contratDao.findById(new Integer(5));
		...
		assertTrue(contratDao.findById(
				new Integer(5)).getNumero().equals(updatedNumero));
		assertTrue(contratDao.findById(
				new Integer(5)).getDateSignature().equals(upSignature));
		// Test de la délétion
	...
	public void testEquals() {
		...
		Plateforme pf1 = plateformeDao.findById(1);
		Plateforme pf2 = plateformeDao.findById(2);
		Contrat b1 = new Contrat();
		Contrat b2 = new Contrat();
	...
	public void testToString() {
		Contrat contrat1 = contratDao.findById(1);
		assertTrue(contrat1.toString().
				equals("{" + contrat1.getNumero() + ", " 
						+ contrat1.getPlateforme().getNom() 
						+ "(Plateforme)}"));
	...
	public void testClone() {
		...
		if (contrat1.getDateDemandeCession() != null) {
			assertTrue(contrat1.getDateDemandeCession()
					.equals(contrat2.getDateDemandeCession()));
		} else {
			assertNull(contrat2.getDateDemandeCession());
		}
		
		if (contrat1.getDateValidation() != null) {
			assertTrue(contrat1.getDateValidation()
					.equals(contrat2.getDateValidation()));
		} else {
			assertNull(contrat2.getDateValidation());
		}
		
		if (contrat1.getDateSignature() != null) {
			assertTrue(contrat1.getDateSignature()
					.equals(contrat2.getDateSignature()));
		} else {
			assertNull(contrat2.getDateSignature());
		}
		
		if (contrat1.getDateDemandeRedaction() != null) {
			assertTrue(contrat1.getDateDemandeRedaction()
					.equals(contrat2.getDateDemandeRedaction()));
		} else {
			assertNull(contrat2.getDateDemandeRedaction());
		}
		
		if (contrat1.getDateEnvoiContrat() != null) {
			assertTrue(contrat1.getDateEnvoiContrat()
					.equals(contrat2.getDateEnvoiContrat()));
		} else {
			assertNull(contrat2.getDateEnvoiContrat());
		}
		
		if (contrat1.getTitreProjet() != null) {
			assertTrue(contrat1.getTitreProjet()
					.equals(contrat2.getTitreProjet()));
		} else {
			assertNull(contrat2.getTitreProjet());
		}
		
		if (contrat1.getDescription() != null) {
			assertTrue(contrat1.getDescription()
					.equals(contrat2.getDescription()));
		} else {
			assertNull(contrat2.getDescription());
		}
		
		if (contrat1.getCollaborateur() != null) {
			assertTrue(contrat1.getCollaborateur()
					.equals(contrat2.getCollaborateur()));
		} else {
			assertNull(contrat2.getCollaborateur());
		}
		
		if (contrat1.getService() != null) {
			assertTrue(contrat1.getService()
					.equals(contrat2.getService()));
		} else {
			assertNull(contrat2.getService());
		}
		
		if (contrat1.getProtocoleType() != null) {
			assertTrue(contrat1.getProtocoleType()
					.equals(contrat2.getProtocoleType()));
		} else {
			assertNull(contrat2.getProtocoleType());
		}
		
		if (contrat1.getEtablissement() != null) {
			assertTrue(contrat1.getEtablissement()
					.equals(contrat2.getEtablissement()));
		} else {
			assertNull(contrat2.getEtablissement());
		}
		
		if (contrat1.getMontant() != null) {
			assertTrue(contrat1.getMontant()
					.equals(contrat2.getMontant()));
		} else {
			assertNull(contrat2.getMontant());
		}
		
		if (contrat1.getPlateforme() != null) {
			assertTrue(contrat1.getPlateforme()
					.equals(contrat2.getPlateforme()));
		} else {
