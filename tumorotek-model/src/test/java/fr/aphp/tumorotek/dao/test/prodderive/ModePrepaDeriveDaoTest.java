...
public class ModePrepaDeriveDaoTest extends AbstractDaoTest {
	...
	public void testReadAllModePrepas() {
		List<ModePrepaDerive> modes = modePrepaDeriveDao.findAll();
	...
	public void testFindByOrder() {
		...
		List< ? extends TKThesaurusObject> list = 
							modePrepaDeriveDao.findByOrder(pf);
	...
	public void testFindByNom() {
		List<ModePrepaDerive> modes = modePrepaDeriveDao
			.findByNom("PREPA1_DERIVE");
	...
	public void testFindByExcludedId() {
		...
		ModePrepaDerive mode = liste.get(0);
		assertNotNull(mode);
	...
	public void testCrudModePrepa() throws Exception {
		...
		ModePrepaDerive m = new ModePrepaDerive();
		...
		ModePrepaDerive m2 = modePrepaDeriveDao.findById(new Integer(5));
		assertNotNull(m2);
		...
		assertTrue(modePrepaDeriveDao.findById(
	...
	public void testEquals() {
		String nom = "Nom";
		String nom2 = "Nom2";
		ModePrepaDerive m1 = new ModePrepaDerive();
		m1.setNom(nom);
		ModePrepaDerive m2 = new ModePrepaDerive();
		m2.setNom(nom);
	...
	public void testHashCode() {
		...
		ModePrepaDerive m2 = new ModePrepaDerive();
		m2.setNom(nom);
		ModePrepaDerive m3 = new ModePrepaDerive();
		m3.setNom(null);
