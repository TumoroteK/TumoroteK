...
public class AffectationImprimanteDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		List<AffectationImprimante> liste = 
			affectationImprimanteDao.findAll();
	...
	public void testFindByExcludedPK() {
		...
		List<AffectationImprimante> liste = 
			affectationImprimanteDao.findByExcludedPK(pk);
	...
	public void testFindByUtilisateurBanque() {
		...
		List<AffectationImprimante> liste = 
			affectationImprimanteDao.findByBanqueUtilisateur(b1, u1);
	...
	public void testCrud() {
		...
		pk.setImprimante(i1);
		pk.setBanque(b3);
		AffectationImprimante aiUp = affectationImprimanteDao.findById(pk);
		assertNotNull(aiUp);
		...
		AffectationImprimante aiTest = affectationImprimanteDao.findById(pk);
	...
	public void testEquals() throws ParseException {
		...
		AffectationImprimante ai1 = new AffectationImprimante();
	...
	public void testHashCode() throws ParseException {
		AffectationImprimante ai1 = new AffectationImprimante();
		AffectationImprimante ai2 = new AffectationImprimante();
		AffectationImprimante ai3 = new AffectationImprimante();
	...
	private void populateClefsToTestEqualsAndHashCode(
			AffectationImprimante ai1, 
			AffectationImprimante ai2) throws ParseException {
		
		Imprimante i1 = imprimanteDao.findById(1);
		Banque b = banqueDao.findById(3);
		Utilisateur u3 = utilisateurDao.findById(3);
		Utilisateur u4 = utilisateurDao.findById(4);
		AffectationImprimantePK pk1 = new AffectationImprimantePK(u3, b, i1);
		AffectationImprimantePK pk2 = new AffectationImprimantePK(u4, b, i1);
		AffectationImprimantePK pk3 = new AffectationImprimantePK(u3, b, i1);
		AffectationImprimantePK[] pks = 
			new AffectationImprimantePK[]{null, pk1, pk2, pk3};
	...
	public void testToString() {
		...
		Utilisateur u1 = utilisateurDao.findById(1);
		AffectationImprimantePK pk1 = new AffectationImprimantePK(u1, b, i1);
		AffectationImprimante ai1 = affectationImprimanteDao.findById(pk1);
		
		assertTrue(ai1.toString().
				equals("{" + ai1.getPk().toString() + "}"));
		
		AffectationImprimante po2 = new AffectationImprimante();
		po2.setPk(null);
