...
public class ImportationDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		List<Importation> liste = importationDao.findAll();
	...
	public void testFindByHistorique() {
		...
		List<Importation> liste = importationDao
			.findByHistorique(ih1);
		assertTrue(liste.size() == 2);
		
		ImportHistorique ih2 = importHistoriqueDao.findById(2);
	...
	public void testFindByHistoriqueAndEntite() {
		...
		List<Importation> liste = importationDao
			.findByHistoriqueAndEntite(ih1, e1);
	...
	public void testCrud() throws Exception {
		...
		ImportHistorique ih = importHistoriqueDao.findById(1);
		Entite e1 = entiteDao.findById(1);
		...
		Integer id = i1.getImportationId();
		assertTrue(importationDao.findAll().size() == 3);
		
		// Test de la mise à jour
		Importation i2 = importationDao.findById(id);
		assertNotNull(i2);
		...
		assertTrue(importationDao.findById(id).
				getObjetId() == 3);
	...
	public void testToString() {
		Importation i1 = importationDao.findById(1);
		assertTrue(i1.toString().equals("{" + i1.getObjetId() + ", " 
				+ i1.getEntite().getNom() + "(Entite) " 
				+ i1.getImportHistorique().toString() 
				+ "}"));
	...
	public void testClone() {
		...
		if (i1.getImportHistorique() != null) {
			assertTrue(i1.getImportHistorique().equals(
					i2.getImportHistorique()));
		} else {
