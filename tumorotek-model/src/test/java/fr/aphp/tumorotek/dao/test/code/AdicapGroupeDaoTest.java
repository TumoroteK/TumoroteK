...
public class AdicapGroupeDaoTest extends AbstractDaoTest {
	...
	public void testReadAllAdicapGroupes() {
		List<AdicapGroupe> adicapGroupes = adicapGroupeDao.findAll();
		assertTrue(adicapGroupes.size() == 58);
	}
	
	public void testFindDictionnaires() {
		List<AdicapGroupe> adicapGroupes = 
			adicapGroupeDao.findDictionnaires();
	...
	public void testEquals() {
		Integer id1 = 1;
		Integer id2 = 2;
		AdicapGroupe a1 = new AdicapGroupe();
		AdicapGroupe a2 = new AdicapGroupe();
	...
	public void testHashCode() {
		...
		AdicapGroupe a2 = new AdicapGroupe();
		a2.setAdicapGroupeId(id1);
		AdicapGroupe a3 = new AdicapGroupe();
