...
public class ChampImprimePKTest extends AbstractDaoTest {
	...
	public void testEquals() throws ParseException {
		ChampImprimePK pk1 = new ChampImprimePK();
		ChampImprimePK pk2 = new ChampImprimePK();
	...
	private void populateClefsToTestEqualsAndHashCode() throws ParseException {
		...
		BlocImpression b3 = blocImpressionDao.findById(1);
		BlocImpression[] blocs = new BlocImpression[]{null, b1, b2, b3};
