...
public class RisqueDaoTest extends AbstractDaoTest {
	...
	private String updatedNom = "Nom mis a jour";
	private Boolean updatedInfectieux = new Boolean(false);
	 ...
	 */
	public void setRisqueDao(RisqueDao tDao) {
		this.risqueDao = tDao;
	}
	...
	public void testCrudRisque() throws Exception {
		...
		Risque r2 = risqueDao.findById(new Integer(4));
		assertNotNull(r2);
		...
		assertTrue(risqueDao.findById(new Integer(4)).getNom()
				.equals(updatedNom));
		assertTrue(risqueDao.findById(new Integer(4)).getInfectieux()
				.equals(updatedInfectieux));
	...
	public void testEquals() {
		...
		String[] risques = new String[]{null, "risque1", "risque2", ""};
		Plateforme[] pfs = new Plateforme[]{null, plateformeDao.findById(1), 
