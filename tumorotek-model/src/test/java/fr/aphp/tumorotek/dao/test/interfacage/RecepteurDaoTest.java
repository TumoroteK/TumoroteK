...
public class RecepteurDaoTest extends AbstractDaoTest {
	...
	public void setRecepteurDao(RecepteurDao eDao) {
	...
	public void testReadAll() {
		List<Recepteur> liste = recepteurDao.findAll();
		assertTrue(liste.size() == 2);
	}
	
	public void testFindByLogicielAndIdentification() {
		Logiciel l2 = logicielDao.findById(2);
		List<Recepteur> liste = recepteurDao
			.findByLogicielAndIdentification(l2, "DIAMIC-ACK");
		assertTrue(liste.size() == 1);
		
		liste = recepteurDao.findByLogicielAndIdentification(l2, "Apix");
		assertTrue(liste.size() == 0);
		
		Logiciel l3 = logicielDao.findById(3);
	...
	public void testCrud() throws Exception {
		...
		Recepteur e2 = recepteurDao.findById(e1.getRecepteurId());
		...
		assertTrue(recepteurDao.findById(
				e1.getRecepteurId()).getIdentification().equals("ID2"));
		assertTrue(recepteurDao.findById(
				e1.getRecepteurId()).getObservations().equals("OBS"));
		assertTrue(recepteurDao.findById(
				e1.getRecepteurId()).getLogiciel().getLogicielId() == 3);
	...
	public void testToString() {
		Recepteur e1 = recepteurDao.findById(1);
