...
public class EnceinteTypeDaoTest extends AbstractDaoTest {
	...
	public void testReadAlls() {
		List<EnceinteType> liste = enceinteTypeDao.findAll();
	...
	public void testFindByOrder() {
		...
		List< ? extends TKThesaurusObject> list = 
							enceinteTypeDao.findByOrder(pf);
	...
	public void testFindByOrderExceptBoite() {
		...
		list = enceinteTypeDao
						.findByOrderExceptBoite(plateformeDao.findById(2));
		assertTrue(list.size() == 1);
	...
	public void testFindByTypeAndPf() {
		List<EnceinteType> liste = enceinteTypeDao
			.findByTypeAndPf("CANISTER", plateformeDao.findById(1));
		assertTrue(liste.size() == 1);
		
		liste = enceinteTypeDao
			.findByTypeAndPf("CANISTER", plateformeDao.findById(2));
		assertTrue(liste.size() == 0);
		
		liste = enceinteTypeDao
			.findByTypeAndPf("CAN", plateformeDao.findById(1));
		assertTrue(liste.size() == 0);
	}
	...
	public void testCrud() throws Exception {
		...
		EnceinteType et = new EnceinteType();
		...
		EnceinteType et2 = enceinteTypeDao.findById(new Integer(10));
		assertNotNull(et2);
		assertTrue(et2.getType().equals("Type"));
		et2.setType(updatedType);
		enceinteTypeDao.updateObject(et2);
		assertTrue(enceinteTypeDao.findById(new Integer(10)).
	...
	public void testEquals() {
		String type = "TYPE";
		String type2 = "TYPE2";
		EnceinteType et1 = new EnceinteType();
		et1.setType(type);
		EnceinteType et2 = new EnceinteType();
		et2.setType(type);
	...
	public void testHashCode() {
		...
		EnceinteType et2 = new EnceinteType();
		et2.setType(type);
		EnceinteType ct3 = new EnceinteType();
		ct3.setType(type);
	...
	public void testToString() {
		EnceinteType et1 = enceinteTypeDao.findById(1);
		assertTrue(et1.toString().
				equals("{" + et1.getType() + "}"));
