...
//				.equals(entiteDao.findByNom("Maladie").get(0).getNom()));
	...
	public void testReadAllMaladies() {
		List<Maladie> maladies = maladieDao.findAll();
	...
	public void testCrudMaladie() throws Exception {
		...
		m.setCode("N12.5");
		Date diag = new SimpleDateFormat("dd/MM/yyyy hh:mm:ss")
												.parse("24/03/2008 12:12:12");
		m.setDateDiagnostic(diag);
		Date debut = new SimpleDateFormat("dd/MM/yyyy").parse("01/11/2004");
		...
		Integer mId = m.getMaladieId();
		Maladie m2 = maladieDao.findById(mId);
		assertNotNull(m2);
	...
	private void populateClefsToTestEqualsAndHashCode(Maladie m1, Maladie m2) 
														throws ParseException {
		String[] libelles = new String[]{null, "libelle1", 
												"libelle2", "libelle1"};
		...
		assertTrue(m1.equals(m2));
		Date diag1 = new SimpleDateFormat("dd/MM/yyyy hh:mm:ss")
												.parse("24/03/2008 12:12:12"); 
		m1.setDateDiagnostic(diag1);
		m2.setDateDiagnostic(new SimpleDateFormat("dd/MM/yyyy hh:mm:ss")
												.parse("24/03/2009 12:12:12"));
		assertFalse(m1.equals(m2));
