...
public class SModeleDaoTest extends AbstractDaoTest {
	...
	public void setIndicateurDao(IndicateurDao i) {
		this.indicateurDao = i;
	}

	public void setsModeleIndicateurDao(SModeleIndicateurDao s) {
	...
	public void testReadAll() {
		List<SModele> liste = sModeleDao.findAll();
	...
	public void testCrud() throws Exception {
		...
		SModeleIndicateur smi1 = new SModeleIndicateur();
		SModeleIndicateurPK smi1PK = new SModeleIndicateurPK();
		smi1PK.setsModele(m1);
		smi1PK.setIndicateur(indicateurDao.findById(2));
		smi1.setPk(smi1PK);
		smi1.setOrdre(1);
		
		SModeleIndicateur smi2 = new SModeleIndicateur();
		SModeleIndicateurPK smi2PK = new SModeleIndicateurPK();
		...
		Integer sModId = m1.getSmodeleId();
		
		SModele m2 = sModeleDao.findById(sModId);
		...
		SModele m3 = sModeleDao.findById(sModId);
		// Vérification des données entrées dans la base
		assertNotNull(m3);
