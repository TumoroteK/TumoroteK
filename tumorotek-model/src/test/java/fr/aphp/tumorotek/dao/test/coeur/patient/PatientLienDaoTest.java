...
public class PatientLienDaoTest extends AbstractDaoTest {
	 ...
	 */
	public void setPatientLienDao(PatientLienDao mDao) {
	...
	public void setLienDao(LienFamilialDao lDao) {
		this.lienDao = lDao;
	}
	...
	public void testToString() {
		PatientLienPK pk = new PatientLienPK(patientDao.findById(2),
												patientDao.findById(5));
		PatientLien pl1 = patientLienDao.findById(pk);
		assertTrue(pl1.toString()
				.equals("{" + pl1.getPatient1() + " - " + pl1.getLienFamilial() 
										+ " - " + pl1.getPatient2() + "}"));
		pl1 = new PatientLien();
	...
	public void testReadAllPatientLiens() {
		List<PatientLien> patientLiens = patientLienDao.findAll();
	...
	public void testCrudLienFamilial() {
		...
		Patient p2 = patientDao.findById(3);
		LienFamilial l1 = lienDao.findById(2);
		pl.setPatient1(p2);
		pl.setPatient2(p1);
	...
	public void testHashCode() throws ParseException {
		PatientLien pl1 = new PatientLien();
		PatientLien pl2 = new PatientLien();
		PatientLien r3 = new PatientLien();
	...
	private void populateClefsToTestEqualsAndHashCode(PatientLien pl1, 
								PatientLien pl2) throws ParseException {
		...
		PatientLienPK pk2 = new PatientLienPK();
