...
public class ItemDaoTest extends AbstractDaoTest {
	...
	public void testToString() throws ParseException {
		...
		assertTrue(i1.toString().
				equals("{Thesaurus Item: Thes1.item1-1}"));
		
		Item i2 = new Item();
		assertTrue(i2.toString().
				equals("{Empty Item}"));
	...
	public void testCrudItem() {
		...
		ChampAnnotation thes = new ChampAnnotation();		
		...
		Integer maxId = thes.getChampAnnotationId();
		
		// Test de l'insertion
		ChampAnnotation thes2 = champAnnotationDao.findById(maxId);
		assertNotNull(thes2);

		// creation item supplementaire
		Item i3 = new Item();
		i3.setLabel("new"); i3.setValeur("newVal");
	...
	public void testEqualsAndHashCode() {
		...
		ChampAnnotation t1 = champAnnotationDao.findById(1);
		ChampAnnotation t2 = champAnnotationDao.findById(2);
		ChampAnnotation t3 = new ChampAnnotation();
		t3.setNom(t2.getNom());
		...
		pf1.setNom("PF1");
		Plateforme pf2 = new Plateforme();
		pf2.setNom("PF2");
		Plateforme pf3 = new Plateforme();
		pf3.setNom("PF2");
	...
	public void testClone() {
		...
		if (i.getAnnotationValeurs() != null) {
			assertTrue(i.getAnnotationValeurs()
											.equals(i2.getAnnotationValeurs()));
		} else {
			assertNull(i2.getAnnotationValeurs());
		}
		if (i.getAnnotationDefauts() != null) {
			assertTrue(i.getAnnotationDefauts()
									.equals(i2.getAnnotationDefauts()));
		} else {
