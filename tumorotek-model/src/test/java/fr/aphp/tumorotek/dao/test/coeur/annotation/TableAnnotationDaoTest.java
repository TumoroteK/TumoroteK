...
public class TableAnnotationDaoTest extends AbstractDaoTest
{
   ...
   public void testCrudTableAnnotation(){
      ...
      final Catalogue cINca = catalogueDao.findById(1);
      table.setCatalogue(cINca);
      final TableAnnotationBanquePK pk1 = new TableAnnotationBanquePK(banqueDao.findById(1), table);
      final TableAnnotationBanque tab1 = new TableAnnotationBanque();
      tab1.setPk(pk1);
      tab1.setOrdre(1);
      final TableAnnotationBanquePK pk2 = new TableAnnotationBanquePK(banqueDao.findById(2), table);
      ...
      final TableAnnotation table2 = tableAnnotationDao.findById(12);
      ...
      final TableAnnotationBanquePK pk3 = new TableAnnotationBanquePK(banqueDao.findById(3), table2);
      final TableAnnotationBanque tab3 = new TableAnnotationBanque();
      tab3.setPk(pk3);
      tab3.setOrdre(1);
      table2.getTableAnnotationBanques().add(tableAnnotationBanqueDao.mergeObject(tab1));
      table2.getTableAnnotationBanques().add(tableAnnotationBanqueDao.mergeObject(tab2));
   ...
   public void testFindByCatalogues(){
      ...
      final Catalogue c2 = catalogueDao.findById(2);
      catas.add(c2);
