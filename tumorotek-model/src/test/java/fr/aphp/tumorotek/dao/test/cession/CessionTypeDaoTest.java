...
public class CessionTypeDaoTest extends AbstractDaoTest {
	...
	public void testReadAllCessionTypes() {
		List<CessionType> liste = cessionTypeDao.findAll();
	...
	public void testFindByOrder() {
		List<CessionType> liste = cessionTypeDao.findByOrder();
		assertTrue(liste.size() == 3);
	...
	public void testFindByExamen() {
		List<CessionType> liste = cessionTypeDao
			.findByType("SANITAIRE");
	...
	public void testCrudCessionType() throws Exception {
		...
		CessionType ct = new CessionType();
		...
		CessionType ct2 = cessionTypeDao.findById(new Integer(4));
		assertNotNull(ct2);
		assertTrue(ct2.getType().equals("TEST"));
		ct2.setType(updatedType);
		cessionTypeDao.updateObject(ct2);
		assertTrue(cessionTypeDao.findById(new Integer(4)).
	...
	public void testEquals() {
		String type = "TYPE";
		String type2 = "TYPE2";
		CessionType ct1 = new CessionType();
		ct1.setType(type);
		CessionType ct2 = new CessionType();
		ct2.setType(type);
	...
	public void testHashCode() {
		...
		CessionType ct2 = new CessionType();
		ct2.setType(type);
		CessionType ct3 = new CessionType();
		ct3.setType(null);
	...
	public void testToString() {
		CessionType ct1 = cessionTypeDao.findById(1);
