...
public class PlateformeDaoTest extends AbstractDaoTest {
	...
	private String updatedNom = "PF mis a jour";
	...
	public void testReadAllPlateformes() {
		List<Plateforme> plateformes = plateformeDao.findAll();
	...
	public void testFindByOrder() {
		List<Plateforme> list = plateformeDao.findByOrder();
	...
	public void testFindByIdWithFetch() {
		List<Plateforme> plateformes = plateformeDao.findByIdWithFetch(1);
	...
	public void testCrudPlateforme() throws Exception {
		...
		Collaborateur c = collaborateurDao.findById(3);
		...
		Plateforme p2 = plateformeDao.findById(new Integer(3));
		assertNotNull(p2);
		...
		assertTrue(plateformeDao.findById(
				new Integer(3)).getNom().equals(updatedNom));
	...
	public void testHashCode() {
		String nom = "PF1";
		Plateforme p1 = new Plateforme(1, nom, "");
		p1.setNom(nom);
		Plateforme p2 = new Plateforme(2, nom, "");
		p2.setNom(nom);
		Plateforme p3 = new Plateforme(3, nom, "");
		p3.setNom(null);
