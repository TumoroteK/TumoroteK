...
public class IncidentDaoTest extends AbstractDaoTest
{
   ...
   private final String updatedNom = "Mis a jour";
   ...
   public void testReadAlls(){
      final List<Incident> liste = incidentDao.findAll();
   ...
   public void testCrud() throws Exception{
      ...
      final Incident ct2 = incidentDao.findById(iId);
      assertNotNull(ct2);
      assertTrue(ct2.getDate().equals(d1));
      ct2.setNom(updatedNom);
      incidentDao.updateObject(ct2);
      assertTrue(incidentDao.findById(iId).getNom().equals(updatedNom));
   ...
   public void testClone(){
      final Incident incident1 = incidentDao.findById(1);
