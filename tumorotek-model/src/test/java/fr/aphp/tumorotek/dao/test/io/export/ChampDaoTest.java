...
public class ChampDaoTest extends AbstractDaoTest
{
   ...
   */
   ...
   public void testCrudChamp() throws Exception{
      ...
      final ChampEntite champEntite = champEntiteDao.findById(champEntiteId);
      ...
      final Champ c2 = this.champDao.findById(idObject);
      assertNotNull(c2);
      ...
      final ChampAnnotation updatedChampAnnotation = champAnnotationDao.findById(updatedChampAnnotationId);
      ...
      if(this.champDao.findById(idObject).getChampEntite() != null){
         assertTrue(this.champDao.findById(idObject).getChampEntite().equals(updatedChampEntite));
      }else{
