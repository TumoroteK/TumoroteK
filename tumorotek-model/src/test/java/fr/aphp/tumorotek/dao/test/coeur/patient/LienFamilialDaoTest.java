...
public class LienFamilialDaoTest extends AbstractDaoTest {
	 ...
	 */
	public void setLienFamilialDao(LienFamilialDao lDao) {
		this.lienDao = lDao;
	}
	...
	public void testReadAllLienFamilials() {
		List<LienFamilial> liens = lienDao.findAll();
	...
	public void testCrudLienFamilial() throws Exception {
		LienFamilial r = new LienFamilial();		
		...
		LienFamilial l2 = lienDao.findById(new Integer(7));
		assertNotNull(l2);
		assertTrue(l2.getNom().equals("Neveu-Tante"));
		assertTrue(l2.getReciproque()
				.equals(lienDao.findByNom("Tante-Neveu").get(0)));
		assertTrue(l2.getAscendant());
		l2.setNom("GandPere-PetitFils");
		l2.setReciproque(null);
		l2.setAscendant(false);
		lienDao.updateObject(l2);
		assertTrue(lienDao.findById(new Integer(7)).getNom()
				.equals("GandPere-PetitFils"));
	...
	public void testEquals() {
		...
		LienFamilial l1 = new LienFamilial();
		LienFamilial l2 = new LienFamilial();
		...
		String[] noms = new String[]{null, "lien1", "lien2", "lien1"};
	...
	public void testHashCode() {
		...
		LienFamilial r3 = new LienFamilial();
		...
		String[] noms = new String[]{null, "lien1", "lien2", ""};
