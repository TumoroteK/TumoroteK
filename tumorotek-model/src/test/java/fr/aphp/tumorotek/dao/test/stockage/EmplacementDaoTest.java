...
public class EmplacementDaoTest extends AbstractDaoTest
{
   ...
   public void testReadAll(){
      final List<Emplacement> liste = emplacementDao.findAll();
   ...
   public void testCrud() throws Exception{
      ...
      final Emplacement e2 = emplacementDao.findById(new Integer(8));
      ...
      assertTrue(emplacementDao.findById(new Integer(8)).getPosition() == 2);
   ...
   public void testToString(){
      final Emplacement e1 = emplacementDao.findById(1);
