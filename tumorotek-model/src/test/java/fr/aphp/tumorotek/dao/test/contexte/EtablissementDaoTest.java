...
public class EtablissementDaoTest extends AbstractDaoTest {
	...
	private String updatedNom = "Etab mis a jour";
	...
	public void testFindByOrder() {
		List<Etablissement> etabs = etablissementDao.findByOrder();
		assertTrue(etabs.size() == 4);
	...
	public void testFindByLocal() {
		List<Etablissement> etabs = etablissementDao.findByLocal(true);
		assertTrue(etabs.size() == 2);
	}
	...
	public void testFindByArchiveWithOrder() {
		List<Etablissement> etabs = etablissementDao
			.findByArchiveWithOrder(false);
		assertTrue(etabs.size() == 3);
		assertTrue(etabs.get(0).getNom().equals("BEAUVAIS CH"));
		
		etabs = etablissementDao
			.findByArchiveWithOrder(true);
		assertTrue(etabs.size() == 1);
	}
	...
	public void testFindByIdWithFetch() {
		List<Etablissement> etabs = etablissementDao.findByIdWithFetch(1);
		Etablissement etab = etabs.get(0);
		assertNotNull(etab);
	...
	public void testCrudEtablissement() throws Exception {
		...
		Categorie cat = categorieDao.findById(2);
		...
		Etablissement e2 = etablissementDao.findById(new Integer(5));
		assertNotNull(e2);
		...
		assertTrue(etablissementDao.findById(
				new Integer(5)).getNom().equals(updatedNom));
	...
	public void testEquals() {
		String nom = "Etab";
		String nom2 = "Etab2";
		String finess = "Finess";
		String finess2 = "Finess2";
		...
		Etablissement et2 = new Etablissement();
		et2.setNom(e.getNom());
