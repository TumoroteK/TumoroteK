...
/**
 * 
 * Classe de test pour le DAO TransformationDao et le bean 
 * du domaine Transformation.
...
public class TransformationDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		List<Transformation> transfos = transformationDao.findAll();
	...
	public void testFindByEntiteObjet() {
		...
		List<Transformation> transfos = 
			transformationDao.findByEntiteObjet(e, 1);
	...
	public void testFindByExcludedId() {
		List<Transformation> transfos = 
			transformationDao.findByExcludedId(1);
		assertTrue(transfos.size() == 4);
		
		transfos = 
			transformationDao.findByExcludedId(10);
		assertTrue(transfos.size() == 5);
	}
	...
	public void testCrud() throws Exception {
		...
		Transformation t2 = transformationDao.findById(new Integer(6));
		...
		assertTrue(transformationDao.findById(new Integer(6)).
				getObjetId() == objId);
		assertTrue(transformationDao.findById(new Integer(6)).
				getQuantite() == (float) 15.146);
	...
	public void testEquals() {
		...
		Entite e2 = entiteDao.findById(4);
	...
	public void testToString() {
		...
		assertTrue(t1.toString().equals("{" + t1.getObjetId() + ", "
				+ t1.getEntite().toString() + "(Entite)}"));
	...
	public void testClone() {
		...
		if (t1.getTransformationId() != null) {
			assertTrue(t1.getTransformationId()
					.equals(t2.getTransformationId()));
		} else {
		...
		/*if (t1.getVolume() != null) {
			assertTrue(t1.getVolume().equals(t2.getVolume()));
		} else {
			assertNull(t2.getVolume());
		}
		if (t1.getVolumeUnite() != null) {
			assertTrue(t1.getVolumeUnite().equals(t2.getVolumeUnite()));
		} else {
