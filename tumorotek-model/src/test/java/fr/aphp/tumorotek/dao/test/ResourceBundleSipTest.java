...
public class ResourceBundleSipTest extends AbstractDaoTest {
	...
	public void setResourceBundleSip(ResourceBundleSip r) {
	...
	public void testDoesResourceBundleExists() {
		assertTrue(resourceBundleSip.doesResourceBundleExists(
				"serveur_Identites.properties"));
		assertFalse(resourceBundleSip.doesResourceBundleExists(
			"blabla"));
		assertFalse(resourceBundleSip.doesResourceBundleExists(
				null));
	}
	...
	public void testGetResourceBundle() {
		ResourceBundle bundle = resourceBundleSip.getResourceBundle(
				"serveur_Identites.properties");
		assertTrue(bundle.getString("DBMS").equals("ORACLE"));
		
		bundle = resourceBundleSip.getResourceBundle(
			"blabla");
		assertNull(bundle);
