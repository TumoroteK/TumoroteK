...
public class CessionExamenDaoTest extends AbstractDaoTest {
	...
	private String updatedExamen = "Mis a jour";
	...
	public void testReadAllCessionExamens() {
		List<CessionExamen> qualites = cessionExamenDao.findAll();
	...
	public void testFindByOrder() {
		...
		List< ? extends TKThesaurusObject> list = 
								cessionExamenDao.findByOrder(pf);
	...
	public void testFindByExamen() {
		List<CessionExamen> liste = cessionExamenDao
			.findByExamen("ANALYSE 1");
	...
	public void testFindByExcludedId() {
		...
		CessionExamen exam = liste.get(0);
		assertNotNull(exam);
	...
	public void testCrudCessionExamen() throws Exception {
		...
		CessionExamen ce = new CessionExamen();
		...
		CessionExamen ce2 = cessionExamenDao.findById(new Integer(5));
		assertNotNull(ce2);
		assertTrue(ce2.getExamen().equals("TEST"));
		ce2.setExamen(updatedExamen);
		cessionExamenDao.updateObject(ce2);
		assertTrue(cessionExamenDao.findById(new Integer(5)).
				getExamen().equals(updatedExamen));
	...
	public void testEquals() {
		String exam = "EXAM";
		String exam2 = "EXAM2";
		CessionExamen ce1 = new CessionExamen();
		ce1.setExamen(exam);
		CessionExamen ce2 = new CessionExamen();
		ce2.setExamen(exam);
	...
	public void testHashCode() {
		...
		CessionExamen ce2 = new CessionExamen();
		ce2.setExamen(exam);
		CessionExamen ce3 = new CessionExamen();
		ce3.setExamen(null);
	...
	public void testToString() {
		CessionExamen ce1 = cessionExamenDao.findById(1);
		assertTrue(ce1.toString().
				equals("{" + ce1.getExamen() + "}"));
