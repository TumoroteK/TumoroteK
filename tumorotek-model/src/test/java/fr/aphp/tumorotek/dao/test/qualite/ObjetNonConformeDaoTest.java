...
public class ObjetNonConformeDaoTest extends AbstractDaoTest
{
   ...
   public void testReadAll(){
      final List<ObjetNonConforme> liste = objetNonConformeDao.findAll();
   ...
   public void testfindByNonConformite(){
      final NonConformite n6 = nonConformiteDao.findById(6);
      ...
      final NonConformite n3 = nonConformiteDao.findById(3);
   ...
   public void testFindByObjetEntiteAndType(){
      final Entite e3 = entiteDao.findById(3);
      final ConformiteType t3 = conformiteTypeDao.findById(3);
   ...
   public void testCrud() throws Exception{
      ...
      final ObjetNonConforme o2 = objetNonConformeDao.findById(oId);
   ...
   public void testEquals(){
      ...
      final Entite e2 = entiteDao.findById(2);
      final NonConformite n1 = nonConformiteDao.findById(1);
      final NonConformite n2 = nonConformiteDao.findById(2);
      final ObjetNonConforme o1 = new ObjetNonConforme();
   ...
   public void testToString(){
      final ObjetNonConforme o1 = objetNonConformeDao.findById(1);
