...
public class EchantillonTypeDaoTest extends AbstractDaoTest {
	...
	public void testReadAllObjetTypes() {
		List<EchantillonType> types = echantillonTypeDao.findAll();
	...
	public void testFindByOrder() {
		...
		List< ? extends TKThesaurusObject> list = 
						echantillonTypeDao.findByOrder(pf);
	...
	public void testFindByExcludedId() {
		...
		EchantillonType type = liste.get(0);
		assertNotNull(type);
	...
	public void testCrudEchanType() throws Exception {
		...
		EchantillonType e = new EchantillonType();
		...
		EchantillonType e2 = echantillonTypeDao.findById(new Integer(5));
		assertNotNull(e2);
		...
		assertTrue(echantillonTypeDao.findById(
				new Integer(5)).getType().equals(updatedType));
	...
	public void testEquals() {
		...
		String inca = "INCA1";
		String inca2 = "INCA2";
		EchantillonType e1 = new EchantillonType();
		e1.setType(type);
		e1.setIncaCat(inca);
		EchantillonType e2 = new EchantillonType();
		e2.setType(type);
		e2.setIncaCat(inca);
	...
	public void testHashCode() {
		String type = "Type1";
		String inca = "INCA1";
		EchantillonType e1 = new EchantillonType(1, type, inca);
		EchantillonType e2 = new EchantillonType(2, type, inca);
		EchantillonType e3 = new EchantillonType(3, null, null);
	...
	public void testToString() {
		...
		EchantillonType type2 = new EchantillonType();
