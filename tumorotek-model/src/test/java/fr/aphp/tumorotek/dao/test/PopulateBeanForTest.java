...
public final class PopulateBeanForTest {
	 ...
	 */
	public static void populateBean(Object o, String resource) 
	throws IllegalAccessException, InvocationTargetException {
		...
		while (keys.hasMoreElements()) {
			...
			try {
				if (o.getClass().getDeclaredField(key).
						getType().getName().equals("java.util.Date")) {
					BeanUtils.setProperty(o, key, 
							format.parse(bundle.getString(key))); 
				} else {
