...
public class ChampLigneEtiquetteDaoTest extends AbstractDaoTest {
	...
	public void testFindById() {
		ChampLigneEtiquette cle = champLigneEtiquetteDao.findById(1);
		assertNotNull(cle);
		
		ChampLigneEtiquette cleNull = champLigneEtiquetteDao.findById(100);
		assertNull(cleNull);
	}
	...
	public void testReadAll() {
		List<ChampLigneEtiquette> liste = champLigneEtiquetteDao.findAll();
	...
	public void testFindByLigneEtiquette() {
		...
		List<ChampLigneEtiquette> liste = champLigneEtiquetteDao
			.findByLigneEtiquette(le1);
		assertTrue(liste.size() == 2);
		
		LigneEtiquette le7 = ligneEtiquetteDao.findById(7);
	...
	public void testFindByLigneEtiquetteAndEntite() {
		...
		List<ChampLigneEtiquette> liste = champLigneEtiquetteDao
			.findByLigneEtiquetteAndEntite(le1, e3);
		assertTrue(liste.size() == 1);
		
		liste = champLigneEtiquetteDao.findByLigneEtiquetteAndEntite(
				le1, e8);
		assertTrue(liste.size() == 1);
	...
	public void testCrud() throws Exception {
		...
		LigneEtiquette le = ligneEtiquetteDao.findById(6);
		Champ c = champDao.findById(142);
		Entite e8 = entiteDao.findById(8);
		...
		ChampLigneEtiquette cle2 = champLigneEtiquetteDao
			.findById(new Integer(11));
		...
		assertTrue(champLigneEtiquetteDao.findById(
				new Integer(11)).getOrdre() == 2);
		assertTrue(champLigneEtiquetteDao.findById(
				new Integer(11)).getExpReg().equals("REG"));
	...
	public void testEquals() {
		...
		Integer o2 = 2;
		LigneEtiquette le1 = ligneEtiquetteDao.findById(1);
		LigneEtiquette le2 = ligneEtiquetteDao.findById(2);
		Champ c1 = champDao.findById(141);
		Champ c2 = champDao.findById(142);
	...
	public void testToString() {
		ChampLigneEtiquette cle1 = champLigneEtiquetteDao.findById(1);
		assertTrue(cle1.toString().equals("{" + cle1.getOrdre() + ", " 
				+ cle1.getLigneEtiquette().getOrdre() 
				+ "(LigneEtiquette) " 
	...
	public void testClone() {
		...
		if (cle1.getChampLigneEtiquetteId() != null) {
			assertTrue(cle1.getChampLigneEtiquetteId() 
				== cle2.getChampLigneEtiquetteId());
		} else {
		...
		if (cle1.getLigneEtiquette() != null) {
			assertTrue(cle1.getLigneEtiquette().equals(
					cle2.getLigneEtiquette()));
		} else {
