...
public class CederObjetPKTest extends AbstractDaoTest {
	...
	public void testEquals() throws ParseException {
		CederObjetPK pk1 = new CederObjetPK();
		CederObjetPK pk2 = new CederObjetPK();
	...
	private void populateClefsToTestEqualsAndHashCode() throws ParseException {
		...
		Integer objetId2 = 2;
		Integer objetId3 = 1;
		Integer[] objetsId = new Integer[]{null, objetId1, objetId2, objetId3};
		Cession c1 = cessionDao.findById(1);
		Cession c2 = cessionDao.findById(2);
		Cession c3 = cessionDao.findById(1);
		Cession[] cessions = new Cession[]{null, c1, c2, c3};
	...
	public void testToString() {
		...
		assertTrue(pk1.toString().
				equals("{" + pk1.getCession().toString() + " (Cession), " 
						+ pk1.getEntite().toString() + " (Entite), " 
						+ pk1.getObjetId() + " (ObjetId)}"));
