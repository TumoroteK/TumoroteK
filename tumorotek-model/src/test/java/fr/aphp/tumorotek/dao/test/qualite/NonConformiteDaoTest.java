...
public class NonConformiteDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		List<NonConformite> liste = nonConformiteDao.findAll();
	...
	public void testFindByTypeAndPf() {
		ConformiteType t1 = conformiteTypeDao.findById(1);
		Plateforme pf1 = plateformeDao.findById(1);
		List<NonConformite> liste = nonConformiteDao
			.findByTypeAndPf(t1, pf1);
	...
	public void testFindByTypePfAndNom() {
		...
		Plateforme pf1 = plateformeDao.findById(1);
		List<NonConformite> liste = nonConformiteDao
			.findByTypePfAndNom(t1, pf1, "Erreur dossier");
		assertTrue(liste.size() == 1);
		...
		ConformiteType t2 = conformiteTypeDao.findById(2);
		liste = nonConformiteDao.findByTypePfAndNom(
				t2, pf1, "Erreur dossier");
		assertTrue(liste.size() == 0);
		
		liste = nonConformiteDao.findByTypePfAndNom(
				null, pf2, "Erreur dossier");
		assertTrue(liste.size() == 0);
		
		liste = nonConformiteDao.findByTypePfAndNom(
				t1, null, "Erreur dossier");
		assertTrue(liste.size() == 0);
	...
	public void testCrud() throws Exception {
		...
		NonConformite n2 = nonConformiteDao.findById(id);
	...
	public void testEquals() {
		...
		NonConformite n1 = new NonConformite();
		NonConformite n2 = new NonConformite();
	...
	public void testToString() {
		...
		assertTrue(n1.toString().equals("{" 
				+ n1.getNom() + ", " 
				+ n1.getConformiteType().getConformiteType() 
				+ "(ConformiteType), " 
				+ n1.getPlateforme().getNom()
				+ "(Plateforme)}"));
