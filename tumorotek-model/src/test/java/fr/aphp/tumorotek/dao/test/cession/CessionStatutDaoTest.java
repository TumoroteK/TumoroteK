...
public class CessionStatutDaoTest extends AbstractDaoTest {
	...
	private String updatedStatut = "Mis a jour";
	...
	public void testReadAllCessionStatuts() {
		List<CessionStatut> liste = cessionStatutDao.findAll();
	...
	public void testFindByOrder() {
		List<CessionStatut> list = cessionStatutDao.findByOrder();
	...
	public void testFindByStatut() {
		List<CessionStatut> liste = cessionStatutDao
			.findByStatut("VALIDEE");
	...
	public void testCrudCessionStatut() throws Exception {
		...
		CessionStatut cs = new CessionStatut();
		...
		CessionStatut cs2 = cessionStatutDao.findById(new Integer(4));
		assertNotNull(cs2);
		assertTrue(cs2.getStatut().equals("TEST"));
		cs2.setStatut(updatedStatut);
		cessionStatutDao.updateObject(cs2);
		assertTrue(cessionStatutDao.findById(new Integer(4)).
				getStatut().equals(updatedStatut));
	...
	public void testEquals() {
		...
		CessionStatut cs1 = new CessionStatut();
		cs1.setStatut(statut);
		CessionStatut cs2 = new CessionStatut();
	...
	public void testHashCode() {
		...
		CessionStatut cs2 = new CessionStatut();
		cs2.setStatut(statut);
		CessionStatut cs3 = new CessionStatut();
		cs3.setStatut(null);
	...
	public void testToString() {
		CessionStatut cs1 = cessionStatutDao.findById(1);
		assertTrue(cs1.toString().
				equals("{" + cs1.getStatut() + "}"));
