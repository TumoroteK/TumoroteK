...
public class ContexteDaoTest extends AbstractDaoTest {
	...
	private String updatedNom = "Contexte mis a jour";
	...
	public void testReadAllContextes() {
		List<Contexte> contextes = contexteDao.findAll();
	...
	public void testFindByOrder() {
		List<Contexte> list = contexteDao.findByOrder();
	...
	public void testCrudCategorie() throws Exception {
		...
		Contexte c2 = contexteDao.findById(new Integer(3));
		assertNotNull(c2);
		assertTrue(c2.getNom().equals("CAT3"));
		c2.setNom(updatedNom);
		contexteDao.updateObject(c2);
		assertTrue(contexteDao.findById(new Integer(3)).getNom()
				.equals(updatedNom));
