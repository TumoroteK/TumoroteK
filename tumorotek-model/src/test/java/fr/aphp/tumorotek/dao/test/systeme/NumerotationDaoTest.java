...
public class NumerotationDaoTest extends AbstractDaoTest {
	...
	public void testReadAlls() {
		List<Numerotation> liste = numerotationDao.findAll();
	...
	public void testFindByBanqueAndEntite() {
		...
		List<Numerotation> liste = numerotationDao.
			findByBanqueAndEntite(b1, e2);
	...
	public void testFindByBanqueSelectEntite() {
		...
		List<Entite> liste = numerotationDao.
			findByBanqueSelectEntite(b1);
	...
	public void testCrud() throws Exception {
		...
		Entite e = entiteDao.findById(1);
		
		String code1 = "XXX[]";
		String code2 = "XXX[]XXX";
		...
		Numerotation num2 = numerotationDao.findById(new Integer(4));
		assertNotNull(num2);
		...
		assertTrue(numerotationDao.findById(new Integer(4)).
				getCodeFormula().equals(code2));
	...
	public void testEquals() throws ParseException {
		...
		Numerotation n2 = new Numerotation();
	...
	public void testToString() {
		Numerotation n1 = numerotationDao.findById(1);
		assertTrue(n1.toString().
				equals("{" + n1.getCodeFormula() + "}"));
	...
	public void testClone() {
		Numerotation num1 = numerotationDao.findById(1);
		...
		if (num1.getEntite() != null) {
			assertTrue(num1.getEntite()
					.equals(num2.getEntite()));
		} else {
			assertNull(num2.getEntite());
		}
		
		if (num1.getCodeFormula() != null) {
			assertTrue(num1.getCodeFormula()
					.equals(num2.getCodeFormula()));
		} else {
			assertNull(num2.getCodeFormula());
		}
		
		if (num1.getCurrentIncrement() != null) {
			assertTrue(num1.getCurrentIncrement() 
					== num2.getCurrentIncrement());
		} else {
		...
		if (num1.getZeroFill() != null) {
			assertTrue(num1.getZeroFill()
					.equals(num2.getZeroFill()));
		} else {
