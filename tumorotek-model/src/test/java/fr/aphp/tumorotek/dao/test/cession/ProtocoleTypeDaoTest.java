...
public class ProtocoleTypeDaoTest extends AbstractDaoTest {
	...
	public void testReadAllProtocoleTypes() {
		List<ProtocoleType> liste = protocoleTypeDao.findAll();
	...
	public void testFindByOrder() {
		...
		List< ? extends TKThesaurusObject> list = 
								protocoleTypeDao.findByOrder(pf);
	...
	public void testFindByType() {
		List<ProtocoleType> liste = protocoleTypeDao
			.findByType("RECHERCHE");
	...
	public void testFindByExcludedId() {
		...
		assertTrue(liste.size() == 1);
		ProtocoleType type = liste.get(0);
		assertNotNull(type);
	...
	public void testCrudProtocoleType() throws Exception {
		...
		ProtocoleType pt = new ProtocoleType();
		...
		ProtocoleType pt2 = protocoleTypeDao.findById(new Integer(3));
		assertNotNull(pt2);
		assertTrue(pt2.getType().equals("TEST"));
		pt2.setType(updatedType);
		protocoleTypeDao.updateObject(pt2);
		assertTrue(protocoleTypeDao.findById(new Integer(3)).
	...
	public void testEquals() {
		String type = "TYPE";
		String type2 = "TYPE2";
		ProtocoleType pt1 = new ProtocoleType();
		pt1.setType(type);
		ProtocoleType pt2 = new ProtocoleType();
		pt2.setType(type);
	...
	public void testHashCode() {
		...
		ProtocoleType pt2 = new ProtocoleType();
		pt2.setType(type);
		ProtocoleType pt3 = new ProtocoleType();
		pt3.setType(null);
	...
	public void testToString() {
		ProtocoleType pt1 = protocoleTypeDao.findById(1);
		assertTrue(pt1.toString().
				equals("{" + pt1.getType() + "}"));
