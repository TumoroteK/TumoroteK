...
public class PatientDaoTest extends AbstractDaoTest {
	...
	public void testToString() {
		...
		assertTrue(p1.toString()
				.equals("{" + p1.getNom() + " " + p1.getPrenom() + "}"));
		assertTrue(p1.listableObjectId().equals(new Integer(1)));
		assertTrue(p1.entiteNom()
				.equals(entiteDao.findByNom("Patient").get(0).getNom()));
		p1 = patientDao.findById(5);
		assertTrue(p1.toString()
				.equals("{" + p1.getNom() + " prenom inconnu}"));
		p1 = new Patient();
	...
	public void testFindByAllIds() {
		List<Integer> ids = patientDao.findByAllIds();
	...
	public void testFindByIncomplet() {
		List<Patient> patients = patientDao.findByEtatIncomplet();
		assertTrue(patients.size() == 1);
	}
	...
	public void testFindAllNips() {
		List<String> nips = patientDao.findAllNips();
	...
	public void testFindAllNoms() {
		List<String> noms = patientDao.findAllNoms();
	...
	public void testCrudPatient() throws Exception {
		...
		p.setPrenom("Margery");
		Date date = new SimpleDateFormat("dd/MM/yyyy").parse("24/03/1991");
		p.setDateNaissance(date);
		p.setVilleNaissance("Springfield");
		p.setPaysNaissance("USA");
		p.setPatientEtat("V");
		Date etat = new SimpleDateFormat("dd/MM/yyyy").parse("28/10/2009");
		p.setDateEtat(etat);
		p.setDateDeces(null);
		...
		Patient p2 = patientDao.findById(new Integer(6));
		assertNotNull(p2);
		...
		p.setPatientEtat("D");
		p.setDateEtat(null);
		Date deces = new SimpleDateFormat("dd/MM/yyyy").parse("13/10/2006");
	...
	private void populateClefsToTestEqualsAndHashCode(Patient p1, Patient p2) 
														throws ParseException {
		String[] noms = new String[]{null, "nom1", "nom2", "nom1"};
		String[] prenoms = new String[]{null, "prenom1", "prenom2", "prenom1"};
		Date date1 = new SimpleDateFormat("dd/MM/yyyy").parse("13/10/2006");
		Date date2 = new SimpleDateFormat("dd/MM/yyyy").parse("01/01/2001");
		Date date3 = new SimpleDateFormat("dd/MM/yyyy").parse("13/10/2006");
		Date[] dates = new Date[]{null, date1, date2, date3};
		String[] villes = new String[]{null, "ville1", "ville2", "ville1"};
	...
	public void testFindCountPrelevementsByBanqueOrNot() {
		...
		assertTrue(patientDao.findCountPrelevements(p)
												.get(0).equals(new Long(3)));
		assertTrue(patientDao.findCountPrelevementsByBanque(p, b)
												.get(0).equals(new Long(2)));
		p = patientDao.findById(1);
		assertTrue(patientDao
						.findCountPrelevements(p).get(0).equals(new Long(1)));
		assertTrue(patientDao.findCountPrelevementsByBanque(p, b)
												.get(0).equals(new Long(0)));
		p = patientDao.findById(2);
		assertTrue(patientDao
						.findCountPrelevements(p).get(0).equals(new Long(0)));
		assertTrue(patientDao.findCountPrelevementsByBanque(p, b)
												.get(0).equals(new Long(0)));
	}
	...
	public void testFindCountPrelevedByDatesSaisie() throws ParseException {
		...
		List<Long> res = patientDao
							.findCountPrelevedByDatesSaisie(d1, d2, banks);
	...
	public void testFindCountPrelevedByDatesPrel() throws ParseException {
		...
		List<Long> res = patientDao
							.findCountPrelevedByDatesPrel(d1, d2, banks);
		assertTrue(res.get(0) == 1);
	...
	public void testFindCountPrelevedByDatesSaisieExt() throws ParseException {
		...
		etabs.add(e4);
		List<Long> res = patientDao
					.findCountPrelevedByDatesSaisieExt(d1, d2, banks, etabs);
		assertTrue(res.get(0) == 2);
		...
		res = patientDao
					.findCountPrelevedByDatesSaisieExt(null, d2, banks, etabs);
		assertTrue(res.get(0) == 0);
		res = patientDao
			.findCountPrelevedByDatesSaisieExt(d1, null, banks, etabs);
		assertTrue(res.get(0) == 0);
		res = patientDao
			.findCountPrelevedByDatesSaisieExt(d1, d2, banks, null);
		assertTrue(res.get(0) == 0);
	}
	...
	public void testFindCountPrelevedByDatesPrelExt() throws ParseException {
		...
		etabs.add(e4);
		List<Long> res = patientDao
					.findCountPrelevedByDatesPrelExt(d1, d2, banks, etabs);
		assertTrue(res.get(0) == 1);
		...
		res = patientDao
			.findCountPrelevedByDatesPrelExt(null, d2, banks, etabs);
		assertTrue(res.get(0) == 0);
		res = patientDao
			.findCountPrelevedByDatesPrelExt(d1, null, banks, etabs);
		assertTrue(res.get(0) == 0);
		res = patientDao
			.findCountPrelevedByDatesPrelExt(d1, d2, banks, null);
		assertTrue(res.get(0) == 0);
	}
