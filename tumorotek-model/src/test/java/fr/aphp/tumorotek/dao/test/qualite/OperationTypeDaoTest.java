...
public class OperationTypeDaoTest extends AbstractDaoTest {
	...
	public void testReadAllOperationTypes() {
		List<OperationType> ops = operationTypeDao.findAll();
	...
	public void testCrudOperationType() throws Exception {
		...
		OperationType o2 = operationTypeDao.findById(o.getOperationTypeId());
		assertNotNull(o2);
		...
		assertTrue(operationTypeDao.findById(o2.getOperationTypeId()).getNom()
				.equals("Revenir"));
		assertFalse(operationTypeDao
				.findById(o2.getOperationTypeId()).getProfilable());
	...
	public void testEquals() {
		...
		String[] noms = new String[]{null, "nom1", "nom2", ""};
	...
	public void testHashCode() {
		...
		OperationType t3 = new OperationType();
