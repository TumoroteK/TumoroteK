...
public class ProdDeriveDaoTest extends AbstractDaoTest
{
   ...
   public void testCrud() throws Exception{
      ...
      final Banque b = banqueDao.findById(1);
      //assertNotNull(e);
      final ProdType pt = prodTypeDao.findById(1);
      assertNotNull(pt);
      p.setCode("code");
      //p.setEmplacement(e);
      p.setProdType(pt);
      ...
      final ProdDerive p2 = prodDeriveDao.findById(new Integer(5));
      assertNotNull(p2);
      ...
      assertNull(prodDeriveDao.findById(new Integer(5)).getConc());
      assertNull(prodDeriveDao.findById(new Integer(5)).getQuantite());
