...
public class TerminaleDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		List<Terminale> liste = terminaleDao.findAll();
	...
	public void testFindByEnceinteWithOrder() {
		...
		Enceinte e2 = enceinteDao.findById(1);
	...
	public void testFindByEnceinteAndNom() {
		Enceinte e1 = enceinteDao.findById(3);
		List<Terminale> liste = terminaleDao.findByEnceinteAndNom(
				e1, "BT1");
		assertTrue(liste.size() == 1);
		assertTrue(liste.get(0).getNom().equals("BT1"));
	...
	public void testFindByEnceinteAndPositionExcludedId() {
		Enceinte e1 = enceinteDao.findById(3);
		List<Terminale> liste = terminaleDao
			.findByEnceinteAndPositionExcludedId(e1, 1, 10);
		assertTrue(liste.size() == 1);
		assertTrue(liste.get(0).getNom().equals("BT1"));
		
		liste = terminaleDao
			.findByEnceinteAndPositionExcludedId(e1, 1, 1);
		assertTrue(liste.size() == 0);
		...
		liste = terminaleDao.findByEnceinteAndPositionExcludedId(
				null, null, null);
		assertTrue(liste.size() == 0);
	}
	...
	public void testFindByExcludedIdEnceinte() {
		...
		List<Terminale> liste = terminaleDao.findByExcludedIdEnceinte(
				1, e1);
		assertTrue(liste.size() == 0);
	...
	public void testFindByTwoExcludedIdsWithEnceinte() {
		Enceinte e3 = enceinteDao.findById(3);
		List<Terminale> liste = terminaleDao.findByTwoExcludedIdsWithEnceinte(
				4, 5, e3);
		assertTrue(liste.size() == 3);
	...
	public void testCrud() throws Exception {
		...
		Terminale t2 = terminaleDao.findById(new Integer(7));
		...
		assertTrue(terminaleDao.findById(
				new Integer(7)).getNom().equals(nomUp));
	...
	public void testClone() {
		...
		if (t1.getEnceinte() != null) {
			assertTrue(t1.getEnceinte()
					.equals(t2.getEnceinte()));
		} else {
			assertNull(t2.getEnceinte());
		}
		
		if (t1.getTerminaleType() != null) {
			assertTrue(t1.getTerminaleType()
					.equals(t2.getTerminaleType()));
		} else {
			assertNull(t2.getTerminaleType());
		}
		
		if (t1.getPosition() != null) {
			assertTrue(t1.getPosition()
					== t2.getPosition());
		} else {
		...
		if (t1.getArchive() != null) {
			assertTrue(t1.getArchive()
					.equals(t2.getArchive()));
		} else {
			assertNull(t2.getArchive());
		}
		
		if (t1.getBanque() != null) {
			assertTrue(t1.getBanque()
					.equals(t2.getBanque()));
		} else {
		...
		if (t1.getTerminaleNumerotation() != null) {
			assertTrue(t1.getTerminaleNumerotation()
					.equals(t2.getTerminaleNumerotation()));
		} else {
			assertNull(t2.getTerminaleNumerotation());
		}
		
		if (t1.getCouleur() != null) {
			assertTrue(t1.getCouleur()
					.equals(t2.getCouleur()));
		} else {
			assertNull(t2.getCouleur());
		}
		
		if (t1.getEmplacements() != null) {
			assertTrue(t1.getEmplacements()
					.equals(t2.getEmplacements()));
		} else {
