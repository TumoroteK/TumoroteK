...
public class ChampEntiteBlocDaoTest extends AbstractDaoTest {
	...
	public void setChampEntiteBlocDao(ChampEntiteBlocDao cDao) {
	...
	public void testReadAll() {
		List<ChampEntiteBloc> liste = 
			champEntiteBlocDao.findAll();
	...
	public void testFindById() {
		...
		ChampEntite ce23 = champEntiteDao.findById(23);
	...
	public void testFindByExcludedPK() {
		...
		List<ChampEntiteBloc> liste = 
			champEntiteBlocDao.findByExcludedPK(pk);
	...
	public void testFindByBlocImpression() {
		BlocImpression b1 = blocImpressionDao.findById(1);
		List<ChampEntiteBloc> liste = 
			champEntiteBlocDao.findByBlocImpression(b1);
		assertTrue(liste.size() == 3);
		
		BlocImpression b6 = blocImpressionDao.findById(6);
	...
	public void testCrud() {
		...
		ChampEntiteBloc ceb = new ChampEntiteBloc();
		BlocImpression b1 = blocImpressionDao.findById(1);
		ChampEntite ce1 = champEntiteDao.findById(1);
		Integer ordre = 5;
		Integer ordreUp = 6;
		...
		ChampEntiteBlocPK pk = new ChampEntiteBlocPK();
		pk.setBlocImpression(b1);
		pk.setChampEntite(ce1);
		ChampEntiteBloc ceb2 = champEntiteBlocDao.findById(pk);
		assertNotNull(ceb2);
		...
		assertTrue(champEntiteBlocDao.findById(pk)
				.getOrdre() == ordreUp);
	...
	public void testEquals() throws ParseException {
		...
		ChampEntiteBloc ceb1 = new ChampEntiteBloc();
	...
	public void testHashCode() throws ParseException {
		ChampEntiteBloc ceb1 = new ChampEntiteBloc();
		ChampEntiteBloc ceb2 = new ChampEntiteBloc();
		ChampEntiteBloc ceb3 = new ChampEntiteBloc();
	...
	private void populateClefsToTestEqualsAndHashCode(
			ChampEntiteBloc ceb1, 
			ChampEntiteBloc ceb2) throws ParseException {
		
		BlocImpression b1 = blocImpressionDao.findById(1);
		BlocImpression b2 = blocImpressionDao.findById(2);
		ChampEntite ce1 = champEntiteDao.findById(1);
		ChampEntiteBlocPK pk1 = new 
			ChampEntiteBlocPK(b1, ce1);
		ChampEntiteBlocPK pk2 = new 
			ChampEntiteBlocPK(b2, ce1);
		ChampEntiteBlocPK pk3 = new 
			ChampEntiteBlocPK(b1, ce1);
		ChampEntiteBlocPK[] pks = new 
			ChampEntiteBlocPK[]{null, pk1, pk2, pk3};
	...
	public void testToString() {
		BlocImpression b1 = blocImpressionDao.findById(1);
		ChampEntite ce1 = champEntiteDao.findById(23);
		ChampEntiteBlocPK pk1 = new 
			ChampEntiteBlocPK(b1, ce1);
		ChampEntiteBloc ceb1 = champEntiteBlocDao.findById(pk1);
		
		assertTrue(ceb1.toString().
				equals("{" + ceb1.getPk().toString() + "}"));
