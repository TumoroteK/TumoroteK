...
public class DroitObjetDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		List<DroitObjet> liste = droitObjetDao.findAll();
	...
	public void testFindByProfilOperation() {
		...
		List<DroitObjet> liste = 
			droitObjetDao.findByProfilOperation(p2, o1);
	...
	public void testCrud() {
		...
		DroitObjet dO = new DroitObjet();
		Profil p = profilDao.findById(1);
		Entite e = entiteDao.findById(5);
		OperationType op = operationTypeDao.findById(1);
		...
		DroitObjetPK pk = new DroitObjetPK();
		pk.setProfil(p);
		pk.setEntite(e);
		pk.setOperationType(op);
		DroitObjet doUp = droitObjetDao.findById(pk);
		assertNotNull(doUp);
	...
	private void populateClefsToTestEqualsAndHashCode(DroitObjet do1, 
			DroitObjet do2) throws ParseException {
		
		Profil p = profilDao.findById(1);
		OperationType op = operationTypeDao.findById(1);
		Entite e1 = entiteDao.findById(4);
		Entite e2 = entiteDao.findById(5);
		DroitObjetPK pk1 = new DroitObjetPK(p, e1, op);
		DroitObjetPK pk2 = new DroitObjetPK(p, e2, op);
		DroitObjetPK pk3 = new DroitObjetPK(p, e1, op);
		DroitObjetPK[] pks = new DroitObjetPK[]{null, pk1, pk2, pk3};
	...
	public void testToString() {
		...
		DroitObjetPK pk1 = new DroitObjetPK(p, e1, op);
		DroitObjet do1 = droitObjetDao.findById(pk1);
		
		assertTrue(do1.toString().
				equals("{" + do1.getPk().toString() + "}"));
