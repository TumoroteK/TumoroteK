...
public class TableAnnotationTemplatePKTest extends AbstractDaoTest {
	...
	public void testEquals() throws ParseException {
		TableAnnotationTemplatePK pk1 = new TableAnnotationTemplatePK();
		TableAnnotationTemplatePK pk2 = new TableAnnotationTemplatePK();
	...
	private void populateClefsToTestEqualsAndHashCode() throws ParseException {
		...
		TableAnnotation ta3 = tableAnnotationDao.findById(1);
		TableAnnotation[] tables = new TableAnnotation[]{null, ta1, ta2, ta3};
		Template t1 = templateDao.findById(1);
		Template t2 = templateDao.findById(2);
		Template t3 = templateDao.findById(1);
		Template[] templates = new Template[]{null, t1, t2, t3};
	...
	public void testToString() {
		...
		assertTrue(pk1.toString().
				equals("{" + pk1.getTemplate().toString() + " (Template), " 
						+ pk1.getTableAnnotation().toString() 
						+ " (TableAnnotation)}"));
