...
public class CouleurEntiteTypeDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		List<CouleurEntiteType> liste = couleurEntiteTypeDao.findAll();
	...
	public void testFindByBanqueAllEchanType() {
		Banque b1 = banqueDao.findById(1);
		List<CouleurEntiteType> liste = couleurEntiteTypeDao
			.findByBanqueAllEchanType(b1);
	...
	public void testCrudCollaborateur() throws Exception {
		...
		CouleurEntiteType c = new CouleurEntiteType();
		Couleur couleur = couleurDao.findById(1);
		Couleur couleurUp = couleurDao.findById(2);
		Banque bank = banqueDao.findById(1);
		...
		CouleurEntiteType c2 = couleurEntiteTypeDao.findById(new Integer(4));
		...
		assertTrue(couleurEntiteTypeDao.findById(
				new Integer(4)).getCouleur().equals(couleurUp));
		// Test de la délétion
	...
	public void testEquals() {
		...
		EchantillonType eType = echantillonTypeDao.findById(1);
		EchantillonType eType2 = echantillonTypeDao.findById(2);
		ProdType pType = prodTypeDao.findById(1);
		ProdType pType2 = prodTypeDao.findById(2);
		CouleurEntiteType c1 = new CouleurEntiteType();
		CouleurEntiteType c2 = new CouleurEntiteType();
	...
	public void testToString() {
		CouleurEntiteType c1 = couleurEntiteTypeDao.findById(1);
		assertTrue(c1.toString().equals("{" + c1.getCouleur() + ", " 
				+ c1.getBanque() + ", " 
				+ c1.getEchantillonType() 
				+ ", " + c1.getProdType() + "}"));
	...
	public void testClone() {
		CouleurEntiteType c1 = couleurEntiteTypeDao.findById(1);
		CouleurEntiteType c2 = c1.clone();
		assertTrue(c1.equals(c2));
		
		if (c1.getCouleurEntiteTypeId() != null) {
			assertTrue(c1.getCouleurEntiteTypeId() 
				== c2.getCouleurEntiteTypeId());
		} else {
