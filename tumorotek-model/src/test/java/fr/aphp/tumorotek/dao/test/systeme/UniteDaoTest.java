...
public class UniteDaoTest extends AbstractDaoTest
{
   ...
   private final String updatedUnite = "Unite mise a jour";
   ...
   public void testReadAllUnites(){
      final List<Unite> unites = uniteDao.findAll();
   ...
   public void testCrudUnite() throws Exception{
      ...
      final Unite u2 = uniteDao.findById(new Integer(15));
      assertNotNull(u2);
      assertTrue(u2.getUnite().equals("ML"));
      u2.setUnite(updatedUnite);
      uniteDao.updateObject(u2);
      assertTrue(uniteDao.findById(new Integer(15)).getUnite().equals(updatedUnite));
   ...
   public void testToString(){
      final Unite u1 = uniteDao.findById(1);
      assertTrue(u1.toString().equals("{" + u1.getUnite() + ", " + u1.getType() + "}"));
