...
public class ConsentTypeDaoTest extends AbstractDaoTest {
	...
	public void testReadAllConsentType() {
		List<ConsentType> types = consentTypeDao.findAll();
	...
	public void testCrudConsentType() throws Exception {
		...
		ConsentType ct2 = consentTypeDao.findById(new Integer(4));
		assertNotNull(ct2);
		assertTrue(ct2.getType().equals("INCONNU"));
		ct2.setType(updatedType);
		consentTypeDao.updateObject(ct2);
		assertTrue(consentTypeDao.findById(new Integer(4)).getType()
				.equals(updatedType));
	...
	public void testHashCode() {
		...
		ct2.setType(type);
		ConsentType ct3 = new ConsentType();
