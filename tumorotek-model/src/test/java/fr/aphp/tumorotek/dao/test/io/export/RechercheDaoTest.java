...
public void testFindByRequete(){
      ...
      final Requete r3 = requeteDao.findById(3);
...
public void testCrudRecherche() throws Exception{
      ...
      final Recherche r2 = this.rechercheDao.findById(r.getRechercheId());
      assertNotNull(r2);
      ...
      final Iterator<Banque> it = rechercheDao.findById(idObject).getBanques().iterator();
      while(it.hasNext()){
      ...
      final Utilisateur updatedCreateur = this.utilisateurDao.findById(idCreateur2);
      final String updatedIntitule = "intitule2";
      final Requete updatedRequete = this.requeteDao.findById(idRequete2);
      final Affichage updatedAffichage = this.affichageDao.findById(idAffichage2);
      ...
      assertNotNull(this.rechercheDao.findById(idObject).getCreateur());
      assertTrue(this.rechercheDao.findById(idObject).getCreateur().equals(updatedCreateur));
      assertNotNull(this.rechercheDao.findById(idObject).getAffichage());
      assertTrue(this.rechercheDao.findById(idObject).getAffichage().equals(updatedAffichage));
      assertNotNull(this.rechercheDao.findById(idObject).getRequete());
      assertTrue(this.rechercheDao.findById(idObject).getRequete().equals(updatedRequete));
      assertNotNull(this.rechercheDao.findById(idObject).getBanques());
