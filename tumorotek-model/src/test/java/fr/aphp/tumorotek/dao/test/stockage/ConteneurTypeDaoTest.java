...
public class ConteneurTypeDaoTest extends AbstractDaoTest {
	...
	public void testReadAlls() {
		List<ConteneurType> liste = conteneurTypeDao.findAll();
	...
	public void testFindByOrder() {
		...
		List< ? extends TKThesaurusObject> list = 
								conteneurTypeDao.findByOrder(pf);
	...
	public void testFindByExcludedId() {
		...
		ConteneurType type = liste.get(0);
		assertNotNull(type);
	...
	public void testCrud() throws Exception {
		...
		ConteneurType ct = new ConteneurType();
		...
		ConteneurType ct2 = conteneurTypeDao.findById(new Integer(4));
		assertNotNull(ct2);
		assertTrue(ct2.getType().equals("Type"));
		ct2.setType(updatedType);
		conteneurTypeDao.updateObject(ct2);
		assertTrue(conteneurTypeDao.findById(new Integer(4)).
	...
	public void testEquals() {
		String type = "TYPE";
		String type2 = "TYPE2";
		ConteneurType ct1 = new ConteneurType();
		ct1.setType(type);
		ConteneurType ct2 = new ConteneurType();
		ct2.setType(type);
	...
	public void testHashCode() {
		...
		ConteneurType ct2 = new ConteneurType();
		ct2.setType(type);
		ConteneurType ct3 = new ConteneurType();
		ct3.setType(type);
	...
	public void testToString() {
		ConteneurType ct1 = conteneurTypeDao.findById(1);
