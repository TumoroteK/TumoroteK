...
public class LigneEtiquetteDaoTest extends AbstractDaoTest {
	...
	public void testFindById() {
		LigneEtiquette le = ligneEtiquetteDao.findById(1);
		assertNotNull(le);
		
		LigneEtiquette leNull = ligneEtiquetteDao.findById(100);
		assertNull(leNull);
	}
	...
	public void testReadAll() {
		List<LigneEtiquette> liste = ligneEtiquetteDao.findAll();
	...
	public void testCrud() throws Exception {
		...
		LigneEtiquette le2 = ligneEtiquetteDao.findById(new Integer(8));
		...
		assertTrue(ligneEtiquetteDao.findById(
				new Integer(8)).getOrdre() == 2);
		assertFalse(ligneEtiquetteDao.findById(
				new Integer(8)).getIsBarcode());
	...
	public void testToString() {
		LigneEtiquette l1 = ligneEtiquetteDao.findById(1);
		assertTrue(l1.toString().
				equals("{" + l1.getOrdre() + ", " 
				+ l1.getModele().getNom() + "(Modele)}"));
	...
	public void testClone() {
		...
		if (l1.getChampLigneEtiquettes() != null) {
			assertTrue(l1.getChampLigneEtiquettes()
					.equals(l2.getChampLigneEtiquettes()));
		} else {
