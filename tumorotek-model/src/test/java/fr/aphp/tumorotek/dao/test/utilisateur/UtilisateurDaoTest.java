...
public class UtilisateurDaoTest extends AbstractDaoTest {
	...
	public void testFindByOrder() {
		List<Utilisateur> utilisateurs = utilisateurDao.findByOrder();
	...
	public void testFindByLoginAndArchive() {
		...
		List<Utilisateur> utilisateurs = utilisateurDao
			.findByLoginAndArchive("USER1", false, pfs);
		assertTrue(utilisateurs.size() == 1);
		
		utilisateurs = utilisateurDao
			.findByLoginAndArchive("USER1", true, pfs);
		assertTrue(utilisateurs.size() == 0);
		
		utilisateurs = utilisateurDao
					.findByLoginAndArchive("USER", true, pfs);
		assertTrue(utilisateurs.size() == 0);
		...
		assertTrue(utilisateurs.size() == 0);
		utilisateurs = utilisateurDao
			.findByLoginAndArchive("USER4", false, pfs);
		assertTrue(utilisateurs.size() == 1);
	}
	...
	public void testFindByArchive() {
		...
		List<Utilisateur> utilisateurs = 
			utilisateurDao.findByArchive(false, pfs);
	...
	public void testFindByOrderWithArchive() {
		...
		pfs.add(plateformeDao.findById(1));
		List<Utilisateur> utilisateurs = utilisateurDao
			.findByOrderWithArchive(false, pfs);
		assertTrue(utilisateurs.size() == 2);
		pfs.add(plateformeDao.findById(2));
		utilisateurs = utilisateurDao.findByArchive(false, pfs);
		assertTrue(utilisateurs.size() == 3);
		...
		utilisateurs = utilisateurDao
			.findByOrderWithArchive(true, pfs);
		assertTrue(utilisateurs.size() == 1);
	}
	...
	public void testFindByCollaborateur() {
		...
		List<Utilisateur> utilisateurs = utilisateurDao.
				findByCollaborateur(c);
		assertTrue(utilisateurs.size() == 1);
		Collaborateur c2 = collaborateurDao.findById(4);
	...
	public void testFindByLoginPassAndArchive() {
		List<Utilisateur> utilisateurs = 
			utilisateurDao.findByLoginPassAndArchive("USER5",
					"b383bb08bd750d8ef04d034ad648a208", false);
		assertTrue(utilisateurs.size() == 1);
		
		utilisateurs =  utilisateurDao.findByLoginPassAndArchive("USER6",
					"b383bb08bd750d8ef04d034ad648a208", false);
		assertTrue(utilisateurs.size() == 0);
		
		utilisateurs =  utilisateurDao.findByLoginPassAndArchive("USER5",
				"b383bb08bd750d8ef04d034ad648a208qcqsc", false);
		assertTrue(utilisateurs.size() == 0);
		
		utilisateurs =  utilisateurDao.findByLoginPassAndArchive("USER5",
				"b383bb08bd750d8ef04d034ad648a208", true);
		assertTrue(utilisateurs.size() == 0);
	}
	...
	public void testCrudUtilisateur() throws Exception {
		...
		Collaborateur c = collaborateurDao.findById(4);
		...
		Date dateTest = new SimpleDateFormat("dd/MM/yyyy").parse("25/11/2011");
		...
		Utilisateur u2 = utilisateurDao.findById(id);
		assertNotNull(u2);
		...
		assertTrue(utilisateurDao.findById(
				id).getLogin().equals(updatedLogin));
	...
	public void testClone() {
		...
		if (u1.getPassword() != null) {
			assertTrue(u1.getPassword()
					.equals(u2.getPassword()));
		} else {
		...
		if (u1.getEncodedPassword() != null) {
			assertTrue(u1.getEncodedPassword()
					.equals(u2.getEncodedPassword()));
		} else {
			assertNull(u2.getEncodedPassword());
		}
		
		if (u1.getDnLdap() != null) {
			assertTrue(u1.getDnLdap()
					.equals(u2.getDnLdap()));
		} else {
		...
		if (u1.getCollaborateur() != null) {
			assertTrue(u1.getCollaborateur()
					.equals(u2.getCollaborateur()));
		} else {
		...
		if (u1.getCodeSelects() != null) {
			assertTrue(u1.getCodeSelects()
					.equals(u2.getCodeSelects()));
		} else {
			assertNull(u2.getCodeSelects());
		}
				
		if (u1.getCodeUtilisateurs() != null) {
			assertTrue(u1.getCodeUtilisateurs()
					.equals(u2.getCodeUtilisateurs()));
		} else {
			assertNull(u2.getCodeUtilisateurs());
		}
		
		if (u1.getProfilUtilisateurs() != null) {
			assertTrue(u1.getProfilUtilisateurs()
					.equals(u2.getProfilUtilisateurs()));
		} else {
			assertNull(u2.getProfilUtilisateurs());
		}
		
		if (u1.getReservations() != null) {
			assertTrue(u1.getReservations()
					.equals(u2.getReservations()));
		} else {
			assertNull(u2.getReservations());
		}
		
		if (u1.getPlateformes() != null) {
			assertTrue(u1.getPlateformes()
					.equals(u2.getPlateformes()));
		} else {
			assertNull(u2.getPlateformes());
		}
		
		if (u1.getAffectationImprimantes() != null) {
			assertTrue(u1.getAffectationImprimantes()
					.equals(u2.getAffectationImprimantes()));
		} else {
			assertNull(u2.getAffectationImprimantes());
		}
		assertTrue(u1.getPlateformeOrig()
							.equals(u2.getPlateformeOrig()));
