...
public class CategorieDaoTest extends AbstractDaoTest {
	...
	private String updatedNom = "Cat mis a jour";
	 ...
	 */
	public void setCategorieDaoJpa(CategorieDao cDao) {
	...
	public void testFindByOrder() {
		List<Categorie> list = categorieDao.findByOrder();
	...
	public void testCrudCategorie() throws Exception {
		...
		Categorie c2 = categorieDao.findById(new Integer(3));
		assertNotNull(c2);
		assertTrue(c2.getNom().equals("CAT3"));
		c2.setNom(updatedNom);
		categorieDao.updateObject(c2);
		assertTrue(categorieDao.findById(new Integer(3)).getNom()
				.equals(updatedNom));
