...
/**
 *
 * Classe de test pour le DAO EntiteDao et le bean du domaine Entite. Classe
 * créée le 29/09/09.
 *
...
public class EntiteDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		final List<Entite> entites = IterableUtils.toList(IterableUtils.toList(entiteDao.findAll()));
	...
	public void testCrud() throws Exception {
		...
		final Entite e2 = entiteDao.findById(e.getEntiteId()).get();
		assertNotNull(e2);
		...
		entiteDao.save(e2);
		assertTrue(entiteDao.findById(e2.getEntiteId()).get().getNom().equals(updatedEntite));

		// Test de la délétion
		entiteDao.deleteById(e2.getEntiteId());
		assertFalse(entiteDao.findById(e2.getEntiteId()).isPresent());
