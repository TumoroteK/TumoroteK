...
public class EntiteDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		List<Entite> entites = entiteDao.findAll();
	...
	public void testFindAnnotables() {
		List<Entite> entites = entiteDao.findAnnotables();
	...
	public void testCrud() throws Exception {
		...
		Entite e2 = entiteDao.findById(e.getEntiteId());
		assertNotNull(e2);
		...
		assertTrue(entiteDao.findById(e2.getEntiteId()).
				getNom().equals(updatedEntite));
