...
public class ProfilUtilisateurPKTest extends AbstractDaoTest {
	...
	public void testEquals() throws ParseException {
		ProfilUtilisateurPK pk1 = new ProfilUtilisateurPK();
		ProfilUtilisateurPK pk2 = new ProfilUtilisateurPK();
	...
	public void testToString() {
		...
		assertTrue(pk1.toString().
				equals("{" + pk1.getProfil().toString() + " (Profil), " 
						+ pk1.getUtilisateur().toString() + " (Utilisateur), " 
						+ pk1.getBanque() + " (Banque)}"));
