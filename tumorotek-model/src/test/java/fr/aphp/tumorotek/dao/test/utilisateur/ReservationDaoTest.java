...
public class ReservationDaoTest extends AbstractDaoTest
{
   ...
   private final String updatedDate = "28/07/2009";
   ...
   public void testFindByDebutAfterDate() throws Exception{
      ...
      List<Reservation> reservations = reservationDao.findByDebutAfterDate(search);
   ...
   public void testFindByFinBeforeDate() throws Exception{
      ...
      List<Reservation> reservations = reservationDao.findByFinBeforeDate(search);
   ...
   public void testFindByDateBetweenDebutFin() throws Exception{
      ...
      List<Reservation> reservations = reservationDao.findByDateBetweenDebutFin(search);
      assertTrue(reservations.size() == 2);
      search = new SimpleDateFormat("dd/MM/yyyy").parse("01/01/1990");
   ...
   public void testFindByUtilisateurId(){
      ...
      assertTrue(reservations.size() == 2);
      final Utilisateur u2 = utilisateurDao.findById(3);
   ...
   public void testFindByIdWithFetch(){
      final List<Reservation> reservations = reservationDao.findByIdWithFetch(1);
   ...
   public void testCrudReservation() throws Exception{
      ...
      final Date deb = new SimpleDateFormat("dd/MM/yyyy").parse("15/02/2009");
      final Date fin = new SimpleDateFormat("dd/MM/yyyy").parse("15/08/2009");
      final Date up = new SimpleDateFormat("dd/MM/yyyy").parse(updatedDate);
      // Test de l'insertion
      r.setDebut(deb);
      r.setFin(fin);
      r.setUtilisateur(u);
      ...
      final Reservation r2 = reservationDao.findById(new Integer(5));
      assertNotNull(r2);
      ...
      assertTrue(reservationDao.findById(new Integer(5)).getDebut().getTime() == up.getTime());
   ...
   public void testEquals() throws Exception{
      final Date deb1 = new SimpleDateFormat("dd/MM/yyyy").parse("15/02/2009");
      final Date fin1 = new SimpleDateFormat("dd/MM/yyyy").parse("15/08/2009");
      final Date deb2 = new SimpleDateFormat("dd/MM/yyyy").parse("15/02/2008");
      final Date fin2 = new SimpleDateFormat("dd/MM/yyyy").parse("15/08/2008");
   ...
   public void testHashCode() throws Exception{
      final Date deb1 = new SimpleDateFormat("dd/MM/yyyy").parse("15/02/2009");
      final Date fin1 = new SimpleDateFormat("dd/MM/yyyy").parse("15/08/2009");
      final Reservation r1 = new Reservation(1, deb1, fin1);
      final Reservation r2 = new Reservation(2, deb1, fin1);
      final Reservation r3 = new Reservation(3, null, null);
   ...
   public void testToString(){
      final Reservation r1 = reservationDao.findById(1);
      assertTrue(r1.toString().equals("{" + r1.getDebut() + " - " + r1.getFin() + "}"));
   ...
   public void testClone(){
      ...
      if(r1.getFin() != null){
         assertTrue(r1.getFin().equals(r2.getFin()));
      }else{
         assertNull(r2.getFin());
      }

      if(r1.getUtilisateur() != null){
         assertTrue(r1.getUtilisateur().equals(r2.getUtilisateur()));
      }else{
         assertNull(r2.getUtilisateur());
      }

      if(r1.getEchantillons() != null){
         assertTrue(r1.getEchantillons().equals(r2.getEchantillons()));
      }else{
         assertNull(r2.getEchantillons());
      }

      if(r1.getProdDerives() != null){
         assertTrue(r1.getProdDerives().equals(r2.getProdDerives()));
      }else{
