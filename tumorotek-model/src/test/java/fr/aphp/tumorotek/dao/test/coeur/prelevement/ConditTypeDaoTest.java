...
public class ConditTypeDaoTest extends AbstractDaoTest {
	...
	public void testReadAllConditType() {
		List<ConditType> types = conditTypeDao.findAll();
	...
	public void testCrudConditType() throws Exception {
		...
		ConditType ct2 = conditTypeDao.findById(new Integer(3));
		assertNotNull(ct2);
		assertTrue(ct2.getType().equals("AUTRE"));
		ct2.setType(updatedType);
		conditTypeDao.updateObject(ct2);
		assertTrue(conditTypeDao.findById(new Integer(3)).getType()
				.equals(updatedType));
