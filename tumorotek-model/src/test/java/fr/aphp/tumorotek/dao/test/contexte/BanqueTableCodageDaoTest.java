...
public class BanqueTableCodageDaoTest extends AbstractDaoTest {
	...
	public void setBanqueTableCodageDao(BanqueTableCodageDao b) {
		this.banqueTableCodageDao = b;
	}

	public void setBanqueDao(BanqueDao b) {
		this.banqueDao = b;
	}

	public void setTableCodageDao(TableCodageDao t) {
	...
	public void testToString() {
		BanqueTableCodagePK pk = 
			new BanqueTableCodagePK(banqueDao.findById(1),
												tableCodageDao.findById(1));
		BanqueTableCodage btc1 = banqueTableCodageDao.findById(pk);
		assertTrue(btc1.toString()
				.equals("{" + btc1.getBanque().getNom() + " - " 
								+ btc1.getTableCodage().getNom() + "}"));
	...
	public void testReadAllBanqueTableCodage() {
		List<BanqueTableCodage> btcs = banqueTableCodageDao.findAll();
	...
	public void testCrud() {
		BanqueTableCodage btc = new BanqueTableCodage();
		Banque b2 = banqueDao.findById(2);
		TableCodage t3 = tableCodageDao.findById(3);
		btc.setBanque(b2);
		...
		BanqueTableCodagePK pk = new BanqueTableCodagePK();
		pk.setBanque(b2);
		pk.setTableCodage(t3);
		BanqueTableCodage btc2 = banqueTableCodageDao.findById(pk);
		assertNotNull(btc2);
