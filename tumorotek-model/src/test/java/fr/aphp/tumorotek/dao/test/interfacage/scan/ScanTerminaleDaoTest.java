...
public class ScanTerminaleDaoTest extends AbstractDaoTest
{
   ...
   public synchronized void setScanDeviceDao(final ScanDeviceDao _s){
   ...
   public void testCrudScanTerminale() throws Exception{
      ...
      final ScanDevice visionMate = scanDeviceDao.findById(1);
      st1.setName("BT1");
      ...
      final ScanTerminale st2 = scanTerminaleDao.findById(st1.getScanTerminaleId());
