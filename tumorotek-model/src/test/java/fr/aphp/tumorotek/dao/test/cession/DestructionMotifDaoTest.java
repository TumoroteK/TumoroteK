...
public class DestructionMotifDaoTest extends AbstractDaoTest {
	...
	private String updatedMotif = "Mis a jour";
	...
	public void testReadAllDestructionMotifs() {
		List<DestructionMotif> liste = destructionMotifDao.findAll();
	...
	public void testFindByOrder() {
		...
		List< ? extends TKThesaurusObject> list = 
								destructionMotifDao.findByOrder(pf);
	...
	public void testFindByMotif() {
		List<DestructionMotif> liste = destructionMotifDao
			.findByMotif("INUTILISABLE");
	...
	public void testFindByExcludedId() {
		...
		DestructionMotif motif = liste.get(0);
		assertNotNull(motif);
	...
	public void testCrudDestructionMotif() throws Exception {
		...
		DestructionMotif de = new DestructionMotif();
		...
		DestructionMotif de2 = destructionMotifDao.findById(new Integer(4));
		assertNotNull(de2);
		assertTrue(de2.getMotif().equals("TEST"));
		de2.setMotif(updatedMotif);
		destructionMotifDao.updateObject(de2);
		assertTrue(destructionMotifDao.findById(new Integer(4)).
				getMotif().equals(updatedMotif));
	...
	public void testEquals() {
		String motif = "MOTIF";
		String motif2 = "MOTIF2";
		DestructionMotif de1 = new DestructionMotif();
		de1.setMotif(motif);
		DestructionMotif de2 = new DestructionMotif();
		de2.setMotif(motif);
	...
	public void testHashCode() {
		...
		DestructionMotif de2 = new DestructionMotif();
		de2.setMotif(motif);
		DestructionMotif de3 = new DestructionMotif();
		de3.setMotif(null);
	...
	public void testToString() {
		DestructionMotif de1 = destructionMotifDao.findById(1);
		assertTrue(de1.toString().
				equals("{" + de1.getMotif() + "}"));
