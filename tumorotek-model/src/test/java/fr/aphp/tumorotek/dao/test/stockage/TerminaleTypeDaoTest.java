...
public class TerminaleTypeDaoTest extends AbstractDaoTest
{
   ...
   public void testReadAlls(){
      final List<TerminaleType> liste = terminaleTypeDao.findAll();
   ...
   public void testCrud() throws Exception{
      ...
      final TerminaleType tt2 = terminaleTypeDao.findById(new Integer(7));
      assertNotNull(tt2);
      ...
      assertTrue(terminaleTypeDao.findById(new Integer(7)).getType().equals(updatedType));
      assertTrue(terminaleTypeDao.findById(new Integer(7)).getDepartNumHaut());
   ...
   public void testToString(){
      final TerminaleType tt1 = terminaleTypeDao.findById(1);
   ...
   public void testClone(){
      final TerminaleType t1 = terminaleTypeDao.findById(1);
