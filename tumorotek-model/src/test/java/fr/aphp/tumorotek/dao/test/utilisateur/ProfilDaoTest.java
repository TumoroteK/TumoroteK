...
public class ProfilDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		List<Profil> liste = profilDao.findAll();
	...
	public void testFindByOrder() {
		List<Profil> liste = profilDao.findByOrder();
		assertTrue(liste.size() == 5);
		assertTrue(liste.get(0).getNom()
				.equals("ADMINISTRATEUR DE COLLECTION"));
	...
	public void testCrud() throws Exception {
		...
		Integer pId = p.getProfilId();
		
		Profil p2 = profilDao.findById(pId);
	...
	public void testEquals() {
		...
		p2.setPlateforme(null);
		assertFalse(p1.equals(p2));
		Plateforme newPF = new Plateforme();
	...
	public void testClone() {
		...
		if (p1.getAnonyme() != null) {
			assertTrue(p1.getAnonyme()
					.equals(p2.getAnonyme()));
		} else {
			assertNull(p2.getAnonyme());
		}
		
		if (p1.getAccesAdministration() != null) {
			assertTrue(p1.getAccesAdministration()
					.equals(p2.getAccesAdministration()));
		} else {
			assertNull(p2.getAccesAdministration());
		}
		
		if (p1.getDroitObjets() != null) {
			assertTrue(p1.getDroitObjets()
					.equals(p2.getDroitObjets()));
		} else {
			assertNull(p2.getDroitObjets());
		}
		
		if (p1.getProfilUtilisateurs() != null) {
			assertTrue(p1.getProfilUtilisateurs()
					.equals(p2.getProfilUtilisateurs()));
		} else {
