...
public void testCrudCederObjet(){
      ...
      final Unite u = uniteDao.findById(1);
      ...
      final CederObjet co2 = cederObjetDao.findById(pk);
      assertNotNull(co2);
...
public void testToString(){
      ...
      final CederObjet co1 = cederObjetDao.findById(pk);
...
public void testFindCodesEchantillonByCession(){
      ...
      final Cession c1 = cessionDao.findById(1);
      final Cession c2 = cessionDao.findById(2);
      final Cession c3 = cessionDao.findById(3);
