...
public class DummyTest extends AbstractDaoTest //FIXME non lancé dans mavent surefire ?
{
   ...
   public void setCollaborateurDao(final CollaborateurDao collaborateurDao){
   ...
   public void testAssoc2(){
      final Banque banque = banqueDao.findById(new Integer(2));
      System.out.println(banque);
      final List<Echantillon> echs = echantillonDao.findByCode("TUM%");
      assertNotNull(echs);
   }
