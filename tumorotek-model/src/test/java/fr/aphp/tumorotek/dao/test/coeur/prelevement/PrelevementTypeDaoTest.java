...
public class PrelevementTypeDaoTest extends AbstractDaoTest {
	...
	private String updatedType = "Type mis a jour";
	private String updatedInca = "M";
	 ...
	 */
	public void setPrelevementTypeDao(PrelevementTypeDao tDao) {
	...
	public void testReadAllTypes() {
		List<PrelevementType> types = prelevementTypeDao.findAll();
	...
	public void testFindByOrder() {
		...
		List< ? extends TKThesaurusObject> list = 
								prelevementTypeDao.findByOrder(pf);
	...
	public void testFindByExcludedId() {
		List<PrelevementType> liste = prelevementTypeDao
			.findByExcludedId(1);
		assertTrue(liste.size() == 3);
		PrelevementType type = liste.get(0);
		assertNotNull(type);
	...
	public void testCrudPrelevementType() throws Exception {
		PrelevementType t = new PrelevementType();		
		...
		PrelevementType t2 = prelevementTypeDao.findById(new Integer(5));
		assertNotNull(t2);
		...
		assertTrue(prelevementTypeDao.findById(new Integer(5)).getType()
				.equals(updatedType));
		assertTrue(prelevementTypeDao.findById(new Integer(5)).getIncaCat()
				.equals(updatedInca));
	...
	public void testEquals() {
		...
		String inca = "I";
		String inca2 = "J";
		PrelevementType t1 = new PrelevementType();
		//t1.setType(type);
		PrelevementType t2 = new PrelevementType();
		//t2.setType(type);
		...
		String[] types = new String[]{null, type, type2, ""};
		String[] incas = new String[]{null, inca, inca2, ""};
	...
	public void testHashCode() {
		...
		t2.setType(type);
		t2.setIncaCat(inca);
		PrelevementType t3 = new PrelevementType();
