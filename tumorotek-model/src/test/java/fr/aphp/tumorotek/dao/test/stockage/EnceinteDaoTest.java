...
public class EnceinteDaoTest extends AbstractDaoTest
{
   ...
   public void testReadAll(){
      final List<Enceinte> liste = enceinteDao.findAll();
   ...
   public void testFindByEnceintePereAndNom(){
      ...
      final Enceinte e2 = enceinteDao.findById(3);
   ...
   public void testFindByConteneurAndPosition(){
      ...
      final Conteneur c2 = conteneurDao.findById(3);
   ...
   public void testCrud() throws Exception{
      ...
      final Enceinte e2 = enceinteDao.findById(new Integer(8));
      ...
      assertTrue(enceinteDao.findById(new Integer(8)).getNom().equals(nomUp));
      assertTrue(enceinteDao.findById(new Integer(8)).getBanques().size() == 2);
   ...
   public void testClone(){
      final Enceinte enceinte1 = enceinteDao.findById(1);
