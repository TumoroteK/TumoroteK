...
public void testCrud() throws Exception{
      ...
      final TableCodage t1 = tableCodageDao.findById(4);
      ...
      final CodeUtilisateur c2 = codeUtilisateurDao.findById(new Integer(7));
      assertNotNull(c2);
...
public void testEqualsAndHashCodeTranscodeUtilisateur(){
      ...
      final CodeUtilisateur c1 = codeUtilisateurDao.findById(1);
      final CodeUtilisateur c2 = codeUtilisateurDao.findById(2);
      final CodeUtilisateur c3 = new CodeUtilisateur();
