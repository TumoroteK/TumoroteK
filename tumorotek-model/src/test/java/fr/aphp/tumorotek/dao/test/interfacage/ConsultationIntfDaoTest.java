...
/**
 *
 * Classe de test pour le DAO ConsultationIntfDao et le bean du domaine
 * ConsultationIntf.
 *
...
public class ConsultationIntfDaoTest extends AbstractDaoTest {
	...
	public void testFindByUtilisateurInDates() throws ParseException {
		...
		liste = consultationIntfDao.findByUtilisateurInDates(utilisateurDao.findById(2).get(), c1, c2);
		assertTrue(liste.size() == 0);

		liste = consultationIntfDao.findByUtilisateurInDates(utilisateurDao.findById(3).get(), c1, c2);
	...
	public void testFindByUtilisateurEmetteurInDates() throws ParseException {
		...
		liste = consultationIntfDao.findByUtilisateurEmetteurInDates(utilisateurDao.findById(2).get(), "%", c1, c2);
		assertTrue(liste.size() == 0);

		liste = consultationIntfDao.findByUtilisateurEmetteurInDates(utilisateurDao.findById(3).get(), "APIX v2.3", c1,
				c2);
		assertTrue(liste.size() == 1);

		liste = consultationIntfDao.findByUtilisateurEmetteurInDates(utilisateurDao.findById(3).get(), "APIX", c1, c2);
		assertTrue(liste.size() == 0);
	...
	public void testCrud() throws Exception {
		...
		final ConsultationIntf c2 = consultationIntfDao.findById(c1.getConsultationIntfId()).get();
