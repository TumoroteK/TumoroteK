...
public class TerminaleNumerotationDaoTest extends AbstractDaoTest {
	...
	public void testReadAlls() {
		List<TerminaleNumerotation> liste = terminaleNumerotationDao.findAll();
	...
	public void testCrud() throws Exception {
		...
		TerminaleNumerotation tn = new TerminaleNumerotation();
		...
		TerminaleNumerotation tn2 = terminaleNumerotationDao
			.findById(new Integer(6));
		assertNotNull(tn2);
		assertTrue(tn2.getLigne().equals("CAR"));
		tn2.setLigne(updated);
		terminaleNumerotationDao.updateObject(tn2);
		assertTrue(terminaleNumerotationDao.findById(new Integer(6)).
				getLigne().equals(updated));
	...
	public void testEquals() {
		...
		String col1 = "C1";
		String col2 = "C2";
		TerminaleNumerotation tn1 = new TerminaleNumerotation();
	...
	public void testToString() {
		TerminaleNumerotation ct1 = terminaleNumerotationDao.findById(1);
		assertTrue(ct1.toString().
				equals("{" + ct1.getLigne() + " " + ct1.getColonne() + "}"));
		
		TerminaleNumerotation ct2 = new TerminaleNumerotation();
