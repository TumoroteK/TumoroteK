...
public class ProtocoleDaoTest extends AbstractDaoTest {
	...
	public void testReadAllProtocole() {
		List<Protocole> types = protocoleDao.findAll();
	...
	public void testCrudProtocole() throws Exception {
		...
		Protocole p2 = protocoleDao.findByNom("MELBASE").get(0);
		assertNotNull(p2);
		assertTrue(p2.getNom().equals("MELBASE"));
		p2.setNom("XEOGR");
		protocoleDao.updateObject(p2);
		assertTrue(protocoleDao.findById(new Integer(4)).getNom()
				.equals("XEOGR"));
	...
	public void testEqualsAndHashCode() {
		...
		Plateforme f1 = plateformeDao.findById(1);
		Plateforme f2 = plateformeDao.findById(2);
		Plateforme f3 = new Plateforme();
		f3.setNom(f2.getNom());
