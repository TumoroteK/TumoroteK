...
public class ImprimanteApiDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		List<ImprimanteApi> liste = imprimanteApiDao.findAll();
	...
	public void testFindByOrder() {
		List<ImprimanteApi> liste = imprimanteApiDao.findByOrder();
		assertTrue(liste.size() == 2);
	...
	public void testEquals() {
		String nom = "test";
		String nom2 = "test2";
		ImprimanteApi ia1 = new ImprimanteApi();
		ia1.setNom(nom);
		ImprimanteApi ia2 = new ImprimanteApi();
		ia2.setNom(nom);
	...
	public void testHashCode() throws Exception {
		...
		ImprimanteApi ia2 = new ImprimanteApi();
		ia2.setNom(nom);
		ImprimanteApi ia3 = new ImprimanteApi();
		
		assertTrue(ia3.hashCode() > 0);
		
		int hash = ia1.hashCode();
	...
	public void testToString() {
		ImprimanteApi ia1 = imprimanteApiDao.findById(1);
		assertTrue(ia1.toString().
				equals("{" + ia1.getNom() + "}"));
