...
public class ConteneurDaoTest extends AbstractDaoTest
{
   ...
   public void testReadAll(){
      final List<Conteneur> liste = conteneurDao.findAll();
   ...
   public void testFindByPlateformeOrigWithOrder(){
      ...
      List<Conteneur> liste = conteneurDao.findByPlateformeOrigWithOrder(plateformeDao.findById(1));
      assertTrue(liste.size() == 3);
      assertTrue(liste.get(0).getCode().equals("CC1"));

      liste = conteneurDao.findByPlateformeOrigWithOrder(plateformeDao.findById(2));
      assertTrue(liste.size() == 1);

      liste = conteneurDao.findByPlateformeOrigWithOrder(plateformeDao.findById(3));
      assertTrue(liste.size() == 0);
   ...
   public void testCrud() throws Exception{
      ...
      final ConteneurType ct = conteneurTypeDao.findById(1);
      ...
      final Conteneur c2 = conteneurDao.findById(new Integer(5));
      ...
      assertTrue(conteneurDao.findById(new Integer(5)).getCode().equals(codeUp));
      assertTrue(conteneurDao.findById(new Integer(5)).getBanques().size() == 2);
      assertTrue(conteneurDao.findById(new Integer(5)).getConteneurPlateformes().size() == 2);
