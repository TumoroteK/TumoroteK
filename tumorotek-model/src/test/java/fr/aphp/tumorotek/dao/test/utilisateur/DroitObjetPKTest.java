...
public class DroitObjetPKTest extends AbstractDaoTest {
	...
	public void testEquals() throws ParseException {
		DroitObjetPK pk1 = new DroitObjetPK();
		DroitObjetPK pk2 = new DroitObjetPK();
	...
	private void populateClefsToTestEqualsAndHashCode() throws ParseException {
		...
		Profil p3 = profilDao.findById(1);
		Profil[] profilsId = new Profil[]{null, p1, p2, p3};
		OperationType o1 = operationTypeDao.findById(1);
		OperationType o2 = operationTypeDao.findById(2);
		OperationType o3 = operationTypeDao.findById(1);
		OperationType[] operations = 
			new OperationType[]{null, o1, o2, o3};
	...
	public void testToString() {
		...
		assertTrue(pk1.toString().
				equals("{" + pk1.getProfil().toString() + " (Profil), " 
						+ pk1.getEntite().toString() + " (Entite), " 
						+ pk1.getOperationType() + " (OperationType)}"));
