...
public class ResourceBundleTumoTest extends AbstractDaoTest {
	...
	public void setResourceBundleTumo(ResourceBundleTumo r) {
	...
	public void testDoesResourceBundleExists() {
		assertTrue(resourceBundleTumo.doesResourceBundleExists(
				"tumorotek.properties"));
		assertFalse(resourceBundleTumo.doesResourceBundleExists(
			"blabla"));
		assertFalse(resourceBundleTumo.doesResourceBundleExists(
				null));
	}
	...
	public void testGetResourceBundle() {
		ResourceBundle bundle = resourceBundleTumo.getResourceBundle(
				"tumorotek.properties");
		assertTrue(bundle.getString("DBMS").equals("MySQL"));
		
		bundle = resourceBundleTumo.getResourceBundle(
			"blabla");
		assertNull(bundle);
