...
public class FichierDaoTest extends AbstractDaoTest
{
   ...
   private final String updatedPath = "Path mis a jour";
   ...
   public void setCrAnapathDao(final FichierDao cDao){
      this.fichierDao = cDao;
   }

   public void setEchantillonDao(final EchantillonDao e){
      this.echantillonDao = e;
   }

   public void setAnnotationValeurDao(final AnnotationValeurDao a){
   ...
   public void testReadAllCrAnapaths(){
      final List<Fichier> crAnapaths = fichierDao.findAll();
   ...
   public void testCrudCrAnapath() throws Exception{
      ...
      final Fichier c2 = fichierDao.findById(fId);
      assertNotNull(c2);
   ...
   public void testEqualsAndHashCode(){
      ...
      final AnnotationValeur av2 = annotationValeurDao.findById(2);
   ...
   public void testFindFilesSharingPathForAnnos(){
      final Fichier f1 = fichierDao.findById(1);
   ...
   public void testToString(){
      final Fichier path1 = fichierDao.findById(1);
