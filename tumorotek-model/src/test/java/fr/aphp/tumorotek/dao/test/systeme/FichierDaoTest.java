...
public class FichierDaoTest extends AbstractDaoTest {
	...
	private String updatedPath = "Path mis a jour";

	/** Constructeur. */
	public FichierDaoTest() {
		
	}

	public void setCrAnapathDao(FichierDao cDao) {
		this.fichierDao = cDao;
	}
	
	public void setEchantillonDao(EchantillonDao e) {
		this.echantillonDao = e;
	}

	public void setAnnotationValeurDao(AnnotationValeurDao a) {
		this.annotationValeurDao = a;
	}
	...
	public void testReadAllCrAnapaths() {
		List<Fichier> crAnapaths = fichierDao.findAll();
	...
	public void testFindByOrder() {
		List<Fichier> list = fichierDao.findByOrder();
	...
	public void testCrudCrAnapath() throws Exception {
		...
		// Test de l'insertion
		fichierDao.createObject(c);
		Integer fId = c.getFichierId();
		assertEquals(fId, c.getFichierId());
		
		// Test de la mise à jour
		Fichier c2 = fichierDao.findById(fId);
		assertNotNull(c2);
		assertTrue(c2.getPath().equals("PATH5"));
		assertTrue(c2.getMimeType().equals("application/octet-stream"));
		c2.setPath(updatedPath);
		fichierDao.updateObject(c2);
		assertTrue(fichierDao.findById(fId).getPath().equals(updatedPath));
		
		// Test de la délétion
		fichierDao.removeObject(fId);
		assertNull(fichierDao.findById(fId));
...
//	}
	...
	public void testEqualsAndHashCode() {
		...
		String s1 = new String("/pt_1/path1");
		String s2 = new String("/pt_1/path2");
		String s3 = new String("/pt_1/path2");
		...
		AnnotationValeur av2 = annotationValeurDao.findById(2);
		AnnotationValeur av3 = new AnnotationValeur();
	...
	public void testFindFilesSharingPathForAnnos() {
		Fichier f1 = fichierDao.findById(1);
	...
	public void testClone() {
		...
		assertTrue(clone.getAnnotationValeur()
								.equals(f1.getAnnotationValeur()));
