...
public class AffectationImprimantePKTest extends AbstractDaoTest {
	...
	public void testEquals() throws ParseException {
		AffectationImprimantePK pk1 = new AffectationImprimantePK();
		AffectationImprimantePK pk2 = new AffectationImprimantePK();
	...
	private void populateClefsToTestEqualsAndHashCode() throws ParseException {
		...
		Imprimante[] imprimantesId = new Imprimante[]{null, i1, i2};
	...
	public void testToString() {
		...
		assertTrue(pk1.toString().
				equals("{" + pk1.getUtilisateur().toString() 
						+ " (Utilisateur), " 
						+ pk1.getBanque().toString() + " (Banque), " 
						+ pk1.getImprimante().toString() + " (Imprimante)}"));
