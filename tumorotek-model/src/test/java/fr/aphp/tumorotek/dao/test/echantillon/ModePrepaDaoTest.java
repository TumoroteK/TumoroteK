...
public class ModePrepaDaoTest extends AbstractDaoTest {
	...
	private String updatedNom = "Prepa mis a jour";
	...
	public void testReadAllModePrepas() {
		List<ModePrepa> modes = modePrepaDao.findAll();
	...
	public void testFindByOrder() {
		...
		List< ? extends TKThesaurusObject> list = 
							modePrepaDao.findByOrder(pf);
		assertTrue(list.size() == 3);
		assertTrue(list.get(0).getNom().equals("PREPA1"));
		pf = plateformeDao.findById(2);
		list = modePrepaDao.findByOrder(pf);
		assertTrue(list.size() == 1);
		list = modePrepaDao.findByOrder(null);
	...
	public void testEquals() {
		String nom = "Nom";
		String nom2 = "Nom2";
		ModePrepa m1 = new ModePrepa();
		m1.setNom(nom);
		ModePrepa m2 = new ModePrepa();
		m2.setNom(nom);
	...
	public void testHashCode() {
		String nom = "nom";
		ModePrepa m1 = new ModePrepa(1, nom, null);
		ModePrepa m2 = new ModePrepa(2, nom, null);
		ModePrepa m3 = new ModePrepa(3, null, null);
	...
	public void testToString() {
		ModePrepa m1 = modePrepaDao.findById(1);
