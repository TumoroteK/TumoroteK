...
public class CollaborateurDaoTest extends AbstractDaoTest {
	...
	private String updatedNom = "Coll mis a jour";
	...
	public void testFindByOrder() {
		List<Collaborateur> collaborateurs = collaborateurDao.findByOrder();
		assertTrue(collaborateurs.size() == 6);
	...
	public void testFindByExcludedId() {
		List<Collaborateur> collaborateurs = 
			collaborateurDao.findByExcludedId(1);
		assertTrue(collaborateurs.size() == 5);
		
		collaborateurs = 
			collaborateurDao.findByExcludedId(10);
		assertTrue(collaborateurs.size() == 6);
	}
	...
	public void testFindByEtablissement() {
		Etablissement etab1 = etablissementDao.findById(3);
		List<Collaborateur> collaborateurs = collaborateurDao.
				findByEtablissement(etab1);
		assertTrue(collaborateurs.size() == 2);
		Etablissement etab2 = etablissementDao.findById(2);
	...
	public void testFindByEtablissementWithOrder() {
		...
		List<Collaborateur> collaborateurs = collaborateurDao
			.findByEtablissementWithOrder(etab1);
		...
		collaborateurs = collaborateurDao
			.findByEtablissementWithOrder(etab2);
		assertTrue(collaborateurs.size() == 0);
	}
	...
	public void testFindByEtablissementArchiveWithOrder() {
		Etablissement etab1 = etablissementDao.findById(1);
		List<Collaborateur> collaborateurs = collaborateurDao
			.findByEtablissementArchiveWithOrder(etab1, false);
		assertTrue(collaborateurs.size() == 2);
		assertTrue(collaborateurs.get(0).getNom().equals("DUFAY"));
		assertTrue(collaborateurs.get(1).getNom().equals("VIAL"));
		
		collaborateurs = collaborateurDao
			.findByEtablissementArchiveWithOrder(etab1, true);
		assertTrue(collaborateurs.size() == 1);
		
		Etablissement etab2 = etablissementDao.findById(2);
		collaborateurs = collaborateurDao
			.findByEtablissementArchiveWithOrder(etab2, true);
		assertTrue(collaborateurs.size() == 0);
		
		Etablissement etab3 = etablissementDao.findById(3);
		collaborateurs = collaborateurDao
			.findByEtablissementArchiveWithOrder(etab3, true);
		assertTrue(collaborateurs.size() == 0);
		
		collaborateurs = collaborateurDao
			.findByEtablissementArchiveWithOrder(etab3, false);
		assertTrue(collaborateurs.size() == 2);
	}
	...
	public void testFindByServiceIdArchiveWithOrder() {
		List<Collaborateur> collaborateurs = collaborateurDao
			.findByServiceIdArchiveWithOrder(1, false);
		assertTrue(collaborateurs.size() == 2);
		assertTrue(collaborateurs.get(0).getNom().equals("DUFAY"));
		assertTrue(collaborateurs.get(1).getNom().equals("VIAL"));
		
		collaborateurs = collaborateurDao
			.findByServiceIdArchiveWithOrder(1, true);
		assertTrue(collaborateurs.size() == 0);
		
		collaborateurs = collaborateurDao
			.findByServiceIdArchiveWithOrder(2, false);
		assertTrue(collaborateurs.size() == 0);
		
		collaborateurs = collaborateurDao
			.findByServiceIdArchiveWithOrder(2, true);
		assertTrue(collaborateurs.size() == 1);
		
		collaborateurs = collaborateurDao
			.findByServiceIdArchiveWithOrder(3, false);
		assertTrue(collaborateurs.size() == 0);
	}
	...
	public void testFindByCollaborateurWithoutService() {
		List<Collaborateur> collaborateurs = collaborateurDao
			.findByCollaborateurWithoutService();
		assertTrue(collaborateurs.size() == 3);
	}
	...
	public void testFindByEtablissementNoService() {
		...
		List<Collaborateur> collaborateurs = collaborateurDao
								.findByEtablissementNoService(e);
		assertTrue(collaborateurs.size() == 2);
	...
	public void testFindByCollaborateurWithoutServiceAndArchive() {
		...
		collaborateurs = collaborateurDao
			.findByCollaborateurWithoutServiceAndArchive(true);
		assertTrue(collaborateurs.size() == 1);
	}
	...
	public void testFindByIdWithFetch() {
		...
		assertTrue(collaborateur.getCoordonnees().
				iterator().next().getCoordonneeId() == 3);
	...
	public void testCrudCollaborateur() throws Exception {
		...
		Coordonnee co = new Coordonnee();
		co.setAdresse("1 ru cELaide");
		Set<Coordonnee> coords = new HashSet<Coordonnee>();
		coords.add(co);
		Titre titre = titreDao.findById(4);
		Specialite spe = specialiteDao.findById(5);
		Service serv = serviceDao.findById(1);
		Service serv2 = serviceDao.findById(2);
		...
		Collaborateur c2 = collaborateurDao.findById(new Integer(7));
		...
		assertTrue(collaborateurDao.findById(
				new Integer(7)).getNom().equals(updatedNom));
		assertTrue(collaborateurDao.findById(
				new Integer(7)).getServices().size() == 2);
		// Test de la délétion
		Coordonnee coord = c2.getCoordonnees().iterator().next();
	...
	public void testEquals() {
		...
		String prenom = "Pre1";
		String prenom2 = "Pre2";
		Specialite s1 = specialiteDao.findById(1);
		Specialite s2 = specialiteDao.findById(2);
	...
	public void testNomAndPrenom() {
		Collaborateur c1 = collaborateurDao.findById(1);
		assertTrue(c1.getNomAndPrenom().equals(c1.getNom() + " "
				+ c1.getPrenom()));
