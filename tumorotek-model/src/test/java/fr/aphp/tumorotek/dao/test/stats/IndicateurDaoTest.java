...
public class IndicateurDaoTest extends AbstractDaoTest {
	...
	public void setModeleDao(SModeleDao mDao) {
		this.modeleDao = mDao;
	}
	...
	public void testFindById() {
		Indicateur s = indicateurDao.findById(1);
		assertNotNull(s);
	...
	public void testFindNullSubvivisionIndicateurs() {
		List<Indicateur> sl = indicateurDao.findNullSubvivisionIndicateurs();
		assertNotNull(sl);
	...
	public void testFindAll() {
		List<Indicateur> liste = indicateurDao.findAll();
...
//	}
	...
	public void testFindBySModele() {
		...
		SModele m3 = modeleDao.findById(3);
	...
	//	indic.setEntite(entiteDao.findById(3));
		...
		Integer indicId = indic.getIndicateurId();

		Indicateur indic2 = indicateurDao.findById(indicId);
		...
		Indicateur indic3 = indicateurDao.findById(indicId);
		// Vérification des données entrées dans la base
