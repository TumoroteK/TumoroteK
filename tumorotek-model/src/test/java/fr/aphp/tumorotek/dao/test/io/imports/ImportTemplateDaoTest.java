...
public class ImportTemplateDaoTest extends AbstractDaoTest {
	...
	public void testReadAll() {
		List<ImportTemplate> liste = importTemplateDao.findAll();
	...
	public void testFindByBanqueWithOrder() {
		...
		List<ImportTemplate> liste = importTemplateDao
			.findByBanqueWithOrder(b1);
	...
	public void testCrud() throws Exception {
		...
		Set<Entite> entites = new HashSet<Entite>();
		...
		ImportTemplate it2 = importTemplateDao.findById(tpId);
		assertNotNull(it2);
		...
		entites = new HashSet<Entite>();
		entites.add(e2);
		entites.add(e3);
		entites.add(e4);
		it2.setEntites(entites);
		importTemplateDao.updateObject(it2);
		assertTrue(importTemplateDao.findById(tpId).
				getNom().equals(nomUp));
		assertTrue(importTemplateDao.findById(tpId).
				getEntites().size() == 3);
