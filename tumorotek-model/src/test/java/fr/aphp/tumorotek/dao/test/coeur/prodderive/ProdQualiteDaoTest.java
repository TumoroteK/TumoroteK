...
/**
 *
 * Classe de test pour le DAO ProdQualiteDao et le bean du domaine ProdQualite.
...
public class ProdQualiteDaoTest extends AbstractDaoTest {
	...
	public void testFindByOrder() {
		...
		list = prodQualiteDao.findByPfOrder(pf);
		assertTrue(list.size() == 1);
		list = prodQualiteDao.findByPfOrder(null);
	...
	public void testCrudProdQualite() throws Exception {
		...
		final ProdQualite p2 = prodQualiteDao.findById(new Integer(4)).get();
		assertNotNull(p2);
		assertTrue(p2.getNom().equals("QUALITE"));
		p2.setNom(updatedQualite);
		prodQualiteDao.save(p2);
		assertTrue(prodQualiteDao.findById(new Integer(4)).get().getNom().equals(updatedQualite));

		// Test de la délétion
		prodQualiteDao.deleteById(new Integer(4));
		assertFalse(prodQualiteDao.findById(new Integer(4)).isPresent());
	...
	public void testHashCode() {
		...
		final ProdQualite p2 = new ProdQualite();
		p2.setNom(qualite);
		final ProdQualite p3 = new ProdQualite();
		p3.setNom(null);
	...
	public void testToString() {
		final ProdQualite p1 = prodQualiteDao.findById(1).get();
