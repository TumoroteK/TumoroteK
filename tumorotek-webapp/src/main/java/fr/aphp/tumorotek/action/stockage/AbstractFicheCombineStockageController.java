...
public abstract class AbstractFicheCombineStockageController 
	...
	public void initIncidents(List<Incident> ics) {
	...
	public void setEmptyToNulls() {
		for (int i = 0; i < getIncidents().size(); i++) {
			if (getIncidents().get(i).getDescription() != null
					&& getIncidents().get(i).getDescription().equals("")) {
	...
	public void updateObject() {
		for (int i = 0; i < getIncidentsToRemove().size(); i++) {
			ManagerLocator.getIncidentManager()
				.removeObjectManager(getIncidentsToRemove().get(i));
		}		
	}
	...
	public void onClick$addIncident() {
		...
		ListModel<Incident> list = new ListModelList<Incident>(getIncidents());
	...
	public void onGetAddedIncident(Event event) {
		if (event.getData() != null) {
			...
			ListModel<IncidentDecorator> list = 
					new ListModelList<IncidentDecorator>(getIncidentsDecorated());
			incidentsList.setModel(list);
			
			ListModel<Incident> list2 = new ListModelList<Incident>(getIncidents());
...
//					+ ".offsetTop;");
	...
	public void setIncidents(List<Incident> is) {
		this.incidents = is;
	}
	...
	public void setIncidentsToRemove(List<Incident> itr) {
	...
	public void setIncidentsDecorated(List<IncidentDecorator> icd) {
	...
	public void setStockageObj(Object s) {
		this.stockageObj = s;
	}
