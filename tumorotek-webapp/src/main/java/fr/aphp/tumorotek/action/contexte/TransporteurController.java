...
public class TransporteurController extends AbstractObjectTabController {
	...
	public FicheTransporteur getFicheCombine() {
		return ((FicheTransporteur) 
				this.self.getFellow("ficheTransporteur")
				.getFellow("fwinTransporteur")
	...
	public ListeTransporteur getListe() {
		return ((ListeTransporteur) 
				this.self.getFellow("listeTransporteur")
				.getFellow("lwinTransporteur")
