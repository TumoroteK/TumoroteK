...
public abstract class AbstractListeController2 extends AbstractController
{
   ...
   public void onLaterExport(final boolean fromSelection){
      ...
      try{
         ...
         getObjectTabController().enregistrerValeursChampsCalculesPourExport(null, getResultatsIds(), getRestrictedTableIds());

         final EContexte contexte = SessionUtils.getCurrentContexte();

         final ProfilExport pExport = askForNonAnonymizationStatut();
   ...
   private static HtmlMacroComponent populateRechercheAvanceeModal(final Window win, final Page page, final Entite entiteToSearch,
      final String path, final boolean anonyme, final Map<?, ?> sessionScope /*TODO Jamais utilisé */,
      ...
      if(entiteToSearch.getNom().equals("Patient")){
         ...
         // since gatsbi
         String pageDef = SessionUtils.getCurrentGatsbiContexteForEntiteId(2) == null ? "ficheRechercheAvanceePrelevement"
            : "ficheRechercheAvanceePrelevementGatsbi";
         ...
         // since gatsbi
         String pageDef = SessionUtils.getCurrentGatsbiContexteForEntiteId(2) == null ? "ficheRechercheAvanceeEchantillon"
            : "ficheRechercheAvanceeEchantillonGatsbi";
