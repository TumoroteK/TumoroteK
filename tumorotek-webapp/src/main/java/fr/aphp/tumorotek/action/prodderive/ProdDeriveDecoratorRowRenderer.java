 ...
 * @version 2.0.10
 */
public class ProdDeriveDecoratorRowRenderer 
				implements RowRenderer<ProdDeriveDecorator2> {
	...
	@Override
	public void render(Row row, final ProdDeriveDecorator2 deco, int index)  {
				
		Hlayout icones = TKStockableObjectUtils.drawListIcones(deco.getProdDerive(), 
			...
			tb.addEventListener(Events.ON_CHANGE, new EventListener<Event>() {
	            public void onEvent(Event event) throws Exception {
	            	...
	            	if (ManagerLocator
	            		...
	            		.findDoublonManager(deco.getProdDerive())) {
	            		deco.setCode(old);
	            		tb.setValue(old);
	            		throw new WrongValueException(tb, 
	            							"Modification impossible! "
	        + new DoublonFoundException("ProdDerive", "creation").getMessage());
