...
public class FicheUtilisateurModale extends AbstractFicheCombineController
{
   ...
   public void doAfterCompose(final Component comp) throws Exception{
      ...
      setObjLabelsComponents(new Component[] {this.emailLabel, this.rowPfsAdmin, this.close});

      setObjBoxsComponents(new Component[] {this.emailBox});
    ...
    */
   public void init(final Utilisateur utilisateur, final String p){
      path = p;
   ...
   public void setObject(final TKdataObject obj){
      ...
      if(user.getUtilisateurId() != null){
         ...
         profilUtilisateurs = ManagerLocator.getProfilUtilisateurManager().findByUtilisateurManager(user, null);
      ...
      if(changed){
         ...
         if(Path.getComponent(path) != null){
            if(user != null){
               ...
               Events.postEvent(new Event("onGetUserUpdated", Path.getComponent(path), user));
            }
         }
      }
   ...
   public void updateObject(){
      ...
      // update de l'objet
      ManagerLocator.getUtilisateurManager().updateObjectManager(user, user.getCollaborateur(), tmp, null,
   ...
   public void setProfilUtilisateurs(final List<ProfilUtilisateur> pu){
   ...
   public void setProfilUtilisateursOtherBanques(final List<ProfilUtilisateur> pu){
   ...
   public void setPlateformesFormated(final String p){
