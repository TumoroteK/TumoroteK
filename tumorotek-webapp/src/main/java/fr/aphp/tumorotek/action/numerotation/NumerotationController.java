...
public class NumerotationController extends AbstractObjectTabController
{

   private static final long serialVersionUID = -2154419190985735890L;
   ...
   public TKdataObject loadById(final Integer id){
      return ManagerLocator.getNumerotationManager().findByIdManager(id);
   }

   @Override
   public FicheNumerotation getFicheCombine(){
      return ((FicheNumerotation) this.self.getFellow("ficheNumerotation").getFellow("fwinNumerotation")
         .getAttributeOrFellow("fwinNumerotation$composer", true));
   }

   @Override
   public ListeNumerotation getListe(){
      return ((ListeNumerotation) this.self.getFellow("listeNumerotation").getFellow("lwinNumerotation")
         .getAttributeOrFellow("lwinNumerotation$composer", true));
   }
