...
public class PlateformeController extends AbstractObjectTabController
{

   private static final long serialVersionUID = -3765838754965786176L;
   ...
   public TKdataObject loadById(final Integer id){
      return ManagerLocator.getPlateformeManager().findByIdManager(id);
   }

   @Override
   public FichePlateforme getFicheCombine(){
      return ((FichePlateforme) this.self.getFellow("fichePlateforme").getFellow("fwinPlateforme")
         .getAttributeOrFellow("fwinPlateforme$composer", true));
   }

   @Override
   public ListePlateforme getListe(){
      return ((ListePlateforme) this.self.getFellow("listePlateforme").getFellow("lwinPlateforme")
         .getAttributeOrFellow("lwinPlateforme$composer", true));
   }
