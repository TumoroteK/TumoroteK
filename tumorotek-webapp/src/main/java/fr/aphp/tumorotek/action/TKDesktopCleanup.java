...
// 	private Log log = LogFactory.getLog(TKDesktopCleanup.class); 
	...
	public void cleanup(Desktop desk) throws Exception {
//		deleteTmpFiles();
...
//	
	...
	private void destroyExportAliveThreads(Desktop desk) {
		if (desk.hasAttribute("threads")) {
			List<Export> thrs = (List<Export>) desk.getAttribute("threads");
			for (Export export : thrs) {
