...
public class CategoryDetails implements Comparable<CategoryDetails> {
	...
	public CategoryDetails(String cat,
		Integer value, Integer nsv, boolean b, Color c) {
		setCategory(cat);
		setValue(value);
	...
	public void setCheckAffichage(Boolean b) {
	...
	public void setNonStockValue(Integer s) {
