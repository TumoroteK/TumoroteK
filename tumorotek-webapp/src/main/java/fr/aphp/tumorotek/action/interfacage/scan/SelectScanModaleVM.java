...
public class SelectScanModaleVM
{
   ...
   @Init
   public void init(@ExecutionArgParam("ScanDevice") ScanDevice _d, @ExecutionArgParam("scans") final List<ScanTerminale> _s,
      @ExecutionArgParam("main") final Component _m){
   ...
   public void onDeleteSelectedScan(){
      if(!scansModel.isSelectionEmpty()){
         final ScanTerminale selected = scansModel.getSelection().iterator().next();
         final int idx = scansModel.indexOf(selected);
   ...
   public void onDeleteSelectedAllScans(){
      ...
      for(final ScanTerminale sT : scansModel){
   ...
   public void setDevice(final ScanDevice _d){
      this.device = _d;
   }
   ...
   public void setDeleteOnSelect(final Boolean _d){
