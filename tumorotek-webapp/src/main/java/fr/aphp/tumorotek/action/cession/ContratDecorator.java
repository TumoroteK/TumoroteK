...
public class ContratDecorator implements TKdataObject {
	...
	public ContratDecorator(Contrat c) {
		this.contrat = c;
	}
	...
	public Integer getNbCessions() {
		if (this.contrat.getContratId() != null) {
			return ManagerLocator.getContratManager()
				.getCessionsManager(contrat).size();
		} else {
			return 0;
		}
	}
	 ...
	 */
	public static List<ContratDecorator> 
								decorateListe(List<Contrat> contrats) {
		List<ContratDecorator> liste = 
	 ...
	 * @return Contrats décorés.
	 */
	public static List<Contrat> extractListe(List<ContratDecorator> contrats) {
		List<Contrat> liste = 
									new ArrayList<Contrat>();
		Iterator<ContratDecorator> it = contrats.iterator();
		while (it.hasNext()) {
	...
	public boolean equals(Object obj) {
		...
		ContratDecorator deco = (ContratDecorator) obj;
	...
	public ContratDecorator clone() {
		ContratDecorator deco = new ContratDecorator(getContrat());
		return deco;
	}
