...
public class FicheChampThesaurus extends AbstractFicheCombineController {
	...
	public String initSecondeValeur() {
		...
		if (valeurThesaurus.getClass()
				.getSimpleName().equals("EnceinteType")) {
			valeur = ((EnceinteType) valeurThesaurus).getPrefixe();
			
			rowSecondValue.setVisible(true);
			labelSecondValue.setValue(Labels
					.getLabel("conteneur.terminale.prefixe"));
		}
	...
	public void initBooleanValeur() {
		...
		if (valeurThesaurus.getClass()
			...
			labelBooleanValue.setValue(Labels
					.getLabel("Champ.Prelevement.Risque"));
	...
	public void onBlur$valueTextbox() {
		if (!valeurThesaurus.getClass()
				.getSimpleName().equals("NonConformite")) {
			valueTextbox.setValue(valueTextbox.getValue()
					.toUpperCase().trim());
		}
	}
	...
	public void onBlur$secondValueTextbox() {
		secondValueTextbox.setValue(secondValueTextbox
	...
	public void onClick$validate() {
		Clients.showBusy(Labels.getLabel(
				"thesaurus.enregistrement.encours"));
	...
	public void detachWindow() {
		if (Path.getComponent(path) != null) {
			Events.postEvent(
					new Event("onGetSaveDoneOnValue", 
	...
	public void saveNautre() {
		...
		if (creationMode) {
			ManagerLocator.getNatureManager()
				.createObjectManager((Nature) valeurThesaurus);
		} else {
			ManagerLocator.getNatureManager()
				.updateObjectManager((Nature) valeurThesaurus);
		}
	}
	...
	public void savePrelevementType() {
		...
		if (creationMode) {
			ManagerLocator.getPrelevementTypeManager()
				.createObjectManager((PrelevementType) valeurThesaurus);
		} else {
			ManagerLocator.getPrelevementTypeManager()
				.updateObjectManager((PrelevementType) valeurThesaurus);
		}
	}
	...
	public void saveEchantillonType() {
		...
		if (creationMode) {
			ManagerLocator.getEchantillonTypeManager()
				.createObjectManager((EchantillonType) valeurThesaurus);
		} else {
			ManagerLocator.getEchantillonTypeManager()
				.updateObjectManager((EchantillonType) valeurThesaurus);
		}
	}
	...
	public void saveEchanQualite() {
		...
		if (creationMode) {
			ManagerLocator.getEchanQualiteManager()
				.createObjectManager((EchanQualite) valeurThesaurus);
		} else {
			ManagerLocator.getEchanQualiteManager()
				.updateObjectManager((EchanQualite) valeurThesaurus);
		}
	}
	...
	public void saveProdType() {
		...
		if (creationMode) {
			ManagerLocator.getProdTypeManager()
				.createObjectManager((ProdType) valeurThesaurus);
		} else {
			ManagerLocator.getProdTypeManager()
				.updateObjectManager((ProdType) valeurThesaurus);
		}
	}
	...
	public void saveProdQualite() {
		...
		if (creationMode) {
			ManagerLocator.getProdQualiteManager()
				.createObjectManager((ProdQualite) valeurThesaurus);
		} else {
			ManagerLocator.getProdQualiteManager()
				.updateObjectManager((ProdQualite) valeurThesaurus);
		}
	}
	...
	public void saveConditMilieu() {
		...
		if (creationMode) {
			ManagerLocator.getConditMilieuManager()
				.createObjectManager((ConditMilieu) valeurThesaurus);
		} else {
			ManagerLocator.getConditMilieuManager()
				.updateObjectManager((ConditMilieu) valeurThesaurus);
		}
	}
	...
	public void saveConditType() {
		...
		if (creationMode) {
			ManagerLocator.getConditTypeManager()
				.createObjectManager((ConditType) valeurThesaurus);
		} else {
			ManagerLocator.getConditTypeManager()
				.updateObjectManager((ConditType) valeurThesaurus);
		}
	}
	...
	public void saveConsentType() {
		...
		if (creationMode) {
			ManagerLocator.getConsentTypeManager()
				.createObjectManager((ConsentType) valeurThesaurus);
		} else {
			ManagerLocator.getConsentTypeManager()
				.updateObjectManager((ConsentType) valeurThesaurus);
		}
	}
	...
	public void saveModePrepa() {
		...
		if (creationMode) {
			ManagerLocator.getModePrepaManager()
				.createObjectManager((ModePrepa) valeurThesaurus);
		} else {
			ManagerLocator.getModePrepaManager()
				.updateObjectManager((ModePrepa) valeurThesaurus);
		}
	}
	...
	public void saveModePrepaDerive() {
		...
		if (creationMode) {
			ManagerLocator.getModePrepaDeriveManager()
				.createObjectManager((ModePrepaDerive) valeurThesaurus);
		} else {
			ManagerLocator.getModePrepaDeriveManager()
				.updateObjectManager((ModePrepaDerive) valeurThesaurus);
		}
	}
	...
	public void saveCessionExamen() {
		...
		if (creationMode) {
			ManagerLocator.getCessionExamenManager()
				.createObjectManager((CessionExamen) valeurThesaurus);
		} else {
			ManagerLocator.getCessionExamenManager()
				.updateObjectManager((CessionExamen) valeurThesaurus);
		}
	}
	...
	public void saveDestructionMotif() {
		...
		if (creationMode) {
			ManagerLocator.getDestructionMotifManager()
				.createObjectManager((DestructionMotif) valeurThesaurus);
		} else {
			ManagerLocator.getDestructionMotifManager()
				.updateObjectManager((DestructionMotif) valeurThesaurus);
		}
	}
	...
	public void saveProtocoleType() {
		...
		if (creationMode) {
			ManagerLocator.getProtocoleTypeManager()
				.createObjectManager((ProtocoleType) valeurThesaurus);
		} else {
			ManagerLocator.getProtocoleTypeManager()
				.updateObjectManager((ProtocoleType) valeurThesaurus);
		}
	}
	...
	public void saveCategorie() {
		...
		if (creationMode) {
			ManagerLocator.getCategorieManager()
				.createObjectManager((Categorie) valeurThesaurus);
		} else {
			ManagerLocator.getCategorieManager()
				.updateObjectManager((Categorie) valeurThesaurus);
		}
	}
	...
	public void saveSpecialite() {
		...
		if (creationMode) {
			ManagerLocator.getSpecialiteManager()
				.createObjectManager((Specialite) valeurThesaurus);
		} else {
			ManagerLocator.getSpecialiteManager()
				.updateObjectManager((Specialite) valeurThesaurus);
		}
	}
	...
	public void saveConteneurType() {
		...
		if (creationMode) {
			ManagerLocator.getConteneurTypeManager()
				.createObjectManager((ConteneurType) valeurThesaurus);
		} else {
			ManagerLocator.getConteneurTypeManager()
				.updateObjectManager((ConteneurType) valeurThesaurus);
		}
	}
	...
	public void saveRisque() {
		...
		if (creationMode) {
			ManagerLocator.getRisqueManager()
				.createObjectManager((Risque) valeurThesaurus);
		} else {
			ManagerLocator.getRisqueManager()
				.updateObjectManager((Risque) valeurThesaurus);
		}
	}
	...
	public void saveEnceinteType() {
		...
		if (creationMode) {
			ManagerLocator.getEnceinteTypeManager()
				.createObjectManager((EnceinteType) valeurThesaurus);
		} else {
			ManagerLocator.getEnceinteTypeManager()
				.updateObjectManager((EnceinteType) valeurThesaurus);
		}
	}
	...
	public void saveNonConformite() {
		...
		if (creationMode) {
			ManagerLocator.getNonConformiteManager()
				.createObjectManager((NonConformite) valeurThesaurus);
		} else {
			ManagerLocator.getNonConformiteManager()
				.updateObjectManager((NonConformite) valeurThesaurus);
		}
	}
	...
	public void saveProtocole() {
		...
		if (creationMode) {
			ManagerLocator.getProtocoleManager()
				.createObjectManager((Protocole) valeurThesaurus);
		} else {
			ManagerLocator.getProtocoleManager()
				.updateObjectManager((Protocole) valeurThesaurus);
		}
	}
	...
	public void setNewValue(String newV) {
		this.newValue = newV;
	}
	...
	public void setCreationMode(boolean creationM) {
	...
	public void setValeurThesaurus(Object valeurTh) {
	...
	public void setNewSecondValue(String nValue) {
