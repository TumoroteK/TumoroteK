 ...
 *
 */
public class CustomSimpleListModel extends SimpleListModel<Object>
{

   private static final long serialVersionUID = 7061490413290014532L;

   public CustomSimpleListModel(final List<?> data){
      super(data);
   }

   public CustomSimpleListModel(final Object[] data){
      super(data);
   }

   @Override
   public ListModel<Object> getSubModel(final Object value, int nRows){
   ...
   public boolean entryMatchesText(final String entry, final String text){
