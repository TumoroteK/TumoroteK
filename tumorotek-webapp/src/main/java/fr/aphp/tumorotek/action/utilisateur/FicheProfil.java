...
public class FicheProfil extends AbstractFicheCombineController
{
   ...
   public void setObject(final TKdataObject obj){
      ...
      if(profil != null && profil.getProfilId() != null){
         ...
         if(this.profil.getAdmin() != null && this.profil.getAdmin()){
            selectedExport = Labels.getLabel("profil.droit.export.nominatif");
         }else{
            if(this.profil.getProfilExport() != null){
               if(this.profil.getProfilExport() == 0){
                  ...
                  selectedExport = Labels.getLabel("profil.droit.export.anonyme");
   ...
   public List<DroitObjet> extractDroitObjets(){
      ...
      // gestion de l'export
      if(selectedExport.equals(Labels.getLabel("profil.droit.export.nominatif"))
         || selectedExport.equals(Labels.getLabel("profil.droit.export.anonyme"))){
         if(selectedExport.equals(Labels.getLabel("profil.droit.export.nominatif"))){
   ...
   public void setSelectedExport(final String selectedE){
