...
public class OutilsController extends AbstractObjectTabController
{
   ...
   public AbstractListeController2 getListe(){
      return ((ListeOutils) this.self.getFellow("listeOutils").getFellow("lwinOutils").getAttributeOrFellow("lwinOutils$composer",
         true));
   }
    ...
    * la fiche.
    */
   public void showFicheOutil(final Outil outil){
      clearOutilDiv();
   ...
   public void switchToFusionPatientsMode(){
      ...
      if(!divOutil.hasFellow("winContexteFusion")){
         Executions.createComponents("/zuls/outils/FicheFusionPatients.zul", divOutil, null);
      }
   }
   ...
   public void switchToFusionCollaborateursMode(){
      ...
      if(!divOutil.hasFellow("fwinFusionPatients")){
         Executions.createComponents("/zuls/outils/contexte/fusion/Fusion.zul", divOutil, null);
      }
   }
