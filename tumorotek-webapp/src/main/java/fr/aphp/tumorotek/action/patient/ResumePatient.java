...
public class ResumePatient {
	...
	private Label linkMaladieLabel;
	private Label codeDiagLabel;
	private Label linkPatientLabel;
...
//	}
	...
	public ResumePatient(Group resumePatientGroup) {
		...
		// third Row
		row3 = (Row) resumePatientGroup.getNextSibling().getNextSibling()
				.getNextSibling();
		dateNaisLabel = (Label) row3.getFellowIfAny("dateNaisLabel");
		sexeLabel = (Label) row3.getFellowIfAny("sexeLabel");
		
		// fourth Row
		linkMaladie = (Row) resumePatientGroup.getNextSibling()
				.getNextSibling().getNextSibling().getNextSibling();
		
		// fifth Row
		row5 = (Row)  resumePatientGroup.getNextSibling().getNextSibling()
				.getNextSibling().getNextSibling().getNextSibling();
...
//		}
	 ...
	 * @param maladie
	 */
	public void setPrelevement(Prelevement prel) {
...
//		}
	...
	public void setPatientAccessible(boolean accessible) {
//		if (accessible) {
//			if (!anonyme) {
...
//		}
	 ...
	 * @param patient
	 */
	public void setPatientProperties(Patient patient) {
		//patient property
...
//		
		if (!anonyme) {
			if (patient != null) {
				...
				dateNaisLabel.setValue(ObjectTypesFormatters
	 ...
	 */
	public void showPatientPanel(boolean opensMaladie) {
...
//	}
	 ...
	 * @param visible
	 */
	public void setNdaBoxVisible(boolean visible) {
		if (ndaBox != null) {
