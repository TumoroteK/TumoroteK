 ...
 * l'interface par zk sur les Templates d'impression.
 * Date: 14/09/2010.
 *
 * @author Mathieu BARTHELEMY
 * @version 2.0
 */
public final class TemplateConstraints
{

   private TemplateConstraints(){}
   ...
   private static ConstWord typeConstraint = new ConstWord();
   static{
      nomConstraint.setNullable(false);
      nomConstraint.setSize(50);
   }
   ...
   public static ConstWord getTypeConstraint(){
