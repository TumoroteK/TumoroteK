...
public final class PrelevementConstraints
{
   ...
   private static ConstCode ndaConstraint = new ConstCode();
   static{
      ndaConstraint.setNullable(true);
      ndaConstraint.setSize(20);
   }

   private static ConstInt nbConditConstraint = new ConstInt();
   static{
      nbConditConstraint.setNullable(true);
      nbConditConstraint.setSize(null);
   }
   ...
   public static ConstCode getNdaConstraint(){
      return ndaConstraint;
   }

   public static ConstInt getNbConditConstraint(){
      return nbConditConstraint;
   }
}
