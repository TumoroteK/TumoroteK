...
public class ListeThesaurus extends AbstractListeController2 {
	...
	private List<Thesaurus> listObjects = new ArrayList<Thesaurus>();
	...
	public void initListes() {
		listObjects.clear();
		// Catégorie
		listObjects.add(new Thesaurus("Categorie", 
				Labels.getLabel("thesaurus.liste.categorie")));
		// examen
		listObjects.add(new Thesaurus("CessionExamen",
				Labels.getLabel("thesaurus.liste.examen.cession")));
		// Milieu de conditionnement
		listObjects.add(new Thesaurus("ConditMilieu",
				Labels.getLabel("thesaurus.liste.milieu.conditionnement")));
		// Mode de préparation
		listObjects.add(new Thesaurus("ModePrepa",
				Labels.getLabel("thesaurus.liste.mode.preparation")));
		// Mode de préparation dérivés
		listObjects.add(new Thesaurus("ModePrepaDerive",
				Labels.getLabel("thesaurus.liste.mode.preparation.derive")));
		// Motif de destruction
		listObjects.add(new Thesaurus("DestructionMotif",
				Labels.getLabel("thesaurus.liste.motif.destruction")));
		// nature des prlvts
		listObjects.add(new Thesaurus("Nature", 
				Labels.getLabel("thesaurus.liste.nature.prelevement")));
		// Non conformite a l'arrivee
		listObjects.add(new Thesaurus("NonConformiteArrivee", 
				Labels.getLabel("thesaurus.liste.nonConformite.arrivee")));
		// Non conformite apres traitement Echantillon
		listObjects.add(new Thesaurus("NonConformiteTraitementEchan", 
				Labels.getLabel("thesaurus.liste.nonConformite.traitement.echan")));
		// Non conformite a la cession Echantillon
		listObjects.add(new Thesaurus("NonConformiteCessionEchan", 
				Labels.getLabel("thesaurus.liste.nonConformite.cession.echan")));
		// Non conformite apres traitement Derive
		listObjects.add(new Thesaurus( "NonConformiteTraitementDerive", 
				Labels.getLabel("thesaurus.liste.nonConformite.traitement.derive")));
		// Non conformite a la cession Derive
		listObjects.add(new Thesaurus("NonConformiteCessionDerive",
				Labels.getLabel("thesaurus.liste.nonConformite.cession.derive")));
		// Protocole SerotK
		listObjects.add(new Thesaurus("Protocole", 
				Labels.getLabel("thesaurus.liste.serotk.protocole")));
		// Qualité de l'échantillon
		listObjects.add(new Thesaurus("EchanQualite", 
				Labels.getLabel("thesaurus.liste.qualite.echantillon")));
		// Qualité du dérivé
		listObjects.add(new Thesaurus("ProdQualite", 
				Labels.getLabel("thesaurus.liste.qualite.prodDerive")));
		// Risque
		listObjects.add(new Thesaurus("Risque", 
							Labels.getLabel("thesaurus.liste.risque")));
		// Spécialité
		listObjects.add(new Thesaurus("Specialite", 
							Labels.getLabel("thesaurus.liste.specialite")));
		// Statut juridique
		listObjects.add(new Thesaurus("ConsentType", 
				Labels.getLabel("thesaurus.liste.type.consentement")));
		// Type d'échantillon
		listObjects.add(new Thesaurus("EchantillonType", 
				Labels.getLabel("thesaurus.liste.type.echantillon")));
		// Type d'enceinte
		listObjects.add(new Thesaurus("EnceinteType", 
				Labels.getLabel("thesaurus.liste.type.enceinte")));
		// Type de conditionnement
		listObjects.add(new Thesaurus("ConditType", 
				Labels.getLabel("thesaurus.liste.type.conditionnement")));
		// Type de conteneur
		listObjects.add(new Thesaurus("ConteneurType", 
				Labels.getLabel("thesaurus.liste.type.conteneur")));
		// Type de prélèvement
		listObjects.add(new Thesaurus("PrelevementType", 
				Labels.getLabel("thesaurus.liste.type.prelevement")));
		// Type de dérivé
		listObjects.add(new Thesaurus("ProdType", 
				Labels.getLabel("thesaurus.liste.type.prodDerive")));
		// Type de protocole
		listObjects.add(new Thesaurus("ProtocoleType", 
				Labels.getLabel("thesaurus.liste.type.protocole")));
	}
