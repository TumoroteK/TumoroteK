...
public class LigneEtiquetteDecorator {
	...
	private List<ChampLigneEtiquette> champs = 
		new ArrayList<ChampLigneEtiquette>();
	private List<ChampLigneEtiquette> champsToRemove = 
		new ArrayList<ChampLigneEtiquette>();
	
	public LigneEtiquetteDecorator(LigneEtiquette le,
			List<ChampLigneEtiquette> c) {
		ligneEtiquette = le;
	...
	public void setChamps(List<ChampLigneEtiquette> c) {
		this.champs = c;
	}
	 ...
	 */
	public static List<LigneEtiquetteDecorator> 
			decorateListe(List<LigneEtiquette> objets) {
		List<LigneEtiquetteDecorator> liste = 
						new ArrayList<LigneEtiquetteDecorator>();
		Iterator<LigneEtiquette> it = objets.iterator();
		while (it.hasNext()) {
	...
	public boolean equals(Object obj) {
		...
		LigneEtiquetteDecorator deco = (LigneEtiquetteDecorator) obj;
