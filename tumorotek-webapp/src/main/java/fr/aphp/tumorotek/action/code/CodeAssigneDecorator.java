...
public class CodeAssigneDecorator extends SmallObjDecorator {
	...
	public CodeAssigneDecorator(CodeAssigne c) {
		setObj(c);
	...
	public void setExport(boolean e) {
...
//		}
	 ...
	 */
	public static List<SmallObjDecorator> 
							decorateListe(List<CodeAssigne> codes) {
		List<SmallObjDecorator> liste = 
...
//			}
	 ...
	 */
	public static List<SmallObjDecorator> 
							cleanDecorateListe(List<CodeAssigne> codes) {
		List<SmallObjDecorator> res = decorateListe(codes);
	 ...
	 */
	private static void 
			setCodeAssigneDecosAsNew(List<SmallObjDecorator> codes) {
		CodeAssigne c;
		CodeAssigneDecorator deco;
		if (codes != null) {
			Iterator<SmallObjDecorator> it = codes.iterator();
			while (it.hasNext()) {
	...
	public boolean ordreChanged() {
		return super.ordreChanged()
			|| getOrdre() != ((CodeAssigne) getObj()).getOrdre();
	}
	
	public static List<CodeAssigne> 
				undecorateListe(List<SmallObjDecorator> decos) {
		List<CodeAssigne> res = new ArrayList<CodeAssigne>();
		if (decos != null) {
	...
	public CodeAssigneDecorator clone() {
		CodeAssigneDecorator clone = 
			new CodeAssigneDecorator((CodeAssigne) getObjClone());
