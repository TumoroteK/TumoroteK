...
public class ChartDataTriggers {
	...
	public void setPatientPfModelTrg(Boolean patientPfModelTrg) {
		this.patientPfModelTrg = patientPfModelTrg;
	}
	
	public void setPrelevementPfModelTrg(Boolean prelevementPfModelTrg) {
		this.prelevementPfModelTrg = prelevementPfModelTrg;
	}
	
	public void setEchanPfModelTrg(Boolean echanPfModelTrg) {
		this.echanPfModelTrg = echanPfModelTrg;
	}
	
	public void setDerivePfModelTrg(Boolean derivePfModelTrg) {
		this.derivePfModelTrg = derivePfModelTrg;
	}
	
	public void setCessionPfModelTrg(Boolean cessionPfModelTrg) {
	...
	public void setPatientCollModelTrg(Boolean patientCollModelTrg) {
		this.patientCollModelTrg = patientCollModelTrg;
	}

	public void setPrelevementCollModelTrg(Boolean prelevementCollModelTrg) {
		this.prelevementCollModelTrg = prelevementCollModelTrg;
	}

	public void setEchanCollModelTrg(Boolean echanCollModelTrg) {
		this.echanCollModelTrg = echanCollModelTrg;
	}

	public void setDeriveCollModelTrg(Boolean deriveCollModelTrg) {
		this.deriveCollModelTrg = deriveCollModelTrg;
	}

	public void setCessionCollModelTrg(Boolean cessionCollModelTrg) {
		this.cessionCollModelTrg = cessionCollModelTrg;
	}

	public void setEchansCedesCollModelTrg(Boolean echansCedesCollModelTrg) {
		this.echansCedesCollModelTrg = echansCedesCollModelTrg;
	}

	//
	public void setDerivesCedesCollModelTrg(Boolean derivesCedesCollModelTrg) {
		this.derivesCedesCollModelTrg = derivesCedesCollModelTrg;
	}

	public void setPrelTypeCollModelTrg(Boolean prelTypeCollModelTrg) {
		this.prelTypeCollModelTrg = prelTypeCollModelTrg;
	}

	public void setPrelEtabCollModelTrg(Boolean prelEtabCollModelTrg) {
		this.prelEtabCollModelTrg = prelEtabCollModelTrg;
	}

	public void setPrelConsentCollModelTrg(Boolean prelConsentCollModelTrg) {
		this.prelConsentCollModelTrg = prelConsentCollModelTrg;
	}

	public void setEchanTypeCollModelTrg(Boolean echanTypeCollModelTrg) {
		this.echanTypeCollModelTrg = echanTypeCollModelTrg;
	}

	public void setEchanCimCollModelTrg(Boolean echanCimCollModelTrg) {
		this.echanCimCollModelTrg = echanCimCollModelTrg;
	}

	public void setEchanOrgCollModelTrg(Boolean echanOrgCollModelTrg) {
		this.echanOrgCollModelTrg = echanOrgCollModelTrg;
	}

	public void setDeriveTypeCollModelTrg(Boolean deriveTypeCollModelTrg) {
		this.deriveTypeCollModelTrg = deriveTypeCollModelTrg;
	}

	public void setCessionTypeCollModelTrg(Boolean cessionTypeCollModelTrg) {
