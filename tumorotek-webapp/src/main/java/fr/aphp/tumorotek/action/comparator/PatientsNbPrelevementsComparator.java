 ...
 *
 */
public class PatientsNbPrelevementsComparator implements Comparator<Patient>
{
   ...
   public int compare(final Patient o1, final Patient o2){
      final Integer i1 = PatientUtils.getNbPrelsForPatientAndUser(o1, banques);
      final Integer i2 = PatientUtils.getNbPrelsForPatientAndUser(o2, banques);
