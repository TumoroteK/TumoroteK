...
public class ListeNumerotation extends AbstractListeController2
{
   ...
   public void initObjectsBox(){
      ...
      final List<Banque> banques =
         ManagerLocator.getBanqueManager().findByUtilisateurIsAdminManager(user, SessionUtils.getPlateforme(sessionScope));
      final List<Numerotation> nums = ManagerLocator.getNumerotationManager().findByBanquesManager(banques);
   ...
   public void onClick$viewObject(final Event event){
      ...
      final Numerotation edit = ((Numerotation) getCurrentObject()).clone();
   ...
   public void setNumerotationRenderer(final NumerotationRowRenderer nRenderer){
