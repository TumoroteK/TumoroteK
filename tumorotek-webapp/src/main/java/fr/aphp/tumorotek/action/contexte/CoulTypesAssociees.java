...
public class CoulTypesAssociees extends OneToManyComponent {
	...
	private List<CouleurEntiteType> objects = 
								new ArrayList<CouleurEntiteType>();
	private List<Couleur> couleurs = 
							new ArrayList<Couleur>();
	
	private CoulTypesRowRenderer coulTypesRenderer = 
									new CoulTypesRowRenderer();
	...
	public void setEchantillonTyped(boolean is) {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		couleurs.addAll(ManagerLocator
				.getCouleurManager().findAllObjectsManager());
	...
	public void removeFromListObjects(Object obj) {
		getObjects().remove((CouleurEntiteType) obj);
	}
	...
	public List< ? extends Object> findObjectsAddable() {
		if (isEchantillonTyped) {
			List<EchantillonType> echanTypes = (List<EchantillonType>) 
			...
			List<ProdType> prodTypes = (List<ProdType>) 
