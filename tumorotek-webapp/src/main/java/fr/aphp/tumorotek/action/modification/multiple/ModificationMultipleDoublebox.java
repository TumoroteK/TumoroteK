 ...
 *
 */
public class ModificationMultipleDoublebox extends AbstractModificationMultipleComponent
{
   ...
   public Object extractValueFromEraserBox(){
      if(eraseMultiDoublebox.getValue() != null){
         if(isInteger){
            ...
            return ObjectTypesFormatters.floor(eraseMultiDoublebox.getValue().floatValue(), 3);
         }
      }
   ...
   public Object extractValueFromMultiBox(){
      if(multiDoublebox.getValue() != null){
         if(isInteger){
            ...
            return ObjectTypesFormatters.floor(multiDoublebox.getValue().floatValue(), 3);
         }
      }
   ...
   public Object formatValue(final Object obj){
      if(obj instanceof String){
         ...
         if(isInteger){
            ...
            return ObjectTypesFormatters.floor(new Float((String) obj), 3);
         }else{
   ...
   public void setInteger(final boolean i){
      this.isInteger = i;
   }

   public void setFloat(final boolean f){
      this.isFloat = f;
   }

   @Override
   public AnnotateDataBinder getBinder(){
      return ((AnnotateDataBinder) self.getParent().getAttributeOrFellow("modificationDoublebox", true));
   }
