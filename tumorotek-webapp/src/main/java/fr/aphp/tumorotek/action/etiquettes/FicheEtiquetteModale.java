 ...
 *
 */
public class FicheEtiquetteModale
{ // extends AbstractFicheCombineController {
   ...
   @Init
   public void init(@ExecutionArgParam("modele") final Modele m, @ExecutionArgParam("imprimante") final Imprimante imp,
      @ExecutionArgParam("rawLang") final String rL, @ExecutionArgParam("barcodeBy") final BarcodeFieldDefault bY,
      @ExecutionArgParam("parent") final Window win){
      modele = m;
      setRawLang(rL);
   ...
   @Command
   public void cancel(){
      Events.postEvent("onClose", fwinEtiquetteModale, null);
      Events.postEvent("onClose", getImprimanteWindow(), null);
   }
   ...
   public void print(){
      ...
      if(listeCheckbox.isChecked()){
         ...
         if(getPremierNumeroTube() == null){
            throw new WrongValueException(premierNumeroBox, Labels.getLabel("validation.syntax.empty"));
         }

         if(getDernierNumeroTube() == null){
            throw new WrongValueException(dernierNumeroBox, Labels.getLabel("validation.syntax.empty"));
         }
      ...
      if(getSelectedImprimante() != null){
         ...
         if(getSelectedImprimante().getImprimanteApi().getNom().equals("tumo")){
               ...
               if(completed != 1){
                  if(completed == -1){
                     Messagebox.show(ObjectTypesFormatters.getLabel("validation.erreur" + ".imprimante.non.detectee",
                        new String[] {getSelectedImprimante().getNom()}), "Error", Messagebox.OK, Messagebox.ERROR);
                  }else{
            ...
            final MBioFileProperties mBioFile = new MBioFileProperties(getSelectedImprimante().getMbioPrinter());
            ...
            if(completed != 1){
               ...
               Messagebox.show(Labels.getLabel("general.impression.ok"), "Confirm Dialog",
                  Messagebox.OK | Messagebox.IGNORE | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>()
                  {
                     @Override
                     public void onEvent(final Event evt) throws InterruptedException{
                        if(evt.getName().equals("onOK")){
                           log.debug("Data Saved : évènement : {}", evt.getName());
                        }
                     }
                  });
   ...
   public void createListLignes(final int i){
   ...
   public List<LigneEtiquette> createListeEtiquette(final String inc){
      ...
      final List<LigneEtiquette> ligneEtiquettes = new ArrayList<>();
   ...
   public void setCodePrelevement(final String c){
   ...
   public void setNumeroTube(final String n){
      this.numeroTube = n;
   }
   ...
   public void setPatient(final String p){
      this.patient = p;
   }
   ...
   public void setDateCongelation(final String d){
   ...
   public void setQuantite(final String q){
      this.quantite = q;
   }
   ...
   public void setNbrCopies(final Integer nbr){
      this.nbrCopies = nbr;
   }
   ...
   public void setPremierNumeroTube(final Integer pTube){
   ...
   public void setDernierNumeroTube(final Integer dTube){
   ...
   public void setCopies(final Boolean c){
      this.copies = c;
   }
   ...
   public void setListeInc(final Boolean li){
      this.listeInc = li;
   }
   ...
   public void setPremierNumeroBox(final Intbox premierNumeroBox){
   ...
   public void setDernierNumeroBox(final Intbox dernierNumeroBox){
   ...
   public void setMbioData(final Vector<String> m){
      this.mbioData = m;
   }
   ...
   public void setListlignes(final List<List<LigneEtiquette>> l){
      this.listlignes = l;
   }
   ...
   public void setImprimanteWindow(final Window i){
   ...
   public void setRawLang(final String rawLang){
   ...
   public void setBarcodeBy(final BarcodeFieldDefault b){
      this.barcodeBy = b;
   }
