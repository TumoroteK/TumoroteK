...
public class ListeRequetes extends AbstractListeController2 {
	...
	private List<Requete> listObjects = 
		new ArrayList<Requete>();
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		listObjects = (List<Requete>) ManagerLocator.getRequeteManager()
				.findByBanqueManager(
	...
	public void removeObjectFromList(TKdataObject obj) {
		getListObjects().remove((Requete) obj);
	}

	@Override
	public void initObjectsBox() {
		List<Requete> reqs = ManagerLocator.getRequeteManager()
	...
	public AbstractFicheCombineController getFiche() {
		return ((FicheRequete) self.getParent().getParent().getParent()
				.getFellow("ficheRegion")
				.getFellow("ficheRequete")
				.getFellow("winFicheRequete").
	...
	public void onClickObject(Event event) {	
		...
		Requete edit = ((Requete) getCurrentObject()).clone();
