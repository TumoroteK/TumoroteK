...
public class FicheEnceinte extends AbstractFicheCombineStockageController
{
   ...
   public void setObject(final TKdataObject e){
      ...
      if(enceinte.getEnceinteId() != null){
         ...
         final boolean orig = ManagerLocator.getEnceinteManager().getConteneurManager(enceinte).getPlateformeOrig()
            .equals(SessionUtils.getCurrentPlateforme());
         setCanEdit(orig);
         setCanDelete(orig);
   ...
   public void createRetoursApresDeplacementTerminale(){
      ...
      if(!getEmplForRetours().isEmpty()){
         ...
         // créer des retours
         if(askForRetoursCreation(getEmplForRetours().size(), null, null, new Hashtable<TKStockableObject, Emplacement>(), null,
    ...
    */
   public void definirEnceinteDestination(final EnceinteNode node){
