...
public class TerminaleTypeController extends AbstractObjectTabController
{

   private static final long serialVersionUID = -8567525915955606193L;
   ...
   public TKdataObject loadById(final Integer id){
      return ManagerLocator.getTerminaleTypeManager().findByIdManager(id);
   }
   ...
   @Override
   public FicheTerminaleType getFicheCombine(){
      return ((FicheTerminaleType) this.self.getFellow("ficheTerminaleType").getFellow("fwinTerminaleType")
         .getAttributeOrFellow("fwinTerminaleType$composer", true));
   }
   ...
   @Override
   public ListeTerminaleType getListe(){
      return ((ListeTerminaleType) this.self.getFellow("listeTerminaleType").getFellow("lwinTerminaleType")
         .getAttributeOrFellow("lwinTerminaleType$composer", true));
   }
}
