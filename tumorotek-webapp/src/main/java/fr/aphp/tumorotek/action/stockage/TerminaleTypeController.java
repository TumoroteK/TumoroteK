...
public class TerminaleTypeController extends AbstractObjectTabController {
	...
	public FicheTerminaleType getFicheCombine() {
		return ((FicheTerminaleType) 
				this.self.getFellow("ficheTerminaleType")
				.getFellow("fwinTerminaleType")
	...
	public ListeTerminaleType getListe() {
		return ((ListeTerminaleType) 
				this.self.getFellow("listeTerminaleType")
				.getFellow("lwinTerminaleType")
