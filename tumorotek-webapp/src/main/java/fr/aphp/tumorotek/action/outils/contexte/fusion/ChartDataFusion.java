...
public class ChartDataFusion
{
   ...
   public void addValueTo1(final String s1, final String s2, final long l){
      model.setValue(s1, s2, (int) l);
   }

   public void addValueTo2(final String s1, final String s2, final long l){
