...
public final class PatientUtils {
	...
	public static final LabelCodeItem SEXE_M = new LabelCodeItem(Labels
								.getLabel("patient.sexe.homme"), "M");
	public static final LabelCodeItem SEXE_F = new LabelCodeItem(Labels
									.getLabel("patient.sexe.femme"), "F");
	public static final LabelCodeItem SEXE_IND = new LabelCodeItem(Labels
									.getLabel("patient.sexe.ind"), "Ind");
	
	private static List<LabelCodeItem> sexes = new ArrayList<LabelCodeItem>();
	static {
	...
	public static final LabelCodeItem ETAT_V = 
		new LabelCodeItem(Labels.getLabel("patient.etat.vivant"), "V");
	public static final LabelCodeItem ETAT_VF = 
		new LabelCodeItem(Labels.getLabel("patient.etat.vivant.f"), "V");
	public static final LabelCodeItem ETAT_D = 
		new LabelCodeItem(Labels.getLabel("patient.etat.decede"), "D");
	public static final LabelCodeItem ETAT_DF = 
		new LabelCodeItem(Labels.getLabel("patient.etat.decede.f"), "D");
	public static final LabelCodeItem ETAT_I = 
		new LabelCodeItem(Labels.getLabel("patient.etat.inconnu"), "Inconnu");
	
	private static List<LabelCodeItem> etats = new ArrayList<LabelCodeItem>();
	static {
		etats.add(ETAT_V);
		etats.add(ETAT_D);
		etats.add(ETAT_I);
	}
	private static List<LabelCodeItem> etatsF = new ArrayList<LabelCodeItem>();
	static {
		etatsF.add(ETAT_VF);
		etatsF.add(ETAT_DF);
		etatsF.add(ETAT_I);
	 ...
	 */
	public static LabelCodeItem getLabelCodeItemFromValue(String value, 
															boolean isMale) {
		if ("M".equals(value)) {
			return SEXE_M;
	 ...
	 * @return liste banque
	 */
	public static List<Banque> 
					getBanquesConsultForPrelevement(Map<?, ?> session) {
		Set<Banque> banks = 
			new HashSet<Banque>(SessionUtils.getSelectedBanques(session));
		if (banks.size() == 1) {
			// la liste de banques consultables
			banks.addAll(ManagerLocator.getBanqueManager()
				.findByEntiteConsultByUtilisateurManager(SessionUtils
					...
					SessionUtils.getPlateforme(session)));
	 ...
	 */
	public static int getNbPrelsForPatientAndUser(Patient patient,
													List<Banque> banks) {
		...
		while (it.hasNext()) {			
			nbPrelevements = (int) (nbPrelevements 
				+ ManagerLocator.getPatientManager()
					.getCountPrelevementsByBanqueManager(patient, 
											it.next()));
		}
	 ...
	 */
	public static String setSexeFromDBValue(Patient pat) {
		if (pat.getSexe() != null) {
	 ...
	 */
	public static String setEtatFromDBValue(Patient pat) {
	 ...
	 * passé en paramètre.
	 */
	public static String getDateDecesOrEtat(Patient patient) {
	 ...
	 */
	public static String setDiagSeroFromDBValue(Maladie mal) {
		if (mal != null && mal.getDelegate() != null 
				&& ((MaladieSero) mal.getDelegate())
								.getDiagnostic() != null) {
			MaladieSero mS = (MaladieSero) mal.getDelegate();
	...
	public static final LabelCodeItem DIAG_C = new LabelCodeItem(Labels
							.getLabel("maladie.diagnostic.certain"), "C");
	public static final LabelCodeItem DIAG_P = new LabelCodeItem(Labels
							.getLabel("maladie.diagnostic.probable"), "P");
	public static final LabelCodeItem DIAG_S = new LabelCodeItem(Labels
							.getLabel("maladie.diagnostic.suspecte"), "S");
	
	private static List<LabelCodeItem> diagsSero = new ArrayList<LabelCodeItem>();
	static {
