...
public class ShowEchantillonsModale extends GenericForwardComposer<Window> {
	...
	public void init(List<Echantillon> echans, 
			Prelevement prlvt,
			String oPrefixe,
			MainWindow mw,
			Page p) {
	...
	public void onLaterUpdate() {
		...
		List<Echantillon> resultats = ManagerLocator
		.getEchantillonManager()
		.updateCodeEchantillonsManager(echantillons, 
				oldPrefixe, 
				prelevement.getCode(), 
	...
	public void setOldPrefixe(String o) {
		this.oldPrefixe = o;
	}
