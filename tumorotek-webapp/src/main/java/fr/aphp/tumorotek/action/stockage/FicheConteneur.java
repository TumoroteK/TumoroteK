...
public class FicheConteneur extends AbstractFicheCombineStockageController
{
   ...
   public void updateObject(){
      ...
      // update de l'objet
      ManagerLocator.getConteneurManager().updateObjectWithConteneurPlateformesManager(conteneur, selectedConteneurType,
         selectedService, banques, getPlateformesAssociees().getObjects(), getIncidents(),
   ...
   public boolean disableActionsForForeignPlateformeConteneur(final Plateforme pOrig){
      final boolean enable = super.disableActionsForForeignPlateformeConteneur(pOrig);
