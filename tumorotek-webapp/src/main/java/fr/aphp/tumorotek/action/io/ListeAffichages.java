...
public class ListeAffichages extends AbstractListeController2 {
	...
	private List<Affichage> listObjects = 
		new ArrayList<Affichage>();
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		//		+ 38 + "px");
		listObjects = (List<Affichage>) ManagerLocator.getAffichageManager()
				.findByBanqueManager(
	...
	public void removeObjectFromList(TKdataObject obj) {
		getListObjects().remove((Affichage) obj);
	}

	@Override
	public void initObjectsBox() {
		// TODO gérer liste des utilisateurs
		List<Affichage> affs = ManagerLocator.getAffichageManager()
	...
	public AbstractFicheCombineController getFiche() {
		return ((FicheAffichage) self.getParent().getParent().getParent()
				.getFellow("ficheRegion")
				.getFellow("ficheAffichage")
				.getFellow("winFicheAffichage").
				getAttributeOrFellow("winFicheAffichage$composer", true));
	}
	...
	public void onClickObject(Event event) {	
		...
		Affichage edit = ((Affichage) getCurrentObject()).clone();
