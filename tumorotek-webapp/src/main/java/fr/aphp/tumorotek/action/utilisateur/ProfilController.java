...
public class ProfilController extends AbstractObjectTabController
{
   ...
   public FicheProfil getFicheCombine(){
      return ((FicheProfil) this.self.getFellow("ficheProfil").getFellow("fwinProfil").getAttributeOrFellow("fwinProfil$composer",
         true));
   }

   @Override
   public ListeProfil getListe(){
      return ((ListeProfil) this.self.getFellow("listeProfil").getFellow("lwinProfil").getAttributeOrFellow("lwinProfil$composer",
         true));
   }
   ...
   public static AbstractObjectTabController backToMe(final MainWindow window, final Tabbox tabbox){
      ...
      if(tabbox != null){
         ...
         final Tabpanel tab = (Tabpanel) tabbox.getFellow("profilsPanel");

         window.createMacroComponent("/zuls/utilisateur/Profil.zul", "winProfil", tab);

         tabController = ((ProfilController) tab.getFellow("winProfil").getAttributeOrFellow("winProfil$composer", true));
    ...
    * @since 2.1
    */
   public void selectProfilInListe(final Profil profil){
