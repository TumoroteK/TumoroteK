...
public final class ManagerLocator
{
   ...
   static{
      ...
      THESAURUS_MANAGER_MAP.put(OrganismePromoteur.class, OrganismePromoteurManager.class);
   ...
   public static RisqueManager getRisqueManager(){
      return (RisqueManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("risqueManager");
   }

   /* Managers du package contexte */
   public static CollaborateurManager getCollaborateurManager(){
      return (CollaborateurManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("collaborateurManager");
   }

   public static TitreManager getTitreManager(){
      return (TitreManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("titreManager");
   }

   public static SpecialiteManager getSpecialiteManager(){
      return (SpecialiteManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("specialiteManager");
   }

   public static EtablissementManager getEtablissementManager(){
      return (EtablissementManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("etablissementManager");
   }

   public static ServiceManager getServiceManager(){
      return (ServiceManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("serviceManager");
   }
   ...
   public static CategorieManager getCategorieManager(){
      return (CategorieManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("categorieManager");
   }

   public static CoordonneeManager getCoordonneeManager(){
      return (CoordonneeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("coordonneeManager");
   }

   public static PlateformeManager getPlateformeManager(){
      return (PlateformeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("plateformeManager");
   }

   /* Managers du package patient */
   public static PatientManager getPatientManager(){
      return (PatientManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("patientManager");
   }

   public static PatientValidator getPatientValidator(){
      return (PatientValidator) (ContextLoader.getCurrentWebApplicationContext()).getBean("patientValidator");
   }
   ...
   public static EchantillonManager getEchantillonManager(){
      return (EchantillonManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("echantillonManager");
   }

   public static EchantillonValidator getEchantillonValidator(){
      return (EchantillonValidator) (ContextLoader.getCurrentWebApplicationContext()).getBean("echantillonValidator");
   }

   public static EchantillonTypeManager getEchantillonTypeManager(){
      return (EchantillonTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("echantillonTypeManager");
   }

   public static EchanQualiteManager getEchanQualiteManager(){
      return (EchanQualiteManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("echanQualiteManager");
   }

   public static ModePrepaManager getModePrepaManager(){
      return (ModePrepaManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("modePrepaManager");
   }
   ...
   public static UniteManager getUniteManager(){
      return (UniteManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("uniteManager");
   }

   public static ObjetStatutManager getObjetStatutManager(){
      return (ObjetStatutManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("objetStatutManager");
   }

   /* Package prodderive */
   public static ProdDeriveManager getProdDeriveManager(){
      return (ProdDeriveManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("prodDeriveManager");
   }

   public static ProdDeriveValidator getProdDeriveValidator(){
      return (ProdDeriveValidator) (ContextLoader.getCurrentWebApplicationContext()).getBean("prodDeriveValidator");
   }

   public static ProdTypeManager getProdTypeManager(){
      return (ProdTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("prodTypeManager");
   }

   public static ProdQualiteManager getProdQualiteManager(){
      return (ProdQualiteManager) ContextLoader.getCurrentWebApplicationContext().getBean("prodQualiteManager");
   }

   public static TransformationManager getTransformationManager(){
      return (TransformationManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("transformationManager");
   }

   public static ModePrepaDeriveManager getModePrepaDeriveManager(){
      return (ModePrepaDeriveManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("modePrepaDeriveManager");
   }

   /* Managers du package utilisateur */
   public static UtilisateurManager getUtilisateurManager(){
      return (UtilisateurManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("utilisateurManager");
   }

   public static ProfilManager getProfilManager(){
      return (ProfilManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("profilManager");
   }

   public static ProfilUtilisateurManager getProfilUtilisateurManager(){
      return (ProfilUtilisateurManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("profilUtilisateurManager");
   }

   public static DroitObjetManager getDroitObjetManager(){
      return (DroitObjetManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("droitObjetManager");
   }

   /* Managers du package prelevement */
   public static PrelevementManager getPrelevementManager(){
      return (PrelevementManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("prelevementManager");
   }

   public static PrelevementValidator getPrelevementValidator(){
      return (PrelevementValidator) (ContextLoader.getCurrentWebApplicationContext()).getBean("prelevementValidator");
   }

   public static LaboInterValidator getLaboInterValidator(){
      return (LaboInterValidator) (ContextLoader.getCurrentWebApplicationContext()).getBean("laboInterValidator");
   }

   public static NatureManager getNatureManager(){
      return (NatureManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("natureManager");
   }

   public static PrelevementTypeManager getPrelevementTypeManager(){
      return (PrelevementTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("prelevementTypeManager");
   }

   public static ConditTypeManager getConditTypeManager(){
      return (ConditTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("conditTypeManager");
   }

   public static ConditMilieuManager getConditMilieuManager(){
      return (ConditMilieuManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("conditMilieuManager");
   }

   public static ConsentTypeManager getConsentTypeManager(){
      return (ConsentTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("consentTypeManager");
   }

   public static LaboInterManager getLaboInterManager(){
      return (LaboInterManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("laboInterManager");
   }

   /* Managers du package qualite */
   public static OperationManager getOperationManager(){
      return (OperationManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("operationManager");
   }

   public static OperationTypeManager getOperationTypeManager(){
      return (OperationTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("operationTypeManager");
   }

   public static ConformiteTypeManager getConformiteTypeManager(){
      return (ConformiteTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("conformiteTypeManager");
   }

   public static NonConformiteManager getNonConformiteManager(){
      return (NonConformiteManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("nonConformiteManager");
   }
   ...
   public static RechercheManager getRechercheManager(){
      return (RechercheManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("rechercheManager");
   }

   public static AffichageManager getAffichageManager(){
      return (AffichageManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("affichageManager");
   }

   public static ResultatManager getResultatManager(){
      return (ResultatManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("resultatManager");
   }

   public static RequeteManager getRequeteManager(){
      return (RequeteManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("requeteManager");
   }

   public static GroupementManager getGroupementManager(){
      return (GroupementManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("groupementManager");
   }

   public static CritereManager getCritereManager(){
      return (CritereManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("critereManager");
   }

   public static ExportUtils getExportUtils(){
      return (ExportUtils) (ContextLoader.getCurrentWebApplicationContext()).getBean("exportUtils");
   }

   /* Managers du package io utils */
   public static CorrespondanceManager getCorrespondanceManager(){
      return (CorrespondanceManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("correspondanceManager");
   }

   public static CorrespondanceIdManager getCorrespondanceIdManager(){
      return (CorrespondanceIdManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("correspondanceIdManager");
   }

   public static TraitementRequeteManager getTraitementRequeteManager(){
      return (TraitementRequeteManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("traitementRequeteManager");
   }

   public static TraitementQueryManager getTraitementQueryManager(){
      return (TraitementQueryManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("traitementQueryManager");
   }

   /* Managers du package cession */
   public static CederObjetManager getCederObjetManager(){
      return (CederObjetManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("cederObjetManager");
   }

   public static CessionManager getCessionManager(){
      return (CessionManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("cessionManager");
   }

   public static CessionExamenManager getCessionExamenManager(){
      return (CessionExamenManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("cessionExamenManager");
   }

   public static CessionStatutManager getCessionStatutManager(){
      return (CessionStatutManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("cessionStatutManager");
   }

   public static CessionTypeManager getCessionTypeManager(){
      return (CessionTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("cessionTypeManager");
   }

   public static DestructionMotifManager getDestructionMotifManager(){
      return (DestructionMotifManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("destructionMotifManager");
   }

   public static ContratManager getContratManager(){
      return (ContratManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("contratManager");
   }

   public static ProtocoleTypeManager getProtocoleTypeManager(){
      return (ProtocoleTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("protocoleTypeManager");
   }

   /* Managers du package annotation */
   public static TableAnnotationManager getTableAnnotationManager(){
      return (TableAnnotationManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("tableAnnotationManager");
   }

   public static DataTypeManager getDataTypeManager(){
      return (DataTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("dataTypeManager");
   }

   public static ChampAnnotationManager getChampAnnotationManager(){
      return (ChampAnnotationManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("champAnnotationManager");
   }

   public static AnnotationValeurManager getAnnotationValeurManager(){
      return (AnnotationValeurManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("annotationValeurManager");
   }

   public static CatalogueManager getCatalogueManager(){
      return (CatalogueManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("catalogueManager");
   }
   ...
   public static CouleurEntiteTypeManager getCouleurEntiteTypeManager(){
      return (CouleurEntiteTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("couleurEntiteTypeManager");
   }

   public static TemperatureManager getTemperatureManager(){
      return (TemperatureManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("temperatureManager");
   }

   public static NumerotationManager getNumerotationManager(){
      return (NumerotationManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("numerotationManager");
   }

   public static VersionManager getVersionManager(){
      return (VersionManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("versionManager");
   }

   /***************** Package stockage. *********************/

   public static ConteneurManager getConteneurManager(){
      return (ConteneurManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("conteneurManager");
   }

   public static ConteneurTypeManager getConteneurTypeManager(){
      return (ConteneurTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("conteneurTypeManager");
   }

   public static EmplacementManager getEmplacementManager(){
      return (EmplacementManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("emplacementManager");
   }

   public static EnceinteManager getEnceinteManager(){
      return (EnceinteManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("enceinteManager");
   }

   public static EnceinteTypeManager getEnceinteTypeManager(){
      return (EnceinteTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("enceinteTypeManager");
   }

   public static IncidentManager getIncidentManager(){
      return (IncidentManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("incidentManager");
   }

   public static TerminaleManager getTerminaleManager(){
      return (TerminaleManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("terminaleManager");
   }

   public static TerminaleNumerotationManager getTerminaleNumerotationManager(){
      return (TerminaleNumerotationManager) (ContextLoader.getCurrentWebApplicationContext())
         .getBean("terminaleNumerotationManager");
   }

   public static TerminaleTypeManager getTerminaleTypeManager(){
      return (TerminaleTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("terminaleTypeManager");
   }
   ...
   public static CimoMorphoManager getCimoMorphoManager(){
      return (CimoMorphoManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("cimoMorphoManager");
   }

   public static TableCodageManager getTableCodageManager(){
      return (TableCodageManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("tableCodageManager");
   }

   public static CommonUtilsManager getCommonUtilsManager(){
      return (CommonUtilsManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("commonUtilsManager");
   }

   public static CodeUtilisateurManager getCodeUtilisateurManager(){
      return (CodeUtilisateurManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("codeUtilisateurManager");
   }

   public static CodeDossierManager getCodeDossierManager(){
      return (CodeDossierManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("codeDossierManager");
   }

   public static CodeAssigneManager getCodeAssigneManager(){
      return (CodeAssigneManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("codeAssigneManager");
   }

   public static CodeSelectManager getCodeSelectManager(){
      return (CodeSelectManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("codeSelectManager");
   }

   /*************** Package XML. ********************/
   public static XmlUtils getXmlUtils(){
      return (XmlUtils) (ContextLoader.getCurrentWebApplicationContext()).getBean("xmlUtils");
   }

   /*************** Package Impression. ********************/
   public static BlocImpressionManager getBlocImpressionManager(){
      return (BlocImpressionManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("blocImpressionManager");
   }

   public static BlocImpressionTemplateManager getBlocImpressionTemplateManager(){
      return (BlocImpressionTemplateManager) (ContextLoader.getCurrentWebApplicationContext())
         .getBean("blocImpressionTemplateManager");
   }

   /*public static CleImpressionManager getCleImpressionManager() {
   	return (CleImpressionManager) (ContextLoader
   		.getCurrentWebApplicationContext())
   		.getBean("cleImpressionManager");
   }*/

   public static ChampEntiteBlocManager getChampEntiteBlocManager(){
      return (ChampEntiteBlocManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("champEntiteBlocManager");
   }

   public static ChampImprimeManager getChampImprimeManager(){
      return (ChampImprimeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("champImprimeManager");
   }

   public static TableAnnotationTemplateManager getTableAnnotationTemplateManager(){
      return (TableAnnotationTemplateManager) (ContextLoader.getCurrentWebApplicationContext())
         .getBean("tableAnnotationTemplateManager");
   }

   public static TemplateManager getTemplateManager(){
      return (TemplateManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("templateManager");
   }

   public static CouleurManager getCouleurManager(){
      return (CouleurManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("couleurManager");
   }

   public static ContexteManager getContexteManager(){
      return (ContexteManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("contexteManager");
   }

   public static IncaReportManager getIncaReportManager(){
      return (IncaReportManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("incaReportManager");
   }

   /****************** Etiquettes. ************************/
   public static TumoBarcodePrinter getTumoBarcodePrinter(){
      return (TumoBarcodePrinter) (ContextLoader.getCurrentWebApplicationContext()).getBean("tumoBarcodePrinter");
   }

   public static TumoPrinterUtilsManager getTumoPrinterUtilsManager(){
      return (TumoPrinterUtilsManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("tumoPrinterUtilsManager");
   }

   /****************** Import. ************************/
   public static ImportManager getImportManager(){
      return (ImportManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("importManager");
   }

   public static ImportTemplateManager getImportTemplateManager(){
      return (ImportTemplateManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("importTemplateManager");
   }

   public static ImportColonneManager getImportColonneManager(){
      return (ImportColonneManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("importColonneManager");
   }
   ...
   public static ImprimanteApiManager getImprimanteApiManager(){
      return (ImprimanteApiManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("imprimanteApiManager");
   }

   public static ModeleManager getModeleManager(){
      return (ModeleManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("modeleManager");
   }

   public static ModeleTypeManager getModeleTypeManager(){
      return (ModeleTypeManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("modeleTypeManager");
   }

   public static AffectationImprimanteManager getAffectationImprimanteManager(){
      return (AffectationImprimanteManager) (ContextLoader.getCurrentWebApplicationContext())
         .getBean("affectationImprimanteManager");
   }

   public static LigneEtiquetteManager getLigneEtiquetteManager(){
      return (LigneEtiquetteManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("ligneEtiquetteManager");
   }

   public static ChampLigneEtiquetteManager getChampLigneEtiquetteManager(){
      return (ChampLigneEtiquetteManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("champLigneEtiquetteManager");
   }

   public static RetourManager getRetourManager(){
      return (RetourManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("retourManager");
   }

   public static RetourValidator getRetourValidator(){
      return (RetourValidator) (ContextLoader.getCurrentWebApplicationContext()).getBean("retourValidator");
   }

   /*************** Package Bundle. ********************/

   public static ResourceBundleMbio getResourceBundleMbio(){
      return (ResourceBundleMbio) (ContextLoader.getCurrentWebApplicationContext()).getBean("resourceBundleMbio");
   }

   public static ResourceBundleSip getResourceBundleSip(){
      return (ResourceBundleSip) (ContextLoader.getCurrentWebApplicationContext()).getBean("resourceBundleSip");
   }

   public static ResourceBundleTumo getResourceBundleTumo(){
      return (ResourceBundleTumo) (ContextLoader.getCurrentWebApplicationContext()).getBean("resourceBundleTumo");
   }

   /************* Export Catalogue. ****************/
   public static ExportCatalogueManager getExportINCaManager(){
      return (ExportCatalogueManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("exportINCaManager");
   }

   public static ExportCatalogueManager getExportTVGSOManager(){
      return (ExportCatalogueManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("exportTVGSOManager");
   }

   /*************** Package Interfacage. ********************/

   public static EmetteurManager getEmetteurManager(){
      return (EmetteurManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("emetteurManager");
   }

   public static RecepteurManager getRecepteurManager(){
      return (RecepteurManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("recepteurManager");
   }

   public static DossierExterneManager getDossierExterneManager(){
      return (DossierExterneManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("dossierExterneManager");
   }

   public static BlocExterneManager getBlocExterneManager(){
      return (BlocExterneManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("blocExterneManager");
   }

   public static ValeurExterneManager getValeurExterneManager(){
      return (ValeurExterneManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("valeurExterneManager");
   }

   public static InjectionManager getInjectionManager(){
      return (InjectionManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("injectionManager");
   }

   public static PatientSipManager getPatientSipManager(){
      return (PatientSipManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("patientSipManager");
   }
   ...
   public static SenderFactory getSenderFactory(){
      if((ContextLoader.getCurrentWebApplicationContext()).containsBean("senderFactory")){
         return (SenderFactory) (ContextLoader.getCurrentWebApplicationContext()).getBean("senderFactory");
      }
      return null;
   }

   public static ProtocoleManager getProtocoleManager(){
      return (ProtocoleManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("protocoleManager");
   }

   public static IndicateurManager getIndicateurManager(){
      return (IndicateurManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("indicateurManager");
   }

   public static SubdivisionManager getSubdivisionManager(){
      return (SubdivisionManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("subdivisionManager");
   }

   public static SModeleManager getSModeleManager(){
      return (SModeleManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("sModeleManager");
   }

   public static GraphesModeleManager getGraphesModeleManager(){
      return (GraphesModeleManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("graphesModeleManager");
   }

   public static ScanTerminaleManager getScanTerminaleManager(){
      return (ScanTerminaleManager) (ContextLoader.getCurrentWebApplicationContext()).getBean("scanTerminaleManager");
   }
   ...
   public static ViewHandlerFactory getViewHandlerFactory(){
      return (ViewHandlerFactory) (ContextLoader.getCurrentWebApplicationContext()).getBean("viewHandlerFactory");
   }
