...
public class ConteneurDecorator {
	...
	public ConteneurDecorator(Conteneur c, Plateforme current) {
		setConteneur(c);
		setCurrent(current);
	...
	public void setDeleteHeaderVisible(Boolean i) {
	...
	public void setCurrent(Plateforme current) {
		this.current = current;
	}

	public static List<ConteneurDecorator> decorateListe(List<Conteneur> conts, 
			Plateforme current) {
		List<ConteneurDecorator> decos = null;
		
		if (conts != null) {
			decos = new ArrayList<ConteneurDecorator>();
			for (Conteneur c : conts) {
	 ...
	 */
	public static List<Conteneur> extractConteneursFromDecos(List<ConteneurDecorator> decos) {
		List<Conteneur> conts = null;
		if (decos != null) {
			conts = new ArrayList<Conteneur>();
			for (ConteneurDecorator deco : decos) {
	...
	public boolean equals(Object obj) {
		...
		ConteneurDecorator test = (ConteneurDecorator) obj;
		return ((this.current == test.current
				|| (this.current != null 
						&& this.current.equals(test.current))) 
