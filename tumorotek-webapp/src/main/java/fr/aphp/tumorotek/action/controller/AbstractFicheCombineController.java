 ...
 *
 */
public abstract class AbstractFicheCombineController 
	...
	public void setClone(TKdataObject c) {
		this.clone = c;
	}
	...
	public void setObjLabelsComponents(Component[] cs) {
	...
	public void setObjBoxsComponents(Component[] cs) {
	...
	public void setRequiredMarks(Component[] rM) {
	...
	public void setListeRetour(ListeRetour lR) {
		this.listeRetour = lR;
	}
	 ...
	 */
	public void switchToStaticMode(boolean isEmptyObj) {
		...
		if (getObjectTabController() != null 
				&& getObjectTabController().getListe() != null) {
	...
	private void switchButtonsToCreateOrEdit(boolean isCreate) {
	...
	private void switchComponentsVisibility(boolean isStatic) {
	...
	public void onClick$deleteC() {
		if (getObject() != null) {
			...
			boolean archive = prepareDeleteObject();
		
			openDeleteWindow(page, getDeleteMessage(), isCascadable(), 
						isFantomable(), isDeletable(), self, archive);
		}
	}
...
//			}
	...
	public void setCanSeeHistorique(boolean canHistorique) {
