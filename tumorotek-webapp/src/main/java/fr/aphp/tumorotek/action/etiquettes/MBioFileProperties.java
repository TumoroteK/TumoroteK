...
public class MBioFileProperties
{
   ...
   public void setConfDir(final String conf){
      this.confDir = conf;
   }
   ...
   public void setLabelFormatId(final String labelId){
      this.labelFormatId = labelId;
   }
   ...
   public void setPrinterId(final Integer printer){
