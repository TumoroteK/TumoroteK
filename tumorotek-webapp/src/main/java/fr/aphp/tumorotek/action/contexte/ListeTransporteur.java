...
public class ListeTransporteur extends AbstractListeController2 {
	...
	private List<Transporteur> listObjects = new ArrayList<Transporteur>();
	
	private TransporteurRowRenderer renderer = 
											new TransporteurRowRenderer();
	...
	public void removeObjectFromList(TKdataObject obj) {
		getListObjects().remove((Transporteur) obj);
	}


	@Override
	public void initObjectsBox() {
		List<Transporteur> transporteurs = ManagerLocator
			.getTransporteurManager().findAllObjectsManager();
	...
	public void onClick$viewObject(Event event) {
		...
		Transporteur edit = ((Transporteur) getCurrentObject()).clone();
