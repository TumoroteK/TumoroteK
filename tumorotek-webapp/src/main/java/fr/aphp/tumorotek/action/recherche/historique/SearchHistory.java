...
public class SearchHistory implements Serializable {
	...
	List<String> openedGroupsIds = new ArrayList<String>();

	public SearchHistory() {
		listSearchHistoryComponent = new ArrayList<RechercheCompValues>();
		listAnnotationsComponent = new ArrayList<RechercheCompValues>();
	}
	...
	public void setInfo(String time, int count) {
		setSearchTime(time);
		setResultCount(count);

		this.info = searchTime + GREATER_THAN + resultCount + SPACE
				+ Labels.getLabel("recherche.avancee.historique.resultat");
	}
	...
	public void setListSearchHistoryComponent(List<RechercheCompValues> lshc) {
	...
	public void setListAnnotationsComponent(List<RechercheCompValues> lac) {
	...
	public void setOpenedGroupsIds(List<String> ogi) {
