...
public class AffichageController extends AbstractObjectTabController
{
   ...
   public TKdataObject loadById(final Integer id){
      return ManagerLocator.getAffichageManager().findByIdManager(id);
   }
   ...
   public ListeAffichages getListeAffichages(){
      return ((ListeAffichages) this.self.getFellow("listeAffichages").getFellow("lwinAffichages")
         .getAttributeOrFellow("lwinAffichages$composer", true));
   }

   @Override
   public AbstractFicheCombineController getFicheCombine(){
      return ((FicheAffichage) this.self.getFellow("ficheAffichage").getFellow("winFicheAffichage")
