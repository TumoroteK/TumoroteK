...
public class LevenshteinDistance {
	...
	public static double similarityTwoParams(String a1, String a2, String b1, String b2){
		
		return (similarity(a1, a2)+similarity(b1, b2)) /2;
	}

	public static double similarityThreeParams(String a1, String a2, String b1, String b2, String c1, String c2){
