...
public class FicheRechercheAvancee extends AbstractFicheRechercheAvancee
{
   ...
   public void doAfterCompose(final Component comp) throws Exception{
      ...
      objPrelevementComponents =
         new Component[] {this.ndaPatientBox, this.codePrelevementBox, this.natutePrelevementBox, this.codeLaboPrelevementBox,
            this.datePrelevement1Box, this.datePrelevement2Box, this.statutJuridiqueBox, this.etablissementPreleveurBox,
            this.servicePreleveurBox, this.nbEchantillonBox, this.agePrlvtBox, this.risquesBox, this.conformeBoolBox,
            this.nonConformitesArriveeBox, this.etablissementLaboBox, this.serviceLaboBox, this.operateurLaboBox};

      objEchantillonComponents = new Component[] {this.codeEchantillonBox, this.typeEchantillonBox, this.qualiteEchantillonBox,
         this.statutEchantillonBox, this.quantiteEchantillonBox, this.delaiCglEchantillonBox, this.dateStock1Box,
         this.dateStock2Box, this.tempStockEchantillonBox, this.modePreparationEchantillonBox, this.codeLesionnelBox,
         this.codeOrganeBox, this.conformeEchanTraitementBoolBox, this.nonConformitesEchanTraitementBox,
         this.conformeEchanCessionBoolBox, this.nonConformitesEchanCessionBox, this.crAnapathFilebox};
      ...
      objProdDeriveComponents = new Component[] {this.codeProdDeriveBox, this.typeProdDeriveBox, this.codeLaboProdDeriveBox,
         ...
         this.dateStockDerive1Box, this.dateStockDerive2Box, this.tempStockDeriveBox, this.conformeDeriveTraitementBoolBox,
         this.nonConformitesDeriveTraitementBox, this.conformeDeriveCessionBoolBox, this.nonConformitesDeriveCessionBox};
      ...
      objOperateurs = new Component[] {this.operateursAgePrlvtBox, this.operateursDateDebutBox, this.operateursDateDiagBox,
         ...
         this.operateursDateStockBox, this.operateursTempStockEchantillonBox, this.operateursNbEchantillonBox,
         this.operateursQuantiteDeriveBox, this.operateursQuantiteEchantillonBox, this.operateursVolumeDerivesBox,
   ...
   public void initRechercheAvancee(final Entite entite, final String path, final boolean ano,
      ...
      etablissementsLabo = new SimpleListModel<>(etablissements);
      servicesLabo = new SimpleListModel<>(new ArrayList<Service>());
      collaborateursLabo =
         new SimpleListModel<>(ManagerLocator.getCollaborateurManager().findAllActiveObjectsWithOrderManager());
   ...
   public void onSelect$etablissementLaboBox(){
      ...
      Etablissement etab = !etablissementsLabo.isSelectionEmpty() ? etablissementsLabo.getSelection().iterator().next() : null;
      ...
      if(etab != null){
         final List<Service> servs = ManagerLocator.getEtablissementManager().getActiveServicesWithOrderManager(etab);
         servs.add(0, null);
         servicesLabo = new SimpleListModel<>(servs);
      }
   ...
   public void onSelect$serviceLaboBox(){
      ...
      Service srv = !servicesLabo.isSelectionEmpty() ? servicesLabo.getSelection().iterator().next() : null;
      ...
      if(srv != null){
         collabs.addAll(ManagerLocator.getCollaborateurManager().findByServicesAndArchiveManager(srv, false));
      }else{
         collabs.addAll(ManagerLocator.getCollaborateurManager().findAllActiveObjectsWithOrderManager());
      }
      // collabs.add(0, null);

      collaborateursLabo = new SimpleListModel<>(collabs);
   ...
   public void executeQueriesForPatients(){
         ...
         if(objPatientComponents[i] != null){
            ...
            if(objPatientComponents[i].getClass().getSimpleName().equals("Textbox")){
               ...
               if(current.getValue() != null){
                  ...
                  // exécution de la requête
                  if(operateur != null){
                     executeSimpleQueryForDatebox(current, parent1ToQueryPatient, parent2ToQueryPatient, operateur, false);
                  }
      ...
      if(sexes.size() > 0){
         executeListQuery("Sexe", "Patient", ManagerLocator.getEntiteManager().findByIdManager(1), null, sexes, false);
         oneValueEntered = true;
      }
      if(etats.size() > 0){
         executeListQuery("PatientEtat", "Patient", ManagerLocator.getEntiteManager().findByIdManager(1), null, etats, false);
         oneValueEntered = true;
      }
   }
         ...
         if(objMaladieComponents[i] != null){
            ...
            if(objMaladieComponents[i].getClass().getSimpleName().equals("Textbox")){
               ...
               if(current.getValue() != null){
                  ...
                  // exécution de la requête
                  if(operateur != null){
                     executeSimpleQueryForDatebox(current, parent1ToQueryMaladie, parent2ToQueryMaladie, operateur, false);
                  }
         ...
         if(objPrelevementComponents[i] != null){
            ...
            if(objPrelevementComponents[i].getClass().getSimpleName().equals("Textbox")){
               ...
               if(current.getValue() != null && !current.getValue().equals("")){
                  ...
                  if(current.getId().equals("nonConformitesArriveeBox")){
                     ...
                     if(!entiteToSearch.getNom().equals("Prelevement")){
                        ...
                        executeObjetByNonConformite(current, ManagerLocator.getConformiteTypeManager().findByIdManager(1),
               ...
               if(current.getValue() != null){
                  ...
                  // exécution de la requête
                  if(operateur != null){
                     executeSimpleQueryForDatebox(current, parent1ToQueryPrlvt, parent2ToQueryPrlvt, operateur, false);
                  }
               ...
               if(current.getValue() != null){
                  ...
                  // exécution de la requête
                  if(operateur != null){
                     executeSimpleQueryForCalendarbox(current, parent1ToQueryPrlvt, parent2ToQueryPrlvt, operateur);
                  }
         ...
         if(objEchantillonComponents[i] != null){
            ...
            if(objEchantillonComponents[i].getClass().getSimpleName().equals("Textbox")){
               ...
               if(current.getValue() != null && !current.getValue().equals("")){
                  ...
                  if(current.getId().equals("codeOrganeBox")){
                     ...
                     if(!entiteToSearch.getNom().equals("Echantillon")){
                        ...
                        executeObjetByNonConformite(current, ManagerLocator.getConformiteTypeManager().findByIdManager(2),
                     ...
                     if(!entiteToSearch.getNom().equals("Echantillon")){
                        ...
                        executeObjetByNonConformite(current, ManagerLocator.getConformiteTypeManager().findByIdManager(3),
                           current.getValue(), parent1, null, searchForProdDerives);
                     }else{
                        executeObjetByNonConformite(current, ManagerLocator.getConformiteTypeManager().findByIdManager(3),
                           current.getValue(), null, null, searchForProdDerives);
               ...
               if(current.getValue() != null){
                  ...
                  // exécution de la requête
                  if(operateur != null){
                     executeSimpleQueryForCalendarbox(current, parentToQueryEchantillon, null, operateur);
                  }
               ...
               if(current.getValue() != null && !current.getValue().equals("")){
                  if(current.getId().equals("nonConformitesDeriveTraitementBox")){
                     if(!entiteToSearch.getNom().equals("ProdDerive")){
                        ...
                        executeObjetByNonConformite(current, ManagerLocator.getConformiteTypeManager().findByIdManager(4),
                           current.getValue(), parent1, parent2, searchForProdDerives);
                     }else{
                        executeObjetByNonConformite(current, ManagerLocator.getConformiteTypeManager().findByIdManager(4),
                           current.getValue(), null, null, searchForProdDerives);
                     ...
                     if(!entiteToSearch.getNom().equals("ProdDerive")){
                        ...
                        executeObjetByNonConformite(current, ManagerLocator.getConformiteTypeManager().findByIdManager(5),
                           current.getValue(), parent1, parent2, searchForProdDerives);
                     }else{
                        executeObjetByNonConformite(current, ManagerLocator.getConformiteTypeManager().findByIdManager(5),
                           current.getValue(), null, null, searchForProdDerives);
   ...
   public void executeAgeAuPrelevementQuery(final String operateur, final Integer age){
      ...
      // dans la liste
      if(!otherQuery){
         resultatsIds = ManagerLocator.getTraitementQueryManager().findPrelevementsByAgePatientWithBanquesManager(operateur, age,
            banques, SessionUtils.getDbms());
      }else{
         // sinon on fait une intersection des résultats de la
         // requête avec ceux déjà trouvés
         final List<Integer> objects = ManagerLocator.getTraitementQueryManager()
    ...
    * @since 2.2.1
    */
   public void executePrelevementViaLaboInterQuery(final Object obj, final Component current, final int selectedIndex){
      ...
      // dans la liste
      if(!otherQuery){
         resultatsIds = ManagerLocator.getTraitementQueryManager().findPrelevementIdsViaLaboInterManager(obj, banques);
      }else{
         // sinon on fait une intersection des résultats de la
         // requête avec ceux déjà trouvés
         resultatsIds = ListUtils.intersection(resultatsIds,
            ManagerLocator.getTraitementQueryManager().findPrelevementIdsViaLaboInterManager(obj, banques));
      }
      otherQuery = true;
   ...
   public void executeObjetByNonConformite(final Textbox current, final ConformiteType cType, final String cNom, final Champ p1,
      final Champ p2, final boolean searchForDerive){
   ...
   public void executeCodesQuery(final Textbox current, final Champ parent1, final String entiteInEchantillon,
      final String entiteFinale, final boolean isMorpho){
