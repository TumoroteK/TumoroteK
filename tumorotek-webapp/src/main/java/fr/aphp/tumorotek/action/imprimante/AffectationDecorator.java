...
public class AffectationDecorator {
	...
	public AffectationDecorator(Utilisateur u,
			Banque b, boolean first, boolean last, Integer nb) {
		utilisateur = u;
		banque = b;
		isFirst = first;
		isLast = last;
	...
	public void setFirst(boolean i) {
		this.isFirst = i;
	}
	...
	public void setNbBanquesForUtilisateur(Integer nb) {
	...
	public void setEdit(boolean isE) {
		this.isEdit = isE;
	}
}
