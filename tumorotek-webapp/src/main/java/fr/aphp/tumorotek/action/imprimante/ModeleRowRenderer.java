 ...
 * @version 2.0
 */
public class ModeleRowRenderer implements RowRenderer {
	...
	public void render(Row row, Object data, int index) throws Exception {
		Modele mod = (Modele) data;
		
		// nom
		Label nomLabel = new Label(mod.getNom());
		...
		if (mod.getIsDefault() != null) {
			isDefault = ObjectTypesFormatters
				.booleanLitteralFormatter(mod.getIsDefault());
		}
