...
public class FicheImprimanteModale extends AbstractFicheCombineController {
	...
	private List<ImprimanteApi> imprimanteApis = new ArrayList<ImprimanteApi>();
	...
	private List<String> availableImprimantes = new ArrayList<String>();
...
//		}
	 ...
	 * @param comp
	 */
	public void initImprimanteModale(Imprimante imp, Component comp) {
		setParent(comp);
		setObject(imp);
	...
	public void onClick$createC() {
		...
		if (selectedImprimante == null) {
			throw new WrongValueException(
					imprimantesBox, 
					Labels.getLabel("fiche.imprimante.error.imprimante"));
		}
		...
		if (selectedImprimanteApi == null) {
			throw new WrongValueException(
					imprimanteApisBox, 
					Labels.getLabel("fiche.imprimante.error.imprimanteApi"));
		}
		...
		if (selectedOrientation == null) {
			throw new WrongValueException(
					orientationsBox, 
					Labels.getLabel("fiche.imprimante.error.orientation"));
		}
		
		if (imprimante.getAdresseIp() != null 
				&& imprimante.getAdresseIp().equals("")) {
	...
	public void createNewObject() {
		...
		if (selectedOrientation.equals(Labels
				.getLabel("Champ.Imprimante.Orientation.portrait"))) {
		...
		if (!selectedImprimanteApi.getNom().equals("mbio")) {
			...
			imprimante.setNom(selectedImprimante 
					+ " - " + imprimante.getMbioPrinter());
		}
		
		// update de l'objet
		ManagerLocator.getImprimanteManager().createObjectManager(imprimante, 
	...
	public void updateObject() {
		...
		// update de l'objet
		ManagerLocator.getImprimanteManager().updateObjectManager(imprimante, 
				SessionUtils.getPlateforme(sessionScope), 
				selectedImprimanteApi);
	}
	...
	public void switchToCreateMode() {		
		...
		availableImprimantes.add(
				Labels.getLabel("fiche.imprimante.fictive"));
	...
	public void initEditableMode() {
		...
		orientations.add(Labels.getLabel(
				"Champ.Imprimante.Orientation.portrait"));
		orientations.add(Labels.getLabel(
			"Champ.Imprimante.Orientation.paysage"));
		
		// init des apis
		imprimanteApis = ManagerLocator.getImprimanteApiManager()
			.findAllObjectsManager();
		imprimanteApis.add(0, null);
		
		availableImprimantes = new ArrayList<String>();
		...
		List<String> nomsUtilises = ManagerLocator.getImprimanteManager()
			.findByPlateformeSelectNomManager(
					SessionUtils.getPlateforme(sessionScope));
		for (int i = 0; i < printServices.length; i++) {
			// si nom valide et imprimante pas encore définie
			if (printServices[i].getName() != null
					&& !printServices[i].getName().equals("null")
		...
		if (this.imprimante.getImprimanteId() != null) {
			...
			if (imprimante.getOrientation() == 1) {
				selectedOrientation = Labels.getLabel(
						"Champ.Imprimante.Orientation.portrait");
			} else {
				selectedOrientation = Labels.getLabel(
						"Champ.Imprimante.Orientation.paysage");
	...
	public void setImprimante(Imprimante i) {
		this.imprimante = i;
	}
	...
	public void setImprimanteApis(List<ImprimanteApi> i) {
	...
	public void setSelectedImprimanteApi(ImprimanteApi s) {
	...
	public void setOrientations(List<String> o) {
		this.orientations = o;
	}
	...
	public void setSelectedOrientation(String s) {
	...
	public void setAvailableImprimantes(List<String> a) {
	...
	public void setSelectedImprimante(String s) {
