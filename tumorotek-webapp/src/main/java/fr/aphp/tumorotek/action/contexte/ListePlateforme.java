...
public class ListePlateforme extends AbstractListeController2 {
	...
	private List<Plateforme> listObjects = new ArrayList<Plateforme>();
	...
	public void onClick$viewObject(Event event) {
		...
		Plateforme edit = ((Plateforme) getCurrentObject()).clone();
