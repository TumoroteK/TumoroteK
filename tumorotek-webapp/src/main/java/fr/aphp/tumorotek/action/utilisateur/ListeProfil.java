...
public class ListeProfil extends AbstractListeController2 {
	...
	private List<Profil> listObjects = new ArrayList<Profil>();
	
	// @since 2.1
	private ProfilRowRenderer profilRowRenderer = new ProfilRowRenderer();
	...
	public void removeObjectFromList(TKdataObject obj) {
		getListObjects().remove((Profil) obj);
	}
	...
	public void initObjectsBox() {
		List<Profil> profils = ManagerLocator.getProfilManager()
	...
	public void onClick$viewObject(Event event) {
		...
		Profil edit = ((Profil) getCurrentObject()).clone();
