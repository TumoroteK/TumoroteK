...
public class DateRetourCompleteModale extends GenericForwardComposer<Window>
{
   ...
   public void init(final Map<String, String> erInc, final Map<String, String> dcInc, final Calendar dateInit,
      final FicheCessionEdit cont){
      ...
      if(echansRetourIncompletes.isEmpty()){
         ...
         echansRetoursDetailsList.setModel(new ListModelMap<>(echansRetourIncompletes));
      }
      if(derivesRetourIncompletes.isEmpty()){
         ...
         derivesRetoursDetailsList.setModel(new ListModelMap<>(derivesRetourIncompletes));
      }
      // fwinDateRetourComplete.doModal();
   }
   ...
   public void setCessionEditController(final FicheCessionEdit controller){
