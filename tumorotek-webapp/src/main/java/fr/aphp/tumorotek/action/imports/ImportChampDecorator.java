...
public class ImportChampDecorator {
	...
	public ImportChampDecorator(Champ chp) {
		this.champ = chp;
	}
	 ...
	 */
	public static List<ImportChampDecorator> 
			decorateListe(List<Champ> objets) {
		List<ImportChampDecorator> liste = 
									new ArrayList<ImportChampDecorator>();
		Iterator<Champ> it = objets.iterator();
		while (it.hasNext()) {
	 ...
	 */
	public static List<Champ> extractListe(
			List<ImportChampDecorator> cedes) {
		List<Champ> liste = new ArrayList<Champ>();
		Iterator<ImportChampDecorator> it = cedes.iterator();
	...
	public boolean equals(Object obj) {
		...
		ImportChampDecorator deco = (ImportChampDecorator) obj;
