 ...
 * des Collaborateurs (et du prénom si nécessaire).
 *
 * @author Marc Deschamps.
 * Le 28/08/2014.
 *
 */
public class CollaborateursNomComparator implements Comparator<Collaborateur>
{

   private Boolean asc;

   public CollaborateursNomComparator(final Boolean a){
      asc = a;
   }

   @Override
   public int compare(final Collaborateur o1, final Collaborateur o2){
      int v = 1;
