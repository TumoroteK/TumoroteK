 ...
 *
 */
public class AffectationCollectionsModale extends GenericForwardComposer {
	...
	public void init(List<Banque> bks, Component p,
			Utilisateur user, Plateforme pf) {
		parent = p;
		banques = bks;
		utilisateur = user;
		plateforme = pf;
	...
	public void onSelect$imprimantesBox() {
		...
		if (selectedImprimante == null) {
			throw new WrongValueException(
					imprimantesBox, 
					Labels.getLabel(
					"etiquette.choix.imprimante.obligatoire"));
		} else {
	...
	public void setSelectedModele(Modele s) {
