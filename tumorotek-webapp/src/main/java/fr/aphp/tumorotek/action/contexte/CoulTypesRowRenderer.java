...
public class CoulTypesRowRenderer implements RowRenderer<CouleurEntiteType>
{
   ...
   @Override
   public void render(final Row row, final CouleurEntiteType data, final int index){

      final CouleurEntiteType cet = data;
      ...
      delImg.addForward("onClick", row.getParent(), "onDeleteObj", cet);
    ...
    */
   private String getObjectType(final CouleurEntiteType cet){
