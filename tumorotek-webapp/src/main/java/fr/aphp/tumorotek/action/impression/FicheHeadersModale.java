 ...
 *
 */
public class FicheHeadersModale extends GenericForwardComposer {
	...
	public void onClick$validate() {
		String[] values = new String[]{hautDePage, basDePage};
	...
	public void setHautDePage(String h) {
		this.hautDePage = h;
	}
	...
	public void setBasDePage(String b) {
		this.basDePage = b;
	}
