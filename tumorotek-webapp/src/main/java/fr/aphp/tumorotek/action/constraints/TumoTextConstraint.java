...
public class TumoTextConstraint {
	 ...
	 */
	public void validateWordOrCode(Component comp, Object value,
						String regexp, String errorLabel, Constraint constr) {
		...
		try {
			if (textValue != null) { 
				...
				if (!nullable) {
					...
					if (textValue.equals("")) {
						throw new WrongValueException(
							comp, Labels.getLabel(errorLabel + "empty"));
					}
				} else if (regexp != null) {
				...
				if (!isValide) {
					 throw new WrongValueException(
								comp, Labels.getLabel(errorLabel + "illegal"));
				}
