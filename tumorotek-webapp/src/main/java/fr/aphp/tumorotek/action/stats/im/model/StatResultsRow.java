...
public class StatResultsRow {
	...
	private List<Number> valuesPourcentage = new ArrayList<Number>();
...
//	}
	...
	public StatResultsRow(Banque b, Integer si, String sn, Boolean f) {
		setBanque(b);
		setSubDivId(si);
		setSubDivNom(sn);
	...
	public boolean equals(Object obj) {
		...
		StatResultsRow st = (StatResultsRow) obj;
		
		return (this.subDivId == st.getSubDivId() 
				|| (subDivId != null 
				&& subDivId.equals(st.getSubDivId())))
			&& (this.banque == st.getBanque() 
					|| (banque != null 
					&& banque.equals(st.getBanque())));
	}
...
//	}
	...
	public void setSubDivId(Integer i) {
		this.subDivId = i;
	}
	...
	public void setSubDivNom(String subDivNom) {
