...
public class FichePrelevementStaticSero extends FichePrelevementStatic
{
   ...
   public String getComplementDiagnostic(){
      ...
      if(getObject() != null && getObject().getDelegate() != null){
         if(((PrelevementSero) getObject().getDelegate()).getLibelle() != null){
            label = ((PrelevementSero) getObject().getDelegate()).getLibelle();
         }
      }
      return label;
   }
   ...
   private void drawProtocolesFormatted(){
      ...
      if(getObject().getPrelevementId() != null && getObject().getDelegate() != null){
         final Iterator<Protocole> protosIt = ((PrelevementSero) getObject().getDelegate()).getProtocoles().iterator();
         Protocole pt;
         Label lab;
