...
public class ConsentTypeUsedTable extends Hashtable<ConsentType, List<PrelevementDecorator2>> {
	...
	public List<PrelevementDecorator2> getPrels() {
		List<PrelevementDecorator2> prels = new ArrayList<PrelevementDecorator2>();
		List<ConsentType> keySet = new ArrayList<ConsentType>(keySet());
		Collections.sort(keySet);
		for (ConsentType keyC : keySet) {
