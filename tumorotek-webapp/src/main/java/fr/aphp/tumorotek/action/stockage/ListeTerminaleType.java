...
private static final long serialVersionUID = -3194629591208205100L;
	...
	private List<TerminaleType> listObjects = 
		new ArrayList<TerminaleType>();
	...
	public void addToObjectList(Object newObj) {
		...
		// du formulaire
		TerminaleType objClone = ((TerminaleType) newObj).clone();
	...
	public void removeObjectFromList(TKdataObject obj) {
		getListObjects().remove((TerminaleType) obj);
	}


	@Override
	public void initObjectsBox() {
		List<TerminaleType> types = ManagerLocator
			.getTerminaleTypeManager().findAllObjectsManager();
	...
	public void onClick$viewObject(Event event) {
		...
		TerminaleType edit = ((TerminaleType) getCurrentObject()).clone();
	...
	public void updateObjectGridList(Object obj) {
		...
		TerminaleType edit = ((TerminaleType) obj).clone();
		...
		if (getCurrentObject() != null) {
			...
			// que celui édité
			Integer idSelected = ((TerminaleType) 
					getCurrentObject()).getTerminaleTypeId();
			Integer idUpdated = edit.getTerminaleTypeId();
