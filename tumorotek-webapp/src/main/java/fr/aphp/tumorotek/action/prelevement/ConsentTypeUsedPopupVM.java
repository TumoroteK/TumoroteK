...
public class ConsentTypeUsedPopupVM {
	...
	@Init
	public void init(@BindingParam("table") ConsentTypeUsedTable t ){
		table = t;
		prelsModel = new SimpleListModel<PrelevementDecorator2>(table.getPrels());
	}
	...
	public void setTable(ConsentTypeUsedTable t) {
		this.table = t;
	}
	...
	public void setPrelsModel(ListModel<PrelevementDecorator2> p) {
		this.prelsModel = p;
	}
