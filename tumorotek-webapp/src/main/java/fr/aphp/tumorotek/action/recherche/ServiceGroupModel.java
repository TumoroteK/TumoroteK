...
public class ServiceGroupModel extends GroupsModelArray<Service, 
								ServiceGroupModel.ServiceInfo, Object, Object> {
		private static final long serialVersionUID = 1L;

		public ServiceGroupModel(List<Service> data, Comparator<Service> cmpr) {
			super(data.toArray(new Service[0]), cmpr);	         
		}

		protected ServiceInfo createGroupHead(Service[] groupdata, int index, int col) {
...
//		}
		...
		public static class ServiceInfo {
			private Service firstChild;
			private int groupIndex;
			private int colIndex;

			public ServiceInfo(Service firstChild, int groupIndex, int colIndex) {
				super();
