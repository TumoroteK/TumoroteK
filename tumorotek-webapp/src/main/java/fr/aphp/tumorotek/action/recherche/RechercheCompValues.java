...
public class RechercheCompValues {
	...
	public void setCompClass(Class<? extends Component> c) {
		this.compClass = c;
	}
	...
	public void setCompId(String c) {
		this.compId = c;
	}
	...
	public void setSelectedIndexValue(Integer s) {
	...
	public void setCheckedValue(Boolean c) {
		this.checkedValue = c;
	}
