...
public final class ImportConstraints {
	...
	private static ConstText descriptionConstraint = new ConstText();
	static {
		descriptionConstraint.setNullable(true);
		descriptionConstraint.setSize(250);
	}
	
	public static ConstWord getNomConstraint() {
		return nomConstraint;
	}
	public static ConstText getDescriptionConstraint() {
