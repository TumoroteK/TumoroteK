...
public class ServeurIdentitesFileBean implements Serializable
{
   ...
   /* constructeur value */
   public ServeurIdentitesFileBean(final String dbms, final String host, final String driver, final String database,
      final String login, final String password,

      final String tablePatient, final String nip, final String nipType, final String nom, final String nomPatron,
      final String prenom, final String sexe, final String sexeType, final String sexeFemme, final String sexeHomme,
      final String dateNaiss, final String numDossier){
      this.dbms = dbms;
      this.host = host;
      this.driver = driver;
   ...
   public void setNipType(final String nipType){
      this.nipType = nipType;
   }
   ...
   public void setNomPatron(final String nomPatron){
      this.nomPatron = nomPatron;
   }
   ...
   public void setSexeType(final String sexeType){
      this.sexeType = sexeType;
   }

   public void setSexeFemme(final String sexeFemme){
      this.sexeFemme = sexeFemme;
   }

   public void setSexeHomme(final String sexeHomme){
      this.sexeHomme = sexeHomme;
   }

   public void setTablePatient(final String tablePatient){
      this.tablePatient = tablePatient;
   }
