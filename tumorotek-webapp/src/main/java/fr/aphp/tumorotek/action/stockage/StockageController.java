...
public class StockageController extends AbstractObjectTabController
{
   ...
   public ListeStockages getListeStockages(){
      return ((ListeStockages) this.self.getFellow("listeStockages").getFellow("lwinStockages")
   ...
   public FicheConteneur getFicheConteneur(){
      ...
      return ((FicheConteneur) this.self.getFellow("ficheConteneur").getFellow("fwinConteneur")
   ...
   public FicheEnceinte getFicheEnceinte(){
      ...
      return ((FicheEnceinte) this.self.getFellow("ficheEnceinte").getFellow("fwinEnceinte")
   ...
   public FicheTerminale getFicheTerminale(){
      ...
      return ((FicheTerminale) this.self.getFellow("ficheTerminale").getFellow("fwinTerminale")
   ...
   public FicheDeplacerEmplacements getFicheDeplacerEmplacements(){
      ...
      return ((FicheDeplacerEmplacements) this.self.getFellow("divDeplacerEmplacements").getFellow("fwinDeplacerEmplacements")
    ...
    * @param conteneur Conteneur à afficher.
    */
   public void switchToFicheConteneurMode(final Conteneur conteneur){
      divConteneur.setVisible(true);
      divEnceinte.setVisible(false);
      divTerminale.setVisible(false);
      divDeplacerEmplacements.setVisible(false);
    ...
    */
   public void switchToFicheEnceinteMode(final Enceinte enceinte){
    ...
    * @param enceinte Enceinte à afficher.
    */
   public void switchToFicheTerminaleMode(final Terminale terminale, final Emplacement empl){
      divConteneur.setVisible(false);
      divEnceinte.setVisible(false);
    ...
    * @version 2.1
    */
   public void switchToDeplacerEmplacementsMode(final Terminale terminale, final Map<ScanTube, TKStockableObject> mismatches){
      divConteneur.setVisible(false);
      divEnceinte.setVisible(false);
      divTerminale.setVisible(false);
    ...
    */
   public void switchToStockerMode(final List<Echantillon> echantillons, final List<ProdDerive> derives, final String path,
      final String methode, final List<Emplacement> reserves){
      divConteneur.setVisible(false);
      divEnceinte.setVisible(false);
      divTerminale.setVisible(false);
      divDeplacerEmplacements.setVisible(true);
      ...
      getFicheDeplacerEmplacements().setObjectTabController(this);
      getFicheDeplacerEmplacements().switchToStockerMode(echantillons, derives, path, methode, reserves);
    ...
    * @version 2.1
    */
   public void switchToDestockageEmplacementsMode(final Terminale terminale, final List<EmplacementDecorator> decos){
      divConteneur.setVisible(false);
      divEnceinte.setVisible(false);
      divTerminale.setVisible(false);
      divDeplacerEmplacements.setVisible(true);
    ...
    */
   public static StockageController backToMe(final MainWindow window, final Page page){
      ...
      if(panels != null){
         ...
         final Tabpanel panel = (Tabpanel) panels.getFellow("stockagePanel");

         window.createMacroComponent("/zuls/stockage/Stockage.zul", "winStockages", panel);

         tabController =
            ((StockageController) panel.getFellow("winStockages").getAttributeOrFellow("winStockages$composer", true));
   ...
   public void setActuelleTerminale(final Terminale actuelle){
   ...
   public void switchToDeplacerContenuCessionMode(List<Echantillon> listEchantillonsReserve, List<ProdDerive> listDerivesReserve){
      ...
      getListeStockages().switchToDeplacementEmplacementMode();
      getFicheDeplacerEmplacements().switchToSelectionContenuCessionMode(listEchantillonsReserve, listDerivesReserve);
