 ...
 *
 */
public class FicheModifMultiProdDerive extends AbstractFicheModifMultiController
{
   ...
   public AbstractObjectTabController getObjectTabController(){
      return ((ProdDeriveController) self.getParent().getParent().getParent().getFellow("winProdDerive")
   ...
   public void updateMultiObjects(){
      ...
      final List<ProdDerive> clones = new ArrayList<>();

      boolean hasAnyChange = false;
      for(int i = 0; i < getObjsToEdit().size(); i++){
         final ProdDerive current = ((ProdDerive) getObjsToEdit().get(i)).clone();
      ...
      if(hasAnyChange){
         ManagerLocator.getProdDeriveManager().updateMultipleObjectsManager(clones, (List<ProdDerive>) getObjsToEdit(),
   ...
   public void onClick$codeLaboMultiLabel(){
      openModificationMultipleWindow(page, Path.getPath(self), "onGetChangeOnChamp", "Textbox", getObjsToEdit(),
         "Champ.ProdDerive.codeLabo", "codeLabo", null, null, null, ProdDeriveConstraints.getCodeNullConstraint(), false, false,
         null);
   }
   ...
   public void onClick$typeMultiLabel(){
      ...
      openModificationMultipleWindow(page, Path.getPath(self), "onGetChangeOnChamp", "Listbox", getObjsToEdit(),
         "Champ.ProdDerive.ProdType.Type", "prodType", (List<Object>) types, "type", null, null, false, null, true);
   }
   ...
   public void onClick$nonConformeTraitementMultiLabel(){
      ...
      openModificationMultipleWindow(page, Path.getPath(self), "onGetChangeOnChamp", "Conformitebox", getObjsToEdit(),
         "Champ.ProdDerive.ConformeTraitement", "conformeTraitement", (List<Object>) nonConfs, "Traitement", null, null, false,
         null, false);
   }
   ...
   public void onClick$nonConformeCessionMultiLabel(){
      ...
      openModificationMultipleWindow(page, Path.getPath(self), "onGetChangeOnChamp", "Conformitebox", getObjsToEdit(),
         "Champ.ProdDerive.ConformeCession", "conformeCession", (List<Object>) nonConfs, "Cession", null, null, false, null,
         false);
   }
