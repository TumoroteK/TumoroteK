...
import fr.aphp.tumorotek.action.stats.charts.ChartDataTriggers;
...
public class ChartsVM {
	...
	private List<Plateforme> pfList = new ArrayList<Plateforme>(ManagerLocator.getPlateformeManager().findAllObjectsManager());
	private List<String> pfListString = new ArrayList<String>();
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view) {
        ...
        if (win1 != null) {
        	int height = (((MainWindow) view.getPage()
    				.getFellow("mainWin").getAttributeOrFellow(
    	    				"mainWin$composer", true)).getPanelHeight()) - 10;
			...
			((Div) win1.getFirstChild().getLastChild())
	...
	public void initPlateformesAndBanques() {
		...
		plateformes.addAll(ManagerLocator.getUtilisateurManager()
				.getAvailablePlateformesManager(loggeduser));
		...
		// init des banques
		banques.addAll(ManagerLocator.getUtilisateurManager()
			.getAvailableBanquesByPlateformeManager(
					loggeduser, selectedPlateforme));
	...
	public void changeBanques(Event event) throws Exception {
		banques.clear();
	...
	@Init
	public void init(@ScopeParam(scopes=Scope.SESSION, value="User") 
				Utilisateur u) {
		loggeduser = u;
		initDate();
		updateDatas();
		for (Plateforme p : pfList) {
			pfListString.add(p.getNom());
		}
		pfModel = new ListModelList<String>(pfListString);
...
//		"cessionTypeCollVisible"})
	...
	public void updateDatas() {
		...
		ChartDataTriggers trgs = new ChartDataTriggers();
		...
		if (loggeduser != null && !loggeduser.isSuperAdmin()) {
			datas = new ChartData(date_debut, date_fin, ManagerLocator.getUtilisateurManager()
				.getPlateformesManager(loggeduser), trgs, 
	...
	public void onDisplayChange() throws ParseException{
		if(db1.getValue()==null) date_debut = null;
		else date_debut = db1.getValue();
		if(db2.getValue()==null) date_fin = null;
		else date_fin = db2.getValue();
...
//	}
	...
	public void setPatientBlocTitle(String s) {
	...
	public void setPrelevementBlocTitle(String s) {
	...
	public void setEchantillonBlocTitle(String s) {
	...
	public void setDeriveBlocTitle(String s) {
	...
	public void setCessionBlocTitle(String s) {
		this.cessionBlocTitle = s;
	}
	
	public void setPatientPfVisible(Boolean b) {
		patientPfVisible = b;
	}
	...
	public void setPatientCollVisible(Boolean b) {
	...
	public void setPrelPfVisible(Boolean b) {
		prelPfVisible = b;
	}
	...
	public void setPrelCollVisible(Boolean b) {
		prelCollVisible = b;
	}
	...
	public void setPrelTypeCollVisible(Boolean b) {
	...
	public void setPrelEtabCollVisible(Boolean b) {
	...
	public void setPrelConsentCollVisible(Boolean b) {
	...
	public void setEchanPfVisible(Boolean b) {
		echanPfVisible = b;
	}
	...
	public void setDerivePfVisible(Boolean b) {
		derivePfVisible = b;
	}
	...
	public void setCessionPfVisible(Boolean b) {
		cessionPfVisible = b;
	}
	...
	public void setEchanCollVisible(Boolean echanCollVisible) {
		this.echanCollVisible = echanCollVisible;
	}

	public void setEchanTypeCollVisible(Boolean echanTypeCollVisible) {
		this.echanTypeCollVisible = echanTypeCollVisible;
	}

	public void setEchanCimCollVisible(Boolean echanCimCollVisible) {
		this.echanCimCollVisible = echanCimCollVisible;
	}

	public void setEchanOrgCollVisible(Boolean echanOrgCollVisible) {
		this.echanOrgCollVisible = echanOrgCollVisible;
	}

	public void setDeriveCollVisible(Boolean deriveCollVisible) {
		this.deriveCollVisible = deriveCollVisible;
	}

	public void setDeriveTypeCollVisible(Boolean deriveTypeCollVisible) {
		this.deriveTypeCollVisible = deriveTypeCollVisible;
	}

	public void setDerivesCedesCollVisible(Boolean derivesCedesCollVisible) {
		this.derivesCedesCollVisible = derivesCedesCollVisible;
	}

	public void setCessionCollVisible(Boolean cessionCollVisible) {
		this.cessionCollVisible = cessionCollVisible;
	}

	public void setEchansCedesCollVisible(Boolean echansCedesCollVisible) {
		this.echansCedesCollVisible = echansCedesCollVisible;
	}

	public void setCessionTypeCollVisible(Boolean cessionTypeCollVisible) {
	...
	public String getPrelTypeCollTitle() {
		return ObjectTypesFormatters
			.getLabel("charts.counts.prelevement.types", 
					new String[]{getSelectedBanque().getNom()});
	}
	
	public String getPrelEtabCollTitle() {
			return ObjectTypesFormatters
				.getLabel("charts.counts.prelevement.etablissements", 
						new String[]{getSelectedBanque().getNom()});
	}
	
	public String getPrelConsentCollTitle() {
			return ObjectTypesFormatters
				.getLabel("charts.counts.prelevement.consents", 
						new String[]{getSelectedBanque().getNom()});
	}
	
	public String getEchanTypeCollTitle() {
			return ObjectTypesFormatters
				.getLabel("charts.counts.echantillon.types", 
						new String[]{getSelectedBanque().getNom()});
	}
	
	public String getEchanCimCollTitle() {
			return ObjectTypesFormatters
				.getLabel("charts.counts.echantillon.cims", 
						new String[]{getSelectedBanque().getNom()});
		}
	...
	public String getEchanOrgCollTitle() {
			return ObjectTypesFormatters
				.getLabel("charts.counts.echantillon.organes", 
							new String[]{getSelectedBanque().getNom()});
		}
	...
	public String getDeriveTypeCollTitle() {
			return ObjectTypesFormatters
				.getLabel("charts.counts.derive.types", 
						new String[]{getSelectedBanque().getNom()});
		}
	...
	public String getCessionTypeCollTitle() {
			return ObjectTypesFormatters
				.getLabel("charts.counts.cession.types", 
						new String[]{getSelectedBanque().getNom()});
		}
    ...
    public void onZoomChartOut (Event event) {
	...
	public void setSelectedPlateforme(Plateforme sPlateforme) {
