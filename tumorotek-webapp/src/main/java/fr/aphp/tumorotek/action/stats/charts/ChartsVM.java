...
public class ChartsVM
{
   ...
   private final List<Plateforme> pfList =
      new ArrayList<>(ManagerLocator.getPlateformeManager().findAllObjectsManager());
   ...
   public void initPlateformesAndBanques(){
      ...
      // init des banques
      banques
         .addAll(ManagerLocator.getUtilisateurManager().getAvailableBanquesByPlateformeManager(loggeduser, selectedPlateforme));
   ...
   public void changeBanques(final Event event) throws Exception{
      ...
      if(selectedPlateforme != null){
         banques.addAll(
            ManagerLocator.getUtilisateurManager().getAvailableBanquesByPlateformeManager(loggeduser, selectedPlateforme));
      }
   ...
   public String getPrelTypeCollTitle(){
      return ObjectTypesFormatters.getLabel("charts.counts.prelevement.types", new String[] {getSelectedBanque().getNom()});
   }
   ...
   public String getPrelConsentCollTitle(){
      return ObjectTypesFormatters.getLabel("charts.counts.prelevement.consents", new String[] {getSelectedBanque().getNom()});
   }

   public String getEchanTypeCollTitle(){
      return ObjectTypesFormatters.getLabel("charts.counts.echantillon.types", new String[] {getSelectedBanque().getNom()});
   }

   public String getEchanCimCollTitle(){
      return ObjectTypesFormatters.getLabel("charts.counts.echantillon.cims", new String[] {getSelectedBanque().getNom()});
   }

   public String getEchanOrgCollTitle(){
      return ObjectTypesFormatters.getLabel("charts.counts.echantillon.organes", new String[] {getSelectedBanque().getNom()});
   }

   public String getDeriveTypeCollTitle(){
      return ObjectTypesFormatters.getLabel("charts.counts.derive.types", new String[] {getSelectedBanque().getNom()});
   }

   public String getCessionTypeCollTitle(){
      return ObjectTypesFormatters.getLabel("charts.counts.cession.types", new String[] {getSelectedBanque().getNom()});
   }
