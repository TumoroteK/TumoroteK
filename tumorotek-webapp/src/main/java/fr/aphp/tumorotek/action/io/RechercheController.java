...
public class RechercheController extends AbstractObjectTabController
{
   ...
   public void setRecherche(final Recherche c){
      this.recherche = c;
   }
   ...
   public ListeRecherches getListeRecherches(){
      return ((ListeRecherches) this.self.getFellow("listeRecherches").getFellow("lwinRecherches")
         .getAttributeOrFellow("lwinRecherches$composer", true));
   }

   @Override
   public AbstractFicheCombineController getFicheCombine(){
      return ((FicheRecherche) this.self.getFellow("ficheRecherche").getFellow("winFicheRecherche")
