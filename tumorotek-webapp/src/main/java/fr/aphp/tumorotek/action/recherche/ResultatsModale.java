...
public class ResultatsModale extends AbstractController {
	...
	public void init(List<Integer> res, Component prt, String ent, 
			AbstractObjectTabController c) {
		...
		entite = ent;
		controller = c;
		hasAnnots = controller != null ? 
				controller.hasAnnoTables() : false;
		...
		if (entite.equals("Echantillon")) {
			...
			if (sessionScope.containsKey("catalogues")) {
				Map<String, Catalogue> catsMap = (Map<String, Catalogue>) 
	...
	public void onClick$deleteItem() {
		Messagebox.show(ObjectTypesFormatters.getLabel("message.deletion.multiple", 
			new String[]{String.valueOf(getNbResults())}), 
	...
	public void onClick$exportItemAdv() {
		openRestrictTablesModale(controller.getListe(), 
							self, controller.getEntiteTab());		
	}
	...
	public void setResults(List<Integer> r) {
		this.results = r;
	}

	public void disableObjectTreeButtons() {
		
		String entiteNom = controller.getEntiteTab().getNom();
	...
	public void onClick$patientsItem() {
		...
		Events.postEvent("onClick$patientsItem", controller.getListe().getSelfComponent(), 
				getResults());			
	}
	
	public void onClick$prelevementsItem() {
		postEventCloseParent();
		Events.postEvent("onClick$prelevementsItem", controller.getListe().getSelfComponent(), 
				getResults());		
	}
	
	public void onClick$echantillonsItem() {
		postEventCloseParent();
		Events.postEvent("onClick$echantillonsItem", controller.getListe().getSelfComponent(), 
				getResults());		
	}
	
	public void onClick$derivesItem() {
		postEventCloseParent();
		Events.postEvent("onClick$derivesItem", controller.getListe().getSelfComponent(), 
				getResults());			
	}
	
	public void onClick$derivesAscItem() {
		postEventCloseParent();
		Events.postEvent("onClick$derivesAscItem", controller.getListe().getSelfComponent(), 
				getResults());			
	}
	
	public void onClick$cessionsItem() {
		postEventCloseParent();
		Events.postEvent("onClick$cessionsItem", controller.getListe().getSelfComponent(), 
				getResults());		
	}
