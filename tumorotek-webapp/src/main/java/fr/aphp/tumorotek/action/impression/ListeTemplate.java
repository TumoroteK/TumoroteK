...
public class ListeTemplate extends AbstractListeController2 {
	...
	private List<Template> listObjects = new ArrayList<Template>();
	...
	public void removeFromSelectedObjects(TKdataObject obj) {
		getSelectedObjects().remove((Template) obj);
	}
	...
	public ImpressionController getObjectTabController() {
		return ((ImpressionController) self.getParent().getParent()
				.getParent()
	...
	public void removeObjectFromList(TKdataObject obj) {
		getListObjects().remove((Template) obj);		
	}

	@Override
	public void initObjectsBox() {
		// TODO gérer liste des utilisateurs
		List<Template> templates = ManagerLocator.getTemplateManager()
			.findByBanqueManager(SessionUtils
