...
public class BanqueController extends AbstractObjectTabController {
	...
	public AbstractFicheCombineController getFicheCombine() {
		return ((FicheBanque) 
				this.self.getFellow("ficheBanque")
				.getFellow("fwinBanque")
				.getAttributeOrFellow("fwinBanque$composer", true));
	}
	
	@Override
	public ListeBanque getListe() {
		return ((ListeBanque) 
				this.self.getFellow("listeBanque")
				.getFellow("lwinBanque")
				.getAttributeOrFellow("lwinBanque$composer", true));
	}
	...
	public void selectBanqueInListe(Banque banque) {
	...
	public static AbstractObjectTabController backToMe(MainWindow window, 
		...
		if (tabbox != null) {
			...
			Tabpanel tab = (Tabpanel) tabbox.getFellow("banquePanel");
			...
			tabController = 
				((BanqueController) tab.getFellow("winBanque")
