...
public class ThesaurusController extends AbstractObjectTabController {
	...
	public FicheThesaurus getFicheCombine() {
		return ((FicheThesaurus) 
				this.self.getFellow("ficheThesaurus")
				.getFellow("fwinThesaurus")
	...
	public AbstractListeController2 getListe() {
		return ((ListeThesaurus) 
				this.self.getFellow("listeThesaurus")
				.getFellow("lwinThesaurus")
