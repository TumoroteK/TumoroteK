...
public class CodificationsAssociees extends OneToManyComponent {
	...
	private List<BanqueTableCodage> objects = 
								new ArrayList<BanqueTableCodage>();
	
	private CodificationsRowRenderer codificationsRenderer = 
									new CodificationsRowRenderer();
	...
	public void addToListObjects(Object obj) {
		...
		if (codeOrLibelleBox.getSelectedItem() != null) {
			value = codeOrLibelleBox.getSelectedItem()
							.getValue().equals("libelle");
		}
	...
	public void removeFromListObjects(Object obj) {
		getObjects().remove((BanqueTableCodage) obj);
	}
	...
	public List< ? extends Object> findObjectsAddable() {
		...
		List<TableCodage> tabs = ManagerLocator
			.getTableCodageManager().findAllObjectsManager();
		tabs.remove(ManagerLocator
				.getTableCodageManager()
