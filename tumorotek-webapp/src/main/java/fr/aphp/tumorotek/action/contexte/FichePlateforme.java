...
public class FichePlateforme extends AbstractFicheCombineController
{
   ...
   public void onClick$deleteAdmin(final Event event){
      final Utilisateur adminToDelete = (Utilisateur) AbstractListeController2.getBindingData((ForwardEvent) event, false);
   ...
   public void onClick$adminLogin(final Event event){
      final Utilisateur adminToShow = (Utilisateur) AbstractListeController2.getBindingData((ForwardEvent) event, false);
