...
public class TableAnnotationDecorator extends SmallObjDecorator {
	...
	public TableAnnotationDecorator(TableAnnotation t) {
		setObj(t);
	}
	...
	public static List<SmallObjDecorator> 
							decorateListe(List< TableAnnotation> objs) {
		List<SmallObjDecorator> liste = 
									new ArrayList<SmallObjDecorator>();
		Iterator<TableAnnotation> it = objs.iterator();
	...
	public static List<TableAnnotation> 
					undecorateListe(List<SmallObjDecorator> decos) {
		List<TableAnnotation> res = new ArrayList<TableAnnotation>();
		if (decos != null) {
