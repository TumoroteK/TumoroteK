...
public class UtilisateurController extends AbstractObjectTabController {
	...
	public FicheUtilisateur getFicheCombine() {
		return ((FicheUtilisateur) 
				this.self.getFellow("ficheUtilisateur")
				.getFellow("fwinUtilisateur")
	...
	public ListeUtilisateur getListe() {
		return ((ListeUtilisateur) 
				this.self.getFellow("listeUtilisateur")
				.getFellow("lwinUtilisateur")
	...
	public void selectUtilisateurInListe(Utilisateur utilisateur) {
	...
	public static AbstractObjectTabController backToMe(MainWindow window, 
		...
		if (tabbox != null) {
			...
			Tabpanel tab = (Tabpanel) tabbox.getFellow("utilisateursPanel");
			...
			tabController = 
				((UtilisateurController) tab.getFellow("winUtilisateur")
