...
public class CollaborationsController extends AbstractObjectTabController
{
   ...
   public FicheCollaborateur getFicheCollaborateur(){
      return ((FicheCollaborateur) this.self.getFellow("ficheCollaborateur").getFellow("fwinCollaborateur")
   ...
   public FicheEtablissement getFicheEtablissement(){
      ...
      return ((FicheEtablissement) this.self.getFellow("ficheEtablissement").getFellow("fwinEtablissement")
   ...
   public FicheService getFicheService(){
      return ((FicheService) this.self.getFellow("ficheService").getFellow("fwinService")
   ...
   public ListeCollaborations getListeCollaborations(){
      return ((ListeCollaborations) this.self.getFellow("listeCollaborations").getFellow("lwinCollaborations")
    ...
    */
   public void switchToSelectMode(final String type, final String _from, final List<Object> filtres,
      final List<Object> oldSelection){
      mode = "select";
      from = _from;
      getListeCollaborations().initTree();
      getListeCollaborations().swithToSelectionMode(type, from, filtres, oldSelection);
    ...
    */
   public void switchToFicheCollaborateurMode(final Collaborateur collab){
    ...
    */
   public void switchToFicheCollaborateurCreationMode(final Service service){
      switchToFicheAndListeMode();
      divCollaborateur.setVisible(true);
      divEtablissement.setVisible(false);
      divService.setVisible(false);
    ...
    */
   public void switchToFicheEtablissementMode(final Etablissement etab){
      switchToFicheAndListeMode();
    ...
    */
   public void switchToFicheServiceMode(final Service serv){
      switchToFicheAndListeMode();
      divCollaborateur.setVisible(false);
      divEtablissement.setVisible(false);
    ...
    */
   public void switchToFicheServiceCreationMode(final Etablissement etab){
      switchToFicheAndListeMode();
      divCollaborateur.setVisible(false);
      divEtablissement.setVisible(false);
      divService.setVisible(true);
