...
public class AnnoTablesAssociees extends OneToManyComponent {
	...
	private List<TableAnnotation> objects = new ArrayList<TableAnnotation>();
	...
	public void removeFromListObjects(Object obj) {
		getObjects().remove((TableAnnotation) obj);
	}
	...
	public List< ? extends Object> findObjectsAddable() {
		...
		List<TableAnnotation> tabs = ManagerLocator
			.getTableAnnotationManager()
				.findByEntiteAndPlateformeManager(getEntite(), 
...
//		}	
	 ...
	 * @param event
	 */
	public void onClick$upImage(Event event) {
		// recupere le TableAnnotation
		Object tab = AbstractListeController2
						.getBindingData((ForwardEvent) event, false); 
	 ...
	 */
	private void upObject(Object obj) {
		int tabIndex = getObjects().indexOf(obj);
	 ...
	 * @param event
	 */
	public void onClick$downImage(Event event) {
		// recupere le TableAnnotation
		Object tab = AbstractListeController2
						.getBindingData((ForwardEvent) event, false); 
		int tabIndex = getObjects().indexOf(tab);
