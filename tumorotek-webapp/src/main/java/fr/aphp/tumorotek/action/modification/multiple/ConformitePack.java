...
public class ConformitePack
{
   ...
   public void setConforme(final Boolean c){
      if(c != null){
         nonConforme = !c;
      }else{
         nonConforme = null;
   ...
   public void setNonConforme(final Boolean nc){
      this.nonConforme = nc;
   }
   ...
   public void setNonConformites(final List<NonConformite> nce){
      this.nonConformites = nce;
   }

   public boolean isEmpty(){
      return nonConforme == null && (nonConformites == null || nonConformites.isEmpty());
   }
   ...
   public boolean equals(final Object obj){
      ...
      final ConformitePack test = (ConformitePack) obj;
      return ((this.nonConformites == test.nonConformites
         || (this.nonConformites != null && this.nonConformites.equals(test.nonConformites)))
         && (this.nonConforme == test.nonConforme || (this.nonConforme != null && this.nonConforme.equals(test.nonConforme))));
   }
   ...
   public ConformitePack clone(){
      final ConformitePack clone = new ConformitePack();
