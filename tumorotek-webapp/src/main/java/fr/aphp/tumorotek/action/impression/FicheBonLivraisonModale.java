...
public class FicheBonLivraisonModale extends AbstractFicheCombineController
{
   ...
   public void init(final Cession cessionToPrint){
      ...
      collabs = ManagerLocator.getCollaborateurManager().findAllObjectsWithOrderManager();
      collabs.add(0, null);
   ...
   public void onClick$print(){
      ...
      final Document document = createDocumentXMLForAccord(loc);
    ...
    */
   public Document createDocumentXMLForAccord(final Locale locale){
      ...
      try{
         ...
         final Element page = ManagerLocator.getXmlUtils().addPage(root,
            ObjectTypesFormatters.getLabel("impression.accord.transfert.titre", new String[] {cession.getNumero()}));

         // Etablissement destinataire
         StringBuilder etab = new StringBuilder();
         StringBuilder adresse = new StringBuilder();
         if(destinataire != null && destinataire.getEtablissement() != null){
            etab.append(destinataire.getEtablissement().getNom());
            if(destinataire.getEtablissement().getCoordonnee() != null){
               if(destinataire.getEtablissement().getCoordonnee().getAdresse() != null){
                  adresse.append(destinataire.getEtablissement().getCoordonnee().getAdresse());
               }else{
                  adresse.append("");
               }
               adresse.append(" - ");
               if(destinataire.getEtablissement().getCoordonnee().getCp() != null){
                  adresse.append(destinataire.getEtablissement().getCoordonnee().getCp());
               }else{
                  adresse.append("");
               }
               adresse.append(" ");
               if(destinataire.getEtablissement().getCoordonnee().getVille() != null){
                  adresse.append(destinataire.getEtablissement().getCoordonnee().getVille());
               }else{
                  adresse.append("");
               }
            }
         }
         final CoupleAccordValeur cv1 = new CoupleAccordValeur(Labels.getLabel("impression.accord.transfert.organisation"),
            new String[] {etab.toString(), adresse.toString()});
         final LigneAccord li1 = new LigneAccord(new CoupleAccordValeur[] {cv1});

         // services
         final StringBuilder sbServDest = new StringBuilder();
         if(destinataire != null){
            final Iterator<Service> it = ManagerLocator.getCollaborateurManager().getServicesManager(destinataire).iterator();
         ...
         final CoupleAccordValeur cv1Bis =
            new CoupleAccordValeur(Labels.getLabel("impression.accord.transfert.services"), new String[] {sbServDest.toString()});
         final LigneAccord li1Bis = new LigneAccord(new CoupleAccordValeur[] {cv1Bis});
         ...
         final CoupleAccordValeur cv2 =
            new CoupleAccordValeur(Labels.getLabel("impression.accord.transfert.nom.titre"), new String[] {dest.toString()});
         ...
         if(destinataire != null){
            final Iterator<Coordonnee> it =
               ManagerLocator.getCollaborateurManager().getCoordonneesManager(destinataire).iterator();
         ...
         final CoupleAccordValeur cv3 = new CoupleAccordValeur(Labels.getLabel("impression.accord.transfert.telephone"),
            new String[] {tel.toString(), fax.toString(), mail.toString()});
         final LigneAccord li3 = new LigneAccord(new CoupleAccordValeur[] {cv3});
         final BlocPrincipal bloc1 = new BlocPrincipal(Labels.getLabel("impression.accord.transfert.destinataire"),
            new LigneAccord[] {li1, li1Bis, li2, li3});

         // Etablissement expéditeur
         etab = new StringBuilder();
         adresse = new StringBuilder();
         if(expediteur != null && expediteur.getEtablissement() != null){
            etab.append(expediteur.getEtablissement().getNom());
            if(expediteur.getEtablissement().getCoordonnee() != null){
               if(expediteur.getEtablissement().getCoordonnee().getAdresse() != null){
                  adresse.append(expediteur.getEtablissement().getCoordonnee().getAdresse());
               }else{
                  adresse.append("");
               }
               adresse.append(" - ");
               if(expediteur.getEtablissement().getCoordonnee().getCp() != null){
                  adresse.append(expediteur.getEtablissement().getCoordonnee().getCp());
               }else{
                  adresse.append("");
               }
               adresse.append(" ");
               if(expediteur.getEtablissement().getCoordonnee().getVille() != null){
                  adresse.append(expediteur.getEtablissement().getCoordonnee().getVille());
               }else{
                  adresse.append("");
               }
            }
         }
         final CoupleAccordValeur cv4 = new CoupleAccordValeur(Labels.getLabel("impression.accord.transfert.organisation"),
            new String[] {etab.toString(), adresse.toString()});
         final LigneAccord li4 = new LigneAccord(new CoupleAccordValeur[] {cv4});
         // services
         final StringBuilder sbExpDest = new StringBuilder();
         if(expediteur != null){
            final Iterator<Service> it = ManagerLocator.getCollaborateurManager().getServicesManager(expediteur).iterator();
         ...
         final CoupleAccordValeur cv4Bis =
            new CoupleAccordValeur(Labels.getLabel("impression.accord.transfert.services"), new String[] {sbExpDest.toString()});
         final LigneAccord li4Bis = new LigneAccord(new CoupleAccordValeur[] {cv4Bis});
         // destinataire
         ...
         if(expediteur != null){
            final Iterator<Coordonnee> it = ManagerLocator.getCollaborateurManager().getCoordonneesManager(expediteur).iterator();
         ...
         final CoupleAccordValeur cv6 = new CoupleAccordValeur(Labels.getLabel("impression.accord.transfert.telephone"),
            new String[] {tel.toString(), fax.toString(), mail.toString()});
         final LigneAccord li6 = new LigneAccord(new CoupleAccordValeur[] {cv6});
         final BlocPrincipal bloc2 = new BlocPrincipal(Labels.getLabel("impression.accord.transfert.expediteur"),
         ...
         // Nature
         final StringBuilder nature = new StringBuilder();
         final StringBuilder nbNat = new StringBuilder();
         final Iterator<Entry<String, Number>> it = nbNatures.entrySet().iterator();
         ...
         final CoupleAccordValeur cv7 =
            new CoupleAccordValeur(Labels.getLabel("impression.accord.transfert.nature"), new String[] {nature.toString()});
         final LigneAccord li7 = new LigneAccord(new CoupleAccordValeur[] {cv7});
         // Quantité
         final CoupleAccordValeur cv8 =
            new CoupleAccordValeur(Labels.getLabel("impression.accord.transfert.quantite"), new String[] {nbNat.toString()});
         ...
         final CoupleAccordValeur cv10 =
            new CoupleAccordValeur(Labels.getLabel("impression.accord.transfert.temp"), new String[] {tmp});
         ...
         final CoupleAccordValeur cv11 =
            new CoupleAccordValeur(Labels.getLabel("impression.accord.transfert.transporteur"), new String[] {tmp});
         final LigneAccord li11 = new LigneAccord(new CoupleAccordValeur[] {cv11});
         final BlocPrincipal bloc3 = new BlocPrincipal(Labels.getLabel("impression.accord.transfert.materiel"),
            new LigneAccord[] {li7, li8, li9, li10, li11});

         ManagerLocator.getXmlUtils().addTableau(page, new BlocPrincipal[] {bloc1, bloc2, bloc3});

         // Signatures
         final ValeursSignatures vs1 = new ValeursSignatures(Labels.getLabel("impression.accord.transfert.responsable"),
            Labels.getLabel("impression.accord.transfert.responsable"));
         final ValeursSignatures vs2 = new ValeursSignatures(Labels.getLabel("impression.accord.transfert.signature"),
            Labels.getLabel("impression.accord.transfert.signature"));
         final ValeursSignatures vs3 = new ValeursSignatures(Labels.getLabel("impression.accord.transfert.exp.date"),
            Labels.getLabel("impression.accord.transfert.recept.date"));
         final ListeSignature ligne1 = new ListeSignature(new ValeursSignatures[] {vs1});
         final ListeSignature ligne2 = new ListeSignature(new ValeursSignatures[] {vs2});
         final ListeSignature ligne3 = new ListeSignature(new ValeursSignatures[] {vs3});
         final Signatures sign = new Signatures(Labels.getLabel("impression.accord.transfert.expediteur").toUpperCase(),
            Labels.getLabel("impression.accord.transfert.destinataire").toUpperCase(),
   ...
   public void setExpediteur(final Collaborateur e){
      this.expediteur = e;
   }
   ...
   public void setDestinataire(final Collaborateur d){
      this.destinataire = d;
   }
   ...
   public void setCollabs(final List<Collaborateur> c){
      this.collabs = c;
   }
   ...
   public void setLangue(final String lg){
      this.langue = lg;
   }
}