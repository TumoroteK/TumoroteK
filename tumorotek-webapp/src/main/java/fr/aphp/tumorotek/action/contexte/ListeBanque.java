...
public class ListeBanque extends AbstractListeController2 {
	...
	private List<Banque> listObjects = new ArrayList<Banque>();
	
	private BanqueRowRenderer banqueRenderer = new BanqueRowRenderer();
	...
	public void doAfterCompose(Component comp) throws Exception {	
		...
		int height = getMainWindow().getListPanelHeight() + 170;
	...
	public void removeObjectFromList(TKdataObject obj) {
		getListObjects().remove((Banque) obj);
	}
	...
	public void initObjectsBox() {
		setListObjects(ManagerLocator.getBanqueManager()
