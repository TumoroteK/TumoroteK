...
public class ListeOutils extends AbstractListeController2 {
	...
	private List<Outil> listObjects = new ArrayList<Outil>();
	...
	public void initListes() {
		listObjects = new ArrayList<Outil>();
		// fusion patient
		Outil fusPat = new Outil("fusionPatients", 
							Labels.getLabel("outil.fusion.patients"));
		listObjects.add(fusPat);
		// fusion collabs
		Outil fusColl = new Outil("fusionCollaborateurs", 
						Labels.getLabel("outil.fusion.collaborateurs"));
