...
public class IncidentDecorator
{
   ...
   public IncidentDecorator(final Incident incid){
      this.incident = incid;
   }
    ...
    */
   public static List<IncidentDecorator> decorateListe(final List<Incident> incidents){
      final List<IncidentDecorator> liste = new ArrayList<>();
      final Iterator<Incident> it = incidents.iterator();
      while(it.hasNext()){
   ...
   public boolean equals(final Object obj){
      ...
      final IncidentDecorator deco = (IncidentDecorator) obj;
