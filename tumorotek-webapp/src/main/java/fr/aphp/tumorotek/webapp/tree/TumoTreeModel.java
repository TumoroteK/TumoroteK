...
public class TumoTreeModel extends AbstractTreeModel<TumoTreeNode>
{
    ...
    */
   public TumoTreeModel(final TumoTreeNode rootNode){
      super(rootNode);
   }
    ...
    */
   @Override
   public int getChildCount(final TumoTreeNode arg0){
      return arg0.getChildCount();
   }
    ...
    */
   @Override
   public boolean isLeaf(final TumoTreeNode arg0){
      if(arg0 == null){
         return true;
      }
    ...
    */
   public int[] getPathFromNode(final TumoTreeNode child, final TumoTreeNode cNode, final int cPath){
   ...
   private boolean conteneurSearch(final List<Integer> path, final TumoTreeNode node, final TumoTreeNode target){
