...
public final class SessionUtils {
	...
	public static List<Banque> getSelectedBanques(Map<?, ?> sessionScp) {
	...
	public static Banque getCurrentBanque(Map<?, ?> sessionScp) {
		List<Banque> banks = getSelectedBanques(sessionScp);
		return !banks.isEmpty() ? banks.get(0) : null;
	}

	public static Utilisateur getLoggedUser(Map<?, ?> sessionScp) {
		return (Utilisateur) sessionScp.get("User");
	}

	public static Plateforme getPlateforme(Map<?, ?> sessionScp) {
	 ...
	 * @return true si oui.
	 */
	public static Boolean isAdminPF(Map<String, Object> sessionScp) {
	 ...
	 */
	public static boolean isAnyDefMaladieInBanques(List<Banque> banks) {
	...
	@SuppressWarnings("unchecked")
	public static Boolean isINCaCollection(Map<?, ?> sessionScp) {
		return sessionScp.containsKey("catalogues")
				&& ((Map<String, Catalogue>) sessionScp.get("catalogues"))
						.containsKey("INCa");
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static List<Emetteur> getEmetteursInterfacages(Map<?, ?> sessionScp) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static List<Recepteur> getRecepteursInterfacages(Map<?, ?> sessionScp) {
		List<Recepteur> recepteurs = new ArrayList<Recepteur>();
	 ...
	 */
	public static boolean isSeroContexte(Map<?, ?> sessionScp) {
		return ((getSelectedBanques(sessionScp).size() == 1) && (getSelectedBanques(
				sessionScp).get(0).getContexte().getNom()
				.equals(seroContextName)));
	}
	 ...
	 */
	public static ResultatInjection getDossierExterneInjection(Map<String, Object> sessionScp) {
	...
	public static void setDossierExterneInjection(Map<String, Object> sessionScp, 
													ResultatInjection res) {
	...
	public static List<? extends Object> 
					getThesaurusListeValeurs(String typeThesaurus) {
		List<? extends Object> listValeurs = new ArrayList<Object>();
		...
		if (thesManager == null) {
			...
			listValeurs = ((TKThesaurusManager) thesManager)
					.findByOrderManager(getCurrentPlateforme());
		} else {
