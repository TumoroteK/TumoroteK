...
public class ConteneurNode extends TumoTreeNode {
	...
	public ConteneurNode(Conteneur cont, Banque banque) {
		this.conteneur = cont;
	...
	public void readChildren() {
		...
		List<Enceinte> enList = ManagerLocator.getEnceinteManager()
			.findByConteneurWithOrderManager(conteneur);
		
		int cpt = 1;
		// on parcourt tous les enfants
		for (int i = 0; i < enList.size(); i++) {
			Enceinte enc = enList.get(i);
	...
	public boolean equals(Object obj) {
		...
		ConteneurNode node = (ConteneurNode) obj;
