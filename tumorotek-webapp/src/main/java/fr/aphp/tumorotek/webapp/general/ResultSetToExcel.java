...
public class ResultSetToExcel
{
   ...
   public ResultSetToExcel(final SXSSFWorkbook wb, final Export export, final ResultSet resultSet, final ResultSet rs2,
      final ResultSet erRs, final ResultSet drRs, final boolean isExportAnonyme, final boolean hasP, final String sheetName,
   ...
   public ResultSetToExcel(final Export export, final ResultSet resultSet, final boolean isExportAnonyme){
      setExport(export);
   ...
   protected void writeCell(final Row row, final int col, final Object value, final FormatType formatType, final Short bgColor,
      ...
      if(value != null){
         ...
         if(isExportAnonyme && this.anonymeColumn.contains(col) && row.getRowNum() != 0){
   ...
   private void createLaboInterSheet() throws SQLException, ClassNotFoundException, InterruptedException{
      if(resultLaboInter.isBeforeFirst()){
         ...
         final Sheet sheet2 = workbook.createSheet(LABO_INTER_SHEET);
         int currentRow = 0;
         int numCols = 0;
         String title = "";
   ...
   private void createHyperlink(final String suff, final Cell cell, final int col, final Row row, final String text,
      ...
      final org.apache.poi.ss.usermodel.Hyperlink link2 = createHelper.createHyperlink(Hyperlink.LINK_DOCUMENT);
   ...
   public void setExportAnonyme(final boolean ie){
