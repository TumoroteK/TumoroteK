...
public class TerminaleNode extends TumoTreeNode {
	...
	public TerminaleNode(Terminale term, Banque banque) {
		this.terminale = term;
		this.selectedBanque = banque;
		
		if (this.terminale != null
				&& !this.terminale.equals(new Terminale())) {
	...
	public Boolean availableTerminale() {
		...
		if (terminale.getBanque() != null
				&& !terminale.getBanque().equals(selectedBanque)) {
			ok = false;
		}
	...
	public boolean isNotFull() {
		System.out.println(ManagerLocator.getTerminaleManager()
				.getNumberEmplacementsLibresManager(terminale));
		return ManagerLocator.getTerminaleManager()
		.getNumberEmplacementsLibresManager(terminale) > 0;
	}
	...
	public boolean equals(Object obj) {
		...
		TerminaleNode node = (TerminaleNode) obj;
