 ...
 *
 */
public class ContexteTreeitemRenderer implements TreeitemRenderer {
	...
	public void render(Treeitem item, Object data, int index) throws Exception {
		...
		if (data instanceof EtablissementNode) {
			EtablissementNode node = (EtablissementNode) data;
			...
			CollaborateurNode node = (CollaborateurNode) data;
		...
		if (archive && oldSelected) {
			tcNamn.setStyle(
				"font-style:italic;color:#07811C;font-weight: bold;");
