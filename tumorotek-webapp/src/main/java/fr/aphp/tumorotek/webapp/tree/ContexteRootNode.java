 ...
 *
 */
public class ContexteRootNode extends TumoTreeNode
{

   /**
    * Recherche tous les établissements et crée un EtablissementNode
    * pour chacun.
    */
   @Override
   public void readChildren(){
      final List<Etablissement> etabs = ManagerLocator.getEtablissementManager().findAllObjectsWithOrderManager();
