...
public class EntiteNode extends TumoTreeNode {
	...
	public void readChildren() {
		...
		for (int i = 0; i < champsEntite.size(); i++) {
			...
			if (!oldSelectedChamps.contains(chp)) {
				ChampNode node = new ChampNode(chp);
	 ...
	 * @param champsEntite
	 */
	private void addVirtualChampEntite(List<ChampEntite> champsEntite) {
		if (entite.getNom().equals("Prelevement")) {
			// Etablissement preleveur
			champsEntite.add(6, ManagerLocator
			.getChampEntiteManager()
			.findByIdManager(193));
		} else if (entite.getNom().equals("Echantillon")) {
			champsEntite.add(5, ManagerLocator
					.getChampEntiteManager()
					.findByIdManager(265));
		} else if (entite.getNom().equals("ProdDerive")) {
			champsEntite.add(10, ManagerLocator
					.getChampEntiteManager()
					.findByIdManager(266));
		}
	}
	...
	public boolean equals(Object obj) {
		...
		EntiteNode node = (EntiteNode) obj;
