...
public class TableGroupModel  extends GroupsModelArray<TableAnnotation, 
								TableGroupModel.TableInfo, Object, Object> {
		private static final long serialVersionUID = 1L;

		public TableGroupModel(List<TableAnnotation> data, 
				Comparator<TableAnnotation> cmpr) {
			super(data.toArray(new TableAnnotation[0]), cmpr);	         
		}

		protected TableInfo createGroupHead(TableAnnotation[] groupdata, int index, int col) {
...
//		}
		...
		public static class TableInfo {
			private TableAnnotation firstChild;
			private int groupIndex;
			private int colIndex;

			public TableInfo(TableAnnotation firstChild, int groupIndex, int colIndex) {
				super();
