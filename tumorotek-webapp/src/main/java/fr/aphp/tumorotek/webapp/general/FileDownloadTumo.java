...
public class FileDownloadTumo
{
    ...
    */
   public static void save(final Media media, final Desktop desktop){
    ...
    */
   public static void save(final Media media, final String flnm, final Desktop desktop){
      ((WebAppCtrl) desktop.getWebApp()).getUiEngine().addResponse(null, new AuDownload(new DownloadURL(media, flnm))); //Bug 2114380
   }
    ...
    */
   public static void save(final byte[] content, final String contentType, final String flnm, final Desktop desktop){
    ...
    * If null, no suggested name is provided.
    */
   public static void save(final String content, final String contentType, final String flnm, final Desktop desktop){
      save(new AMedia(flnm, null, contentType, content), flnm, desktop);
   }
    ...
    * If null, no suggested name is provided.
    */
   public static void save(final InputStream content, final String contentType, final String flnm, final Desktop desktop){
      save(new AMedia(flnm, null, contentType, content), flnm, desktop);
   }
    ...
    * If null, no suggested name is provided.
    */
   public static void save(final Reader content, final String contentType, final String flnm, final Desktop desktop){
      save(new AMedia(flnm, null, contentType, content), flnm, desktop);
   }
    ...
    * @since 3.0.8
    */
   public static void save(final File file, final String contentType, final Desktop desktop) throws FileNotFoundException{
    ...
    * @since 3.0.8
    */
   public static void save(final URL url, final String contentType, final Desktop desktop) throws FileNotFoundException{
    ...
    * @since 3.0.8
    */
   public static void save(final String path, final String contentType, final Desktop desktop) throws FileNotFoundException{
