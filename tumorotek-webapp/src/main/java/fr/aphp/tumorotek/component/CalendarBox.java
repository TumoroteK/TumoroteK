...
public class CalendarBox extends HtmlMacroComponent {
	...
	public void afterCompose() {
		...
		((Datebox) getFirstChild().getFirstChild())
										.addForward("onBlur", this, "onBlur");
		((Timebox) getFirstChild()
						.getLastChild()).addForward("onBlur", this, 
								"onBlurTimebox");
	}
	...
	public Calendar getValue() {
		...
		if (((Datebox) getFirstChild().getFirstChild()).getValue() != null) {
			...
			timeCal.setTime(((Datebox) getFirstChild()
		...
		if (((Timebox) getFirstChild().getLastChild()).getValue() != null) {
			Calendar timeCal = Calendar.getInstance();
			timeCal.setTime(((Timebox) getFirstChild()
	...
	public void onBlurTimebox() {
		...
		if (timeCal.get(Calendar.HOUR_OF_DAY) == 0
				&& timeCal.get(Calendar.MINUTE) == 0) {
			((Timebox) getFirstChild().getLastChild()).setValue(null);
		}
	...
	public void clearErrorMessage(Calendar value) {
	...
	public void onFocus$dateBox() {
		if (((Timebox) getFirstChild().getLastChild()).getValue() == null) {
			...
			((Timebox) getFirstChild().getLastChild()).setValue(
					calTmp.getTime());
		}
	}
