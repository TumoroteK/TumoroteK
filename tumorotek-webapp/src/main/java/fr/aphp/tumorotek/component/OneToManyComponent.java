...
public abstract class OneToManyComponent extends AbstractController {
	...
	public void setGroupHeader(Group gH) {
		this.groupHeader = gH;
	}
	 ...
	 * @param event
	 */
	public void onDeleteObj$rows(ForwardEvent event) {
		if (!addObj.isDisabled()) {
			// recupere l'objet
			Object obj = event.getOrigin().getData(); 
	...
	public void onClick$addObj() {	
		...
		ListModel<? extends Object> list = 
				new ListModelList<Object>(findObjectsAddable());
