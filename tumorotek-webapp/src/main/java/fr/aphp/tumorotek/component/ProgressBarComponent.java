...
public class ProgressBarComponent extends GenericForwardComposer<Component> {
	 ...
	 */
	public void setDetail(Integer v, Integer count, String action, String entite, 
			Exception e) {
		if (e == null) {
//			if (v != null) {
...
//			}
			...
			// changement action
			if (getAction() != null) {
				type_.setValue(Labels.getLabel(getAction()) 
					+ (getCounter() != null ? " : " + getCounter() :  "")
...
//		if (exportThread.isAlive() 
	...
	public void setExportThread(Export exportThread) {
