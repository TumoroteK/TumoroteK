...
public abstract class SmallObjDecorator {
	...
	public SmallObjDecorator(Object object) {
		setObj(object);
	}
	...
	public boolean equals(Object deco2) {
		...
		SmallObjDecorator deco = (SmallObjDecorator) deco2;
		return this.getObj().equals(deco.getObj())
		 			&& this.getEdition() == deco.getEdition();
	...
	public int hashCode() {
		...
		int hash = 7;
		int hashObj = 0;
		int hashEdition = new Boolean(edition).hashCode();
	...
	public void setOrdreInit(Integer oI) {
		this.ordreInit = oI;
	}
