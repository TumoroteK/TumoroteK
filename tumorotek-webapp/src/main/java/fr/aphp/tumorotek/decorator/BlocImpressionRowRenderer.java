 ...
 * @version 2.0
 */
public class BlocImpressionRowRenderer implements RowRenderer {
	
	private Boolean edit = false;
	private Template template;
	
	public BlocImpressionRowRenderer(Boolean isEdit) {
		edit = isEdit;
	}

	@Override
	public void render(Row row, Object data, int index) throws Exception {
		BlocImpressionDecorator bloc = (BlocImpressionDecorator) data;
		...
		// Nom du bloc
		Label nomLabel = new Label(bloc.getNomForBloc());
	 ...
	 */
	public void createDetailContenu(Row row, BlocImpressionDecorator bloc) {
		// partie détail
