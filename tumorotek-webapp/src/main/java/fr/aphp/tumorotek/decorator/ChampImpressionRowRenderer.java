 ...
 * @version 2.0
 */
public class ChampImpressionRowRenderer implements RowRenderer {

	@Override
	public void render(Row row, Object data, int index) throws Exception {
		ChampImpressionDecorator deco = (ChampImpressionDecorator) data;
		
		Label nomLabel = new Label(Labels.getLabel(deco.getNom()));
