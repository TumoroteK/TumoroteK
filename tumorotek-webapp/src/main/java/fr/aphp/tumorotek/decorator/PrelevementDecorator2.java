...
public class PrelevementDecorator2 {
	 ...
	 * @param prel
	 */
	public PrelevementDecorator2(Prelevement prel) {
	...
	public String getPatientNomAndPrenom() {
		...
		Maladie maladie = this.prelevement.getMaladie();
	...
	public int getNbEchanRestants() {
		return ManagerLocator.getEchantillonManager()
					.findRestantsByPrelevementManager(this.prelevement).size();
	}
	...
	public String getDateCreation() {
		Calendar date = ManagerLocator.getOperationManager()
			.findDateCreationManager(this.prelevement);
		if (date != null) {
	 ...
	 */
	public static List<PrelevementDecorator2> 
								decorateListe(List<Prelevement> prels) {
		List<PrelevementDecorator2> liste = 
									new ArrayList<PrelevementDecorator2>();
	...
	public boolean equals(Object obj) {
		...
		PrelevementDecorator2 deco = (PrelevementDecorator2) obj;
