 ...
 *
 */
public class CombinaisonDecorator implements Comparable<Object>
{

   private Combinaison combinaison;

   public CombinaisonDecorator(final Combinaison c){
      this.combinaison = c;
   }
   ...
   public void setCombinaison(final Combinaison c){
      this.combinaison = c;
   }

   public String getLabel(){
      return new ChampDecorator(combinaison.getChamp1()).getLabelLong() + " " + combinaison.getOperateur() + " "
    ...
    */
   public static List<CombinaisonDecorator> decorateListe(final List<Combinaison> combinaisons){
      final List<CombinaisonDecorator> liste = new ArrayList<>();
      final Iterator<Combinaison> it = combinaisons.iterator();
      while(it.hasNext()){
    ...
    */
   public static List<Combinaison> extractListe(final List<CombinaisonDecorator> combinaisons){
      final List<Combinaison> liste = new ArrayList<>();
      final Iterator<CombinaisonDecorator> it = combinaisons.iterator();
      while(it.hasNext()){
   ...
   public boolean equals(final Object obj){
      ...
      final CombinaisonDecorator deco = (CombinaisonDecorator) obj;
   ...
   private int compareTo(final CombinaisonDecorator cd){
