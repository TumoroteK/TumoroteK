...
public class ObjetDecorator implements Comparable<Object>
{
      ...
      while(itRes.hasNext()){
         ...
         if(entite != null){
            ...
            if(entite.getNom().equals("Patient")){
               if(null != recup && null != res && res.getChamp().getChampEntite() != null){
                  ...
                  liste.add(ManagerLocator.getChampAnnotationManager().findAnnotationValeurManager(recup,
                     res.getChamp().getChampAnnotation()));
               }else{
                  liste.add("-");
               }
            }else if(entite.getNom().equals("Maladie")){
               if(null != res && res.getChamp().getChampEntite() != null){
                  final String nomChampEntite = res.getChamp().getChampEntite().getNom();
                  final MaladieDecorator malDeco = new MaladieDecorator((Maladie) recup);
               ...
               if(null != res && res.getChamp().getChampEntite() != null){
                  final String nomChampEntite = res.getChamp().getChampEntite().getNom();
                  final PrelevementDecorator2 preDeco = new PrelevementDecorator2((Prelevement) recup);
               ...
               if(null != res && res.getChamp().getChampEntite() != null){
                  final String nomChampEntite = res.getChamp().getChampEntite().getNom();
                  final EchantillonDTO echDeco = new EchantillonDTO((Echantillon) recup);
                  if(nomChampEntite.equals("BanqueId")){
                     ...
                     liste.add(ObjectTypesFormatters.dateRenderer2(echDeco.getDateStockage()));
               ...
               if(null != res && res.getChamp().getChampEntite() != null){
                  final String nomChampEntite = res.getChamp().getChampEntite().getNom();
                  final ProdDeriveDecorator2 prodDeco = new ProdDeriveDecorator2((ProdDerive) recup);
                  if(nomChampEntite.equals("BanqueId")){
    ...
    */
   public static List<ObjetDecorator> decorateListe(final List<Object> objs, final Affichage aff){
      final List<ObjetDecorator> liste = new ArrayList<>();
   ...
   public int compareTo(final Object o){
      final ObjetDecorator obj = (ObjetDecorator) o;
      if(affichage != null){
         ...
         final List<Object> thisListObjets = this.getCells();
         final List<Object> objListObjets = obj.getCells();
         ...
         for(int i = 0; i < resultats.size(); i++){
            if(thisListObjets.get(resultats.get(i).getPosition() - 1) != null
               && objListObjets.get(resultats.get(i).getPosition() - 1) != null){
               if(resultats.get(i).getTri()){

                  if(((Comparable<Object>) thisListObjets.get(resultats.get(i).getPosition() - 1))
                     .compareTo(objListObjets.get(resultats.get(i).getPosition() - 1)) != 0){
                     return ((Comparable<Object>) thisListObjets.get(resultats.get(i).getPosition() - 1))
                        .compareTo(objListObjets.get(resultats.get(i).getPosition() - 1));
                  }
