...
public class EntiteDecorator {
	...
	public EntiteDecorator(Entite e) {
		this.entite = e;
	}
	 ...
	 */
	public static List<EntiteDecorator> 
								decorateListe(Collection<Entite> entites) {
		List<EntiteDecorator> liste = 
									new ArrayList<EntiteDecorator>();
	 ...
	 */
	public static List<Entite> extractListe(List<EntiteDecorator> entites) {
		List<Entite> liste = 
									new ArrayList<Entite>();
	...
	public boolean equals(Object obj) {
		...
		EntiteDecorator deco = (EntiteDecorator) obj;
