...
public class CollaborateurDecorator {
	 ...
	 * @param col
	 */
	public CollaborateurDecorator(Collaborateur col) {
		this.collaborateur = col;
	}
	
	public void setCollaborateur(Collaborateur col) {
		this.collaborateur = col;
	}
	...
	public String getNomPrenom() {
		return this.collaborateur.getTitre().getTitre() + " "
				+ this.collaborateur.getNom() + " "
				+ this.collaborateur.getPrenom();
	}
	 ...
	 */
	public static List<CollaborateurDecorator> 
								decorateListe(List<Collaborateur> cols) {
		List<CollaborateurDecorator> liste = 
									new ArrayList<CollaborateurDecorator>();
		Iterator<Collaborateur> it = cols.iterator();
		while (it.hasNext()) {
	...
	public boolean equals(Object obj) {
		...
		CollaborateurDecorator deco = (CollaborateurDecorator) obj;
