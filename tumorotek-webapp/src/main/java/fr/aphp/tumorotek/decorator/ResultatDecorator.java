 ...
 *
 */
public class ResultatDecorator implements Comparable<Object>
{

   private Resultat resultat;

   public ResultatDecorator(final Resultat r){
      this.resultat = r;
   }
   ...
   public void setResultat(final Resultat r){
      this.resultat = r;
   }
    ...
    */
   public static List<ResultatDecorator> decorateListe(final List<Resultat> resultats){
      final List<ResultatDecorator> liste = new ArrayList<>();
    ...
    */
   public static List<Resultat> extractListe(final List<ResultatDecorator> resultats){
      final List<Resultat> liste = new ArrayList<>();
      final Iterator<ResultatDecorator> it = resultats.iterator();
      while(it.hasNext()){
   ...
   public boolean equals(final Object obj){
      ...
      final ResultatDecorator deco = (ResultatDecorator) obj;
   ...
   private int compareTo(final ResultatDecorator cd){
