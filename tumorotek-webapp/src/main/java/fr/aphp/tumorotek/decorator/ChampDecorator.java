...
public class ChampDecorator implements Comparable<Object> {
	...
	public String getLabelLong() {
		...
		if (this.champ.getChampAnnotation() != null) {
			nomEntite = this.champ.getChampAnnotation()
			...
			if (this.champ.getChampParent() == null) {
				...
				nom.append(this.champ.getChampParent().getChampEntite()
						.getEntite().getNom());
				nom.append(" - ");
				nom.append(getLabelForChampEntite(this.champ.getChampParent()
						.getChampEntite()));
			}
			return nom.toString();
		}
	 ...
	 */
	public static List<ChampDecorator> 
								decorateListe(List<Champ> champs) {
		List<ChampDecorator> liste = 
									new ArrayList<ChampDecorator>();
		Iterator<Champ> it = champs.iterator();
		while (it.hasNext()) {
	 ...
	 */
	public static List<Champ> extractListe(List<ChampDecorator> champs) {
		List<Champ> liste = 
									new ArrayList<Champ>();
		Iterator<ChampDecorator> it = champs.iterator();
		while (it.hasNext()) {
	...
	public boolean equals(Object obj) {
		...
		ChampDecorator deco = (ChampDecorator) obj;
	...
	private int compareTo(ChampDecorator cd) {
