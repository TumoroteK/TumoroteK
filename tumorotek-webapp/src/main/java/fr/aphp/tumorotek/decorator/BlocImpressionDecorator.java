...
public class BlocImpressionDecorator
{
   ...
   public void setBlocImpression(final BlocImpression bImpression){
   ...
   public void setTableAnnotation(final TableAnnotation tAnnotation){
   ...
   public void generateContenuForBlocInConsulation(){
      ...
      if(blocImpression.getIsListe() && template.getTemplateId() != null){
         ...
         final List<ChampImprime> champsI =
            ManagerLocator.getChampImprimeManager().findByTemplateAndBlocManager(template, blocImpression);
   ...
   public void generateContenuForAnnotationInConsulation(){
      ...
      final Set<ChampAnnotation> champs = ManagerLocator.getTableAnnotationManager().getChampAnnotationsManager(tableAnnotation);

      final Iterator<ChampAnnotation> it = champs.iterator();
      int i = 0;
      while(it.hasNext()){
         ++i;
   ...
   public boolean equals(final Object obj){
      ...
      final BlocImpressionDecorator test = (BlocImpressionDecorator) obj;
