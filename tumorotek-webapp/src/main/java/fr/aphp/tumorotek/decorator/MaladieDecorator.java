...
public class MaladieDecorator
{
    ...
    * @param pat
    */
   public MaladieDecorator(final Maladie mal){
      this.maladie = mal;
   }
   ...
   public String getPatientNomAndPrenom(){
      if(this.maladie != null && this.maladie.getPatient() != null){
         ...
         final Patient pat = this.maladie.getPatient();
    ...
    */
   public static List<MaladieDecorator> decorateListe(final List<Maladie> mals){
      final List<MaladieDecorator> liste = new ArrayList<>();
      final Iterator<Maladie> it = mals.iterator();
      while(it.hasNext()){
   ...
   public boolean equals(final Object obj){
      ...
      final MaladieDecorator deco = (MaladieDecorator) obj;
