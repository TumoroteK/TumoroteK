...
public class CritereDecorator {
	...
	public CritereDecorator(Critere c) {
		this.critere = c;
	}
	...
	public String getLabel() {
		...
		if (this.critere.getChamp() != null && op != null
				&& this.critere.getValeur() != null) {
				
			return new ChampDecorator(critere.getChamp()).getLabelLong() + " "
				+ op + " " + critere.getValeur();
		} else {
			return new CombinaisonDecorator(critere.getCombinaison())
					.getLabel()
					+ " " + op + " " + critere.getValeur();
		}
	}
	 ...
	 */
	public static List<CritereDecorator> 
								decorateListe(List<Critere> criteres) {
		List<CritereDecorator> liste = 
	 ...
	 */
	public static List<Critere> extractListe(List<CritereDecorator> criteres) {
		List<Critere> liste = 
									new ArrayList<Critere>();
		Iterator<CritereDecorator> it = criteres.iterator();
		while (it.hasNext()) {
	...
	public boolean equals(Object obj) {
		...
		CritereDecorator deco = (CritereDecorator) obj;
