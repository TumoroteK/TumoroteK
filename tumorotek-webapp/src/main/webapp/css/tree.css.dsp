...
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/arrow-toggle.png')});
}
span.z-tree-root-open, span.z-tree-tee-open, span.z-tree-last-open {
...
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/dot-toggle.gif')});
}
...
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/tee-open.gif')});
}
span.z-dottree-tee-close {
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/tee-close.gif')});
}
span.z-dottree-last-open {
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/tee-last-open.gif')});
}
span.z-dottree-last-close {
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/tee-last-close.gif')});
}
span.z-dottree-tee {
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/tee.gif')});
}
span.z-dottree-vbar {
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/tee-vbar.gif')});
}
span.z-dottree-last {
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/tee-last.gif')});
}
...
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/folder-toggle.gif')});
}
...
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/entity.gif')});
}
...
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/vfolder-toggle.png')});
}
...
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/ventity.png')});
}
...
span.z-vfiletree-ico, span.z-vfiletree-firstspacer {
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/vfolder-toggle.gif')});
}
span.z-vfiletree-tee, span.z-vfiletree-last {
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/ventity.gif')});
}
span.z-tree-root-open, span.z-tree-tee-open, span.z-tree-last-open,
span.z-tree-root-close, span.z-tree-tee-close, span.z-tree-last-close {
background-image: url(${c:encodeThemeURL('/images/icones/components/tree/arrow-toggle.gif')});
}
</c:if>
</c:if>
