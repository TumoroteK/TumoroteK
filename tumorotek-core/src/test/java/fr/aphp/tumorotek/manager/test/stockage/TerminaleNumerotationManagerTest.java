...
public class TerminaleNumerotationManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		TerminaleNumerotation tn1 = terminaleNumerotationManager
			.findByIdManager(1);
		assertNotNull(tn1);
		assertTrue(tn1.getLigne().equals("NUM"));
		assertTrue(tn1.getColonne().equals("NUM"));
		
		TerminaleNumerotation tnNull = terminaleNumerotationManager
			.findByIdManager(10);
		assertNull(tnNull);
	}
	...
	public void testFindAll() {
		List<TerminaleNumerotation> list = terminaleNumerotationManager
