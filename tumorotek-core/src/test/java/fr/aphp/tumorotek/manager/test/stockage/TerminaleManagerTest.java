...
public class TerminaleManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindDoublon(){
      ...
      final Enceinte e1 = enceinteDao.findById(3).orElse(null);
      final Enceinte e2 = enceinteDao.findById(2).orElse(null);
   ...
   public void testFindDoublonWithoutTwoTerminalesManager(){
      ...
      final Enceinte e = enceinteDao.findById(5).orElse(null);
      t4.setEnceinte(e);
   ...
   public void testGetListOfParentsManager(){
      ...
      assertTrue(results.get(0).equals(conteneurDao.findById(1))).orElse(null);
      assertTrue(results.get(1).equals(enceinteDao.findById(1))).orElse(null);
      assertTrue(results.get(2).equals(enceinteDao.findById(3))).orElse(null);

      final Terminale t5 = terminaleManager.findByIdManager(5);
      results = terminaleManager.getListOfParentsManager(t5);
      assertTrue(results.size() == 3);
      assertTrue(results.get(0).equals(conteneurDao.findById(1))).orElse(null);
      assertTrue(results.get(1).equals(enceinteDao.findById(2))).orElse(null);
      assertTrue(results.get(2).equals(enceinteDao.findById(6))).orElse(null);
   ...
   private void createObjectManagerTest() throws ParseException{
      ...
      final Enceinte enc = enceinteDao.findById(3).orElse(null);
      final TerminaleType type = terminaleTypeDao.findById(1).orElse(null);
      final TerminaleNumerotation num = terminaleNumerotationDao.findById(1).orElse(null);
      final Banque banque = banqueDao.findById(1).orElse(null);
      final Entite ent = entiteDao.findById(3).orElse(null);
      ...
      try{
         terminaleManager.createObjectManager(t1, null, type, null, null, num, null, u);
      ...
      try{
         terminaleManager.createObjectManager(t1, enc, null, null, null, num, null, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         terminaleManager.createObjectManager(t1, enc, type, null, null, null, null, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      t1.setNom("BT1");
      try{
         terminaleManager.createObjectManager(t1, enc, type, null, null, num, null, u);
      }catch(final Exception e){
      ...
      t2.setPosition(4);
      t2.setAlias("ALIAS4");
      final Couleur coul = couleurDao.findById(6).orElse(null);
      terminaleManager.createObjectManager(t2, enc, type, banque, ent, num, coul, u);
   ...
   private void updateObjectManagerTest() throws ParseException{
      ...
      t.setNom("BT3");
      t.setPosition(3);
      terminaleManager.createObjectManager(t, enc, type, null, ent, num, null, u);
      ...
      try{
         terminaleManager.updateObjectManager(tUp1, null, type, null, null, num, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         terminaleManager.updateObjectManager(tUp1, enc, null, null, null, num, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         terminaleManager.updateObjectManager(tUp1, enc, type, null, null, null, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      tUp1.setNom("BT1");
      try{
         terminaleManager.updateObjectManager(tUp1, enc, type, null, null, num, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      try{
         terminaleManager.updateObjectManager(tUp1, enc, type, null, null, num, null, incs, u, null);
      }catch(final Exception e){
      ...
      terminaleManager.updateObjectManager(tUp2, enc, type, banque, ent, num, couleurDao.findById(8), incs, u, opTypes).orElse(null);
   ...
   private void removeObjectManagerTest(){
      ...
      newT.setNom("BT3");
      newT.setPosition(3);
      terminaleManager.createObjectManager(newT, enc, type, null, null, num, null, u);
      assertTrue(terminaleManager.findAllObjectsManager().size() == 7);
   ...
   public void testCreateMultiObjetcsManager(){
      final Utilisateur u = utilisateurDao.findById(1).orElse(null);
      final Enceinte e3 = enceinteDao.findById(3).orElse(null);
      final Enceinte e4 = enceinteDao.findById(4).orElse(null);
      final TerminaleType type = terminaleTypeDao.findById(1).orElse(null);
      final TerminaleNumerotation num = terminaleNumerotationDao.findById(1).orElse(null);
      final Banque banque = banqueDao.findById(1).orElse(null);
      final Entite ent = entiteDao.findById(3).orElse(null);
   ...
   private void validationInsert(final Terminale terminale) throws ParseException{
      ...
      try{
         ...
         terminaleManager.createObjectManager(terminale, enc, type, null, null, num, null, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("ValidationException")){
            catchedInsert = true;
         }
   ...
   private void validationUpdate(Terminale terminale) throws ParseException{
      ...
      try{
         terminale.setPosition(-1);
         terminaleManager.updateObjectManager(terminale, enc, type, null, null, num, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("ValidationException")){
            catchedInsert = true;
         }
      ...
      boolean catched = false;
      try{
         terminaleManager.updateObjectManager(terminale, enc, type, null, null, num, null, incs, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
   ...
   public void testUpdateNumerotationForMultiTerminales(){
      ...
      final Utilisateur u = utilisateurDao.findById(1).orElse(null);
      final ConteneurType type = conteneurTypeDao.findById(1).orElse(null);
      final Service serv = serviceDao.findById(1).orElse(null);
      final Banque bank1 = banqueDao.findById(1).orElse(null);
      ...
      final TerminaleType tType = terminaleTypeDao.findById(1).orElse(null);
      final TerminaleNumerotation num = terminaleNumerotationDao.findById(1).orElse(null);
      ...
      final TerminaleNumerotation num2 = terminaleNumerotationDao.findById(2).orElse(null);
   ...
   public void testGetTkObjectsAndEmplacementsManager(){
      ...
      assertTrue(emps.containsKey(echantillonDao.findById(2))).orElse(null);
      assertTrue(emps.get(echantillonDao.findById(2)).getEmplacementId().equals(3)).orElse(null);
      assertTrue(emps.containsKey(prodDeriveDao.findById(1))).orElse(null);
      assertTrue(emps.get(prodDeriveDao.findById(1)).getEmplacementId().equals(1)).orElse(null);
      assertTrue(emps.containsKey(prodDeriveDao.findById(2))).orElse(null);
      assertTrue(emps.get(prodDeriveDao.findById(2)).getEmplacementId().equals(2)).orElse(null);
   ...
   public void testFindTerminaleIdsFromNomManager(){
      ...
      conts.remove(conteneurDao.findById(1)).orElse(null);
      ids.clear();
      ids.addAll(terminaleManager.findTerminaleIdsFromNomManager("ALIAS BT%", null, conts));
      assertTrue(ids.isEmpty());

      conts.clear();
      conts.add(conteneurDao.findById(1)).orElse(null);
      ids.clear();
      ...
      conts.clear();
      conts.add(conteneurDao.findById(2)).orElse(null);
      ids.clear();
      ids.addAll(terminaleManager.findTerminaleIdsFromNomManager("BT2", null, conts));
      assertTrue(ids.isEmpty());
      ...
      conts.add(conteneurDao.findById(1)).orElse(null);
      ids.clear();
      ids.addAll(terminaleManager.findTerminaleIdsFromNomManager("BT1", enceinteDao.findById(1), conts)).orElse(null);
      assertTrue(ids.size() == 2);
      assertTrue(ids.contains(1));
      assertTrue(ids.contains(4));
      ids.clear();
      ids.addAll(terminaleManager.findTerminaleIdsFromNomManager("BT1", enceinteDao.findById(3), conts)).orElse(null);
      assertTrue(ids.size() == 1);
      assertTrue(ids.contains(1));
      ...
      ids.addAll(terminaleManager.findTerminaleIdsFromNomManager("BT1", enceinteDao.findById(3), conts)).orElse(null);
      assertTrue(ids.isEmpty());
      ids.addAll(terminaleManager.findTerminaleIdsFromNomManager("BT2", enceinteDao.findById(4), conts)).orElse(null);
      assertTrue(ids.isEmpty());
   }
   ...
   public void testGetDistinctBanquesFromTkObjectsManager() {
	   ...
	   assertTrue(banks.contains(banqueDao.findById(1))).orElse(null);
