...
public class BlocExterneManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByDossierExterneManager(){
      final DossierExterne d1 = dossierExterneDao.findById(1).orElse(null);
      final DossierExterne d2 = dossierExterneDao.findById(2).orElse(null);
   ...
   public void testFindByDossierExterneAndEntiteManager(){
      ...
      final Entite e5 = entiteDao.findById(5).orElse(null);
   ...
   public void testFindDoublon(){
      final DossierExterne de1 = dossierExterneDao.findById(1).orElse(null);
      final DossierExterne de2 = dossierExterneDao.findById(2).orElse(null);
   ...
   public void testCrud(){
      final DossierExterne de = dossierExterneDao.findById(2).orElse(null);
