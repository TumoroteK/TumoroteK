...
public class TvgsoComplementExportTest extends AbstractManagerTest {
	...
	public void testGetDonneesClinBase() 
					throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
				+ "toul?characterEncoding=UTF-8", "root", "root");		
		Prelevement p = new Prelevement();
		p.setPrelevementId(7268);
		assertTrue(tvgsoComplementExport
				.getDonneesClinBase(con, p).equals("N"));
		p.setPrelevementId(3348);
		assertTrue(tvgsoComplementExport
				.getDonneesClinBase(con, p).equals("O"));
		p.setPrelevementId(3412);
		assertTrue(tvgsoComplementExport
				.getDonneesClinBase(con, p).equals(""));
	}
	
	public void testGetInclusionTherap() 
			throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		assertTrue(tvgsoComplementExport
				.getInclusionTherap(con, p).equals("O"));
		p.setPrelevementId(11921);
		assertTrue(tvgsoComplementExport
				.getInclusionTherap(con, p).equals("N"));
		p.setPrelevementId(3412);
		assertTrue(tvgsoComplementExport
				.getInclusionTherap(con, p).equals(""));
	...
	public void testGetNomProtocoleTherap() 
					throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		p.setPrelevementId(7242);
		assertTrue(tvgsoComplementExport
				.getNomProtocoleTherap(con, p).equals(""));
		p.setPrelevementId(11921);
		assertTrue(tvgsoComplementExport
				.getNomProtocoleTherap(con, p).equals(""));
		p.setPrelevementId(3412);
		...
		p.setPrelevementId(6709);
		assertTrue(tvgsoComplementExport
				.getNomProtocoleTherap(con, p).equals("MERCK SERONO"));
		p.setPrelevementId(9405);
		assertTrue(tvgsoComplementExport
				.getNomProtocoleTherap(con, p).equals("Tarceva"));
	}
	
	public void testGetAnomalieGenomiqueDescr() 
						throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		assertTrue(tvgsoComplementExport
				.getAnomalieGenomiqueDescr(con, p, b).equals("Syndrome XXY"));

		p.setPatientId(2);
		assertTrue(tvgsoComplementExport
				.getAnomalieGenomiqueDescr(con, p, b).equals("Trisomie 21"));

		p.setPatientId(3);
		assertTrue(tvgsoComplementExport
				.getAnomalieGenomiqueDescr(con, p, b).equals(""));
		b.setBanqueId(2);
		assertTrue(tvgsoComplementExport
				.getAnomalieGenomiqueDescr(con, p, b).equals("Klinefelter"));
	...
	public void testGetInclusionProtocoleRech() 
			throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		assertTrue(tvgsoComplementExport
				.getInclusionProtocoleRech(con, e).equals("O"));
		e.setEchantillonId(16698);
		assertTrue(tvgsoComplementExport
				.getInclusionProtocoleRech(con, e).equals("N"));
		e.setEchantillonId(4);
		assertTrue(tvgsoComplementExport
				.getInclusionProtocoleRech(con, e).equals(""));
	}

	public void testGetNomProtocoleRech() 
			throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		assertTrue(tvgsoComplementExport
				.getNomProtocoleRech(con, e).equals("Marges ORL"));
		e.setEchantillonId(31456);
		assertTrue(tvgsoComplementExport
				.getNomProtocoleRech(con, e).equals("Oncodesign prostate"));
		e.setEchantillonId(25);
		assertTrue(tvgsoComplementExport
				.getNomProtocoleRech(con, e).equals(""));
	}
	
	public void testGetChampSpecCancer() 
			throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		b.setBanqueId(1);
		assertTrue(tvgsoComplementExport
				.getChampSpecCancer(con, p, b).equals(""));
	}
	
	public void testGetConsentement() {
		Prelevement p = new Prelevement();
		ConsentType cType = new ConsentType();
		cType.setType("Autorisation avant 2004");
		p.setConsentType(cType);
		assertTrue("Consentement", tvgsoComplementExport
				.getConsentement(p, 
						".*AUTORISATION.*", "(.*ATTENTE.*)|(.*REFUS.*)")
				.equals("O"));
	...
	public void testGetContactShort() 
