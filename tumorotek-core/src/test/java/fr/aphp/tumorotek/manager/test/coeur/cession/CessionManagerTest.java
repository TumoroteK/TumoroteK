...
public class CessionManagerTest extends AbstractManagerTest4
{
   ...
   private void createObjectManagerTest() throws ParseException{
      ...
      final CessionType type = cessionTypeDao.findById(1).orElse(null);
      final CessionExamen exam = cessionExamenDao.findById(1).orElse(null);
      final Collaborateur destinataire = collaborateurDao.findById(1).orElse(null);
      final Service servDest = serviceDao.findById(1).orElse(null);
      final Collaborateur demandeur = collaborateurDao.findById(2).orElse(null);
      final CessionStatut statut = cessionStatutDao.findById(1).orElse(null);
      final Collaborateur executant = collaborateurDao.findById(3).orElse(null);
      final Transporteur transp = transporteurDao.findById(1).orElse(null);
      final DestructionMotif motif = destructionMotifDao.findById(1).orElse(null);
      final Utilisateur utilisateur = utilisateurManager.findByIdManager(1);
      final Unite qteU = uniteDao.findById(5).orElse(null);
   ...
   public void testCreateUpdateCessionWithAnnots(){
      ...
      final Banque b1 = banqueManager.findByIdManager(1);
      final Utilisateur utilisateur = utilisateurManager.findByIdManager(1);
      final CessionType cType = cessionTypeDao.findById(2).orElse(null);
      final CessionStatut cStatut = cessionStatutDao.findById(1).orElse(null);
   ...
   //				objetStatutDao.findById(1), emplacementDao.findById(4), echantillonTypeDao.findById(1).orElse(null), null, 
   //				uniteDao.findById(4), null, null, null, null, null, u1, false, null, false).orElse(null);
   //		
   ...
   //				objetStatutDao.findById(1), emplacementDao.findById(5), echantillonTypeDao.findById(1).orElse(null), null, 
   //				uniteDao.findById(4), null, null, null, null, null, u1, false, null, false).orElse(null);
   //		
   ...
   //				objetStatutDao.findById(4), null, echantillonTypeDao.findById(1).orElse(null), null, 
   //				uniteDao.findById(4), null, null, null, null, null, u1, false, null, false).orElse(null);
   //		
   ...
   //				objetStatutDao.findById(1), emplacementDao.findById(6), echantillonTypeDao.findById(1).orElse(null), null, 
   //				uniteDao.findById(4), null, null, null, null, null, u1, false, null, false).orElse(null);
   //		
   //		// clean up
