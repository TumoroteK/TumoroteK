...
public class TableAnnotationTemplateManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByIdManager(){
      ...
      final TableAnnotation ta1 = tableAnnotationDao.findById(2).orElse(null);
   ...
   public void testFindDoublonManager(){
      ...
      final Template t1 = templateDao.findById(1).orElse(null);
      final Template t2 = templateDao.findById(2).orElse(null);
      final TableAnnotation ta2 = tableAnnotationDao.findById(2).orElse(null);
      final TableAnnotation ta3 = tableAnnotationDao.findById(3).orElse(null);
