...
public class TableAnnotationTemplateManagerTest extends AbstractManagerTest4 {
	...
	public void testFindAllObjectsManager() {
		List<TableAnnotationTemplate> liste = 
			tableAnnotationTemplateManager.findAllObjectsManager();
	...
	public void testFindByIdManager() {
		...
		TableAnnotationTemplate tat = tableAnnotationTemplateManager
			.findByIdManager(pk);
		assertNotNull(tat);
	...
	public void testFindByExcludedPKManager() {
		...
		List<TableAnnotationTemplate> liste = 
			tableAnnotationTemplateManager.findByExcludedPKManager(pk);
	...
	public void testFindByTemplateManager() {
		...
		List<TableAnnotationTemplate> liste = 
			tableAnnotationTemplateManager.findByTemplateManager(t1);
		assertTrue(liste.size() == 1);
	...
	public void testFindDoublonManager() {
		...
		TableAnnotation ta3 = tableAnnotationDao.findById(3);
		...
		assertFalse(tableAnnotationTemplateManager
				.findDoublonManager(null, ta2));
		assertFalse(tableAnnotationTemplateManager
				.findDoublonManager(t1, null));
		assertFalse(tableAnnotationTemplateManager
	...
	public void testCrud() {
		...
		// on test l'insertion avec la tableannotation null
		try {
			tableAnnotationTemplateManager.createObjectManager(
					tat1, t1, null);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"RequiredObjectIsNullException")) {
		...
		tableAnnotationTemplateManager.createObjectManager(
				tat1, t1, ta3);
		TableAnnotationTemplatePK pk = tat1.getPk();
		assertTrue(tableAnnotationTemplateManager
				.findAllObjectsManager().size() == 2);
		
		TableAnnotationTemplate tatTest = tableAnnotationTemplateManager
			.findByIdManager(pk);
		...
		TableAnnotationTemplate tatTest2 = tableAnnotationTemplateManager
			.findByIdManager(pk);
