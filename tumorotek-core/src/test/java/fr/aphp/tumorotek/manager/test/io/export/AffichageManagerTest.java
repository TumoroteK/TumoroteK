...
public class AffichageManagerTest extends AbstractManagerTest4
{
   ...
   public void testCopyAffichage(){
      ...
      assertNotNull(affichage);
      final Utilisateur util = utilisateurDao.findById(3).orElse(null);
      final Banque b1 = banqueDao.findById(1).orElse(null);
   ...
   public void testAddResultat(){
      ...
      final Champ champ = new Champ(champEntiteDao.findById(20)).orElse(null);
      //On crée un résultat
   ...
   public void testMoveResultat(){
      ...
      final Resultat resultat2 = resultatDao.findById(idResultat).orElse(null);
   ...
   public void testCrud(){
      ...
      final Champ champ1 = new Champ(champEntiteDao.findById(3)).orElse(null);
      final Resultat resultat1 = new Resultat("col1", champ1, true, 1, 2, "format", null);
      final Champ champ2 = new Champ(champEntiteDao.findById(4)).orElse(null);
      ...
      final Champ champ3 = new Champ(champEntiteDao.findById(1)).orElse(null);
      ...
      resultat = resultatDao.findById(idResultat).orElse(null);
