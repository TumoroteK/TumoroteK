...
public class TKAnnnotableDuoManagerTest extends AbstractManagerTest4 {
	...
	public void testComparePrelevementsDuoManager() {
		...
		assertTrue(tkAnnotableDuoManager.compareObjectsDuoManager(null, new ArrayList<ChampEntite>(), 
				new ArrayList<ChampAnnotation>()).isEmpty());
		
		TKAnnotableObjectDuo duo = new TKAnnotableObjectDuo();
		duo.setEntite(prelEntite);
		
		assertTrue(tkAnnotableDuoManager.compareObjectsDuoManager(duo, new ArrayList<ChampEntite>(), 
				new ArrayList<ChampAnnotation>()).isEmpty());
		...
		List<ChampEntite> chpsE = champEntiteDao.findByEntiteAndImport(prelEntite, true);
		...
		assertTrue(tkAnnotableDuoManager.compareObjectsDuoManager(duo, chpsE, 
				new ArrayList<ChampAnnotation>()).isEmpty());
		...
		List<TKAnnotableObjectPropertyDuo> propDuos = 
				tkAnnotableDuoManager.compareObjectsDuoManager(duo, chpsE, 
