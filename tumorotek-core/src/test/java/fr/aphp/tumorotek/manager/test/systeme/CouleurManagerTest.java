...
public class CouleurManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		Couleur c1 = couleurManager.findByIdManager(1);
		assertNotNull(c1);
		assertTrue(c1.getCouleur().equals("VERT"));
		
		Couleur cNull = couleurManager.findByIdManager(25);
		assertNull(cNull);
	}
	...
	public void testFindAll() {
		List<Couleur> list = couleurManager.findAllObjectsManager();
	...
	public void testFindByOrdreVisotubeManager() {
		List<Couleur> list = couleurManager.findByOrdreVisotubeManager();
	...
	public void testFindByCouleurLikeExactManager() {
		List<Couleur> list = 
			couleurManager.findByCouleurLikeManager("VERT", true);
	...
	public void testFindByCouleurLikeManager() {
		List<Couleur> list = 
			couleurManager.findByCouleurLikeManager("VERT", false);
		assertTrue(list.size() == 1);
