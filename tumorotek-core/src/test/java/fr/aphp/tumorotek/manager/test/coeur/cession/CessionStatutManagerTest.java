...
public class CessionStatutManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		CessionStatut cs1 = cessionStatutManager.findByIdManager(1);
		assertNotNull(cs1);
		assertTrue(cs1.getStatut().equals("EN ATTENTE"));
		
		CessionStatut csNull = cessionStatutManager.findByIdManager(10);
		assertNull(csNull);
	}
	...
	public void testFindAll() {
		List<CessionStatut> list = cessionStatutManager.findAllObjectsManager();
	...
	public void testFindByStatutLikeExactManager() {
		List<CessionStatut> list = 
			cessionStatutManager.findByStatutLikeManager("REFUSEE", true);
	...
	public void testFindByStatutLikeManager() {
		List<CessionStatut> list = 
			cessionStatutManager.findByStatutLikeManager("REFUSEE", false);
		assertTrue(list.size() == 1);
