...
public class SpecialiteManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		Specialite spec1 = specialiteManager.findByIdManager(2);
		assertNotNull(spec1);
		assertTrue(spec1.getNom().equals("DERMATOLOGIE"));
		
		Specialite specNull = specialiteManager.findByIdManager(10);
		assertNull(specNull);
	}
	...
	public void testFindAll() {
		List<Specialite> list = specialiteManager.findAllObjectsManager();
	...
	public void testFindByNomLikeExactManager() {
		List<Specialite> list = 
			specialiteManager.findByNomLikeManager("DERMATOLOGIE", true);
	...
	public void testFindByNomLikeManager() {
		List<Specialite> list = 
			specialiteManager.findByNomLikeManager("DERMATOLOGIE", false);
		assertTrue(list.size() == 1);
	...
	public void testFindDoublon() {
		//Cree le doublon
		Specialite s1 = specialiteManager.findByIdManager(1);
	...
	public void testIsUsedObjectManager() {
		...
		Specialite s2 = specialiteManager.findByIdManager(4);
	...
	private void createObjectManagerTest() {
		...
		Specialite s1Bis = new Specialite();
		s1Bis.setNom("NEW");
		try {
		...
		//Validation test
		String[] emptyValues = new String[]{"", "  ", "¤¤1$$2.K", 
	...
	private void updateObjectManagerTest() {
		...
		Specialite s1 = specialiteManager.findByIdManager(6);
		s1.setNom("NEW BIS");
		specialiteManager.updateObjectManager(s1);
		Specialite s1Bis = specialiteManager.findByIdManager(6);
