...
public class TvgsoPatientExportTest extends AbstractManagerTest {
	...
	public void setTvgsoPatientExport(TvgsoPatientExport tE) {
	...
	public void testGetPatientCode() 
						throws SQLException, ClassNotFoundException {	
		Patient p = new Patient();
		p.setNip("TVGSO NIP");

		assertTrue(tvgsoPatientExport.getPatientCode(p)
												.equals("TVGSO NIP"));
	...
	ClassNotFoundException, ParseException {
		...
		assertTrue(tvgsoPatientExport.getDateEtat(con, p, 
				dateFormatterINCA, b).equals("18760222"));

		p.setDateDeces(dateFormatterINCA.parse("19990909"));
		assertTrue(tvgsoPatientExport.getDateEtat(con, p, 
				dateFormatterINCA, b).equals("19990909"));
		
		p.setDateEtat(null);
		p.setDateDeces(null);

		assertTrue(tvgsoPatientExport.getDateEtat(con, p, 
					dateFormatterINCA, b).equals("20080102"));
		
		p.setPatientId(12969);
		assertTrue(tvgsoPatientExport.getDateEtat(con, p, 
				dateFormatterINCA, b).equals("20090417"));
		
		p.setPatientId(59);
		assertTrue(tvgsoPatientExport.getDateEtat(con, p, 
				dateFormatterINCA, b).equals("00000000"));
	}
