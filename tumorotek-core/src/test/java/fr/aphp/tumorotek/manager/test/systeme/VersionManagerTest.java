...
public class VersionManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		Version v1 = versionManager.findByIdManager(1);
		assertNotNull(v1);
		assertTrue(v1.getVersion().equals("2.0 beta 1"));
		
		Version vNull = versionManager.findByIdManager(25);
		assertNull(vNull);
	}
	...
	public void testFindAll() {
		List<Version> list = versionManager.findAllObjectsManager();
	...
	public void testFindByDateChronologiqueManager() {
		List<Version> list = versionManager
			.findByDateChronologiqueManager();
		assertTrue(list.size() == 3);
	...
	public void testFindByCurrentVersionManager() {
		Version v1 = versionManager.findByCurrentVersionManager();
		assertNotNull(v1);
