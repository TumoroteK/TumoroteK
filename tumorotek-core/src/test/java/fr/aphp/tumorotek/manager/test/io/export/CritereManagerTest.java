...
public class CritereManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		...
		Critere critere = manager.findByIdManager(1);
		assertNotNull(critere);
		assertTrue(critere.getCritereId().equals(1));
		
		Critere critereNull = manager.findByIdManager(50);
	...
	public void testFindAllObjects() {
		List<Critere> list = manager.findAllObjectsManager();
		//On vérifie chaque élément par un findById
		Iterator<Critere> it = list.iterator();
		while (it.hasNext()) {
			Critere temp = it.next();
			if (temp != null) {
				assertTrue(temp.equals(
						manager.findByIdManager(temp.getCritereId())));
			}
		}
	}
	...
	public void testCopyCritere() {
		...
		Critere copie = manager.copyCritereManager(critere);
	...
	public void testCrud() {
		...
		Critere critere = new Critere(champ, "=",
				"07B0%");
		...
		/** Update. */
		String oldValeur = critere.getValeur();
		String valeur = "val2";		
