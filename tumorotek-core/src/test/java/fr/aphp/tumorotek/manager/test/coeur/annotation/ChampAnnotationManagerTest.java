...
public class ChampAnnotationManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByTableManager(){
      ...
      assertTrue(tables.size() == 2);
      t = tableAnnotationDao.findById(6).orElse(null);
      tables = champAnnotationManager.findByTableManager(t);
      assertTrue(tables.size() == 2);
   ...
   private void createObjectManagerTest(){
      ...
      final TableAnnotation t = tableAnnotationDao.findById(5).orElse(null);
      //chp.setTableAnnotation(tableAnnotationDao.findById(3)).orElse(null);
      chp.setCombine(true);
      chp.setOrdre(4);
   ...
   private void updateDefautsObjectManagerTest(){
      ...
      final AnnotationDefaut d2 = new AnnotationDefaut();
      d2.setItem(itemDao.findById(90)).orElse(null);
   ...
   private void removeObjectManagerTest(){
      ...
      champAnnotationManager.removeObjectManager(c, null, utilisateurDao.findById(1), null).orElse(null);
      ...
      champAnnotationManager.removeObjectManager(c2, null, utilisateurDao.findById(1), null).orElse(null);
   ...
   public void testCreateOrDeleteFileDirectoryManager() throws IOException{
      ...
      chp.setDataType(dt);
      chp.setTableAnnotation(tableAnnotationDao.findById(2)).orElse(null);
      try{
   ...
   public void testFindByEditByCatalogueManager(){
      ...
      t = tableAnnotationDao.findById(2).orElse(null);
   ...
   public void testFindChampsFichiersByTableManager(){
      ...
      t = tableAnnotationDao.findById(7).orElse(null);
