...
public class CodeSelectManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByCodeDossierManager(){
      CodeDossier dos = codeDossierDao.findById(3).orElse(null);
   ...
   private void createObjectManagerTest(){
      ...
      /*Champs obligatoires*/
      final Banque b = banqueDao.findById(3).orElse(null);
      ...
      final CodeDossier dos = codeDossierDao.findById(3).orElse(null);
      ...
      assertTrue(codeSelectManager.findByCodeDossierManager(codeDossierDao.findById(3)).size() == 3).orElse(null);
