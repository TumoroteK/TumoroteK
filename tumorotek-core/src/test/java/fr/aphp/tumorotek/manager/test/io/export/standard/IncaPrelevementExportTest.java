...
public class IncaPrelevementExportTest extends AbstractManagerTest {
	...
	public void setIncaPrelevementExport(IncaPrelevementExport iP) {
	...
	public void testGetCentreStockage() 
		...
		e.setFiness("1478");
		assertTrue(incaPrelevementExport.getCentreStockage(echan)
												.equals("1478"));
	...
	public void testGetDatePrelevement() throws ParseException {
		...
		assertTrue(incaPrelevementExport.getDatePrelevement(p,
				dateFormatterINCA).equals("11/09/2011"));
		
		p.setDatePrelevement(null);
		boolean catched = false;
		try {
			assertTrue(incaPrelevementExport.getDatePrelevement(p, null)
												.equals(""));
	...
	public void testGetCodeOrgane() 
		...
		assertTrue(incaPrelevementExport
					.getCodeOrgane(con, e, "A").equals("BL"));
		assertTrue(incaPrelevementExport
				.getCodeOrgane(con, e, "C").equals("C02.0.1234"));
		e.setEchantillonId(3);
		boolean catched = false;
		try {
			assertTrue(incaPrelevementExport
					.getCodeOrgane(con, e, "A").equals("DC : COLON"));
		} catch (ItemException ie) {
			catched = true;
		}
		assertTrue(catched);
	...
	public void getTypeLesionnel() throws ClassNotFoundException, SQLException {
		...
		assertTrue(incaPrelevementExport.getTypeLesionnel(con, e, "A")
														.equals("BL0211-2"));
		assertTrue(incaPrelevementExport.getTypeLesionnel(con, e, "C")
													.equals("D5-22050"));
		...
		try {
			assertTrue(incaPrelevementExport
					.getTypeLesionnel(con, e, "A").equals(""));
		} catch (ItemException ie) {
			catched = true;
		}
		assertTrue(catched);
	...
	public void testGetTypeEvent() throws ClassNotFoundException, SQLException {
		...
		assertTrue(incaPrelevementExport.getTypeEvent(con, p)
												.equals("3 : METASTASE"));
