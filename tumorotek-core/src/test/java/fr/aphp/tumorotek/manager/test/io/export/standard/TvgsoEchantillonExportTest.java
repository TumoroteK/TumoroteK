...
public class TvgsoEchantillonExportTest extends AbstractManagerTest {
	...
	public void testGetModePreparation() 
		...
		assertTrue(tvgsoEchantillonExport
							.getModePreparation(con, e).equals(""));
		e.setEchantillonId(30346);	
		assertTrue(tvgsoEchantillonExport
							.getModePreparation(con, e).equals("1"));
		e.setEchantillonId(17870);	
		assertTrue(tvgsoEchantillonExport
							.getModePreparation(con, e).equals("3"));

		ModePrepa mode = new ModePrepa();
		mode.setNom("7 : new");
		e.setModePrepa(mode);
		assertTrue(tvgsoEchantillonExport
							.getModePreparation(con, e).equals("9"));	
	}
	...
	public void testgetRessourceBiolAssociee() {
		...
		assertTrue(tvgsoEchantillonExport
				.getRessourceBiolAssociee(e, "CELLULES").equals("1"));
		assertTrue(tvgsoEchantillonExport
	...
	public void testGetADNconstitutionnel() 
		...
		assertTrue(tvgsoEchantillonExport
				.getADNconstitutionnel(con, e).equals("1"));
		e.setEchantillonId(12911);
		assertTrue(tvgsoEchantillonExport
				.getADNconstitutionnel(con, e).equals("N"));
		e.setEchantillonId(1000);
		assertTrue(tvgsoEchantillonExport
				.getADNconstitutionnel(con, e).equals(""));
	}
}