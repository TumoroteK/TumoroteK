...
public class CessionTypeManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		CessionType ct1 = cessionTypeManager.findByIdManager(1);
		assertNotNull(ct1);
		assertTrue(ct1.getType().equals("Sanitaire"));
		
		CessionType ctNull = cessionTypeManager.findByIdManager(10);
		assertNull(ctNull);
	}
	...
	public void testFindAll() {
		List<CessionType> list = cessionTypeManager.findAllObjectsManager();
	...
	public void testFindByTypeLikeExactManager() {
		List<CessionType> list = 
			cessionTypeManager.findByTypeLikeManager("SANITAIRE", true);
	...
	public void testFindByTypeLikeManager() {
		List<CessionType> list = 
			cessionTypeManager.findByTypeLikeManager("SANITAIRE", false);
		assertTrue(list.size() == 1);
