...
public class InjectionManagerTest extends AbstractManagerTest4
{
   ...
   public void testDaveDossierAndChildrenManager() throws ParseException{
      ...
      valeursPatientParent.add(nomVal);
      valeursPatientParent.add(prenomVal);
      valeursPatientParent.add(sexeVal);
      valeursPatientParent.add(dateNVal);
      ...
      valeursPrelParent.add(codePrel);
      valeursPrelParent.add(natPrel);
      ...
      valeursDer1.add(codeDer1);
      valeursDer1.add(typeDer1);
      valeursDer1.add(concDer1);
      valeursDer1.add(concUDer1);
      ...
      valeursDer2.add(codeDer2);
      valeursDer2.add(typeDer2);
      ...
      Prelevement newPrel = prelevementManager.findByCodeLikeManager("NEW_PREL_PARENT_001", true).get(0);
      ...
      // 1 seule transfo
      assertTrue(derive1.getTransformation().getTransformationId().equals(derive1.getTransformation().getTransformationId()));
   ...
   public void testSynchronizeDeriveChildrenManager(){
      ...
      valeursDer3.add(codeDer3);
      valeursDer3.add(typeDer3);
      ...
      ProdDerive derive4 = prodDeriveManager.findByCodeLikeManager("NEW_DERIVE_004", true).get(0);
      ...
      // 1 seule transfo
      assertTrue(derive2.getTransformation().getTransformationId().equals(derive4.getTransformation().getTransformationId()));

      // 2 operation synchro
      assertTrue(getOperationManager()
         .findByObjetIdEntiteAndOpeTypeManager(prelevementManager.findByIdManager(1), operationTypeDao.findById(19)).size() == 1); // sync
      assertTrue(getOperationManager()
         .findByObjetIdEntiteAndOpeTypeManager(prelevementManager.findByIdManager(2), operationTypeDao.findById(19)).size() == 1); // sync
      ...
      getOperationManager().removeObjectManager(getOperationManager()
         .findByObjetIdEntiteAndOpeTypeManager(prelevementManager.findByIdManager(1), operationTypeDao.findById(19)).get(0)); // sync
      getOperationManager().removeObjectManager(getOperationManager()
         .findByObjetIdEntiteAndOpeTypeManager(prelevementManager.findByIdManager(2), operationTypeDao.findById(19)).get(0)); // sync
