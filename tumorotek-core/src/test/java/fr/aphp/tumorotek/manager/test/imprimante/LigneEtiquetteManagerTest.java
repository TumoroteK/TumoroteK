...
public class LigneEtiquetteManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByModeleManager(){
      final Modele m2 = modeleDao.findById(2).orElse(null);
   ...
   private void createObjectManager() throws ParseException{
      ...
      final Modele m3 = modeleDao.findById(3).orElse(null);
      ...
      try{
         ligneEtiquetteManager.createObjectManager(le1, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
   ...
   private void updateObjectManager() throws ParseException{
      ...
      try{
         ligneEtiquetteManager.updateObjectManager(leUp, null, champs, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      ligneEtiquetteManager.updateObjectManager(leUp, m3, champs, champsToRemove);
      assertTrue(ligneEtiquetteManager.findAllObjectsManager().size() == 8);
      assertTrue(champLigneEtiquetteManager.findAllObjectsManager().size() == 12);
      assertTrue(champManager.findAllObjectsManager().size() == cTots + 2);
