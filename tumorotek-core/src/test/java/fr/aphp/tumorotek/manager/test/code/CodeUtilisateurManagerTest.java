...
public class CodeUtilisateurManagerTest extends AbstractManagerTest4
{
   ...
   public void testGetTranscodesManager(){
      final CodeDossier dos = codeDossierDao.findById(1);
      ...
      final TableCodage adicap = tableCodageDao.findById(1);
      final TableCodage cim = tableCodageDao.findById(2);
      tables.add(adicap);
      tables.add(cim);
   ...
   private void createObjectManagerTest(){
      ...
      final CodeUtilisateur u1 = codeUtilisateurDao.findById(1);
      ...
      assertTrue(codeUtilisateurManager.getTranscodesManager(code, tableCodageDao.findAll()).size() == 4);
   ...
   private void updateObjectManagerTest(){
      ...
      // Transcodes
      final Set<CodeCommon> codes = codeUtilisateurManager.getTranscodesManager(c, tableCodageDao.findAll());
      final CodeUtilisateur a3 = codeUtilisateurDao.findById(3);
      ...
      assertTrue(codeUtilisateurManager.findByCodeDossierManager(codeDossierDao.findById(1)).size() == 1);
      ...
      assertTrue(codeUtilisateurManager.getTranscodesManager(c, tableCodageDao.findAll()).size() == 1);

      assertTrue(a3.equals(codeUtilisateurManager.getTranscodesManager(c, tableCodageDao.findAll()).iterator().next()));
