...
public class IncaSpecifiqueExportTest extends AbstractManagerTest {
	...
	public void setIncaSpecifiqueExport(IncaSpecifiqueExport iE) {
		this.incaSpecifiqueExport = iE;
	}

	public void testGetQuestAntTabac() 
		...
		Banque b = new Banque();
		b.setBanqueId(1);
		assertTrue(incaSpecifiqueExport
						.getQuestAntTabac(con, p, b).equals(""));
	}
	
	public void testGetQuestFamilial() 
						throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		b.setBanqueId(1);
		assertTrue(incaSpecifiqueExport
				.getQuestFamilial(con, p, b).equals(""));
	}
	
	public void testGetQuestPro() 
						throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		b.setBanqueId(1);
		assertTrue(incaSpecifiqueExport
				.getQuestPro(con, p, b).equals(""));
	}
	
	public void testGetRadioNaif() 
						throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
	...
	public void testGetStatutTabac() 
					throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		b.setBanqueId(1);
		assertTrue(incaSpecifiqueExport
				.getStatutTabac(con, p, b).equals(""));
	}
	
	public void testGetNPA() 
					throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
