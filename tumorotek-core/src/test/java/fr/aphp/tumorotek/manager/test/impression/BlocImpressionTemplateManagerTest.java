...
public class BlocImpressionTemplateManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByIdManager(){
      final Template t1 = templateDao.findById(1).orElse(null);
      final Template t2 = templateDao.findById(2).orElse(null);
      final BlocImpression b1 = blocImpressionDao.findById(1).orElse(null);
   ...
   public void testFindDoublonManager(){
      ...
      final Template t2 = templateDao.findById(2).orElse(null);
      final BlocImpression b1 = blocImpressionDao.findById(1).orElse(null);
      final BlocImpression b6 = blocImpressionDao.findById(6).orElse(null);
   ...
   public void testCrud(){
      final Template t1 = templateDao.findById(1).orElse(null);
      final BlocImpression b1 = blocImpressionDao.findById(1).orElse(null);
      final BlocImpression b4 = blocImpressionDao.findById(4).orElse(null);
      ...
      // test maj
      try{
         blocImpressionTemplateManager.updateObjectManager(bitTest, t1, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         blocImpressionTemplateManager.updateObjectManager(bitTest, null, b1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // maj valide
      bitTest.setOrdre(10);
      blocImpressionTemplateManager.updateObjectManager(bitTest, bitTest.getTemplate(), bitTest.getBlocImpression());
