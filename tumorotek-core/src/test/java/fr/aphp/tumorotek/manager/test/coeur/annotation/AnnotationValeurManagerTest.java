...
public class AnnotationValeurManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByChampAndObjetManager(){
      ChampAnnotation c = champAnnotationDao.findById(1).orElse(null);
      ...
      c = champAnnotationDao.findById(4).orElse(null);
   ...
   public void testFindByTableAndBanqueManager(){
      TableAnnotation t = tableAnnotationDao.findById(3).orElse(null);
      ...
      t = tableAnnotationDao.findById(1).orElse(null);
      valeurs = annotationValeurManager.findByTableAndBanqueManager(t, b);
      assertTrue(valeurs.size() == 0);
   ...
   public void testFindByObjectManager(){
      List<AnnotationValeur> vals = annotationValeurManager.findByObjectManager(echantillonDao.findById(1)).orElse(null);
      assertTrue(vals.size() == 6);

      vals = annotationValeurManager.findByObjectManager(patientDao.findById(1)).orElse(null);
      assertTrue(vals.size() == 1);

      vals = annotationValeurManager.findByObjectManager(echantillonDao.findById(3)).orElse(null);
   ...
   public void testFindDoublonManager(){
      //Cree le doublon
      final AnnotationValeur av1 = annotationValeurDao.findById(8).orElse(null);
   ...
   public void createObjectManagerTest(){
      ...
      final Prelevement prel = prelevementDao.findById(1).orElse(null);
   ...
   public void testAnnotationCommonValidation() throws ParseException{
      ...
      ChampAnnotation chp = champAnnotationDao.findById(1).orElse(null);
      ...
      // champAnnotation num
      chp = champAnnotationDao.findById(7).orElse(null);
      v.setChampAnnotation(chp);
      v.setAlphanum("a");
      try{
         BeanValidator.validateObject(v, new Validator[] {annotationCommonValidator});
      ...
      chp = champAnnotationDao.findById(15).orElse(null);
      v.setChampAnnotation(chp);
      ...
      chp = champAnnotationDao.findById(12).orElse(null);
      v.setChampAnnotation(chp);
      v.setAlphanum("##");
      BeanValidator.validateObject(v, new Validator[] {annotationCommonValidator});
   }
   ...
   public void testRemoveValeurWithBanqueRelation(){
      ...
      final ChampAnnotation alpha = champAnnotationDao.findById(1).orElse(null);
      final ChampAnnotation file1 = champAnnotationDao.findById(13).orElse(null);
      final Patient p1 = patientDao.findById(1).orElse(null);
   ...
   public void testStoreFileAnno(){
      final AnnotationValeur valeur = new AnnotationValeur();
      final Patient pat = patientDao.findById(2).orElse(null);
      final ChampAnnotation c = champAnnotationDao.findById(13).orElse(null);
      final Banque b = banqueDao.findById(1).orElse(null);
      final Utilisateur u = utilisateurDao.findById(2).orElse(null);

      final Integer totFichier = IterableUtils.toList(fichierDao.findAll()).size();
      ...
      assertTrue(fichierDao.findById(f.getFichierId()).getNom().equals("fichierTest")).orElse(null);
      ...
      annotationValeurManager.createOrUpdateObjectManager(valeur, c, pat, b, f, u, "modification", "/tmp/", filesCreated,
         filesToDelete);
      assertTrue(fichierDao.findById(f.getFichierId()).getNom().equals("heroes")).orElse(null);
      assertTrue(IterableUtils.toList(fichierDao.findAll()).size() == totFichier + 1);
   ...
   public void testCreateAnnotationValeurListManager(){
      ...
      final Echantillon obj = echantillonDao.findById(4).orElse(null);
      final Banque b = banqueDao.findById(1).orElse(null);
      ...
      bool2.setChampAnnotation(champAnnotationDao.findById(4)).orElse(null);
      bool2.setBool(true);
      bool2.setBanque(b);
      valeurs.add(bool2);
      ...
      thes1.setChampAnnotation(champAnnotationDao.findById(12)).orElse(null);
      thes1.setItem(itemDao.findById(4)).orElse(null);
      thes1.setBanque(b);
      valeurs.add(thes1);
      ...
      //				.findByChampAndObjetManager(champAnnotationDao.findById(4), obj).orElse(null)
      //														.get(0);
      //		boolUp.setBool(false);
      //		AnnotationValeur numUp = annotationValeurManager
      //		.findByChampAndObjetManager(champAnnotationDao.findById(7), obj).orElse(null)
      //												.get(0);
      ...
      annotationValeurManager.createAnnotationValeurListManager(valeurs, obj, u, "modification", "/tmp/", filesCreated,
         filesToDelete);
      assertTrue(annotationValeurManager.findAllObjectsManager().size() == 15);
      assertFalse(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(4), obj).get(0).getBool()).orElse(null);
      assertFalse(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), obj).get(0).getAlphanum().orElse(null)
         .equals("13.0"));
      assertTrue(filesCreated.isEmpty());
      assertTrue(filesToDelete.isEmpty());
      ...
      //			.findByChampAndObjetManager(champAnnotationDao.findById(12), obj).orElse(null)
      //				.get(0));
      valeurs.add(thes1);
   ...
   public void testPrepareAnnotationValeurListJDBCManager() throws SQLException{
      ...
      try{
         ...
         texte1.setChampAnnotation(champAnnotationDao.findById(9)).orElse(null);
         texte1.setTexte("bob l'éponge le film");
         texte1.setBanque(b);
         valeurs.add(texte1);
         final AnnotationValeur date1 = new AnnotationValeur();
         date1.setChampAnnotation(champAnnotationDao.findById(5)).orElse(null);
         ...
         date1.setChampAnnotation(champAnnotationDao.findById(6)).orElse(null);
         // creation réussie
         annotationValeurManager.prepareAnnotationValeurListJDBCManager(suite, valeurs, obj, u);
         ...
         final AnnotationValeur av1 =
            annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(4), obj).get(0).orElse(null);
         ...
         final AnnotationValeur av2 =
            annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), obj).get(0).orElse(null);
         ...
         final AnnotationValeur av3 =
            annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(12), obj).get(0).orElse(null);
         assertTrue(av3.getItem().equals(itemDao.findById(4))).orElse(null);
         ...
         final AnnotationValeur av4 =
            annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(9), obj).get(0).orElse(null);
         ...
         final AnnotationValeur av5 =
            annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(6), obj).get(0).orElse(null);
   ...
   public void testCreateFileBatchForTKObjectsManager(){
      ...
      objs.add(patientDao.findById(2)).orElse(null);
      objs.add(patientDao.findById(1)).orElse(null);
      objs.add(patientDao.findById(3)).orElse(null);
      final ChampAnnotation c = champAnnotationDao.findById(13).orElse(null);
      final Banque b = banqueDao.findById(1).orElse(null);
      final Utilisateur u = utilisateurDao.findById(2).orElse(null);

      final Integer totFichier = IterableUtils.toList(fichierDao.findAll()).size();
      final Integer totValeurs = IterableUtils.toList(annotationValeurDao.findAll()).size();
      ...
      assertTrue(filesCreated.size() == 1);
      assertTrue(IterableUtils.toList(fichierDao.findAll()).size() == totFichier + 3);
      assertTrue(IterableUtils.toList(annotationValeurDao.findAll()).size() == totValeurs + 3);
      assertTrue(baseDir.listFiles().length == 1);

      final Fichier f1 = annotationValeurManager.findByChampAndObjetManager(c, patientDao.findById(1)).get(0).getFichier().orElse(null);
      final Fichier f2 = annotationValeurManager.findByChampAndObjetManager(c, patientDao.findById(2)).get(0).getFichier().orElse(null);
      final Fichier f3 = annotationValeurManager.findByChampAndObjetManager(c, patientDao.findById(3)).get(0).getFichier().orElse(null);
      ...
      annotationValeurManager
         .removeObjectManager(annotationValeurManager.findByChampAndObjetManager(c, patientDao.findById(1)).get(0), null).orElse(null);
      ...
      annotationValeurManager
         .removeObjectManager(annotationValeurManager.findByChampAndObjetManager(c, patientDao.findById(2)).get(0), null).orElse(null);
      assertTrue(IterableUtils.toList(fichierDao.findAll()).size() == totFichier + 1);
      ...
      annotationValeurManager
         .removeObjectManager(annotationValeurManager.findByChampAndObjetManager(c, patientDao.findById(3)).get(0), null).orElse(null);
      assertTrue(IterableUtils.toList(fichierDao.findAll()).size() == totFichier);
      assertTrue(IterableUtils.toList(annotationValeurDao.findAll()).size() == totValeurs);
      assertTrue(baseDir.listFiles().length == 0);
