...
//    }
	...
	public void testFindById() {
		Emetteur m = emetteurManager.findByIdManager(1);
		assertNotNull(m);
		
		Emetteur mNull = emetteurManager.findByIdManager(100);
		assertNull(mNull);
	}

	@Test
	public void testFindAll() {
		List<Emetteur> list = emetteurManager
	...
	public void testFindByIdentificationAndServiceManager() {
		List<Emetteur> liste = emetteurManager
			.findByIdentificationAndServiceManager("Apix Anapath", "ANAP");
		assertTrue(liste.size() == 1);
		
		liste = emetteurManager.findByIdentificationAndServiceManager(
				"Apix", "ANAP");
