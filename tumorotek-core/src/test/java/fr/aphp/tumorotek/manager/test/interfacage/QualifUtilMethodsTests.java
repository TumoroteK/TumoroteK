...
public class QualifUtilMethodsTests extends AbstractManagerTest4
{
   ...
   public void testParseInterfacageXmlFile2() throws Exception{
      ...
      // changer ICI 
      final String folder = "/home/mathieu/partageXP/diamic-qulif/";
...
//      final InputStream input = null;
      try{
         ...
         final String str = lireDonnees("DIAMIC/000000044_S1500030.hl7");

         // changer ICI
         final DossierExterne dossier =
            interfacageParsingUtils.parseInterfacageXmlFile(folder + "diamic-mapping2.xml", str, e1, false, 100);

         StringBuilder bld;
         for(final BlocExterne bloc : blocExterneManager.findByDossierExterneManager(dossier)){
            System.out.println("--");
            for(final ValeurExterne val : valeurExterneManager.findByBlocExterneManager(bloc)){
