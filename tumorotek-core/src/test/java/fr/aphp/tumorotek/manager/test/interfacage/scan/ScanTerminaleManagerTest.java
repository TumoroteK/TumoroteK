...
public class ScanTerminaleManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindTKObjectCodesManager(){
      ...
      sT.setScanDevice(scanDeviceDao.findById(1)).orElse(null);
      ...
      scanTerminaleManager.createObjectManager(sT, scanDeviceDao.findById(1)).orElse(null);
   ...
   public void testFindEmplacementsToFillManager(){
      ...
      final List<Conteneur> conts = IterableUtils.toList(conteneurDao.findAll());
