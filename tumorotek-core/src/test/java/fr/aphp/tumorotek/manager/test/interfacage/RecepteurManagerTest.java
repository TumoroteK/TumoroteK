...
public class RecepteurManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindById(){
      final Recepteur m = recepteurManager.findByIdManager(1);
      assertNotNull(m);

      final Recepteur mNull = recepteurManager.findByIdManager(100);
      assertNull(mNull);
   }

   @Test
   public void testFindAll(){
      final List<Recepteur> list = recepteurManager.findAllObjectsManager();
