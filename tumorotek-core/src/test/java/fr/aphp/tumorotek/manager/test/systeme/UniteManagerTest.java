...
public class UniteManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		Unite unite = uniteManager.findByIdManager(1);
		assertNotNull(unite);
		assertTrue(unite.getUnite().equals("FRAGMENTS"));
		
		Unite uniteNull = uniteManager.findByIdManager(25);
	...
	public void testFindAll() {
		List<Unite> list = uniteManager.findAllObjectsManager();
	...
	public void testIsUsed() {
		Unite unite1 = uniteManager.findByIdManager(1);
		assertNotNull(unite1);
		assertTrue(uniteManager.isUsedObjectManager(unite1));
		
		Unite unite2 = uniteManager.findByIdManager(3);
	...
	public void testCrud() {
		...
		String[] uniteValues = new String[]{"", "  ", null, "hf¤u_$$|(", 
				createOverLength(30), "GOOD"};
		String[] typeValues = new String[]{"", " ", null, "*/$$¤..ç=", 
		...
		Unite unite2 = uniteManager.findByIdManager(15);
		String typeUpdated1 = "volume";
		String typeUpdated2 = "discret";
		...
		uniteManager.updateObjectManager(unite2);
		Unite unite3 = uniteManager.findByIdManager(15);
		assertTrue(unite3.getType().equals(typeUpdated1));
		
		// Test de la suppression
		Unite unite4 = uniteManager.findByIdManager(15);
		...
		Unite unite5 = uniteManager.findByIdManager(1);
