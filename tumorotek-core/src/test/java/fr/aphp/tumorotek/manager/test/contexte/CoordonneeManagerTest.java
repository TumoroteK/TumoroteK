...
public class CoordonneeManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		Coordonnee coord = coordonneeManager.findByIdManager(1);
		assertNotNull(coord);
		assertTrue(coord.getVille().equals("PARIS"));
		
		Coordonnee coordNull = coordonneeManager.findByIdManager(10);
	...
	public void testFindAll() {
		List<Coordonnee> list = coordonneeManager.findAllObjectsManager();
	...
	public void testGetCollaborateursManager() {
		...
		Set<Collaborateur> list = 
			coordonneeManager.getCollaborateursManager(coord1);
		assertTrue(list.size() == 3);
		
		Coordonnee coord2 = coordonneeManager.findByIdManager(4);
	...
	public void testFindDoublon() {
		...
		assertTrue(coordonneeManager.findDoublonForCollaborateurManager(
				newCoord, collab));
		
		newCoord.setAdresse(null);
		assertFalse(coordonneeManager.findDoublonForCollaborateurManager(
				newCoord, collab));
	...
	public void testFindDoublonInList() {
		List<Coordonnee> list = new ArrayList<Coordonnee>();
	...
	public void testIsUsedByOtherObjectManager() {
		...
		Collaborateur collab = collaborateurManager.findByIdManager(6);
		Coordonnee coord1 = coordonneeManager.findByIdManager(1);
		Coordonnee coord4 = coordonneeManager.findByIdManager(4);
		Coordonnee coord5 = coordonneeManager.findByIdManager(5);
		
		assertTrue(coordonneeManager.isUsedByOtherObjectManager(
				coord1, collab));
		assertTrue(coordonneeManager.isUsedByOtherObjectManager(
				coord4, collab));
		assertFalse(coordonneeManager.isUsedByOtherObjectManager(
				coord5, collab));
	...
	public void testCrud() {
		...
		Collaborateur collab2 = collaborateurManager.findByIdManager(2);
		Collaborateur collab3 = collaborateurManager.findByIdManager(3);
		...
		int id1 = coord1.getCoordonneeId();
		assertTrue(coord1.getCoordonneeId() == id1);
		
		// on teste une insertion valide avec les associations 
		// non obigatoires remplies
		Coordonnee coord2 = new Coordonnee();
		...
		assertTrue(coordonneeManager
				.getCollaborateursManager(testInsert).size() == 2);
		
		// Suppression
		Coordonnee coord3 = coordonneeManager.findByIdManager(id1);
		coordonneeManager.removeObjectManager(coord3);
		Coordonnee coord4 = coordonneeManager.findByIdManager(id2);
		coordonneeManager.removeObjectManager(coord4);
		
		
		// Update
		Coordonnee coord5 = new Coordonnee();
		coord5.setAdresse("TEST");
		coordonneeManager.createObjectManager(coord5, null);
		int id = coord5.getCoordonneeId();
		assertTrue(coord5.getCoordonneeId() == id);
		
		// On test la validation lors d'un update
		Coordonnee coord7 = coordonneeManager.findByIdManager(id);
		...
		Coordonnee coord8 = coordonneeManager.findByIdManager(id);
		assertTrue(coord8.getAdresse().equals("         "));
		
		// On teste une mise à jour valide avec les assos et validation
		Coordonnee coord9 = coordonneeManager.findByIdManager(id);
		...
		// On vérifie que toutes associations ont étées enregistrées
		Coordonnee testInsert2 = coordonneeManager.findByIdManager(id);
		// On test les attributs
		...
		Coordonnee coord11 = coordonneeManager.findByIdManager(id);
	 ...
	 */
	private void validationInsert(Coordonnee coordonnee) {
		
		boolean catchedInsert = false;
		String[] adresseValues = new String[]{"", "  ", 
				createOverLength(250), "GOOD"};
		String[] cpValues = new String[]{"", " ", "%*$$€kj¤¤s", 
				createOverLength(10), "GOOD"};
		String[] villeValues = new String[]{"", " ", "%€$*¤¤k", 
				createOverLength(20), "GOOD"};
		String[] paysValues = new String[]{"", "  ", "l#$$jd¤¤%", 
				createOverLength(20), "GOOD"};
		String[] telValues = new String[]{"", " ", "%*k$$js¤¤", 
				createOverLength(15), "GOOD"};
		String[] faxValues = new String[]{"", " ", "%*€$k¤¤", 
				createOverLength(15), "GOOD"};
		String[] mailValues = new String[]{"", " ", "%*€$k¤¤", 
	 ...
	 * @param coordonnee Coordonnee à tester.
	 */
	private void validationUpdate(Coordonnee coordonnee) {
		
		boolean catchedInsert = false;
		String[] adresseValues = new String[]{"", "  ", 
				createOverLength(250), "GOOD"};
		String[] cpValues = new String[]{"", " ", "%*k$$j¤s", 
				createOverLength(10), "GOOD"};
		String[] villeValues = new String[]{"", " ", "%$€*¤k", 
				createOverLength(20), "GOOD"};
		String[] paysValues = new String[]{"", "  ", "l#$€j¤¤d%", 
				createOverLength(20), "GOOD"};
		String[] telValues = new String[]{"", " ", "%*ke$$j¤s", 
				createOverLength(15), "GOOD"};
		String[] faxValues = new String[]{"", " ", "%€€k¤", 
				createOverLength(15), "GOOD"};
		String[] mailValues = new String[]{"", " ", "%*$€¤k", 
