...
public class TvgsoPrelevementExportTest extends AbstractManagerTest {
	...
	public void setTvgsoPrelevementExport(TvgsoPrelevementExport iP) {
		this.tvgsoPrelevementExport = iP;
	}


	public void testGetCentreStockage() 
		...
		assertTrue(tvgsoPrelevementExport.getCentreStockage(con, echan)
												.equals("7TGSOCHUTLS"));
	...
	public void testGetDatePrelevement() throws ParseException {
		...
		DateFormat dateFormatterINCA = new SimpleDateFormat("dd/MM/yyyy");
		
		assertTrue(tvgsoPrelevementExport.getDatePrelevement(p,
				dateFormatterINCA).equals("11/09/2011"));
		
		p.setDatePrelevement(null);
		assertTrue(tvgsoPrelevementExport.getDatePrelevement(p, null)
												.equals(""));
	...
	public void testGetModePrelevement() {
		...
		boolean catched = false;
		try {
			assertTrue(tvgsoPrelevementExport
						.getModePrelevement(p).equals("c"));
		} catch (ItemException ie) {
			catched = true;
			assertTrue(ie.getSeverity() == 2);
		}
		assertTrue(catched);
		PrelevementType pType = new PrelevementType();
	...
	public void testGetCodeOrgane() 
		...
		assertTrue(tvgsoPrelevementExport
				.getCodeOrgane(con, e).equals("LM"));
		e.setEchantillonId(113);
		assertTrue(tvgsoPrelevementExport
				.getCodeOrgane(con, e).equals("FF"));
		e.setEchantillonId(3658);
		assertTrue(tvgsoPrelevementExport
					.getCodeOrgane(con, e).equals(""));
	}
	...
	public void getTypeLesionnel() throws ClassNotFoundException, SQLException {
		...
		assertTrue(tvgsoPrelevementExport.getTypeLesionnel(con, e)
														.equals("OKDCA7A0"));
		...
		assertTrue(tvgsoPrelevementExport
					.getTypeLesionnel(con, e).equals(""));
	}
	
	public void testGetVersionPTNM() 
	throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
	...
	public void testGetTailleTumeurPT() 
	throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		assertTrue(tvgsoPrelevementExport
						.getTailleTumeurPT(con, p).equals("2"));
		p.setPrelevementId(15377);
		assertTrue(tvgsoPrelevementExport
				.getTailleTumeurPT(con, p).equals("4b"));
		p.setPrelevementId(14866);
		assertTrue(tvgsoPrelevementExport
				.getTailleTumeurPT(con, p).equals("is"));
		p.setPrelevementId(11416);
		assertTrue(tvgsoPrelevementExport
						.getTailleTumeurPT(con, p).equals(""));	
	}
	...
	public void testGetExtMeta() throws ClassNotFoundException, SQLException {
		...
		assertTrue(tvgsoPrelevementExport
				.getExtMetastaticPM(con, p).equals("0"));
		p.setPrelevementId(5881);
		assertTrue(tvgsoPrelevementExport
				.getExtMetastaticPM(con, p).equals("X"));
		p.setPrelevementId(9189);
		assertTrue(tvgsoPrelevementExport
							.getExtMetastaticPM(con, p).equals(""));
	}
