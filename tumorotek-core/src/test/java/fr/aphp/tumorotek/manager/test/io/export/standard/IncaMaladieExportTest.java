...
public class IncaMaladieExportTest extends AbstractManagerTest {
	...
	public void setIncaMaladieExport(IncaMaladieExport iE) {
	...
	public void testGetDiagnosticPrincipal() 
		...
		assertTrue(incaMaladieExport.getDiagnosticPrincipal(con, prel, true)
															.equals("C50.9"));
		
		boolean catched = false;
		try {
			assertTrue(incaMaladieExport
					.getDiagnosticPrincipal(con, prel, false)
					.equals(""));
		...
		try {
			assertTrue(incaMaladieExport
				.getDiagnosticPrincipal(con, prel, false).equals(""));
		} catch (ItemException ie) {
			catched = true;
		}
		assertTrue(catched);
		...
		assertTrue(incaMaladieExport.getDiagnosticPrincipal(con, prel, true)
															.equals("ZZ.2"));
		assertTrue(incaMaladieExport.getDiagnosticPrincipal(con, prel, false)
				.equals("ZZ.2"));
	...
	public void testGetDateDiag() 
		...
		assertTrue(incaMaladieExport.getDateDiag(con, prel, true, 
				dateFormatterINCA).equals("30/04/2010"));
		
		assertTrue(incaMaladieExport.getDateDiag(con, prel, false, 
				dateFormatterINCA).equals(""));
		...
		assertTrue(incaMaladieExport.getDateDiag(con, prel, true, 
				dateFormatterINCA).equals("12/12/1212"));
		assertTrue(incaMaladieExport.getDateDiag(con, prel, false, 
				dateFormatterINCA).equals("12/12/1212"));
	...
	public void testGetVersionCTNM() 
		throws SQLException, ClassNotFoundException {
	...
	public void testGetTailleTumeur() 
							throws SQLException, ClassNotFoundException {
	...
	public void testGetExtMetastatique() 
						throws SQLException, ClassNotFoundException {
