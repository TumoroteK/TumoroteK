...
public class TableAnnotationManagerTest extends AbstractManagerTest4
{
   ...
   private void createObjectManagerTest(){
      ...
      c1.setDataType(dataTypeDao.findById(1)).orElse(null);
      c1.setOrdre(1);
      //c1.setTableAnnotation(table);
      final ChampAnnotation c2 = new ChampAnnotation();
      c2.setNom("thes_table_test¢¢¢€}}");
      c2.setDataType(dataTypeDao.findById(7)).orElse(null);
      c2.setOrdre(2);
      ...
      //required Entite
      try{
         tableAnnotationManager.createOrUpdateObjectManager(table, null, null, null, banks, null, u, "creation", null, null);
      }catch(final RequiredObjectIsNullException re){
         assertTrue(true);
      }
      //operation invalide
      try{
         tableAnnotationManager.createOrUpdateObjectManager(table, e, null, null, banks, null, u, null, null, null);
      }catch(final NullPointerException ne){
         assertTrue(ne.getMessage().equals("operation cannot be " + "set to null for createorUpdateMethod"));
      }
      try{
         tableAnnotationManager.createOrUpdateObjectManager(table, e, null, null, banks, null, u, "", null, null);
      }catch(final IllegalArgumentException ie){
         assertTrue(ie.getMessage().equals("Operation must match " + "'creation/modification' values"));
      }
      // champs invalide -> rollback
      try{
         tableAnnotationManager.createOrUpdateObjectManager(table, e, null, champs, banks, null, u, "creation", null, null);
      ...
      c2.setNom("thes_table_test");
      tableAnnotationManager.createOrUpdateObjectManager(table, e, null, champs, banks, null, u, "creation", "/tmp/", pf2);
      ...
      assertTrue(tableAnnotationBanqueDao.findById(new TableAnnotationBanquePK(b2, table)).getOrdre().equals(1)).orElse(null);
      ...
      try{
         tableAnnotationManager.createOrUpdateObjectManager(t2, null, null, null, null, null, u, "creation", null, pf2);
   ...
   private void updateObjectManagerTest(){
      ...
      // Catalogue c = catalogueDao.findById(1).orElse(null);
      // references vers banques
      final Banque b1 = banqueDao.findById(1).orElse(null);
      ...
      c3.setDataType(dataTypeDao.findById(5)).orElse(null);
      c3.setOrdre(3);
      ...
      //champs.remove(1);
      try{
         tableAnnotationManager.createOrUpdateObjectManager(t, null, null, champs, null, null, u, "modification", null, null);
      ...
      c1.setNom("alpha2_table_test");
      c1.setAnnotationDefauts(defauts);
      tableAnnotationManager.createOrUpdateObjectManager(t, null, null, champs, banks, null, u, "modification", null, null);
      ...
      assertTrue((tableAnnotationManager.getBanquesManager(t)).size() == 3);
      assertTrue(tableAnnotationBanqueDao.findById(new TableAnnotationBanquePK(b1, t)).getOrdre().equals(1)).orElse(null);
      ...
      assertTrue(getOperationManager().findByObjetIdEntiteAndOpeTypeManager(t, operationTypeDao.findByNom("Modification").get(0))
         .size() == 1);
      tableAnnotationManager.createOrUpdateObjectManager(t, null, null, null, null, null, u, "modification", null, null);
      assertTrue(tableAnnotationManager.getBanquesManager(t).size() == 3);
      tableAnnotationManager.createOrUpdateObjectManager(t, null, null, null, new ArrayList<Banque>(), null, u, "modification",
         null, null);
      assertTrue(tableAnnotationManager.getBanquesManager(t).size() == 0);
      // pour tester la cascade plus loin lors du testRemove
      tableAnnotationManager.createOrUpdateObjectManager(t, null, null, null, banks, null, u, "modification", null, null);
      assertTrue(tableAnnotationManager.getBanquesManager(t).size() == 3);
      ...
      try{
         ...
         t.setPlateforme(plateformeDao.findById(1)).orElse(null);
         tableAnnotationManager.createOrUpdateObjectManager(t, e, null, null, null, null, u, "modification", null, null);
      }catch(final DoublonFoundException e){
         catched = true;
      }
      assertTrue(catched);
      assertTrue(tableAnnotationManager.findByNomLikeManager("INCA_ECHAN1", true).size() == 1);
      t.setPlateforme(plateformeDao.findById(2)).orElse(null);
   ...
   private void updateObjectwWithThesaurusChampManagerTest(){
      ...
      final ChampAnnotation c3 = new ChampAnnotation();
      c3.setNom("thes_test");
      c3.setDataType(dataTypeDao.findById(6)).orElse(null);
      c3.setOrdre(4);
      c3.setTableAnnotation(t);
      final List<ChampAnnotation> champs = new ArrayList<>();
      champs.add(c3);
   ...
   //		Banque b3 = banqueDao.findById(3).orElse(null);
   //		Banque b4 = banqueDao.findById(4).orElse(null);
   //		// verifie l'ordre
   ...
   private void removeObjectManagerTest(){
      ...
      tableAnnotationManager.removeObjectManager(t, null, utilisateurDao.findById(1), "/tmp/").orElse(null);
      ...
      assertNull(tableAnnotationBanqueDao.findById(new TableAnnotationBanquePK(banqueDao.findById(1), t))).orElse(null);
   ...
   public void testUpdateChampOrdersManager(){
      ...
      final ChampAnnotation c1 = new ChampAnnotation();
      c1.setNom("c1");
      c1.setDataType(dataTypeDao.findById(5)).orElse(null);
      c1.setOrdre(1);
      c1.setTableAnnotation(t);
      final ChampAnnotation c2 = new ChampAnnotation();
      c2.setNom("c2");
      c2.setDataType(dataTypeDao.findById(2)).orElse(null);
      c2.setOrdre(1);
      c2.setTableAnnotation(t);
      final ChampAnnotation c3 = new ChampAnnotation();
      c3.setNom("c3");
      c3.setDataType(dataTypeDao.findById(1)).orElse(null);
      c3.setOrdre(1);
      c3.setTableAnnotation(t);
      final ChampAnnotation c4 = new ChampAnnotation();
      c4.setNom("c4");
      c4.setDataType(dataTypeDao.findById(8)).orElse(null);
      c4.setOrdre(1);
      ...
      try{
         tableAnnotationManager.createOrUpdateObjectManager(t, e, null, champs, banks, null, u, "creation", "zaz", pf2);
      }catch(final RuntimeException re){
         assertTrue(re.getMessage().equals("error.filesystem.access"));
      }
      tableAnnotationManager.createOrUpdateObjectManager(t, e, null, champs, null, null, u, "creation", "/tmp/", pf2);
   ...
   public void testFindByCataloguesManager(){
      final Catalogue c = catalogueDao.findById(1).orElse(null);
   ...
   public void updateObjectwWithThesaurusCatalogue(){
      ...
      final ChampAnnotation c = champAnnotationDao.findById(21).orElse(null);
      ...
      tableAnnotationManager.createOrUpdateObjectManager(t, null, null, champs, null, b1, u, "modification", null, null);
      ...
      tableAnnotationManager.createOrUpdateObjectManager(t, null, null, champs, null, b4, u, "modification", null, null);
   ...
   public void testUpdateTableFichiers() throws IOException{
      ...
      tableAnnotationManager.createOrUpdateObjectManager(t, null, null, null, banks, null, u, "modification", "/tmp/", null);
