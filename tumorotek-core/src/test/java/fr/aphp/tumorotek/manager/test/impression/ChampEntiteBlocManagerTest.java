...
public class ChampEntiteBlocManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindById(){
      final ChampEntite ce1 = champEntiteManager.findByIdManager(2);
      final BlocImpression bi1 = blocImpressionManager.findByIdManager(2);
      final ChampEntiteBlocPK pk = new ChampEntiteBlocPK(bi1, ce1);
      final ChampEntiteBloc ceb = champEntiteBlocManager.findByIdManager(pk);
      assertNotNull(ceb);

      final ChampEntiteBloc cebNull = champEntiteBlocManager.findByIdManager(null);
      assertNull(cebNull);
   }
   ...
   public void testFindAll(){
      final List<ChampEntiteBloc> list = champEntiteBlocManager.findAllObjectsManager();
   ...
   public void testFindByBlocManager(){
      final BlocImpression bi1 = blocImpressionManager.findByIdManager(1);
      List<ChampEntiteBloc> list = champEntiteBlocManager.findByBlocManager(bi1);
      assertTrue(list.size() == 3);

      final BlocImpression bi5 = blocImpressionManager.findByIdManager(5);
