...
public class EchantillonManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindRestantsByPrelevementManager(){
      Prelevement p = prelevementDao.findById(1).orElse(null);
      ...
      p = prelevementDao.findById(2).orElse(null);
   ...
   public void testFindDoublon(){
      ...
      // pf
      echan.setBanque(banqueDao.findById(4)).orElse(null);
      assertFalse(echan.equals(echantillonManager.findByIdManager(1)));
   ...
   public void testCrud(){
      ...
      final Prelevement prelevement = prelevementDao.findById(1).orElse(null);
      ...
      emp.setTerminale(terminaleDao.findById(6)).orElse(null);
      emp.setPosition(3);
      emp.setObjetId(echan1.getEchantillonId());
      emp.setEntite(entiteDao.findById(3)).orElse(null);
      emp.setVide(false);
   ...
   public void testDateStockageCoherence() throws ParseException{
      final Prelevement p = prelevementDao.findById(3).clone().orElse(null);
   ...
   public void testCreateAndUpdateCodesAssignes(){
      ...
      cOrg1.setTableCodage(tableCodageDao.findById(1)).orElse(null);
      cOrg1.setOrdre(1);
      ...
      cLes1.setTableCodage(tableCodageDao.findById(2)).orElse(null);
      cLes1.setOrdre(1);
      ...
      cOrg3.setTableCodage(tableCodageDao.findById(1)).orElse(null);
      cOrg3.setOrdre(1);
      codes2.add(cOrg3);
      ...
      cLes3.setOrdre(1);
      cLes3.setTableCodage(tableCodageDao.findById(2)).orElse(null);
      codes2.add(cLes3);
      try{
   ...
   public void testCreateUpdateEchantillonWithAnnots(){
      ...
      final ChampAnnotation c = champAnnotationDao.findById(7).orElse(null);
      ...
      final ChampAnnotation c2 = champAnnotationDao.findById(4).orElse(null);
   ...
   public void testCascadeEchantillonChildren(){
      ...
      final Entite entite = entiteDao.findById(3).orElse(null);
   ...
   public void testFindByPrelevementManager(){
      ...
      assertTrue(echans.size() == 2);
      p = prelevementDao.findById(4).orElse(null);
   ...
   public void testSwitchBanque(){
      ...
      final Transformation transfo1 = new Transformation();
      transfo1.setObjetId(e.getEchantillonId());
      transformationManager.createObjectManager(transfo1, entiteDao.findById(3), null).orElse(null);
      ProdDerive derive = new ProdDerive();
      derive.setCode("deriveSwitch");
      prodDeriveManager.createObjectManager(derive, b2, prodTypeDao.findById(1), objetStatutManager.findByIdManager(4).orElse(null), null,
      ...
      final Entite entite = entiteDao.findById(3).orElse(null);
      // Unite qteUnite = uniteDao.findById(5).orElse(null);
      ...
      cederObjetManager.createObjectManager(ced2, cession, entiteDao.findById(8), null).orElse(null);
      catched = false;
      try{
         echantillonManager.switchBanqueCascadeManager(e, b4, true, u, null, null);
      }catch(final RuntimeException re){
      ...
      final Terminale t = terminaleDao.findById(1).orElse(null);
      final List<Banque> banques = new ArrayList<>();
      banques.add(b3);
      banques.add(b1);
      ...
      emplacementManager.updateObjectManager(emp, emp.getTerminale(), entiteDao.findById(3)).orElse(null);
      ...
      final List<AnnotationValeur> listAnnots = new ArrayList<>();
      final AnnotationValeur num = new AnnotationValeur();
      num.setChampAnnotation(champAnnotationDao.findById(7)).orElse(null);
      num.setAlphanum("123456");
      num.setBanque(b1);
      listAnnots.add(num);
      final AnnotationValeur link = new AnnotationValeur();
      link.setChampAnnotation(champAnnotationDao.findById(16)).orElse(null);
      link.setAlphanum("http://yahoo.fr");
      link.setBanque(b1);
      listAnnots.add(link);
      final AnnotationValeur thes = new AnnotationValeur();
      thes.setChampAnnotation(champAnnotationDao.findById(40)).orElse(null);
      thes.setItem(itemDao.findById(83)).orElse(null);
      thes.setBanque(b1);
      listAnnots.add(thes);
      echantillonManager.updateObjectManager(e, e.getBanque(), null, null, null, emp, e.getEchantillonType(), null, null, null,
   ...
   public void testUpdateMultipleObjectsManager() throws ParseException, IOException{
      final Banque b1 = banqueManager.findByIdManager(1);
      final Utilisateur utilisateur = utilisateurDao.findById(1).orElse(null);
      final Prelevement p1 = prelevementDao.findById(1).orElse(null);
      ...
      num1.setChampAnnotation(champAnnotationDao.findById(7)).orElse(null);
      num1.setAlphanum("1234");
      listAnnots.add(num1);
      final AnnotationValeur num2 = new AnnotationValeur();
      num2.setChampAnnotation(champAnnotationDao.findById(7)).orElse(null);
      ...
      assertTrue(objetNonConformeDao.findByObjetAndEntite(id1, entiteDao.findById(3)).isEmpty()).orElse(null);
      assertTrue(objetNonConformeDao.findByObjetAndEntite(id2, entiteDao.findById(3)).isEmpty()).orElse(null);
      assertTrue(objetNonConformeDao.findByObjetAndEntite(id3, entiteDao.findById(3)).isEmpty()).orElse(null);
      ...
      list.add(eUp3);
      listAnnots.clear();
      listAnnots.addAll(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), echan1)).orElse(null);
      listAnnots.addAll(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), echan2)).orElse(null);
      final AnnotationValeur num3 = new AnnotationValeur();
      num3.setChampAnnotation(champAnnotationDao.findById(7)).orElse(null);
      ...
      ncfsTrait.add(nonConformiteDao.findById(4)).orElse(null);

      final List<NonConformite> ncfsCess = new ArrayList<>();
      ncfsCess.add(nonConformiteDao.findById(6)).orElse(null);
      ...
      assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), eTest1).get(0).getAlphanum().orElse(null)
         .equals("1111"));
      assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), eTest2).get(0).getAlphanum().orElse(null)
         .equals("2222"));
      assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), eTest3).get(0).getAlphanum().orElse(null)
         .equals("91011"));
      ...
      assertTrue(objetNonConformeDao.findByObjetAndEntite(id1, entiteDao.findById(3)).size() == 2).orElse(null);
      assertTrue(objetNonConformeDao.findByObjetAndEntite(id2, entiteDao.findById(3)).size() == 2).orElse(null);
      assertTrue(objetNonConformeDao.findByObjetAndEntite(id3, entiteDao.findById(3)).size() == 2).orElse(null);
      ...
      assertFalse(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), eTest1).get(0).getAlphanum().orElse(null)
         .equals("0000"));
      ...
      bool4.setBool(true);
      bool4.setChampAnnotation(champAnnotationDao.findById(4)).orElse(null);
      bool4.setObjetId(id1);
      bool4.setBanque(b1);
      listAnnots.add(bool4);
      final AnnotationValeur alpha5 = new AnnotationValeur();
      alpha5.setAlphanum("&&é**¤¤");
      alpha5.setChampAnnotation(champAnnotationDao.findById(7)).orElse(null);
      ...
      assertFalse(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(4), eTest1).size() > 0).orElse(null);
      assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), eTest2).get(0).getAlphanum().orElse(null)
         .equals("2222"));
      ...
      assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(4), eTest1).get(0).getBool()).orElse(null);
      assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), eTest2).get(0).getAlphanum().orElse(null)
         .equals("8888"));
      assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), eTest3).get(0).getAlphanum().orElse(null)
         .equals("91011"));
   ...
   public void testExtractValueForChampManager(){
      ...
      final Champ c57 = new Champ(champEntiteDao.findById(57)).orElse(null);
      ...
      final Champ c229 = new Champ(champEntiteDao.findById(229)).orElse(null);
      ...
      final Champ c230 = new Champ(champEntiteDao.findById(230)).orElse(null);
      assertTrue(
   ...
   public void testFindCountByPrelevement(){
      ...
      final Prelevement p2 = prelevementDao.findById(2).orElse(null);
      res = echantillonManager.findCountByPrelevementManager(p2);
      assertTrue(res == 1);

      final Prelevement p3 = prelevementDao.findById(3).orElse(null);
      res = echantillonManager.findCountByPrelevementManager(p3);
      assertTrue(res == 1);

      final Prelevement p4 = prelevementDao.findById(4).orElse(null);
   ...
   public void testCreateUpdateWithNonConformites(){
      ...
      assertTrue(objetNonConformeDao.findByObjetAndEntite(e0.getEchantillonId(), entiteDao.findById(3)).size() == 0).orElse(null);
      assertNull(e0.getConformeCession());
      assertNull(e0.getConformeTraitement());

      ncfsTrait.add(nonConformiteDao.findById(4)).orElse(null);
      ncfsCess.add(nonConformiteDao.findById(6)).orElse(null);
      ncfsCess.add(nonConformiteDao.findById(7)).orElse(null);

      echantillonManager.createObjectWithNonConformitesManager(e1, banqueDao.findById(1).orElse(null), null, null,
      ...
      assertTrue(objetNonConformeDao.findByObjetAndEntite(e1.getEchantillonId(), entiteDao.findById(3)).size() == 3).orElse(null);
      ...
      echantillonManager.createObjectWithNonConformitesManager(e2, banqueDao.findById(1).orElse(null), null, null,
         objetStatutManager.findByIdManager(4), null, echantillonTypeManager.findByIdManager(1), null, null, null, null,
         null, null, null, u, false, "/tmp/", false, null, null);

      e2 = echantillonManager.findByCodeLikeManager("e2", true).get(0);

      assertTrue(objetNonConformeDao.findByObjetAndEntite(e2.getEchantillonId(), entiteDao.findById(3)).size() == 0).orElse(null);
      assertNull(e2.getConformeCession());
      assertNull(e2.getConformeTraitement());

      echantillonManager.updateObjectWithNonConformitesManager(e1, banqueDao.findById(1).orElse(null), null, null,
         objetStatutManager.findByIdManager(4), null, echantillonTypeManager.findByIdManager(1), null, null, null, null,
      ...
      assertTrue(objetNonConformeDao.findByObjetAndEntite(e1.getEchantillonId(), entiteDao.findById(3)).size() == 0).orElse(null);
      assertTrue(e1.getConformeTraitement());
      assertTrue(e1.getConformeCession());

      ncfsTrait.add(nonConformiteDao.findById(5)).orElse(null);
      ncfsCess.add(nonConformiteDao.findById(6)).orElse(null);
      ...
      assertTrue(objetNonConformeDao.findByObjetAndEntite(e1.getEchantillonId(), entiteDao.findById(3)).size() == 2).orElse(null);
      assertTrue(objetNonConformeDao.findByObjetAndEntite(e1.getEchantillonId(), entiteDao.findById(3)).get(0).getNonConformite().orElse(null)
         .getNom().equals("Echantillon non stérile")
         || objetNonConformeDao.findByObjetAndEntite(e1.getEchantillonId(), entiteDao.findById(3)).get(0).getNonConformite().orElse(null)
            .getNom().equals("Non cédable"));
      assertTrue(objetNonConformeDao
         .findByObjetEntiteAndType(e1.getEchantillonId(), entiteDao.findById(3), conformiteTypeDao.findById(3)).size() == 1).orElse(null);
      assertTrue(objetNonConformeDao
         .findByObjetEntiteAndType(e1.getEchantillonId(), entiteDao.findById(3), conformiteTypeDao.findById(2)).size() == 1).orElse(null);
      assertFalse(e1.getConformeTraitement());
      assertFalse(e1.getConformeCession());
   ...
   public void testPrepareJDBC() throws ParseException, SQLException{
      ...
      try{
         ...
         av1.setChampAnnotation(champAnnotationDao.findById(7)).orElse(null);
         avs.add(av1);
         final AnnotationValeur av2 = new AnnotationValeur();
         av2.setBool(false);
         av2.setChampAnnotation(champAnnotationDao.findById(4)).orElse(null);
         avs.add(av2);
         ...
         c1.setOrdre(1);
         c1.setExport(true);
         c1.setTableCodage(tableCodageDao.findById(1)).orElse(null);
         c1.setCodeRefId(2);
         codes.add(c1);
         ...
         assertTrue(objetNonConformeDao.findByObjetAndEntite(testInsert.getEchantillonId(), entiteDao.findById(3)).isEmpty()).orElse(null);
         ...
         assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(7), testInsert).get(0).orElse(null)
            .getAlphanum().equals("1.36"));
         assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(4), testInsert).get(0).orElse(null)
         ...
         assertTrue(objetNonConformeDao.findByObjetAndEntite(testInsert.getEchantillonId(), entiteDao.findById(3)).size() == 3).orElse(null);

         assertTrue(objetNonConformeDao
            .findByObjetEntiteAndType(testInsert.getEchantillonId(), entiteDao.findById(3), conformiteTypeDao.findById(3)).orElse(null)
            .size() == 2);
         assertTrue(objetNonConformeDao
            .findByObjetEntiteAndType(testInsert.getEchantillonId(), entiteDao.findById(3), conformiteTypeDao.findById(3)).get(0).orElse(null)
            .getNonConformite().equals(nonConformiteDao.findById(6)).orElse(null)
            || objetNonConformeDao
               .findByObjetEntiteAndType(testInsert.getEchantillonId(), entiteDao.findById(3), conformiteTypeDao.findById(3)).orElse(null)
               .get(1).getNonConformite().equals(nonConformiteDao.findById(6))).orElse(null);
         assertTrue(objetNonConformeDao
            .findByObjetEntiteAndType(testInsert.getEchantillonId(), entiteDao.findById(3), conformiteTypeDao.findById(3)).get(0).orElse(null)
            .getNonConformite().equals(nonConformiteDao.findById(7)).orElse(null)
            || objetNonConformeDao
               .findByObjetEntiteAndType(testInsert.getEchantillonId(), entiteDao.findById(3), conformiteTypeDao.findById(3)).orElse(null)
               .get(1).getNonConformite().equals(nonConformiteDao.findById(7))).orElse(null);

         assertTrue(objetNonConformeDao
            .findByObjetEntiteAndType(testInsert.getEchantillonId(), entiteDao.findById(3), conformiteTypeDao.findById(2)).orElse(null)
            .size() == 1);
         assertTrue(objetNonConformeDao
            .findByObjetEntiteAndType(testInsert.getEchantillonId(), entiteDao.findById(3), conformiteTypeDao.findById(2)).get(0).orElse(null)
            .getNonConformite().equals(nonConformiteDao.findById(4))).orElse(null);
