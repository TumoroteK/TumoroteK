...
public class InterfacageParsingUtilsTest extends AbstractManagerTest4
{
	...
	public void testExtractXMLFIleFromFileToInjectInTk() throws IOException{
		...
		try{
			...
			// Emetteur e2 = emetteurDao.findById(2).orElse(null);
			...
			// Emetteur e1 = emetteurDao.findById(1).orElse(null);
	...
	public void testDIAMICEvolutionMultiORC() throws IOException{
		...
		try{
			...
			BlocExterne patBloc = blocExterneManager
					.findByDossierExterneAndEntiteManager(dossiers.get(0), entiteDao.findById(1)).get(0).orElse(null);
			...
			BlocExterne prelBloc = blocExterneManager
					.findByDossierExterneAndEntiteManager(dossiers.get(0), entiteDao.findById(2)).get(0).orElse(null);
			...
			BlocExterne echanBloc = blocExterneManager
					.findByDossierExterneAndEntiteManager(dossiers.get(0), entiteDao.findById(3)).get(0).orElse(null);
			...
			patBloc = blocExterneManager
					.findByDossierExterneAndEntiteManager(dossiers.get(1), entiteDao.findById(1)).get(0).orElse(null);
			...
			prelBloc = blocExterneManager
					.findByDossierExterneAndEntiteManager(dossiers.get(1), entiteDao.findById(2)).get(0).orElse(null);
			vals = valeurExterneManager.findByBlocExterneManager(prelBloc);
			assertTrue(vals.size() == 5);
			codePrel.setBlocExterne(prelBloc);
			...
			echanBloc = blocExterneManager
					.findByDossierExterneAndEntiteManager(dossiers.get(1), entiteDao.findById(3)).get(0).orElse(null);
			vals = valeurExterneManager.findByBlocExterneManager(echanBloc);
			assertTrue(vals.size() == 3);
			cr.setBlocExterne(echanBloc);
			...
			BlocExterne spmBloc = blocExterneManager
					.findByDossierExterneAndEntiteManager(dossiers.get(1), entiteDao.findById(3)).get(1).orElse(null);
			...
			spmBloc = blocExterneManager
					.findByDossierExterneAndEntiteManager(dossiers.get(1), entiteDao.findById(3)).get(2).orElse(null);
			vals = valeurExterneManager.findByBlocExterneManager(spmBloc);
			assertTrue(vals.size() == 5);
			codeEchan.setBlocExterne(spmBloc);
