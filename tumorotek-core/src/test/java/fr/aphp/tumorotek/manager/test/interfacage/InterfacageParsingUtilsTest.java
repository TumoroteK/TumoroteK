...
public class InterfacageParsingUtilsTest extends AbstractManagerTest4
{
   ...
   public void testParseFileToInjectInTk() throws IOException{
      ...
      try{
         ...
         Hashtable<String, List<String>> record = interfacageParsingUtils.parseFileToInjectInTk(conf, str).get(0);
         ...
         List<Hashtable<String, List<String>>> contenu = interfacageParsingUtils.parseFileToInjectInTk(conf, str);
   ...
   public void testInitNewDossierExterne() throws IOException{
      ...
      try{
         ...
         try{
            ...
            input.read(ba);
            final String str = new String(ba);
            final Hashtable<String, List<String>> contenu = interfacageParsingUtils.parseFileToInjectInTk(conf, str).get(0);
   ...
   public void testExtractXMLFIleFromFileToInjectInTk() throws IOException{
      ...
      try{
         ...
         String xml =
            interfacageParsingUtils.extractInboxParamFromFile(folder + "configuration_interfacage.xml", str, "Boite Apix", "XML");
         //e2);
         assertNotNull(xml);
         ...
         xml = interfacageParsingUtils.extractInboxParamFromFile(folder + "configuration_interfacage.xml", str, "Boite Erreur",
            "XML");
         //e2);
         assertNotNull(xml);
         ...
         // balise non reconnue
         xml = interfacageParsingUtils.extractInboxParamFromFile(folder + "configuration_interfacage.xml", str, "Boite Apix",
            "nooope");
         //e2);
         assertNull(xml);
   ...
   public void testFormateValueUsingFunction(){
      ...
      assertTrue(
         interfacageParsingUtils.formateValueUsingFunction(fcElt, "TEST25", null, null, null, null, null).equals("test25"));
      ...
      assertTrue(
         interfacageParsingUtils.formateValueUsingFunction(null, "test25", null, null, null, null, null).equals("test25"));
      fcElt.setAttribute("nom", "stringToUpperCase");
      ...
      assertNull(
         interfacageParsingUtils.formateValueUsingFunction(fcElt, "Cas^1^Rayon^2^Tiroir^3", null, conf, null, bld, encMap));
      ...
      assertTrue(interfacageParsingUtils.formateValueUsingFunction(fcElt, "A^06^0", null, conf, null, bld, null)
         .equals("C1.Cas1.R2.T3.2FIBROCHIR.A-6"));
   ...
   public void testParseInterfacageXmlFile() throws Exception{
      ...
      try{
         ...
         DossierExterne dossier =
            interfacageParsingUtils.parseInterfacageXmlFile(folder + "interfacage.xml", str, e1, false, 10, null).get(0);
         ...
         // Const
         dossier =
            interfacageParsingUtils.parseInterfacageXmlFile(folder + "interfacage_const.xml", str, e1, false, 10, null).get(0);
         //		DossierExterne dossier = interfacageParsingUtils
         //			.parseInterfacageXmlFile(
         //			folder + "apix-mapping.xml", str, e1);
         assertTrue(dossierExterneManager.findAllObjectsManager().size() == nbD + 1);
         ...
         BlocExterne bPrel = blocExterneManager.findByDossierExterneManager(dossier).iterator().next();
         List<ValeurExterne> vals = valeurExterneManager.findByBlocExterneManager(bPrel);
         assertTrue(vals.size() == 3);
         ValeurExterne valToAssert = new ValeurExterne();
         valToAssert.setChampEntiteId(27);
         valToAssert.setBlocExterne(bPrel);
   ...
   public void testDIAMICEvolutionMultiORC() throws IOException{
      ...
      try{
         ...
         dossiers.addAll(
            interfacageParsingUtils.parseInterfacageXmlFile(folder.concat("diamic-mapping.xml"), str, e1, false, 10, null));
         ...
         ValeurExterne nip = new ValeurExterne();
         nip.setChampEntiteId(2);
         ValeurExterne nom = new ValeurExterne();
         nom.setChampEntiteId(3);
         ValeurExterne prenom = new ValeurExterne();
         prenom.setChampEntiteId(5);
         ValeurExterne sexe = new ValeurExterne();
         sexe.setChampEntiteId(6);
         ValeurExterne dateNais = new ValeurExterne();
         dateNais.setChampEntiteId(7);
         ValeurExterne codePrel = new ValeurExterne();
         codePrel.setChampEntiteId(23);
         ValeurExterne numLabo = new ValeurExterne();
         numLabo.setChampEntiteId(45);
         ValeurExterne datePrel = new ValeurExterne();
         datePrel.setChampEntiteId(30);
         ValeurExterne dateArr = new ValeurExterne();
         dateArr.setChampEntiteId(38);
         ValeurExterne servicePrel = new ValeurExterne();
         servicePrel.setChampEntiteId(29);
         ValeurExterne cr = new ValeurExterne();
         cr.setChampEntiteId(255);
         ValeurExterne codeLes = new ValeurExterne();
         codeLes.setChampEntiteId(230);
         ValeurExterne codeOrg = new ValeurExterne();
         codeOrg.setChampEntiteId(229);
         ValeurExterne codeEchan = new ValeurExterne();
         codeEchan.setChampEntiteId(54);
         ValeurExterne eType = new ValeurExterne();
         eType.setChampEntiteId(58);
         ValeurExterne dateStock = new ValeurExterne();
         dateStock.setChampEntiteId(56);
         ValeurExterne collab = new ValeurExterne();
         collab.setChampEntiteId(53);
         ...
         BlocExterne patBloc =
            blocExterneManager.findByDossierExterneAndEntiteManager(dossiers.get(0), entiteDao.findById(1)).get(0);
         ...
         BlocExterne prelBloc =
            blocExterneManager.findByDossierExterneAndEntiteManager(dossiers.get(0), entiteDao.findById(2)).get(0);
         ...
         BlocExterne echanBloc =
            blocExterneManager.findByDossierExterneAndEntiteManager(dossiers.get(0), entiteDao.findById(3)).get(0);
         ...
         patBloc = blocExterneManager.findByDossierExterneAndEntiteManager(dossiers.get(1), entiteDao.findById(1)).get(0);
         ...
         dateNais.setBlocExterne(patBloc);
         assertTrue(vals.get(vals.indexOf(dateNais)).getValeur().equals("19150823"));
         prelBloc = blocExterneManager.findByDossierExterneAndEntiteManager(dossiers.get(1), entiteDao.findById(2)).get(0);
         vals = valeurExterneManager.findByBlocExterneManager(prelBloc);
         assertTrue(vals.size() == 5);
         codePrel.setBlocExterne(prelBloc);
         ...
         servicePrel.setBlocExterne(prelBloc);
         assertTrue(vals.get(vals.indexOf(servicePrel)).getValeur().equals("1589"));
         echanBloc = blocExterneManager.findByDossierExterneAndEntiteManager(dossiers.get(1), entiteDao.findById(3)).get(0);
         vals = valeurExterneManager.findByBlocExterneManager(echanBloc);
         assertTrue(vals.size() == 3);
         cr.setBlocExterne(echanBloc);
         ...
         BlocExterne spmBloc =
            blocExterneManager.findByDossierExterneAndEntiteManager(dossiers.get(1), entiteDao.findById(3)).get(1);
         ...
         spmBloc = blocExterneManager.findByDossierExterneAndEntiteManager(dossiers.get(1), entiteDao.findById(3)).get(2);
         vals = valeurExterneManager.findByBlocExterneManager(spmBloc);
         assertTrue(vals.size() == 5);
         codeEchan.setBlocExterne(spmBloc);
