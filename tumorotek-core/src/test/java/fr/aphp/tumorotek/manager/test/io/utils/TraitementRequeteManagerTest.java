...
public class TraitementRequeteManagerTest extends AbstractManagerTest4
{
   ...
   public void testTraitementCritereManager(){
      ...
      final ChampEntite codeDerive = champEntiteDao.findById(79).orElse(null);
   ...
   public void testCritereWithChampParent(){
      ...
      final ChampEntite codeMaladie = champEntiteDao.findById(18).orElse(null);
      // On récup le champ MaladieId de la table prélèvement
      final ChampEntite maladieId = champEntiteDao.findById(25).orElse(null);
      ...
      final ChampEntite maladies = champEntiteDao.findById(222).orElse(null);
   ...
   public void testMultiParents(){
      ...
      final ChampEntite champEntitePatientId = champEntiteDao.findById(16).orElse(null);
      final Champ parentToQueryPatient = new Champ(champEntitePatientId);
      // création du parent pour accéder aux maladies
      final ChampEntite champEntiteMaladieId = champEntiteDao.findById(25).orElse(null);
      ...
      final ChampEntite nomPatient = champEntiteDao.findById(3).orElse(null);
      ...
      final ChampEntite champEntiteEchantillons = champEntiteDao.findById(224).orElse(null);
      ...
      final ChampEntite codeEchantillon = champEntiteDao.findById(54).orElse(null);
   ...
   public void testFindIdsFromEntite(){
      ...
      final ChampEntite idP = champEntiteDao.findById(1).orElse(null);
      ...
      final ChampEntite idPrlvt = champEntiteDao.findById(21).orElse(null);
      ...
      final ChampEntite idE = champEntiteDao.findById(50).orElse(null);
      champ = new Champ(idE);
      champ.setChampParent(parentToQueryEchantillon);
      critere = new Critere(champ, "in", "");
   ...
   public void testFindIdsFromEntiteDeriveVersion(){
      ...
      final ChampEntite champEntitePrlvtId = champEntiteDao.findById(52).orElse(null);
      ...
      // création du parent pour accéder aux échantillons
      final ChampEntite champEntiteEchans = champEntiteDao.findById(226).orElse(null);
      ...
      final ChampEntite champEntiteDerives = champEntiteDao.findById(226).orElse(null);
      final Champ parentToQueryDerive = new Champ(champEntiteDerives);
      parentToQueryDerive.setChampParent(parentToQueryEchan);

      final ChampEntite idDer = champEntiteDao.findById(76).orElse(null);
      ...
      final ChampEntite champEntiteDerives2 = champEntiteDao.findById(225).orElse(null);
   ...
   public void testMultiCriteres(){
      ...
      final ChampAnnotation ca = champAnnotationDao.findById(9).orElse(null);
      champ = new Champ(ca);
      champ.setChampParent(parentToQueryEchantillon);
   ...
   public void testNumCritereAnnot(){
      ...
      // critere sur un champannotation
      final ChampAnnotation ca = champAnnotationDao.findById(7).orElse(null);
   ...
   public void testProdDeriveQuery() {
   	...
   	// création du parent pour accéder aux patients
   	ChampEntite champEntitePatientId = champEntiteDao.findById(16).orElse(null);
   	Champ parentToQueryPatient = new Champ(champEntitePatientId);
   	// création du parent pour accéder aux maladies
   	ChampEntite champEntiteMaladieId = champEntiteDao.findById(25).orElse(null);
   	Champ parentToQueryOneMaladie = new Champ(champEntiteMaladieId);
   	parentToQueryPatient.setChampParent(parentToQueryOneMaladie);
   	// création du parent pour accéder aux prélèvement
   	ChampEntite champEntitePrlvtId = champEntiteDao.findById(52).orElse(null);
   	Champ parentToQueryOnePrlvt = new Champ(champEntitePrlvtId);
   	parentToQueryOneMaladie.setChampParent(parentToQueryOnePrlvt);
   	
   	ChampEntite nomPatient = champEntiteDao.findById(3).orElse(null);
   	Champ champ = new Champ(nomPatient);
   	champ.setChampParent(parentToQueryPatient);
   	...
   	ChampEntite champEntiteMaladies = champEntiteDao.findById(222).orElse(null);
   	Champ parentToQueryMaladie = new Champ(champEntiteMaladies);
   	// création du parent pour accéder aux prélèvements
   	ChampEntite champEntitePrelevements = champEntiteDao.findById(223).orElse(null);
   	Champ parentToQueryPrlvt = new Champ(champEntitePrelevements);
   	parentToQueryPrlvt.setChampParent(parentToQueryMaladie);
   	// création du parent pour accéder aux dérivés
   	ChampEntite champEntiteDerives = champEntiteDao.findById(225).orElse(null);
   	Champ parentToQueryDerives = new Champ(champEntiteDerives);
   	parentToQueryDerives.setChampParent(parentToQueryPrlvt);
   	
   	ChampEntite codeDerive = champEntiteDao.findById(79).orElse(null);
   ...
   public void testProdDeriveQueryWithCriteresList(){
      ...
      parentToQueryPrlvt.setChampParent(parentToQueryMaladie);
      // création du parent pour accéder aux dérivés
      final ChampEntite champEntiteDerives = champEntiteDao.findById(225).orElse(null);
      ...
      final ChampEntite laboDerive = champEntiteDao.findById(80).orElse(null);
   ...
   //		ChampEntite codePrelevement = champEntiteDao.findById(23).orElse(null);
   ...
   //		ChampEntite idPatient = champEntiteDao.findById(1).orElse(null);
   ...
   //		 * (27).
   //		 */
   //		ChampEntite consentDate = champEntiteDao.findById(27).orElse(null);
   //
   //		/* On crée un arbre de groupement. */
   ...
   //
   //			ChampAnnotation champAnno = champAnnotationDao.findById(72).orElse(null);
   //			
   //			ChampEntite champEchantillonCode = champEntiteDao.findById(54).orElse(null);
   //
   //			/* On crée un arbre de groupement. */
   ...
   public void testCodesInList(){
      ...
      final ChampEntite champEntiteCodeOrganes = champEntiteDao.findById(241).orElse(null);
      ...
      final ChampEntite codeOrgane = champEntiteDao.findById(125).orElse(null);
      ...
      final ChampEntite champEntiteCodeMorphos = champEntiteDao.findById(241).orElse(null);
      ...
      final ChampEntite codeMorpho = champEntiteDao.findById(231).orElse(null);
   ...
   public void testFindEchantillonsByRequeteBiocapManager() throws ParseException{
      ...
      List<Banque> banques = new ArrayList<>();
      banques.add(b2);
      final Service s1 = serviceDao.findById(1).orElse(null);
      ...
      liste = traitementQueryManager.findEchantillonsByRequeteBiocapManager("mysql", banques, services, dateInf, dateSup, 12,
         objetStatutDao.findById(1)).orElse(null);
      assertTrue(liste.isEmpty());
      liste = traitementQueryManager.findEchantillonsByRequeteBiocapManager("mysql", banques, services, dateInf, dateSup, 12,
         objetStatutDao.findById(3)).orElse(null);
      assertTrue(liste.size() == 1);
      ...
      services.add(serviceDao.findById(2)).orElse(null);
      liste =
         traitementQueryManager.findEchantillonsByRequeteBiocapManager("mysql", banques, services, dateInf, dateSup, 18, null);
      assertTrue(liste.size() == 0);
      ...
      services.add(serviceDao.findById(1)).orElse(null);
      banques = new ArrayList<>();
      banques.add(banqueDao.findById(1)).orElse(null);
      liste =
         traitementQueryManager.findEchantillonsByRequeteBiocapManager("mysql", banques, services, dateInf, dateSup, 18, null);
      assertTrue(liste.size() == 0);
      ...
      banques = new ArrayList<>();
      banques.add(banqueDao.findById(2)).orElse(null);
      liste = traitementQueryManager.findEchantillonsByRequeteBiocapManager("mysql", banques, services, dateInf, dateSup, 12,
         objetStatutDao.findById(3)).orElse(null);
      assertTrue(liste.size() == 1);
      ...
      liste = traitementQueryManager.findEchantillonsByRequeteBiocapManager("mysql", new ArrayList<Banque>(), services, dateInf,
         dateSup, 18, objetStatutDao.findById(3)).orElse(null);
      assertTrue(liste.size() == 0);
   ...
   public void testFindPrelevementsByMedecinsManager(){
      ...
      List<Banque> banques = new ArrayList<>();
      banques.add(b1);
      Collaborateur c = collaborateurDao.findById(1).orElse(null);
      ...
      c = collaborateurDao.findById(2).orElse(null);
      liste = traitementQueryManager.findPrelevementsByMedecinsManager(c, banques);
      assertTrue(liste.size() == 1);
      assertTrue(liste.get(0) == 3);

      c = collaborateurDao.findById(4).orElse(null);
      banques.add(banqueDao.findById(2)).orElse(null);
      liste = traitementQueryManager.findPrelevementsByMedecinsManager(c, banques);
      assertTrue(liste.size() == 0);

      c = collaborateurDao.findById(3).orElse(null);
      liste = traitementQueryManager.findPrelevementsByMedecinsManager(c, banques);
      assertTrue(liste.size() == 1);
      assertTrue(liste.get(0) == 3);
   ...
   public void testFindObjetIdsFromNonConformiteNomManager(){
      ...
      final ConformiteType c2 = conformiteTypeDao.findById(2).orElse(null);
      ...
      final ConformiteType c3 = conformiteTypeDao.findById(3).orElse(null);
      ids = traitementQueryManager.findObjetIdsFromNonConformiteNomManager("Non", c3, pf1, banks);
      assertTrue(ids.size() == 2);
      assertTrue(ids.contains(3));
      assertTrue(ids.contains(2));

      final ConformiteType c5 = conformiteTypeDao.findById(5).orElse(null);
   ...
   public void testNoConfCritereWithBanques(){
      ...
      final ChampEntite raisonNc = champEntiteDao.findById(257).orElse(null);
      final Banque b1 = banqueDao.findById(1).orElse(null);
      final List<Banque> banques = new ArrayList<>();
      banques.add(b1);
      ...
      assertEquals(3, resultats.size());
      banques.add(banqueDao.findById(3)).orElse(null);
      resultats = traitementQueryManager.findObjetByCritereManager(critere, banques, null, "mysql");
      assertTrue(resultats.size() == 4);

      // is null derives
      critere.getChamp().setChampEntite(champEntiteDao.findById(262)).orElse(null);
      resultats = traitementQueryManager.findObjetByCritereManager(critere, banques, null, "mysql");
      assertTrue(resultats.size() == 2);
   ...
   public void testTempStockCritereWithBanques(){
      ...
      final ChampEntite tempStockE = champEntiteDao.findById(265).orElse(null);
      final Banque b1 = banqueDao.findById(1).orElse(null);
      final List<Banque> banques = new ArrayList<>();
      banques.add(b1);
      ...
      final ChampEntite tempStockD = champEntiteDao.findById(266).orElse(null);
