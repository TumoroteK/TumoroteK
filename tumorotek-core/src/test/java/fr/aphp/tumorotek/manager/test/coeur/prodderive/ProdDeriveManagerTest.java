...
public class ProdDeriveManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindDoublon(){
      ...
      // pf
      derive.setBanque(banqueDao.findById(4)).orElse(null);
   ...
   public void testCrud(){
      ...
      final ModePrepaDerive mode = modePrepaDeriveDao.findById(1).orElse(null);
      ...
      prodDeriveManager.createObjectManager(derive2, banque, type, statut, collab, emp, volume, conc, quantite, mode, qualite,
         upT, null, null, utilisateur, true, "/tmp/", false);
      ...
      prodDeriveManager.createObjectManager(derive5, banque, type, objetStatutManager.findByIdManager(4), null, null, null, null,
         null, null, null, null, null, null, utilisateur, true, "/tmp/", false);
      ...
      try{
         prodDeriveManager.updateObjectManager(derive6, null, type, null, null, null, null, null, null, null, null, null, null,
            null, null, null, null, true, null, "/tmp/");
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catchedUpdate = true;
         }
      ...
      prodDeriveManager.updateObjectManager(derive11, banque, type, statut, collab, emp, volume, conc, quantite, mode, qualite,
         upT2, null, null, null, null, utilisateur, true, opTypes, "/tmp/");
   ...
   private void validationInsert(final ProdDerive derive){
      ...
      final String[] codesLabos = new String[] {"", " ", "%¢¢kjs", createOverLength(50), "GOOD"};
   ...
   private void validationUpdate(final ProdDerive derive){
      ...
      final String[] codesLabos = new String[] {"", " ", "%$$ÆÂ¢kjs", createOverLength(50), "GOOD"};
      for(int i = 0; i < codes.length; i++){
         for(int j = 0; j < codesLabos.length; j++){
            catchedUpdate = false;
            try{
   ...
   public void testUpdateMultipleObjectsManager(){
      ...
      bool1.setChampAnnotation(champAnnotationDao.findById(18)).orElse(null);
      bool1.setBool(true);
      ...
      list.add(deriveUp3);
      listAnnots.clear();
      listAnnots.addAll(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(18), derive1)).orElse(null);
      listAnnots.addAll(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(18), derive2)).orElse(null);
      listAnnots.addAll(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(18), derive3)).orElse(null);
      ...
      ncfsTrait.add(nonConformiteDao.findById(8)).orElse(null);

      final List<NonConformite> ncfsCess = new ArrayList<>();
      ncfsCess.add(nonConformiteDao.findById(10)).orElse(null);
      ...
      assertFalse(
         annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(18), deriveTest1).get(0).getBool()).orElse(null);
      assertTrue(
         annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(18), deriveTest2).get(0).getBool()).orElse(null);
      assertFalse(
         annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(18), deriveTest3).get(0).getBool()).orElse(null);
      ...
      assertFalse(
         annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(18), deriveTest4).get(0).getBool()).orElse(null);
      assertTrue(objetNonConformeDao.findByObjetAndEntite(id1, entiteManager.findByIdManager(8)).size() == 2);
      assertTrue(objetNonConformeDao.findByObjetAndEntite(id2, entiteManager.findByIdManager(8)).size() == 2);
      assertTrue(objetNonConformeDao.findByObjetAndEntite(id3, entiteManager.findByIdManager(8)).size() == 2);
      ...
      assertFalse(
         annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(18), deriveTest7).get(0).getBool()).orElse(null);
      ...
      alpha1.setChampAnnotation(champAnnotationDao.findById(17)).orElse(null);
      ...
      alpha2.setChampAnnotation(champAnnotationDao.findById(17)).orElse(null);
      ...
      assertFalse(annotationValeurManager
         .findByChampAndObjetManager(champAnnotationDao.findById(18), prodDeriveManager.findByIdManager(id3)).get(0).getBool()).orElse(null);
      ...
      assertTrue(annotationValeurManager
         .findByChampAndObjetManager(champAnnotationDao.findById(18), prodDeriveManager.findByIdManager(id1)).get(0).getBool()).orElse(null);
      assertTrue(annotationValeurManager
         .findByChampAndObjetManager(champAnnotationDao.findById(17), prodDeriveManager.findByIdManager(id2)).get(0).getAlphanum().orElse(null)
         .equals("yy"));
      assertTrue(annotationValeurManager
         .findByChampAndObjetManager(champAnnotationDao.findById(17), prodDeriveManager.findByIdManager(id3)).size() == 0).orElse(null);
   ...
   public void testCreateDeriveListWithAnnotsManager(){
      ...
      bool2.setChampAnnotation(champAnnotationDao.findById(18)).orElse(null);
      bool2.setBool(true);
      bool2.setBanque(banque);
      valeurs.add(bool2);
      final AnnotationValeur alpha = new AnnotationValeur();
      alpha.setAlphanum("$$€€");
      alpha.setChampAnnotation(champAnnotationDao.findById(17)).orElse(null);
      ...
      final List<NonConformite> ncfsCess = new ArrayList<>();
      ncfsCess.add(nonConformiteDao.findById(10)).orElse(null);
      ncfsCess.add(nonConformiteDao.findById(11)).orElse(null);
      ...
      assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(17).orElse(null),
   ...
   public void testCreateUpdateDeriveWithAnnots(){
      ...
      final ChampAnnotation c = champAnnotationDao.findById(17).orElse(null);
      ...
      try{
         prodDeriveManager.createObjectManager(derive, b1, type, objetStatutManager.findByIdManager(4), null, null, null, null,
            null, null, null, null, listAnnots, null, utilisateur, true, "/tmp/", false);
      ...
      prodDeriveManager.createObjectManager(derive, b1, type, objetStatutManager.findByIdManager(4), null, null, null, null, null,
         null, null, null, listAnnots, null, utilisateur, true, "/tmp/", false);
      ...
      listAnnots.add(a2);
      final AnnotationValeur bool1 = new AnnotationValeur();
      final ChampAnnotation c2 = champAnnotationDao.findById(18).orElse(null);
      ...
      prodDeriveManager.updateObjectManager(derive, b1, type, null, null, null, null, null, null, null, null, null, listAnnots,
         listDelete, null, null, utilisateur, true, null, "/tmp/");
   ...
   public void testSwitchBanque(){
      ...
      prodDeriveManager.createObjectManager(p, b3, prodTypeManager.findByIdManager(1), objetStatutManager.findByIdManager(4),
         null, null, null, null, null, null, null, null, null, null, u, false, "/tmp/", false);
      ...
      prodDeriveManager.createObjectManager(derive, b2, prodTypeManager.findByIdManager(1), objetStatutManager.findByIdManager(4),
         null, null, null, null, null, null, null, transfo1, null, null, u, false, "/tmp/", false);
      ...
      num.setChampAnnotation(champAnnotationDao.findById(17)).orElse(null);
      num.setAlphanum("123456");
      num.setBanque(b1);
      listAnnots.add(num);
      final AnnotationValeur bool = new AnnotationValeur();
      bool.setChampAnnotation(champAnnotationDao.findById(18)).orElse(null);
      bool.setBool(true);
      bool.setBanque(b1);
      listAnnots.add(bool);
      prodDeriveManager.updateObjectManager(p, p.getBanque(), p.getProdType(), null, null, emp, null, null, null, null, null,
         null, listAnnots, null, null, null, u, false, null, "/tmp/");
   ...
   public void testExtractValueForChampManager(){
      ...
      final Champ c79 = new Champ(champEntiteDao.findById(79)).orElse(null);
      ...
      final Champ c87 = new Champ(champEntiteDao.findById(87)).orElse(null);
   ...
   public void testCreateUpdateWithNonConformites(){
      ...
      prodDeriveManager.createObjectWithNonConformitesManager(p0, banqueDao.findById(1), prodTypeManager.findByIdManager(1).orElse(null),
      ...
      ncfsTrait.add(nonConformiteDao.findById(8)).orElse(null);
      ncfsTrait.add(nonConformiteDao.findById(9)).orElse(null);
      ncfsCess.add(nonConformiteDao.findById(10)).orElse(null);

      prodDeriveManager.createObjectWithNonConformitesManager(p1, banqueDao.findById(1), prodTypeManager.findByIdManager(1).orElse(null),
         objetStatutManager.findByIdManager(4), null, null, null, null, null, null, null, null, null, u, false, null, false,
         ncfsTrait, ncfsCess);
      ...
      prodDeriveManager.createObjectWithNonConformitesManager(p2, banqueDao.findById(1), prodTypeManager.findByIdManager(1).orElse(null),
         objetStatutManager.findByIdManager(4), null, null, null, null, null, null, null, null, null, u, false, null, false,
         null, null);
      ...
      prodDeriveManager.updateObjectWithNonConformitesManager(p1, banqueDao.findById(1), prodTypeManager.findByIdManager(1).orElse(null),
      ...
      assertTrue(objetNonConformeDao
         .findByObjetEntiteAndType(p1.getProdDeriveId(), entiteManager.findByIdManager(8), conformiteTypeDao.findById(4)).orElse(null)
         .size() == 1);
      assertTrue(objetNonConformeDao
         .findByObjetEntiteAndType(p1.getProdDeriveId(), entiteManager.findByIdManager(8), conformiteTypeDao.findById(5)).orElse(null)
         .size() == 1);
   ...
   public void testCreateDerivesEmplacement() throws ParseException{
      ...
      // new1.setTerminale(terminaleDao.findById(6)).orElse(null);
      // new1.setPosition(3);
      // empls.put(pd2, new1);
      final Emplacement new2 = new Emplacement();
      new2.setTerminale(terminaleDao.findById(6)).orElse(null);
      new2.setPosition(4);
      empls.put(pd3, new2);
      ...
      final List<Emplacement> emps = emplacementManager.findByTerminaleWithOrder(terminaleDao.findById(6)).orElse(null);
   ...
   public void testCreateDerivesPrelevement() throws ParseException{
      ...
      avD1.setChampAnnotation(champAnnotationDao.findById(17)).orElse(null);
      avD1.setAlphanum("v1");
      avD1.setBanque(b2);
      avs1.add(avD1);
      final AnnotationValeur avD2 = new AnnotationValeur();
      avD2.setChampAnnotation(champAnnotationDao.findById(18)).orElse(null);
      avD2.setBool(true);
      avD2.setBanque(b2);
      avs1.add(avD2);
      annos.put(pd1, avs1);
      ...
      avD3.setChampAnnotation(champAnnotationDao.findById(17)).orElse(null);
      ...
      ncT1.add(nonConformiteDao.findById(8)).orElse(null);
      ncfTraits.put(pd3, ncT1);
      final List<NonConformite> ncT2 = new ArrayList<>();
      ncT2.add(nonConformiteDao.findById(8)).orElse(null);
      ncT2.add(nonConformiteDao.findById(9)).orElse(null);
      ...
      ncC1.add(nonConformiteDao.findById(10)).orElse(null);
      ncC1.add(nonConformiteDao.findById(11)).orElse(null);
      ncfCess.put(pd3, ncC1);
      final List<NonConformite> ncC2 = new ArrayList<>();
      ncC2.add(nonConformiteDao.findById(10)).orElse(null);
      ...
      prel = prelevementDao.findById(prel.getPrelevementId()).orElse(null);
      ...
      assertTrue(objetNonConformeDao
         .findByObjetEntiteAndType(pd1.getProdDeriveId(), entiteManager.findByIdManager(8), conformiteTypeDao.findById(4)).orElse(null)
         .size() == 2);
      assertNull(pd1.getConformeCession());
      assertTrue(objetNonConformeDao
         .findByObjetEntiteAndType(pd1.getProdDeriveId(), entiteManager.findByIdManager(8), conformiteTypeDao.findById(5)).orElse(null)
         .isEmpty());
      assertNull(pd2.getConformeTraitement());
      assertTrue(objetNonConformeDao
         .findByObjetEntiteAndType(pd2.getProdDeriveId(), entiteManager.findByIdManager(8), conformiteTypeDao.findById(4)).orElse(null)
         .isEmpty());
      assertFalse(pd2.getConformeCession());
      assertTrue(objetNonConformeDao
         .findByObjetEntiteAndType(pd2.getProdDeriveId(), entiteManager.findByIdManager(8), conformiteTypeDao.findById(5)).orElse(null)
         .size() == 1);
      assertFalse(pd3.getConformeTraitement());
      assertTrue(objetNonConformeDao
         .findByObjetEntiteAndType(pd3.getProdDeriveId(), entiteManager.findByIdManager(8), conformiteTypeDao.findById(4)).orElse(null)
         .size() == 1);
      assertFalse(pd3.getConformeCession());
      assertTrue(objetNonConformeDao
         .findByObjetEntiteAndType(pd3.getProdDeriveId(), entiteManager.findByIdManager(8), conformiteTypeDao.findById(5)).orElse(null)
         .size() == 2);
      ...
      prel2 = prelevementDao.findById(prel2.getPrelevementId()).orElse(null);
      ...
      prel3 = prelevementDao.findById(prel3.getPrelevementId()).orElse(null);
   ...
   public void testCreateDerivesEchantillon() throws ParseException{
      ...
      echantillonManager.updateObjectManager(ech2, b2, null, null, ech2.getObjetStatut(), null, ech2.getEchantillonType(), null,
         null, null, null, null, null, null, null, null, u2, false, null, "/tmp/");
      derives.clear();
      pd1 = new ProdDerive();
      pd1.setCode("PD1e");
      pd1.setProdType(prodTypeManager.findByTypeLikeManager("ADN", true).get(0));
