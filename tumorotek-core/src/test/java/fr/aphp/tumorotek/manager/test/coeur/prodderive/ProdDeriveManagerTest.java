...
public class ProdDeriveManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		ProdDerive derive = prodDeriveManager.findByIdManager(1);
		assertNotNull(derive);
		assertTrue(derive.getCode().equals("PTRA.1.1"));
		
		ProdDerive deriveNull = prodDeriveManager.findByIdManager(10);
		assertNull(deriveNull);
	}
	
	@Test
	public void testFindAll() {
		List<ProdDerive> list = prodDeriveManager.findAllObjectsManager();
	...
	public void testFindByIdsInListManager() {
		...
		ids.add(3);
		ids.add(10);
		List<ProdDerive> liste = 
			prodDeriveManager.findByIdsInListManager(ids);
	...
	public void testFindByBanquesManager() {
		...
		List<ProdDerive> res = prodDeriveManager
	...
	public void testFindAllObjectsIdsByBanquesManager() {
		...
		banks.add(banqueDao.findById(1));
		banks.add(banqueDao.findById(2));
		List<Integer> res = prodDeriveManager
	...
	public void testFindByDateStockAfterDateManager() throws Exception {
		...
		List<ProdDerive> list = 
			prodDeriveManager.findByDateStockAfterDateManager(search);
		assertTrue(list.size() == 4);
	...
	public void testFindByDateTransfoAfterDateManager() throws Exception {
		Date search = new SimpleDateFormat("dd/MM/yyyy").parse("15/01/2009");
		List<ProdDerive> list = 
			prodDeriveManager.findByDateTransfoAfterDateManager(search);
		assertTrue(list.size() == 4);
	 ...
	 */
	@Test
	public void testFindByDateTransformationAfterDateWithBanqueManager() 
	throws Exception {
		...
		Date search = new SimpleDateFormat("dd/MM/yyyy").parse("15/01/2009");
		List<ProdDerive> list = prodDeriveManager
			.findByDateTransformationAfterDateWithBanqueManager(search, banks);
		assertTrue(list.size() == 0);
		
		banks.add(b1);
		search = new SimpleDateFormat("dd/MM/yyyy").parse("15/01/2009");
		list = prodDeriveManager
			.findByDateTransformationAfterDateWithBanqueManager(search, banks);
		...
		list = prodDeriveManager
			.findByDateTransformationAfterDateWithBanqueManager(search, null);
		assertTrue(list.size() == 0);
		...
		list = prodDeriveManager
			.findByDateTransformationAfterDateWithBanqueManager(null, banks);
		assertTrue(list.size() == 0);
		
		list = prodDeriveManager
			.findByDateTransformationAfterDateWithBanqueManager(null, null);
		assertTrue(list.size() == 0);
	}
	...
	public void testFindByCodeLikeExactManager() {
		List<ProdDerive> list = 
			prodDeriveManager.findByCodeLikeManager("PTRA.1.1", true);
		assertTrue(list.size() == 1);
	...
	public void testFindByCodeLikeManager() {
		List<ProdDerive> list = 
			prodDeriveManager.findByCodeLikeManager("PTRA.1.1", false);
		assertTrue(list.size() == 1);
	...
	public void testFindAllCodesForBanqueManager() {
		...
		List<String> codes = 
			prodDeriveManager.findAllCodesForBanqueManager(b);
	...
	public void testFindAllCodesForBanqueAndQuantiteManager() {
		Banque b = banqueManager.findByIdManager(1);
		List<String> codes = 
			prodDeriveManager.findAllCodesForBanqueAndQuantiteManager(b);
	...
	public void testFindAllCodesForBanqueAndStockesManager() {
		Banque b = banqueManager.findByIdManager(1);
		List<String> codes = 
			prodDeriveManager.findAllCodesForBanqueAndStockesManager(b);
		assertTrue(codes.size() == 2);
	...
	public void testFindByCodeOrLaboWithBanqueManager() {
		...
		List<ProdDerive> list = 
			prodDeriveManager.findByCodeOrLaboWithBanqueManager(
					"PTRA.1.1", b1, false);
		assertTrue(list.size() == 1);
	...
	public void testFindByCodeOrLaboBothSideWithBanqueReturnIdsManager() {
		...
		List<Integer> list = 
			...
			.findByCodeOrLaboBothSideWithBanqueReturnIdsManager(
					"PTRA.1.1", banks, false);
		assertTrue(list.size() == 0);
		
		banks.add(b1);
		list = prodDeriveManager
			.findByCodeOrLaboBothSideWithBanqueReturnIdsManager("PTRA.1.1", 
															banks, false);
		assertTrue(list.size() == 1);
	...
	public void testFindByPatientNomReturnIdsManager() {
		...
		banks.add(b1);
		List<Integer> list = 
			prodDeriveManager.findByPatientNomReturnIdsManager(
					"DELPHINO", banks, true);
		assertTrue(list.size() == 2);
		
		list = prodDeriveManager.findByPatientNomReturnIdsManager(
						"ELPH", banks, false);
		assertTrue(list.size() == 2);
	...
	public void testGetProdDerivesManager() {
		ProdDerive derive1 = prodDeriveManager.findByIdManager(1);
		List<ProdDerive> derives = 
			prodDeriveManager.getProdDerivesManager(derive1);
		assertTrue(derives.size() == 1);
		
		ProdDerive derive2 = prodDeriveManager.findByIdManager(2);
		derives = 
			prodDeriveManager.getProdDerivesManager(derive2);
	...
	public void testGetEmplacementManager() {
		ProdDerive derive1 = prodDeriveManager.findByIdManager(1);
		Emplacement empl1 = 
			prodDeriveManager.getEmplacementManager(derive1);
		assertNotNull(empl1);
		assertTrue(empl1.getPosition().equals(1));
		assertFalse(empl1.getVide());
		
		ProdDerive derive3 = prodDeriveManager.findByIdManager(3);
		Emplacement empl3 = 
			prodDeriveManager.getEmplacementManager(derive3);
		assertNull(empl3);
		
		Emplacement emplNull = 
			prodDeriveManager.getEmplacementManager(null);
		assertNull(emplNull);
	}
	...
	public void testGetEmplacementAdrlManager() {
		ProdDerive derive1 = prodDeriveManager.findByIdManager(1);
		String adrl1 = 
			prodDeriveManager.getEmplacementAdrlManager(derive1);
		assertNotNull(adrl1);
		assertTrue(adrl1.equals("CC1.R1.T1.BT1.A-A"));
		
		ProdDerive derive3 = prodDeriveManager.findByIdManager(3);
		String adrl3 = 
			prodDeriveManager.getEmplacementAdrlManager(derive3);
		assertNotNull(adrl3);
		assertTrue(adrl3.equals(""));
		
		String adrlNull = 
			prodDeriveManager.getEmplacementAdrlManager(null);
	...
	public void testFindDoublon() {
		...
		ProdDerive derive2 = prodDeriveManager.findByIdManager(1);
	...
	@Test
	public void testFindAfterDateCreationManager() 
		...
		cal.setTime(search);
		List<Integer> liste = prodDeriveManager
		...
		cal.setTime(search);
		liste = prodDeriveManager.findAfterDateCreationReturnIdsManager(
				cal, banks);
		assertTrue(liste.size() == 0);
		//null recherche
		liste = prodDeriveManager.findAfterDateCreationReturnIdsManager(
	...
	public void testFindByTransformationManager() {
		...
		List<ProdDerive> derives = prodDeriveManager
									.findByTransformationManager(transfo);
		assertTrue(derives.size() == 1);
	...
	public void testFindByParentAndTypeManager() {
		...
		List<ProdDerive> res = prodDeriveManager
			.findByParentAndTypeManager(e1, "ADN");
		...
		ProdDerive pd1 = prodDeriveManager.findByIdManager(1);
	...
	public void testFindByCodeInListManager() {
		...
		notfounds.clear();
		criteres.add("PTRA.1.1");
		liste = prodDeriveManager.findByCodeInListManager(
				criteres, bks, notfounds);
		assertTrue(liste.size() == 1);
	...
	public void testFindByPatientNomOrNipInListManager() {
		...
		criteres.add("DELPHINO");
		criteres.add("12");
		liste = prodDeriveManager.findByPatientNomOrNipInListManager(
				criteres, bks);
		assertTrue(liste.size() == 3);
	...
	public void testCrud() {
		...
		Unite quantite = uniteManager.findByIdManager(5);
		...
		ModePrepaDerive mode = modePrepaDeriveDao.findById(1);
		...
		try {
			prodDeriveManager.createObjectManager(
					derive1, null, type, null, null, null, null, null, 
					null, null, null, null, null, null, null, null, true, "/tmp/",
					false);
		} catch (Exception e) {
		...
		try {
			prodDeriveManager.createObjectManager(
					derive1, banque, null, null, null, null, null, null,
					null, null, null, null, null, null, null, null, true, "/tmp/",
					false);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
		...
		try {
			prodDeriveManager.createObjectManager(
					derive1, banque, type, null, null, null, null, null,
					null, null, null, null, null, null, null, null, true, "/tmp/",
					false);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
		...
		try {
			prodDeriveManager.createObjectManager(
					derive1, banque, type, statut, null, null, null, null,
					null, null, null, null, null, null, null, null, true, "/tmp/",
					false);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
		...
		try {
			prodDeriveManager.createObjectManager(
					derive1, banque, type, statut, null, empl, null, null,
					null, null, null, null, null, null, null, null, true, "/tmp/",
					false);
		...
		try {
			prodDeriveManager.createObjectManager(
					derive1, banque, type, statut, null, null, null, null, 
					null, null, null, badT, null, null, null, null, true, "/tmp/",
					false);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"EntiteObjectIdNotExistException")) {
				catched = true;
			}
		}
		assertTrue(catched);
		...
		prodDeriveManager.createObjectManager(
				derive1, banque, type, statut, null, null, null, null,
				null, null, null, newT, null, null, null, utilisateur, false, "/tmp/",
				false);
		int id1 = derive1.getProdDeriveId();
		assertTrue(derive1.getProdDeriveId() == id1);
		assertTrue(getOperationManager()
								.findByObjectManager(derive1).size() == 1);
		...
		int idNewT = newT.getTransformationId();
		...
		derive2.setConc(num);
		Transformation upT = transformationManager.findByIdManager(idNewT);
		upT.setQuantite((float) 21.3);
		prodDeriveManager.createObjectManager(
				derive2, banque, type, statut, collab, emp, 
				volume, conc, quantite, mode, qualite, upT, null, null, reserv,
				utilisateur, true, "/tmp/",
				false);
		int id2 = derive2.getProdDeriveId();
		assertTrue(derive2.getProdDeriveId() == id2);
		assertTrue(getOperationManager()
								.findByObjectManager(derive2).size() == 1);
		assertTrue(transformationManager.findAllObjectsManager().size() == 6);
		...
		assertTrue(testInsert.getTransformation()
				.getQuantite().equals((float) 21.3));
		
		// Suppression
		ProdDerive derive3 = prodDeriveManager.findByIdManager(id1);
		prodDeriveManager.removeObjectManager(derive3, null, utilisateur, null);
		ProdDerive derive4 = prodDeriveManager.findByIdManager(id2);
		...
		assertTrue(getOperationManager()
				.findByObjectManager(derive1).size() == 0);
		assertTrue(getOperationManager()
				.findByObjectManager(derive2).size() == 0);
		assertTrue(transformationManager.findAllObjectsManager().size() == 5);
		
		// Update
		ProdDerive derive5 = new ProdDerive();
		derive5.setCode("PTRA.1.3");
		derive5.setProdType(type);
		derive5.setBanque(banque);
		prodDeriveManager.createObjectManager(
				derive5, banque, type, objetStatutManager.findByIdManager(4), 
				null, null, null, null,
				null, null, null, null, null, null, null, utilisateur, true, "/tmp/",
				false);
		int id3 = derive5.getProdDeriveId();
		assertTrue(derive5.getProdDeriveId() == id3);
		Boolean catchedUpdate = false;
		
		// on test l'update avec une banque nulle
		ProdDerive derive6 = prodDeriveManager.findByIdManager(id3);
		String codeUpdated1 = "PTRA.1.5";
		String codeUpdated2 = "PTRA.1.2";
		String codeUpdated3 = "PTRA.1.6";
		derive6.setCode(codeUpdated1);
		try {
			prodDeriveManager.updateObjectManager(
					derive6, null, type, null, null, null, null, null,
		...
		ProdDerive derive7 = prodDeriveManager.findByIdManager(id3);
		derive6.setCode(codeUpdated1);
		try {
			prodDeriveManager.updateObjectManager(
					derive7, banque, null, null, null, null, null, null,
					null, null, null, null, null, null, null, null, null, null, true,
					null, "/tmp/");
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
		...
		// est lancée
		ProdDerive derive8 = prodDeriveManager.findByIdManager(id3);
		derive8.setCode(codeUpdated2);
		try {
			prodDeriveManager.updateObjectManager(
					derive8, banque, type, null, null, null, null, null,
					null, null, null, null, null, null, null, null, null, null, true,
					null, "/tmp/");
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
		...
		ProdDerive derive9 = prodDeriveManager.findByIdManager(id3);
		// MAJ emplacemet Emplacement occupé par un dérivé
		try {
			prodDeriveManager.updateObjectManager(
					derive9, banque, type, null, null, empl, null, null,
					null, null, null, null, null, null, null, null, null, null, true,
					null, "/tmp/");
		} catch (TKException ex) {
			catchedUpdate = true; 
		...
		try {
			prodDeriveManager.updateObjectManager(
					derive8, banque, type, null, null, null, null, null,
					null, null, null, badT, null, null, null, null, null, null, true,
					null, "/tmp/");
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"EntiteObjectIdNotExistException")) {
		...
		Transformation newT2 = new Transformation();
		...
		prodDeriveManager.updateObjectManager(
				derive9, banque, type, null, null, null, null, null,
				null, null, null, newT2, null, null, null, null, null, utilisateur, false,
				null, "/tmp/");
		ProdDerive derive10 = prodDeriveManager.findByIdManager(id3);
		assertTrue(derive10.getCodeLabo().equals("LAB"));
		assertTrue(getOperationManager()
							.findByObjectManager(derive9).size() == 2);
		ProdDerive testInsert2 = prodDeriveManager.findByIdManager(id3);
		assertTrue(testInsert2.getQuantite() < 0);
		assertTrue(transformationManager.findAllObjectsManager().size() == 6);
		int idNewT2 = newT2.getTransformationId();
		
		// On teste une mise à jour valide avec les assos et une
		// transfo existante
		ProdDerive derive11 = prodDeriveManager.findByIdManager(id3);
		...
		Transformation upT2 = transformationManager.findByIdManager(idNewT2);
		...
		prodDeriveManager.updateObjectManager(
				derive11, banque, type, statut, collab, emp, 
				volume, conc, quantite, mode, 
				qualite, upT2, null, null, null, null, reserv,
				utilisateur, true, opTypes, "/tmp/");
		ProdDerive derive12 = prodDeriveManager.findByIdManager(id3);
		assertTrue(derive12.getCode().equals(codeUpdated3));
		assertTrue(getOperationManager()
							.findByObjectManager(derive11).size() == 5);
		assertTrue(transformationManager.findAllObjectsManager().size() == 6);
		...
		assertTrue(testInsert2.getTransformation()
				.getQuantite().equals((float) 21.3));
		
		ProdDerive derive13 = prodDeriveManager.findByIdManager(id3);
		...
		assertTrue(getOperationManager()
								.findByObjectManager(derive13).size() == 0);
		assertTrue(transformationManager.findAllObjectsManager().size() == 5);
	...
	public void testFindParent() {
		String code = "PTRA.1.1";
		List<ProdDerive> derives = prodDeriveManager
				.findByCodeLikeManager(code, true);
		assertTrue(derives.size() == 1);
		ProdDerive derive = derives.get(0);
		assertTrue(derive.getCode().equals(code));
		Echantillon echantillon = echantillonManager
				.findByIdManager(((Echantillon) prodDeriveManager
						.findParent(derive)).getEchantillonId());
		assertTrue(echantillonManager.getProdDerivesManager(echantillon)
				.contains(derive));
	}
	...
	public void testGetPrelevementParent() {
		ProdDerive pd1 = prodDeriveManager.findByIdManager(1);
		Prelevement prel1 = prodDeriveManager.getPrelevementParent(pd1);
		assertNotNull(prel1);
		assertTrue(prel1.getCode().equals("PRLVT1"));
		
		ProdDerive pd2 = prodDeriveManager.findByIdManager(2);
		Prelevement prel2 = prodDeriveManager.getPrelevementParent(pd2);
		assertNotNull(prel2);
		assertTrue(prel2.getCode().equals("PRLVT1"));
		
		ProdDerive pd3 = prodDeriveManager.findByIdManager(3);
		Prelevement prel3 = prodDeriveManager.getPrelevementParent(pd3);
		assertNotNull(prel3);
		assertTrue(prel3.getCode().equals("PRLVT1"));
		
		ProdDerive pd4 = prodDeriveManager.findByIdManager(4);
		Prelevement prel4 = prodDeriveManager.getPrelevementParent(pd4);
		assertNotNull(prel4);
	...
	public void testGetPatientParent() {
		ProdDerive pd1 = prodDeriveManager.findByIdManager(1);
		Patient pat1 = prodDeriveManager.getPatientParentManager(pd1);
		assertNotNull(pat1);
		assertTrue(pat1.getNom().equals("DELPHINO"));
		
		ProdDerive pd2 = prodDeriveManager.findByIdManager(2);
		Patient pat2 = prodDeriveManager.getPatientParentManager(pd2);
		assertNotNull(pat2);
		assertTrue(pat2.getNom().equals("DELPHINO"));
		
		ProdDerive pd3 = prodDeriveManager.findByIdManager(3);
		Patient pat3 = prodDeriveManager.getPatientParentManager(pd3);
		assertNotNull(pat3);
		assertTrue(pat3.getNom().equals("DELPHINO"));
		
		ProdDerive pd4 = prodDeriveManager.findByIdManager(4);
		Patient pat4 = prodDeriveManager.getPatientParentManager(pd4);
		assertNotNull(pat4);
		assertTrue(pat4.getNom().equals("MAYER"));
	}
	
	private void validationInsert(ProdDerive derive) {
		// Récupération des objets associés à un produit dérivé
		Banque banque = banqueManager.findByIdManager(1);
		ProdType type = prodTypeManager.findByIdManager(1);
		Utilisateur utilisateur = utilisateurDao.findById(1);
		...
		String[] codes = new String[]{"", "  ", null, "l#jd$$", 
				createOverLength(50), "GOOD"};
		String[] codesLabos = new String[]{"", " ", "%¢¢kjs", 
				createOverLength(10), "GOOD"};
			...
			for (int j = 0; j < codesLabos.length; j++) {
				...
				try {
					...
					if (i != 5 || j != 4) { //car creation valide
						prodDeriveManager.createObjectManager(derive, banque, 
		...
		Calendar transfo = Calendar.getInstance();
		try {
			stock.setTime(new SimpleDateFormat("dd/MM/yyyy")
												.parse("01/06/2009"));
			transfo.setTime(new SimpleDateFormat("dd/MM/yyyy")
												.parse("05/06/2009"));
		...
		float qte1 = (float) 2.0;
		float vol1 = (float) 1.0;
		float conc1 = (float) 1.0;
		...
		Unite volume = uniteManager.findByIdManager(4);
		Unite conc = uniteManager.findByIdManager(2);
		catchedInsert = false;
		try {
			prodDeriveManager.createObjectManager(derive, banque, 
					type, null, null, null, volume, 
					conc, quantite, null, null, null, null, null, null,
					utilisateur, true, "/tmp/",
					false);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
	...
	private void validationUpdate(ProdDerive derive) {
		// Récupération des objets associés à un produit dérivé
		Banque banque = banqueManager.findByIdManager(1);
		ProdType type = prodTypeManager.findByIdManager(1);
		Utilisateur utilisateur = utilisateurDao.findById(1);
		...
		boolean catchedUpdate = false;
		String[] codes = new String[]{"", "  ", null, "l¢ËÊ¢jd%", 
				createOverLength(50), "GOOD"};
		String[] codesLabos = new String[]{"", " ", "%$$ÆÂ¢kjs", 
				createOverLength(10), "GOOD"};
		for (int i = 0; i < codes.length; i++) {
			for (int j = 0; j < codesLabos.length; j++) {
				catchedUpdate = false;
				try {
					...
					derive.setCodeLabo(codesLabos[j]);
					if (i != 5 || j != 4) { //car creation valide
						prodDeriveManager.updateObjectManager(derive, banque, 
								type, null, null, null, null, null,
								null, null, null, null, null, null, null,
								null, null,
								utilisateur, true,
		...
		try {
			prodDeriveManager.updateObjectManager(derive, banque, 
					...
					null, null, null, null, null, null, null, utilisateur, true,
					null, "/tmp/");
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"ValidationException")) {
...
//		Reservation reserv = reservationManager.findByIdManager(1);
		...
		derives.add(derive1); derives.add(derive2); derives.add(derive3);
		...
		prodDeriveManager.createDeriveListWithAnnotsManager(derives, 
								banque, newT, utilisateur, listAnnots, "/tmp/", 
		...
		int id1 = derive1.getProdDeriveId();
		int id2 = derive2.getProdDeriveId();
		int id3 = derive3.getProdDeriveId();
		...
		String codeLaboUp = "heya";
		ProdDerive deriveUp1 = prodDeriveManager.findByIdManager(id1);
		ProdDerive deriveUp2 = prodDeriveManager.findByIdManager(id2);
		ProdDerive deriveUp3 = prodDeriveManager.findByIdManager(id3);
		deriveUp1.setCodeLabo(codeLaboUp);
		deriveUp2.setCodeLabo(codeLaboUp);
		deriveUp3.setCodeLabo(codeLaboUp);
		List<ProdDerive> list = new ArrayList<ProdDerive>();
		list.add(deriveUp1);
		list.add(deriveUp2);
		list.add(deriveUp3);
		listAnnots.clear();
		listAnnots.addAll(annotationValeurManager
			.findByChampAndObjetManager(champAnnotationDao.findById(18), 
																derive1));
		listAnnots.addAll(annotationValeurManager
			.findByChampAndObjetManager(champAnnotationDao.findById(18), 
																derive2));
		...
		prodDeriveManager.updateMultipleObjectsManager(list, null,
							listAnnots, listDelete, ncfsTrait, ncfsCess, 
							utilisateur, "/tmp/");
		
		ProdDerive deriveTest1 = prodDeriveManager.findByIdManager(id1);
		ProdDerive deriveTest2 = prodDeriveManager.findByIdManager(id2);
		ProdDerive deriveTest3 = prodDeriveManager.findByIdManager(id3);
		...
		assertTrue(objetNonConformeDao.findByObjetAndEntite(id1, 
				entiteManager.findByIdManager(8)).size() == 2);
		...
		try {
			prodDeriveManager.updateMultipleObjectsManager(list, null, 
									...
									new ArrayList<NonConformite>(), null,
													utilisateur, "/tmp/");
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"ValidationException")) {
		...
		assertTrue(catched);
		ProdDerive deriveTest4 = prodDeriveManager.findByIdManager(id1);
		ProdDerive deriveTest5 = prodDeriveManager.findByIdManager(id2);
		ProdDerive deriveTest6 = prodDeriveManager.findByIdManager(id3);
		...
		assertTrue(catched);
		ProdDerive deriveTest7 = prodDeriveManager.findByIdManager(id1);
		ProdDerive deriveTest8 = prodDeriveManager.findByIdManager(id2);
		ProdDerive deriveTest9 = prodDeriveManager.findByIdManager(id3);
		...
		try {
			prodDeriveManager
				.updateMultipleObjectsManager(list, null, listAnnots, listDelete, 
											null, null, utilisateur, "/tmp/");
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"ValidationException")) {
				catched = true;
		...
		assertTrue(catched);
		assertTrue(prodDeriveManager.findByIdManager(id1).getCodeLabo()
													.equals(codeLaboUp));
		assertTrue(prodDeriveManager.findByIdManager(id2).getCodeLabo()
													.equals(codeLaboUp));
		assertTrue(prodDeriveManager.findByIdManager(id3).getCodeLabo()
													.equals(codeLaboUp));
		
		assertFalse(annotationValeurManager
				.findByChampAndObjetManager(champAnnotationDao.findById(18), 
										prodDeriveManager.findByIdManager(id3))
						.get(0).getBool());
		...
		prodDeriveManager
				.updateMultipleObjectsManager(list, null, listAnnots, listDelete, 
						null, new ArrayList<NonConformite>(), utilisateur, "/tmp/");
		assertTrue(prodDeriveManager.findByIdManager(id3).getCodeLabo()
														.equals(codeLaboUp2));
		assertTrue(annotationValeurManager
				.findByChampAndObjetManager(champAnnotationDao.findById(18), 
										prodDeriveManager.findByIdManager(id1))
						.get(0).getBool());
		assertTrue(annotationValeurManager
				.findByChampAndObjetManager(champAnnotationDao.findById(17), 
										prodDeriveManager.findByIdManager(id2))
						.get(0).getAlphanum().equals("yy"));
		assertTrue(annotationValeurManager
				.findByChampAndObjetManager(champAnnotationDao.findById(17), 
										prodDeriveManager.findByIdManager(id3))
						.size() == 0);
		assertTrue(objetNonConformeDao.findByObjetAndEntite(id1, 
				entiteManager.findByIdManager(8)).size() == 1);
		assertTrue(objetNonConformeDao.findByObjetAndEntite(id2, 
				entiteManager.findByIdManager(8)).size() == 1);
		assertTrue(objetNonConformeDao.findByObjetAndEntite(id3, 
				entiteManager.findByIdManager(8)).size() == 1);
		...
		Transformation t = transformationManager.findByIdManager(idNewT);
		prodDeriveManager.removeObjectCascadeManager(t, null, utilisateur, null);
		assertTrue(getOperationManager()
				.findByObjectManager(deriveTest7).size() == 0);
		assertTrue(getOperationManager()
				.findByObjectManager(deriveTest8).size() == 0);
		assertTrue(transformationManager.findAllObjectsManager().size() == 5);
		assertTrue(annotationValeurManager
	...
	public void testDateStockCoherence() throws ParseException {
		ProdDerive derive = new ProdDerive();
		Calendar transfo = Calendar.getInstance();
		transfo.setTime(new SimpleDateFormat("dd/MM/yy")
													.parse("01/01/1973"));
		Calendar stock = Calendar.getInstance();
		...
		assertEquals("date.validation.infDateTransfo",
		...
		errs = prodDeriveValidator.checkDateStockCoherence(derive);
		assertEquals("date.validation.infDateStockEchan",
												errs.getFieldError().getCode());
		...
		errs = prodDeriveValidator.checkDateStockCoherence(derive);
		assertEquals("date.validation.infDateStockDeriveParent",
												errs.getFieldError().getCode());
	...
	public void testDateTransfoCoherence() throws ParseException {
		...
		test.setTime(new SimpleDateFormat("dd/MM/yy")
											.parse("12/13/2008 10:00:00"));
		...
		errs = prodDeriveValidator.checkDateTransfoCoherence(derive);
		assertEquals("date.validation.supDateStock",
												errs.getFieldError().getCode());
	...
	public void testCreateDeriveListWithAnnotsManager() {
		...
		ProdDerive derive1 = new ProdDerive();
		derive1.setCode("Code1"); derive1.setProdType(type);
		derive1.setObjetStatut(st);
		derives.add(derive1);
		ProdDerive derive2 = new ProdDerive();
		derive2.setCode("Code2"); derive2.setProdType(type);
		derive2.setObjetStatut(st);
		derives.add(derive2);
		ProdDerive derive3 = new ProdDerive();
		derive3.setCode("Code$!"); derive3.setProdType(type);
		derive3.setObjetStatut(st);
		derives.add(derive3);
		
		List<AnnotationValeur> valeurs = new ArrayList<AnnotationValeur>();
		
		AnnotationValeur bool2 = new AnnotationValeur();
		bool2.setChampAnnotation(champAnnotationDao.findById(18));
		bool2.setBool(true);
		bool2.setBanque(banque);
		valeurs.add(bool2);
		AnnotationValeur alpha = new AnnotationValeur();
		alpha.setAlphanum("$$€€");
		...
		try {
			prodDeriveManager.createDeriveListWithAnnotsManager(derives, 
								banque, null, utilisateur, valeurs, "/tmp/", 
								ncfsTrait, ncfsCess);
		} catch (DeriveBatchSaveException ve) {
		...
		prodDeriveManager.createDeriveListWithAnnotsManager(derives, 
									banque, null, utilisateur, valeurs, "/tmp/",
									ncfsTrait, ncfsCess);
		assertTrue(prodDeriveManager
							.findByCodeLikeManager("Code", false).size() == 3);
		assertTrue(annotationValeurManager
										.findAllObjectsManager().size() == 18);
		assertTrue(annotationValeurManager
			.findByChampAndObjetManager(champAnnotationDao.findById(17), 
				prodDeriveManager.findByCodeLikeManager("Code", false).get(0))
					.get(0).getAlphanum().equals("ok"));
		
		assertFalse(prodDeriveManager.findByIdManager(derive1.getProdDeriveId())
				.getConformeCession());
		assertFalse(prodDeriveManager.findByIdManager(derive1.getProdDeriveId())
				.getConformeTraitement());
		assertFalse(prodDeriveManager.findByIdManager(derive2.getProdDeriveId())
				.getConformeCession());
		assertFalse(prodDeriveManager.findByIdManager(derive2.getProdDeriveId())
				.getConformeTraitement());
		assertFalse(prodDeriveManager.findByIdManager(derive3.getProdDeriveId())
				.getConformeCession());
		assertFalse(prodDeriveManager.findByIdManager(derive3.getProdDeriveId())
				.getConformeTraitement());
		
		assertTrue(objetNonConformeDao
				.findByObjetAndEntite(derive1.getProdDeriveId(), 
				entiteManager.findByIdManager(8)).size() == 3);
		assertTrue(objetNonConformeDao
				.findByObjetAndEntite(derive2.getProdDeriveId(),
				entiteManager.findByIdManager(8)).size() == 3);
		assertTrue(objetNonConformeDao.findByObjetAndEntite(
				derive3.getProdDeriveId(),
				entiteManager.findByIdManager(8)).size() == 3);

		// clean up
		for (int i = 0; i < derives.size(); i++) {	
			prodDeriveManager
				.removeObjectManager(derives.get(i), null, utilisateur, null);
		}
	...
	public void testRemoveUsedAndCessedObject() {
		 ...
		 ProdDerive p3 = prodDeriveManager.findByIdManager(3);
		 try {
	...
	public void testCascadeDeriveChildren() {
		...
		ProdType pType = prodTypeManager.findByIdManager(1);
		ObjetStatut st = objetStatutManager.findByIdManager(4);
		
		prodDeriveManager.createObjectManager(p, b, pType, 
				st, null, null, 
		...
		//insertion valide
		retourManager.createOrUpdateObjectManager(r, p, null, null, null, 
		...
		Entite entite = entiteManager.findByIdManager(8);
		...
		ProdDerive derive1 = new ProdDerive();
		derive1.setCode("D1"); derive1.setProdType(pType);
		derive1.setObjetStatut(st);
		derives.add(derive1);
		ProdDerive derive2 = new ProdDerive();
		derive2.setCode("D2"); derive2.setProdType(pType);
		derive2.setObjetStatut(st);
		derives.add(derive2);
		ProdDerive derive3 = new ProdDerive();
		derive3.setCode("D3"); derive3.setProdType(pType);
		derive3.setObjetStatut(st);
		derives.add(derive3);
	
		prodDeriveManager.createDeriveListWithAnnotsManager(derives, 
										b, transfo1, utilisateur, null, null, 
										null, null);
		
		assertTrue(transformationManager
						.findAllDeriveFromParentManager(p).size() == 3);
		...
		try {
			 ...
			 assertTrue(oe.getKey()
					 .equals("derive.deletion.isUsedCascade"));
		...
		Unite qteUnite = uniteManager.findByIdManager(5);
		cederObjetManager.createObjectManager(ced2, c, 
			entiteManager.findByNomManager("ProdDerive").get(0), qteUnite);
		
		catched = false;
		try {
			prodDeriveManager
				.removeObjectCascadeManager(p, null, u, null);
		} catch (ObjectUsedException oe) {
	...
	public void testFindByParentManager() {
		Echantillon e1 = echantillonManager.findByIdManager(1);
		List<ProdDerive> derives = 
			prodDeriveManager.findByParentManager(e1, false);
		assertTrue(derives.size() == 1);
	...
	public void testCreateUpdateDeriveWithAnnots() {
		...
		ChampAnnotation c = champAnnotationDao.findById(17);
		
		AnnotationValeur a1 = new AnnotationValeur();
		...
		boolean catched = false;
		try {
			prodDeriveManager.createObjectManager(derive, b1, type, 
					objetStatutManager.findByIdManager(4), 
					null, null, null, null, null, null, null, null, 
					listAnnots, null, null, utilisateur, true, "/tmp/",
					false);
		...
		assertTrue(prodDeriveManager
				.findByCodeLikeManager("deriveAnnotated", true).size() == 1);
		assertTrue(annotationValeurManager
				.findByChampAndObjetManager(c, derive).get(0)
											.getAlphanum().equals("alpha1"));
		assertTrue(getOperationManager()
				.findByObjectManager(derive).size() == 2);
		assertTrue(getOperationManager()
				.findByObjetIdEntiteAndOpeTypeManager(derive, 
		...
		listDelete.add(annotationValeurManager
				.findByChampAndObjetManager(c, derive).get(0));
		listAnnots.clear();
		AnnotationValeur a2 = new AnnotationValeur();
		a2.setChampAnnotation(c);
		a2.setAlphanum("789");
		a2.setBanque(b1);
		listAnnots.add(a2);
		AnnotationValeur bool1 = new AnnotationValeur();
		ChampAnnotation c2 = champAnnotationDao.findById(18);
		bool1.setChampAnnotation(c2);
		bool1.setBool(true);
		bool1.setBanque(b1);
		listAnnots.add(bool1);
						
		prodDeriveManager.updateObjectManager(derive, b1, type, null, 
				null, null, null, null, null, null, null, null, 
				listAnnots, listDelete, null, null, null, utilisateur, true, null, "/tmp/");
		
		assertTrue(prodDeriveManager
				.findByCodeLikeManager("deriveAnnotated", true).size() == 1);
		assertTrue(annotationValeurManager
				.findByChampAndObjetManager(c, derive).size() == 1);
		assertTrue(annotationValeurManager
				.findByChampAndObjetManager(c, derive).get(0)
									.getAlphanum().equals("789"));
		assertTrue(annotationValeurManager
				.findByChampAndObjetManager(c2, derive).get(0).getBool());
		assertTrue(getOperationManager()
				.findByObjectManager(derive).size() == 4);
		assertTrue(getOperationManager()
				.findByObjetIdEntiteAndOpeTypeManager(derive, 
				operationTypeDao.findByNom("Annotation").get(0)).size() == 2);
...
//				.findByChampAndObjetManager(c2, echan).get(0));
		...
		assertTrue(annotationValeurManager
				.findByChampAndObjetManager(c, derive).size() == 0);
		assertTrue(annotationValeurManager
				.findByChampAndObjetManager(c2, derive).size() == 1);
		assertTrue(getOperationManager()
				.findByObjectManager(derive).size() == 6);
		assertTrue(getOperationManager()
			.findByObjetIdEntiteAndOpeTypeManager(derive, 
				operationTypeDao.findByNom("Annotation").get(0)).size() == 3);
		
		// Nettoyage
		prodDeriveManager.removeObjectManager(derive, null, utilisateur, null);
		
		assertTrue(getOperationManager()
								.findByObjectManager(derive).size() == 0);
		assertTrue(annotationValeurManager
										.findAllObjectsManager().size() == 12);
		testFindAll();
	...
	public void testSwitchBanque() {
		...
		prodDeriveManager.createObjectManager(p, b3, 
			prodTypeManager.findByIdManager(1), 
			objetStatutManager.findByIdManager(4), null, null, null, null, 
			null, null, null, null, null, null, null, u, false, "/tmp/",
			false);
		...
		ProdDerive pbis = new ProdDerive(); pbis.setCode("JEG.1.2");	
		pbis.setObjetStatut(objetStatutManager.findByIdManager(4));
		prodDeriveManager.createObjectManager(pbis, b4, 
				prodTypeManager.findByIdManager(1), 
				objetStatutManager.findByIdManager(4), null, null, null, null, 
				null, null, null, null, null, null, null, u, false, "/tmp/",
				false);
		...
		prodDeriveManager.updateObjectManager(p, p.getBanque(), p.getProdType(), p.getObjetStatut(), 
					null, null, null, null, null, null, null, null, null, null, null, null, 
					null, u, false, null, null);
		...
		transformationManager.createObjectManager(transfo1, 
									entiteManager.findByIdManager(8), null);	
		ProdDerive derive = new ProdDerive();
		derive.setCode("deriveSwitch");
		prodDeriveManager.createObjectManager(derive, b2, 
			prodTypeManager.findByIdManager(1),
			objetStatutManager.findByIdManager(4), null, null, null, null, 
			null, null, null, transfo1, null, null, null, u, false, "/tmp/",
			false);
		...
		prodDeriveManager.updateObjectManager(derive, derive.getBanque(), 
			...
			null, derive.getTransformation(), null, null, 
			null, null, null, u, false, null, "/tmp/");
		...
		prodDeriveManager.updateObjectManager(derive, derive.getBanque(), 
				derive.getProdType(), null, null, null, null, null, null, null, 
					null, transfo1, null, null, null, null, 
					null, u, false, null, "/tmp/");
		prodDeriveManager.updateObjectManager(p, p.getBanque(), 
				p.getProdType(), null, null, emp, null, null, null, null, 
					null, null, null, null, null, null, null, u, false, null, "/tmp/");
		...
		listAnnots.add(num);
		AnnotationValeur bool = new AnnotationValeur();
		bool.setChampAnnotation(champAnnotationDao.findById(18));
		bool.setBool(true); bool.setBanque(b1);
		listAnnots.add(bool);	
		prodDeriveManager.updateObjectManager(p, p.getBanque(), 
				p.getProdType(), null, null, emp, null, null, null, null, 
				null, null, listAnnots, null, null, null, 
				null, u, false, null, "/tmp/");
		assertTrue(annotationValeurManager
								.findByObjectManager(p).size() == 2);
		
		prodDeriveManager.switchBanqueCascadeManager(p, b3, true, u, null);
		// switched ok
		assertTrue(annotationValeurManager
							.findByObjectManager(p).size() == 0);
	...
	public void testStatutEmplacementValidation() {
		...
		try {
			BeanValidator.validateObject(
					e, new Validator[]{prodDeriveValidator});
		} catch (ValidationException ve) {
			assertEquals("prodDerive.statut.incoherent", ve.getErrors()
	...
	public void testCreateUpdateWithNonConformites() {
		...
		ProdDerive p0 = new ProdDerive();
		p0.setCode("p0");
		
		prodDeriveManager.createObjectWithNonConformitesManager(p0, banqueDao.findById(1), 
				prodTypeManager.findByIdManager(1), 
				objetStatutManager.findByIdManager(4), null, null, null, null, 
				null, null, null, null, null, null, u, false, null, false, 
				ncfsTrait, ncfsCess); 
		
		assertTrue(objetNonConformeDao.findByObjetAndEntite(p0.getProdDeriveId(),
				entiteManager.findByIdManager(8)).size() == 0);
		...
		prodDeriveManager.createObjectWithNonConformitesManager(p1, banqueDao.findById(1), 
				prodTypeManager.findByIdManager(1), 
				objetStatutManager.findByIdManager(4), null, null, null, null, 
				null, null, null, null, null, null, u, false, null, false, 
				ncfsTrait, ncfsCess); 
		...
		assertTrue(objetNonConformeDao.findByObjetAndEntite(p1.getProdDeriveId(),
				entiteManager.findByIdManager(8)).size() == 3);
		assertFalse(p1.getConformeTraitement());
		assertFalse(p1.getConformeCession());
		
		ProdDerive p2 = new ProdDerive();
		p2.setCode("p2");
		
		prodDeriveManager.createObjectWithNonConformitesManager(p2, banqueDao.findById(1), 
				prodTypeManager.findByIdManager(1), 
				objetStatutManager.findByIdManager(4), null, null, null, null, 
				null, null, null, null, null, null, u, false, null, false, 
				null, null); 
		
		assertTrue(objetNonConformeDao.findByObjetAndEntite(p2.getProdDeriveId(),
				entiteManager.findByIdManager(8)).size() == 0);
		...
		prodDeriveManager.updateObjectWithNonConformitesManager(p1, banqueDao.findById(1), 
				prodTypeManager.findByIdManager(1), 
				objetStatutManager.findByIdManager(4),
				null, null, null, null, null, null, null, null, null, null, null, u, 
				false, null, null, ncfsTrait, ncfsCess);
		...
		assertTrue(objetNonConformeDao.findByObjetAndEntite(p1.getProdDeriveId(),
				entiteManager.findByIdManager(8)).size() == 2);
		assertTrue(objetNonConformeDao.findByObjetEntiteAndType(p1.getProdDeriveId(),
				entiteManager.findByIdManager(8), 
				conformiteTypeDao.findById(4)).size() == 1);
		assertTrue(objetNonConformeDao.findByObjetEntiteAndType(p1.getProdDeriveId(),
				entiteManager.findByIdManager(8), 
				conformiteTypeDao.findById(5)).size() == 1);
	...
	public void testCreateDerivesEmplacement() throws ParseException {
		...
		Hashtable<ProdDerive, Emplacement> empls = new Hashtable<ProdDerive, Emplacement>();
		...
		dateS.setTime(new SimpleDateFormat("dd/MM/yy HH:mm")
			.parse("12/12/2012 22:21"));
		
		// 1 Sans parent		
		prodDeriveManager.createProdDerivesManager(derives, 
				b2, u2, 
				null, 
				null, 
				empls, 
		...
		List<ProdDerive> created = prodDeriveManager
				.findByCodeOrLaboWithBanqueManager("PD_", b2, false);
		...
		List<Emplacement> emps = emplacementManager.findByTerminaleWithOrder(terminaleDao.findById(6));
		...
		assertFalse(getOperationManager()
				.findByObjetIdEntiteAndOpeTypeManager(pd1, 
						operationTypeDao.findByNom("Stockage").get(0)).isEmpty());
		assertTrue(getOperationManager()
				.findByObjetIdEntiteAndOpeTypeManager(pd2, 
						operationTypeDao.findByNom("Stockage").get(0)).isEmpty());
		assertFalse(getOperationManager()
				.findByObjetIdEntiteAndOpeTypeManager(pd3, 
						operationTypeDao.findByNom("Stockage").get(0)).isEmpty());
		
		// clean up
		Emplacement e7 = emps.get(1);
		e7.setVide(true);
		e7.setEntite(null);
		e7.setObjetId(null);
		emplacementManager.updateObjectManager(e7, e7.getTerminale(), null);
		
		ObjetStatut nonstocke = 
				objetStatutManager.findByStatutLikeManager("NON STOCKE", true).get(0);
		pd1.setEmplacement(null); pd1.setObjetStatut(nonstocke);
		// pd2.setEmplacement(null); pd2.setObjetStatut(nonstocke);
		pd3.setEmplacement(null); pd3.setObjetStatut(nonstocke);
		prodDeriveManager
			.updateMultipleObjectsManager(derives, derives, 
								null, null, null, null, u2, "/tmp/");
	...
	public void testCreateDerivesPrelevement() throws ParseException {
		...
		Hashtable<ProdDerive, List<AnnotationValeur>> annos = new Hashtable<ProdDerive, List<AnnotationValeur>>();
		List<AnnotationValeur> avs1 = new ArrayList<AnnotationValeur>();
		AnnotationValeur avD1 = new AnnotationValeur();
		avD1.setChampAnnotation(champAnnotationDao.findById(17));
		avD1.setAlphanum("v1");
		avD1.setBanque(b2);
		avs1.add(avD1);
		AnnotationValeur avD2 = new AnnotationValeur();
		avD2.setChampAnnotation(champAnnotationDao.findById(18));
		avD2.setBool(true);
		avD2.setBanque(b2);
		avs1.add(avD2);
		annos.put(pd1,  avs1);
		List<AnnotationValeur> avs2 = new ArrayList<AnnotationValeur>();
		AnnotationValeur avD3 = new AnnotationValeur();
		...
		Hashtable<ProdDerive, List<NonConformite>> ncfTraits = new Hashtable<ProdDerive, List<NonConformite>>();
		List<NonConformite> ncT1 = new ArrayList<NonConformite>();
		ncT1.add(nonConformiteDao.findById(8));
		ncfTraits.put(pd3, ncT1);
		List<NonConformite> ncT2 = new ArrayList<NonConformite>();
		ncT2.add(nonConformiteDao.findById(8));
		ncT2.add(nonConformiteDao.findById(9));
		ncfTraits.put(pd1, ncT2);
		
		Hashtable<ProdDerive, List<NonConformite>> ncfCess = new Hashtable<ProdDerive, List<NonConformite>>();
		List<NonConformite> ncC1 = new ArrayList<NonConformite>();
		ncC1.add(nonConformiteDao.findById(10));
		ncC1.add(nonConformiteDao.findById(11));
		ncfCess.put(pd3, ncC1);
		List<NonConformite> ncC2 = new ArrayList<NonConformite>();
		...
		Unite mL = uniteManager.findByUniteLikeManager("ml", false).get(0);
		prelevementManager.createObjectManager(prel, b2, p1.getNature(), null, 
				p1.getConsentType(), null, null, null, null, null, null, null,
				mL, null, null, null, u2, false, "/tmp/", false);
		...
		Transformation transfo = transformationManager
				.findByEntiteObjetManager(entiteManager.findByNomManager("Prelevement").get(0), 
						prel.getPrelevementId()).get(0);
		...
		assertTrue(objetNonConformeDao.findByObjetEntiteAndType(pd1.getProdDeriveId(), 
						entiteManager.findByIdManager(8), conformiteTypeDao.findById(4)).size() == 2);
		assertNull(pd1.getConformeCession());
		assertTrue(objetNonConformeDao.findByObjetEntiteAndType(pd1.getProdDeriveId(), 
					entiteManager.findByIdManager(8), conformiteTypeDao.findById(5)).isEmpty());
		assertNull(pd2.getConformeTraitement());
		assertTrue(objetNonConformeDao.findByObjetEntiteAndType(pd2.getProdDeriveId(), 
					entiteManager.findByIdManager(8), conformiteTypeDao.findById(4)).isEmpty());
		assertFalse(pd2.getConformeCession());
		assertTrue(objetNonConformeDao.findByObjetEntiteAndType(pd2.getProdDeriveId(), 
					entiteManager.findByIdManager(8), conformiteTypeDao.findById(5)).size() == 1);
		assertFalse(pd3.getConformeTraitement());
		assertTrue(objetNonConformeDao.findByObjetEntiteAndType(pd3.getProdDeriveId(), 
					entiteManager.findByIdManager(8), conformiteTypeDao.findById(4)).size() == 1);
		assertFalse(pd3.getConformeCession());
		assertTrue(objetNonConformeDao.findByObjetEntiteAndType(pd3.getProdDeriveId(), 
					entiteManager.findByIdManager(8), conformiteTypeDao.findById(5)).size() == 2);
		...
		prelevementManager.createObjectManager(prel2, b2, p1.getNature(), null, 
				p1.getConsentType(), null, null, null, null, null, null, null,
		...
		prelevementManager.createObjectManager(prel3, b2, p1.getNature(), null, 
				p1.getConsentType(), null, null, null, null, null, null, null,
				mL, null, null, null, u2, false, "/tmp/", false);
	...
	public void testCreateDerivesEchantillon() throws ParseException {
		...
		new2.setPosition(4);
		new2.setVide(false);
		echantillonManager.createObjectManager(ech, b2, null, null, 
				e1.getObjetStatut(), new2, 
				e1.getEchantillonType(), null, mL, null, null, null, 
				null, null, u2, false, "/tmp/", false);
		new2 = echantillonManager.getEmplacementManager(ech);
		new2.setObjetId(ech.getEchantillonId());
		emplacementManager.updateObjectManager(new2, new2.getTerminale(), 
				entiteManager.findByNomManager("Echantillon").get(0));
		...
		try {
			...
			prodDeriveManager.createProdDerivesManager(derives, 
					b2, u2, 
					echantillonManager.findByIdManager(3), // EHT.1 EPUISE
					null, 
					null, 
					new Float(25.0), mL,
					null, 
					...
					null, 
					null);
		} catch (DeriveBatchSaveException oe) {
		...
		Transformation transfo = transformationManager
				.findByEntiteObjetManager(entiteManager.findByNomManager("Echantillon").get(0), 
						ech.getEchantillonId()).get(0);
		...
		Transformation transfo2 = pd1.getTransformation();
		...
		Transformation transfo3 = pd1.getTransformation();
		...
		assertTrue(echantillonManager.getEmplacementManager(ech) == null);
		assertTrue(getOperationManager()
			.findByObjetIdEntiteAndOpeTypeManager(ech, operationTypeDao
					.findByNom("Destockage").get(0)).size() == 1);
		...
		echantillonManager.createObjectManager(ech2, b2, null, null, 
				objetStatutManager.findByStatutLikeManager("NON STOCKE", true).get(0), null, 
				e1.getEchantillonType(), null, null, null, null, null, null, 
		...
		Transformation transfo4 = transformationManager
				.findByEntiteObjetManager(entiteManager.findByNomManager("Echantillon").get(0), 
						ech2.getEchantillonId()).get(0);
		...
		echantillonManager.updateObjectManager(ech2, b2, null, null, ech2.getObjetStatut(), null, 
				ech2.getEchantillonType(), null, null, null, null, null, null, null, null, null, 
				null, u2, false, null, "/tmp/");
		derives.clear();
		pd1 = new ProdDerive();
		pd1.setCode("PD1e");
		pd1.setProdType(prodTypeManager.findByTypeLikeManager("ADN", true).get(0));
		...
		Transformation transfo5 = pd1.getTransformation();
		...
		assertTrue(echantillonManager.getEmplacementManager(ech2) == null);
		assertTrue(getOperationManager()
			.findByObjetIdEntiteAndOpeTypeManager(ech2, operationTypeDao
					.findByNom("Destockage").get(0)).isEmpty());
		// epuisement -> creation Retour
...
//		prelevementManager.removeListFromIdsManager(ids, null, u2);
	...
	public void testCreateDerivesDerives() throws ParseException {
		...
		Unite mL = uniteManager.findByUniteLikeManager("ml", false).get(0);
		Unite mG = uniteManager.findByUniteLikeManager("mg", false).get(0);

		List<ProdDerive> derivesToCreate = new ArrayList<ProdDerive>();
		ProdDerive der1 = new ProdDerive();
		...
		ProdDerive der2 = new ProdDerive();
		...
		ProdDerive der3 = new ProdDerive();
		...
		// 1 Sans parent		
		prodDeriveManager.createProdDerivesManager(derivesToCreate, 
				b2, u2, 
				null, 
				null, 
				empls, 
		...
		Transformation transfo = transformationManager
				.findByEntiteObjetManager(entiteManager.findByNomManager("ProdDerive").get(0), 
						der1.getProdDeriveId()).get(0);
		...
		Transformation transfo2 = transformationManager
				.findByEntiteObjetManager(entiteManager.findByNomManager("ProdDerive").get(0), 
						der2.getProdDeriveId()).get(0);
		...
		Transformation transfo3 = transformationManager
				.findByEntiteObjetManager(entiteManager.findByNomManager("ProdDerive").get(0), 
						der3.getProdDeriveId()).get(0);
		...
		Transformation transfo4 = pd1.getTransformation();
		...
		assertTrue(prodDeriveManager.getEmplacementManager(der1) == null);
		assertTrue(getOperationManager()
			.findByObjetIdEntiteAndOpeTypeManager(der1, operationTypeDao
					.findByNom("Destockage").get(0)).size() == 1);
		// epuisement -> creation Retour
		...
		assertTrue(prodDeriveManager.getEmplacementManager(der2) == null);
		assertTrue(getOperationManager()
			.findByObjetIdEntiteAndOpeTypeManager(der2, operationTypeDao
					.findByNom("Destockage").get(0)).isEmpty());
		// epuisement -> creation Retour
	...
	public void testCreateDerivesFocusRetour() throws ParseException {
		...
		echantillonManager.createObjectManager(ech, b2, null, null, 
				e1.getObjetStatut(), new2, 
				e1.getEchantillonType(), null, mL, null, null, null, null,
				null, u2, false, "/tmp/", false);
		new2 = echantillonManager.getEmplacementManager(ech);
		new2.setObjetId(ech.getEchantillonId());
		emplacementManager.updateObjectManager(new2, new2.getTerminale(), 
		...
		dateSortie.setTimeInMillis(new SimpleDateFormat("dd/MM/yyyy HH:mm")
			.parse("12/12/2012 10:55").getTime());
		Retour incomp = new Retour();
		incomp.setDateSortie(dateSortie);
		incomp.setTempMoyenne(new Float(21.0));
		incomp.setObservations("OBS1");
		retourManager.createOrUpdateObjectManager(incomp, ech, 
				echantillonManager.getEmplacementManager(ech), 
				null, null, null, null, u2, "creation");
		List<Integer> echIds = new ArrayList<Integer>();
		echIds.add(ech.getEchantillonId());
		assertTrue(retourManager.findByObjectDateRetourEmptyManager(echIds, 
				entiteManager.findByNomManager("Echantillon").get(0)).get(0)
				.getDateSortie().equals(dateSortie));
		
		Calendar dateRetour = Calendar.getInstance();
		dateRetour.setTimeInMillis(new SimpleDateFormat("dd/MM/yyyy HH:mm")
			.parse("12/12/2012 10:58").getTime());
		...
		dateSortie.setTimeInMillis(new SimpleDateFormat("dd/MM/yyyy HH:mm")
			.parse("13/12/2012 13:55").getTime());
		incomp = new Retour();
		...
		// retour incomplete
		dateSortie.setTimeInMillis(new SimpleDateFormat("dd/MM/yyyy HH:mm")
										.parse("12/12/2012 13:55").getTime());
		incomp = new Retour();
	...
	public void testRemoveListFromIds() throws ParseException {
		...
		assertTrue(prodDeriveManager
				.findByCodeOrLaboWithBanqueManager("PD_", b2, false).size() == 3);
		
		ids.add(pd1.getProdDeriveId());
		ids.add(pd2.getProdDeriveId());
		ids.add(pd3.getProdDeriveId());
		Integer cessedderiveId = new Integer(3);
		...
		assertTrue(prodDeriveManager
				.findByCodeOrLaboWithBanqueManager("PD_", b2, false).isEmpty());
		
		assertTrue(getFantomeDao().findByNom("PD3").get(0)
	...
	public void testFindByCodeInPlateformeBanqueManager() {
		...
		List<ProdDerive> derives = prodDeriveManager
				.findByCodeInPlateformeManager("PTRA.1.1", p1);
		assertTrue(derives.size() == 1);
		derives = prodDeriveManager
