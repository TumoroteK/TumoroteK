...
public class TraitementQueryManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindObjetByCritereInListWithBanquesManager(){
      ...
      itemVals.add(itemDao.findById(5));// item2-2).orElse(null);
      ...
      itemVals.add(itemDao.findById(6)).orElse(null);// item3-2-max;
      res = traitementQueryManager.findObjetByCritereInListWithBanquesManager(critere, banques, itemVals, false);
      assertTrue(res.size() == 1);
      assertTrue(res.get(0) == 1);
      ...
      itemVals.add(itemDao.findById(4)).orElse(null); //item1-2
      res = traitementQueryManager.findObjetByCritereInListWithBanquesManager(critere, banques, itemVals, true);
      assertTrue(res.isEmpty());
   ...
   public void testFindPrelevementIdsThroughLaboInterManager(){
      ...
      res.addAll(traitementQueryManager
    		  .findPrelevementIdsViaLaboInterManager(etablissementDao.findById(1), banks)).orElse(null);
      assertTrue(res.size() == 1);
      assertTrue(res.get(0) == 1);
      
      res.clear();
      res.addAll(traitementQueryManager
    		  .findPrelevementIdsViaLaboInterManager(etablissementDao.findById(2), banks)).orElse(null);
      assertTrue(res.isEmpty());
      
      // services
      res.addAll(traitementQueryManager
    		  .findPrelevementIdsViaLaboInterManager(serviceDao.findById(1), banks)).orElse(null);
      assertTrue(res.size() == 1);
      assertTrue(res.get(0) == 1);
      
      res.clear();
      res.addAll(traitementQueryManager
    		  .findPrelevementIdsViaLaboInterManager(serviceDao.findById(4), banks)).orElse(null);
      assertTrue(res.isEmpty());
      
      // operateur
      res.addAll(traitementQueryManager
    		  .findPrelevementIdsViaLaboInterManager(collaborateurDao.findById(2), banks)).orElse(null);
      assertTrue(res.size() == 1);
      assertTrue(res.get(0) == 1);
      
      res.clear();
      res.addAll(traitementQueryManager
    		  .findPrelevementIdsViaLaboInterManager(collaborateurDao.findById(1), banks)).orElse(null);
      assertTrue(res.isEmpty());
      
      // nulls
      res.clear();
      res.addAll(traitementQueryManager
    		  .findPrelevementIdsViaLaboInterManager(collaborateurDao.findById(1), null)).orElse(null);
      assertTrue(res.isEmpty());
      res.addAll(traitementQueryManager
