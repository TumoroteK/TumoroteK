...
//    }
	...
	public void testFindById() {
		DossierExterne m = dossierExterneManager.findByIdManager(1);
		assertNotNull(m);
		
		DossierExterne mNull = dossierExterneManager.findByIdManager(100);
		assertNull(mNull);
	}
	...
	public void testFindAll() {
		List<DossierExterne> list = dossierExterneManager
	...
	public void testFindByEmetteurAndIdentificationManager() {
		...
		List<DossierExterne> list = dossierExterneManager
			.findByEmetteurAndIdentificationManager(e2, num1);
		assertTrue(list.size() == 1);
		
		list = dossierExterneManager.findByEmetteurAndIdentificationManager(
				e2, num2);
		assertTrue(list.size() == 0);
	...
	public void testFindByEmetteurInListAndIdentificationManager() {
		...
		Emetteur e2 = emetteurDao.findById(2);
		emetteurs.add(e2);
		List<DossierExterne> liste = dossierExterneManager
		...
		emetteurs.add(e3);
		liste = dossierExterneManager
			.findByEmetteurInListAndIdentificationManager(
					emetteurs, "X459GCT");
		assertTrue(liste.size() == 2);
		
		liste = dossierExterneManager
			.findByEmetteurInListAndIdentificationManager(emetteurs, "kljsvoi");
		...
		liste = dossierExterneManager
			.findByEmetteurInListAndIdentificationManager(
				new ArrayList<Emetteur>(), "758910000");
		assertTrue(liste.size() == 0);
	...
	public void testFindByIdentificationManager() {
		List<DossierExterne> liste = dossierExterneManager
			.findByIdentificationManager("758910000");
		assertTrue(liste.size() == 1);
		
		liste = dossierExterneManager
			.findByIdentificationManager("kljsvoi");
		assertTrue(liste.size() == 0);
	...
	public void testFindDoublon() {
		...
		DossierExterne de = new DossierExterne();
		de.setEmetteur(e2);
	...
	public void testValidateValeurExterneManager() {
		...
		try {
			dossierExterneManager.validateDossierExterneManager(
					de, null, null, null);
		} catch (Exception e) {
		...
		String[] emptyValues = new String[]{"", "  ", "%¬ ↓»üß*d", 
		...
		List<BlocExterne> blocs = new ArrayList<BlocExterne>();
		...
		b2.setEntiteId(2);
		b2.setOrdre(2);
		BlocExterne b3 = new BlocExterne();
		b3.setEntiteId(null);
		b3.setOrdre(3);
		blocs.add(b1);
		blocs.add(b2);
		...
		blocs = new ArrayList<BlocExterne>();
		b3.setEntiteId(3);
		blocs.add(b1);
		blocs.add(b2);
		blocs.add(b3);
		ValeurExterne ve1 = new ValeurExterne();
		ve1.setValeur("VAL");
		ve1.setChampEntiteId(3);
		ValeurExterne ve2 = new ValeurExterne();
		ve2.setValeur("VAL2");
		ve2.setChampEntiteId(5);
		List<ValeurExterne> vals1 = new ArrayList<ValeurExterne>();
		vals1.add(ve1);
		vals1.add(ve2);
		ValeurExterne ve3 = new ValeurExterne();
		ve3.setValeur("VAL3");
		List<ValeurExterne> vals2 = new ArrayList<ValeurExterne>();
		vals2.add(ve3);
		Hashtable<BlocExterne, List<ValeurExterne>> valeurs = new
			Hashtable<BlocExterne, List<ValeurExterne>>();
		...
		try {
			...
			if (e.getClass().getSimpleName().equals(
					"InvalidMultipleAssociationException")) {
				catched = true;
			}
		}
		assertTrue(catched);
	...
	public void testCrud() throws ParseException {
		...
		Integer nb = dossierExterneManager.findAllObjectsManager().size();
		...
		DossierExterne de1 = new DossierExterne();
		...
		assertTrue(dossierExterneManager.findAllObjectsManager().size() 
				== nb + 1);
		Integer id1 = de1.getDossierExterneId();
		DossierExterne dTest1 = dossierExterneManager.findByIdManager(id1);
		...
		DossierExterne de2 = new DossierExterne();
		...
		assertTrue(blocExterneManager.findAllObjectsManager().size() 
				== nbB + 2);
		Integer id2 = de2.getDossierExterneId();
		DossierExterne dTest2 = dossierExterneManager.findByIdManager(id2);
		assertNotNull(dTest2);
		assertTrue(blocExterneManager.findByDossierExterneManager(
				dTest2).size() == 2);
		assertTrue(blocExterneManager.findByDossierExterneManager(
				dTest2).contains(b1));
		assertTrue(blocExterneManager.findByDossierExterneManager(
		...
		DossierExterne de3 = new DossierExterne();
		...
		b3.setEntiteId(1);
		b3.setOrdre(1);
		BlocExterne b4 = new BlocExterne();
		b4.setEntiteId(2);
		b4.setOrdre(2);
		blocs.add(b3);
		blocs.add(b4);
		...
		assertTrue(valeurExterneManager.findAllObjectsManager().size() 
				== nbV + 2);
		Integer id3 = de3.getDossierExterneId();
		DossierExterne dTest3 = dossierExterneManager.findByIdManager(id3);
		assertNotNull(dTest3);
		assertTrue(blocExterneManager.findByDossierExterneManager(
				dTest3).size() == 2);
		BlocExterne bTest = blocExterneManager.findByDossierExterneManager(
				dTest3).get(0);
		assertTrue(valeurExterneManager
				.findByBlocExterneManager(bTest).size() == 2);
		assertTrue(valeurExterneManager
				.findByBlocExterneManager(bTest).contains(ve1));
		assertTrue(valeurExterneManager
				.findByBlocExterneManager(bTest).contains(ve2));
		
		// Insertion d'un doublon
		DossierExterne de4 = new DossierExterne();
		de4.setIdentificationDossier("ID3");
		de4.setOperation("TEST3");
		blocs = new ArrayList<BlocExterne>();
		BlocExterne b5 = new BlocExterne();
		b5.setEntiteId(3);
		b5.setOrdre(1);
		blocs.add(b5);
		ValeurExterne ve3 = new ValeurExterne();
		...
		List<ValeurExterne> vals3 = new ArrayList<ValeurExterne>();
		vals3.add(ve3);
		valeurs = new  Hashtable<BlocExterne, List<ValeurExterne>>();
		...
		assertTrue(valeurExterneManager.findAllObjectsManager().size() 
				== nbV + 1);
		Integer id4 = de4.getDossierExterneId();
		DossierExterne dTest4 = dossierExterneManager.findByIdManager(id4);
		assertNotNull(dTest4);
		assertTrue(blocExterneManager.findByDossierExterneManager(
				dTest4).size() == 1);
		BlocExterne bTest2 = blocExterneManager.findByDossierExterneManager(
				dTest4).get(0);
		assertTrue(valeurExterneManager
				.findByBlocExterneManager(bTest2).size() == 1);
		assertTrue(valeurExterneManager
				.findByBlocExterneManager(bTest2).contains(ve3));
	...
	public void testFirstInFirstOut() throws ParseException, 
		...
		int totD = dossierExterneManager.findAllObjectsManager().size();
		int totB = blocExterneManager.findAllObjectsManager().size();
		int totV = valeurExterneManager.findAllObjectsManager().size();
		...
		Hashtable<BlocExterne, List<ValeurExterne>> valeurs = new
			Hashtable<BlocExterne, List<ValeurExterne>>();
		valeurs.put(b3, vals1);
		dossierExterneManager.createObjectManager(de3, 
						emetteurDao.findById(1), blocs, valeurs, 7);
		assertTrue(dossierExterneManager.findAllObjectsManager().size() 
				== totD + 1); // 7
		assertTrue(blocExterneManager.findAllObjectsManager().size() 
				== totB + 2);
		assertTrue(valeurExterneManager.findAllObjectsManager().size() 
				== totV + 2);
		Integer id3 = de3.getDossierExterneId();
		DossierExterne d3 = dossierExterneManager.findByIdManager(id3);
		...
		// clean up
		dossierExterneManager.removeObjectManager(dossierExterneManager
								.findByIdentificationManager("ID").get(0));
