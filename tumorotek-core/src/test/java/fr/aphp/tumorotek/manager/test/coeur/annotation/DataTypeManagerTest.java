...
/**
 * 
 * Classe de test pour le manager DataTypeManager.
 ...
 *
 */
public class DataTypeManagerTest extends AbstractManagerTest4 {
	...
	public void testFindAllObjectsManager() {
		List<DataType> dts = dataTypeManager.findAllObjectsManager();
