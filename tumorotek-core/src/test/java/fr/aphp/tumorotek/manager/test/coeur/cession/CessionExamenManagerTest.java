...
public class CessionExamenManagerTest extends AbstractManagerTest4
{
   ...
   public void createObjectManagerTest(){
      ...
      c1.setExamen("RAAAAA");
      c1.setPlateforme(plateformeDao.findById(1)).orElse(null);
      ...
      assertTrue(catched);
      c1Bis.setPlateforme(plateformeDao.findById(1)).orElse(null);
      try{
         cessionExamenManager.createObjectManager(c1Bis);
      }catch(final Exception e){
      ...
      final CessionExamen c2 = new CessionExamen();
      c2.setPlateforme(plateformeDao.findById(1)).orElse(null);
