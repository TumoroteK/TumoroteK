...
public class IncaEchantillonExportTest extends AbstractManagerTest {
	...
	//	assertTrue(incaEchantillonExport.getModeConservation(e).equals("1"));
		...
		try {
			assertTrue(incaEchantillonExport
							.getModeConservation(e).equals("5"));	
		} catch (ItemException ie) {
			assertTrue(ie.getSeverity() == 2);
			catched = true;
		}
	...
	public void testGetEchantillonType() {
		Echantillon e = new Echantillon();
		EchantillonType eType = new EchantillonType();
	...
	public void testGetModePreparation() 
							throws ClassNotFoundException, SQLException {
	
		Echantillon e = new Echantillon();
		ModePrepa m = new ModePrepa();
		e.setModePrepa(m);
		m.setNom("DMSO like");
	...
	public void testGetPourcentage() 
		...
		assertTrue(incaEchantillonExport
				.getPourcentageCellulesTumorales(con, e).equals("100"));
		e.setEchantillonId(19278);	
		assertTrue(incaEchantillonExport
				.getPourcentageCellulesTumorales(con, e).equals("60"));
		e.setEchantillonId(17709);
		e.setBanque(banqueDao.findById(3));
		assertTrue(incaEchantillonExport
				.getPourcentageCellulesTumorales(con, e).equals("0"));
		
		boolean catched = false;
		try {
			e.setEchantillonId(14995);	
			assertTrue(incaEchantillonExport
					.getPourcentageCellulesTumorales(con, e).equals(""));
		} catch (ItemException ie) {
			assertTrue(ie.getSeverity() == 2);
			catched = true;
		}
	...
	public void testGetProdTypeAssocie() 
							throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		assertTrue(incaEchantillonExport
				.getProdTypeAssocie(con, e, 
						".*([Aa][Dd][nN])|([Dd][nN][Aa]).*").equals("1"));
		assertTrue(incaEchantillonExport
				.getProdTypeAssocie(con, e, 
						".*([Aa][Rr][nN])|([Rr][nN][Aa]).*").equals("1"));
		assertTrue(incaEchantillonExport
				.getProdTypeAssocie(con, e, 
						".*[Pp][Rr][Oo][Tt][Ee][Ii][Nn].*").equals("N"));
		
		e.setEchantillonId(423);
		assertTrue(incaEchantillonExport
				.getProdTypeAssocie(con, e, 
						".*([Aa][Dd][nN])|([Dd][nN][Aa]).*(ADN)|(DNA)")
						.equals("N"));
		assertTrue(incaEchantillonExport
				.getProdTypeAssocie(con, e, 
						".*([Aa][Rr][nN])|([Rr][nN][Aa]).*").equals("1"));
		...
		assertTrue(incaEchantillonExport
				.getProdTypeAssocie(con, e, 
						".*([Aa][Dd][nN])|([Dd][nN][Aa]).*").equals("N"));
		assertTrue(incaEchantillonExport
				.getProdTypeAssocie(con, e, 
						".*([Aa][Rr][nN])|([Rr][nN][Aa]).*").equals("N"));
		assertTrue(incaEchantillonExport
				.getProdTypeAssocie(con, e, 
						".*[Pp][Rr][Oo][Tt][Ee][Ii][Nn].*").equals("N"));
	...
	public void testgetRessourceBiolAssociee() {
		...
		assertTrue(incaEchantillonExport
				.getRessourceBiolAssociee(e, "cellules").equals("O"));
		assertTrue(incaEchantillonExport
				.getRessourceBiolAssociee(e, "%URINE%").equals("N"));
	}
	
	public void testGetADNconstitutionnel() 
			throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		assertTrue(incaEchantillonExport
				.getADNconstitutionnel(con, e, "%Attente%").equals("O"));
		assertTrue(incaEchantillonExport
				.getADNconstitutionnel(con, e, "%CONSENTEMENT%").equals(""));
		e.setEchantillonId(12911);
		assertTrue(incaEchantillonExport
				.getADNconstitutionnel(con, e, "%OPPOSITION%").equals("N"));
		assertTrue(incaEchantillonExport
				.getADNconstitutionnel(con, e, "%CONSENTEMENT%").equals(""));
		e.setEchantillonId(1000);
		assertTrue(incaEchantillonExport
				.getADNconstitutionnel(con, e, "ATTENTE").equals(""));
		assertTrue(incaEchantillonExport
				.getADNconstitutionnel(con, e, "%CONSENTEMENT%").equals(""));
	}
}