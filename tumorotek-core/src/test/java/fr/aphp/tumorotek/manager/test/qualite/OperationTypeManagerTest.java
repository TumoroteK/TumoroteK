...
public class OperationTypeManagerTest extends AbstractManagerTest {
	...
	public void setOperationTypeManager(OperationTypeManager oManager) {
	...
	public void testFindById() {
		OperationType op = operationTypeManager.findByIdManager(1);
		assertNotNull(op);
		assertTrue(op.getNom().equals("Consultation"));
		
		OperationType opNull = operationTypeManager.findByIdManager(87);
		assertNull(opNull);
	}
	...
	public void testFindAll() {
		List<OperationType> list = operationTypeManager.findAllObjectsManager();
	...
	public void testFindByNomLikeExactManager() {
		List<OperationType> list = 
			operationTypeManager.findByNomLikeManager("Export", true);
	...
	public void testFindByNomLikeManager() {
		List<OperationType> list = 
			operationTypeManager.findByNomLikeManager(
					"ExportAnonyme", false);
		assertTrue(list.size() == 1);
