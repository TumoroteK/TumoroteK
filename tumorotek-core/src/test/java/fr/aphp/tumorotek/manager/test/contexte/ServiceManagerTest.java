...
public class ServiceManagerTest extends AbstractManagerTest4
{
   ...
   private void setUpFusionTest(){
      ...
      serviceManager.createObjectManager(sA, null, etablissementDao.findById(3), null, utilisateurDao.findById(1), false);

      serviceManager.createObjectManager(sP, null, etablissementDao.findById(2), null, utilisateurDao.findById(1), false);
   ...
   public void testFusionServicesWithBanques(){
      ...
      b.setNom("BANK");
      b.setArchive(false);
      banqueManager.createOrUpdateObjectManager(b, plateformeDao.findById(1), contexteDao.findById(1), passif, null, null, null,
         null, null, null, null, null, null, null, null, null, u1, null, "creation", "/tmp/");

      final Banque b2 = new Banque();
      b2.setNom("BANK2");
      b2.setArchive(false);
      banqueManager.createOrUpdateObjectManager(b2, plateformeDao.findById(1), contexteDao.findById(1), passif, null, null, null,
         null, null, null, null, null, null, null, null, null, u1, null, "creation", "/tmp/");
   ...
   public void testFusionServicesContrats(){
      ...
      contratManager.createObjectManager(contrat, null, passif, null, null, plateformeDao.findById(1), u1);

      Contrat contrat2 = new Contrat();
      contrat2.setNumero("CONTRAT2");
      contratManager.createObjectManager(contrat2, null, passif, null, null, plateformeDao.findById(1), u1);
   ...
   public void testFusionServicesCession(){
      ...
      cessionManager.createObjectManager(cess, banqueDao.findById(1), cessionTypeDao.findById(1), null, null, null, passif, null,
      ...
      cessionManager.createObjectManager(cess2, banqueDao.findById(1), cessionTypeDao.findById(1), null, null, null, passif, null,
         cessionStatutDao.findById(1), null, null, null, null, null, u1, null, "/tmp/");
   ...
   public void testFusionServicesConteneur(){
      ...
      conteneurManager.createObjectManager(conteneur, conteneurTypeDao.findById(1), passif, null, null, u1,
      ...
      conteneurManager.createObjectManager(conteneur2, conteneurTypeDao.findById(1), passif, null, null, u1,
         plateformeDao.findById(1));
