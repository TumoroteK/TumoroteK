...
public class LaboInterManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindServiceManager(){
      Service s1 = serviceDao.findById(2).orElse(null);
      ...
      s1 = serviceDao.findById(4).orElse(null);
   ...
   public void testFindCollaborateurManager(){
      Collaborateur c1 = collaborateurDao.findById(2).orElse(null);
      //teste une recherche fructueuse
      List<LaboInter> laboInters = laboInterManager.findByCollaborateurManager(c1);
      assertTrue(laboInters.size() == 3);
      //teste une recherche infructueuse
      c1 = collaborateurDao.findById(1).orElse(null);
   ...
   public void testFindDoublon(){
      final Service s1 = serviceDao.findById(2).orElse(null);
      //Cree le doublon
   ...
   private void createObjectManagerTest(){
      ...
      final Transporteur t1 = transporteurDao.findById(2).orElse(null);
   ...
   private void updateObjectManagerTest(){
      ...
      final Service s1 = serviceDao.findById(3).orElse(null);
      final Transporteur t1 = transporteurDao.findById(2).orElse(null);
      final LaboInter l1 = (laboInterManager.findByTransporteurManager(t1)).get(0);
      final Prelevement p1 = prelevementDao.findById(3).orElse(null);
      l1.setOrdre(5);
      ...
      try{
         l1.setOrdre(1);
         final Prelevement p2 = prelevementDao.findById(1).orElse(null);
   ...
   public void testDateArriveeCoherence() throws ParseException{
      Prelevement p = prelevementDao.findById(3).clone().orElse(null);
      ...
      p = prelevementDao.findById(1).orElse(null);
   ...
   public void testSteriliteCoherence(){
      ...
      final Prelevement p = prelevementDao.findById(3).orElse(null);
      final Set<LaboInter> set = new HashSet<>();
      final LaboInter l1 = new LaboInter();
      l1.setOrdre(1);
      set.add(l1);
