...
public class DestructionMotifManagerTest extends AbstractManagerTest4
{
   ...
   public void createObjectManagerTest(){
      ...
      d1.setMotif("PAS BON");
      d1.setPlateforme(plateformeDao.findById(1)).orElse(null);
      ...
      assertTrue(catched);
      d1Bis.setPlateforme(plateformeDao.findById(1)).orElse(null);
      catched = false;
      try{
         destructionMotifManager.createObjectManager(d1Bis);
      }catch(final Exception e){
      ...
      final DestructionMotif d2 = new DestructionMotif();
      d2.setPlateforme(plateformeDao.findById(1)).orElse(null);
