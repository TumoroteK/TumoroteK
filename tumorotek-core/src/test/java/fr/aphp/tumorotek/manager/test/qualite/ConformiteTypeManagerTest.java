...
public class ConformiteTypeManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		ConformiteType c = conformiteTypeManager.findByIdManager(1);
		assertNotNull(c);
		
		ConformiteType cNull = conformiteTypeManager.findByIdManager(100);
		assertNull(cNull);
	}

	@Test
	public void testFindAll() {
		List<ConformiteType> list = conformiteTypeManager
	...
	public void testFindByEntiteAndTypeManager() {
		List<ConformiteType> list = conformiteTypeManager
			.findByEntiteAndTypeManager("Arrivee", entiteDao.findById(2));
		assertTrue(list.size() == 1);
		
		list = conformiteTypeManager.findByEntiteAndTypeManager("Test",  
