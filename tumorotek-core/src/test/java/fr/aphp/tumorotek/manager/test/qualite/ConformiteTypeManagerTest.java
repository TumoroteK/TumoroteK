...
public class ConformiteTypeManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByEntiteAndTypeManager(){
      List<ConformiteType> list = conformiteTypeManager.findByEntiteAndTypeManager("Arrivee", entiteDao.findById(2).orElse(null));
      assertTrue(list.size() == 1);

      list = conformiteTypeManager.findByEntiteAndTypeManager("Test", entiteDao.findById(3).orElse(null));
