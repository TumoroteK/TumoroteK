...
public class CombinaisonManagerTest extends AbstractManagerTest4
{
   ...
   public void testCopyCombinaison(){
      ...
      for(int i = 0; i < Math.pow(2, 3) - 1; i++){
         ...
         Champ champ1 = null;
         if(i >= 4){
            champ1 = new Champ(champEntiteDao.findById(2)).orElse(null);
         }
         int toTest = i % 4;
         Champ champ2 = null;
         if(toTest >= 2){
            champ2 = new Champ(champEntiteDao.findById(3)).orElse(null);
         }
         toTest = toTest % 2;
   ...
   public void testCrud(){
      ...
      /** Save. */
      Champ champ1 = new Champ(champEntiteDao.findById(2)).orElse(null);
      Champ champ2 = new Champ(champEntiteDao.findById(3)).orElse(null);
      final Combinaison combinaison = new Combinaison();
      ...
      champ1 = new Champ(champEntiteDao.findById(45)).orElse(null);
      champ2 = new Champ(champEntiteDao.findById(13)).orElse(null);
