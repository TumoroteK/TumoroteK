...
public class ProdQualiteManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		...
		ProdQualite qualiteNull = prodQualiteManager.findByIdManager(4);
		assertNull(qualiteNull);
	}
	
	@Test
	public void testFindByQualiteLikeExactManager() {
		List<ProdQualite> list = 
			prodQualiteManager.findByQualiteLikeManager("NECROSE", true);
	...
	public void testFindByQualiteLikeManager() {
		List<ProdQualite> list = 
			prodQualiteManager.findByQualiteLikeManager("NECROSE", false);
		assertTrue(list.size() == 1);
	...
	public void testIsUsed() {
		...
		ProdQualite qualite2 = prodQualiteManager.findByIdManager(3);
	...
	public void testCrud() {
		// Test de l'insertion
		ProdQualite qualite1 = new ProdQualite();
		...
		String[] emptyValues = new String[]{"", "  ", null, "%$uhec¤¤", 
		...
		assertTrue(prodQualiteManager
			.findByOrderManager(qualite1.getPlateforme()).size() == 1);
		...
		ProdQualite qualite2 = prodQualiteManager.findByIdManager(4);
		String qualiteUpdated1 = "NEW";
		String qualiteUpdated2 = "TUMEUR";
		...
		prodQualiteManager.updateObjectManager(qualite2);
		ProdQualite qualite3 = prodQualiteManager.findByIdManager(4);
		assertTrue(qualite3.getProdQualite().equals(qualiteUpdated1));
		
		// Test de la suppression
		ProdQualite qualite4 = prodQualiteManager.findByIdManager(4);
...
//		assertTrue(catchedDelete);
	...
	public void testFindByOrderManager() {
		...
		List< ? extends TKThesaurusObject> list = 
					prodQualiteManager.findByOrderManager(pf);
