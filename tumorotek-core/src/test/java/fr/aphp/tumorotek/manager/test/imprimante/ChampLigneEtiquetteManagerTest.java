...
public class ChampLigneEtiquetteManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByLigneEtiquetteManager(){
      final LigneEtiquette li1 = ligneEtiquetteDao.findById(1).orElse(null);
      final LigneEtiquette li7 = ligneEtiquetteDao.findById(7).orElse(null);
   ...
   public void testFindByLigneEtiquetteAndEntiteManager(){
      ...
      final Entite e4 = entiteDao.findById(4).orElse(null);
   ...
   public void testValidateObjectManager(){
      final LigneEtiquette le1 = ligneEtiquetteDao.findById(1).orElse(null);
      final Champ c1 = champManager.findByIdManager(1);
      final Entite e3 = entiteDao.findById(4).orElse(null);
   ...
   public void createObjectManager(){
      ...
      final ChampEntite ce = champEntiteDao.findById(1).orElse(null);
