...
public class ChampLigneEtiquetteManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		ChampLigneEtiquette cle = champLigneEtiquetteManager
		.findByIdManager(1);
		assertNotNull(cle);

		ChampLigneEtiquette cleNull = champLigneEtiquetteManager
		.findByIdManager(1000);
		assertNull(cleNull);
	}
	...
	public void testFindAll() {
		List<ChampLigneEtiquette> list = champLigneEtiquetteManager
	...
	public void testFindByLigneEtiquetteManager() {
		LigneEtiquette li1 = ligneEtiquetteDao.findById(1);
		LigneEtiquette li7 = ligneEtiquetteDao.findById(7);

		List<ChampLigneEtiquette> list = champLigneEtiquetteManager
		.findByLigneEtiquetteManager(li1);
		assertTrue(list.size() == 2);

		list = champLigneEtiquetteManager
		.findByLigneEtiquetteManager(li7);
		assertTrue(list.size() == 0);

		list = champLigneEtiquetteManager
		.findByLigneEtiquetteManager(null);
		assertTrue(list.size() == 0);
	}
	...
	public void testFindByLigneEtiquetteAndEntiteManager() {
		...
		Entite e4 = entiteDao.findById(4);

		List<ChampLigneEtiquette> list = champLigneEtiquetteManager
		.findByLigneEtiquetteAndEntiteManager(li1, e3);
		assertTrue(list.size() == 1);

		list = champLigneEtiquetteManager
		.findByLigneEtiquetteAndEntiteManager(li1, e4);
		assertTrue(list.size() == 0);

		list = champLigneEtiquetteManager
		.findByLigneEtiquetteAndEntiteManager(li7, e3);
		assertTrue(list.size() == 0);

		list = champLigneEtiquetteManager
		.findByLigneEtiquetteAndEntiteManager(null, e3);
		assertTrue(list.size() == 0);

		list = champLigneEtiquetteManager
		.findByLigneEtiquetteAndEntiteManager(li7, null);
		assertTrue(list.size() == 0);

		list = champLigneEtiquetteManager
		.findByLigneEtiquetteAndEntiteManager(null, null);
		assertTrue(list.size() == 0);
	}
	...
	public void testValidateObjectManager() {
		LigneEtiquette le1 = ligneEtiquetteDao.findById(1);
		Champ c1 = champManager.findByIdManager(1);
		Entite e3 = entiteDao.findById(4);
	...
	public void createObjectManager() {
		...
		ChampEntite ce = champEntiteDao.findById(1);
		...
		Integer idCle1 = cle1.getChampLigneEtiquetteId();
		
		ChampLigneEtiquette cle2 = champLigneEtiquetteManager
			.findByIdManager(idCle1);
		assertNotNull(cle2);
	...
	public void updateObjectManager() {
		...
		ChampLigneEtiquette cleUp = champLigneEtiquetteManager
			.findByIdManager(idCle1);
		// on vérifie qu'une exception est bien lancée
		Boolean catched = false;
		// on test avec la ligne null
		...
		ChampLigneEtiquette cleTest = champLigneEtiquetteManager
			.findByIdManager(idCle1);
		...
		assertTrue(champLigneEtiquetteManager
				.findAllObjectsManager().size() == 11);
		assertTrue(champManager.findAllObjectsManager().size() == cTots + 2);
		ChampLigneEtiquette cleTest2 = champLigneEtiquetteManager
			.findByIdManager(idCle1);
