...
public class DroitObjetManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindById(){
      ...
      final OperationType o1 = operationTypeDao.findById(1).orElse(null);
   ...
   public void testFindByProfilOperationManager(){
      ...
      final Profil p3 = profilDao.findById(3).orElse(null);
      final OperationType o1 = operationTypeDao.findById(1).orElse(null);
      final OperationType o2 = operationTypeDao.findById(2).orElse(null);
   ...
   public void testCrud(){
      ...
      // on test l'insertion avec l'opération nulle
      try{
         droitObjetManager.createObjectManager(do1, p1, e1, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // on test l'insertion avec le profil null
      try{
         droitObjetManager.createObjectManager(do1, null, e1, o1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // on test l'insertion avec l'entité nulle
      try{
         droitObjetManager.createObjectManager(do1, p1, null, o1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // est lancée
      try{
         droitObjetManager.createObjectManager(do1, p1, e1, o1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      // insertion valide
      droitObjetManager.createObjectManager(do1, p4, e1, o1);
   ...
   public void testHasProfilOperationOnEntitesManager(){
      final OperationType creation = operationTypeDao.findById(3).orElse(null);
      final Profil p2 = profilDao.findById(2).orElse(null);
      ...
      entites.add(entiteDao.findById(1)).orElse(null);
      assertTrue(droitObjetManager.hasProfilOperationOnEntitesManager(p2, creation, entites));
      entites.add(entiteDao.findById(2)).orElse(null);
      assertTrue(droitObjetManager.hasProfilOperationOnEntitesManager(p2, creation, entites));
      entites.add(entiteDao.findById(3)).orElse(null);
      assertFalse(droitObjetManager.hasProfilOperationOnEntitesManager(p2, creation, entites));

      final Profil p3 = profilDao.findById(3).orElse(null);
      final OperationType consultation = operationTypeDao.findById(1).orElse(null);
