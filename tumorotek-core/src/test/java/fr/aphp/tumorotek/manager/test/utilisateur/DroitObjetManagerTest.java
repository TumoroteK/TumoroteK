...
public class DroitObjetManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		...
		DroitObjetPK pk1 = new DroitObjetPK(p1, e1, o1);
		
		DroitObjet do1 = droitObjetManager.findByIdManager(pk1);
		assertNotNull(do1);
		
		DroitObjetPK pk2 = new DroitObjetPK(p4, e1, o1);
		DroitObjet do2 = droitObjetManager.findByIdManager(pk2);
		assertNull(do2);
		
		DroitObjet do3 = droitObjetManager.findByIdManager(null);
		assertNull(do3);
	}

	@Test
	public void testFindAll() {
		List<DroitObjet> list = droitObjetManager.findAllObjectsManager();
	...
	public void testFindByProfilManager() {
		...
		List<DroitObjet> liste = 
			droitObjetManager.findByProfilManager(p1);
	...
	public void testFindByProfilEntiteManager() {
		...
		List<DroitObjet> liste = 
			droitObjetManager.findByProfilEntiteManager(p2, e2);
		assertTrue(liste.size() == 3);
	...
	public void testGetOperationsByProfilEntiteManager() {
		Profil p2 = profilDao.findById(2);
		Profil p3 = profilDao.findById(3);
		String e2 = "Prelevement";
		String e3 = "Echantillon";
		
		List<OperationType> liste = 
			droitObjetManager.getOperationsByProfilEntiteManager(p2, e2);
		assertTrue(liste.size() == 3);
		...
		liste = droitObjetManager
			.getOperationsByProfilEntiteManager(null, null);
		assertTrue(liste.size() == 0);
	}
	...
	public void testFindByProfilOperationManager() {
		...
		Profil p3 = profilDao.findById(3);
		OperationType o1 = operationTypeDao.findById(1);
		OperationType o2 = operationTypeDao.findById(2);
		
		List<DroitObjet> liste = 
			droitObjetManager.findByProfilOperationManager(p2, o1);
	...
	public void testValidateObjectManager() {
		...
		try {
			droitObjetManager.validateObjectManager(
					p1, e1, null);
		} catch (Exception e) {
	...
	public void testCrud() {
		...
		// on test l'insertion avec l'opération nulle
		try {
			droitObjetManager.createObjectManager(do1,
					p1, e1, null);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"RequiredObjectIsNullException")) {
		...
		DroitObjetPK pk = do1.getPk();
		
		DroitObjet doTest = droitObjetManager.findByIdManager(pk);
	...
	public void testHasProfilOperationOnEntitesManager() {
		OperationType creation = operationTypeDao.findById(3);
		Profil p2 = profilDao.findById(2);
		List<Entite> entites = new ArrayList<Entite>();
		assertFalse(droitObjetManager
				.hasProfilOperationOnEntitesManager(p2, creation, entites));
		
		entites.add(entiteDao.findById(1));
		assertTrue(droitObjetManager
				.hasProfilOperationOnEntitesManager(p2, creation, entites));
		...
		Profil p3 = profilDao.findById(3);
		OperationType consultation = operationTypeDao.findById(1);
		assertFalse(droitObjetManager
				.hasProfilOperationOnEntitesManager(p3, creation, entites));
		assertFalse(droitObjetManager
				.hasProfilOperationOnEntitesManager(p3, consultation, entites));

		Profil p1 = profilDao.findById(1);
		assertFalse(droitObjetManager
				.hasProfilOperationOnEntitesManager(p1, creation, entites));
		assertTrue(droitObjetManager
				.hasProfilOperationOnEntitesManager(p1, consultation, entites));
		

		
		assertFalse(droitObjetManager
				.hasProfilOperationOnEntitesManager(p2, creation, null));
		assertFalse(droitObjetManager
				.hasProfilOperationOnEntitesManager(p2, null, entites));
		assertFalse(droitObjetManager
				.hasProfilOperationOnEntitesManager(null, creation, entites));
