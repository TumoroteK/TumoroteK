 ...
 *
 */
public class ImportColonneManagerTest extends AbstractManagerTest4
{
	...
	public void testFindByImportTemplateManager(){
		...
		final ImportTemplate it2 = importTemplateDao.findById(2).orElse(null);
	...
	public void testFindByTemplateAndDataTypeManager(){
		final ImportTemplate it1 = importTemplateDao.findById(1).orElse(null);
		final ImportTemplate it2 = importTemplateDao.findById(2).orElse(null);
		final DataType d1 = dataTypeDao.findById(1).orElse(null);
		final DataType d7 = dataTypeDao.findById(7).orElse(null);
	...
	public void testFindByTemplateAndEntiteManager(){
		...
		final Entite e10 = entiteDao.findById(10).orElse(null);
	...
	public void testValidateObjectManager(){
		final ImportTemplate it = importTemplateDao.findById(1).orElse(null);
	...
	private void createObjectManager(){
		...
		final ChampEntite ce = champEntiteDao.findById(2).orElse(null);
		final ImportColonne ic1 = new ImportColonne();
		ic1.setNom("TEST");
		ic1.setOrdre(12);
	...
	private void updateObjectManager(){
		final ImportTemplate it = importTemplateDao.findById(1).orElse(null);
		final Champ c1 = new Champ();
		final ChampEntite ce = champEntiteDao.findById(2).orElse(null);
		final ChampEntite ce3 = champEntiteDao.findById(3).orElse(null);
		final ChampEntite ce4 = champEntiteDao.findById(4).orElse(null);
		final ImportColonne ic1 = new ImportColonne();
		ic1.setNom("TEST");
		ic1.setOrdre(12);
