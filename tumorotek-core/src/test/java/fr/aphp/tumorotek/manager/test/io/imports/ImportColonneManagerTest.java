...
public class ImportColonneManagerTest extends AbstractManagerTest {
	...
	public void testFindById() {
		ImportColonne temp = importColonneManager.findByIdManager(1);
		assertNotNull(temp);
		
		ImportColonne tempNull = importColonneManager.findByIdManager(1000);
		assertNull(tempNull);
	}
	...
	public void testFindAll() {
		List<ImportColonne> list = importColonneManager
	...
	public void testFindByImportTemplateManager() {
		...
		List<ImportColonne> list = importColonneManager
			.findByImportTemplateManager(it1);
	...
	public void testFindByTemplateAndDataTypeManager() {
		...
		List<ImportColonne> list = importColonneManager
			.findByTemplateAndDataTypeManager(it1, d1);
		...
		list = importColonneManager.findByTemplateAndDataTypeManager(
				null, null);
		assertTrue(list.size() == 0);
	}
	...
	public void testFindByTemplateAndEntiteManager() {
		...
		List<ImportColonne> list = importColonneManager
			.findByTemplateAndEntiteManager(it1, e1);
	...
	public void testFindByTemplateAndAnnotationEntiteManager() {
		...
		List<ImportColonne> list = importColonneManager
			.findByTemplateAndAnnotationEntiteManager(it1, e2);
		assertTrue(list.size() == 5);
		list = importColonneManager
			.findByTemplateAndAnnotationEntiteManager(it1, e10);
		assertTrue(list.size() == 0);
		
		list = importColonneManager
			.findByTemplateAndAnnotationEntiteManager(it2, e2);
		assertTrue(list.size() == 0);
		
		list = importColonneManager
			.findByTemplateAndAnnotationEntiteManager(null, e2);
		assertTrue(list.size() == 0);
		
		list = importColonneManager
			.findByTemplateAndAnnotationEntiteManager(it1, null);
		assertTrue(list.size() == 0);
		
		list = importColonneManager
			.findByTemplateAndAnnotationEntiteManager(null, null);
		assertTrue(list.size() == 0);
	}
	...
	public void testFindByTemplateAndThesaurusManager() {
		...
		List<ImportColonne> list = importColonneManager
			.findByTemplateAndThesaurusManager(it1);
	...
	public void testFindByTemplateAndAnnotationThesaurusManager() {
		...
		List<ImportColonne> list = importColonneManager
			.findByTemplateAndAnnotationThesaurusManager(it1);
		assertTrue(list.size() == 2);
		
		list = importColonneManager
			.findByTemplateAndAnnotationThesaurusManager(it2);
		assertTrue(list.size() == 0);
		
		list = importColonneManager
			.findByTemplateAndAnnotationThesaurusManager(null);
		assertTrue(list.size() == 0);
	}
	...
	public void testFindDoublon() {
		...
		ImportColonne ic2 = importColonneManager.findByIdManager(1);
	...
	public void testFindDoublonInListManager() {
		...
		ImportColonne ic2 = importColonneManager.findByIdManager(2);
		ImportColonne ic3 = importColonneManager.findByIdManager(3);
		ImportColonne ic4 = importColonneManager.findByIdManager(4);
		ImportColonne ic5 = importColonneManager.findByIdManager(5);
		...
		colonnes.add(ic2);
		colonnes.add(ic3);
		ImportColonne icTmp = new ImportColonne();
	...
	public void testValidateObjectManager() {
		...
		Champ c1 = champManager.findByIdManager(1);
	...
	public void createObjectManager() {
		ImportTemplate it = importTemplateDao.findById(1);
		Champ c2 = new Champ();
		ChampEntite ce = champEntiteDao.findById(2);
		ImportColonne ic1 = new ImportColonne();
		ic1.setNom("TEST");
		ic1.setOrdre(12);
		
		int tots = importColonneManager.findAllObjectsManager().size();
		...
		Integer idIc2 = ic2.getImportColonneId();
		
		ImportColonne icTest2 = importColonneManager.findByIdManager(idIc2);
	...
	public void updateObjectManager() {
		...
		ChampEntite ce4 = champEntiteDao.findById(4);
		ImportColonne ic1 = new ImportColonne();
		ic1.setNom("TEST");
		ic1.setOrdre(12);
		...
		assertTrue(importColonneManager.findAllObjectsManager().size() == tots + 1);
		assertTrue(champManager.findAllObjectsManager().size() == cTots + 1);
		Integer idIc1 = ic1.getImportColonneId();
		
		ImportColonne icUp = importColonneManager.findByIdManager(idIc1);
		// on vérifie qu'une exception est bien lancée
		Boolean catched = false;
		// on test avec l'importtemplate null
		try {
		...
		ImportColonne icTest = importColonneManager.findByIdManager(idIc1);
		...
		assertTrue(importColonneManager.findAllObjectsManager().size() == tots + 1);
		assertTrue(champManager.findAllObjectsManager().size() == cTots + 2);
		ImportColonne icTest2 = importColonneManager.findByIdManager(idIc1);
		assertNotNull(icTest2);
		assertTrue(icTest2.getImportTemplate().equals(it));
		assertTrue(icTest2.getChamp().equals(c2));
