...
public class PatientManagerTest extends AbstractManagerTest4
{
	...
	public void testGetMedecinsManager(){
		...
		assertTrue(patientManager.getMedecinsManager(p).get(0).equals(collaborateurDao.findById(1))).orElse(null);
		assertTrue(patientManager.getMedecinsManager(p).get(1).equals(collaborateurDao.findById(2))).orElse(null);
		assertTrue(patientManager.getMedecinsManager(p).get(2).equals(collaborateurDao.findById(3))).orElse(null);
	}
	...
	private void createObjectManagerTest() throws ParseException{
		...
		final Collaborateur c = collaborateurDao.findById(1).orElse(null);
		final Collaborateur c2 = collaborateurDao.findById(2).orElse(null);
		final Collaborateur c3 = collaborateurDao.findById(3).orElse(null);
		colls.add(c);
		colls.add(c2);
		colls.add(c3);
		//Liens familiaux
		...
		pl1.setLienFamilial(lienFamilialDao.findById(1)).orElse(null);
		final PatientLien pl2 = new PatientLien();
		pl2.setPatient2(patientManager.findByNomLikeManager("SOLIS", true).get(0));
		pl2.setLienFamilial(lienFamilialDao.findById(2)).orElse(null);
		liens.add(pl1);
		liens.add(pl2);
		...
		assertTrue(patientMedecinDao.findById(new PatientMedecinPK(c3, p)).getOrdre().equals(3)).orElse(null);
		assertTrue(patientManager.getPatientLiensManager(p).size() == 2);
		assertTrue(patientLienDao.findById(new PatientLienPK(p, mayer)).getLienFamilial().equals(lienFamilialDao.findById(1))).orElse(null);
	...
	private void updateObjectManagerTest() throws ParseException{
		...
		//medecins
		final List<Collaborateur> colls = new ArrayList<>();
		final Collaborateur c4 = collaborateurDao.findById(4).orElse(null);
		final Collaborateur c3 = collaborateurDao.findById(3).orElse(null);
		colls.add(c4);
		colls.add(c3);
		//Liens familiaux
		...
		pl1.setLienFamilial(lienFamilialDao.findById(3)).orElse(null);
		final PatientLienPK pk = new PatientLienPK(p, patientManager.findByNomLikeManager("SOLIS", true).get(0));
		liens.add(pl1);
		liens.add(patientLienDao.findById(pk)).orElse(null);
		final Utilisateur u = utilisateurDao.findById(2).orElse(null);
		...
		assertTrue(patientMedecinDao.findById(new PatientMedecinPK(c4, p)).getOrdre().equals(1)).orElse(null);
		assertTrue(patientMedecinDao.findById(new PatientMedecinPK(c3, p)).getOrdre().equals(2)).orElse(null);
		assertTrue(patientManager.getPatientLiensManager(p).size() == 2);
		assertTrue(patientLienDao.findById(new PatientLienPK(p, delphino)).getLienFamilial().equals(lienFamilialDao.findById(3))).orElse(null);
		...
		catched = true;
		try{
			final Patient mayer = patientDao.findById(1).orElse(null);
	...
	public void testUpdateMultipleObjectsManager() throws ParseException{
		...
		alpha2.setChampAnnotation(champAnnotationDao.findById(1)).orElse(null);
		alpha2.setAlphanum("bank2");
		listAnnots.add(alpha2);
		final AnnotationValeur alpha3 = new AnnotationValeur();
		alpha3.setChampAnnotation(champAnnotationDao.findById(1)).orElse(null);
		...
		list.add(patUp3);
		listAnnots.clear();
		listAnnots.addAll(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(1), pat1)).orElse(null);
		listAnnots.addAll(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(1), pat2)).orElse(null);
		listAnnots.addAll(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(1), pat3)).orElse(null);
		...
		assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(1), patTest1).get(0).getAlphanum().orElse(null)
				.equals("old"));
		assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(1), patTest2).get(0).getAlphanum().orElse(null)
				.equals("mid"));
		assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(1), patTest3).get(0).getAlphanum().orElse(null)
				.equals("young"));
		...
		assertFalse(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(1), patTest1).get(0).orElse(null)
		...
		alpha4.setChampAnnotation(champAnnotationDao.findById(1)).orElse(null);
		alpha4.setObjetId(id1);
		alpha4.setBanque(b1);
		listAnnots.add(alpha4);
		final AnnotationValeur alpha5 = new AnnotationValeur();
		alpha5.setAlphanum("&&é**¤¤");
		alpha5.setChampAnnotation(champAnnotationDao.findById(1)).orElse(null);
	...
	public void testCreateUpdatePatientWithAnnots() throws ParseException{
		...
		final Banque b1 = banqueManager.findByIdManager(1);
		final Utilisateur utilisateur = utilisateurDao.findById(1).orElse(null);
		final ChampAnnotation c = champAnnotationDao.findById(1).orElse(null);
	...
	public void testFusionPatientManager() throws ParseException{
		...
		alpha1b.setChampAnnotation(champAnnotationDao.findById(1)).orElse(null);
		...
		alpha2b.setChampAnnotation(champAnnotationDao.findById(20)).orElse(null);
		...
		alpha3b.setChampAnnotation(champAnnotationDao.findById(21)).orElse(null);
		alpha3b.setItem(itemDao.findById(8)).orElse(null);
		...
		final Collaborateur c1 = collaborateurDao.findById(1).orElse(null);
		colls1.add(c1);
		final Collaborateur c2 = collaborateurDao.findById(2).orElse(null);
		colls1.add(c2);
		//Liens familiaux
		...
		prel1.setCode("prel1");
		prelevementManager.createObjectManager(prel1, banqueManager.findByIdManager(1), natureDao.findById(1), malsP1.get(0).orElse(null),
				consentTypeDao.findById(1), null, null, null, null, null, null, null, null, null, null, null, u, false, null, false).orElse(null);
		final Prelevement prel2 = new Prelevement();
		prel2.setCode("prel2");
		prelevementManager.createObjectManager(prel2, banqueManager.findByIdManager(1), natureDao.findById(1), malsP1.get(1).orElse(null),
				consentTypeDao.findById(1), null, null, null, null, null, null, null, null, null, null, null, u, false, null, false).orElse(null);
		...
		listAnnots.add(alpha1);
		final AnnotationValeur alpha2 = new AnnotationValeur();
		alpha2.setChampAnnotation(champAnnotationDao.findById(19)).orElse(null);
		alpha2.setBool(true);
		alpha2.setBanque(banqueManager.findByIdManager(1));
		listAnnots.add(alpha2);
		final AnnotationValeur alpha3 = new AnnotationValeur();
		alpha3.setChampAnnotation(champAnnotationDao.findById(21)).orElse(null);
		alpha3.setItem(itemDao.findById(7)).orElse(null);
		...
		pl3.setLienFamilial(lienFamilialDao.findById(1)).orElse(null);
		final PatientLien pl4 = new PatientLien();
		pl4.setPatient2(patientManager.findByNomLikeManager("SOLIS", true).get(0));
		pl4.setLienFamilial(lienFamilialDao.findById(2)).orElse(null);
		liens2.add(pl3);
		liens2.add(pl4);
		...
		prel3.setCode("prel3");
		prelevementManager.createObjectManager(prel3, banqueManager.findByIdManager(1), natureDao.findById(1), malsP2.get(0).orElse(null),
				consentTypeDao.findById(1), null, null, null, null, null, null, null, null, null, null, null, u, false, null, false).orElse(null);
		final Prelevement prel4 = new Prelevement();
		prel4.setCode("prel4");
		prelevementManager.createObjectManager(prel4, banqueManager.findByIdManager(1), natureDao.findById(1), malsP2.get(1).orElse(null),
				consentTypeDao.findById(1), null, null, null, null, null, null, null, null, null, null, null, u, false, null, false).orElse(null);
		...
		assertTrue(patientMedecinDao.findById(new PatientMedecinPK(c2, fus)).getOrdre().equals(3)).orElse(null);
		assertTrue(patientManager.getPatientLiensManager(fus).size() == 3);
		assertTrue(patientManager.getPatientLiensManager(fus).contains(patientLienDao.findById(new PatientLienPK(fus, mayer)))).orElse(null);
		...
		assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(1), fus).size() == 1).orElse(null);
		assertTrue(annotationValeurManager.findByChampAndObjetManager(champAnnotationDao.findById(1), fus).get(0).getAlphanum().orElse(null)
				.equals("val1"));
