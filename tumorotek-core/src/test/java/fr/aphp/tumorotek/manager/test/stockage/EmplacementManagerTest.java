...
public class EmplacementManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		...
		Emplacement eNull = emplacementManager.findByIdManager(10);
		assertNull(eNull);
	}
	...
	public void testFindAll() {
		List<Emplacement> list = emplacementManager.findAllObjectsManager();
	...
	public void testFindByTerminaleAndVide() {
		...
		List<Emplacement> list = emplacementManager
			.findByTerminaleAndVideManager(t1, true);
		assertEquals(2, list.size());
		assertTrue(list.get(0).getAdrl().equals("CC1.R1.T1.BT1.A-J"));
		
		list = emplacementManager
			.findByTerminaleAndVideManager(t1, false);
		assertTrue(list.size() == 3);
		assertTrue(list.get(0).getAdrl().equals("CC1.R1.T1.BT1.A-A"));
		
		Terminale t2 = terminaleDao.findById(3);
	...
	public void testFindByTerminaleWithOrder() {
		...
		List<Emplacement> list = emplacementManager
			.findByTerminaleWithOrder(t1);
		assertEquals(5, list.size());
		assertTrue(list.get(0).getAdrl().equals("CC1.R1.T1.BT1.A-A"));
		
		Terminale t2 = terminaleDao.findById(6);
		list = emplacementManager
			.findByTerminaleWithOrder(t2);
		assertTrue(list.size() == 2);
		assertTrue(list.get(0).getAdrl().equals("CC1.R2.T6.BT1.A-1"));
		
		Terminale t3 = terminaleDao.findById(3);
	...
	public void testFindByTerminaleAndPosition() {
		...
		list = emplacementManager
			.findByTerminaleAndPosition(t2, 1);
		assertTrue(list.size() == 0);
	...
	public void testFindByEmplacementAdrlManager() {
		...
		Emplacement empl = emplacementManager
			.findByEmplacementAdrlManager("CC1.R1.T1.BT1.A-A", b1);
		assertTrue(empl.getEmplacementId() == 1);
		assertTrue(emplacementManager
			.findByEmplacementAdrlManager("CC1.R1.T1.BT1.1", b1)
			.getEmplacementId() == 1);
		assertNull(emplacementManager
				.findByEmplacementAdrlManager("CC1.R1.T1.BT1.A-1", b1));
		
		empl = emplacementManager
			.findByEmplacementAdrlManager("CC1.R1.T1.BT1.A-J", b1);
		assertTrue(empl.getEmplacementId() == 4);
		assertTrue(emplacementManager
				.findByEmplacementAdrlManager("CC1.R1.T1.BT1.10", b1)
				.getEmplacementId() == 4);
		
		// out of bounds
		assertNull(emplacementManager
			.findByEmplacementAdrlManager("CC1.R1.T1.BT1.A-K", b1));
		assertNull(emplacementManager
				.findByEmplacementAdrlManager("CC1.R1.T1.BT1.415", b1));
		
		// a creer
		empl = emplacementManager
			.findByEmplacementAdrlManager("CC1.R1.T1.BT1.C-D", b1);
		assertNull(empl.getEmplacementId());
		empl = emplacementManager
				.findByEmplacementAdrlManager("CC1.R1.T1.BT1.29", b1);
		assertNull(empl.getEmplacementId());
		
		
		// autre numerotation
		 empl = emplacementManager
				.findByEmplacementAdrlManager("CC1.R2.T6.BT1.A-2", b1);
		assertTrue(empl.getEmplacementId() == 7);
		assertTrue(emplacementManager
			.findByEmplacementAdrlManager("CC1.R2.T6.BT1.2", b1)
			.getEmplacementId() == 7);
		empl = emplacementManager
				.findByEmplacementAdrlManager("CC1.R2.T6.BT1.A-1", b1);
		assertTrue(empl.getEmplacementId() == 6);
		assertTrue(emplacementManager
				.findByEmplacementAdrlManager("CC1.R2.T6.BT1.1", b1)
				.getEmplacementId() == 6);
		
		// out of bounds
		assertNull(emplacementManager
			.findByEmplacementAdrlManager("CC1.R2.T6.BT1.K-2", b1));
		assertNull(emplacementManager
				.findByEmplacementAdrlManager("CC1.R2.T6.BT1.114", b1));
		
		// a creer
		empl = emplacementManager
			.findByEmplacementAdrlManager("CC1.R2.T6.BT1.C-2", b1);
		assertNull(empl.getEmplacementId());
		empl = emplacementManager
				.findByEmplacementAdrlManager("CC1.R2.T6.BT1.31", b1);
			assertNull(empl.getEmplacementId());
			
		// dummy tests
		empl = emplacementManager
			.findByEmplacementAdrlManager("CC1.1", b1);
		assertNull(empl);
		
		empl = emplacementManager
			.findByEmplacementAdrlManager("CC1.BT1.1", b1);
		assertNull(empl);
		
		empl = emplacementManager
			.findByEmplacementAdrlManager("CC1.R1.BT1.1", b1);
		assertNull(empl);
		
		empl = emplacementManager
			.findByEmplacementAdrlManager("CT1.R1.T1.BT1.1", b1);
		assertNull(empl);
	
		empl = emplacementManager
			.findByEmplacementAdrlManager("CC1.X1.T1.BT1.1", b1);
		assertNull(empl);
		
		empl = emplacementManager
			.findByEmplacementAdrlManager("CC1.R1.X1.BT1.1", b1);
		assertNull(empl);

		empl = emplacementManager
			.findByEmplacementAdrlManager("CC1.R1.T1.B1.1", b1);
		assertNull(empl);
		
		empl = emplacementManager
			.findByEmplacementAdrlManager("CC1.R1.T1.BT1.1A", b1);
		assertNull(empl);
		
		empl = emplacementManager
				.findByEmplacementAdrlManager("CC1.R1.T1.BT33.A-A", b1);
			assertNull(empl);
		...
		banks.add(b1);
		conteneurManager
			.createObjectManager(c2, null, serviceDao.findById(1), 
						banks, pfs,
		...
		try {
			 emplacementManager
				.findByEmplacementAdrlManager("CC1.R1.T1.BT1.89", b1);
		} catch (EmplacementImportConteneurException ie) {
			catched = true;
		}
		assertTrue(catched);
		
		// clean up
		Conteneur cTest2 = conteneurManager.findByIdManager(c2.getConteneurId());
		assertNotNull(cTest2);
		conteneurManager.removeObjectManager(cTest2, null, 
				utilisateurDao.findById(1));
	...
	public void testGetNumerotationByPositionAndTerminaleManager() {
		Terminale t1 = terminaleDao.findById(1);
		String num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(1, t1);
		assertTrue(num.equals("A-A"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(5, t1);
		assertTrue(num.equals("A-E"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(10, t1);
		assertTrue(num.equals("A-J"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(11, t1);
		assertTrue(num.equals("B-A"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(20, t1);
		assertTrue(num.equals("B-J"));		
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(23, t1);
		assertTrue(num.equals("C-C"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(59, t1);
		assertTrue(num.equals("F-I"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(100, t1);
		assertTrue(num.equals("J-J"));
		
		Terminale t2 = terminaleDao.findById(2);
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(1, t2);
		assertTrue(num.equals("1"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(5, t2);
		assertTrue(num.equals("5"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(10, t2);
		assertTrue(num.equals("10"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(11, t2);
		assertTrue(num.equals("11"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(20, t2);
		assertTrue(num.equals("20"));		
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(23, t2);
		assertTrue(num.equals("23"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(59, t2);
		assertTrue(num.equals("59"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(100, t2);
		assertTrue(num.equals("100"));
		
		Terminale t4 = terminaleDao.findById(4);
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(1, t4);
		assertTrue(num.equals("1-1"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(5, t4);
		assertTrue(num.equals("1-5"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(10, t4);
		assertTrue(num.equals("1-10"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(11, t4);
		assertTrue(num.equals("2-1"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(23, t4);
		assertTrue(num.equals("3-3"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(59, t4);
		assertTrue(num.equals("6-9"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(100, t4);
		assertTrue(num.equals("10-10"));
		
		Terminale t5 = terminaleDao.findById(5);
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(1, t5);
		assertTrue(num.equals("1-A"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(5, t5);
		assertTrue(num.equals("2-C"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(10, t5);
		assertTrue(num.equals("4-A"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(11, t5);
		assertTrue(num.equals("4-B"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(23, t5);
		assertTrue(num.equals("6-C"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(59, t5);
		assertTrue(num.equals("10-E"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(67, t5);
		assertTrue(num.equals("11-D"));
		
		Terminale t6 = terminaleDao.findById(6);
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(1, t6);
		assertTrue(num.equals("A-1"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(5, t6);
		assertTrue(num.equals("A-5"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(10, t6);
		assertTrue(num.equals("B-1"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(11, t6);
		assertTrue(num.equals("B-2"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(23, t6);
		assertTrue(num.equals("C-5"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(59, t6);
		assertTrue(num.equals("G-5"));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(81, t6);
		assertTrue(num.equals("I-9"));
		
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(0, t1);
		assertTrue(num.equals(""));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(155, t1);
		assertTrue(num.equals(""));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(15, null);
		assertTrue(num.equals(""));
		num = emplacementManager
			.getNumerotationByPositionAndTerminaleManager(15, new Terminale());
		assertTrue(num.equals(""));
	}
	...
	public void testGetPositionByCoordonnees() {
		...
		assertTrue(pos.equals(0));
		pos = emplacementManager.getPositionByCoordonnees(
				new Terminale(), 1, 1);
		assertTrue(pos.equals(0));
	...
	public void testFindDoublon() {
		...
		Emplacement e2 = emplacementManager.findByIdManager(2);
	...
	public void testGetNomsForEmplacementsManager() {
		Emplacement e1 = emplacementManager.findByIdManager(1);
		Emplacement e2 = emplacementManager.findByIdManager(2);
		Emplacement e3 = emplacementManager.findByIdManager(3);
		Emplacement e5 = emplacementManager.findByIdManager(5);
		Emplacement e6 = emplacementManager.findByIdManager(6);
		
		List<Emplacement> emplList = new ArrayList<Emplacement>();
		...
		emplList = new ArrayList<Emplacement>();
		emplList.add(e6);
		emplList.add(e5);
		results = emplacementManager.getNomsForEmplacementsManager(emplList);
	...
	private void createObjectManagerTest() throws ParseException {
		...
		Terminale term = terminaleDao.findById(1);
		...
		try {
			...
			if (e.getClass().getSimpleName().equals(
					"EmplacementDoublonFoundException")) {
				assertTrue(((EmplacementDoublonFoundException) e)
												.getTerminale().equals(term));
				assertTrue(((EmplacementDoublonFoundException) e)
		...
		int id = emp1.getEmplacementId();
		// Vérification
		Emplacement eTest = emplacementManager.findByIdManager(id);
		assertNotNull(eTest);
		...
		int id2 = emp2.getEmplacementId();
		// Vérification
		Emplacement eTest2 = emplacementManager.findByIdManager(id2);
	...
	private void updateObjectManagerTest() throws ParseException {
		...
		Integer id1 = emp.getEmplacementId();
		
		Boolean catched = false;
		Emplacement empUp1 = emplacementManager.findByIdManager(id1);
		...
		assertTrue(emplacementManager.findAllObjectsManager().size() == 8);
		// Vérification
		Emplacement eTest = emplacementManager.findByIdManager(id1);
		assertNotNull(eTest);
		assertNotNull(eTest.getTerminale());
		...
		// On test une insertion valide avec toutes les assos
		Emplacement empUp2 = emplacementManager.findByIdManager(id1);
		...
		assertTrue(emplacementManager.findAllObjectsManager().size() == 8);
		// Vérification
		Emplacement eTest2 = emplacementManager.findByIdManager(id1);
		assertNotNull(eTest2);
		assertNotNull(eTest2.getTerminale());
		assertNotNull(eTest2.getEntite());
	...
	private void removeObjectManagerTest() {
		...
		Emplacement emp1 = emplacementManager.findByIdManager(1);
		boolean catched = false;
		try {
	...
	public void testCreateMultiObjetcsManager() {
		...
		List<Emplacement> list = emplacementManager
			.createMultiObjetcsManager(t2, 10);
	 ...
	 * @throws ParseException 
	 */
	private void validationInsert(Emplacement emplacement) 
		throws ParseException {
		...
		String[] emptyValues = new String[]{"", "  ", "%$$¤¤*gd", 
				createOverLength(50)};
	 ...
	 * @throws ParseException 
	 */
	private void validationUpdate(Emplacement emplacement) 
		throws ParseException {
	...
	public void testDeplacerMultiEmplacementsManager() {
		Utilisateur u = utilisateurDao.findById(4);
		...
		List<Emplacement> list = new ArrayList<Emplacement>();
		...
		try {
			emplacementManager.deplacerMultiEmplacementsManager(list, u);
		} catch (RequiredObjectIsNullException rex) {
			catched = true;
		}
		assertTrue(catched);
		assertTrue(emplacementManager.findAllObjectsManager().size() == 7);
		...
		list = new ArrayList<Emplacement>();
		Emplacement e1 = emplacementManager.findByIdManager(1);
		e1.setPosition(155);
		list.add(e1);
		catched = false;
		...
		Integer pos1 = e1.getPosition();
		Emplacement e2 = emplacementManager.findByIdManager(2);
		Integer pos2 = e2.getPosition();
		Emplacement e3 = emplacementManager.findByIdManager(3);
		...
		Object o1 = entiteManager.findObjectByEntiteAndIdManager(
				e1.getEntite(), e1.getObjetId());
		assertTrue(getOperationManager().findByObjectManager(o1).size() == 3);
		Object o2 = entiteManager.findObjectByEntiteAndIdManager(
				e2.getEntite(), e2.getObjetId());
		assertTrue(getOperationManager().findByObjectManager(o2).size() == 2);
		Object o3 = entiteManager.findObjectByEntiteAndIdManager(
				e3.getEntite(), e3.getObjetId());
		...
		List<Operation> ops = getOperationManager().findByUtilisateurManager(u);
	...
	public void testValidateMultiEmplacements() {
		Emplacement e1 = emplacementManager.findByIdManager(1);
		Emplacement e2 = emplacementManager.findByIdManager(2);
		Emplacement eError = new Emplacement();
		Terminale t = terminaleDao.findById(1);
		Entite entite = entiteDao.findById(3);
		List<Emplacement> liste = new ArrayList<Emplacement>();
		liste.add(e1);
		liste.add(e2);
		liste.add(eError);
		liste.add(null);
	...
	public void testSaveMultiEmplacements() {
		Emplacement e1 = emplacementManager.findByIdManager(1);
		Emplacement e2 = emplacementManager.findByIdManager(2);
		Emplacement eNew = new Emplacement();
		...
		Integer idEmp = eNew.getEmplacementId();
		Emplacement eTestNew = emplacementManager.findByIdManager(idEmp);
		assertTrue(eTestNew.getPosition().equals(20));
		
		eTest4.setPosition(10);
		emplacementManager.updateObjectManager(
				eTest4, eTest4.getTerminale(), eTest4.getEntite());
		eTest4 = emplacementManager.findByIdManager(4);
		assertTrue(eTest4.getPosition().equals(10));
