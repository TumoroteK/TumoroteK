...
public class EmplacementManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByTerminaleAndVide(){
      final Terminale t1 = terminaleDao.findById(1).orElse(null);
      ...
      final Terminale t2 = terminaleDao.findById(3).orElse(null);
   ...
   public void testFindByTerminaleWithOrder(){
      ...
      final Terminale t2 = terminaleDao.findById(6).orElse(null);
      list = emplacementManager.findByTerminaleWithOrder(t2);
      assertEquals(2, list.size());
      assertEquals("CC1.R2.T6.BT1.A-1", list.get(0).getAdrl());

      final Terminale t3 = terminaleDao.findById(3).orElse(null);
   ...
   public void testFindByTerminaleAndPosition(){
      ...
      final Terminale t2 = terminaleDao.findById(2).orElse(null);
   ...
   public void testFindByEmplacementAdrlManager(){
      ...
      pfs.add(plateformeDao.findById(1)).orElse(null);
      final List<Banque> banks = new ArrayList<>();
      banks.add(b1);
      conteneurManager.createObjectManager(c2, null, serviceDao.findById(1), banks, pfs, utilisateurDao.findById(1).orElse(null),
      ...
      conteneurManager.removeObjectManager(cTest2, null, utilisateurDao.findById(1)).orElse(null);
   ...
   public void testGetNumerotationByPositionAndTerminaleManager(){
      ...
      final Terminale t4 = terminaleDao.findById(4).orElse(null);
      ...
      final Terminale t5 = terminaleDao.findById(5).orElse(null);
      ...
      final Terminale t6 = terminaleDao.findById(6).orElse(null);
   ...
   private void createObjectManagerTest() throws ParseException{
      ...
      final Terminale term = terminaleDao.findById(1).orElse(null);
   ...
   public void testDeplacerMultiEmplacementsManager(){
      final Utilisateur u = utilisateurDao.findById(4).orElse(null);
