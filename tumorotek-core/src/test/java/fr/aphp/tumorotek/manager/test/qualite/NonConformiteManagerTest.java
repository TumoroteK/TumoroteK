...
public class NonConformiteManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByPlateformeAndTypeObjManager(){
      ...
      final Plateforme p2 = plateformeDao.findById(2).orElse(null);
   ...
   public void testFindByPlateformeAndTypeStringManager(){
      ...
      List<NonConformite> list =
         nonConformiteManager.findByPlateformeEntiteAndTypeStringManager(p1, "Arrivee", entiteDao.findById(2)).orElse(null);
      assertTrue(list.size() == 2);

      final Plateforme p2 = plateformeDao.findById(2).orElse(null);
      list = nonConformiteManager.findByPlateformeEntiteAndTypeStringManager(p2, "Arrivee", entiteDao.findById(2)).orElse(null);
      assertTrue(list.size() == 1);

      list = nonConformiteManager.findByPlateformeEntiteAndTypeStringManager(p2, "%", entiteDao.findById(3)).orElse(null);
      assertTrue(list.size() == 0);

      list = nonConformiteManager.findByPlateformeEntiteAndTypeStringManager(p2, "Traitement", entiteDao.findById(3)).orElse(null);
      assertTrue(list.size() == 0);

      list = nonConformiteManager.findByPlateformeEntiteAndTypeStringManager(p1, "Traitement", entiteDao.findById(3)).orElse(null);
      assertTrue(list.size() == 2);

      list = nonConformiteManager.findByPlateformeEntiteAndTypeStringManager(p1, "Cession", entiteDao.findById(8)).orElse(null);
      assertTrue(list.size() == 2);

      list = nonConformiteManager.findByPlateformeEntiteAndTypeStringManager(null, "Arrivee", entiteDao.findById(2)).orElse(null);
      assertTrue(list.size() == 0);

      list = nonConformiteManager.findByPlateformeEntiteAndTypeStringManager(p1, null, entiteDao.findById(3)).orElse(null);
      assertTrue(list.size() == 0);
   ...
   public void testFindDoublon(){
      ...
      n1.setPlateforme(plateformeDao.findById(1)).orElse(null);
      n1.setNom("Test");
      ...
      n1.setPlateforme(plateformeDao.findById(2)).orElse(null);
      assertFalse(nonConformiteManager.findDoublonManager(n1));
  ...
  @Test
   public void testCrud(){
      ...
      assertTrue(n2.getPlateforme().equals(plateformeDao.findById(1))).orElse(null);
      ...
      assertTrue(nonConformiteManager.findAllObjectsManager().size() == tot + 1);
      n2.setPlateforme(plateformeDao.findById(1)).orElse(null);
      ...
      n2.setNom("UP");
      n2.setPlateforme(plateformeDao.findById(2)).orElse(null);
      ...
      assertTrue(n3.getPlateforme().equals(plateformeDao.findById(2))).orElse(null);
