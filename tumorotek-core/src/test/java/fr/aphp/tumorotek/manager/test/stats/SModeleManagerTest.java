...
public class SModeleManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      assertTrue(sModeleManager.getSubdivisionManager(sM2).equals(subdivisionDao.findById(2))).orElse(null);
   ...
   public void testGetSubdivisionManager(){
      ...
      assertTrue(s.equals(subdivisionDao.findById(1))).orElse(null);
