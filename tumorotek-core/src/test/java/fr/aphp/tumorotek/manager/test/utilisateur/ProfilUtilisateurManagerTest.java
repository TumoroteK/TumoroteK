...
public class ProfilUtilisateurManagerTest extends AbstractManagerTest4
{
	...
	public void testFindByIdManager(){
		final Profil p1 = profilDao.findById(1).orElse(null);
	...
	public void testFindByProfilManager(){
		final Profil p1 = profilDao.findById(1).orElse(null);
		final Profil p3 = profilDao.findById(3).orElse(null);
		final Profil p4 = profilDao.findById(4).orElse(null);
	...
	public void testFindByUtilisateurProfilManager(){
		final Profil p2 = profilDao.findById(2).orElse(null);
		final Profil p4 = profilDao.findById(4).orElse(null);
		final Utilisateur u2 = utilisateurDao.findById(2).orElse(null);
		final Utilisateur u4 = utilisateurDao.findById(4).orElse(null);
	...
	public void testCountDistinctProfilForUserAndPlateformeGroupedByContexteManager(){
		...
		Long counts = profilUtilisateurManager
			.countDistinctProfilForUserAndPlateformeGroupedByContexteManager(utilisateurDao.findById(1).orElse(null), 
				plateformeDao.findById(1)).orElse(null);
		assertTrue(counts == 1L);

		counts = profilUtilisateurManager
				.countDistinctProfilForUserAndPlateformeGroupedByContexteManager(utilisateurDao.findById(3).orElse(null), 
						plateformeDao.findById(1)).orElse(null);
		assertTrue(counts == 2L);

		counts = profilUtilisateurManager
				.countDistinctProfilForUserAndPlateformeGroupedByContexteManager(utilisateurDao.findById(3).orElse(null), 
						plateformeDao.findById(2)).orElse(null);
		...
		counts = profilUtilisateurManager
				.countDistinctProfilForUserAndPlateformeGroupedByContexteManager(utilisateurDao.findById(1), null).orElse(null);
		assertTrue(counts == 0L);
	}
}