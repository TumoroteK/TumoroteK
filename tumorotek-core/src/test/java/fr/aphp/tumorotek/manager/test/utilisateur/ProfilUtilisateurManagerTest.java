...
public class ProfilUtilisateurManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindAllObjectsManager(){
      final List<ProfilUtilisateur> liste = profilUtilisateurManager.findAllObjectsManager();
   ...
   public void testFindByExcludedPKManager(){
      ...
      List<ProfilUtilisateur> liste = profilUtilisateurManager.findByExcludedPKManager(pk);
   ...
   public void testFindByProfilManager(){
      ...
      List<ProfilUtilisateur> liste = profilUtilisateurManager.findByProfilManager(p1, true);
   ...
   public void testFindByUtilisateurManager(){
      ...
      List<ProfilUtilisateur> liste = profilUtilisateurManager.findByUtilisateurManager(u2, false);
      assertTrue(liste.size() == 2);
   ...
   public void testFindByBanqueManager(){
      ...
      List<ProfilUtilisateur> liste = profilUtilisateurManager.findByBanqueManager(b1, false);
      assertTrue(liste.size() == 2);
   ...
   public void testFindByUtilisateurProfilManager(){
      ...
      List<ProfilUtilisateur> liste = profilUtilisateurManager.findByUtilisateurProfilManager(u2, p2);
      assertTrue(liste.size() == 2);
      ...
      liste = profilUtilisateurManager.findByUtilisateurProfilManager(u2, null);
      assertTrue(liste.size() == 0);

      liste = profilUtilisateurManager.findByUtilisateurProfilManager(null, p2);
      assertTrue(liste.size() == 0);

      liste = profilUtilisateurManager.findByUtilisateurProfilManager(null, null);
      assertTrue(liste.size() == 0);
   }
   ...
   public void testFindByUtilisateurBanqueManager(){
      ...
      List<ProfilUtilisateur> liste = profilUtilisateurManager.findByUtilisateurBanqueManager(u2, b1);
      assertTrue(liste.size() == 1);
      ...
      liste = profilUtilisateurManager.findByUtilisateurBanqueManager(u2, null);
      assertTrue(liste.size() == 0);

      liste = profilUtilisateurManager.findByUtilisateurBanqueManager(null, b1);
      assertTrue(liste.size() == 0);

      liste = profilUtilisateurManager.findByUtilisateurBanqueManager(null, null);
      assertTrue(liste.size() == 0);
   }
   ...
   public void testFindByBanqueProfilManager(){
      ...
      List<ProfilUtilisateur> liste = profilUtilisateurManager.findByBanqueProfilManager(b1, p2);
      assertTrue(liste.size() == 1);
   ...
   public void testValidateObjectManager(){
      ...
      try{
         profilUtilisateurManager.validateObjectManager(u3, b1, null);
      ...
      try{
         profilUtilisateurManager.validateObjectManager(null, b1, p1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         profilUtilisateurManager.validateObjectManager(u3, null, p1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // est lancée
      try{
         profilUtilisateurManager.validateObjectManager(u3, b2, p1);
      }catch(final Exception e){
   ...
   public void testCrud(){
      ...
      // on test l'insertion avec le profil null
      try{
         profilUtilisateurManager.createObjectManager(pu1, u4, b1, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // on test l'insertion avec l'utilisateur null
      try{
         profilUtilisateurManager.createObjectManager(pu1, null, b1, p1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // on test l'insertion avec la banque null
      try{
         profilUtilisateurManager.createObjectManager(pu1, u4, null, p1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // est lancée
      try{
         profilUtilisateurManager.createObjectManager(pu1, u3, b2, p1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      profilUtilisateurManager.createObjectManager(pu1, u4, b1, p1);
      final ProfilUtilisateurPK pk = pu1.getPk();
      assertTrue(profilUtilisateurManager.findAllObjectsManager().size() == 9);

      final ProfilUtilisateur puTest = profilUtilisateurManager.findByIdManager(pk);
   ...
   public void testCountDistinctProfilForUserAndPlateformeGroupedByContexteManager(){
      ...
      Long counts = profilUtilisateurManager
         .countDistinctProfilForUserAndPlateformeGroupedByContexteManager(utilisateurDao.findById(1), plateformeDao.findById(1));
      assertTrue(counts == 1L);

      counts = profilUtilisateurManager
         .countDistinctProfilForUserAndPlateformeGroupedByContexteManager(utilisateurDao.findById(3), plateformeDao.findById(1));
      assertTrue(counts == 2L);

      counts = profilUtilisateurManager
         .countDistinctProfilForUserAndPlateformeGroupedByContexteManager(utilisateurDao.findById(3), plateformeDao.findById(2));
      assertTrue(counts == 0L);

      // nulls
      counts = profilUtilisateurManager.countDistinctProfilForUserAndPlateformeGroupedByContexteManager(null,
   ...
   public void testCountDistinctProfilForUserAndPlateformeGroupedByEtudeManager(){
      ...
      Map<Etude, Long> counts = profilUtilisateurManager
         .countDistinctProfilForUserAndPlateformeGroupedByEtudeManager(utilisateurDao.findById(1), plateformeDao.findById(1));
      assertTrue(counts.isEmpty());

      counts =
         profilUtilisateurManager.countDistinctProfilForUserAndPlateformeGroupedByEtudeManager(null, plateformeDao.findById(1));
      assertTrue(counts.isEmpty());

      counts =
         profilUtilisateurManager.countDistinctProfilForUserAndPlateformeGroupedByEtudeManager(utilisateurDao.findById(1), null);
      assertTrue(counts.isEmpty());
   }
}
