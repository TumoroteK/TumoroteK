...
public class ModeleTypeManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		ModeleType mt = modeleTypeManager.findByIdManager(1);
		assertNotNull(mt);
		assertTrue(mt.getType().equals("Etiquettes"));
		
		ModeleType mtNull = modeleTypeManager.findByIdManager(10);
		assertNull(mtNull);
	}
	...
	public void testFindAll() {
		List<ModeleType> list = modeleTypeManager.findAllObjectsManager();
