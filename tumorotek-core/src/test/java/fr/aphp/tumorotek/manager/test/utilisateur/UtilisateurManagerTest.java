...
public class UtilisateurManagerTest extends AbstractManagerTest4
{
   ...
   public void testArchiveScheduledUtilisateursManager(){
      ...
      u2.setArchive(false);
      utilisateurManager.updateObjectManager(u2, u2.getCollaborateur(), null, null, admin, operationTypeDao.findById(5));
      ...
      u4.setArchive(false);
      utilisateurManager.updateObjectManager(u4, u4.getCollaborateur(), null, null, admin, operationTypeDao.findById(5));
