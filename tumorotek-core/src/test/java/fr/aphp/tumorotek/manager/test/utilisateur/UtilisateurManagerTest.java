...
public class UtilisateurManagerTest extends AbstractManagerTest4
{
   ...
   private void createObjectManagerTest() throws ParseException{
      ...
      u1.setPassword("PASS");
      try{
         utilisateurManager.createObjectManager(u1, null, null, null, admin, null);
      ...
      catched = false;
      try{
         utilisateurManager.createObjectManager(u1, null, profils, null, admin, null);
      }catch(final Exception e){
      ...
      u1.setLogin("PIERRE");
      utilisateurManager.createObjectManager(u1, null, null, null, admin, plateformeManager.findByIdManager(1));
      ...
      utilisateurManager.createObjectManager(u2, c, profils, plateformes, admin, null);
   ...
   private void updateObjectManagerTest() throws ParseException{
      ...
      final OperationType oType = operationTypeDao.findById(5).orElse(null);
      ...
      profils.add(pu1);
      plateformes.add(pf1);
      utilisateurManager.createObjectManager(u, null, profils, plateformes, admin, plateformeManager.findByIdManager(1));
      assertTrue(utilisateurManager.findAllObjectsManager().size() == 5);
      ...
      uUp1.setLogin("USER1");
      try{
         utilisateurManager.updateObjectManager(uUp1, null, null, null, admin, oType);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      catched = false;
      try{
         utilisateurManager.updateObjectManager(uUp1, null, profils, null, admin, oType);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      plateformes.add(pf2);
      utilisateurManager.updateObjectManager(uUp1, null, profils, plateformes, admin, oType);
      assertTrue(utilisateurManager.findAllObjectsManager().size() == 5);
      assertTrue(profilUtilisateurManager.findAllObjectsManager().size() == 9);
      assertTrue(plateformeManager.findAllObjectsManager().size() == 2);
      ...
      utilisateurManager.updateObjectManager(uTest, c, profils, plateformes, admin, oType);
      assertTrue(utilisateurManager.findAllObjectsManager().size() == 5);
      assertTrue(profilUtilisateurManager.findAllObjectsManager().size() == 8);
      assertTrue(plateformeManager.findAllObjectsManager().size() == 2);
   ...
   public void testUpdatePasswordManager(){
      ...
      utilisateurManager.createObjectManager(u1, c, profils, plateformes, admin, plateformeManager.findByIdManager(2));
      assertTrue(utilisateurManager.findAllObjectsManager().size() == 5);
      assertTrue(profilUtilisateurManager.findAllObjectsManager().size() == 10);
      assertTrue(plateformeManager.findAllObjectsManager().size() == 2);
      final Integer idU1 = u1.getUtilisateurId();
   ...
   private void removeObjectManagerTest(){
      ...
      u.setLogin("TEST");
      u.setPassword("PASS");
      utilisateurManager.createObjectManager(u, null, null, null, admin, plateformeManager.findByIdManager(1));
      assertTrue(utilisateurManager.findAllObjectsManager().size() == 5);
   ...
   public void testArchiveScheduledUtilisateursManager(){
      final Utilisateur admin = utilisateurManager.findByIdManager(5);
      // Profil p1 = profilDao.findById(1).orElse(null);
      // Profil p2 = profilDao.findById(2).orElse(null);
      ...
      utilisateurManager.createObjectManager(uNew1, c, null, null, admin, plateformeManager.findByIdManager(2));
      ...
      utilisateurManager.createObjectManager(uNew2, c, null, null, admin, plateformeManager.findByIdManager(2));
      ...
      assertTrue(toArchiveNow.contains(utilisateurDao.findById(2))).orElse(null);
      assertTrue(toArchiveNow.contains(utilisateurDao.findById(4))).orElse(null);
      ...
      u2.setArchive(false);
      utilisateurManager.updateObjectManager(u2, u2.getCollaborateur(), null, null, admin, operationTypeDao.findById(5)).orElse(null);
      ...
      u4.setArchive(false);
      utilisateurManager.updateObjectManager(u4, u4.getCollaborateur(), null, null, admin, operationTypeDao.findById(5)).orElse(null);
