...
public class BanqueManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByPlateformeAndArchiveManager(){
      ...
      assertTrue(banques.size() == 0);
      pf = plateformeDao.findById(3).orElse(null);
      banques = banqueManager.findByPlateformeAndArchiveManager(pf, false);
      assertTrue(banques.size() == 0);
   }
   ...
   public void testFindByEntiteConsultByUtilisateurManager(){
      Utilisateur utilisateur = utilisateurDao.findById(3).orElse(null);
      final Plateforme pf = plateformeDao.findById(1).orElse(null);
      final Entite prel = entiteDao.findById(2).orElse(null);
      ...
      banks = banqueManager.findByEntiteModifByUtilisateurManager(utilisateurDao.findById(2), prel, pf).orElse(null);
      assertTrue(banks.size() == 2);

      // superadmin since 2.0.13
      utilisateur = utilisateurDao.findById(5).orElse(null);
      banks = banqueManager.findByEntiteModifByUtilisateurManager(utilisateur, prel, pf);
      assertTrue(banks.size() == 3);

      utilisateur = utilisateurDao.findById(1).orElse(null);
      banks = banqueManager.findByEntiteModifByUtilisateurManager(utilisateur, prel, pf);
      assertTrue(banks.size() == 2);

      final Entite der = entiteDao.findById(8).orElse(null);
      banks = banqueManager.findByEntiteModifByUtilisateurManager(utilisateur, der, pf);
      assertTrue(banks.size() == 2);

      utilisateur = utilisateurDao.findById(2).orElse(null);
      banks = banqueManager.findByEntiteModifByUtilisateurManager(utilisateur, der, pf);
      assertTrue(banks.size() == 0);

      banks = banqueManager.findByEntiteConsultByUtilisateurManager(utilisateurDao.findById(4), prel, pf).orElse(null);
      assertTrue(banks.size() == 0);
   }
   ...
   public void testFindByEntiteModifByUtilisateurManager(){
      ...
      banks = banqueManager.findByEntiteModifByUtilisateurManager(utilisateurDao.findById(4), prel, pf).orElse(null);
      assertTrue(banks.size() == 0);
   }
   ...
   public void testFindByUtilisateurIsAdminManager(){
      ...
      assertTrue(banks.contains(banqueManager.findByIdManager(1)));
      assertTrue(banks.contains(banqueManager.findByIdManager(2)));
      banks = banqueManager.findByUtilisateurIsAdminManager(utilisateurDao.findById(3), pf).orElse(null);
      assertTrue(banks.size() == 1);
   ...
   public void testFindByUtilisateurAndPFManager(){
      ...
      final Plateforme pf2 = plateformeDao.findById(2).orElse(null);
   ...
   public void testGetConteneursManager(){
      ...
      assertTrue(conts.contains(conteneurDao.findById(1))).orElse(null);
      assertTrue(conts.contains(conteneurDao.findById(2))).orElse(null);
      assertTrue(conts.contains(conteneurDao.findById(3))).orElse(null);
      assertTrue(conts.contains(conteneurDao.findById(4))).orElse(null);
   ...
   private Banque createObjectManagerTest(){
      ...
      final Plateforme pf = plateformeDao.findById(1).orElse(null);
      final Contexte ct = contexteDao.findById(1).orElse(null);
      final Set<Catalogue> cats = new HashSet<>();
      cats.add(catalogueDao.findById(1)).orElse(null);
      cats.add(catalogueDao.findById(2)).orElse(null);
      ...
      final Collaborateur co = collaborateurDao.findById(3).orElse(null);
      final Couleur c1 = couleurDao.findById(3).orElse(null);
      final Couleur c2 = couleurDao.findById(4).orElse(null);
      ...
      assertTrue(banqueManager.findByPlateformeAndArchiveManager(plateformeDao.findById(1), null).size() == 3).orElse(null);
   ...
   private Banque updateObjectManagerTest(final Banque bank){
      ...
      b2.getCatalogues().remove(catalogueDao.findById(1)).orElse(null);
   ...
   public void testCreateUpdateConteneurs(){
      ...
      final Conteneur c1 = conteneurDao.findById(1).orElse(null);
      final Conteneur c2 = conteneurDao.findById(2).orElse(null);
      final Conteneur c3 = conteneurDao.findById(3).orElse(null);
      conts.add(c1);
      conts.add(c2);
      conts.add(c3);
      ...
      banske6.add(b);
      enceinteManager.updateObjectManager(e6, e6.getEnceinteType(), e6.getConteneur(), e6.getEnceintePere(), e6.getEntite(),
      ...
      banskec3.add(b);
      enceinteManager.createObjectManager(ec3, enceinteTypeManager.findByIdManager(1), c3, null, null, banskec3, null, u);
      ...
      conts.remove(c1);
      conts.remove(c2);
      final Conteneur c4 = conteneurDao.findById(4).orElse(null);
      conts.add(c4);
   ...
   public void testCreateUpdateTablesCodage(){
      ...
      tabs.remove(btc1);
      tabs.remove(btc2);
      final TableCodage t4 = tableCodageDao.findById(5).orElse(null);
   ...
   public void testCreateUpdateTablesAnnotation(){
      ...
      final List<TableAnnotation> tabsPat = new ArrayList<>();
      final TableAnnotation t1 = tableAnnotationDao.findById(1).orElse(null);
      tabsPat.add(t1);
      final List<TableAnnotation> tabsPrel = new ArrayList<>();
      final TableAnnotation t2 = tableAnnotationDao.findById(2).orElse(null);
      tabsPrel.add(t2);
      final List<TableAnnotation> tabsEchan = new ArrayList<>();
      final TableAnnotation t3 = tableAnnotationDao.findById(3).orElse(null);
      final TableAnnotation t4 = tableAnnotationDao.findById(4).orElse(null);
      final TableAnnotation t5 = tableAnnotationDao.findById(5).orElse(null);
      tabsEchan.add(t5);
      tabsEchan.add(t3);
      final List<TableAnnotation> tabsDerive = new ArrayList<>();
      final TableAnnotation t6 = tableAnnotationDao.findById(6).orElse(null);
      tabsDerive.add(t6);
   ...
   public void testCreateUpdateCouleurEntiteTypes(){
      ...
      final EchantillonType e1 = echantillonTypeDao.findById(1).orElse(null);
      final EchantillonType e2 = echantillonTypeDao.findById(2).orElse(null);
      final EchantillonType e3 = echantillonTypeDao.findById(3).orElse(null);
      final ProdType p1 = prodTypeDao.findById(1).orElse(null);
      final Couleur coul5 = couleurDao.findById(5).orElse(null);
      final CouleurEntiteType cE1 = new CouleurEntiteType();
      cE1.setCouleur(couleurDao.findById(1)).orElse(null);
      cE1.setEchantillonType(e1);
      final CouleurEntiteType cE2 = new CouleurEntiteType();
      cE2.setCouleur(couleurDao.findById(2)).orElse(null);
      cE2.setEchantillonType(e2);
      final CouleurEntiteType cE3 = new CouleurEntiteType();
      cE3.setCouleur(couleurDao.findById(3)).orElse(null);
      ...
      final EchantillonType e4 = echantillonTypeDao.findById(4).orElse(null);
      final CouleurEntiteType cE4 = new CouleurEntiteType();
      final Couleur coul4 = couleurDao.findById(4).orElse(null);
   ...
   public void testCreateOrUpdateBanqueWithProfilUtilisateur() throws IOException{
      ...
      final Plateforme pf = plateformeDao.findById(1).orElse(null);
      final Contexte contexte = contexteDao.findById(1).orElse(null);
      
      //Récupération des profils utilisé pour le test
      final Profil profilConsultation = profilDao.findById(1).orElse(null);
      final Profil profilGestionPatient = profilDao.findById(2).orElse(null);
      final Profil profilAdminBanque = profilDao.findById(4).orElse(null);
      
      //Préparation de la banque
      final Utilisateur admin = utilisateurDao.findById(5).orElse(null);
      final Banque banque = new Banque();
   ...
   public void testCascadeDeletion(){
      ...
      banqueManager.createOrUpdateObjectManager(b, pf, ct, b1.getProprietaire(), b1.getCollaborateur(), b1.getContact(),
         ...
         couleurDao.findById(2), u, null, "creation", "/tmp/").orElse(null);
      ...
      codeSel.setCodeId(1);
      codeSel.setTableCodage(tableCodageDao.findById(1)).orElse(null);
      ...
      couleurEntiteTypeManager.createObjectManager(cType, couleurDao.findById(2), b, echantillonTypeDao.findById(3), null).orElse(null);
      ...
      prelevementManager.createObjectManager(p, b, p1.getNature(), null, p1.getConsentType(), null, null, null, null, null, null,
      ...
      prodDeriveManager.createObjectManager(d, b, d1.getProdType(), objetStatutDao.findById(4).orElse(null), null, null, null, null, null,
      ...
      cessionManager.createObjectManager(c, b, c1.getCessionType(), null, null, null, null, null, c1.getCessionStatut(), null,
   ...
   public void testExistingAnnotationValuesException(){
      ...
      assertTrue(tableAnnotationManager.findByEntiteAndBanqueManager(entiteDao.findById(3), b2).size() == 1).orElse(null);
      assertTrue(tableAnnotationManager.findByEntiteAndBanqueManager(entiteDao.findById(3), b2).contains(t3)).orElse(null);
      ...
      banqueManager.createOrUpdateObjectManager(b2, b2.getPlateforme(), b2.getContexte(), b2.getProprietaire(),
         ...
         b2.getProdDeriveCouleur(), utilisateurDao.findById(1), null, "modification", "/tmp").orElse(null);

      assertTrue(tableAnnotationManager.findByEntiteAndBanqueManager(entiteDao.findById(3), b2).size() == 2).orElse(null);
      assertTrue(tableAnnotationManager.findByEntiteAndBanqueManager(entiteDao.findById(3), b2).contains(t3)).orElse(null);
      assertTrue(tableAnnotationManager.findByEntiteAndBanqueManager(entiteDao.findById(3), b2).contains(t4)).orElse(null);
      ...
      try{
         banqueManager.createOrUpdateObjectManager(b2, b2.getPlateforme(), b2.getContexte(), b2.getProprietaire(),
            ...
            b2.getEchantillonCouleur(), b2.getProdDeriveCouleur(), utilisateurDao.findById(1), null, "modification", "/tmp").orElse(null);
