...
public class IncaComplementExportTest extends AbstractManagerTest {
	...
	public void testGetCRAnapathInterrogeable() 
		...
		assertTrue(incaComplementExport
					.getCRAnapathInterro(con, p).equals("O"));
		p.setPrelevementId(3412);
		assertTrue(incaComplementExport
					.getCRAnapathInterro(con, p).equals("N"));
		p.setPrelevementId(1000);
		assertTrue(incaComplementExport
				.getCRAnapathInterro(con, p).equals(""));
	}
	...
	public void testGetDonneesClinBase() 
		...
		assertTrue(incaComplementExport
				.getDonneesClinBase(con, p, b).equals("N"));
		p.setPatientId(33);
		assertTrue(incaComplementExport
				.getDonneesClinBase(con, p, b).equals("N"));
		p.setPatientId(3412);
	...
	public void testGetInclusionTherap() 
		...
		assertTrue(incaComplementExport
				.getInclusionTherap(con, p, b).equals(""));
		p.setPatientId(119);
		assertTrue(incaComplementExport
				.getInclusionTherap(con, p, b).equals(""));
		p.setPatientId(3412);
	...
	throws ClassNotFoundException, SQLException {
		...
		assertTrue(incaComplementExport
				.getNomProtocoleTherap(con, p, b).equals(""));
	...
	public void testGetCaryotype() 
		...
		b.setBanqueId(1);
		assertTrue(incaComplementExport
				.getCaryotype(con, p, b).equals(""));
	}
	
	public void testGetAnomalieCaryo() 
	throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		assertTrue(incaComplementExport
				.getAnomalieCaryo(con, p, b).equals(""));
	}
	
	public void testGetAnomalieGenomique() 
					throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection con = DriverManager
		.getConnection("jdbc:mysql://localhost:3306/" 
		...
		assertTrue(incaComplementExport
				.getAnomalieGenomique(con, p, b).equals("O"));
		p.setPatientId(3);
		assertTrue(incaComplementExport
				.getAnomalieGenomique(con, p, b).equals("N"));
		p.setPatientId(4);
		assertTrue(incaComplementExport
				.getAnomalieGenomique(con, p, b).equals(""));
	}
	...
	public void testGetControleQualite() {
		...
		EchanQualite qual = new EchanQualite();
	...
	public void testGetInclusionProtocoleRech() 
		...
		assertTrue(incaComplementExport
				.getInclusionProtocoleRech(con, p).equals(""));
	...
	public void testGetNomProtocoleRech() 
		...
		assertTrue(incaComplementExport
				.getNomProtocoleRech(con, p).equals(""));
