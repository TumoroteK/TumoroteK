...
public class TemplateManagerTest extends AbstractManagerTest4
{
   ...
   public void testCreateObjectManager() throws ParseException{
      ...
      final BlocImpression bi2 = blocImpressionDao.findById(2).orElse(null);
      final ChampEntite ce1 = champEntiteDao.findById(1).orElse(null);
   ...
   public void testUpdateObjectManager(){
      ...
      final BlocImpression bi1 = blocImpressionDao.findById(1).orElse(null);
      final BlocImpression bi2 = blocImpressionDao.findById(2).orElse(null);
      final BlocImpression bi3 = blocImpressionDao.findById(3).orElse(null);
      final ChampEntite ce1 = champEntiteDao.findById(1).orElse(null);
      final ChampEntite ce2 = champEntiteDao.findById(2).orElse(null);
