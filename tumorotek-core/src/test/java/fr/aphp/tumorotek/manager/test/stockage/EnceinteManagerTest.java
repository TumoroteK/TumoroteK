...
public class EnceinteManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		...
		Enceinte eNull = enceinteManager.findByIdManager(10);
		assertNull(eNull);
	}
	...
	public void testFindAll() {
		List<Enceinte> list = enceinteManager.findAllObjectsManager();
	...
	public void testFindByConteneurWithOrderManager() {
		...
		List<Enceinte> list = enceinteManager
			.findByConteneurWithOrderManager(c1);
		assertEquals(2, list.size());
		assertTrue(list.get(0).getNom().equals("R1"));
		
		Conteneur c2 = conteneurDao.findById(2);
		list = enceinteManager
			.findByConteneurWithOrderManager(c2);
	...
	public void testFindByEnceintePereWithOrderManager() {
		Enceinte e1 = enceinteManager.findByIdManager(1);
		List<Enceinte> list = enceinteManager
			.findByEnceintePereWithOrderManager(e1);
		assertTrue(list.size() == 3);
		assertTrue(list.get(0).getNom().equals("T1"));
		
		Enceinte e2 = enceinteManager.findByIdManager(2);
		list = enceinteManager
			.findByEnceintePereWithOrderManager(e2);
		assertTrue(list.size() == 2);
		
		Enceinte e3 = enceinteManager.findByIdManager(3);
	...
	public void testFindByConteneurAndNomManager() {
		Conteneur c1 = conteneurDao.findById(1);
		List<Enceinte> list = enceinteManager
			.findByConteneurAndNomManager(c1, "R1");
		assertTrue(list.size() == 1);
		assertTrue(list.get(0).getNom().equals("R1"));
		
		list = enceinteManager
			.findByConteneurAndNomManager(c1, "Rqsdqsd1");
		assertTrue(list.size() == 0);
		
		Conteneur c2 = conteneurDao.findById(2);
		list = enceinteManager
			.findByConteneurAndNomManager(c2, "R1");
		assertTrue(list.size() == 0);
	...
	public void testFindByEnceintePereAndNomManager() {
		Enceinte e1 = enceinteManager.findByIdManager(1);
		List<Enceinte> list = enceinteManager
			.findByEnceintePereAndNomManager(e1, "T1");
		assertTrue(list.size() == 1);
		assertTrue(list.get(0).getNom().equals("T1"));
		
		list = enceinteManager
			.findByEnceintePereAndNomManager(e1, "jhq");
		assertTrue(list.size() == 0);
	...
	public void testUsedNomsExceptOneManager() {
		Enceinte e1 = enceinteManager.findByIdManager(1);
		List<String> list = enceinteManager
			.usedNomsExceptOneManager(e1);
		assertTrue(list.size() == 1);
		assertTrue(list.get(0).equals("R2"));
		
		Enceinte e2 = enceinteManager.findByIdManager(2);
		list = enceinteManager
			.usedNomsExceptOneManager(e2);
		assertTrue(list.size() == 1);
	...
	public void testGetEnceintesManager() {
		...
		Iterator<Enceinte> it = set.iterator();
	...
	public void testGetTerminalesManager() {
		...
		assertTrue(set.size() == 3);
		Iterator<Terminale> it = set.iterator();
		...
		Enceinte e4 = enceinteManager.findByIdManager(4);
	...
	public void testGetAllTerminalesInArborescenceManager() {
		...
		Enceinte e3 = enceinteManager.findByIdManager(3);
		List<Terminale> list = enceinteManager
			.getAllTerminalesInArborescenceManager(e3);
		assertTrue(list.size() == 3);
	...
	public void testCheckEnceinteInEnceintePereLimitesManager() {
		...
		Enceinte e3 = enceinteManager.findByIdManager(3);
		assertTrue(enceinteManager
				.checkEnceinteInEnceintePereLimitesManager(e3));
		
		e3.setPosition(1000);
		assertFalse(enceinteManager
				.checkEnceinteInEnceintePereLimitesManager(e3));
		
		Enceinte newE = new Enceinte();
		assertFalse(enceinteManager
				.checkEnceinteInEnceintePereLimitesManager(newE));
		...
		assertFalse(enceinteManager
				.checkEnceinteInEnceintePereLimitesManager(null));
	...
	public void testCheckEnceinteInConteneurLimitesManager() {
		...
		Enceinte e1 = enceinteManager.findByIdManager(1);
		assertTrue(enceinteManager
				.checkEnceinteInConteneurLimitesManager(e1));
		...
		Enceinte newE = new Enceinte();
		assertFalse(enceinteManager
				.checkEnceinteInConteneurLimitesManager(newE));
		...
		assertFalse(enceinteManager
				.checkEnceinteInConteneurLimitesManager(null));
	...
	public void testCheckPositionLibreInEnceinte() {
		Enceinte e1 = enceinteManager.findByIdManager(1);
		assertFalse(checkPositionManager
			.checkPositionLibreInEnceinteManager(e1, 1, null, 10));
		assertTrue(checkPositionManager
				.checkPositionLibreInEnceinteManager(e1, 1, null, 3));
		assertFalse(checkPositionManager
				.checkPositionLibreInEnceinteManager(e1, 1, 1, null));
		assertFalse(checkPositionManager
				.checkPositionLibreInEnceinteManager(e1, 1, null, null));
		assertTrue(checkPositionManager
				.checkPositionLibreInEnceinteManager(e1, 10, null, null));
		
		Enceinte e3 = enceinteManager.findByIdManager(3);
		assertFalse(checkPositionManager
			.checkPositionLibreInEnceinteManager(e3, 1, 10, null));
		assertTrue(checkPositionManager
				.checkPositionLibreInEnceinteManager(e3, 10, 1, null));
		assertFalse(checkPositionManager
				.checkPositionLibreInEnceinteManager(e3, 1, null, 1));
		assertFalse(checkPositionManager
				.checkPositionLibreInEnceinteManager(e3, 1, null, null));
		
		Enceinte e4 = enceinteManager.findByIdManager(4);
		assertTrue(checkPositionManager
			.checkPositionLibreInEnceinteManager(e4, 1, null, null));
		
		assertFalse(checkPositionManager
				.checkPositionLibreInEnceinteManager(null, 1, 1, 1));
		
		assertFalse(checkPositionManager
				.checkPositionLibreInEnceinteManager(e3, null, null, null));
		
		assertFalse(checkPositionManager
				.checkPositionLibreInEnceinteManager(null, null, null, null));
	}
	...
	public void testCheckPositionLibreInConteneurManager() {
		Conteneur c1 = conteneurDao.findById(1);
		assertFalse(checkPositionManager
			.checkPositionLibreInConteneurManager(c1, 1, 10));
		
		assertTrue(checkPositionManager
				.checkPositionLibreInConteneurManager(c1, 1, 1));
		
		assertFalse(checkPositionManager
				.checkPositionLibreInConteneurManager(c1, 1, 2));
		
		assertFalse(checkPositionManager
				.checkPositionLibreInConteneurManager(c1, 1, null));
		
		assertFalse(checkPositionManager
				.checkPositionLibreInConteneurManager(c1, null, 1));
		
		assertFalse(checkPositionManager
				.checkPositionLibreInConteneurManager(null, 1, 1));
		
		assertFalse(checkPositionManager
				.checkPositionLibreInConteneurManager(null, 1, null));
		
		assertFalse(checkPositionManager
				.checkPositionLibreInConteneurManager(c1, null, null));
		
		assertFalse(checkPositionManager
				.checkPositionLibreInConteneurManager(null, null, null));
	}
	...
	public void testCheckLastEnceinte() {
		...
		Enceinte e2 = enceinteManager.findByIdManager(1);
	...
	public void testGetObjetIdsByEntiteByPS() {
		...
		list = enceinteManager.getObjetIdsByEntiteByPS(e1,
		...
		Enceinte e2 = enceinteManager.findByIdManager(2);
		list = enceinteManager.getObjetIdsByEntiteByPS(e2,
				entiteDao.findById(3));
		assertTrue(list.size() == 0);
		
		Enceinte e3 = enceinteManager.findByIdManager(3);
		list = enceinteManager.getObjetIdsByEntiteByPS(e3,
				entiteDao.findById(3));
		assertTrue(list.size() == 1);
		
		Enceinte e4 = enceinteManager.findByIdManager(4);
		list = enceinteManager.getObjetIdsByEntiteByPS(e4,
				entiteDao.findById(3));
		assertTrue(list.size() == 0);
		
		Enceinte newE = new Enceinte();
		list = enceinteManager.getObjetIdsByEntiteByPS(newE,
				entiteDao.findById(3));
		assertTrue(list.size() == 0);
		
		list = enceinteManager.getObjetIdsByEntiteByPS(null,
				entiteDao.findById(3));
		assertTrue(list.size() == 0);
	...
	public void testFindDoublonWithoutOneEnceinteManager() {
		...
		Enceinte e1 = enceinteManager.findByIdManager(1);
		Enceinte e2 = enceinteManager.findByIdManager(2);
		assertFalse(enceinteManager.findDoublonWithoutTwoEnceintesManager(
				e1, e2));
		...
		assertTrue(enceinteManager.findDoublonWithoutTwoEnceintesManager(
				e3, e7));
		assertFalse(enceinteManager.findDoublonWithoutTwoEnceintesManager(
				e3, e6));
		assertFalse(enceinteManager.findDoublonWithoutTwoEnceintesManager(
	...
	private void createObjectManagerTest() throws ParseException {
		...
		Enceinte enc = enceinteManager.findByIdManager(1);
		Conteneur cont = conteneurDao.findById(1);
		...
		try {
			enceinteManager.createObjectManager(e1, null, cont, 
		...
		// non nulls
		try {
			enceinteManager.createObjectManager(e1, type, cont, 
					enc, null, null, null, u);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
		...
		// nulls
		try {
			enceinteManager.createObjectManager(e1, type, null, 
					null, null, null, null, u);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"InvalidParentException")) {
		...
		e1.setPosition(3);
		try {
			enceinteManager.createObjectManager(e1, type, c4, 
					null, null, banks, null, u);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
		...
		int id = e1.getEnceinteId();
		// Vérification
		Enceinte eTest = enceinteManager.findByIdManager(id);
		assertNotNull(eTest);
		...
		enceinteManager.createObjectManager(e2, type, null, 
				enc, ent, banks, couleurDao.findById(7), u);
		assertTrue(enceinteManager.findAllObjectsManager().size() == 9);
		assertTrue(getOperationManager().findByObjectManager(e2).size() == 1);
		int id2 = e2.getEnceinteId();
		// Vérification
		Enceinte eTest2 = enceinteManager.findByIdManager(id2);
		...
		assertTrue(getOperationManager()
								.findByObjectManager(eTest).size() == 0);
		assertTrue(getOperationManager()
								.findByObjectManager(eTest2).size() == 0);
		assertTrue(enceinteManager.findAllObjectsManager().size() == 7);
	...
	private void updateObjectManagerTest() throws ParseException {
		...
		Enceinte en = new Enceinte();
		en.setNbPlaces(3);
		en.setNom("TEST3");
		en.setPosition(3);
		enceinteManager.createObjectManager(en, type, null, 
				enc, null, null, null, u);
		assertTrue(enceinteManager.findAllObjectsManager().size() == 8);
		assertTrue(getOperationManager().findByObjectManager(en).size() == 1);
		Integer id = en.getEnceinteId();
		
		Enceinte eUp1 = enceinteManager.findByIdManager(id);
		Boolean catched = false;
		// on test l'update avec l'enceinteType nulle
		try {
			enceinteManager.updateObjectManager(eUp1, null, cont, 
		...
		// non nulls
		try {
			enceinteManager.updateObjectManager(eUp1, type, cont, 
					enc, null, null, null, null, u, null);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"InvalidParentException")) {
				catched = true;
		...
		// nulls
		try {
			enceinteManager.updateObjectManager(eUp1, type, null, 
					null, null, null, null, null, u, null);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"InvalidParentException")) {
		...
		eUp1.setPosition(3);
		try {
			enceinteManager.updateObjectManager(eUp1, type, c4, 
					null, null, banks, null, null, u, null);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"IncoherenceException")) {
				catched = true;
		...
		try {
			enceinteManager.updateObjectManager(eUp1, type, cont, 
					null, null, banks, null, incs, u, null);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"ValidationException")) {
				catched = true;
		...
		// toutes les assos
		Enceinte eUp2 = enceinteManager.findByIdManager(id);
		eUp2.setNom("T3");
		eUp2.setPosition(3);
		...
		enceinteManager.updateObjectManager(eUp2, type, null, 
				enc, ent, banks, couleurDao.findById(5), incs, u, opTypes);
		assertTrue(getOperationManager().findByObjectManager(eUp2).size() == 5);
		// Vérification
		Enceinte eTest2 = enceinteManager.findByIdManager(id);
		assertNotNull(eTest2);
		assertNotNull(eTest2.getEnceintePere());
		assertNotNull(eTest2.getEnceinteType());
		assertNotNull(eTest2.getEntite());
		...
		Iterator<Banque> it = enceinteManager.getBanquesManager(eTest2)
			.iterator();
	...
	private void removeObjectManagerTest() {
		...
		try {
			...
			if (e.getClass().getSimpleName().equals(
					"ObjectUsedException")) {
				assertTrue(((ObjectUsedException) e)
						.getKey().equals("enceinte.deletion.isUsed"));
				catched = true;
			}
		}
		assertTrue(catched);
		...
		Enceinte newE = new Enceinte();
		Conteneur cont = conteneurDao.findById(2);
		EnceinteType type = enceinteTypeDao.findById(1);
		...
		newE.setNbPlaces(5);
		newE.setPosition(1);
		enceinteManager.createObjectManager(newE, type, cont, 
				null, null, banks, null, u);
		assertTrue(enceinteManager.findAllObjectsManager().size() == 8);
		Integer id = newE.getEnceinteId();
		
		// création de 5 enceintes pour celle-ci
		Enceinte supE = enceinteManager.findByIdManager(id);
		Enceinte newE2 = new Enceinte();
		newE2.setNom("T");
		newE2.setNbPlaces(5);
		newE2.setEnceinteType(type);
		List<Enceinte> encs = enceinteManager
			.createMultiObjetcsForEnceinteManager(supE, newE2, 5, null, u);
	 ...
	 * @throws ParseException 
	 */
	private void validationInsert(Enceinte enceinte) 
		throws ParseException {
		Utilisateur u = utilisateurDao.findById(1);
		Conteneur cont = conteneurDao.findById(1);
		EnceinteType type = enceinteTypeDao.findById(1);
		...
		try {
			...
			enceinteManager.createObjectManager(enceinte, type, cont, 
					null, null, null, null, u);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"ValidationException")) {
		...
		Integer[] nbPlacesValues = new Integer[]{null, -1};
	 ...
	 * @throws ParseException 
	 */
	private void validationUpdate(Enceinte enceinte) 
		throws ParseException {
		Utilisateur u = utilisateurDao.findById(1);
		Conteneur cont = conteneurDao.findById(1);
		EnceinteType type = enceinteTypeDao.findById(1);
		...
		try {
			enceinte.setPosition(-1);
			enceinteManager.updateObjectManager(enceinte, type, cont, 
					null, null, null, null, null, u, null);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"ValidationException")) {
		...
		List<Incident> incs = incidentManager.findByEnceinteManager(enceinte);
		Incident inc1 = new Incident();
		...
		try {
			enceinteManager.updateObjectManager(enceinte, type, cont, 
					null, null, null, null, incs, u, null);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"DoublonFoundException")) {
				catched = true;
	...
	public void testCreateMultiObjetcsForConteneurManager() {
		Utilisateur u = utilisateurDao.findById(1);
		Conteneur cont1 = conteneurDao.findById(1);
		Conteneur cont2 = conteneurDao.findById(2);
		EnceinteType type = enceinteTypeDao.findById(1);
		Entite ent = entiteDao.findById(3);
		
		Enceinte newEs = new Enceinte();
		...
		enceinteManager.createMultiObjetcsForConteneurManager(
				cont2, null, 2, null, u);
		assertTrue(enceinteManager.findAllObjectsManager().size() == 7);
		...
		// on teste une création multiple valide avec la premiere position
		// à null
		List<Enceinte> list2  = enceinteManager
			.createMultiObjetcsForConteneurManager(
				cont2, newEs, 2, null, u);
	...
	public void testCreateMultiObjetcsForEnceinteManager() {
		...
		// Test de la création avec l'enceinte à null
		enceinteManager.createMultiObjetcsForEnceinteManager(
				e4, null, 2, null, u);
		assertTrue(enceinteManager.findAllObjectsManager().size() == 7);
		...
		List<Enceinte> list = enceinteManager
			.createMultiObjetcsForEnceinteManager(e4, newEs, 5, 58, u);
	...
	public void testEchangerDeuxEnceintesManager() {
		...
		Conteneur c3 = e3.getConteneur();
		Enceinte ep3 = e3.getEnceintePere();
		Integer pos3 = e3.getPosition();
		
		Conteneur c6 = e6.getConteneur();
		Enceinte ep6 = e6.getEnceintePere();
		Integer pos6 = e6.getPosition();
		
		Conteneur c7 = e7.getConteneur();
		Enceinte ep7 = e7.getEnceintePere();
		Integer pos7 = e7.getPosition();
		...
		assertTrue(getOperationManager()
						.findByObjectManager(eTest3).size() == 1);
		assertTrue(getOperationManager()
						.findByObjectManager(eTest6).size() == 1);
		...
		assertTrue(getOperationManager()
							.findByObjectManager(eTest3).size() == 2);
		assertTrue(getOperationManager()
							.findByObjectManager(eTest6).size() == 2);
		
		// on teste l'échange de 2 enceintes cote a cote
		Enceinte e4 = enceinteManager.findByIdManager(4);
		Conteneur c4 = e4.getConteneur();
		Enceinte ep4 = e4.getEnceintePere();
		Integer pos4 = e4.getPosition();
	...
	public void testCreateAllTerminalesManager() throws ParseException {
		Utilisateur u = utilisateurDao.findById(1);
		Conteneur c = conteneurDao.findById(2);
		Enceinte eParent = enceinteManager.findByIdManager(3);
		Banque bank1 = banqueDao.findById(1);
		...
		try {
			enceinteManager.createAllArborescenceManager(
					null, enceintes, term, goodPositions, banques, u);
			enceinteManager.createAllArborescenceManager(
					e1, null, term, goodPositions, banques, u);
			enceinteManager.createAllArborescenceManager(
					e1, enceintes, null, goodPositions, banques, u);
			enceinteManager.createAllArborescenceManager(
					e1, enceintes, term, null, banques, u);
			enceinteManager.createAllArborescenceManager(
					e1, enceintes, term, badPositions, banques, u);
		} catch (Exception e) {
			e.printStackTrace();
		}
		assertTrue(enceinteManager.findAllObjectsManager().size() == 7);
		...
		try {
			enceinteManager.createAllArborescenceManager(
					e1, enceintes, term, goodPositions, banques, u);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"InvalidParentException")) {
				catched = true;
		...
		Set<Enceinte> eTests = enceinteManager.getEnceintesManager(eParent);
		assertTrue(eTests.size() == 1);
		
		Terminale tTest = enceinteManager.getTerminalesManager(e1)
			.iterator().next();
		assertTrue(tTest.getNom().equals("BT10"));
		
		List<Terminale> terms = terminaleManager
									.findByEnceinteWithOrderManager(e1);
	...
	public void testCreateAllArborescenceManager() throws ParseException {
		...
		Enceinte eTest1 = conteneurManager.getEnceintesManager(c)
			.iterator().next();
		...
		List<Enceinte> dep = new ArrayList<Enceinte>();
		dep.add(e1);
		...
		for (int i = 0; i < encs.size(); i++) {
			terms.addAll(terminaleManager
					.findByEnceinteWithOrderManager(encs.get(i)));
		}
	 ...
	 */
	@Test
	public void testUpdatewithCreateAllArborescenceManager() 
		throws ParseException {
		Utilisateur u = utilisateurDao.findById(1);
		Conteneur c = conteneurDao.findById(2);
		Enceinte eParent = enceinteManager.findByIdManager(3);
		...
		e.setPosition(1);
		enceinteManager
			.createObjectManager(e, eType1, c, null, null, banques, 
					couleurDao.findById(2), u);
		Enceinte eUp = enceinteManager.findByIdManager(e.getEnceinteId());
		eUp.setNom("RUP1");
		...
		// test avec des éléments nulls ou de mauvais positions
		try {
			enceinteManager.updatewithCreateAllArborescenceManager(
					null, enceintes, term, goodPositions, banques, u);
			enceinteManager.updatewithCreateAllArborescenceManager(
					eUp, null, term, goodPositions, banques, u);
			enceinteManager.updatewithCreateAllArborescenceManager(
					eUp, enceintes, null, goodPositions, banques, u);
			enceinteManager.updatewithCreateAllArborescenceManager(
					eUp, enceintes, term, null, banques, u);
			enceinteManager.updatewithCreateAllArborescenceManager(
					eUp, enceintes, term, badPositions, banques, u);
		} catch (Exception exp) {
			exp.printStackTrace();
		}
		assertTrue(enceinteManager.findAllObjectsManager().size() == 8);
		...
		try {
			enceinteManager.updatewithCreateAllArborescenceManager(
					eUp, enceintes, term, goodPositions, banques, u);
		} catch (Exception exp) {
			if (exp.getClass().getSimpleName().equals(
					"InvalidParentException")) {
				catched = true;
			}
		}
	...
	public void getConteneurParentManager() {
		Enceinte e5 = enceinteManager.findByIdManager(6);
		assertTrue(enceinteManager.getConteneurParent(e5)
									.equals(conteneurDao.findById(1)));
		Enceinte e1 = enceinteManager.findByIdManager(1);
		assertTrue(enceinteManager.getConteneurParent(e1)
									.equals(conteneurDao.findById(1)));
		Enceinte enull = new Enceinte();
	...
	public void testUpdateTailleEnceinte() {
		...
		enceinteManager.createObjectManager(e1, type, null, 
				enc, ent, banks, null, u);
		assertTrue(enceinteManager.findAllObjectsManager().size() == 8);
		assertTrue(getOperationManager().findByObjectManager(e1).size() == 1);
		int id1 = e1.getEnceinteId();
		// Vérification
		Enceinte eTest1 = enceinteManager.findByIdManager(id1);
		...
		// update de la taille
		Enceinte up = enceinteManager.findByIdManager(id1);
		Enceinte eTest2 = enceinteManager.updateTailleEnceinteManager(
				up, 5, u);
		assertTrue(enceinteManager.findAllObjectsManager().size() == 8);
		assertTrue(getOperationManager().findByObjectManager(eTest2)
				.size() == 2);
		...
		enceinteManager.createObjectManager(e3, type, null, 
				eTest2, ent, banks, null, u);
		
		Enceinte e4 = new Enceinte();
		e4.setNom("T3-8");
		e4.setPosition(8);
		e4.setAlias("T3_8");
		e4.setNbPlaces(5);
		
		enceinteManager.createObjectManager(e4, type, null, 
				eTest2, ent, banks, null, u);
		...
		Set<Enceinte> enceintes = enceinteManager.getEnceintesManager(eTest2);
		int i = 1;
		for (Enceinte ec : enceintes) {
			if (i == 1) {
		...
		assertTrue(getOperationManager().findByObjectManager(bad)
				.size() == 4);
		...
		Integer idEct1 = ect1.getEnceinteId();
		...
		// terminales filles
		Terminale t1 = new Terminale();
		t1.setNom("BT1-1");
		t1.setPosition(3);
		TerminaleType typeT = terminaleTypeDao.findById(1);
		TerminaleNumerotation num = terminaleNumerotationDao.findById(1);
				
		terminaleManager.createObjectManager(t1, ect1, typeT, null, null, 
				num, null, u);
		...
		terminaleManager.createObjectManager(t2, ect1, typeT, null, null, 
				num, null, u);
				
		Terminale t3 = new Terminale();
		t3.setNom("BT3-9");
		t3.setPosition(9);
				
		terminaleManager.createObjectManager(t3, ect1, typeT, null, null, 
				num, null, u);
		...
		ect1 = enceinteManager.findByIdManager(idEct1);
		Set<Terminale> terminales = enceinteManager.getTerminalesManager(ect1);
		i = 1;
		for (Terminale tm : terminales) {
			if (i == 1) {
