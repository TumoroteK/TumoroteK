...
public class EnceinteManagerTest extends AbstractManagerTest4
{
   ...
   public void testGetObjetIdsByEntiteByPS(){
      ...
      list = enceinteManager.getObjetIdsByEntiteByPS(e1, entiteDao.findById(3)).orElse(null);
      assertEquals(1, list.size());

      list = enceinteManager.getObjetIdsByEntiteByPS(e1, entiteDao.findById(8)).orElse(null);
      assertEquals(2, list.size());

      final Enceinte e2 = enceinteManager.findByIdManager(2);
      list = enceinteManager.getObjetIdsByEntiteByPS(e2, entiteDao.findById(3)).orElse(null);
      assertEquals(0, list.size());

      final Enceinte e3 = enceinteManager.findByIdManager(3);
      list = enceinteManager.getObjetIdsByEntiteByPS(e3, entiteDao.findById(3)).orElse(null);
      assertEquals(1, list.size());

      final Enceinte e4 = enceinteManager.findByIdManager(4);
      list = enceinteManager.getObjetIdsByEntiteByPS(e4, entiteDao.findById(3)).orElse(null);
      assertEquals(0, list.size());

      final Enceinte newE = new Enceinte();
      list = enceinteManager.getObjetIdsByEntiteByPS(newE, entiteDao.findById(3)).orElse(null);
      assertEquals(0, list.size());

      list = enceinteManager.getObjetIdsByEntiteByPS(null, entiteDao.findById(3)).orElse(null);
      assertEquals(0, list.size());
   ...
   private void createObjectManagerTest() throws ParseException{
      ...
      final Conteneur cont = conteneurDao.findById(1).orElse(null);
      final EnceinteType type = enceinteTypeDao.findById(1).orElse(null);
      ...
      enceinteManager.createObjectManager(e2, type, null, enc, ent, banks, couleurDao.findById(7), u).orElse(null);
   ...
   private void updateObjectManagerTest() throws ParseException{
      ...
      enceinteManager.updateObjectManager(eUp2, type, null, enc, ent, banks, couleurDao.findById(5), incs, u, opTypes).orElse(null);
   ...
   private void removeObjectManagerTest(){
      ...
      final Enceinte newE = new Enceinte();
      final Conteneur cont = conteneurDao.findById(2).orElse(null);
      final EnceinteType type = enceinteTypeDao.findById(1).orElse(null);
   ...
   public void testCreateMultiObjetcsForConteneurManager(){
      final Utilisateur u = utilisateurDao.findById(1).orElse(null);
      final Conteneur cont1 = conteneurDao.findById(1).orElse(null);
      final Conteneur cont2 = conteneurDao.findById(2).orElse(null);
      final EnceinteType type = enceinteTypeDao.findById(1).orElse(null);
      final Entite ent = entiteDao.findById(3).orElse(null);
   ...
   public void testCreateAllTerminalesManager() throws ParseException{
      final Utilisateur u = utilisateurDao.findById(1).orElse(null);
      final Conteneur c = conteneurDao.findById(2).orElse(null);
   ...
   public void testUpdatewithCreateAllArborescenceManager() throws ParseException{
      ...
      e.setConteneur(c);
      e.setPosition(1);
      enceinteManager.createObjectManager(e, eType1, c, null, null, banques, couleurDao.findById(2), u).orElse(null);
   ...
   public void getConteneurParentManager(){
      ...
      assertEquals(enceinteManager.getConteneurParent(e5), conteneurDao.findById(1)).orElse(null);
      final Enceinte e1 = enceinteManager.findByIdManager(1);
      assertEquals(enceinteManager.getConteneurParent(e1), conteneurDao.findById(1)).orElse(null);
   ...
   public void testUpdateTailleEnceinte(){
      ...
      t1.setNom("BT1-1");
      t1.setPosition(3);
      final TerminaleType typeT = terminaleTypeDao.findById(1).orElse(null);
      final TerminaleNumerotation num = terminaleNumerotationDao.findById(1).orElse(null);
