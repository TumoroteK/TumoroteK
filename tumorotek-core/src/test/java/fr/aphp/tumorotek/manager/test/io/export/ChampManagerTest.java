...
public class ChampManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      /** Save. */
      final Champ champ = new Champ(champEntiteDao.findById(200)).orElse(null);
      ...
      /** Update. */
      champ.setChampEntite(champEntiteDao.findById(201)).orElse(null);
      final Champ parent = new Champ(champEntiteDao.findById(202)).orElse(null);
   ...
   public void testGetValueForObjectManager() throws ParseException{
      ...
      final Champ c1 = new Champ(champEntiteDao.findById(3)).orElse(null);
      assertTrue(manager.getValueForObjectManager(c1, p1, true).equals("MAYER"));

      final Prelevement prlvt1 = prelevementDao.findById(1).orElse(null);
      final Champ c24 = new Champ(champEntiteDao.findById(24)).orElse(null);
      ...
      final Champ c28 = new Champ(champEntiteDao.findById(28)).orElse(null);
      assertTrue(manager.getValueForObjectManager(c28, prlvt1, true).equals("VIAL"));
      final Champ c27 = new Champ(champEntiteDao.findById(27)).orElse(null);
      ...
      final Champ c30 = new Champ(champEntiteDao.findById(30)).orElse(null);
      assertTrue(manager.getValueForObjectManager(c30, prlvt1, true).equals("06/09/1983 10:00"));
      final Champ c34 = new Champ(champEntiteDao.findById(34)).orElse(null);
      assertTrue(manager.getValueForObjectManager(c34, prlvt1, true).equals("10"));
      final Champ c37 = new Champ(champEntiteDao.findById(37)).orElse(null);
      assertTrue(manager.getValueForObjectManager(c37, prlvt1, true).equals("-5.0"));
      final Champ c47 = new Champ(champEntiteDao.findById(47)).orElse(null);
      assertTrue(manager.getValueForObjectManager(c47, prlvt1, true).equals("Oui"));

      // Mauvais paramétrage
      final Champ cWrong = new Champ(champEntiteDao.findById(24)).orElse(null);
