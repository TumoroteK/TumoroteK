...
public class CollaborateurManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		...
		Collaborateur collabNull = collaborateurManager.findByIdManager(7);
	...
	public void testFindAll() {
		List<Collaborateur> list = collaborateurManager.findAllObjectsManager();
	...
	public void testFindAllObjectsWithOrderManager() {
		List<Collaborateur> list = collaborateurManager
	...
	public void testFindAllActiveObjectsWithoutService() {
		List<Collaborateur> list = collaborateurManager
			.findAllActiveObjectsWithoutService();
	...
	public void testGetServicesManager() {
		Collaborateur collab1 = collaborateurManager.findByIdManager(1);
		assertNotNull(collab1);
		Set<Service> services = 
			collaborateurManager.getServicesManager(collab1);
		assertTrue(services.size() == 1);
		
		Collaborateur collab2 = collaborateurManager.findByIdManager(4);
		assertNotNull(collab2);
		services = collaborateurManager.getServicesManager(collab2);
		assertTrue(services.size() == 0);
		
		Collaborateur collabNull = null;
	...
	public void testGetCoordonneesManager() {
		Collaborateur collab1 = collaborateurManager.findByIdManager(1);
		assertNotNull(collab1);
		Set<Coordonnee> coordonnees = 
			collaborateurManager.getCoordonneesManager(collab1);
	...
	public void testFindByNomLikeExactManager() {
		List<Collaborateur> list = 
			collaborateurManager.findByNomLikeManager("VIAL", true);
	...
	public void testFindByNomLikeManager() {
		List<Collaborateur> list = 
			collaborateurManager.findByNomLikeManager("VIAL", false);
		assertTrue(list.size() == 1);
	...
	public void testFindByNomLikeBothSideManager() {
		List<Collaborateur> list = 
			collaborateurManager.findByNomLikeBothSideManager("AL");
		assertTrue(list.size() == 1);
	...
	public void testFindByPrenomLikeExactManager() {
		List<Collaborateur> list = 
			collaborateurManager.findByPrenomLikeManager("CHRISTOPHE", true);
		assertTrue(list.size() == 2);
	...
	public void testFindBySpecialiteManager() {
		Specialite spec1 = specialiteManager.findByIdManager(1);
		List<Collaborateur> list = 
			collaborateurManager.findBySpecialiteManager(spec1);
		assertNotNull(list);
		assertTrue(list.size() == 3);
		
		Specialite spec4 = specialiteManager.findByIdManager(4);
	...
	public void testFindByServicesAndArchiveManager() {
		...
		List<Collaborateur> liste = collaborateurManager
			.findByServicesAndArchiveManager(s1, false);
		assertTrue(liste.size() == 2);
		liste = collaborateurManager
			.findByServicesAndArchiveManager(s1, true);
		assertTrue(liste.size() == 0);
		
		Service s2 = serviceManager.findByIdManager(2);
		liste = collaborateurManager
			.findByServicesAndArchiveManager(s2, false);
		assertTrue(liste.size() == 0);
		liste = collaborateurManager
			.findByServicesAndArchiveManager(s2, true);
		assertTrue(liste.size() == 1);
		
		liste = collaborateurManager
			.findByServicesAndArchiveManager(new Service(), false);
		
		liste = collaborateurManager
			.findByServicesAndArchiveManager(null, false);
	}
	...
	public void testFindByPrenomLikeManager() {
		List<Collaborateur> list = 
			collaborateurManager.findByPrenomLikeManager("CHRISTOPHE", false);
		assertTrue(list.size() == 2);
	...
	public void testFindDoublon() {
		Specialite spe1 = specialiteManager.findByIdManager(1);
		Specialite spe2 = specialiteManager.findByIdManager(2);
		String nom1 = "VIAL";
		String nom2 = "VRAI";
		String prenom1 = "CHRISTOPHE";
		String prenom2 = "PRE";
		...
		Collaborateur collab2 = collaborateurManager.findByIdManager(1);
	...
	public void testIsArchivableManager() {
		Collaborateur c1 = collaborateurManager.findByIdManager(1);
		Service s1 = serviceManager.findByIdManager(1);
		Service s2 = serviceManager.findByIdManager(2);
		...
		Collaborateur c3 = collaborateurManager.findByIdManager(3);
		...
		Collaborateur c4 = collaborateurManager.findByIdManager(4);
	...
	public void testCrud() {
		...
		Service service = serviceManager.findByIdManager(1);
		Service service2 = serviceManager.findByIdManager(2);
		Service service3 = serviceManager.findByIdManager(3);
		List<Service> services = new ArrayList<Service>();
		Set<Service> servicesTest = new HashSet<Service>();
		Coordonnee coord1 = coordonneeManager.findByIdManager(1);
		Coordonnee coord2 = coordonneeManager.findByIdManager(2);
		// Coordonnee coord3 = coordonneeManager.findByIdManager(3);
		List<Coordonnee> coords = new ArrayList<Coordonnee>();
		Set<Coordonnee> coordsTest = new HashSet<Coordonnee>();
		...
		try {
			collaborateurManager.createObjectManager(
					collab1, null, null, spec, null, null, u);
		} catch (Exception e) {
		...
		collaborateurManager.createObjectManager(
				collab1, null, null, null, null, null, u);
		int idC1 = collab1.getCollaborateurId();
		...
		coords.add(newCoord);
		coords.add(newCoord2);
		collaborateurManager.createObjectManager(collab2, titre, etab, spec, 
				services, coords, u);
		int idC2 = collab2.getCollaborateurId();
		assertTrue(coordonneeManager.findAllObjectsManager().size() == 7);
		assertTrue(getOperationManager().findByObjectManager(
				collab2).size() == 1);
		
		// On vérifie que toutes associations ont étées enregistrées
		Collaborateur testInsert = collaborateurManager.findByIdManager(idC2);
		...
		assertTrue(collaborateurManager
				.getCoordonneesManager(testInsert).size() == 2);
		// on vérifie 1 coord updaté lors de la création du collab
		Coordonnee testCoord = coordonneeManager.findByIdManager(id2);
		assertTrue(testCoord.getAdresse().equals("TEST"));
		assertTrue(coordonneeManager.getCollaborateursManager(
				testCoord).size() == 1);
		
		// Suppression
		Collaborateur collab3 = collaborateurManager.findByIdManager(idC1);
		collaborateurManager.removeObjectManager(collab3, null, u);
		Collaborateur collab4 = collaborateurManager.findByIdManager(idC2);
		...
		// Update
		String nomUpdated2 = "VIAL";
		Collaborateur collab5 = new Collaborateur();
		collab5.setNom("COLLAB7");
		collaborateurManager.createObjectManager(
				collab5, null, null, spec, null, null, u);
		int idC3 = collab5.getCollaborateurId();
		assertTrue(getOperationManager().findByObjectManager(
				collab5).size() == 1);
		...
		// est lancée
		Collaborateur collab6 = collaborateurManager.findByIdManager(idC3);
		collab6.setNom(nomUpdated2);
		collab6.setPrenom("CHRISTOPHE");
		try {
			collaborateurManager.updateObjectManager(
					collab6, null, null, spec, null, null, u, true);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"DoublonFoundException")) {
				catchedUpdate = true;
		...
		Collaborateur collab7 = collaborateurManager.findByIdManager(idC3);
		...
		collab7.setPrenom("*#%$$");
		collaborateurManager.updateObjectManager(
				collab7, null, null, spec, null, null, u, false);
		Collaborateur collab8 = collaborateurManager.findByIdManager(idC3);
		...
		Collaborateur collab9 = collaborateurManager.findByIdManager(idC3);
		...
		Coordonnee newCoordUp = new Coordonnee();
		newCoordUp.setAdresse("TMP");
		Coordonnee newCoordUp2 = new Coordonnee();
		...
		try {
			collaborateurManager.updateObjectManager(
					collab9, titre, etab, spec, services, coords, u, true);
		} catch (Exception e) {
			if (e.getClass().getSimpleName().equals(
					"DoublonFoundException")) {
				catchedUpdate = true;
		...
		//coords.add(coord3);
		collaborateurManager.updateObjectManager(
				collab10, titre, etab, spec, services, coords, u, true);
		assertTrue(getOperationManager()
									.findByObjectManager(collab10).size() == 4);
		// On vérifie que les associations de services ont étée modifiées
		Collaborateur testInsert3 = collaborateurManager.findByIdManager(idC3);
		...
		Collaborateur collab11 = collaborateurManager.findByIdManager(idC3);
	 ...
	 */
	private void validationInsert(Collaborateur collaborateur) {
		Utilisateur u = utilisateurDao.findById(1);
		boolean catchedInsert = false;
		String[] nomValues = new String[]{"", "  ", null, "l#¤¤$d%", 
				createOverLength(30), "GOOD"};
		String[] prenomValues = new String[]{"", " ", "l#¤¤$d%", 
				createOverLength(30), "GOOD"};
			...
			for (int j = 0; j < prenomValues.length; j++) {
				...
				try {
					...
					if (i != 5 || j != 4) { //car creation valide
						collaborateurManager.createObjectManager(
								collaborateur, null, null, null, null
								, null, u);
					}
				} catch (Exception e) {
					if (e.getClass().getSimpleName().equals(
	 ...
	 * @param collaborateur Collaborateur à tester.
	 */
	private void validationUpdate(Collaborateur collaborateur) {
		Utilisateur u = utilisateurDao.findById(1);
		boolean catchedUpdate = false;
		String[] nomValues = new String[]{"", "  ", null, "l#¤¤$d%", 
				createOverLength(30), "GOOD"};
	...
	private void setUpFusionTest() {
		...
		cA.setNom("ACTIF");
		Collaborateur cP = new Collaborateur();
		cP.setNom("PASSIF");
	...
	private void cleanAfterFusion(List<TKFantomableObject> fs) {
		Collaborateur actif = collaborateurManager.findByNomLikeManager("ACTIF", true).get(0);
	...
	public void testFusionCollaborateurManagerVide() throws ParseException{
		...
		Collaborateur actif = collaborateurManager.findByNomLikeManager("ACTIF", true).get(0); 
		Collaborateur cPVide = collaborateurManager.findByNomLikeManager("PASSIF", true).get(0);
		...
		collaborateurManager.fusionCollaborateurManager(actif.getCollaborateurId(), 
				cPVide.getCollaborateurId(), "fusion test vide", u1);
	...
	public void testFusionCollaborateurs() {
		...
		Collaborateur actif = collaborateurManager.findByNomLikeManager("ACTIF", true).get(0); 
		Collaborateur passifVide = collaborateurManager.findByNomLikeManager("PASSIF", true).get(0);

		
		collaborateurManager.fusionCollaborateurManager(actif.getCollaborateurId(), 
				passifVide.getCollaborateurId(), "test vide", u1);
		
		assertTrue(collaborateurManager.findByNomLikeManager("PASSIF", true).isEmpty());
		assertTrue(getFantomeDao().findByNom("PASSIF").get(0)
				.getCommentaires().equals("fusion id: " + actif.getCollaborateurId().toString() + " .test vide"));
	...
	public void testFusionCollaborateursWithBanques() {
		...
		Collaborateur actif = collaborateurManager.findByNomLikeManager("ACTIF", true).get(0); 
		Collaborateur passif = collaborateurManager.findByNomLikeManager("PASSIF", true).get(0);

		Banque b = new Banque();
		b.setNom("BANK");
		b.setArchive(false);
		banqueManager.createOrUpdateObjectManager(b, plateformeDao.findById(1), 
				contexteDao.findById(1), null, passif, passif, null, null, null, null, 
				null, null, null, null, null, null, u1, "creation", "/tmp/");
		
		Banque b2 = new Banque();
		b2.setNom("BANK2");
		b2.setArchive(false);
		banqueManager.createOrUpdateObjectManager(b2, plateformeDao.findById(1), 
				contexteDao.findById(1), null, passif, passif, null, null, null, null, 
				null, null, null, null, null, null, u1, "creation", "/tmp/");
		...
		collaborateurManager.fusionCollaborateurManager(actif.getCollaborateurId(), 
				passif.getCollaborateurId(), "test banque", u1);
		...
		banqueManager.removeObjectManager(banqueDao
							.findByNom("BANK").get(0), null, u1, "/tmp/", true);
		assertTrue(banqueDao.findByNom("BANK").isEmpty());
		banqueManager.removeObjectManager(banqueDao
				.findByNom("BANK2").get(0), null, u1, "/tmp/", true);
	...
	public void testFusionCollaborateursContrats() {
		...
		Collaborateur actif = collaborateurManager
						.findByNomLikeManager("ACTIF", true).get(0); 
		Collaborateur passif = collaborateurManager
						.findByNomLikeManager("PASSIF", true).get(0);
		
		Contrat contrat = new Contrat();
		contrat.setNumero("CONTRAT");
		contratManager.createObjectManager(contrat, passif, null, null, null,
												plateformeDao.findById(1), u1);
		Contrat contrat2 = new Contrat();
		contrat2.setNumero("CONTRAT2");
		contratManager.createObjectManager(contrat2, passif, null, null, null,
												plateformeDao.findById(1), u1);
		assertTrue(contratDao.findByCollaborateur(passif).size() == 2);
		assertTrue(contratDao.findByCollaborateur(actif).isEmpty());
		assertTrue(contratDao.findByNumero("CONTRAT").get(0).getCollaborateur()
															.equals(passif));
		assertTrue(contratDao.findByNumero("CONTRAT2").get(0).getCollaborateur()
				.equals(passif));	
		
		collaborateurManager.fusionCollaborateurManager(actif.getCollaborateurId(), 
				passif.getCollaborateurId(), "test contrat", u1);
	...
	public void testFusionCollaborateursCoordonnees() {
		...
		Coordonnee coordonneeA = new Coordonnee();
		coordonneeA.setAdresse("addresse Active");
		coordonneeA.setPays("FRANCE");

		Coordonnee coordonneeP = new Coordonnee();
		coordonneeP.setAdresse("addresse Passive");
		coordonneeP.setPays("FRANCE");

		Coordonnee coordonneesCommune = coordonneeDao.findById(5);
		 	
		List<Collaborateur> collaborateurActifList =  new ArrayList<Collaborateur>();
		collaborateurActifList.add(actif);
		List<Collaborateur> collaborateurPassifList =  new ArrayList<Collaborateur>();
		collaborateurPassifList.add(passif);
		List<Collaborateur> collaborateurX2List =  new ArrayList<Collaborateur>();
		...
		coordonneeManager.updateObjectManager(coordonneesCommune, 
														collaborateurX2List, false);
		...
		collaborateurManager.fusionCollaborateurManager(actif.getCollaborateurId(), 
				passif.getCollaborateurId(), "test coords", u1);
		...
		assertTrue(coordonneeDao.findByCollaborateurId(actif.getCollaborateurId())
				.contains(coordonneeDao.findById(5)));
	...
	public void testFusionCollaborateursServices() {
		...
		List<Collaborateur> s1colList = new ArrayList<Collaborateur>();
		s1colList.add(actif);
		List<Collaborateur> s2colList = new ArrayList<Collaborateur>();
		s2colList.add(passif);
		List<Collaborateur> s3colList =  new ArrayList<Collaborateur>();
		s3colList.add(actif);
		s3colList.add(passif);

		serviceManager.createObjectManager(s1, null, etablissementManager.findByIdManager(1), 
				s1colList, u1, false);
		serviceManager.createObjectManager(s2, null, etablissementManager.findByIdManager(1), 
				s2colList, u1, false);
		serviceManager.createObjectManager(s3, null, etablissementManager.findByIdManager(1), 
				s3colList, u1, false);
		...
		assertTrue(serviceDao.findByCollaborateurId(passif.getCollaborateurId())
				.contains(s2));
		assertTrue(serviceDao.findByCollaborateurId(passif.getCollaborateurId())
				.contains(s3));
		assertTrue(serviceDao.findByCollaborateurId(actif.getCollaborateurId()).size() == 2);
		assertTrue(serviceDao.findByCollaborateurId(actif.getCollaborateurId())
				.contains(s1));
		assertTrue(serviceDao.findByCollaborateurId(actif.getCollaborateurId())
				.contains(s3));

		collaborateurManager.fusionCollaborateurManager(actif.getCollaborateurId(), 
				passif.getCollaborateurId(), "test services", u1);
		...
		serviceManager.updateObjectManager(s1, null, etablissementManager.findByIdManager(1), 
											new ArrayList<Collaborateur>(), u1, false, false);
		serviceManager.updateObjectManager(s2, null, etablissementManager.findByIdManager(1), 
				new ArrayList<Collaborateur>(), u1, false, false);
		serviceManager.updateObjectManager(s3, null, etablissementManager.findByIdManager(1), 
				new ArrayList<Collaborateur>(), u1, false, false);
		...
		assertTrue(serviceDao.findByEtablissement(etablissementManager
				.findByIdManager(1)).size() == 3);
	...
	public void testFusionCollaborateursCoreObjects() {
		...
		prelevementManager.createObjectManager(prelevement2, banqueDao.findById(1), natureDao.findById(1), maladieDao.findById(1),
				consentTypeDao.findById(1), passif, serviceDao.findById(1), null, null, null, null, passif,
				null, labs2, null, null, u1, false, "/tmp/", false);
		...
		echantillonManager.createObjectManager(echantillon,
				banqueDao.findById(1), prelevementDao.findByCode("PRELEVEMENTEST").get(0), 
				passif, null, null,
				echantillonTypeDao.findById(1), null, null, null, 
		...
		echantillonManager.createObjectManager(echantillon2,
				banqueDao.findById(1), prelevementDao.findByCode("PRELEVEMENTEST").get(0), 
				passif, null, null,
				echantillonTypeDao.findById(1), null, null, null, 
				null, null, null, null, u1, false, "/tmp/", false);
		...
		retour.setObjetId(echantillonDao.findByCode("ECHANTILLONTEST")
												.get(0).getEchantillonId());
		
		Calendar dateSortie = Calendar.getInstance();
		Calendar dateRetour = Calendar.getInstance();

		try {
			dateSortie.setTime(new SimpleDateFormat("dd/MM/yyyy hh:mm:ss")
												.parse("01/01/2011 12:10:25"));
			dateRetour.setTime(new SimpleDateFormat("dd/MM/yyyy hh:mm:ss")
				.parse("02/01/2012 16:47:10"));
		...
		retourManager.createOrUpdateObjectManager(retour, null, null,
				passif, null, null, null, u1, "creation");
		
		Retour retour2 = new Retour();		
		retour2.setObjetId(echantillonDao.findByCode("ECHANTILLONTEST2")
												.get(0).getEchantillonId());
		...
		retourManager.createOrUpdateObjectManager(retour2, null, null,
				passif, null, null, null, u1, "creation");
		...
		produitDeriveManager.createObjectManager(prodDerive,
				banqueDao.findById(1), produitTypeDao.findById(1), null, passif,
		...
		produitDeriveManager.createObjectManager(prodDerive2,
				banqueDao.findById(1), produitTypeDao.findById(1), null, passif,
				null, null, null, null, null, null, null, null, null, null, u1,
				false, "/tmp/", false);
	...
	public void testFusionCollaborateurCession() {
		...
		cessionManager.createObjectManager(cess, banqueDao.findById(1), cessionTypeDao.findById(1),
				null, null, passif, null, passif, cessionStatutDao.findById(1),
				passif, null, null, null, null, u1, null, "/tmp/");
		...
		cessionManager.createObjectManager(cess2, banqueDao.findById(1), cessionTypeDao.findById(1),
				null, null, passif, null, passif, cessionStatutDao.findById(1),
				passif, null, null, null, null, u1, null, "/tmp/");
		...
		// fusion
		collaborateurManager.fusionCollaborateurManager(actif.getCollaborateurId(), 
									passif.getCollaborateurId(), "test cession", u1);
	...
	public void testFusionCollaborateurPlateformeAndUtilisateur() {
		...
		Plateforme plateF = plateformeDao.findById(1);
		plateformeManager.updateObjectManager(plateF, passif, null, null, u1);
		Plateforme plateF2 = plateformeDao.findById(2);
		...
		utilisateurManager.createObjectManager(utilisateur, passif, 
											null, null, u1, plateformeDao.findById(1));
		...
		utilisateurManager.createObjectManager(utilisateur2, passif, 
											null, null, u1, plateformeDao.findById(1));
		...
		// fusion
		collaborateurManager.fusionCollaborateurManager(actif.getCollaborateurId(), 
								passif.getCollaborateurId(), "test pf and user", u1);
		...
		for (Operation op : getOperationManager().findByObjectManager(plateF)) {
			getOperationManager().removeObjectManager(op);
		}
		for (Operation op : getOperationManager().findByObjectManager(plateF2)) {
			getOperationManager().removeObjectManager(op);
		}
	...
	public void testFusionCollaborateurPatientMaladieMedecin() throws ParseException {
		...
		patient.setDateNaissance(new SimpleDateFormat("dd/MM/yyyy")
													.parse("21/03/1980"));
		
		List<Collaborateur> collaborateurPassifList = new ArrayList<Collaborateur>();
		collaborateurPassifList.add(passif);
		
		patientManager.createOrUpdateObjectManager(patient, null, collaborateurPassifList, 
								null, null, null, null, null, u1, "creation", "/tmp/",	false);
		
		assertTrue(patientManager
				.getMedecinsManager(patientDao.findByNom("PATTEST").get(0))
				.size() == 1);
		...
		patient2.setDateNaissance(new SimpleDateFormat("dd/MM/yyyy")
													.parse("21/03/1980"));
		
		patientManager.createOrUpdateObjectManager(patient2, null, collaborateurPassifList, 
								null, null, null, null, null, u1, "creation", "/tmp/",	false);
		
		assertTrue(patientManager
				.getMedecinsManager(patientDao.findByNom("PATTEST2").get(0))
				.size() == 1);
		...
		maladieManager.createOrUpdateObjectManager(maladie, patientDao.findByNom("PATTEST").get(0),
															collaborateurPassifList, u1, "creation");
		...
		List<Collaborateur> allCollabs = new ArrayList<Collaborateur>();
		allCollabs.add(passif);
		allCollabs.add(actif);
		
		maladieManager.createOrUpdateObjectManager(maladie2, patientDao.findByNom("PATTEST2").get(0),
															allCollabs, u1, "creation");
		...
		// new Collab
		Collaborateur newCol = new Collaborateur();
		...
		List<Collaborateur> listActif = new ArrayList<Collaborateur>();
		listActif.add(passif);
		listActif.add(newCol);
				
		maladieManager.createOrUpdateObjectManager(maladie3, patientDao.findByNom("PATTEST2").get(0),
				listActif, u1, "creation");
		...
		// fusion
		collaborateurManager.fusionCollaborateurManager(actif.getCollaborateurId(), 
								passif.getCollaborateurId(), "patient and maladie medecins", u1);
