...
public class CollaborateurManagerTest extends AbstractManagerTest4
{
   ...
   private void cleanAfterFusion(final List<TKFantomableObject> fs){
      ...
      collaborateurManager.removeObjectManager(actif, null, utilisateurDao.findById(1)).orElse(null);
      fs.add(actif);
      cleanUpFantomes(fs);
      assertTrue(collaborateurManager.findAllObjectsManager().size() == 6);
   }
   ...
   public void testFusionCollaborateursWithBanques(){
      ...
      b.setNom("BANK");
      b.setArchive(false);
      banqueManager.createOrUpdateObjectManager(b, plateformeDao.findById(1), contexteDao.findById(1).orElse(null), null, passif, passif, null,
         null, null, null, null, null, null, null, null, null, u1, null, "creation", "/tmp/");

      final Banque b2 = new Banque();
      b2.setNom("BANK2");
      b2.setArchive(false);
      banqueManager.createOrUpdateObjectManager(b2, plateformeDao.findById(1), contexteDao.findById(1).orElse(null), null, passif, passif,
   ...
   public void testFusionCollaborateursContrats(){
      ...
      contratManager.createObjectManager(contrat, passif, null, null, null, plateformeDao.findById(1), u1).orElse(null);
      Contrat contrat2 = new Contrat();
      contrat2.setNumero("CONTRAT2");
      contratManager.createObjectManager(contrat2, passif, null, null, null, plateformeDao.findById(1), u1).orElse(null);
   ...
   public void testFusionCollaborateursCoordonnees(){
      ...
      final Coordonnee coordonneesCommune = coordonneeDao.findById(5).orElse(null);
      ...
      collaborateurX2List.add(collaborateurDao.findById(6)).orElse(null); // VENTADOUR
      ...
      assertTrue(coordonneeDao.findByCollaborateurId(actif.getCollaborateurId()).contains(coordonneeDao.findById(5))).orElse(null);
   ...
   public void testFusionCollaborateursCoreObjects(){
      ...
      prelevementManager.createObjectManager(prelevement, banqueDao.findById(1), natureDao.findById(1), maladieDao.findById(1).orElse(null),
         consentTypeDao.findById(1), passif, serviceDao.findById(1).orElse(null), null, null, null, null, passif, null, labs, null, null, u1,
         false, "/tmp/", false);
      ...
      prelevementManager.createObjectManager(prelevement2, banqueDao.findById(1), natureDao.findById(1), maladieDao.findById(1).orElse(null),
         consentTypeDao.findById(1), passif, serviceDao.findById(1).orElse(null), null, null, null, null, passif, null, labs2, null, null, u1,
         false, "/tmp/", false);
      ...
      echantillon.setObjetStatut(objetStatutDao.findById(1)).orElse(null);

      echantillonManager.createObjectManager(echantillon, banqueDao.findById(1).orElse(null),
         prelevementDao.findByCode("PRELEVEMENTEST").get(0), passif, null, null, echantillonTypeDao.findById(1).orElse(null), null, null, null,
      ...
      echantillon2.setObjetStatut(objetStatutDao.findById(1)).orElse(null);

      echantillonManager.createObjectManager(echantillon2, banqueDao.findById(1).orElse(null),
         prelevementDao.findByCode("PRELEVEMENTEST").get(0), passif, null, null, echantillonTypeDao.findById(1).orElse(null), null, null, null,
         null, null, null, u1, false, "/tmp/", false);
      ...
      retour.setTempMoyenne(retourDao.findById(1).getTempMoyenne()).orElse(null);
      retour.setEntite(entiteDao.findById(3)).orElse(null);
      ...
      retour2.setTempMoyenne(retourDao.findById(1).getTempMoyenne()).orElse(null);
      retour2.setEntite(entiteDao.findById(3)).orElse(null);
      ...
      prodDerive.setObjetStatut(objetStatutDao.findById(1)).orElse(null);

      produitDeriveManager.createObjectManager(prodDerive, banqueDao.findById(1), produitTypeDao.findById(1).orElse(null), null, passif, null,
      ...
      prodDerive2.setObjetStatut(objetStatutDao.findById(1)).orElse(null);

      produitDeriveManager.createObjectManager(prodDerive2, banqueDao.findById(1), produitTypeDao.findById(1).orElse(null), null, passif, null,
         null, null, null, null, null, null, null, null, u1, false, "/tmp/", false);
   ...
   public void testFusionCollaborateurCession(){
      ...
      // cess.setDemandeur(collaborateurDao.findById(1)).orElse(null);
      // cess.setExecutant(collaborateurDao.findById(1)).orElse(null);

      cessionManager.createObjectManager(cess, banqueDao.findById(1), cessionTypeDao.findById(1).orElse(null), null, null, passif, null,
         passif, cessionStatutDao.findById(1), passif, null, null, null, null, u1, null, "/tmp/").orElse(null);

      Cession cess2 = new Cession();
      cess2.setNumero("1002");
      cess2.setArchive(false);

      // cess2.setDemandeur(collaborateurDao.findById(1)).orElse(null);
      // cess2.setExecutant(collaborateurDao.findById(1)).orElse(null);

      cessionManager.createObjectManager(cess2, banqueDao.findById(1), cessionTypeDao.findById(1).orElse(null), null, null, passif, null,
         passif, cessionStatutDao.findById(1), passif, null, null, null, null, u1, null, "/tmp/").orElse(null);
   ...
   public void testFusionCollaborateurPlateformeAndUtilisateur(){
      ...
      final Plateforme plateF = plateformeDao.findById(1).orElse(null);
      plateformeManager.updateObjectManager(plateF, passif, null, null, u1);
      final Plateforme plateF2 = plateformeDao.findById(2).orElse(null);
      ...
      utilisateurManager.createObjectManager(utilisateur, passif, null, null, u1, plateformeDao.findById(1)).orElse(null);
      ...
      utilisateurManager.createObjectManager(utilisateur2, passif, null, null, u1, plateformeDao.findById(1)).orElse(null);
      ...
      // plateF.setCollaborateur(collaborateurDao.findById(1)).orElse(null);
      plateformeManager.updateObjectManager(plateF, collaborateurDao.findById(1), null, null, u1).orElse(null);
      // plateF2.setCollaborateur(collaborateurDao.findById(4)).orElse(null);
      plateformeManager.updateObjectManager(plateF2, collaborateurDao.findById(4), null, null, u1).orElse(null);
