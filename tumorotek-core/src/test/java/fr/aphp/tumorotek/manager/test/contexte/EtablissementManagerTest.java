...
public class EtablissementManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      final Categorie cat = categorieDao.findById(1).orElse(null);
   ...
   private void setUpFusionTest(){
      ...
      etablissementManager.createObjectManager(eA, null, null, utilisateurDao.findById(1)).orElse(null);

      etablissementManager.createObjectManager(eP, null, null, utilisateurDao.findById(1)).orElse(null);
   ...
   private void cleanAfterFusion(final List<TKFantomableObject> fs){
      ...
      etablissementManager.removeObjectManager(actif, null, utilisateurDao.findById(1)).orElse(null);
      fs.add(actif);
      cleanUpFantomes(fs);
      testFindAll();
   }
   ...
   public void testFusionEtablissementsContrats(){
      ...
      contratManager.createObjectManager(contrat, null, null, passif, null, plateformeDao.findById(1), u1).orElse(null);

      Contrat contrat2 = new Contrat();
      contrat2.setNumero("CONTRAT2");
      contratManager.createObjectManager(contrat2, null, null, passif, null, plateformeDao.findById(1), u1).orElse(null);
