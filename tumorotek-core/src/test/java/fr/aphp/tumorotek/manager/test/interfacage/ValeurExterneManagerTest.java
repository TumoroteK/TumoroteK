...
//    }
	...
	public void testFindById() {
		ValeurExterne m = valeurExterneManager.findByIdManager(1);
		assertNotNull(m);
		
		ValeurExterne mNull = valeurExterneManager.findByIdManager(100);
		assertNull(mNull);
	}
	...
	public void testFindAll() {
		List<ValeurExterne> list = valeurExterneManager
	...
	public void testFindDoublon() {
		Integer ce = 3;
		Integer ca = null;
		BlocExterne be1 = blocExterneDao.findById(1);
		BlocExterne be3 = blocExterneDao.findById(3);
	...
	public void testValidateValeurExterneManager() {
		BlocExterne be = blocExterneDao.findById(1);
		ValeurExterne ve = new ValeurExterne();
		ve.setChampEntiteId(10);
	...
	public void testCrud() {
		BlocExterne be = blocExterneDao.findById(3);
		ValeurExterne ve = new ValeurExterne();
		
		Integer nb = valeurExterneManager.findAllObjectsManager().size();
		...
		assertTrue(valeurExterneManager.findAllObjectsManager().size() 
				== nb + 1);
		Integer id1 = ve.getValeurExterneId();
		
		ValeurExterne vTest = valeurExterneManager.findByIdManager(id1);
		assertNotNull(vTest);
		...
		assertTrue(valeurExterneManager.findAllObjectsManager().size() 
				== nb + 2);
		Integer id2 = ve2.getValeurExterneId();
		
		ValeurExterne vTest2 = valeurExterneManager.findByIdManager(id2);
		...
		assertTrue(valeurExterneManager.findAllObjectsManager().size() 
				== nb + 2);
		Integer id3 = ve3.getValeurExterneId();
		
		ValeurExterne vTest3 = valeurExterneManager.findByIdManager(id3);
