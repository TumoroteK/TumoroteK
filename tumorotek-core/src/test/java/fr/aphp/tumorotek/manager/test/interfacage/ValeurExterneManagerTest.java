...
public class ValeurExterneManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByBlocExterneManager(){
      ...
      final BlocExterne b3 = blocExterneDao.findById(3).orElse(null);
   ...
   public void testFindByDossierChampEntiteIdAndBlocEntiteIdManager() {
		  DossierExterne dos = dossierExterneDao.findById(4).orElse(null);
   ...
   public void testFindDoublon(){
      ...
      final BlocExterne be1 = blocExterneDao.findById(1).orElse(null);
      final BlocExterne be3 = blocExterneDao.findById(3).orElse(null);
   ...
   public void testValidateValeurExterneManager(){
      final BlocExterne be = blocExterneDao.findById(1).orElse(null);
      final ValeurExterne ve = new ValeurExterne();
      ve.setChampEntiteId(10);
   ...
   public void testCrud(){
      final BlocExterne be = blocExterneDao.findById(3).orElse(null);
      final ValeurExterne ve = new ValeurExterne();
