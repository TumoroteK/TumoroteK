...
public class AbstractManagerTest extends AbstractDependencyInjectionSpringContextTests
{
   ...
   public void setOperationManager(final OperationManager opManager){
   ...
   protected String[] getConfigLocations(){
      return new String[] {"applicationContextManagerBase.xml", "applicationContextDaoBase-test-mysql.xml"};
   }
