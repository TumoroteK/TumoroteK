...
public class RechercheManagerTest extends AbstractManagerTest4
{
   ...
   //		assertNotNull(recherche);
   //		Utilisateur util = utilisateurDao.findById(3).orElse(null);
   ...
   public void testCrud(){
      ...
      ChampEntite champEntite = champEntiteDao.findById(25).orElse(null);
      final Champ champ1 = new Champ(champEntite);
      final Resultat resultat1 = new Resultat("col1", champ1, true, 1, 2, "format", null);
      champEntite = champEntiteDao.findById(54).orElse(null);
      ...
      banques.add(this.banqueDao.findById(2)).orElse(null);
      banques.add(this.banqueDao.findById(3)).orElse(null);
      banques.add(this.banqueDao.findById(1)).orElse(null);
      ...
      banques.add(this.banqueDao.findById(4)).orElse(null);
      ...
      assertTrue(manager.findBanquesManager(rechTest).get(0).equals(banqueDao.findById(4))).orElse(null);
   ...
   public void testFindDoublons(){
      ...
      final Affichage affichage = affichageDao.findById(1).orElse(null);
      recherche.setAffichage(affichage);
      final Requete requete = requeteDao.findById(3).orElse(null);
      ...
      banques.add(banqueDao.findById(4)).orElse(null);
