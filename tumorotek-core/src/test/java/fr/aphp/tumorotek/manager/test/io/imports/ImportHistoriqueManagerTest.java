...
public class ImportHistoriqueManagerTest extends AbstractManagerTest {
	...
	public void setImportationDao(ImportationDao iDao) {
	...
	public void setEchantillonTypeDao(EchantillonTypeDao eTypeDao) {
	...
	public void testFindById() {
		ImportHistorique temp = importHistoriqueManager
			.findByIdManager(1);
		assertNotNull(temp);
		
		ImportHistorique tempNull = importHistoriqueManager
			.findByIdManager(10);
		assertNull(tempNull);
	}
	...
	public void testFindAll() {
		List<ImportHistorique> list = importHistoriqueManager
	...
	public void testFindByTemplateWithOrderManager() {
		...
		List<ImportHistorique> list = importHistoriqueManager
			.findByTemplateWithOrderManager(it);
	...
	public void testFindImportationsByHistoriqueManager() {
		...
		List<Importation> list = importHistoriqueManager
		...
		list = importHistoriqueManager
			.findImportationsByHistoriqueManager(null);
		assertTrue(list.size() == 0);
	}
	...
	public void testFindImportationsByHistoriqueAndEntiteManager() {
		ImportHistorique ih = importHistoriqueManager.findByIdManager(1);
		ImportHistorique ih2 = importHistoriqueManager.findByIdManager(2);
		Entite e1 = entiteDao.findById(1);
		Entite e3 = entiteDao.findById(3);
		List<Importation> list = importHistoriqueManager
			.findImportationsByHistoriqueAndEntiteManager(ih, e1);
		assertTrue(list.size() == 1);
		
		list = importHistoriqueManager
			.findImportationsByHistoriqueAndEntiteManager(ih, e3);
		assertTrue(list.size() == 0);
		
		list = importHistoriqueManager
			.findImportationsByHistoriqueAndEntiteManager(ih2, e1);
		assertTrue(list.size() == 0);
		
		list = importHistoriqueManager
			.findImportationsByHistoriqueAndEntiteManager(null, e1);
		assertTrue(list.size() == 0);
	
		list = importHistoriqueManager
			.findImportationsByHistoriqueAndEntiteManager(ih, null);
		assertTrue(list.size() == 0);
	}
	...
	public void testFindImportationsByObjectManager() {
		Patient p1 = patientManager.findByNomLikeManager("MAYER", true).get(0);
		Prelevement prlvt = prelevementManager.findByIdManager(4);
		...
		List<Importation> list = importHistoriqueManager
			.findImportationsByObjectManager(p1);
		assertTrue(list.size() == 1);
	...
	public void testFindImportationsByEntiteAndObjectIdManager() {
		...
		List<Importation> list = importHistoriqueManager
			.findImportationsByEntiteAndObjectIdManager(e1, 1);
		assertTrue(list.size() == 1);
		
		list = importHistoriqueManager
			.findImportationsByEntiteAndObjectIdManager(e1, 15);
		assertTrue(list.size() == 0);
		
		list = importHistoriqueManager
			.findImportationsByEntiteAndObjectIdManager(e3, 1);
		assertTrue(list.size() == 0);
		
		list = importHistoriqueManager
			.findImportationsByEntiteAndObjectIdManager(e1, null);
		assertTrue(list.size() == 0);
	
		list = importHistoriqueManager
			.findImportationsByEntiteAndObjectIdManager(null, 15);
		assertTrue(list.size() == 0);
	}
	...
	public void testCreateObjectManager() throws ParseException {
		...
		ImportHistorique ih1 = new ImportHistorique();
		...
		Integer idH1 = ih1.getImportHistoriqueId();
		
		// Vérification
		ImportHistorique ihTest = importHistoriqueManager.findByIdManager(idH1);
		...
		assertTrue(importHistoriqueManager
				.findImportationsByHistoriqueManager(
						ihTest).size() == 0);
		...
		Importation i1 = new Importation();
		i1.setObjetId(1);
		i1.setEntite(e3);
		i1.setImportHistorique(ih2);
		Importation i2 = new Importation();
		i2.setObjetId(2);
		i2.setEntite(e3);
		...
		Integer idH2 = ih2.getImportHistoriqueId();
		
		// Vérification
		ImportHistorique ihTest2 = importHistoriqueManager
			.findByIdManager(idH2);
		...
		importHistoriqueManager.removeImportationManager(
	...
	public void testRemoveImportationsByObjects() throws ParseException {
		...
		ConsentType consentType = consentTypeDao.findById(1);
		EchantillonType eType = echantillonTypeDao.findById(1);
		ProdType pType = prodTypeDao.findById(1);
		...
		pat.setPrenom("MOI");
		pat.setSexe("M");
		Date date = new SimpleDateFormat("dd/MM/yyyy").parse("12/12/1958");
		cal.setTime(date);
		pat.setDateNaissance(cal.getTime());
		patientManager.createOrUpdateObjectManager(pat, null, null, null, 
				null, null, null, null, u, "creation", null, false);
		...
		prlvt.setCode("TMP");
		prelevementManager.createObjectManager(prlvt, banque, nature, 
				null, consentType, null, null, null, 
				null, null, null, null, null, null, 
				null, null, u, false, null, false);
		...
		echantillonManager.createObjectManager(echan, banque, null, null, 
				objetStatutDao.findById(4), null, eType, null, null, 
				null, null, null,
				null, null, u, false, null, false);
		assertTrue(echantillonManager.findAllObjectsManager().size() == 5);
		Importation i3 = new Importation();
		...
		prodDeriveManager.createObjectManager(derive, banque, pType, 
				objetStatutDao.findById(4), null, null, 
				null, null, null, null, null, 
				null, null, null, null, u, false, null, false);
		assertTrue(prodDeriveManager.findAllObjectsManager().size() == 5);
		Importation i4 = new Importation();
	...
	public void testFindPrelevementByImportHistoriqueManager() {
		ImportHistorique ih1 = importHistoriqueManager.findByIdManager(1);
		...
		prels.addAll(importHistoriqueManager
			.findPrelevementByImportHistoriqueManager(importHistoriqueManager
															.findByIdManager(2)));
		assertTrue(prels.isEmpty());
		
		prels.addAll(importHistoriqueManager
				.findPrelevementByImportHistoriqueManager(null));
		assertTrue(prels.isEmpty());
