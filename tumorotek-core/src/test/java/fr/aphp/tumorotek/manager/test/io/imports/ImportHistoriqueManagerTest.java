...
@Autowired
  ...
  public void testFindById(){
   ...
   public void testCreateObjectManager() throws ParseException{
      ...
      final ImportTemplate it1 = importTemplateDao.findById(1).orElse(null);
   ...
   public void testRemoveImportationsByObjects() throws ParseException{
      ...
      final Nature nature = natureDao.findById(1).orElse(null);
      final ConsentType consentType = consentTypeDao.findById(1).orElse(null);
      final EchantillonType eType = echantillonTypeDao.findById(1).orElse(null);
      final ProdType pType = prodTypeDao.findById(1).orElse(null);
      ...
      echantillonManager.createObjectManager(echan, banque, null, null, objetStatutDao.findById(4).orElse(null), null, eType, null, null, null,
      ...
      prodDeriveManager.createObjectManager(derive, banque, pType, objetStatutDao.findById(4).orElse(null), null, null, null, null, null, null,
         null, null, null, null, u, false, null, false);
