...
public class ConteneurManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByPlateformeWithOrderManager(){
      ...
      final Plateforme p3 = plateformeDao.findById(3).orElse(null);
   ...
   public void testFindDoublon(){
      ...
      c1.setCode(code1);
      c1.setNom(nom1);
      c1.setPlateformeOrig(plateformeDao.findById(2)).orElse(null);
      ...
      c2.setPlateformeOrig(plateformeDao.findById(2)).orElse(null);
   ...
   public void createObjectManagerTest() throws ParseException{
      ...
      final Banque bank2 = banqueDao.findById(2).orElse(null);
      ...
      try{
         conteneurManager.createObjectManager(c1, null, null, null, null, u, plateformeDao.findById(1)).orElse(null);
      ...
      try{
         conteneurManager.createObjectManager(c1, null, serv, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         conteneurManager.createObjectManager(c1, null, serv, banks, null, u, plateformeDao.findById(1)).orElse(null);
      }catch(final Exception e){
      ...
      c1.setArchive(false);
      conteneurManager.createObjectManager(c1, null, serv, null, null, u, plateformeDao.findById(1)).orElse(null);
      ...
      pfs.add(pf1);
      pfs.add(pf2);
      conteneurManager.createObjectManager(c2, type, serv, banks, pfs, u, plateformeDao.findById(2)).orElse(null);
   ...
   public void updateObjectManagerTest() throws ParseException{
      ...
      final Banque bank1 = banqueDao.findById(1).orElse(null);
      final Banque bank2 = banqueDao.findById(2).orElse(null);
      final Banque bank3 = banqueDao.findById(3).orElse(null);
      final Plateforme pf1 = plateformeDao.findById(1).orElse(null);
      final Plateforme pf2 = plateformeDao.findById(2).orElse(null);
      ...
      try{
         conteneurManager.updateObjectManager(cUp1, null, null, null, null, null, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         conteneurManager.updateObjectManager(cUp1, null, serv, banks, null, null, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      catched = false;
      try{
         conteneurManager.updateObjectManager(cUp1, null, serv, null, null, incs, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
   ...
   private void validationInsert(final Conteneur conteneur) throws ParseException{
      ...
      for(int i = 0; i < emptyValues.length; i++){
         ...
         try{
            ...
            conteneurManager.createObjectManager(conteneur, null, serv, null, null, u, plateformeDao.findById(1)).orElse(null);
         }catch(final Exception e){
   ...
   private void validationUpdate(final Conteneur conteneur) throws ParseException{
      ...
      for(int i = 0; i < emptyValues.length; i++){
         ...
         try{
            conteneur.setCode(emptyValues[i]);
            conteneurManager.updateObjectManager(conteneur, null, serv, null, null, null, u);
         }catch(final Exception e){
            if(e.getClass().getSimpleName().equals("ValidationException")){
               catched = true;
            }
   ...
   public void testCreateAllArborescenceManager() throws ParseException{
      ...
      emp.setObjetId(1);
      emp.setAdrl("ADRL");
      emplacementManager.createObjectManager(emp, terminaleManager.findByEnceinteWithOrderManager(eTest3).get(4),
      ...
      /*Champs obligatoires*/
      final Echantillon ec2 = echantillonDao.findById(2).orElse(null);
   ...
   public void testRemoveBanqueFromConteneurAndEnceintes(){
      ...
      enceinteManager.updateObjectManager(e5, e5.getEnceinteType(), e5.getConteneur(), e5.getEnceintePere(), e5.getEntite(),
   ...
   public void testFindByPartageManager(){
      List<Conteneur> conts = conteneurManager.findByPartageManager(plateformeDao.findById(1), true).orElse(null);
      assertEquals(1, conts.size());
      conts = conteneurManager.findByPartageManager(null, true);
      assertTrue(conts.isEmpty());
      conts = conteneurManager.findByPartageManager(plateformeDao.findById(1), null).orElse(null);
      assertTrue(conts.isEmpty());
   }
