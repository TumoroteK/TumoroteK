...
public class ConteneurManagerTest extends AbstractManagerTest4
{
   ...
   public void createObjectManagerTest() throws ParseException{
      ...
      try{
         conteneurManager.createObjectManager(c1, null, null, null, null, u, plateformeDao.findById(1));
      ...
      try{
         conteneurManager.createObjectManager(c1, null, serv, banks, null, u, plateformeDao.findById(1));
      }catch(final Exception e){
   ...
   private void validationInsert(final Conteneur conteneur) throws ParseException{
      ...
      for(int i = 0; i < emptyValues.length; i++){
         ...
         try{
            ...
            conteneurManager.createObjectManager(conteneur, null, serv, null, null, u, plateformeDao.findById(1));
         }catch(final Exception e){
