...
public class ModePrepaManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		ModePrepa mode = modePrepaManager.findByIdManager(1);
		assertNotNull(mode);
		assertTrue(mode.getNom().equals("PREPA1"));
		
		ModePrepa modeNull = modePrepaManager.findByIdManager(5);
		assertNull(modeNull);
	}
	...
	public void testFindByModePrepaLikeExactManager() {
		List<ModePrepa> list = 
			modePrepaManager.findByModePrepaLikeManager("PREPA1", true);
	...
	public void testFindByModePrepaLikeManager() {
		List<ModePrepa> list = 
			modePrepaManager.findByModePrepaLikeManager("PREPA1", false);
		assertTrue(list.size() == 1);
	...
	public void testIsUsed() {
		ModePrepa mode1 = modePrepaManager.findByIdManager(1);
		assertNotNull(mode1);
		assertTrue(modePrepaManager.isUsedObjectManager(mode1));
		
		ModePrepa mode2 = modePrepaManager.findByIdManager(4);
		assertNotNull(mode2);
	...
	public void testCrud() {
		...
		ModePrepa mode2 = modePrepaManager.findByIdManager(5);
		String modeUpdated1 = "NEW";
		String modeUpdated2 = "PREPA1";
		...
		modePrepaManager.updateObjectManager(mode2);
		ModePrepa mode3 = modePrepaManager.findByIdManager(5);
		assertTrue(mode3.getNom().equals(modeUpdated1));
		
		// Test de la suppression
		ModePrepa mode4 = modePrepaManager.findByIdManager(5);
...
//		assertTrue(catchedDelete);
	...
	public void testFindByOrderManager() {
		...
		List< ? extends TKThesaurusObject> list = 
					modePrepaManager.findByOrderManager(pf);
