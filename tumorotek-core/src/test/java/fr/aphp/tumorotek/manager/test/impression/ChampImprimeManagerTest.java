...
public class ChampImprimeManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByIdManager(){
      ...
      final ChampEntite ce = champEntiteDao.findById(54).orElse(null);
      final BlocImpression bi = blocImpressionDao.findById(5).orElse(null);
   ...
   public void testFindByTemplateAndBlocManager(){
      final Template t1 = templateDao.findById(1).orElse(null);
      final Template t2 = templateDao.findById(2).orElse(null);
      final BlocImpression bi5 = blocImpressionDao.findById(5).orElse(null);
      final BlocImpression bi1 = blocImpressionDao.findById(1).orElse(null);
   ...
   public void testFindDoublonManager(){
      ...
      final Template t1 = templateDao.findById(1).orElse(null);
      final Template t2 = templateDao.findById(2).orElse(null);
      final ChampEntite ce1 = champEntiteDao.findById(54).orElse(null);
      final ChampEntite ce2 = champEntiteDao.findById(2).orElse(null);
      final BlocImpression bi5 = blocImpressionDao.findById(5).orElse(null);
      final BlocImpression bi1 = blocImpressionDao.findById(1).orElse(null);
   ...
   public void testCrud(){
      final Template t1 = templateDao.findById(1).orElse(null);
      final ChampEntite ce54 = champEntiteDao.findById(54).orElse(null);
      final ChampEntite ce2 = champEntiteDao.findById(2).orElse(null);
      final BlocImpression bi5 = blocImpressionDao.findById(5).orElse(null);
      ...
      // MAJ valide
      ciTest.setOrdre(10);
      champImprimeManager.updateObjectManager(ciTest, t1, ce2, bi5);
      assertTrue(champImprimeManager.findAllObjectsManager().size() == 5);
