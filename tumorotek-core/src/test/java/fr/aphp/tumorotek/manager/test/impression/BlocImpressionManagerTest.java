...
public class BlocImpressionManagerTest extends AbstractManagerTest4 {
	...
	public void testFindById() {
		BlocImpression bi = blocImpressionManager.findByIdManager(1);
		assertNotNull(bi);
		
		BlocImpression biNull = blocImpressionManager.findByIdManager(500);
		assertNull(biNull);
	}
	...
	public void testFindAll() {
		List<BlocImpression> list = blocImpressionManager
	...
	public void testFindByEntiteManager() {
		Entite e1 = entiteManager.findByIdManager(2);
		List<BlocImpression> list = blocImpressionManager
			.findByEntiteManager(e1);
		assertTrue(list.size() == 6);
		
		Entite e2 = entiteManager.findByIdManager(11);
