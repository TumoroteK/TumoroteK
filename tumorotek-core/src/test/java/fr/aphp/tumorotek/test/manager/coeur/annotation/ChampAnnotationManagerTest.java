...
public class ChampAnnotationManagerTest extends AbstractManagerTest4
{
   ...
   private void saveManagerTest(){
      ...
      //insertion
      try{
         champAnnotationManager.createOrsaveManager(chp, t, dt, its, defauts, u, null, null, null);
      }catch(final NullPointerException ne){
         assertTrue(ne.getMessage().equals("operation cannot be " + "set to null for createorUpdateMethod"));
      }
      // validation table null
      try{
         champAnnotationManager.createOrsaveManager(chp, null, null, null, null, u, null, "creation", null);
      ...
      try{
         champAnnotationManager.createOrsaveManager(chp, t, null, null, null, u, null, "creation", null);
      }catch(final RequiredObjectIsNullException re){
         assertTrue(re.getRequiredObject().equals("DataType"));
      }
      // validationException item 
      try{
         champAnnotationManager.createOrsaveManager(chp, t, dt, its, defauts, u, null, "creation", null);
      }catch(final ValidationException ve){
         assertTrue(ve.getErrors().get(0).getFieldError().getCode().equals("item.label.illegal"));
      }
      i3.setLabel("i3");
      try{
         champAnnotationManager.createOrsaveManager(chp, t, dt, its, defauts, u, null, "", null);
      ...
      try{
         champAnnotationManager.createOrsaveManager(c2, t, dt, null, null, u, null, "creation", null);
      ...
      // validationException item 
      try{
         champAnnotationManager.createOrsaveManager(chp2, t, dt2, null, defauts, u, null, "creation", null);
      }catch(final ValidationException ve){
   ...
   private void updateDefautsObjectManagerTest(){
      ...
      final Utilisateur u = utilisateurDao.findById(2);
      champAnnotationManager.createOrsaveManager(c, null, null, null, defauts, u, null, "modification", null);
      ...
      champAnnotationManager.createOrsaveManager(c, null, null, null, null, u, null, "modification", null);
      assertTrue((champAnnotationManager.getItemsManager(c, null)).size() == 3);
      assertTrue((champAnnotationManager.getAnnotationDefautsManager(c)).size() == 2);
      assertTrue(d2.equals(new ArrayList<>(champAnnotationManager.getAnnotationDefautsManager(c)).get(0))
         || d2.equals(new ArrayList<>(champAnnotationManager.getAnnotationDefautsManager(c)).get(1)));

      champAnnotationManager.createOrsaveManager(c, null, null, new ArrayList<Item>(), new ArrayList<AnnotationDefaut>(),
      ...
      champAnnotationManager.createOrsaveManager(c, null, null, its, defauts, u, null, "modification", null);
      assertTrue((champAnnotationManager.getItemsManager(c, null)).size() == 3);
      assertTrue((champAnnotationManager.getAnnotationDefautsManager(c)).size() == 2);
   ...
   private void updateItemsObjectManagerTest(){
      ...
      final Utilisateur u = utilisateurDao.findById(2);
      champAnnotationManager.createOrsaveManager(c, null, null, its, new ArrayList<AnnotationDefaut>(), u, null,
         "modification", null);
      ...
      champAnnotationManager.createOrsaveManager(c, null, null, its, null, u, null, "modification", null);
      assertTrue((champAnnotationManager.getItemsManager(c, null)).size() == 3);
   ...
   public void testCreateOrDeleteFileDirectoryManager() throws IOException{
      ...
      try{
         champAnnotationManager.createOrsaveManager(chp, null, dt, null, null, u, null, "creation", null);
      }catch(final RuntimeException re){
         assertTrue(re.getMessage().equals("error.filesystem.access"));
      }
      champAnnotationManager.createOrsaveManager(chp, null, dt, null, null, u, null, "creation", "/tmp/");
      assertTrue((champAnnotationManager.findByNomLikeManager("CHAMP_TEST", true)).size() == 1);
