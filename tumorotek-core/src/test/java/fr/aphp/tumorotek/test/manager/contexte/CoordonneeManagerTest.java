...
public class CoordonneeManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      coord1.setFax("TEST");
      coord1.setMail("TEST");
      coordonneeManager.saveManager(coord1, null);
      ...
      collabs.add(collab1);
      collabs.add(collab2);
      coordonneeManager.saveManager(coord2, collabs);
      ...
      coordonneeManager.saveManager(coord5, null);
      ...
      coordonneeManager.saveManager(coord7, null, false);
      ...
      collabs.add(collab1);
      collabs.add(collab2);
      coordonneeManager.saveManager(coord9, collabs, true);
      ...
      collabs = new ArrayList<>();
      collabs.add(collab3);
      coordonneeManager.saveManager(coord10, collabs, true);
