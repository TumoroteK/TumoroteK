...
@Autowired
   ...
   private void saveManagerTest() throws ParseException{
      ...
      //insertion
      patientMedecinManager.createOrsaveManager(pm, p1, c, "creation");
      ...
      try{
         pm2.setOrdre(6);
         patientMedecinManager.createOrsaveManager(pm2, p1, c, "creation");
      ...
      try{
         patientMedecinManager.createOrsaveManager(pm2, null, null, null);
      }catch(final NullPointerException ne){
         assertTrue(true);
      }
      try{
         patientMedecinManager.createOrsaveManager(pm2, null, null, "dummy");
   ...
   private void saveManagerTest() throws ParseException{
      ...
      pm.setOrdre(3);
      patientMedecinManager.createOrsaveManager(pm, null, null, "modification");
      ...
      pm.setOrdre(2);
      try{
         patientMedecinManager.createOrsaveManager(pm, patientDao.findById(1), collaborateurDao.findById(2),
            "modification");
