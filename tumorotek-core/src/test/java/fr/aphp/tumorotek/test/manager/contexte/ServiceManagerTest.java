...
public class ServiceManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      final Collaborateur collab1 = collaborateurDao.findById(1);
      final Collaborateur collab2 = collaborateurDao.findById(2);
      final Collaborateur collab3 = collaborateurDao.findById(3);
      ...
      try{
         serviceManager.saveManager(serv1, coordExcp, null, null, u, false);
      ...
      // est lancée
      try{
         serviceManager.saveManager(serv1, coordExcp, etab, null, u, false);
      }catch(final Exception e){
      ...
      serv1.setNom("TEST");
      serviceManager.saveManager(serv1, null, etab, null, u, false);
      ...
      serviceManager.saveManager(serv2, newCoord1, etab, collabs, u, false);
      ...
      serviceManager.saveManager(serv2, newCoordbis, etab, collabs, u, false);
      ...
      serv5.setNom("CANCER");
      serviceManager.saveManager(serv5, null, etab, null, u, false);
      ...
      try{
         serviceManager.saveManager(serv6, coordExcp, null, null, u, false, true);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      coordExcp.setAdresse("Excep");
      try{
         serviceManager.saveManager(serv6, coordExcp, etab, null, u, false, true);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catchedUpdate = true;
         }
      ...
      // sans la validation
      serv7.setNom("*****$#¤¤@-_");
      serviceManager.saveManager(serv7, null, etab, null, u, false, false);
      ...
      serviceManager.saveManager(serv9, newCoord2, etab, collabs, u, false, true);
      ...
      serviceManager.saveManager(serv9, newCoord3, etab, collabs, u, false, true);
      assertTrue(coordonneeManager.findAllObjectsManager().size() == 6);
      ...
      collabs = new ArrayList<>();
      collabs.add(collab3);
      serviceManager.saveManager(serv10, newCoord2, etab, collabs, u, false, true);
      ...
      for(int i = 0; i < nomValues.length; i++){
         ...
         try{
            ...
            if(i != 5){ //car creation valide
               serviceManager.saveManager(service, coord, etab, null, u, false);
            }
         }catch(final Exception e){
   ...
   private void validationUpdate(final Service service){
      ...
      for(int i = 0; i < nomValues.length; i++){
         ...
         try{
            ...
            service.setNom(nomValues[i]);
            if(i != 5){ //car creation valide
               serviceManager.saveManager(service, coord, etab, null, u, false, true);
            }
         }catch(final Exception e){
            if(e.getClass().getSimpleName().equals("ValidationException")){
               catchedUpdate = true;
   ...
   public void testArchivage(){
      ...
      collabs.add(c1);
      collabs.add(c2);
      serviceManager.saveManager(newS, null, etab, collabs, u, true);
      ...
      serviceManager.saveManager(sTest1, null, etab, collabs, u, true, true);
   ...
   public void testDeleteCascade(){
      ...
      Collaborateur c1 = new Collaborateur();
      c1.setNom("NOM1");
      collaborateurManager.saveManager(c1, null, null, null, servs, null, u);
      Collaborateur c2 = new Collaborateur();
      c2.setNom("NOM2");
      collaborateurManager.saveManager(c2, null, null, null, servs, null, u);
      final List<Collaborateur> collabs = new ArrayList<>();
      collabs.add(c1);
      collabs.add(c2);
      ...
      prelevementManager.saveManager(p, p1.getBanque(), p1.getNature(), null, p1.getConsentType(), c2, null, null, null,
   ...
   private void setUpFusionTest(){
      ...
      serviceManager.saveManager(sA, null, etablissementDao.findById(3), null, utilisateurDao.findById(1), false);

      serviceManager.saveManager(sP, null, etablissementDao.findById(2), null, utilisateurDao.findById(1), false);
   ...
   public void testFusionServicesWithBanques(){
      ...
      b.setNom("BANK");
      b.setArchive(false);
      banqueManager.createOrsaveManager(b, plateformeDao.findById(1), contexteDao.findById(1), passif, null, null, null,
         null, null, null, null, null, null, null, null, null, u1, null, "creation", "/tmp/");

      final Banque b2 = new Banque();
      b2.setNom("BANK2");
      b2.setArchive(false);
      banqueManager.createOrsaveManager(b2, plateformeDao.findById(1), contexteDao.findById(1), passif, null, null, null,
         null, null, null, null, null, null, null, null, null, u1, null, "creation", "/tmp/");
   ...
   public void testFusionServicesContrats(){
      ...
      contratManager.saveManager(contrat, null, passif, null, null, plateformeDao.findById(1), u1);

      Contrat contrat2 = new Contrat();
      contrat2.setNumero("CONTRAT2");
      contratManager.saveManager(contrat2, null, passif, null, null, plateformeDao.findById(1), u1);
   ...
   public void testFusionServicesCoreObjects(){
      ...
      prelevementManager.saveManager(prelevement, banqueDao.findById(1), natureDao.findById(1), maladieDao.findById(1),
         consentTypeDao.findById(1), null, passif, null, null, null, null, null, null, labs, null, null, u1, false, "/tmp/",
         false);
      ...
      prelevementManager.saveManager(prelevement2, banqueDao.findById(1), natureDao.findById(1), maladieDao.findById(1),
         consentTypeDao.findById(1), null, passif, null, null, null, null, null, null, labs2, null, null, u1, false, "/tmp/",
         false);
   ...
   public void testFusionServicesCession(){
      ...
      cessionManager.saveManager(cess, banqueDao.findById(1), cessionTypeDao.findById(1), null, null, null, passif, null,
         cessionStatutDao.findById(1), null, null, null, null, null, u1, null, "/tmp/");

      Cession cess2 = new Cession();
      cess2.setNumero("1002");
      cess2.setArchive(false);

      cessionManager.saveManager(cess2, banqueDao.findById(1), cessionTypeDao.findById(1), null, null, null, passif, null,
         cessionStatutDao.findById(1), null, null, null, null, null, u1, null, "/tmp/");
   ...
   public void testFusionServicesConteneur(){
      ...
      conteneurManager.saveManager(conteneur, conteneurTypeDao.findById(1), passif, null, null, u1,
      ...
      conteneurManager.saveManager(conteneur2, conteneurTypeDao.findById(1), passif, null, null, u1,
         plateformeDao.findById(1));
   ...
   public void testFusionServicesCollaborateur(){
      ...
      final Collaborateur collCommun = collaborateurDao.findById(3);
      ...
      collaborateurManager.saveManager(collPassif, null, null, null, servicesPassifSet, new ArrayList<Coordonnee>(), u1);
      collaborateurManager.saveManager(collActif, null, null, null, servicesActifSet, new ArrayList<Coordonnee>(), u1);
      collaborateurManager.saveManager(collCommun, collCommun.getTitre(), collCommun.getEtablissement(),
