...
public class AffectationImprimanteManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      // on test l'insertion avec l'utilisateur null
      try{
         affectationImprimanteManager.saveManager(ai, null, b1, i1, m1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // on test l'insertion avec la banque null
      try{
         affectationImprimanteManager.saveManager(ai, u3, null, i1, m1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // on test l'insertion avec l'irmpirmante null
      try{
         affectationImprimanteManager.saveManager(ai, u3, b1, null, m1);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      affectationImprimanteManager.saveManager(ai, u3, b1, i1, m1);
      ...
      affectationImprimanteManager.saveManager(ai2, u3, b1, i2, null);
      pk = ai2.getPk();
      ...
      affectationImprimanteManager.saveManager(aiUp1, u3, b1, i2, m1);
      pk = aiUp1.getPk();
      assertTrue(affectationImprimanteManager.findAllObjectsManager().size() == 6);
