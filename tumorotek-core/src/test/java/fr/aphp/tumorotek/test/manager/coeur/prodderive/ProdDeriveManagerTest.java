...
public class ProdDeriveManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      try{
         prodDeriveManager.saveManager(derive1, null, type, null, null, null, null, null, null, null, null, null, 
      ...
      try{
         prodDeriveManager.saveManager(derive1, banque, null, null, null, null, null, null, null, null, null, null,
            null, null, null, true, "/tmp/", false);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
      ...
      try{
         prodDeriveManager.saveManager(derive1, banque, type, null, null, null, null, null, null, null, null, null,
            null, null, null, true, "/tmp/", false);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
      ...
      // est lancée
      try{
         prodDeriveManager.saveManager(derive1, banque, type, statut, null, null, null, null, null, null, null,
      ...
      catched = false;
      try{
         prodDeriveManager.saveManager(derive1, banque, type, statut, null, empl, null, null, null, null, null,
            null, null, null, null, true, "/tmp/", false);
      ...
      badT.setObjetId(10);
      try{
         prodDeriveManager.saveManager(derive1, banque, type, statut, null, null, null, null, null, null, null, badT,
            null, null, null, true, "/tmp/", false);
      }catch(final Exception e){
      ...
      prodDeriveManager.saveManager(derive1, banque, type, statut, null, null, null, null, null, null, null, newT,
      ...
      prodDeriveManager.saveManager(derive2, banque, type, statut, collab, emp, volume, conc, quantite, mode, qualite,
      ...
      prodDeriveManager.saveManager(derive5, banque, type, objetStatutManager.findByIdManager(4), null, null, null, null,
      ...
      try{
         prodDeriveManager.saveManager(derive6, null, type, null, null, null, null, null, null, null, null, null, null,
      ...
      derive6.setCode(codeUpdated1);
      try{
         prodDeriveManager.saveManager(derive7, banque, null, null, null, null, null, null, null, null, null, null, null,
            null, null, null, null, true, null, "/tmp/");
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catchedUpdate = true;
      ...
      try{
         prodDeriveManager.saveManager(derive8, banque, type, null, null, null, null, null, null, null, null, null, null,
            null, null, null, null, true, null, "/tmp/");
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catchedUpdate = true;
      ...
      try{
         prodDeriveManager.saveManager(derive9, banque, type, null, null, empl, null, null, null, null, null, null, null,
            null, null, null, null, true, null, "/tmp/");
      }catch(final TKException ex){
         catchedUpdate = true;
         assertTrue(ex.getMessage().equals("PTRA.1.3 : error.emplacement.notEmpty"));
      ...
      badT.setObjetId(10);
      try{
         prodDeriveManager.saveManager(derive8, banque, type, null, null, null, null, null, null, null, null, badT, null,
            null, null, null, null, true, null, "/tmp/");
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("EntiteObjectIdNotExistException")){
            catched = true;
      ...
      prodDeriveManager.saveManager(derive9, banque, type, null, null, null, null, null, null, null, null, newT2, null,
      ...
      prodDeriveManager.saveManager(derive11, banque, type, statut, collab, emp, volume, conc, quantite, mode, qualite,
   ...
   private void validationInsert(final ProdDerive derive){
         ...
         for(int j = 0; j < codesLabos.length; j++){
            ...
            try{
               ...
               if(i != 5 || j != 4){ //car creation valide
                  prodDeriveManager.saveManager(derive, banque, type, null, null, null, null, null, null, null, null,
      ...
      catchedInsert = false;
      try{
         prodDeriveManager.saveManager(derive, banque, type, null, null, null, null, null, null, null, null, null,
      ...
      catchedInsert = false;
      try{
         prodDeriveManager.saveManager(derive, banque, type, null, null, null, volume, conc, quantite, null, null,
            null, null, null, utilisateur, true, "/tmp/", false);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("ValidationException")){
            catchedInsert = true;
      ...
      for(int i = 0; i < codes.length; i++){
         for(int j = 0; j < codesLabos.length; j++){
            ...
            try{
               ...
               derive.setCodeLabo(codesLabos[j]);
               if(i != 5 || j != 4){ //car creation valide
                  prodDeriveManager.saveManager(derive, banque, type, null, null, null, null, null, null, null,
   ...
   public void testCascadeDeriveChildren(){
      ...
      prodDeriveManager.saveManager(p, b, pType, st, null, null, null, null, null, null, null, null, null, null, u,
         false, "/tmp/", false);
      ...
      //insertion valide
      retourManager.createOrsaveManager(r, p, null, null, null, null, null, u, "creation");
      ...
      cederObjetManager.saveManager(ced2, c, entiteManager.findByNomManager("ProdDerive").get(0), qteUnite);
   ...
   public void testCreateUpdateDeriveWithAnnots(){
      ...
      boolean catched = false;
      try{
         prodDeriveManager.saveManager(derive, b1, type, objetStatutManager.findByIdManager(4), null, null, null, null,
      ...
      prodDeriveManager.saveManager(derive, b1, type, objetStatutManager.findByIdManager(4), null, null, null, null, null,
      ...
      prodDeriveManager.saveManager(derive, b1, type, null, null, null, null, null, null, null, null, null, listAnnots,
   ...
   public void testSwitchBanque(){
      ...
      prodDeriveManager.saveManager(p, b3, prodTypeManager.findByIdManager(1), objetStatutManager.findByIdManager(4),
      ...
      prodDeriveManager.saveManager(pbis, b4, prodTypeManager.findByIdManager(1), objetStatutManager.findByIdManager(4),
         null, null, null, null, null, null, null, null, null, null, u, false, "/tmp/", false);
      ...
      prodDeriveManager.saveManager(p, p.getBanque(), p.getProdType(), p.getObjetStatut(), null, null, null, null, null,
      ...
      final Transformation transfo1 = new Transformation();
      transfo1.setObjetId(p.getProdDeriveId());
      transformationManager.saveManager(transfo1, entiteManager.findByIdManager(8), null);
      ProdDerive derive = new ProdDerive();
      derive.setCode("deriveSwitch");
      prodDeriveManager.saveManager(derive, b2, prodTypeManager.findByIdManager(1), objetStatutManager.findByIdManager(4),
         ...
         enceinteManager
            .getTerminalesManager(
               enceinteManager
                  ...
                  .iterator().next())
            .iterator().next();
      emplacementManager.saveManager(emp, t1, entite);
      ...
      emplacementManager.saveManager(emp, emp.getTerminale(), entite);
      ...
      prodDeriveManager.saveManager(p, p.getBanque(), p.getProdType(), null, null, emp, null, null, null, null,
      ...
      bool.setBanque(b1);
      listAnnots.add(bool);
      prodDeriveManager.saveManager(p, p.getBanque(), p.getProdType(), null, null, emp, null, null, null, null, null,
   ...
   public void testCreateUpdateWithNonConformites(){
      ...
      prodDeriveManager.saveWithNonConformitesManager(p0, banqueDao.findById(1), prodTypeManager.findByIdManager(1),
      ...
      prodDeriveManager.saveWithNonConformitesManager(p1, banqueDao.findById(1), prodTypeManager.findByIdManager(1),
         objetStatutManager.findByIdManager(4), null, null, null, null, null, null, null, null, null, u, false, null, false,
         ncfsTrait, ncfsCess);
      ...
      prodDeriveManager.saveWithNonConformitesManager(p2, banqueDao.findById(1), prodTypeManager.findByIdManager(1),
         objetStatutManager.findByIdManager(4), null, null, null, null, null, null, null, null, null, u, false, null, false,
         null, null);
   ...
   public void testCreateDerivesEmplacement() throws ParseException{
      ...
      e7.setEntite(null);
      e7.setObjetId(null);
      emplacementManager.saveManager(e7, e7.getTerminale(), null);
   ...
   public void testCreateDerivesPrelevement() throws ParseException{
      ...
      prelevementManager.saveManager(prel, b2, p1.getNature(), null, p1.getConsentType(), null, null, null, null, null,
      ...
      prelevementManager.saveManager(prel2, b2, p1.getNature(), null, p1.getConsentType(), null, null, null, null, null,
      ...
      prelevementManager.saveManager(prel3, b2, p1.getNature(), null, p1.getConsentType(), null, null, null, null, null,
         null, null, mL, null, null, null, u2, false, "/tmp/", false);
   ...
   public void testCreateDerivesEchantillon() throws ParseException{
      ...
      new2.setPosition(4);
      new2.setVide(false);
      echantillonManager.saveManager(ech, b2, null, null, e1.getObjetStatut(), new2, e1.getEchantillonType(), null, mL,
      ...
      emplacementManager.saveManager(new2, new2.getTerminale(), entiteManager.findByNomManager("Echantillon").get(0));
      ...
      echantillonManager.saveManager(ech2, b2, null, null,
      ...
      echantillonManager.saveManager(ech2, b2, null, null, ech2.getObjetStatut(), null, ech2.getEchantillonType(), null,
   ...
   public void testCreateDerivesFocusRetour() throws ParseException{
      ...
      retourManager.createOrsaveManager(incomp, ech, echantillonManager.getEmplacementManager(ech), null, null, null,
         null, u2, "creation");
