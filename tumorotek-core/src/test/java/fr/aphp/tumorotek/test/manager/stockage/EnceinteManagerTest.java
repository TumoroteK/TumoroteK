...
public class EnceinteManagerTest extends AbstractManagerTest4
{
   ...
   private void saveManagerTest() throws ParseException{
      ...
      try{
         enceinteManager.saveManager(e1, null, cont, null, null, null, null, u);
      ...
      // non nulls
      try{
         enceinteManager.saveManager(e1, type, cont, enc, null, null, null, u);
      }catch(final Exception e){
      ...
      // nulls
      try{
         enceinteManager.saveManager(e1, type, null, null, null, null, null, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("InvalidParentException")){
            catched = true;
         }
      ...
      e1.setNom("R1");
      try{
         enceinteManager.saveManager(e1, type, cont, null, null, null, null, u);
      }catch(final Exception e){
      ...
      e1.setNom("T1");
      try{
         enceinteManager.saveManager(e1, type, null, enc, null, null, null, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      e1.setPosition(3);
      try{
         enceinteManager.saveManager(e1, type, c4, null, null, banks, null, u);
      }catch(final Exception e){
      ...
      enceinteManager.saveManager(e2, type, null, enc, ent, banks, couleurDao.findById(7), u);
   ...
   private void saveManagerTest() throws ParseException{
      ...
      en.setNom("TEST3");
      en.setPosition(3);
      enceinteManager.saveManager(en, type, null, enc, null, null, null, u);
      assertEquals(8, enceinteManager.findAllObjectsManager().size());
      ...
      try{
         enceinteManager.saveManager(eUp1, null, cont, null, null, null, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // non nulls
      try{
         enceinteManager.saveManager(eUp1, type, cont, enc, null, null, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("InvalidParentException")){
            catched = true;
         }
      ...
      // nulls
      try{
         enceinteManager.saveManager(eUp1, type, null, null, null, null, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("InvalidParentException")){
            catched = true;
         }
      ...
      eUp1.setNom("R1");
      try{
         enceinteManager.saveManager(eUp1, type, cont, null, null, null, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      eUp1.setNom("T1");
      try{
         enceinteManager.saveManager(eUp1, type, null, enc, null, null, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      eUp1.setPosition(3);
      try{
         enceinteManager.saveManager(eUp1, type, c4, null, null, banks, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("IncoherenceException")){
            catched = true;
         }
      ...
      catched = false;
      try{
         enceinteManager.saveManager(eUp1, type, cont, null, null, banks, null, incs, u, null);
      }catch(final Exception e){
      ...
      enceinteManager.saveManager(eUp2, type, null, enc, ent, banks, couleurDao.findById(5), incs, u, opTypes);
   ...
   private void deleteByIdManagerTest(){
      ...
      newE.setNbPlaces(5);
      newE.setPosition(1);
      enceinteManager.saveManager(newE, type, cont, null, null, banks, null, u);
      assertEquals(8, enceinteManager.findAllObjectsManager().size());
   ...
   private void validationInsert(final Enceinte enceinte) throws ParseException{
      ...
      try{
         ...
         enceinteManager.saveManager(enceinte, type, cont, null, null, null, null, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("ValidationException")){
            catchedInsert = true;
         }
   ...
   private void validationUpdate(Enceinte enceinte) throws ParseException{
      ...
      try{
         enceinte.setPosition(-1);
         enceinteManager.saveManager(enceinte, type, cont, null, null, null, null, null, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("ValidationException")){
            catched = true;
         }
      ...
      catched = false;
      try{
         enceinteManager.saveManager(enceinte, type, cont, null, null, null, null, incs, u, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
   ...
   public void testUpdatewithCreateAllArborescenceManager() throws ParseException{
      ...
      e.setConteneur(c);
      e.setPosition(1);
      enceinteManager.saveManager(e, eType1, c, null, null, banques, couleurDao.findById(2), u);
   ...
   public void testUpdateTailleEnceinte(){
      ...
      enceinteManager.saveManager(e1, type, null, enc, ent, banks, null, u);
      assertEquals(8, enceinteManager.findAllObjectsManager().size());
      assertEquals(1, getOperationManager().findByObjectManager(e1).size());
      ...
      enceinteManager.saveManager(e2, type, null, eTest2, ent, banks, null, u);
      ...
      enceinteManager.saveManager(e3, type, null, eTest2, ent, banks, null, u);
      ...
      enceinteManager.saveManager(e4, type, null, eTest2, ent, banks, null, u);
      ...
      terminaleManager.saveManager(t1, ect1, typeT, null, null, num, null, u);

      final Terminale t2 = new Terminale();
      t2.setNom("BT2-6");
      t2.setPosition(6);

      terminaleManager.saveManager(t2, ect1, typeT, null, null, num, null, u);

      final Terminale t3 = new Terminale();
      t3.setNom("BT3-9");
      t3.setPosition(9);

      terminaleManager.saveManager(t3, ect1, typeT, null, null, num, null, u);
