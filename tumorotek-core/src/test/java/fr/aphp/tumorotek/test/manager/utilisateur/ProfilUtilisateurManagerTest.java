...
public class ProfilUtilisateurManagerTest extends AbstractManagerTest4
{
	...
	public void testCrud(){
		...
		// on test l'insertion avec le profil null
		try{
			profilUtilisateurManager.saveManager(pu1, u4, b1, null);
		}catch(final Exception e){
			if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
				catched = true;
			}
		...
		// on test l'insertion avec l'utilisateur null
		try{
			profilUtilisateurManager.saveManager(pu1, null, b1, p1);
		}catch(final Exception e){
			if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
				catched = true;
			}
		...
		// on test l'insertion avec la banque null
		try{
			profilUtilisateurManager.saveManager(pu1, u4, null, p1);
		}catch(final Exception e){
			if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
				catched = true;
			}
		...
		// est lancée
		try{
			profilUtilisateurManager.saveManager(pu1, u3, b2, p1);
		}catch(final Exception e){
			if(e.getClass().getSimpleName().equals("DoublonFoundException")){
				catched = true;
			}
		...
		profilUtilisateurManager.saveManager(pu1, u4, b1, p1);
