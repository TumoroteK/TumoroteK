...
//	}
	...
	public void testPrintListCopiesData() {
		...
		List<LigneEtiquette> lbis = new ArrayList<LigneEtiquette>();
		LigneEtiquette l1bis = new LigneEtiquette();
		l1bis.setIsBarcode(true);
		l1bis.setContenu("béè");
		lbis.add(l1bis);
		
		LigneEtiquette l2bis = new LigneEtiquette();
		...
		try {
			...
			BarcodeFieldDefault by = new BarcodeFieldDefault(new Float(1.0), new Float(2.35), 10);
...
//	}
	...
	public void testPrintForDynamiqueModele() {
		...
		Modele mod = modeleManager.findByIdManager(2);

		List<TKStockableObject> liste = new ArrayList<TKStockableObject>();
		liste.add(echantillonManager.findByIdManager(1));
		liste.add(echantillonManager.findByIdManager(2));
		liste.add(echantillonManager.findByIdManager(3));
		liste.add(prodDeriveManager.findByIdManager(3));
		...
		try {
			BarcodeFieldDefault by = new BarcodeFieldDefault(new Float(1.0), new Float(2.35678), 10);
