...
public class CessionManagerTest extends AbstractManagerTest4
{
   ...
   private void saveManagerTest() throws ParseException{
      ...
      try{
         cessionManager.saveManager(cess1, null, type, null, null, null, null, null, statut, null, null, null, null, null,
      ...
      try{
         cessionManager.saveManager(cess1, bank, null, null, null, null, null, null, statut, null, null, null, null, null,
            utilisateur, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
      ...
      try{
         cessionManager.saveManager(cess1, bank, type, null, null, null, null, null, null, null, null, null, null, null,
            utilisateur, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
      ...
      cess1.setNumero("55");
      try{
         cessionManager.saveManager(cess1, bank, type, null, null, null, null, null, statut, null, null, null, null, null,
            utilisateur, null, null);
      }catch(final Exception e){
      ...
      cessionManager.saveManager(cess2, bank, type, exam, contrat, destinataire, servDest, demandeur, statut, executant,
   ...
   private void saveManagerTest() throws ParseException{
      ...
      // Première insertion
      cessionManager.saveManager(cess, bank, type, null, null, null, null, null, statut, null, null, null, null, null,
         utilisateur, null, null);
      assertTrue(contratManager.findAllObjectsManager().size() == 4);
      assertTrue(cessionManager.findAllObjectsManager().size() == 5);
      ...
      try{
         cessionManager.saveManager(cessUp1, null, type, null, null, null, null, null, statut, null, null, null, null,
      ...
      try{
         cessionManager.saveManager(cessUp1, bank, null, null, null, null, null, null, statut, null, null, null, null,
            null, null, null, utilisateur, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
      ...
      try{
         cessionManager.saveManager(cessUp1, bank, type, null, null, null, null, null, null, null, null, null, null, null,
      ...
      try{
         cessionManager.saveManager(cessUp1, bank, type, null, null, null, null, null, statut, null, null, null, null,
            null, null, null, utilisateur, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
      ...
      cessionManager.saveManager(cessUp1, bank, type, null, null, null, null, null, statut, null, null, null, null, null,
         null, null, utilisateur, null, null);
      assertTrue(contratManager.findAllObjectsManager().size() == 4);
      assertTrue(cessionManager.findAllObjectsManager().size() == 5);
      ...
      cessionManager.saveManager(cessUp2, bank, type, exam, contrat, destinataire, servDest, demandeur, statut, executant,
      ...
      list.add(cederUp1);
      list.add(cederUp2);
      cessionManager.saveManager(cess3, bank, type, null, contrat, null, null, null, statut, null, null, null, null, null,
      ...
      list = new ArrayList<>();
      list.add(cederUp3);
      cessionManager.saveManager(cessTest2, bank, type, null, contrat, null, null, null, statut, null, null, null, null,
         null, null, null, utilisateur, list, null);
   ...
   private void validationInsert(final Cession cession) throws ParseException{
      ...
      for(int i = 0; i < numeros.length; i++){
         ...
         try{
            ...
            cessionManager.saveManager(cession, banque, type, null, null, null, null, null, statut, null, null, null,
   ...
   public void testCreateUpdateCessionWithAnnots(){
      ...
      champs.add(c1);
      tableAnnotationManager.createOrsaveManager(table, e, null, champs, banks, null, utilisateur, "creation", null,
         null);
      ...
      boolean catched = false;
      try{
         cessionManager.saveManager(cession, b1, cType, null, null, null, null, null, cStatut, null, null, null,
      ...
      alpha1.setAlphanum("val1");
      cessionManager.saveManager(cession, b1, cType, null, null, null, null, null, cStatut, null, null, null, listAnnots,
      ...
      cessionManager.saveManager(cession, cession.getBanque(), cType, null, null, null, null, null, cStatut, null, null,
   ...
   //		Integer emplNb = IterableUtils.toList(emplacementDao.findAll()).size();
   //		
   ...
   //		
   //		echantillonManager.saveManager(e1, banqueManager.findByIdManager(1), null, null, 
   ...
   //		
   //		echantillonManager.saveManager(e2, banqueManager.findByIdManager(2), null, null, 
   ...
   //		
   //		echantillonManager.saveManager(e3, banqueManager.findByIdManager(1), null, null, 
   ...
   //		
   //		echantillonManager.saveManager(e4, banqueManager.findByIdManager(1), null, null, 
   ...
   //		assertTrue(IterableUtils.toList(emplacementDao.findAll()).size() == emplNb);
   //	}
