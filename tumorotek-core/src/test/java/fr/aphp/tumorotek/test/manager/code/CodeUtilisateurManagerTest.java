...
public class CodeUtilisateurManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindByCodeDossierManager(){
      ...
      dos = codeDossierDao.findById(2).get();
   ...
   public void testGetTranscodesManager(){
      ...
      final TableCodage adicap = tableCodageDao.findById(1).get();
      ...
      final TableCodage cimo = tableCodageDao.findById(3).get();
      tables.add(cimo);
   ...
   private void createObjectManagerTest(){
      ...
      final CodeUtilisateur u1 = codeUtilisateurDao.findById(1).get();
   ...
   private void updateObjectManagerTest(){
      ...
      final CodeUtilisateur a3 = codeUtilisateurDao.findById(3).get();
      ...
      assertTrue(codeUtilisateurManager.findByCodeDossierManager(codeDossierDao.findById(1).get()).size() == 1);
