...
public class EtablissementManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      // est lancée
      try{
         etablissementManager.saveManager(etab1, coordExcp, cat, u);
      ...
      etablissementManager.saveManager(etab1, null, null, u);
      ...
      etablissementManager.saveManager(etab2, newCoord1, cat, u);
      ...
      coordonneeManager.saveManager(newCoordbis, null);
      final int id2 = newCoordbis.getCoordonneeId();
      etablissementManager.saveManager(etab2, newCoordbis, cat, u);
      ...
      etablissementManager.deleteByIdManager(etab3, null, u);
      ...
      etablissementManager.deleteByIdManager(etab4, null, u);
      ...
      etablissementManager.deleteByIdManager(etab4b, null, u);
      ...
      etab5.setNom("NANCY");
      etablissementManager.saveManager(etab5, null, null, u);
      ...
      try{
         etablissementManager.saveManager(etab6, coordExcp, null, u, false);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catchedUpdate = true;
         }
      ...
      etablissementManager.saveManager(etab7, null, null, u, false);
      ...
      etablissementManager.saveManager(etab9, newCoord2, cat, u, false);
      ...
      etablissementManager.saveManager(etab10, newCoord3, cat, u, false);
      assertTrue(coordonneeManager.findAllObjectsManager().size() == 6);
      ...
      etablissementManager.deleteByIdManager(etab11, null, u);
         ...
         for(int j = 0; j < finessValues.length; j++){
            ...
            try{
               ...
               if(i != 5 || j != 4){ //car creation valide
                  ...
                  etablissementManager.saveManager(etablissement, coord, null, u);
               }
            }catch(final Exception e){
               if(e.getClass().getSimpleName().equals("ValidationException")){
                  catchedInsert = true;
         ...
         for(int j = 0; j < finessValues.length; j++){
            ...
            try{
               ...
               if(i != 5 || j != 4){ //car creation valide
                  final Coordonnee coord = new Coordonnee();
                  coord.setAdresse("test");
                  etablissementManager.saveManager(etablissement, coord, null, u, false);
               }
            }catch(final Exception e){
               if(e.getClass().getSimpleName().equals("ValidationException")){
                  catchedUpdate = true;
   ...
   public void testArchivable(){
      ...
      etab.setNom("ETAB");
      etablissementManager.saveManager(etab, null, cat, u);
      ...
      coordonneeManager.saveManager(coord, null);
      coords.add(coord);
      ...
      c1.setNom("NOM1");
      collaborateurManager.saveManager(c1, titre, etab, spec, services, null, u);
      ...
      c1.setPrenom("      ");
      collaborateurManager.saveManager(c1, titre, etab, spec, services, null, u, false);
      ...
      c2.setNom("NOM2");
      collaborateurManager.saveManager(c2, titre, etab, spec, services, coords, u);
      ...
      collabs.add(c1);
      collabs.add(c2);
      serviceManager.saveManager(newS, null, etab, collabs, u, false);
      final int idS1 = newS.getServiceId();

      // collaborateur isolé
      Collaborateur c4 = new Collaborateur();
      c4.setNom("NOM4");
      collaborateurManager.saveManager(c4, null, etab, null, null, null, u);
      ...
      newS.setNom("          ");
      serviceManager.saveManager(newS, null, etab, collabs, u, false, false);

      // création d'un service sans collabs
      final Service newS2 = new Service();
      newS2.setNom("NOMS2");
      serviceManager.saveManager(newS2, null, etab, null, u, false);
      ...
      etablissementManager.saveManager(etab, null, cat, u, true);
      ...
      etablissementManager.deleteByIdCascadeManager(etab, null, u);
      //serviceManager.deleteByIdManager(sTest2, null, u);
      //serviceManager.deleteByIdManager(sTest1, null, u);
      c1 = collaborateurManager.findByIdManager(idColl1);
      c2 = collaborateurManager.findByIdManager(idColl2);
   ...
   public void testDeleteCascade(){
      ...
      newS.setNom("NOMS");
      serviceManager.saveManager(newS, null, etab, null, u, false);
      final int idS1 = newS.getServiceId();
      final Service newS2 = new Service();
      newS2.setNom("NOMS2");
      serviceManager.saveManager(newS2, null, etab, null, u, false);
      ...
      newS3.setNom("NOMS3");
      serviceManager.saveManager(newS3, null, etab, null, u, false);
      ...
      Collaborateur c1 = new Collaborateur();
      c1.setNom("NOM1");
      collaborateurManager.saveManager(c1, null, etab, null, servs1, null, u);
      Collaborateur c2 = new Collaborateur();
      c2.setNom("NOM2");
      collaborateurManager.saveManager(c2, null, etab, null, servs1, null, u);
      final List<Collaborateur> collabs = new ArrayList<>();
      collabs.add(c1);
      collabs.add(c2);
      final Collaborateur c3 = new Collaborateur();
      c3.setNom("NOM3");
      collaborateurManager.saveManager(c3, null, etab, null, servs2, null, u);
      ...
      c.setNumero("666");
      cessionManager.saveManager(c, ces1.getBanque(), ces1.getCessionType(), null, null, null, null, c2,
      ...
      cessionManager.saveManager(c, c.getBanque(), c.getCessionType(), null, null, null, null, null, c.getCessionStatut(),
      ...
      ct.setNumero("12");
      contratManager.saveManager(ct, null, sTest2, null, null, pf, u);
      ...
      //referencement de c4
      contratManager.saveManager(ct, c4, null, null, null, pf, u);
      ...
      // dereferencement c4
      contratManager.saveManager(ct, null, null, null, null, pf, u);
      ...
      cessionManager.deleteByIdManager(c, null, u, null);
      assertTrue(cessionManager.findAllObjectsManager().size() == 4);
      contratManager.deleteByIdManager(ct, null, u);
   ...
   public void testIsReferencedObject(){
      ...
      try{
         etablissementManager.deleteByIdManager(e, null, u);
   ...
   private void setUpFusionTest(){
      ...
      etablissementManager.saveManager(eA, null, null, utilisateurDao.findById(1));

      etablissementManager.saveManager(eP, null, null, utilisateurDao.findById(1));
   ...
   private void cleanAfterFusion(final List<TKFantomableObject> fs){
      ...
      etablissementManager.deleteByIdManager(actif, null, utilisateurDao.findById(1));
      fs.add(actif);
      cleanUpFantomes(fs);
      testFindAll();
   }
   ...
   public void testFusionEtablissementsContrats(){
      ...
      contratManager.saveManager(contrat, null, null, passif, null, plateformeDao.findById(1), u1);

      Contrat contrat2 = new Contrat();
      contrat2.setNumero("CONTRAT2");
      contratManager.saveManager(contrat2, null, null, passif, null, plateformeDao.findById(1), u1);
   ...
   public void testFusionEtablissementsCollaborateursNoService(){
      ...
      collaborateurManager.saveManager(collaborateur, null, passif, null, null, null, u1);

      Collaborateur collaborateur2 = new Collaborateur();
      collaborateur2.setNom("NOM2");
      collaborateur2.setPrenom("PRENOM2");
      collaborateurManager.saveManager(collaborateur2, null, passif, null, null, null, u1);
      ...
      collaborateurManager.deleteByIdManager(collaborateur, "removeTest", u1);
      assertTrue(collaborateurDao.findByNom("NOM1").isEmpty());
      collaborateur2 = collaborateurDao.findByNom("NOM2").get(0);
      collaborateurManager.deleteByIdManager(collaborateur2, "removeTest", u1);
   ...
   public void testFusionEtablissementsService(){
      ...
      serviceManager.saveManager(service1, null, passif, null, u1, false);
      ...
      collaborateur.setNom("NOM1");
      collaborateur.setPrenom("PRENOM1");
      collaborateurManager.saveManager(collaborateur, null, passif, null, srvs, null, u1);

      service1 = serviceManager.findByNomLikeManager("SERVICE1", true).get(0);

      Service service2 = new Service();
      service2.setNom("SERVICE2");
      serviceManager.saveManager(service2, null, passif, null, u1, false);
      ...
      collaborateur2.setNom("NOM2");
      collaborateur2.setPrenom("PRENOM2");
      collaborateurManager.saveManager(collaborateur2, null, passif, null, srvs2, null, u1);

      Service service3 = new Service();
      service3.setNom("SERVICE1");
      serviceManager.saveManager(service3, null, actif, null, u1, false);
      ...
      collaborateurManager.saveManager(collaborateur3, null, passif, null, srvs3, null, u1);
      ...
      serviceManager.deleteByIdCascadeManager(service2, null, u1);
      serviceManager.deleteByIdCascadeManager(service3, null, u1);
