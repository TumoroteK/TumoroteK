...
public class IncidentManagerTest extends AbstractManagerTest4
{
   ...
   private void saveManagerTest() throws ParseException{
      ...
      try{
         incidentManager.saveManager(i1, null, null, null);
      ...
      i1.setDate(d1);
      try{
         incidentManager.saveManager(i1, c, null, null);
      }catch(final Exception e){
   ...
   private void saveManagerTest() throws ParseException{
      ...
      final Date date = new SimpleDateFormat("dd/MM/yyyy").parse("01/09/2009");
      i.setDate(date);
      incidentManager.saveManager(i, null, e1, null);
      assertTrue(incidentManager.findAllObjectsManager().size() == 6);
      ...
      try{
         incidentManager.saveManager(iUp, null, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      iUp.setDate(d1);
      try{
         incidentManager.saveManager(iUp, null, e1, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      incidentManager.saveManager(iUp, null, null, terminaleDao.findById(1));
      assertTrue(incidentManager.findAllObjectsManager().size() == 6);
   ...
   private void validationInsert(final Incident incident) throws ParseException{
      ...
      for(int i = 0; i < emptyValues.length; i++){
         ...
         try{
            ...
            incident.setDate(d);
            incidentManager.saveManager(incident, c, null, null);
         }catch(final Exception e){
