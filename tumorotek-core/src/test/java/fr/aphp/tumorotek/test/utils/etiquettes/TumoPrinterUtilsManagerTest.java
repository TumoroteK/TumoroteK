...
import fr.aphp.tumorotek.model.imprimante.Modele;public class TumoPrinterUtilsManagerTest extends AbstractManagerTest4 {
	...
	public void testExtractStaticDataForEchantillon() {
		...
		List<LigneEtiquette> data = tumoPrinterUtilsManager.createListEtiquette(e1,
				null);
	...
	public void testExtractDynDataForEchantillon() {
		...
		List<LigneEtiquette> data = tumoPrinterUtilsManager
				.extractDynData(e1, m2);
		...
		assertTrue(tumoPrinterUtilsManager.extractDynData(null,
				m2).size() == 0);
		assertTrue(tumoPrinterUtilsManager.extractDynData(e1,
				null).size() == 0);
		assertTrue(tumoPrinterUtilsManager.extractDynData(null,
				null).size() == 0);
	}
	...
	public void testExtractDynDataForProdDerive() {
		...
		assertTrue(tumoPrinterUtilsManager
				.extractDynData(null, m2).size() == 0);
		assertTrue(tumoPrinterUtilsManager
				.extractDynData(p1, null).size() == 0);
		assertTrue(tumoPrinterUtilsManager.extractDynData(null,
				null).size() == 0);
	}
