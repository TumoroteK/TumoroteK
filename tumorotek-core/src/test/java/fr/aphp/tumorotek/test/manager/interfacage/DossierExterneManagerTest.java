...
public class DossierExterneManagerTest extends AbstractManagerTest4
{
	...
	public void testCrud() throws ParseException{
		...
		dossierExterneManager.saveManager(de1, e1, null, null, 20);
		...
		blocs.add(b1);
		blocs.add(b2);
		dossierExterneManager.saveManager(de2, e1, blocs, null, 20);
		...
		dossierExterneManager.saveManager(de3, e1, blocs, valeurs, 20);
		...
		dossierExterneManager.saveManager(de4, e1, blocs, valeurs, 20);
		assertTrue(dossierExterneManager.findAllObjectsManager().size() == nb + 3);
	...
	public void testFirstInFirstOut() throws ParseException, NoSuchFieldException{
		...
		final Hashtable<BlocExterne, List<ValeurExterne>> valeurs = new Hashtable<>();
		valeurs.put(b3, vals1);
		dossierExterneManager.saveManager(de3, emetteurDao.findById(1), blocs, valeurs, 7);
		...
		de1.setDateOperation(date);
		dossierExterneManager.saveManager(de1, emetteurDao.findById(1), null, null, 7);
	...
	public void testFindChildrenByEmetteurValeurManager(){
		...
		dossierExterneManager.saveManager(der4, emetteurDao.findById(2), blocsDer4, valeursDer4Map, 2000);
