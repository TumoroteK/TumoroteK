...
public class LaboInterManagerTest extends AbstractManagerTest4
{
   ...
   private void saveManagerTest(){
      ...
      l1.setSterile(false);
      laboInterManager.saveManager(l1, p1, null, c1, t1, true);
      ...
      l2.setSterile(false);
      try{
         laboInterManager.saveManager(l2, p1, null, null, null, true);
               ...
               for(int g = 0; g < transportTempValues.length; g++){
                  try{
                     ...
                     if(!(i == 1 && j == 3 && k > 1 && g > 1)){ //car creation valide
                        laboInterManager.saveManager(l2, prelValues[i], null, null, null, true);
                     }
                  }catch(final Exception e){
                     if(i == 0){
   ...
   private void saveManagerTest(){
      ...
      l1.setOrdre(5);
      laboInterManager.saveManager(l1, p1, s1, null, null, true);
      ...
      try{
         ...
         laboInterManager.saveManager(l1, p2, s1, null, null, true);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
               ...
               for(int g = 0; g < transportTempValues.length; g++){
                  try{
                     ...
                     if(i != 1 && j != 3 && k != 3 && g != 3){ //car creation valide
                        laboInterManager.saveManager(l1, prelValues[i], null, null, null, true);
                     }
                  }catch(final Exception e){
                     if(i == 0){
                        assertTrue(e.getClass().getSimpleName().equals("RequiredObjectIsNullException"));
