 ...
 * accepté les termes.
 **/
package fr.aphp.tumorotek.test.manager.ui;
...
public class UiRequeteManagerTest extends AbstractManagerTest4
{
	...
	//
	//		// Test de l'insertion
	//		uiRequeteManager.saveManager("REQPAT", utilisateurDao.findById(2), entiteDao.findById(1), 1, vals);
	//
	...
	//
	//		// null update 
	//		uiRequeteManager.saveManager(null, vals);
	//
	//		final UiRequete r2 =
	...
	//
	//		uiRequeteManager.saveManager(r1, vals);
	//
	...
	//
	//		r1.setOrdre(4);
	//		uiRequeteManager.saveManager(r1, null);
	//
	//		r1 = uiRequeteManager.findByUtilisateurAndEntiteManager(utilisateurDao.findById(2), entiteDao.findById(1)).get(0);
	...
	//		try{
	//			uiRequeteManager.saveManager("TESTVAL", null, entiteDao.findById(5), 1, null);
	...
	//		catched = false;
	//		try{
	//			uiRequeteManager.saveManager("TESTVAL", utilisateurDao.findById(5), null, 1, null);
	//		}catch(final RequiredObjectIsNullException re){
	//			catched = true;
	//		}
	//		assertTrue(catched);
	//		catched = false;
	//		try{
	//			uiRequeteManager.saveManager("TESTVAL", utilisateurDao.findById(5), entiteDao.findById(5), null, null);
	//		}catch(final RequiredObjectIsNullException re){
	//			catched = true;
	//		}
	//		assertTrue(catched);
	...
	//		catched = false;
	//		try{
	//			uiRequeteManager.saveManager("REQ2", utilisateurDao.findById(1), entiteDao.findById(2), 6, null);
	...
	//		try{
	//			uiRequeteManager.saveManager(null, utilisateurDao.findById(1), entiteDao.findById(2), 6, null);
	...
	//		errs.clear();
	//		try{
	//			uiRequeteManager.saveManager("", utilisateurDao.findById(1), entiteDao.findById(2), 6, null);
	//		}catch(final ValidationException ve){
	//			errs = ve.getErrors();
	//			assertTrue(errs.get(0).getFieldError().getCode().equals("uiRequete.nom.empty"));
	//		}
	...
	//		errs.clear();
	//		try{
	//			uiRequeteManager.saveManager(createOverLength(250), utilisateurDao.findById(1), entiteDao.findById(2), 6, null);
	//		}catch(final ValidationException ve){
	//			errs = ve.getErrors();
