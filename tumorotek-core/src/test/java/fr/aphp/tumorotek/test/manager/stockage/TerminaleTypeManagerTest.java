...
public class TerminaleTypeManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindById(){
      final TerminaleType tt1 = terminaleTypeManager.findByIdManager(1);
      assertNotNull(tt1);
      assertTrue(tt1.getType().equals("RECTANGULAIRE_100"));

      final TerminaleType ttNull = terminaleTypeManager.findByIdManager(100);
      assertNull(ttNull);
   }
   ...
   public void testFindAll(){
      final List<TerminaleType> list = terminaleTypeManager.findAllObjectsManager();
   ...
   public void testFindByTypeManager(){
      List<TerminaleType> list = terminaleTypeManager.findByTypeManager("RECTANGULAIRE_100");
   ...
   public void testFindDoublon(){
      //Cree le doublon
      final TerminaleType t1 = terminaleTypeManager.findByIdManager(1);
      ...
      final TerminaleType t2 = new TerminaleType();
   ...
   public void testIsUsedObjectManager(){
      ...
      final TerminaleType t2 = terminaleTypeManager.findByIdManager(2);
   ...
   private void saveManagerTest(){
      ...
      try{
         terminaleTypeManager.saveManager(t1Bis);
   ...
   private void saveManagerTest(){
      ...
      t1.setType("TEST BIS");
      terminaleTypeManager.saveManager(t1);
      final TerminaleType t1Bis = terminaleTypeManager.findByIdManager(7);
    ...
    */
   private void validationInsert(final TerminaleType type) throws ParseException{

      boolean catchedInsert = false;

      // On teste une insertion avec un attribut nom non valide
      final String[] emptyValues = new String[] {null, "", "  ", "%¤¤$$*gd", createOverLength(25)};
      for(int i = 0; i < emptyValues.length; i++){
         catchedInsert = false;
         try{
            type.setType(emptyValues[i]);
            terminaleTypeManager.saveManager(type);
         }catch(final Exception e){
      ...
      final Integer[] nbPlacesValues = new Integer[] {null, -1, 0};
      ...
      final Integer[] hauteurValues = new Integer[] {null, -1};
    ...
    * @throws ParseException 
    */
   private void validationUpdate(final TerminaleType type) throws ParseException{
