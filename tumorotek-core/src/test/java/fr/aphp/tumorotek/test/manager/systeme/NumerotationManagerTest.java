...
public class NumerotationManagerTest extends AbstractManagerTest4
{
   ...
   private void saveManagerTest() throws ParseException{
      ...
      try{
         numerotationManager.saveManager(n1, null, e3);
      ...
      try{
         numerotationManager.saveManager(n1, b1, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         numerotationManager.saveManager(n1, b1, e2);
      }catch(final Exception e){
      ...
      n1.setNbChiffres(5);
      n1.setZeroFill(true);
      numerotationManager.saveManager(n1, b1, e3);
   ...
   private void saveManagerTest() throws ParseException{
      ...
      numerotationManager.saveManager(n, b1, e3);
      assertTrue(numerotationManager.findAllObjectsManager().size() == 4);
      ...
      try{
         numerotationManager.saveManager(nUp, null, e3);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         numerotationManager.saveManager(nUp, b1, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         numerotationManager.saveManager(nUp, b1, e2);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      numerotationManager.saveManager(nUp, b1, e3);
      assertTrue(numerotationManager.findAllObjectsManager().size() == 4);
