...
public class ImportTemplateManagerTest extends AbstractManagerTest4
{
	 ...
	 */
	public void saveManager() throws ParseException{
		...
		try{
			importTemplateManager.saveManager(it1, null, null, null);
		...
		it1.setNom("IMPORT AUTO");
		try{
			importTemplateManager.saveManager(it1, b1, null, null);
		}catch(final Exception e){
		...
		colonnes.add(ic1);
		try{
			importTemplateManager.saveManager(it1, b1, null, colonnes);
		}catch(final Exception e){
			if(e.getClass().getSimpleName().equals("DoublonFoundException")){
				catched = true;
			}
		...
		importTemplateManager.saveManager(it2, b1, entites, colonnes);
	...
	public void saveManager() throws ParseException{
		...
		it.setNom("TEST");
		importTemplateManager.saveManager(it, b1, null, colonnes);
		assertTrue(importTemplateManager.findAllObjectsManager().size() == tots + 1);
		...
		try{
			importTemplateManager.saveManager(itUp, null, null, null, null);
		}catch(final Exception e){
			if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
				catched = true;
			}
		...
		try{
			importTemplateManager.saveManager(itUp, b1, null, null, null);
		}catch(final Exception e){
			if(e.getClass().getSimpleName().equals("DoublonFoundException")){
				catched = true;
			}
		...
		colonnes.add(icE);
		try{
			importTemplateManager.saveManager(itUp, b1, null, colonnes, null);
		}catch(final Exception e){
			if(e.getClass().getSimpleName().equals("DoublonFoundException")){
				catched = true;
			}
		...
		entites.add(e1);
		entites.add(e2);
		importTemplateManager.saveManager(itTest, b1, entites, null, null);
		assertTrue(importTemplateManager.findAllObjectsManager().size() == tots + 1);
		...
		itTest2.setNom("TEST");
		importTemplateManager.saveManager(itTest2, b1, entites, colonnes, colsToRemove);
		assertTrue(importTemplateManager.findAllObjectsManager().size() == tots + 1);
		assertTrue(importColonneManager.findAllObjectsManager().size() == cTots + 3);
		assertTrue(champManager.findAllObjectsManager().size() == aTots + 3);
	...
	public void validationInsert(final ImportTemplate template) throws ParseException{
		...
		for(int i = 0; i < emptyValues.length; i++){
			...
			try{
				...
				importTemplateManager.saveManager(template, b1, null, null);
			}catch(final Exception e){
	...
	public void validationUpdate(final ImportTemplate template) throws ParseException{
		...
		for(int i = 0; i < emptyValues.length; i++){
			...
			try{
				template.setNom(emptyValues[i]);
				importTemplateManager.saveManager(template, b1, null, null, null);
			}catch(final Exception e){
				if(e.getClass().getSimpleName().equals("ValidationException")){
					catchedInsert = true;
				}
