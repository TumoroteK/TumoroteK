...
public class ModeleManagerTest extends AbstractManagerTest4
{
   ...
   //		try {
   //			modeleManager.saveManager(m1, null, mt1, null, null);
   //		} catch (Exception e) {
   ...
   //		try {
   //			modeleManager.saveManager(m1, pf1, null, null, null);
   //		} catch (Exception e) {
   //			if (e.getClass().getSimpleName().equals(
   //					"RequiredObjectIsNullException")) {
   //				catched = true;
   ...
   //		m1.setNom("NBT");
   //		try {
   //			modeleManager.saveManager(m1, pf1, mt1, null, null);
   //		} catch (Exception e) {
   //			if (e.getClass().getSimpleName().equals(
   ...
   //		catched = false;
   //		try {
   //			modeleManager.saveManager(m1, pf1, mt1, lignes, null);
   //		} catch (Exception e) {
   //			catched = true;
   //		}
   //		assertTrue(catched);
   ...
   //		hash.put(le1, champs);
   //		
   //		modeleManager.saveManager(m2, pf1, mt1, lignes, hash);
   ...
   private void saveManagerTest() throws ParseException{
      ...
      modeleManager.saveManager(m, pf1, mt1, lignes, hash);
      ...
      // on test l'insertion avec une pf nulle
      try{
         modeleManager.saveManager(mUp1, null, mt1, null, null, null, null);
      ...
      // on test l'insertion avec un type null
      try{
         modeleManager.saveManager(mUp1, pf1, null, null, null, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      mUp1.setNom("NBT");
      try{
         modeleManager.saveManager(mUp1, pf1, mt1, null, null, null, null);
      }catch(final Exception e){
      ...
      catched = false;
      try{
         modeleManager.saveManager(mUp1, pf1, mt1, lignes, null, null, null);
      }catch(final Exception e){
         catched = true;
      }
      assertTrue(catched);
      ...
      modeleManager.saveManager(mTest, pf1, mt1, lignes, null, hash, hashToRmv);
      assertTrue(modeleManager.findAllObjectsManager().size() == 4);
      assertTrue(ligneEtiquetteManager.findAllObjectsManager().size() == 9);
      assertTrue(champLigneEtiquetteManager.findAllObjectsManager().size() == 12);
      assertTrue(champManager.findAllObjectsManager().size() == cTots + 2);
      ...
      modeleManager.saveManager(mTest2, pf1, mt1, lignes, lignesToRmv, hash, null);
      assertTrue(modeleManager.findAllObjectsManager().size() == 4);
   ...
   //		m.setTexteLibre("TEXTE");
   //		m.setIsDefault(false);
   //		modeleManager.saveManager(m, pf1, mt1, null, null);
   //		assertTrue(modeleManager.findAllObjectsManager().size() == 4);
   //		
   ...
   //		affectationImprimanteManager.saveManager(ai, u1, b1, i2, m);
