...
public class InjectionManagerTest extends AbstractManagerTest4
{
	...
	public void testDaveDossierAndChildrenManager() throws ParseException {
		...
		dossierExterneManager.saveManager(parent, e1, blocsParent, valeursParentMap, 2000);
		...
		dossierExterneManager.saveManager(der1, e1, blocsDer1, valeursDer1Map, 2000);	
		...
		dossierExterneManager.saveManager(der2, e1, blocsDer2, valeursDer2Map, 2000);	
	...
	public void testFindExistingPrelevementByEmetteurManager() {
		...
		dossierExterneManager.saveManager(newDos2, emet, null, null, 25);
	...
	public void testFindExistingParentByEmetteurAndEntiteManager() {
		...
		dossierExterneManager.saveManager(der2, emet, blocsDer2, valeursDer2Map, 25);
	...
	public void testFindExistingChildByEmetteurAndEntiteManager() {
		...
		der2.setOperation("D");
		der2.setEntiteId(8);
		dossierExterneManager.saveManager(der2, emet, null, null, 25);
	...
	public void testSynchronizeDeriveChildrenManager() {
		...
		dossierExterneManager.saveManager(parent, e2, blocsParent, valeursParentMap, 2000);
		...
		dossierExterneManager.saveManager(der1, e2, blocsDer1, valeursDer1Map, 2000);	
		...
		dossierExterneManager.saveManager(der2, e2, blocsDer2, valeursDer2Map, 2000);
		...
		dossierExterneManager.saveManager(der3, e2, blocsDer3, valeursDer3Map, 2000);
		...
		dossierExterneManager.saveManager(der4, e2, blocsDer4, valeursDer4Map, 2000);
