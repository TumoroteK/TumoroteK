...
public class CollaborateurManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      // est lancée
      try{
         collaborateurManager.saveManager(collab1, null, null, spec, null, null, u);
      ...
      collaborateurManager.saveManager(collab1, null, null, null, null, null, u);
      ...
      coordonneeManager.saveManager(newCoord2, null);
      ...
      catched = false;
      try{
         collaborateurManager.saveManager(collab2, titre, etab, spec, services, coords, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      collaborateurManager.saveManager(collab5, null, null, spec, null, null, u);
      ...
      try{
         collaborateurManager.saveManager(collab6, null, null, spec, null, null, u, true);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catchedUpdate = true;
         }
      ...
      collab7.setNom("BAR");
      collab7.setPrenom("*#%$$");
      collaborateurManager.saveManager(collab7, null, null, spec, null, null, u, false);
      ...
      coordonneeManager.saveManager(newCoordUp2, null);
      ...
      catchedUpdate = false;
      try{
         collaborateurManager.saveManager(collab9, titre, etab, spec, services, coords, u, true);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catchedUpdate = true;
         }
      ...
      //coords.add(coord2);
      //coords.add(coord3);
      collaborateurManager.saveManager(collab10, titre, etab, spec, services, coords, u, true);
         ...
         for(int j = 0; j < prenomValues.length; j++){
            ...
            try{
               ...
               if(i != 5 || j != 4){ //car creation valide
                  collaborateurManager.saveManager(collaborateur, null, null, null, null, null, u);
               }
            }catch(final Exception e){
      ...
      for(int i = 0; i < nomValues.length; i++){
         for(int j = 0; j < prenomValues.length; j++){
            ...
            try{
               ...
               collaborateur.setPrenom(prenomValues[j]);
               if(i != 5 || j != 4){ //car creation valide
                  collaborateurManager.saveManager(collaborateur, null, null, null, null, null, u, true);
               }
            }catch(final Exception e){
               if(e.getClass().getSimpleName().equals("ValidationException")){
                  catchedUpdate = true;
   ...
   private void setUpFusionTest(){
      ...
      collaborateurManager.saveManager(cA, null, null, null, null, null, u1);
      collaborateurManager.saveManager(cP, null, null, null, null, null, u1);
   ...
   public void testFusionCollaborateursWithBanques(){
      ...
      b.setNom("BANK");
      b.setArchive(false);
      banqueManager.createOrsaveManager(b, plateformeDao.findById(1), contexteDao.findById(1), null, passif, passif, null,
         null, null, null, null, null, null, null, null, null, u1, null, "creation", "/tmp/");

      final Banque b2 = new Banque();
      b2.setNom("BANK2");
      b2.setArchive(false);
      banqueManager.createOrsaveManager(b2, plateformeDao.findById(1), contexteDao.findById(1), null, passif, passif,
   ...
   public void testFusionCollaborateursContrats(){
      ...
      contratManager.saveManager(contrat, passif, null, null, null, plateformeDao.findById(1), u1);
      Contrat contrat2 = new Contrat();
      contrat2.setNumero("CONTRAT2");
      contratManager.saveManager(contrat2, passif, null, null, null, plateformeDao.findById(1), u1);
   ...
   public void testFusionCollaborateursCoordonnees(){
      ...
      coordonneeManager.saveManager(coordonneeA, collaborateurActifList);
      coordonneeManager.saveManager(coordonneeP, collaborateurPassifList);
      coordonneeManager.saveManager(coordonneesCommune, collaborateurX2List, false);
   ...
   public void testFusionCollaborateursServices(){
      ...
      serviceManager.saveManager(s1, null, etablissementManager.findByIdManager(1), s1colList, u1, false);
      serviceManager.saveManager(s2, null, etablissementManager.findByIdManager(1), s2colList, u1, false);
      serviceManager.saveManager(s3, null, etablissementManager.findByIdManager(1), s3colList, u1, false);
      ...
      serviceManager.saveManager(s1, null, etablissementManager.findByIdManager(1), new ArrayList<Collaborateur>(), u1,
         false, false);
      serviceManager.saveManager(s2, null, etablissementManager.findByIdManager(1), new ArrayList<Collaborateur>(), u1,
         false, false);
   ...
   public void testFusionCollaborateursCoreObjects(){
      ...
      prelevementManager.saveManager(prelevement, banqueDao.findById(1), natureDao.findById(1), maladieDao.findById(1),
      ...
      prelevementManager.saveManager(prelevement2, banqueDao.findById(1), natureDao.findById(1), maladieDao.findById(1),
      ...
      echantillonManager.saveManager(echantillon, banqueDao.findById(1),
      ...
      echantillonManager.saveManager(echantillon2, banqueDao.findById(1),
         prelevementDao.findByCode("PRELEVEMENTEST").get(0), passif, null, null, echantillonTypeDao.findById(1), null, null, null,
         null, null, null, u1, false, "/tmp/", false);
      ...
      retourManager.createOrsaveManager(retour, null, null, passif, null, null, null, u1, "creation");
      ...
      retourManager.createOrsaveManager(retour2, null, null, passif, null, null, null, u1, "creation");
      ...
      produitDeriveManager.saveManager(prodDerive, banqueDao.findById(1), produitTypeDao.findById(1), null, passif, null,
      ...
      produitDeriveManager.saveManager(prodDerive2, banqueDao.findById(1), produitTypeDao.findById(1), null, passif, null,
         null, null, null, null, null, null, null, null, u1, false, "/tmp/", false);
   ...
   public void testFusionCollaborateurCession(){
      ...
      cessionManager.saveManager(cess, banqueDao.findById(1), cessionTypeDao.findById(1), null, null, passif, null,
      ...
      cessionManager.saveManager(cess2, banqueDao.findById(1), cessionTypeDao.findById(1), null, null, passif, null,
         passif, cessionStatutDao.findById(1), passif, null, null, null, null, u1, null, "/tmp/");
   ...
   public void testFusionCollaborateurPlateformeAndUtilisateur(){
      ...
      plateformeManager.saveManager(plateF, passif, null, null, u1);
      final Plateforme plateF2 = plateformeDao.findById(2);
      plateformeManager.saveManager(plateF2, passif, null, null, u1);
      ...
      utilisateurManager.saveManager(utilisateur, passif, null, null, u1, plateformeDao.findById(1));
      ...
      utilisateurManager.saveManager(utilisateur2, passif, null, null, u1, plateformeDao.findById(1));
      ...
      plateformeManager.saveManager(plateF, collaborateurDao.findById(1), null, null, u1);
   ...
   public void testFusionCollaborateurPatientMaladieMedecin() throws ParseException{
      ...
      patientManager.createOrsaveManager(patient, null, collaborateurPassifList, null, null, null, null, null, u1,
         "creation", "/tmp/", false);
      ...
      patientManager.createOrsaveManager(patient2, null, collaborateurPassifList, null, null, null, null, null, u1,
         "creation", "/tmp/", false);
      ...
      maladieManager.createOrsaveManager(maladie, patientDao.findByNom("PATTEST").get(0), collaborateurPassifList, u1,
         "creation");
      ...
      maladieManager.createOrsaveManager(maladie2, patientDao.findByNom("PATTEST2").get(0), allCollabs, u1, "creation");
      ...
      collaborateurManager.saveManager(newCol, null, null, null, null, null, u1);
      ...
      maladieManager.createOrsaveManager(maladie3, patientDao.findByNom("PATTEST2").get(0), listActif, u1, "creation");
