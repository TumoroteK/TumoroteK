...
public class TemplateManagerTest extends AbstractManagerTest4
{
   ...
   public void testsaveManager() throws ParseException{
      ...
      try{
         templateManager.saveManager(t1, null, e2, null, null, null);
      ...
      try{
         templateManager.saveManager(t1, b1, null, null, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      t1.setNom("Fiche prélèvement");
      try{
         templateManager.saveManager(t1, b1, e2, null, null, null);
      }catch(final Exception e){
      ...
      catched = false;
      try{
         templateManager.saveManager(t1, b1, e2, blocs, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      catched = false;
      try{
         templateManager.saveManager(t1, b1, e2, null, champs, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      catched = false;
      try{
         templateManager.saveManager(t1, b1, e2, null, null, tables);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      templateManager.saveManager(t2, b1, e2, blocs, champs, tables);
   ...
   public void testsaveManager(){
      ...
      templateManager.saveManager(t, b1, e2, blocs, champs, tables);
      assertTrue(templateManager.findAllObjectsManager().size() == 4);
      assertTrue(blocImpressionTemplateManager.findAllObjectsManager().size() == 6);
      assertTrue(champImprimeManager.findAllObjectsManager().size() == 6);
      assertTrue(tableAnnotationTemplateManager.findAllObjectsManager().size() == 3);
      ...
      // on test l'insertion avec la banque null
      try{
         templateManager.saveManager(tUp, null, e2, null, null, null, null, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // on test l'insertion avec l'entité null
      try{
         templateManager.saveManager(tUp, b1, null, null, null, null, null, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         templateManager.saveManager(tUp, b1, e2, null, null, null, null, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      catched = false;
      try{
         templateManager.saveManager(tUp, b1, e2, blocs, blocsToCreate, null, null, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      catched = false;
      try{
         templateManager.saveManager(tUp, b1, e2, null, null, champs, champsToCreate, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      catched = false;
      try{
         templateManager.saveManager(tUp, b1, e2, null, null, null, null, tables, tablesToCreate);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      tablesToCreate.add(tat3);
      templateManager.saveManager(tUp2, b1, e2, blocs, blocsToCreate, champs, champsToCreate, tables, tablesToCreate);
      assertTrue(templateManager.findAllObjectsManager().size() == 4);
      ...
      templateManager.saveManager(tUp2, b1, e2, blocs, null, champs, null, tables, null);
      assertTrue(templateManager.findAllObjectsManager().size() == 4);
      assertTrue(tableAnnotationTemplateManager.findAllObjectsManager().size() == 3);
      assertTrue(champImprimeManager.findAllObjectsManager().size() == 6);
      assertTrue(blocImpressionTemplateManager.findAllObjectsManager().size() == 6);
   ...
   private void validationInsert(final Template template) throws ParseException{
      ...
      for(int i = 0; i < emptyValues.length; i++){
         ...
         try{
            ...
            templateManager.saveManager(template, b1, e2, null, null, null);
         }catch(final Exception e){
   ...
   private void validationUpdate(final Template template) throws ParseException{
      ...
      for(int i = 0; i < emptyValues.length; i++){
         ...
         try{
            template.setNom(emptyValues[i]);
            templateManager.saveManager(template, b1, e2, null, null, null, null, null, null);
         }catch(final Exception e){
            if(e.getClass().getSimpleName().equals("ValidationException")){
               catchedInsert = true;
            }
