...
public class RequeteManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      for(int i = 0; i < Math.pow(2, 3) - 1; i++){
         ...
         try{
            manager.saveManager(requete, groupement, createur, b);
         }catch(final RequiredObjectIsNullException e){
            assertEquals("RequiredObjectIsNullException", e.getClass().getSimpleName());
         }
         try{
            manager.saveManager(requete, groupement, createur);
         }catch(final RequiredObjectIsNullException e){
            assertEquals("RequiredObjectIsNullException", e.getClass().getSimpleName());
         }
      }
      ...
      try{
         manager.saveManager(requete, groupement, util, null);
      }catch(final RequiredObjectIsNullException e){
         assertEquals("RequiredObjectIsNullException", e.getClass().getSimpleName());
      }
      requete.setIntitule("requete one");
      manager.saveManager(requete, gCopie, util, b);
      ...
      manager.saveManager(requete2, gCopie2, util);
