...
public class RetourManagerTest extends AbstractManagerTest4
{
   ...
   private void saveManagerTest() throws ParseException{
      ...
      try{
         retourManager.createOrsaveManager(r, e1, null, c, null, null, i1, u, "creation");
      ...
      retourManager.createOrsaveManager(r, e2, null, c, null, null, i1, u, "creation");
      ...
      catched = false;
      try{
         retourManager.createOrsaveManager(r, e2, null, c, null, null, i1, u, null);
      ...
      catched = false;
      try{
         retourManager.createOrsaveManager(r, e2, null, c, null, null, i1, u, "test");
   ...
   private void saveManagerTest() throws ParseException{
      ...
      //modification valide
      retourManager.createOrsaveManager(r, e2, emplacementDao.findById(2), r.getCollaborateur(), r.getCession(),
   ...
   public void testCreateRetourHugeListManager() throws ParseException{
      ...
      retourManager.createOrsaveManager(r2, echantillonDao.findById(1), null, null, null, null, null, u, "creation");
      ...
      retourManager.createOrsaveManager(last, echantillonDao.findById(1), null, null, null, null, null, u,
         "modification");
   ...
   public void testDeleteIncompleteRetour(){
      ...
      Boolean catched = false;
      try{ // EPUISE
         retourManager.createOrsaveManager(r, e3, null, c, null, null, i1, u, "creation");
      }catch(final ObjectStatutException oe){
         catched = true;
      }
      assertTrue(catched);
      retourManager.createOrsaveManager(r2, e2, null, c, null, null, i1, u, "creation");
      retourManager.createOrsaveManager(rp, p1, null, c, null, null, i1, u, "creation");
      ...
      r.setDateSortie(r1.getDateSortie());
      try{
         retourManager.createOrsaveManager(r, p1, null, c, null, null, i1, u, "creation");
   ...
   public void testFindByObjectDateRetourEmptyManager(){
      ...
      retourManager.createOrsaveManager(r1, e2, null, c, null, null, i1, u, "creation");
      ...
      retourManager.createOrsaveManager(r2, e1, null, c, null, null, null, u, "creation");
