...
public class EchantillonManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      try{
         echantillonManager.saveManager(echan1, null, null, null, null, null, type, null, null, null, null, null,
      ...
      try{
         echantillonManager.saveManager(echan1, banque, null, null, null, null, null, null, null, null, null, null,
            null, null, true, null, false);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
      ...
      try{
         echantillonManager.saveManager(echan1, banque, null, null, null, null, type, null, null, null, null, null,
            null, null, true, null, false);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
      ...
      // est lancée
      try{
         echantillonManager.saveManager(echan1, banque, null, null, statut, null, type, null, null, null, null,
      ...
      catched = false;
      try{
         echantillonManager.saveManager(echan1, banque, null, null, statut, empl, type, null, null, null, null,
            null, null, null, true, null, false);
      ...
      echantillonManager.saveManager(echan1, banque, null, null, statut, null, type, null, null, null, null, null,
      ...
      echantillonManager.saveManager(echan2, banque, prelevement, collab, statut, emp, type, null, quantite, qualite,
      ...
      echantillonManager.saveManager(echan5, banque, null, null, statut, null, type, null, null, null, null, null,
      ...
      try{
         echantillonManager.saveManager(echan6, null, null, null, null, null, type, null, null, null, null, null,
      ...
      try{
         echantillonManager.saveManager(echan8, banque, null, null, null, null, null, null, null, null, null, null,
            null, null, null, null, null, true, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catchedUpdate = true;
      ...
      try{
         echantillonManager.saveManager(echan9, banque, null, null, null, null, type, null, null, null, null, null,
            null, null, null, null, null, true, null, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catchedUpdate = true;
      ...
      catched = false;
      try{
         echantillonManager.saveManager(echan10, banque, null, null, null, empl, type, null, null, null, null, null,
      ...
      echantillonManager.saveManager(echan10, banque, null, null, null, null, type, null, null, null, null, null,
         null, null, null, null, utilisateur, false, null, null);
      ...
      echantillonManager.saveManager(echan12, banque, prelevement, collab, objetStatutManager.findByIdManager(1), emp,
   ...
   private void validationInsert(final Echantillon echantillon){
      ...
      for(int i = 0; i < emptyValues.length; i++){
         ...
         try{
            ...
            echantillonManager.saveManager(echantillon, banque, null, null, st, null, type, null, null, null, null,
      ...
      catchedInsert = false;
      try{
         echantillonManager.saveManager(echantillon, banque, null, null, null, null, type, null, null, null, null,
            null, null, utilisateur, true, null, false);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("ValidationException")){
            catchedInsert = true;
   ...
   private void validationUpdate(final Echantillon echantillon){
      ...
      for(int i = 0; i < emptyValues.length; i++){
         ...
         try{
            echantillon.setCode(emptyValues[i]);
            echantillonManager.saveManager(echantillon, banque, null, null, null, null, type, null, null, null,
   ...
   public void testCreateAndUpdateCodesAssignes(){
      ...
      boolean catchedInsert = false;
      try{
         echantillonManager.saveManager(echan1, banque, null, null, null, null, type, codes, null, null, null, null,
            null, utilisateur, true, null, false);
      ...
      //		catchedInsert = false;
      //		try {
      //			echantillonManager.saveManager(echan1, banque, 
      ...
      echantillonManager.saveManager(testInsert, banque, null, null, null, null, type, codes, codesToD, null, null,
         null, null, null, null, null, utilisateur, true, null, null);
      ...
      echantillonManager.saveManager(echan2, banque, null, null, objetStatutManager.findByIdManager(4), null, type,
      ...
      codes2.add(cLes3);
      try{
         echantillonManager.saveManager(echan2, banque, null, null, null, null, type, codes2, null, null, null,
            null, null, null, null, null, utilisateur, true, null, null);
      }catch(final RuntimeException e){
         assertTrue(e.getMessage().equals("echantillon" + ".codesAssigne.organe.exportNbIllegal"));
         catchedInsert = true;
      ...
      echantillonManager.saveManager(echan2, banque, null, null, null, null, type, codes2, null, null, null, null,
      ...
      cLes2.setOrdre(2);
      codes.add(cLes2);
      echantillonManager.saveManager(testInsert, banque, null, null, null, null, type, codes, null, null, null,
      ...
      //																.size() - 1);
      //		
      //		echantillonManager.saveManager(testInsert, banque, 
   ...
   public void testCreateUpdateEchantillonWithAnnots(){
      ...
      boolean catched = false;
      try{
         echantillonManager.saveManager(echan, b1, null, null, null, null, type, null, null, null, null, listAnnots,
            null, utilisateur, false, null, false);
      ...
      echantillonManager.saveManager(echan, b1, null, null, null, null, type, null, null, null, null, null,
   ...
   public void testCreateUpdateEchantillonCrAnapath(){
      ...
      echan.setCode("*ù$&àé");
      try{
         echantillonManager.saveWithCrAnapathManager(echan, b1, null, null, null, null, type, null, null, null, null, cr,
      ...
      cr2.setNom("cr2");
      echantillonManager.saveWithCrAnapathManager(echan, b1, null, null, null, null, type, null, null, null, null, null,
      ...
      try{
         echantillonManager.saveWithCrAnapathManager(echan, b1, null, null, null, null, type, null, null, null, null,
   ...
   public void testCreateUpdateCrAnapathForEchantillons(){
      ...
      echantillonManager.saveWithCrAnapathManager(e1, b1, null, null, statut, null, type, null, null, null, null, cr,
         bais, filesCreated, null, utilisateur, false, "/tmp/", false);

      final Fichier cr2 = cr.cloneNoId();
      echantillonManager.saveWithCrAnapathManager(e2, b1, null, null, statut, null, type, null, null, null, null, cr2,
         null, filesCreated, null, utilisateur, false, "/tmp/", false);
      Fichier cr3 = cr.cloneNoId();
      echantillonManager.saveWithCrAnapathManager(e3, b1, null, null, statut, null, type, null, null, null, null, cr3,
         null, filesCreated, null, utilisateur, false, "/tmp/", false);
      final Fichier cr4 = cr.cloneNoId();
      echantillonManager.saveWithCrAnapathManager(e4, b1, null, null, statut, null, type, null, null, null, null, cr4,
         null, filesCreated, null, utilisateur, false, "/tmp/", false);
      final Fichier cr5 = cr.cloneNoId();
      echantillonManager.saveWithCrAnapathManager(e5, b1, null, null, statut, null, type, null, null, null, null, cr5,
         null, filesCreated, null, utilisateur, false, "/tmp/", false);
      ...
      cr.setNom("cr2");
      try{
         echantillonManager.saveWithCrAnapathManager(e1, b1, null, null, null, null, type, null, null, null, null, null,
      ...
      e1.setCode("ok");
      echantillonManager.saveWithCrAnapathManager(e1, b1, null, null, null, null, type, null, null, null, null, null, cr,
      ...
      e3.setCode("&*ù*ù$");
      try{
         echantillonManager.saveWithCrAnapathManager(e3, b1, null, null, null, null, type, null, null, null, null, null,
            cr3, bais, filesCreated, filesToDelete, null, null, utilisateur, true, null, "/tmp/");
      }catch(final Exception e){
         assertTrue(fichierManager.findAllObjectsManager().size() == totFichier + 5);
         assertTrue(
      ...
      cr3 = e3.getCrAnapath();
      e3.setCode("ok2");
      echantillonManager.saveWithCrAnapathManager(e3, b1, null, null, null, null, type, null, null, null, null, null, cr3,
      ...
      // nullifying pour e4
      echantillonManager.saveWithCrAnapathManager(e4, b1, null, null, null, null, type, null, null, null, null, null,
         null, null, filesCreated, filesToDelete, null, null, utilisateur, false, null, "/tmp/");
   ...
   public void testCascadeEchantillonChildren(){
      ...
      echantillonManager.saveManager(e, b, null, null, null, null, eType, null, null, null, null, null, null,
      ...
      //insertion valide
      retourManager.createOrsaveManager(r, e, null, null, null, null, null, u, "creation");
      ...
      transformationManager.saveManager(transfo1, entite, null);
      ...
      cederObjetManager.saveManager(ced2, c, entiteDao.findByNom("ProdDerive").get(0), qteUnite);
   ...
   public void testSwitchBanque(){
      ...
      e.setCode("JEG.2");
      echantillonManager.saveManager(e, b3, null, null, null, null, echantillonTypeManager.findByIdManager(1), null, null,
      ...
      echantillonManager.saveManager(ebis, b4, null, null, null, null, echantillonTypeManager.findByIdManager(4), null,
      ...
      echantillonManager.saveManager(e, e.getBanque(), e.getPrelevement(), null, e.getObjetStatut(), null,
      ...
      final Transformation transfo1 = new Transformation();
      transfo1.setObjetId(e.getEchantillonId());
      transformationManager.saveManager(transfo1, entiteDao.findById(3), null);
      ProdDerive derive = new ProdDerive();
      derive.setCode("deriveSwitch");
      prodDeriveManager.saveManager(derive, b2, prodTypeDao.findById(1), objetStatutManager.findByIdManager(4), null,
         ...
         enceinteManager
            .getTerminalesManager(
               enceinteManager
                  ...
                  .iterator().next())
            .iterator().next();
      emplacementManager.saveManager(emp, t1, entiteDao.findById(8));
      prodDeriveManager.saveManager(derive, derive.getBanque(), derive.getProdType(), null, null, emp, null, null, null,
      ...
      emplacementManager.saveManager(emp, emp.getTerminale(), entiteDao.findById(3));
      emp = emplacementManager.findByIdManager(emp.getEmplacementId());
      emp.getTerminale().getEnceinte();
      prodDeriveManager.saveManager(derive, derive.getBanque(), derive.getProdType(), null, null, null, null, null, null,
         null, null, transfo1, null, null, null, null, u, false, null, null);
      echantillonManager.saveManager(e, e.getBanque(), null, null, null, emp, e.getEchantillonType(), null, null, null,
   ...
   public void testUpdateMultipleObjectsManager() throws ParseException, IOException{
      ...
      echantillonManager.saveWithCrAnapathManager(echan1, b1, p1, c, statut, null, eT, codes, null, eQual, prepa, cr1,
         bais1, filesCreated, null, utilisateur, false, pathFile + "/tmp/", false);
      echan2.setDelaiCgl(new Float(15));
      cOrg1.setExport(false);
      cOrg2.setExport(true);
      echantillonManager.saveWithCrAnapathManager(echan2, b1, p1, c, statut, null, eT, codes, null, eQual, prepa, cr2,
         bais2, filesCreated, null, utilisateur, false, pathFile + "/tmp/", false);
      echantillonManager.saveWithCrAnapathManager(echan3, b1, p1, c, statut, null, eT, null, null, eQual, prepa, null,
      ...
      for(int i = 0; i < listAnnots.size(); i++){
         annotationValeurManager.createOrsaveManager(listAnnots.get(i), listAnnots.get(i).getChampAnnotation(),
   ...
   public void testUpdateCodeEchantillonsManager(){
      ...
      echantillonManager.saveManager(echan2, banque, null, null, null, null, type, null, null, null, null, null,
         null, utilisateur, false, null, false);
      final Echantillon echan3 = new Echantillon();
      echan3.setCode("XTRA.3");
      echan3.setObjetStatut(objetStatutManager.findByIdManager(4));
      echantillonManager.saveManager(echan3, banque, null, null, null, null, type, null, null, null, null, null,
         null, utilisateur, false, null, false);
   ...
   public void testSaveEchantillonEmplacementManager(){
      ...
      final Echantillon echan1 = new Echantillon();
      echan1.setCode("XTRA.1");
      echantillonManager.saveManager(echan1, banque, null, null, objetStatutManager.findByIdManager(4), null, type, null,
   ...
   public void testCreateUpdateWithNonConformites(){
      ...
      echantillonManager.saveWithNonConformitesManager(e0, b1, null, null, objetStatutManager.findByIdManager(4), null,
      ...
      echantillonManager.saveWithNonConformitesManager(e1, banqueDao.findById(1), null, null,
      ...
      echantillonManager.saveWithNonConformitesManager(e2, banqueDao.findById(1), null, null,
         objetStatutManager.findByIdManager(4), null, echantillonTypeManager.findByIdManager(1), null, null, null, null,
   ...
   public void testRemoveListFromIds() throws ParseException{
      ...
      ech1.setCode("ECH1");
      echantillonManager.saveWithCrAnapathManager(ech1, b2, null, null, objetStatutManager.findByIdManager(1), null, et1,
      ...
      ech2.setCode("ECH2");
      echantillonManager.saveManager(ech2, b2, null, null, objetStatutManager.findByIdManager(1), null, et1, null, null,
         null, null, null, filesCreated, u2, false, null, false);
      final Echantillon ech3 = new Echantillon();
      ech3.setCode("ECH3");
      echantillonManager.saveManager(ech3, b2, null, null, objetStatutManager.findByIdManager(1), null, et1, null, null,
         null, null, null, filesCreated, u2, false, null, false);
