...
public class SModeleManagerTest extends AbstractManagerTest4
{
   ...
   public void testFindAllObjectsManager(){
      final List<SModele> ims = IterableUtils.toList(modeleDao.findAll());
   ...
   public void testValidateObject(){
      ...
      // nom empty
      try{
         sModeleManager.saveManager(modele, pf2, null, null);
   ...
   public void testCrud(){
      ...
      try{
         sModeleManager.saveManager(sM1, null, null, null);
      ...
      sM1.setNom("MOD1");
      try{
         sModeleManager.saveManager(sM1, pf1, null, null);
      }catch(final Exception e){
      ...
      sM1.setNom("MyModele");
      sModeleManager.saveManager(sM1, pf1, new ArrayList<Indicateur>(), null);
      ...
      sModeleManager.saveManager(sM2, pf1, indicateurs, banques);
      assertTrue(sModeleManager.findAllObjectsManager().size() == sModeleTotCount + 1);
      assertTrue(IterableUtils.toList(sModeleIndicateurDao.findAll()).size() == sMIndicTotCount + 2);
      ...
      sM2 = sModeleManager.saveManager(sM2, pf1, indicateurs, banques);
      assertTrue(sModeleManager.findAllObjectsManager().size() == sModeleTotCount + 1);
      assertTrue(IterableUtils.toList(sModeleIndicateurDao.findAll()).size() == sMIndicTotCount + 1);
      ...
      sM2 = sModeleManager.saveManager(sM2, pf1, indicateurs, banques);
      assertTrue(sModeleManager.findAllObjectsManager().size() == sModeleTotCount + 1);
      assertTrue(IterableUtils.toList(sModeleIndicateurDao.findAll()).size() == sMIndicTotCount + 5);
