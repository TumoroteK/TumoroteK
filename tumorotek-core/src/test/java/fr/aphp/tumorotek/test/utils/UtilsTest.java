...
public class UtilsTest
{
   ...
   public void testCreateListChars(){
      List<String> res = Utils.createListChars(2, null, new ArrayList<String>());
      assertTrue(res.size() == 2);
      assertTrue(res.get(res.size() - 1).equals("B"));

      res = Utils.createListChars(26, null, new ArrayList<String>());
      assertTrue(res.size() == 26);
      assertTrue(res.get(res.size() - 1).equals("Z"));

      res = Utils.createListChars(27, null, new ArrayList<String>());
      assertTrue(res.size() == 27);
      assertTrue(res.get(res.size() - 1).equals("AA"));

      res = Utils.createListChars(55, null, new ArrayList<String>());
      assertTrue(res.size() == 55);

      res = Utils.createListChars(235, null, new ArrayList<String>());
   ...
   public void testFormateString(){
      ...
      assertTrue(Utils.formateString("VENTADOUR_PIERRE", "[10,15]").equals("_PIERR"));
      assertTrue(Utils.formateString("PTRA.1", "[8,10]").equals(""));
      assertTrue(Utils.formateString("PTRA.1", "[2,10]").equals("TRA.1"));
   ...
   public void testExtractAssosPlateformesEmetteurs(){
      ...
      Hashtable<Integer, List<Integer>> res = Utils.extractAssosPlateformesEmetteursRecepteurs(value);
