...
public class TableAnnotationTemplateManagerTest extends AbstractManagerTest4
{
   ...
   public void testCrud(){
      ...
      // on test l'insertion avec la tableannotation null
      try{
         tableAnnotationTemplateManager.saveManager(tat1, t1, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // on test l'insertion avec le template null
      try{
         tableAnnotationTemplateManager.saveManager(tat1, null, ta2);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // est lancée
      try{
         tableAnnotationTemplateManager.saveManager(tat1, t1, ta2);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      tableAnnotationTemplateManager.saveManager(tat1, t1, ta3);
      ...
      // MAJ
      try{
         tableAnnotationTemplateManager.saveManager(tatTest, t1, null);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         tableAnnotationTemplateManager.saveManager(tatTest, null, ta2);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      // Maj valide
      tatTest.setOrdre(10);
      tableAnnotationTemplateManager.saveManager(tatTest, t1, ta3);
      assertTrue(tableAnnotationTemplateManager.findAllObjectsManager().size() == 2);
