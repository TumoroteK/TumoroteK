...
public class ContratManagerTest extends AbstractManagerTest4
{
   ...
   private void saveManagerTest() throws ParseException{
      ...
      try{
         contratManager.saveManager(contrat1, null, null, null, null, null, u);
      ...
      try{
         contratManager.saveManager(contrat1, null, null, null, null, pf1, u);
      }catch(final Exception e){
      ...
      contratManager.saveManager(contrat2, collab, serv, etab, type, pf1, u);
   ...
   private void saveManagerTest() throws ParseException{
      ...
      contratManager.saveManager(contrat, null, null, null, null, pf1, u);
      assertTrue(contratManager.findAllObjectsManager().size() == 5);
      ...
      try{
         contratManager.saveManager(contrat2, null, null, null, null, null, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("RequiredObjectIsNullException")){
            catched = true;
         }
      ...
      try{
         contratManager.saveManager(contrat2, null, null, null, null, pf1, u);
      }catch(final Exception e){
         if(e.getClass().getSimpleName().equals("DoublonFoundException")){
            catched = true;
         }
      ...
      contratManager.saveManager(contrat3, collab, serv, etab, type, pf1, u);
      assertTrue(contratManager.findAllObjectsManager().size() == 5);
   ...
   private void validationInsert(final Contrat contrat) throws ParseException{
      ...
      for(int i = 0; i < emptyValues.length; i++){
         ...
         try{
            ...
            contratManager.saveManager(contrat, null, null, null, null, pf, u);
         }catch(final Exception e){
