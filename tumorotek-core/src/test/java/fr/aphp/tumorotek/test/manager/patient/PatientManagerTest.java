 ...
 * accepté les termes.
 **/
package fr.aphp.tumorotek.test.manager.patient;
...
public class PatientManagerTest extends AbstractManagerTest4
{
	...
	private void saveManagerTest() throws ParseException{
		...
		//insertion
		patientManager.createOrsaveManager(p, maladies, colls, liens, null, null, null, null, u, "creation", "/tmp/",
				false);
		...
		try{
			patientManager.createOrsaveManager(p2, null, null, null, null, null, null, null, u, "creation", "/tmp/", false);
				...
				for(int z = 0; z < dates.length; z++){
					...
					try{
						if((x == 0 || y == 0 || z == 0) || (x == 2 && (y == 1 || z == 1))){ //valide
							patientManager.createOrsaveManager(p2, null, null, null, null, null, null, null, null, "creation",
									null, false);
						}
					}catch(final Exception e){
		...
		p2.setPatientEtat("V");
		try{
			patientManager.createOrsaveManager(p2, null, null, null, null, null, null, null, null, "creation", null, false);
		}catch(final Exception e){
			assertTrue(e.getClass().getSimpleName().equals("ValidationException"));
		}
		...
		try{
			patientManager.createOrsaveManager(p2, null, null, null, null, null, null, null, u, null, null, false);
		}catch(final NullPointerException ne){
			assertTrue(true);
		}
		try{
			patientManager.createOrsaveManager(p2, null, null, null, null, null, null, null, u, "dummy", null, false);
	...
	private void validationTest(final Patient p2, final String nip, final String nom, final String nomNais, final String prenom,
		...
		try{
			if(!isValide){ //car creation valide
				patientManager.createOrsaveManager(p2, null, null, null, null, null, null, null, null, "creation", null,
						false);
			}
		}catch(final Exception e){
			assertTrue(e.getClass().getSimpleName().equals("ValidationException"));
	...
	private void saveManagerTest() throws ParseException{
		...
		final Utilisateur u = utilisateurDao.findById(2);
		patientManager.createOrsaveManager(p, maladies, colls, liens, null, null, null, null, u, "modification", null,
				false);
		...
		patientManager.createOrsaveManager(p, null, null, null, null, null, null, null, u, "modification", null, false);
		assertTrue(maladieManager.getMaladiesManager(p).size() == 2);
		assertTrue((patientManager.getPatientMedecinsManager(p)).size() == 2);
		assertTrue((patientManager.getPatientLiensManager(p)).size() == 2);
		patientManager.createOrsaveManager(p, new ArrayList<Maladie>(), new ArrayList<Collaborateur>(),
	...
	public void testUpdateMultipleObjectsManager() throws ParseException{
		...
		for(int i = 0; i < patients.size(); i++){
			patientManager.createOrsaveManager(patients.get(i), null, null, null, null, null, null, null, utilisateur,
					"creation", null, false);
			annotationValeurManager.createOrsaveManager(listAnnots.get(i), null, patients.get(i), b1, null, utilisateur,
	...
	public void testCreateUpdatePatientWithAnnots() throws ParseException{
		...
		boolean catched = false;
		try{
			patientManager.createOrsaveManager(pat, null, null, null, listAnnots, listDelete, null, null, utilisateur,
					"creation", null, false);
	...
	public void testFusionPatientManager() throws ParseException{
		...
		patientManager.createOrsaveManager(p1, maladies1, colls1, liens1, listAnnots, null, null, null, u, "creation",
				"/tmp/", false);
		...
		prel1.setCode("prel1");
		prelevementManager.saveManager(prel1, banqueManager.findByIdManager(1), natureDao.findById(1), malsP1.get(0),
		...
		prel2.setCode("prel2");
		prelevementManager.saveManager(prel2, banqueManager.findByIdManager(1), natureDao.findById(1), malsP1.get(1),
				consentTypeDao.findById(1), null, null, null, null, null, null, null, null, null, null, null, u, false, null, false);
		...
		patientManager.createOrsaveManager(p2, maladies2, colls2, liens2, listAnnots, null, null, null, u, "creation",
				"/tmp/", false);

		final List<Maladie> malsP2 = new ArrayList<>(maladieManager.getMaladiesManager(p2));
		final Prelevement prel3 = new Prelevement();
		prel3.setCode("prel3");
		prelevementManager.saveManager(prel3, banqueManager.findByIdManager(1), natureDao.findById(1), malsP2.get(0),
				consentTypeDao.findById(1), null, null, null, null, null, null, null, null, null, null, null, u, false, null, false);
		final Prelevement prel4 = new Prelevement();
		prel4.setCode("prel4");
		prelevementManager.saveManager(prel4, banqueManager.findByIdManager(1), natureDao.findById(1), malsP2.get(1),
				consentTypeDao.findById(1), null, null, null, null, null, null, null, null, null, null, null, u, false, null, false);
	...
	public void testRemoveListFromIds() throws ParseException{
		...
		patientManager.createOrsaveManager(p1, null, null, null, null, null, null, null, u2, "creation", "/tmp/", false);
		...
		patientManager.createOrsaveManager(p2, null, null, null, null, null, null, null, u2, "creation", "/tmp/", false);
		...
		patientManager.createOrsaveManager(p3, null, null, null, null, null, null, null, u2, "creation", "/tmp/", false);
