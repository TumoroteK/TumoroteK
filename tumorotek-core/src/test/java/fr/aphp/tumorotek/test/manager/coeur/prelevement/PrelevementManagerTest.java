...
public class PrelevementManagerTest extends AbstractManagerTest4
{
   ...
   private void saveManagerTest() throws ParseException{
      ...
      // insertion
      prelevementManager.saveManager(p, b, n, m, ct, preleveur, s, ptype, cType, milieu, t, op, qU, labos, null, null, u,
         true, "/tmp/", false);
      ...
      try{
         prelevementManager.saveManager(p2, b, n, m, ct, null, null, null, null, null, null, null, null, null, null, null,
            null, true, "/tmp/", false);
   ...
   private void saveManagerTest() throws ParseException{
      ...
      // Modif
      prelevementManager.saveManager(p, null, null, null, null, null, null, null, null, null, null, null, null, labos,
      ...
      try{
         p.setCode("PRLVT1");
         p.setConditNbr(10);
         prelevementManager.saveManager(p, b, null, null, null, null, null, null, null, null, null, null, null, null,
   ...
   public void testValidation(){
      ...
      try{
         prelevementManager.saveManager(p, banques[0], natures[1], m, cTypes[1], preleveur, s, ptype, cType, milieu, t,
            op, qU, null, null, null, u, true, "/tmp/", false);
      }catch(final RequiredObjectIsNullException e){
         assertTrue(e.getMessage().contains("Banque"));
      }
      try{
         prelevementManager.saveManager(p, banques[1], natures[0], m, cTypes[1], preleveur, s, ptype, cType, milieu, t,
            op, qU, null, null, null, u, true, "/tmp/", false);
      }catch(final RequiredObjectIsNullException e){
         assertTrue(e.getMessage().contains("Nature"));
      }
      try{
         prelevementManager.saveManager(p, banques[1], natures[1], m, cTypes[0], preleveur, s, ptype, cType, milieu, t,
            op, qU, null, null, null, u, true, "/tmp/", false);
      }catch(final RequiredObjectIsNullException e){
      ...
      for(int i = 0; i < codes.length; i++){
         try{
            p.setCode(codes[i]);
            prelevementManager.saveManager(p, banques[1], natures[1], m, cTypes[1], preleveur, s, ptype, cType, milieu, t,
               op, qU, null, null, null, u, true, "/tmp/", false);
   ...
   public void testCreateMaladieAndPrelevement() throws ParseException{
      ...
      m.setLibelle("");
      try{
         prelevementManager.saveManager(p, b, n, m, ct, null, null, null, null, null, null, null, null, null, null, null,
            u, true, "/tmp/", false);
      }catch(final Exception e){
      ...
      p.setCode("AvecMaladie");
      prelevementManager.saveManager(p, b, n, m, ct, null, null, null, null, null, null, null, null, null, null, null, u,
         true, "/tmp/", false);
   ...
   public void testCreateUpdatePrelevementWithAnnots(){
      ...
      boolean catched = false;
      try{
         prelevementManager.saveManager(prel, b1, n, null, ct, null, null, null, null, null, null, null, null, labos,
      ...
      prelevementManager.saveManager(prel, null, null, null, null, null, null, null, null, null, null, null, null, null,
   ...
   public void testCascadePrelevementChildren(){
      ...
      cederObjetManager.saveManager(ced3, c, entiteDao.findByNom("Echantillon").get(0), qteUnite);
   ...
   public void testSimpleSwitchBanque(){
      ...
      prelevementManager.saveManager(p, b3, natureDao.findById(1), null, consentTypeDao.findById(1), null, null, null,
      ...
      echantillonManager.saveManager(e, b2, p, null, objetStatutDao.findById(4), null,
         echantillonTypeManager.findByIdManager(1), null, null, null, null, null, null, u, false, "/tmp/", false);
      final Transformation transfo1 = new Transformation();
      transfo1.setObjetId(p.getPrelevementId());
      transformationManager.saveManager(transfo1, entiteDao.findById(2), null);
      ProdDerive derive = new ProdDerive();
      derive.setCode("deriveSwitch");
      prodDeriveManager.saveManager(derive, b2, prodTypeDao.findById(1), objetStatutDao.findById(4), null, null, null,
      ...
      cederObjetManager.saveManager(ced1, cession, entiteDao.findById(8), null);
      boolean catched = false;
      try{
      ...
      emp2.setPosition(56);
      emplacementManager.saveManager(emp2, t1, null);

      // emp.setObjetId(e.getEchantillonId());
      // emplacementManager.saveManager(emp, emp.getTerminale(),
      //		entiteDao.findById(3));
      // emp = emplacementManager.findByIdManager(emp.getEmplacementId());
      // emp.getTerminale().getEnceinte();
      echantillonManager.saveManager(e, e.getBanque(), e.getPrelevement(), null, null, emp2, e.getEchantillonType(), null,
      ...
      // listAnnots.add(text);
      // patientManager.createOrsaveManager(pat, mals, null, null,
      ...
      // prelevementManager.saveManager(p2, b1, natureDao.findById(1),
   ...
   public void testMultipleSwitchBanque(){
      ...
      p1.setCode("p1");
      prelevementManager.saveManager(p1, b1, n1, null, c1, null, null, null, null, null, null, null, null, null, null,
         null, u, false, "/tmp/", false);

      final Prelevement p2 = new Prelevement();
      p2.setCode("p2");
      prelevementManager.saveManager(p2, b1, n1, null, c1, null, null, null, null, null, null, null, null, null, null,
         null, u, false, "/tmp/", false);
      ...
      p1bis.setCode("p1");
      prelevementManager.saveManager(p1bis, b4pf2, n1, null, c1, null, null, null, null, null, null, null, null, null,
   ...
   public void testUpdateMultipleObjectsManager() throws ParseException{
      ...
      for(int i = 0; i < prels.size(); i++){
         if(!prels.get(i).getCode().equals("p1")){
            prelevementManager.saveManager(prels.get(i), b1, n, null, ct, preleveur, s, ptype, cType, milieu, t,
         ...
         annotationValeurManager.createOrsaveManager(listAnnots.get(i), null, prels.get(i), b1, null, utilisateur,
   ...
   public void testCreateUpdateWithNonConformites(){
      ...
      prelevementManager.saveWithNonConformitesManager(prel1, banqueDao.findById(1), n, null, ct, null, null, null, null,
   ...
   public void testRemoveListFromIds() throws ParseException{
      ...
      final Prelevement p1 = new Prelevement();
      p1.setCode("PD1");
      prelevementManager.saveManager(p1, b2, n1, null, ct1, null, null, null, null, null, null, null, null, null, null,
         null, u2, false, "/tmp/", false);
      final Prelevement p2 = new Prelevement();
      p2.setCode("PD2");
      prelevementManager.saveManager(p2, b2, n1, null, ct1, null, null, null, null, null, null, null, null, null, null,
         null, u2, false, "/tmp/", false);
      final Prelevement p3 = new Prelevement();
      p3.setCode("PD3");
      prelevementManager.saveManager(p3, b2, n1, null, ct1, null, null, null, null, null, null, null, null, null, null,
         null, u2, false, "/tmp/", false);
