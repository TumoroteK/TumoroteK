...
public class AnnotationValeurManagerTest extends AbstractManagerTest4
{
   ...
   public void saveManagerTest(){
      ...
      //insertion
      try{
         annotationValeurManager.createOrsaveManager(valeur, null, null, null, null, u, null, null, filesCreated,
            filesToDelete);
      }catch(final NullPointerException ne){
         assertTrue(ne.getMessage().equals("operation cannot be " + "set to null for createorUpdateMethod"));
      }
      try{
         annotationValeurManager.createOrsaveManager(valeur, null, null, null, null, u, "op", null, filesCreated,
            filesToDelete);
      }catch(final RequiredObjectIsNullException re){
         assertTrue(re.getRequiredObject().equals("ChampAnnotation"));
      }
      try{
         annotationValeurManager.createOrsaveManager(valeur, c, null, null, null, u, "op", null, filesCreated,
            filesToDelete);
      }catch(final RequiredObjectIsNullException re){
         assertTrue(re.getRequiredObject().equals("TKAnnotableObject"));
      }
      try{
         annotationValeurManager.createOrsaveManager(valeur, c, pat, null, null, u, "op", null, filesCreated,
            filesToDelete);
      }catch(final RequiredObjectIsNullException re){
         assertTrue(re.getRequiredObject().equals("Banque"));
      }
      try{
         annotationValeurManager.createOrsaveManager(valeur, c, pat, b, null, u, "op", null, filesCreated, filesToDelete);
      }catch(final RuntimeException rte){
         assertTrue(true);
      }
      valeur.setAlphanum("loos#¤¤");
      try{
         annotationValeurManager.createOrsaveManager(valeur, c, prel, b, null, u, "creation", null, filesCreated,
            filesToDelete);
      ...
      try{
         annotationValeurManager.createOrsaveManager(valeur, c, prel, b, null, u, "op", null, filesCreated,
            filesToDelete);
      }catch(final IllegalArgumentException ie){
         assertTrue(ie.getMessage().equals("Operation must match " + "'creation/modification' values"));
      }
      annotationValeurManager.createOrsaveManager(valeur, c, prel, b, null, u, "creation", "/tmp/", filesCreated,
         filesToDelete);
      ...
      try{
         annotationValeurManager.createOrsaveManager(v2, c, prel, b, null, u, "creation", "/tmp/", filesCreated,
            filesToDelete);
   ...
   public void saveManagerTest(){
      ...
      annotationValeurManager.createOrsaveManager(valeur, null, null, null, null, u, "modification", "/tmp/",
   ...
   public void testRemoveValeurWithBanqueRelation(){
      ...
      banks.add(b2);
      final Utilisateur u = utilisateurDao.findById(2);
      tableAnnotationManager.createOrsaveManager(t1, null, null, null, banks, null, u, "modification", "/tmp/", null);
      ...
      annotationValeurManager.createOrsaveManager(p1alpha, alpha, p1, b2, null, u, "creation", "/tmp/", filesCreated,
         filesToDelete);

      final AnnotationValeur p2alpha = new AnnotationValeur();
      p2alpha.setAlphanum("p2lapha");
      annotationValeurManager.createOrsaveManager(p2alpha, alpha, p2, b2, null, u, "creation", "/tmp/", filesCreated,
         filesToDelete);

      final AnnotationValeur p1file1 = new AnnotationValeur();
      p1file1.setAlphanum("p1file1");
      annotationValeurManager.createOrsaveManager(p1file1, file1, p1, b2, null, u, "creation", "/tmp/", filesCreated,
         filesToDelete);
      assertTrue(filesCreated.isEmpty());

      final AnnotationValeur p2file1 = new AnnotationValeur();
      p2file1.setAlphanum("p2file1");
      annotationValeurManager.createOrsaveManager(p2file1, file1, p2, b2, null, u, "creation", "/tmp/", filesCreated,
         filesToDelete);
      assertTrue(filesCreated.isEmpty());
   ...
   public void testStoreFileAnno(){
      ...
      boolean catched = false;
      try{
         annotationValeurManager.createOrsaveManager(valeur, c, pat, b, f, u, "creation", "/tmp/", filesCreated,
            filesToDelete);
      ...
      catched = false;
      try{
         annotationValeurManager.createOrsaveManager(valeur, c, pat, b, f, u, "creation", "rm *", filesCreated,
            filesToDelete);
      ...
      annotationValeurManager.createOrsaveManager(valeur, c, pat, b, f, u, "modification", "/tmp/", filesCreated,
         filesToDelete);
