...
public class ComponentBarcodeLabel extends Component {
     ...
     */
	public ComponentBarcodeLabel(Vector d, String e, int ab, int or) {
		data = d;
		nomEtablissement = e;
		abscisse = ab;
		ordonnee = or;
...
// On double la taille du code barres
	public void paint(Graphics g, Vector aData, int x0, int y0) {
		...
		Font font1 = new Font("Times New Roman", Font.BOLD, 4);
		Font font2 = new Font("Times New Roman", Font.BOLD, 6);
		Font font3 = new Font("Times New Roman", Font.BOLD, 8);

		String titreParam1 = "Prel: ";
		String titreParam2 = "Tube: ";
		String titreParam3 = "Type: ";
		String titreParam4 = "Patient: ";
		String titreParam5 = "Date Cong: ";
		String titreParam6 = "Quantite: ";


		String param1 = (String) aData.get(0);
		String param2 = (String) aData.get(1);
		String param3 = (String) aData.get(2);
		String param4 = (String) aData.get(3);
		String param5 = (String) aData.get(4);
		String param6 = (String) aData.get(5);
		...
		if (barcode1 == null) {
			imageBarcode1 = new BufferedImage(
					1, 56, BufferedImage.TYPE_BYTE_GRAY);
		} else {
			try {
		...
		if (barcode2 == null) {
			imageBarcode2 = new BufferedImage(
					1, 56, BufferedImage.TYPE_BYTE_GRAY);
		} else {
			try {
		...
		// height1 = 56/4 = 14
		int height1 = imageBarcode1.getHeight(this) / d; 
		int width1 = imageBarcode1.getWidth(this) / d;

		int height2 = imageBarcode2.getHeight(this) / d;
		int width2 = imageBarcode2.getWidth(this) / d;
