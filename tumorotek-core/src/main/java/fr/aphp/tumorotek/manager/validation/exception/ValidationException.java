 ...
 * accepté les termes.
 **/
package fr.aphp.tumorotek.manager.validation.exception;
...
/**
 * Exception lancee lors de l'echec de la validation par AOP.
 * Date: 06/10/2009
 *
 * @author jbriscoe
...
public class ValidationException extends TKException
{
   ...
   public void setErrors(final List<Errors> errs){
      this.errors = errs;
   }
}
