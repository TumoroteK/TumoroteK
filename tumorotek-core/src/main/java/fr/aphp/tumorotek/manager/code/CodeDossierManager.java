...
public interface CodeDossierManager {
	 ...
	 */
	List<CodeDossier> findByNomLikeManager(String nom, boolean exactMatch, 
																Banque bank);
	 ...
	 * @return une liste de codeDossiers.
	 */
	List<CodeDossier> findByRootCodeDossierSelectManager(Utilisateur u, 
																Banque bank);
	 ...
	 */
	List<CodeDossier> 
		findBySelectUtilisateurAndBanqueManager(Utilisateur u, Banque b);
	 ...
	 */
	void createOrUpdateManager(CodeDossier dos, CodeDossier parent, 
	 ...
	 */
	List<CodeDossier> findByRootDossierBanqueManager(Banque bank, 
														Boolean select);
}
