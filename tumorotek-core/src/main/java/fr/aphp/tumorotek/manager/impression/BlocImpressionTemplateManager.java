...
public interface BlocImpressionTemplateManager {
	 ...
	 * @return Liste de BlocImpressionTemplates.
	 */
	List<BlocImpressionTemplate> findByExcludedPKManager(
	 ...
	 * @param blocImpression BlocImpression du BlocImpressionTemplate.
	 */
	void createObjectManager(BlocImpressionTemplate blocImpressionTemplate, 
			Template template,
			BlocImpression blocImpression);
	 ...
	 * @param blocImpression BlocImpression du BlocImpressionTemplate.
	 */
	void updateObjectManager(BlocImpressionTemplate blocImpressionTemplate, 
			Template template,
			BlocImpression blocImpression);
