...
public interface ContratManager {
	 ...
	 * @return Liste de Contrats.
	 */
	List<Contrat> findAllObjectsByPlateformeManager(
	 ...
	 */
	void createObjectManager(Contrat contrat, Collaborateur collaborateur, 
	 ...
	 * @param plateforme Plateforme du contrat.
	 */
	void updateObjectManager(Contrat contrat, Collaborateur collaborateur, 
			Service service, Etablissement etablissement,
			ProtocoleType protocoleType,
			Plateforme plateforme, Utilisateur utilisateur); 
	 ...
	 */
	void removeObjectManager(Contrat contrat, String comments, 
														Utilisateur usr);
