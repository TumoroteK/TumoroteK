 ...
 *
 */
public class MaladieGatsbiValidator extends RequiredValueValidator
{
   
   public MaladieGatsbiValidator(final String _e, final List<Integer> _f){
      super(_e, _f);
   }
   ...
   protected void initChpIdNameMap(){
      // chpIdNameMap.put(17, "libelle");
      chpIdNameMap.put(18, "code"); 
      chpIdNameMap.put(19, "dateDiagnostic");
      // cchpIdNameMap.put(20, "dateDebut");
      // chpIdNameMap.put(250, "collaborateurs");
   }
