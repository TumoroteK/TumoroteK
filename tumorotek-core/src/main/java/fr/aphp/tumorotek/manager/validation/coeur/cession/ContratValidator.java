...
public class ContratValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		Contrat contrat = (Contrat) target; 	

		//numero non null
		ValidationUtils
			.rejectIfEmptyOrWhitespace(errors, "numero", 
											"contrat.numero.empty");
		//numero valide
	 ...
	 * @return Errors
	 */
	public static Errors checkDemandeDateCoherence(Contrat contrat) {		
		
		BindException errs = new BindException(contrat, 
					"fr.aphp.tumorotek.model.cession.Contrat");
		
		if (contrat.getDateDemandeCession() != null) {
			if (contrat.getDateValidation() != null) {
				ValidationUtilities
					.checkWithDate(contrat.getDateDemandeCession(), 
							"dateDemandeCession", 
							contrat.getDateValidation(), "date", 
							"validation", "DateValidation", errs, true);
			} else if (contrat.getDateDemandeRedaction() != null) {
				ValidationUtilities
					.checkWithDate(contrat.getDateDemandeCession(), 
							"dateDemandeCession", 
							contrat.getDateDemandeRedaction(), 
							"date", "validation",
							"DateDemandeRedaction", errs, true);
	 ...
	 * @return Errors
	 */
	public static Errors checkDateValidation(Contrat contrat) {		
		...
		if (contrat.getDateValidation() != null) {
			...
			if (contrat.getDateDemandeCession() != null) {
				ValidationUtilities
					.checkWithDate(contrat.getDateValidation(), 
							"dateValidation", 
							contrat.getDateDemandeCession(), "date", 
							"validation", "DemandeCession", errs, false);
			}
		}
		return errs;
	}
	 ...
	 * @return Errors
	 */
	public static Errors checkDateDemandeRedaction(Contrat contrat) {		
		...
		if (contrat.getDateDemandeRedaction() != null) {
			...
			if (contrat.getDateDemandeCession() != null) {
				ValidationUtilities
				.checkWithDate(contrat.getDateDemandeRedaction(), 
						"dateDemandeRedaction", 
						contrat.getDateDemandeCession(), "date", 
						"validation", "DemandeCession", errs, false);
			}
	 ...
	 * @return Errors
	 */
	public static Errors checkDateEnvoiContrat(Contrat contrat) {		
		...
		if (contrat.getDateEnvoiContrat() != null) {
			...
			if (contrat.getDateDemandeRedaction() != null) {
				ValidationUtilities
					.checkWithDate(contrat.getDateEnvoiContrat(), 
							"dateEnvoiContrat", 
							contrat.getDateDemandeRedaction(), "date", 
							"validation", "DateDemandeRedaction", 
							errs, false);
	 ...
	 * @return Errors
	 */
	public static Errors checkDateSignature(Contrat contrat) {		
		...
		if (contrat.getDateSignature() != null) {
			...
			if (contrat.getDateEnvoiContrat() != null) {
				ValidationUtilities
					.checkWithDate(contrat.getDateSignature(), 
							"dateSignature", 
							contrat.getDateEnvoiContrat(), "date", 
							"validation", "DateEnvoiContrat", 
							errs, false);
			} else if (contrat.getDateDemandeRedaction() != null) {
				ValidationUtilities
					.checkWithDate(contrat.getDateSignature(), 
