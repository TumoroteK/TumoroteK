...
public interface IncaComplementExport {
	 ...
	 * @return "0", "N" 
	 */
	String getDonneesClinBase(Connection con, Patient patient, 
																Banque bank);
	 ...
	 * @return "O", "N" ou ""
	 */
	String getInclusionTherap(Connection con, Patient patient, 
															Banque bank);
	 ...
	 */
	String getNomProtocoleTherap(Connection con, Patient patient, 
															Banque bank);
	 ...
	 * @return "O", "N" ou ""
	 */
	String getCaryotype(Connection con, Patient patient, 
														Banque bank);
	 ...
	 */
	String getAnomalieCaryo(Connection con, Patient patient, 
														Banque bank);
	 ...
	 * @return "O", "N" ou ""
	 */
	String getAnomalieGenomique(Connection con, Patient patient, 
														Banque bank);
	 ...
	 */
	String getAnomalieGenomiqueDescr(Connection con, Patient patient, 
			Banque bank);
	 ...
	 * @return "O", "N" ou ""
	 */
	String getInclusionProtocoleRech(Connection con, 
