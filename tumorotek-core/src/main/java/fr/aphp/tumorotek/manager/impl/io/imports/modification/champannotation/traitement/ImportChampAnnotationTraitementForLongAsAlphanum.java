 ...
 * mais au format d'un entier
 * 
 * @since 2.3.1.0 (TK-538)
 * @author chuet
 *
 */
public class ImportChampAnnotationTraitementForLongAsAlphanum extends ImportChampAnnotationTraitementForAlphanum
{
   private final Logger log = LoggerFactory.getLogger(ImportChampAnnotationTraitementForLongAsAlphanum.class);
   
   public ImportChampAnnotationTraitementForLongAsAlphanum(Integer champAnnotationId, int indexColonne, ImportColonne importColonne) {
      super(champAnnotationId, indexColonne, importColonne);
      //surcharge du reader du parent : 
      setImportChampAnnotationReader(ImportChampAnnotationReaderFactory.getLongReader());
   }
   ...
   protected Object convertCellContent(Object cellContent) throws AbstractImportCellScopeException {
      return String.valueOf((Long)cellContent);
   }
}
