...
public interface CouleurEntiteTypeManager {
	 ...
	 * @return Liste de CouleurEntiteType.
	 */
	List<CouleurEntiteType> findAllCouleursForEchanTypeByBanqueManager(
			Banque banque);
	 ...
	 * @return Liste de CouleurEntiteType.
	 */
	List<CouleurEntiteType> findAllCouleursForProdTypeByBanqueManager(
			Banque banque);
	 ...
	 */
	void createObjectManager(CouleurEntiteType couleurEntiteType, 
			Couleur couleur, Banque banque,
			EchantillonType echantillonType,
			ProdType prodType);
	 ...
	 */
	void updateObjectManager(CouleurEntiteType couleurEntiteType, 
			Couleur couleur, Banque banque,
			EchantillonType echantillonType,
			ProdType prodType);
