...
public interface ExtractValueFromChampManager
{
    ...
    */
   String extractValueForChampManager(Echantillon echantillon, Champ champ);
    ...
    * @return Valeur extraite du champ.
    */
   String extractValueForChampManager(ProdDerive prodDerive, Champ champ);
