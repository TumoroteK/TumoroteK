...
public interface PrelevementManager {
	 ...
	 * dans le file system
	 */
	void createObjectManager(Prelevement prelevement,
								Banque banque,
								Nature nature,
								Maladie maladie,
								ConsentType consentType,
								Collaborateur preleveur,
								Service servicePreleveur,
								PrelevementType prelevementType,
								ConditType conditType,
								ConditMilieu conditMilieu,
	 ...
	 */
	void updateObjectManager(Prelevement prelevement,
								Banque banque,
								Nature nature,
								Maladie maladie,
								ConsentType consentType,
	 ...
	 */
	void removeObjectManager(Prelevement prelevement, String comments, 
	 ...
	 * @param liste des fichiers à supprimer après transaction
	 */
	void removeObjectCascadeManager(Prelevement prelevement, String comments, 
	 ...
	 * @return Liste de Prelevement.
	 */
	List<Prelevement> findByCodeOrNumLaboLikeWithBanqueManager(
	 ...
	 * @return Liste de Prelevement.
	 */
	List<Integer> findByCodeOrNumLaboLikeBothSideWithBanqueReturnIdsManager(
	 ...
	 * @return Liste de Prelevement.
	 */
	List<Prelevement> findAfterDatePrelevementWithBanqueManager(
	 ...
	 * @return Liste de Prelevement.
	 */
	List<Integer> findAfterDateCreationReturnIdsManager(Calendar date, 
														List<Banque> banques);
	 ...
	 * @return Liste de Prelevement.
	 */
	List<Prelevement> findAfterDateModificationManager(
	 ...
	 * @return Liste de Prelevement.
	 */
	List<Prelevement> findByMaladieLibelleLikeManager(String libelle, 
														boolean exactMatch);
	 ...
	 */
	List<Prelevement> 
			findLastCreationManager(List<Banque> banques, int nbResults);
	 ...
	 * @return
	 */
	List<LaboInter> cascadeNonSterileManager(Prelevement prelevement,
	 ...
	 * @return une liste de prelevements.
	 */
	List<Prelevement> findByMaladieAndOtherBanquesManager(Maladie mal, 
																Banque bank);
	 ...
	 */
	List<Integer> findByCodeOrNumLaboInListManager(
	 ...
	 * dans le file system
	 */
	void createPrelAndEchansManager(Prelevement prelevement,
											List<AnnotationValeur> annosPrel,
											List<Echantillon> echantillons,
											List<AnnotationValeur> annosEchan,
											Banque banque,
											Utilisateur utilisateur,
	...
	public void switchBanqueMultiplePrelevementManager(Prelevement[] prlvts, Banque bank, 
	 ...
	 * @param utilisateur
	 */
	void switchMaladieManager(Prelevement prel, Maladie maladie, 
			Utilisateur usr);
	 ...
	 * dans le file system
	 */
	void updateMultipleObjectsManager(List<Prelevement> prelevements,
			List<Prelevement> basePrelevements,
			List<AnnotationValeur> listAnnoToCreateOrUpdate,
			List<AnnotationValeur> listAnnoToDelete, 
			List<NonConformite> ncfs,
			boolean cascadeNonSterile, Utilisateur utilisateur,
			String baseDir);
	 ...
	 */
	List<Prelevement> findByDossierExternesManager(List<Banque> banques,
	 ...
	 * @param noconfs
	 */
	void createObjectWithNonConformitesManager(Prelevement prelevement,
			Banque banque, Nature nature, Maladie maladie,
			ConsentType consentType, Collaborateur preleveur,
			Service servicePreleveur, PrelevementType prelevementType,
			ConditType conditType, ConditMilieu conditMilieu,
			Transporteur transporteur, Collaborateur operateur,
			Unite quantiteUnite, List<LaboInter> laboInters,
			List<AnnotationValeur> listAnnoToCreateOrUpdate,
			Utilisateur utilisateur, boolean doValidation, String baseDir,
			boolean isImport, List<NonConformite> noconfs);
	 ...
	 * @param noconfs
	 */
	void updateObjectWithNonConformitesManager(Prelevement prelevement,
			Banque banque, Nature nature, Maladie maladie,
			ConsentType consentType, Collaborateur preleveur,
			Service servicePreleveur, PrelevementType prelevementType,
			ConditType conditType, ConditMilieu conditMilieu,
			...
			boolean multiple, List<NonConformite> noconfs);
	 ...
	 * @since 2.0.13
	 */
	List<Prelevement> findByPatientAndAuthorisationsManager(Patient pat,
