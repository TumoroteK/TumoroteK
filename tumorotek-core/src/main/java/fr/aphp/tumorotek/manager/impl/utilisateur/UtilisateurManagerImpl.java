...
public class UtilisateurManagerImpl implements UtilisateurManager
{
   ...
   @Override
   public Set<Plateforme> getPlateformesManager(final Utilisateur utilisateur){
      if(utilisateur != null){
      ...
      if(utilisateur != null){
         ...
         if(utilisateur.isSuperAdmin()){
            ...
            final List<ProfilUtilisateur> profils =
               profilUtilisateurManager.findByUtilisateurManager(utilisateur, keepArchived ? null : false);
   ...
   @Override
   public List<Utilisateur> findBySuperAndArchiveManager(final boolean archive, final boolean isSuper){
