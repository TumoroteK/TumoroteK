...
/**
 *
 * Interface pour le manager du bean de domaine CessionExamen.
...
public interface CessionExamenManager extends PfDependantTKThesaurusManager<CessionExamen>
{
    ...
    */
   @Override
   CessionExamen findByIdManager(Integer cessionExamenId);
    ...
    */
   List<CessionExamen> findByExamenLikeManager(String examen, boolean exactMatch);
