...
public class ObjectReferencedException extends TKException {
	...
	public ObjectReferencedException(String en, String op) {
		super();
		this.entite = en;
		this.operation = op;
	}
	
	public ObjectReferencedException(String k, boolean c) {
		super();
		this.key = k;
		this.cascadable = c;
	}
	...
	public String getMessage() {
		return this.entite + ": objet référencé par un autre element, " 
