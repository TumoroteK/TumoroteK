...
public class UsedPositionException extends TKException
{
   ...
   public UsedPositionException(final String ent, final String op, final Integer pos){
      this.entite = ent;
      this.operation = op;
      this.position = pos;
   }
   ...
   public String getMessage(){
      return this.entite + ": la position " + position + " est déjà occupée dans l'enceinte parente lors de " + "l'opération de "
         + this.operation + "";
   }
}
