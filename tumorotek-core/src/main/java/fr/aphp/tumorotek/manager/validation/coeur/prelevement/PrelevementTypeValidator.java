...
/**
 * Validator pour le bean domaine PrelevementType.<br>
 * Classe creee le 09/10/09<br>
 * <br>
 * Regles de validation:<br>
 * 	- le champ type doit etre non vide, non null<br>
 *  - le champ incaCat doit etre non vide, de taille limitee a 2 digits
 *  mais peut etre null.
 * 
 * @author Mathieu BARTHELEMY
 * @version 2.0
 */
public class PrelevementTypeValidator implements Validator {

	@Override
	public boolean supports(Class<?> clazz) {
		return PrelevementType.class.equals(clazz);
	}
	...
	public void validate(Object obj, Errors errs) {
		//type non vide
		ValidationUtils
			.rejectIfEmptyOrWhitespace(errs, "type", 
										"prelevementType.type.empty");
		
		PrelevementType pType = (PrelevementType) obj;
		//nom valide
