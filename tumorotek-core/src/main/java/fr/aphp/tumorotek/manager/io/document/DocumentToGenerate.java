...
/**
 * Représente un document à générer avec ses composants principaux.
 *
 * <p>Cette classe encapsule les informations nécessaires pour générer un document, y compris
 * le nom du document, le contexte (en-tête), les données du document et le pied de page.</p>
 *
