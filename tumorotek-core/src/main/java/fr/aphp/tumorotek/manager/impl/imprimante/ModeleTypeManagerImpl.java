...
/**
 * 
 * Implémentation du manager du bean de domaine ModeleType.
 ...
 *
 */
public class ModeleTypeManagerImpl implements ModeleTypeManager {
	
	private Log log = LogFactory.getLog(ModeleTypeManager.class);
	...
	@Override
	public ModeleType findByIdManager(Integer modeleTypeId) {
		return modeleTypeDao.findById(modeleTypeId);
	}
	
	@Override
	public List<ModeleType> findAllObjectsManager() {
		log.debug("Recherche de tous les ModeleTypes");
		return modeleTypeDao.findByOrder();
	}
}
