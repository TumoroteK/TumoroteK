...
/**
 * 
 * Implémentation du manager du bean de domaine TerminaleNumerotation.
 ...
 *
 */
public class TerminaleNumerotationManagerImpl implements
		TerminaleNumerotationManager {
	
	/** Bean Dao TerminaleNumerotationDao. */
	...
	@Override
	public TerminaleNumerotation findByIdManager(
			Integer terminaleNumerotationId) {
