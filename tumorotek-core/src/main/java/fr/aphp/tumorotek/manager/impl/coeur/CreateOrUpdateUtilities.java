...
public final class CreateOrUpdateUtilities {
	 ...
	 * @param utilisateur
	 */
	public static void createAssociateOperation(Object obj, 
	 ...
	 * @param manager
	 */
	public static void removeAssociateOperations(Object obj,
												OperationManager manager,
												String comments, 
												Utilisateur user) {
		
		List<Operation> ops = manager.findByObjectManager(obj);
	 ...
	 * @param manager
	 */
	public static void removeAssociateImportations(Object obj,
											ImportHistoriqueManager manager) {
		
		List<Importation> ops = manager.findImportationsByObjectManager(obj);
		for (int i = 0; i < ops.size(); i++) {
	 ...
	 * @param manager
	 */
	public static void removeAssociateNonConformites(TKAnnotableObject obj,
										ObjetNonConformeManager manager) {
		
		List<ObjetNonConforme> ncfs = manager.findByObjetManager(obj);
