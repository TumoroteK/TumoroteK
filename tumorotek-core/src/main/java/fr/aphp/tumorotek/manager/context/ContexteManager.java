...
/**
 *
 * Interface pour le manager du bean de domaine Contexte.
 * Interface créée le 29/10/10.
 *
 * @author Mathieu BARTHELEMY
 * @version 2.0
 *
 */
public interface ContexteManager
{
    ...
    */
   List<Contexte> findByNomManager(String nom);

   /**
    * Recherche tous les Contextes ordonnés. par leur nom.
    * @return Liste ordonnée de Contextes.
    */
   List<Contexte> findByOrderManager();

   /**
    * Renvoie les catalogues associés au contexte.
    * @param contexte
    * @return liste de Catalogue.
    */
   Set<Catalogue> getCataloguesManager(Contexte contexte);
}
