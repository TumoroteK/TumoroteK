...
public interface TransformationManager {
	 ...
	 */
	List<Transformation> findByEntiteObjetManager(
...
//	Boolean isUsedObjectManager(Transformation transformation);
	 ...
	 */
	void createObjectManager(Transformation transformation, 
	 ...
	 * l'objet à créer se trouve déjà dans la base.
	 */
	void updateObjectManager(Transformation transformation, 
			Entite entite, Unite quantiteUnite);
	 ...
	 */
	void removeObjectManager(Transformation transformation, 
												String comments,
												Utilisateur user);
