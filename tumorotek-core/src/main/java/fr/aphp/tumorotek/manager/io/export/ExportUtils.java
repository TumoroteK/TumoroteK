...
public interface ExportUtils {
	 ...
	 * @return HSSFSheet.
	 */
	HSSFSheet addDataToRow(HSSFSheet sheet, 
			int indCell, int indRow, List< ? extends Object > values);
	 ...
	 */
	void addMaladieData(HSSFRow row, HSSFWorkbook wb,
			int indCell,
			Maladie maladie,
			List<ChampAnnotation> champAnnotations,
			boolean isAnnonyme,
			Utilisateur user);
	 ...
	 * @param isAnnonyme True si l'export est anonyme.
	 */
	void addPrelevementData(HSSFRow row, HSSFWorkbook wb,
			int indCell,
	 ...
	 * @param isAnnonyme True si l'export est anonyme.
	 */
	void addEchantillonData(HSSFRow row, HSSFWorkbook wb,
			int indCell,
	 ...
	 * @param isAnnonyme True si l'export est anonyme.
	 */
	void addProdDeriveData(HSSFRow row, HSSFWorkbook wb,
			int indCell,
			ProdDerive derive,
			List<ChampAnnotation> champAnnotations,
			boolean isAnnonyme,
	 ...
	 * @param champAnnotations Annotations à faire apparaître.
	 */
	void addCessionData(HSSFRow row, HSSFWorkbook wb,
			int indCell,
			Cession cession,
			List<ChampAnnotation> champAnnotations,
			Utilisateur user);
	 ...
	 */
	void addDataToRowCSV(BufferedWriter buf, int index, List<String> values, String fsep,
			String lsep) throws IOException;
