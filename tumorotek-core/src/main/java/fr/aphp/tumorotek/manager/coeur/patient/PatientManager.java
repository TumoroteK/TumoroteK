...
public interface PatientManager {
	 ...
	 * dans le file system
	 */
	void createOrUpdateObjectManager(Patient patient,
	 ...
	 * @param filesToDelete liste de fichier à supprimer
	 */
	void removeObjectManager(Patient patient, String comments, 
	 ...
	 */
	List<Patient> 
		findByNipLikeManager(String nip, boolean exactMatch);
	 ...
	 */
	List<Integer> 
		findByNomLikeBothSideReturnIdsManager(String nom, List<Banque> banques,
				boolean exactMatch);
	 ...
	 */
	List<Integer> 
		findByNipLikeBothSideReturnIdsManager(String nip, List<Banque> banques,
				boolean exactMatch);
	 ...
	 */
	List<Patient> 
		findByDateNaissanceManager(Date date);
	 ...
	 */
	List<Patient> findLastCreationManager(List<Banque> banques,
			int nbResults);
	 ...
	 * dans le file system
	 */
	void updateMultipleObjectsManager(List<Patient> patients,
	 ...
	 * @para String baseDir
	 */
	void fusionPatientManager(Patient patient, Patient passif, Utilisateur u, 
											String comments);
	 ...
	 */
	List<Integer> findByNomInListManager(List<String> criteres,
			List<Banque> banques);
	 ...
	 * @return une liste d'ids.
	 */
	List<Integer> findByNipInListManager(List<String> criteres,
			List<Banque> banques);
