...
public interface CodeAssigneManager {
	 ...
	 * @return une liste de codes assignes.
	 */
	List<CodeAssigne> findByLibelleLikeManager(String libelle, 
														boolean exactMatch);
	 ...
	 */
	void createOrUpdateManager(CodeAssigne code, Echantillon echantillon, 
				TableCodage table, Utilisateur utilisateur,  String operation);
	 ...
	 */
	List<CodeAssigne> 
		findCodesOrgExportedByPrelevementManager(Prelevement prel);
	 ...
	 */
	List<CodeAssigne> 
		findFirstCodesLesByPrelevementManager(Prelevement prel);
	 ...
	 */
	List<CodeAssigne> 
		findFirstCodesOrgByPrelevementManager(Prelevement prel);
	 ...
	 * @since 2.0.10.6
	 */
	void prepareListJDBCManager(EchantillonJdbcSuite jdbcSuite, 
