...
public class DoublonFoundException extends TKException {
	...
	public DoublonFoundException(String en, String op) {
		super();
		this.entite = en;
		this.operation = op;
	}
	 ...
	 * @since 2.1
	 */
	public DoublonFoundException(String _e, String _o, String _c, Plateforme _p) {
		super();
		this.entite = _e;
		this.operation = _o;
		this.code = _c;
	...
	public String getMessage() {
		return this.entite + ": doublon detecte lors de la " 
			+ this.operation + "";
	}
	...
	public void setPlateforme(Plateforme _p) {
		this.plateforme = _p;
	}
}
