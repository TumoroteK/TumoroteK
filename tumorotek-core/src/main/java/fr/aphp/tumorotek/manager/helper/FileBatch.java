...
public class FileBatch {
	...
	private List<TKAnnotableObject> objs = new ArrayList<TKAnnotableObject>();
	...
	public void setObjs(List<TKAnnotableObject> objs) {
		this.objs = objs;
	}
	...
	public void setChamp(ChampAnnotation champ) {
		this.champ = champ;
	}
	...
	public boolean equals(Object obj) {
		...
		FileBatch test = (FileBatch) obj;

		return ((this.champ == test.champ 
					|| (this.champ != null 
					&& this.champ.equals(test.champ))) 
				&& (this.stream == test.stream || (this.stream != null 
						&& this.stream.equals(test.stream))));
	}
}