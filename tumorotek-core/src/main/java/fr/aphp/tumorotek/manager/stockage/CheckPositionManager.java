...
public interface CheckPositionManager {
	 ...
	 */
	public Boolean checkPositionLibreInEnceinteManager(
			Enceinte enceinte, Integer position, Integer terminaleId,
			Integer enceinteId);
	 ...
	 * @return True si la position est libre.
	 */
	public Boolean checkPositionLibreInConteneurManager(
			Conteneur conteneur, Integer position, Integer enceinteId);
