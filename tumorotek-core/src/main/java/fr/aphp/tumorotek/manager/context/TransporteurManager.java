...
public interface TransporteurManager {
	 ...
	 */
	void createObjectManager(Transporteur transporteur,
	 ...
	 */
	void updateObjectManager(Transporteur transporteur,
			Coordonnee coordonnee, Utilisateur utilisateur);
	 ...
	 * objets.
	 */
	void removeObjectManager(Transporteur transporteur, String comments, 
															Utilisateur user);
