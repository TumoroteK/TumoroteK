...
public interface ServiceManager
{
    ...
    * @return Liste ordonnée de Collaborateurs.
    */
   List<Collaborateur> getActiveCollaborateursWithOrderManager(Service service);
    ...
    */
   void fusionServiceManager(int idActif, int idPassif, String comments, Utilisateur user);
