...
/**
 *
 * Interface pour le manager du bean de domaine Titre.
...
public interface TitreManager
{
    ...
    * @return Un Titre.
    */
   Titre findByIdManager(Integer titreId);

   /**
    * Recherche tous les Titres présents dans la base.
    * @return Liste de Titres.
    */
   List<Titre> findAllObjectsManager();
    ...
    * @return Liste de Titres.
    */
   List<Titre> findByTitreLikeManager(String titre, boolean exactMatch);
