...
public interface FichierManager {
	 ...
	 */
	List<Fichier> findByPathLikeManager(
	 ...
	 */
	void createObjectManager(Fichier path, InputStream stream, 
	 ...
	 * l'objet à créer se trouve déjà dans la base.
	 */
	Fichier updateObjectManager(Fichier path, InputStream stream, 
	 ...
	 * @param filesToDelete
	 */
	void createOrUpdateFileForObject(TKFileSettableObject obj, Fichier fileRef,
			InputStream stream, String pathBase, List<File> filesCreated,
