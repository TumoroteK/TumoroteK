...
public interface CessionManager {
	 ...
	 * @version 2.0.10
	 */
	List<Integer> findByNumeroWithBanqueReturnIdsManager(String numero,	
	 ...
	 * @return Liste de Cessions.
	 */
	List<Integer> findByStatutWithBanquesReturnIdsManager(String statut,	
												List<Banque> banques);
	 ...
	 * @return Liste de Cessions.
	 */
	List<Integer> findByEtatIncompletWithBanquesReturnIdsManager(
	 ...
	 * @return Liste de Cessions.
	 */
	List<Cession> findAfterDateModificationManager(
	 ...
	 * dans le file system
	 */
	void createObjectManager(Cession cession, Banque banque, 
			CessionType cessionType, CessionExamen cessionExamen,
			Contrat mta, Collaborateur destinataire, Service servDest,
	 ...
	 * dans le file system
	 */
	void updateObjectManager(Cession cession, Banque banque, 
			CessionType cessionType, CessionExamen cessionExamen,
			Contrat mta, Collaborateur destinataire, Service servDest,
			Collaborateur demandeur, CessionStatut cessionStatut,
			Collaborateur executant, Transporteur transporteur,
	 ...
	 * @param filesToDelete liste de fichier à supprimer
	 */
	void removeObjectManager(Cession cession, String comments, Utilisateur usr, 
