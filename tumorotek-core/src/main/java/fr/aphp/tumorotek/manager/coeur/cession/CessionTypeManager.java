...
/**
 *
 * Interface pour le manager du bean de domaine CessionType.
 ...
 *
 */
public interface CessionTypeManager
{
    ...
    */
   CessionType findByIdManager(Integer cessionTypeId);

   /**
    * Recherche tous les CessionTypes présents dans la base.
    * @return Liste de CessionTypes.
    */
   List<CessionType> findAllObjectsManager();
    ...
    * @return Liste de CessionTypes.
    */
   List<CessionType> findByTypeLikeManager(String type, boolean exactMatch);
