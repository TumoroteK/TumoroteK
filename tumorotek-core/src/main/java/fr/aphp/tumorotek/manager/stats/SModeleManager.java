...
public interface SModeleManager {
	 ...
	 */
	void createObjectManager(SModele modele, Plateforme plateforme,
			List<Indicateur> indicateurs, List<Banque> banques);
	 ...
	 * @version 2.1
	 */
	SModele updateObjectManager(SModele modele, Plateforme plateforme,
