...
/**
 *
 * Interface pour le manager du bean de domaine Diagnostic.<br>
 * Interface créée le 07/02/12.<br>
 * <br>
 * Actions:<br>
 * 	- Enregistrer un diagnostic (controle de doublons)<br>
 * 	- Modifier un diagnostic (controle de doublons)<br>
 * 	- Retourner les diagnostics, ordonnées ou non, avec un filtre sur le nom...
 * 	- Supprimer un diagnostic<br>
 *
