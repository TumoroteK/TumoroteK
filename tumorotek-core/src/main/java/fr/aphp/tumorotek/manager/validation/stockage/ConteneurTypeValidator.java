...
/**
 * Validator pour le bean domaine ConteneurType (de stockage).<br>
 ...
 * @version 2.0
 */
public class ConteneurTypeValidator implements Validator {

	@SuppressWarnings("unchecked")
	@Override
	public boolean supports(Class clazz) {
		return ConteneurType.class.equals(clazz);
	}
	...
	public void validate(Object obj, Errors errs) {
		...
		ValidationUtils
			.rejectIfEmptyOrWhitespace(errs, "type", 
					"conteneurType.type.empty");
		
		ConteneurType type = (ConteneurType) obj;
		//nom valide
