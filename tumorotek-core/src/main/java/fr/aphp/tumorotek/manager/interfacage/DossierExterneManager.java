...
public interface DossierExterneManager {
	 ...
	 * @return Liste de DossierExternes.
	 */
	List<DossierExterne> findByEmetteurManager(
			Emetteur emetteur);
	 ...
	 * @return Liste de DossierExternes.
	 */
	List<DossierExterne> findByEmetteurAndIdentificationManager(
	 ...
	 * @return Liste de DossierExternes.
	 */
	List<DossierExterne> findByEmetteurInListAndIdentificationManager(
	 ...
	 */
	void validateDossierExterneManager(DossierExterne dossierExterne,
	 ...
	 * @version 2.1
	 */
	void createObjectManager(DossierExterne dossierExterne,
			Emetteur emetteur, List<BlocExterne> blocExternes,
			Hashtable<BlocExterne, List<ValeurExterne>> valeurExternes, 
			int max);
