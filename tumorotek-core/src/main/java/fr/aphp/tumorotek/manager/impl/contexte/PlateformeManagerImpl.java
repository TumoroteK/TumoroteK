...
public class PlateformeManagerImpl implements PlateformeManager
{
   ...
   @Override
   public void updateObjectManager(final Plateforme plateforme, final Collaborateur collaborateur,
    ...
    * l'utilisateur.
    */
   public void updateAdministrateurs(final Plateforme plateforme, final List<Utilisateur> utilisateurs){
