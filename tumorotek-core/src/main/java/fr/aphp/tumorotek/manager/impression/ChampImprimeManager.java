...
public interface ChampImprimeManager {
	 ...
	 * @return Liste de ChampImprimes.
	 */
	List<ChampImprime> findByExcludedPKManager(
			ChampImprimePK pk);
	 ...
	 * @return une liste de ChampImprimes.
	 */
	List<ChampImprime> findByTemplateAndBlocManager(
	...
	Boolean findDoublonManager(Template template,
			ChampEntite champEntite, BlocImpression bloc);
	 ...
	 * @param bloc BlocImpression du ChampImprime.
	 */
	void validateObjectManager(Template template,
			ChampEntite champEntite, BlocImpression bloc);
	 ...
	 * @param bloc BlocImpression du ChampImprime.
	 */
	void createObjectManager(ChampImprime champImprime, 
			Template template,
			ChampEntite champEntite, BlocImpression bloc);
	 ...
	 * @param bloc BlocImpression du ChampImprime.
	 */
	void updateObjectManager(ChampImprime champImprime, 
			Template template,
			ChampEntite champEntite, BlocImpression bloc);
