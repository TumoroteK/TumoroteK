...
public interface ImportHistoriqueManager {
	 ...
	 */
	List<ImportHistorique> findByTemplateWithOrderManager(
	 ...
	 */
	List<Importation> findImportationsByHistoriqueManager(
	 ...
	 * @return Liste d'Importation.
	 */
	List<Importation> findImportationsByHistoriqueAndEntiteManager(
	 ...
	 * @return Liste d'Importation.
	 */
	List<Importation> findImportationsByObjectManager(
			Object object);
	 ...
	 * @return Liste d'Importation.
	 */
	List<Importation> findImportationsByEntiteAndObjectIdManager(
	 ...
	 */
	void createObjectManager(ImportHistorique importHistorique, 
			ImportTemplate importTemplate,
	 ...
	 */
	List<Prelevement> 
			findPrelevementByImportHistoriqueManager(ImportHistorique ih);
