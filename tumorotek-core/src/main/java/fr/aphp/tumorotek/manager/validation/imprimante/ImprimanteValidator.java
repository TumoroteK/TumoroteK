...
public class ImprimanteValidator implements Validator
{
   ...
   public void validate(final Object target, final Errors errors){
      ...
      final Imprimante imprimante = (Imprimante) target;

      // nom non null
      ValidationUtils.rejectIfEmptyOrWhitespace(errors, "nom", "imprimante.nom.empty");
      //nom valide
      if(imprimante.getNom() != null){
         if(!imprimante.getNom().matches(ValidationUtilities.MOTREGEXP)){
      ...
      if(imprimante.getAdresseIp() != null){
         if(!imprimante.getAdresseIp().matches(ValidationUtilities.IPREGEXP)){
