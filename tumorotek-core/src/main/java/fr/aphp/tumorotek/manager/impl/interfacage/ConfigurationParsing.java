...
public class ConfigurationParsing {
	...
	public ConfigurationParsing(String sepChamps, String sepComposants,
			String sepSousComposants, String keyLibre) {
	...
	public void setSeparateurChamps(String s) {
	...
	public void setSeparateurComposants(String s) {
	...
	public void setSeparateurSousComposants(String s) {
	...
	public void setBlocLibreKey(String b) {
		this.blocLibreKey = b;
	}
