...
public class Paragraphe {
	...
	public Paragraphe(String t, Object[] lig, 
			SousParagraphe[] sousP, String inc,
			ListeElement l) {
		super();
		this.lignes = lig;
		this.titre = t;
	...
	public void setLignes(Object[] lig) {
		this.lignes = lig;
	}
	...
	public void setSousParagraphes(SousParagraphe[] sousP) {
		this.sousParagraphes = sousP;
	}
	...
	public void setInconnu(String inc) {
		this.inconnu = inc;
	}
	...
	public void setListe(ListeElement l) {
		this.liste = l;
	}
