...
public class RechercheValidator implements Validator
{
   ...
   public void validate(final Object obj, final Errors errs){
      //intitule non vide
      ValidationUtils.rejectIfEmptyOrWhitespace(errs, "intitule", "recherche.intitule.empty");

      final Recherche recherche = (Recherche) obj;
      //createur valide
      ...
      if(recherche.getIntitule() != null){
         if(!recherche.getIntitule().matches(ValidationUtilities.MOTREGEXP)){
      ...
      if(recherche.getAffichage() == null){
         errs.rejectValue("affichage", "recherche.affichage.empty");
      }

      //requete valide
      if(recherche.getRequete() == null){
         errs.rejectValue("requete", "recherche.requete.empty");
      }
