...
public interface IncaSpecifiqueExport {
	 ...
	 * @return "0", "N" ou ""
	 */
	String getQuestAntTabac(Connection con, Patient patient, 
													Banque bank);
	 ...
	 * @return "0", "N" ou ""
	 */
	String getQuestFamilial(Connection con, Patient patient, 
													Banque bank);
	 ...
	 * @return "0", "N" ou ""
	 */
	String getQuestPro(Connection con, Patient patient, 
													Banque bank);
	 ...
	 * @return 0, 1, 2, 3
	 */
	String getStatutTabac(Connection con, Patient patient, 
														Banque bank);
