...
/**
 * 
 * Implémentation du manager du bean de domaine Logiciel.
...
public class LogicielManagerImpl implements LogicielManager {
	...
	private Log log = LogFactory.getLog(LogicielManager.class);
	...
	@Override
	public Logiciel findByIdManager(Integer logicielId) {
		return logicielDao.findById(logicielId);
	}
	
	@Override
	public List<Logiciel> findAllObjectsManager() {
		log.debug("Recherche de tous les BlocExternes");
		return logicielDao.findByOrder();
	}
}
