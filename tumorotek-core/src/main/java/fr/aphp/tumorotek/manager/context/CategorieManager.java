...
/**
 *
 * Interface pour le manager du bean de domaine Categorie.
...
public interface CategorieManager extends TKThesaurusManager<Categorie>
{
    ...
    */
   List<Categorie> findAllObjectsManager();
    ...
    * @return Liste de Categories.
    */
   List<Categorie> findByNomLikeManager(String nom, boolean exactMatch);
