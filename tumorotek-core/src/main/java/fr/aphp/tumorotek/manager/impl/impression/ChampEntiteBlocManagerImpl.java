...
/**
 * 
 * Implémentation du manager du bean de domaine ChampEntiteBloc.
 * Classe créée le 30/07/10.
 * 
 * @author Pierre Ventadour
 * @version 2.0
 *
 */
public class ChampEntiteBlocManagerImpl implements ChampEntiteBlocManager {
	
	private Log log = LogFactory.getLog(ChampEntiteBlocManager.class);
	...
	@Override
	public ChampEntiteBloc findByIdManager(ChampEntiteBlocPK pk) {
	...
	@Override
	public List<ChampEntiteBloc> findByBlocManager(BlocImpression bloc) {
		log.debug("Recherche de tous les ChampEntiteBlocs d'un bloc.");
		
		if (bloc != null) {
			return champEntiteBlocDao.findByBlocImpression(bloc);
		} else {
			return new ArrayList<ChampEntiteBloc>();
		}
	}
}
