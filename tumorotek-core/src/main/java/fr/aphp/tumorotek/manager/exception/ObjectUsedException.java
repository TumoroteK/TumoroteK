...
public class ObjectUsedException extends TKException
{
   ...
   public ObjectUsedException(final String en, final String op){
      super();
      this.entite = en;
      this.operation = op;
   }

   public ObjectUsedException(final String k, final boolean c){
      super();
      this.key = k;
      this.cascadable = c;
   }
   ...
   public String getMessage(){
      if(getKey() != null){
         ...
         return this.entite + ": objet utilise par un autre element, " + this.operation + " impossible";
      }
   }
