...
public class TKScanTerminaleDTO {
	...
	private Map<ScanTube, Emplacement> emplacementsToFill = new HashMap<ScanTube, Emplacement>();
	private Map<ScanTube, TKStockableObject> emplacementsToFree = new HashMap<ScanTube, TKStockableObject>();
	private Map<ScanTube, TKStockableObject> emplacementsMismatch = new HashMap<ScanTube, TKStockableObject>();
	...
	public void setScanTerminale(ScanTerminale _s) {
	...
	public void setTerminale(Terminale _t) {
		this.terminale = _t;
	}
	...
	public void setEmplacementsToFill(Map<ScanTube, Emplacement> _e) {
	...
	public void setEmplacementsToFree(Map<ScanTube, TKStockableObject> _e) {
	...
	public void setEmplacementsMismatch(Map<ScanTube, TKStockableObject> _e) {
