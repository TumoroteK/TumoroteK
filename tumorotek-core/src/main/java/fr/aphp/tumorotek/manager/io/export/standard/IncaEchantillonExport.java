...
public interface IncaEchantillonExport
{
    ...
    * @return 1 ou N
    */
   String getProdTypeAssocie(Connection con, Echantillon echantillon, String regexp);
    ...
    * @return O, N ou ""
    */
   String getADNconstitutionnel(Connection con, Echantillon echantillon, String consentSQLRegexp);
