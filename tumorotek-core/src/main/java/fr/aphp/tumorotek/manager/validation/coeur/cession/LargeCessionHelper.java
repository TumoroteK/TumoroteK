...
public class LargeCessionHelper {
	...
	List<String> codesNotFound = new ArrayList<String>();
	List<String> objsNonStockes  = new ArrayList<String>();
	List<String> dateStockIncompatible = new ArrayList<String>();
	List<String> evtsStockIncompatible  = new ArrayList<String>();
	
	public LargeCessionHelper(Integer _i) {
		entiteId = _i;
	}
	
	public boolean containsErrs() {
		return !codesNotFound.isEmpty() 
				|| !objsNonStockes.isEmpty()
				|| !dateStockIncompatible.isEmpty()
	...
	public void setEntiteId(Integer _i) {
		this.entiteId = _i;
	}
	...
	public void setIdsFound(List<Integer> _i) {
		this.idsFound = _i;
	}
	...
	public void setCodesNotFound(List<String> _c) {
	...
	public void setObjsNonStockes(List<String> _o) {
	...
	public void setDateStockIncompatible(List<String> _d) {
	...
	public void setEvtsStockIncompatible(List<String> _e) {
