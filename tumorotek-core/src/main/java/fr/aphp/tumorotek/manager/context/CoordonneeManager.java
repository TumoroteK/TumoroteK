...
public interface CoordonneeManager {
	 ...
	 */
	Boolean findDoublonForCollaborateurManager(Coordonnee coordonnee, 
	 ...
	 * coordonnée.
	 */
	void createObjectManager(Coordonnee coordonnee, 
	 ...
	 * coordonnée.
	 */
	void updateObjectManager(Coordonnee coordonnee, 
			List<Collaborateur> collaborateurs,
	 ...
	 */
	Boolean isUsedByOtherObjectManager(Coordonnee coordonnee, 
			Collaborateur collaborateur);
