 ...
 *
 */
public interface ValidateurManager
{

   /**
    * Déclenche les validations associées à une action
    * @param entite entité à valider
    * @param action action
    * @return
    */
   ResultatValidation validerAction(TKAnnotableObject entite, Action action);
