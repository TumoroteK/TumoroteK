...
public interface EnceinteManager {
	 ...
	 * @return True s'il existe des doublons.
	 */
	Boolean findDoublonWithoutTwoEnceintesManager(
	 ...
	 */
	void createObjectManager(Enceinte enceinte, 
			EnceinteType enceinteType,
			Conteneur conteneur, Enceinte enceintePere,
			Entite entite, List<Banque> banques,
			Couleur couleur,
	 ...
	 */
	void createAllArborescenceManager(Enceinte enceinte,
	 ...
	 */
	List<Enceinte> createMultiObjetcsForConteneurManager(
			Conteneur conteneur, 
			Enceinte enceinte,
			Integer number, 
	 ...
	 * @param firstPosition Index de la première enceinte.
	 */
	List<Enceinte> createMultiObjetcsForEnceinteManager(
	 ...
	 * @version 2.0.10
	 */
	void updateObjectManager(Enceinte enceinte, 
			EnceinteType enceinteType,
			Conteneur conteneur, Enceinte enceintePere,
			Entite entite, List<Banque> banques,
			Couleur couleur,
	 ...
	 * @param plateformes Plateformes liées au conteneur.
	 */
	void updatewithCreateAllArborescenceManager(Enceinte enceinte,
			List<Enceinte> enceintes,
			Terminale terminale,
			List<Integer> firstPositions,
			List<Banque> banques,
	 ...
	 */
	void removeObjectManager(Enceinte enceinte, String comments, 
												Utilisateur user);
	 ...
	 */
	List<Integer> getObjetIdsByEntiteByPS(Enceinte enceinte,
			Entite entite);
	 ...
	 */
	void echangerDeuxEnceintesManager(Enceinte enceinte1, Enceinte enceinte2,
			Utilisateur utilisateur);
	 ...
	 * @return Liste d'Enceinte.
	 */
	List<Enceinte> findByEnceintePereAndNomManager(Enceinte enceintePere,
			String nom);
	 ...
	 * @return Liste d'Enceintes.
	 */
	List<Enceinte> findByConteneurAndNomManager(Conteneur conteneur,
			String nom);
	 ...
	 * @return Enceinte maj.
	 */
	Enceinte updateTailleEnceinteManager(Enceinte enceinte, Integer nbPlaces,
			Utilisateur utilisateur);
}
