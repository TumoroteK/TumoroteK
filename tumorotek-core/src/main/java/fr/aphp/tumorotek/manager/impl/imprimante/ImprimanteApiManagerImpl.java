...
/**
 * 
 * Implémentation du manager du bean de domaine ImprimanteApi.
...
public class ImprimanteApiManagerImpl implements ImprimanteApiManager {
	...
	private Log log = LogFactory.getLog(ImprimanteApiManager.class);
	...
	@Override
	public ImprimanteApi findByIdManager(Integer imprimanteApiId) {
		return imprimanteApiDao.findById(imprimanteApiId);
	}
	
	@Override
	public List<ImprimanteApi> findAllObjectsManager() {
		log.debug("Recherche de toutes les ImprimanteApis");
		return imprimanteApiDao.findByOrder();
	}
