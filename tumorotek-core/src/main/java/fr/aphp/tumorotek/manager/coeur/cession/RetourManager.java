...
public interface RetourManager {
	 ...
	 */
	void createOrUpdateObjectManager(Retour retour, TKStockableObject objet,
			Emplacement emplacement, 
			Collaborateur collborateur, Cession cession,
			Transformation transformation,
			Incident incident, Utilisateur utilisateur, String operation);
	 ...
	 * @param utilisateur
	 */
	void createRetourListManager(List<TKStockableObject> objects, 
	 ...
	 * @version 2.0.10
	 */
	boolean createRetourHugeListManager(List<TKStockableObject> objects, 
			HashMap<TKStockableObject, Emplacement> oldEmpAdrls,
			Retour retour,
			Collaborateur collaborateur, Cession cession,
			Transformation transformation, 
			Incident incident, Utilisateur utilisateur);
...
*/
	 ...
	 * @param utilisateur
	 */
	void updateMultipleObjectManager(List<Retour> retours,
			Collaborateur collaborateur, Cession cession,
			Transformation transformation, Incident incident,
