...
/**
 *
 * Interface pour le Manager du bean de domaine Catalogue.
...
public interface CatalogueManager
{
   ...
   /**
    * Recherche toutes les Catalogue présentes dans la base.
    ...
    * @return liste de Catalogue
    */
   List<Catalogue> findByAssignedBanqueManager(Banque b);
}
