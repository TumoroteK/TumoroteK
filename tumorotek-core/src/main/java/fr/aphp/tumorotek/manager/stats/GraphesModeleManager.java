...
public interface GraphesModeleManager
{
    ...
    * @return grapheModele
    */
   GraphesModele prelevementTypeByCollectionManager(Date date_debut, Date date_fin, String banqueNom, String pfNom,
      boolean isOracle);
    ...
    * @return grapheModele
    */
   GraphesModele prelevementByEtablissementByCollectionManager(Date date_debut, Date date_fin, String banqueNom, String pfNom,
      boolean isOracle);
    ...
    * @return grapheModele
    */
   GraphesModele prelevementByConsentementByCollectionManager(Date date_debut, Date date_fin, String banqueNom, String pfNom,
      boolean isOracle);
    ...
    * @return grapheModele
    */
   GraphesModele echantillonTypeByCollectionManager(Date date_debut, Date date_fin, String banqueNom, String pfNom,
      boolean isOracle);
    ...
    * @return grapheModele
    */
   GraphesModele collectionViewByEchansCedesManager(Date date_debut, Date date_fin, String pfNom, boolean isOracle);
    ...
    * @return grapheModele
    */
   GraphesModele collectionViewByDerivesCedesManager(Date date_debut, Date date_fin, String pfNom, boolean isOracle);
