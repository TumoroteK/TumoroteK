...
/**
 *
 * Interface pour le validator du bean de domaine ProdDerive.
 * Interface créée le 14/12/10, contrairement aux autres validators,
 * pour beneficier injection dependances (ref vers entiteManager)
 *
 * @author Mathieu Barthelemy
 * @version 2.0
 *
 */
public interface ProdDeriveValidator extends Validator
{

   /**
    * Vérifie la cohérence de la date de stockage du derive.
    * @param derive
    * @paral objet parent du derive
    * @return errors
    */
   Errors checkDateStockCoherence(ProdDerive derive);

   /**
    * Vérifie la cohérence de la date de transformation du derive.
    * @param derive
    * @paral objet parent du derive
    * @return errors
    */
    ...
    */
   //Object[] findPostRefDateInDerives(Object parent);
}
