...
//			Banque banque);
	 ...
	 */
	void createObjectManager(Recherche recherche,
			Affichage affichage, Requete requete,
			List<Banque> banques, Utilisateur createur,
			Banque banque);
	 ...
	 */
	void updateObjectManager(Recherche recherche,
			Affichage affichage, Requete requete,
			List<Banque> banques, Utilisateur createur,
			Banque banque);
	 ...
	 * @return la liste de toutes les Recherches de l'intitulé.
	 */
	List<Recherche> findByIntituleAndUtilisateurManager(
