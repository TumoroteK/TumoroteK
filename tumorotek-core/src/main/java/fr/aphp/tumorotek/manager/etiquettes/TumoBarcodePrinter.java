...
//					throws PrinterException;
	 ...
	 * @throws PrinterException 
	 */
	int printStockableObjects(List<? extends TKStockableObject> objects, int i,
			Imprimante imp, Modele mod, String rawLang, 
	 ...
	 * @throws PrinterException
	 */
	int printListCopiesData(List<List<LigneEtiquette>> l, int nb,
			Imprimante imprimante, Modele modele, String rawLang, 
