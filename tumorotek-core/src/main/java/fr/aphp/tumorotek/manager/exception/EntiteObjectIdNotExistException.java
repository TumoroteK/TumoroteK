...
public class EntiteObjectIdNotExistException extends TKException
{
   ...
   public EntiteObjectIdNotExistException(final String en, final String nom, final Integer id){
      super();
      this.entite = en;
      this.nomEntite = nom;
      this.objectId = id;
   ...
   public String getMessage(){
      return this.entite + ": aucune instance de l'élément " + nomEntite + " n'a un identifiant égal à " + objectId;
   }
