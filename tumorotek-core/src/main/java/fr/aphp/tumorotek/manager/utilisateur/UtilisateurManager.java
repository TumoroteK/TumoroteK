...
public interface UtilisateurManager {
	 ...
	 * @return Un Utilisateur.
	 */
	List<Utilisateur> findByLoginAndArchiveManager(String login, 
	 ...
	 */
	List<Utilisateur> findByArchiveManager(boolean archive, 
									List<Plateforme> pfs);
	 ...
	 * @return Liste d'utilisateurs.
	 */
	List<Utilisateur> findByLoginPasswordAndArchiveManager(
			String login, String pass, boolean archive);
	 ...
	 * @version 2.1
	 */
	List<Plateforme> getAvailablePlateformesManager(
	 ...
	 * @return Liste de banques.
	 */
	List<Banque> getAvailableBanquesByPlateformeManager(
	 ...
	 */
	void createObjectManager(Utilisateur utilisateur, 
	 ...
	 */
	void updateObjectManager(Utilisateur utilisateur, 
			Collaborateur collaborateur,
			List<ProfilUtilisateur> profils,
			List<Plateforme> plateformes,
			Utilisateur admin,
	 ...
	 */
	Utilisateur updatePasswordManager(Utilisateur utilisateur,
			String newPwd, Integer nbMois, Utilisateur admin);
	 ...
	 * @param admin User réalisant l'opréation.
	 */
	void archiveUtilisateurManager(Utilisateur utilisateur, 
			Utilisateur admin);
