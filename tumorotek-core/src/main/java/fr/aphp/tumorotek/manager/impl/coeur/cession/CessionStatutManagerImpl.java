...
public class CessionStatutManagerImpl implements CessionStatutManager {
	...
	private Log log = LogFactory.getLog(CessionStatutManager.class);
	 ...
	 */
	@Override
	public CessionStatut findByIdManager(Integer cessionStatutId) {
	 ...
	 */
	@Override
	public List<CessionStatut> findByStatutLikeManager(String statut,
			boolean exactMatch) {
		
		log.debug("Recherche CessionStatut par " 
		...
		if (statut != null) {
			...
			return new ArrayList<CessionStatut>();
		}
