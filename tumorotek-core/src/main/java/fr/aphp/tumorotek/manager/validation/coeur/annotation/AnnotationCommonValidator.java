...
public class AnnotationCommonValidator implements Validator
{
   ...
   public boolean supports(final Class<?> clazz){
      return AnnotationValeur.class.equals(clazz) || AnnotationDefaut.class.equals(clazz);
   }
   ...
   public void validate(final Object obj, final Errors errs){
      ...
      if(anno.getAlphanum() != null){
         ...
         if(anno.getChampAnnotation() != null){
            if(anno.getChampAnnotation().getDataType().getType().equals("alphanum")){
               if(!anno.getAlphanum().matches(ValidationUtilities.MOTREGEXP)){
            ...
            }else if(anno.getChampAnnotation().getDataType().getType().equals("hyperlien")){
               if(!anno.getAlphanum().matches(ValidationUtilities.HTTPREGEXP)
                  && !anno.getAlphanum().equals("system.tk.unknownExistingValue")){
      ...
      //texte valide
      if(anno.getTexte() != null){
         ValidationUtils.rejectIfEmptyOrWhitespace(errs, "texte", "anno.texte.empty");
      }
