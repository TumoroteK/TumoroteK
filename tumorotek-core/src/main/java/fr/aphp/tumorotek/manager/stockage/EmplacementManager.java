...
public interface EmplacementManager {
	 ...
	 * @return Liste ordonnée d'Emplacements.
	 */
	List<Emplacement> findByTerminaleAndPosition(
			Terminale terminale, Integer position);
	 ...
	 * @return La position.
	 */
	Integer getPositionByCoordonnees(Terminale terminale, 
	 ...
	 */
	String getNumerotationByPositionAndTerminaleManager(Integer position,
			Terminale terminale);
	 ...
	 */
	void createObjectManager(Emplacement emplacement, 
	 ...
	 */
	List<Emplacement> createMultiObjetcsManager(
	 ...
	 * @param entite Entite de l'objet se trouvant a cet Emplacement.
	 */
	void updateObjectManager(Emplacement emplacement, 
			Terminale terminale, Entite entite); 
	 ...
	 */
	void deplacerMultiEmplacementsManager(List<Emplacement> emplacements,
	 ...
	 * @since 2.0.10
	 */
	List<TKStockableObject> 
			findObjByEmplacementManager(Emplacement empl, String entiteNom);
