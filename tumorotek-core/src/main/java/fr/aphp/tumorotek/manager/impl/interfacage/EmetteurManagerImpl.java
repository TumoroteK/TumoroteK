...
public class EmetteurManagerImpl implements EmetteurManager {
	...
	private Log log = LogFactory.getLog(EmetteurManager.class);
	...
	@Override
	public Emetteur findByIdManager(Integer emetteurId) {
	...
	@Override
	public List<Emetteur> findByLogicielManager(Logiciel logiciel) {
		log.debug("Recherche de tous les Emetteurs d'un logiciel");
		if (logiciel != null) {
			return emetteurDao.findByLogiciel(logiciel);
		} else {
			return new ArrayList<Emetteur>();
		}
	}
	
	@Override
	public List<Emetteur> findByIdinListManager(List<Integer> emetteurIds) {
	...
	@Override
	public List<Emetteur> findByIdentificationAndServiceManager(
			String identification, String service) {
		if (identification != null && service != null) {
			return emetteurDao.findByIdentificationAndService(
