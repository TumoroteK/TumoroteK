...
public class LaboInterManagerImpl implements LaboInterManager
{
   ...
   /* Properties setters */
   public void setLaboInterDao(final LaboInterDao nDao){
   ...
   @Override
   public boolean findDoublonManager(final LaboInter obj){
      final Prelevement prlvt = obj.getPrelevement();

      if(prlvt != null){
         if(obj.getLaboInterId() == null){
            return laboInterDao.findByPrelevementWithOnlyOrder(prlvt).contains(obj.getOrdre());
         }else{
            return laboInterDao.findByPrelevementWithOnlyOrderAndExcludedId(prlvt, obj.getLaboInterId())
   ...
   @Override
   public List<LaboInter> findByPrelevementWithOrder(final Prelevement prelevement){
