...
public class BarcodeFieldDefault {
	...
	public BarcodeFieldDefault(Float w, Float r, Integer h) {
		moduleWidth = w;
		widthRatio = r;
		barCodeHeight = h;
	}
	...
	public void setModuleWidth(Float m) {
		this.moduleWidth = m;
	}
	...
	public void setWidthRatio(Float w) {
		this.widthRatio = w;
	}
	...
	public void setBarCodeHeight(Integer b) {
