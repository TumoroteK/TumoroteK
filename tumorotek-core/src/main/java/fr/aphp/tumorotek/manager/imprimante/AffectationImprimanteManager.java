...
public interface AffectationImprimanteManager {
	 ...
	 * @return Liste de AffectationImprimantes.
	 */
	List<AffectationImprimante> findByExcludedPKManager(
	 ...
	 */
	List<AffectationImprimante> findByBanqueUtilisateurManager(
	 ...
	 * @param imprimante Imprimante de la AffectationImprimante.
	 */
	void validateObjectManager(Utilisateur utilisateur, 
			Banque banque, 
			Imprimante imprimante);
	 ...
	 */
	void createObjectManager(AffectationImprimante affectationImprimante, 
