...
/**
 *
 * Implémentation du manager du bean de domaine Catalogue.
 * Date: 18/03/2010.
 *
...
public class CatalogueManagerImpl implements CatalogueManager
{
   ...
   @Override
   public List<Catalogue> findByAssignedBanqueManager(final Banque b){
      return catalogueDao.findByAssignedBanque(b);
   }
}
