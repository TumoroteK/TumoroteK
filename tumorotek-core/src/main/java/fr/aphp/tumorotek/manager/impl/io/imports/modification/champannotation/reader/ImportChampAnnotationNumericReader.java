...
/**
 * classe qui lit une cellule d'un fichier d'import qui correspond à un nombre
 * 
 * @since 2.3.1.0 (TK-538)
 * @author chuet
 *
 */
public class ImportChampAnnotationNumericReader implements ImportChampAnnotationReader
{

   @Override
   public Number read(Cell cell, FormulaEvaluator formulaEvaluator) throws ExcelIllegalContentTypeException {
      return ExcelUtility.readNumericContent(cell, formulaEvaluator);
   }
