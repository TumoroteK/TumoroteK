...
public class CombinaisonManagerImpl implements CombinaisonManager {
	...
	private Log log = LogFactory.getLog(CombinaisonManager.class);
	 ...
	 */
	public void setCombinaisonDao(CombinaisonDao combDao) {
	 ...
	 */
	public void setChampDao(ChampDao chDao) {
		this.champDao = chDao;
	}
	 ...
	 */
	public void setChampManager(ChampManager chManager) {
	 ...
	 */
	public void setCombinaisonValidator(CombinaisonValidator validator) {
	 ...
	 */
	@Override
	public Combinaison copyCombinaisonManager(Combinaison combinaison) {
		Combinaison temp = null;
		//On verifie que la combinaison n'est pas nulle
		if (combinaison == null) {
			log.warn("Objet obligatoire Combinaison manquant lors " 
					+ "de la copie d'un objet Combinaison");
			throw new RequiredObjectIsNullException(
					"Combinaison", "copie", "Combinaison");
		} else {
			//On copie le champ1
			Champ champ1 = null;
			...
			temp = new Combinaison(champ1, 
					combinaison.getOperateur(), champ2);
	 ...
	 */
	@Override
	public void createObjectManager(Combinaison combinaison, Champ champ1,
			Champ champ2) {
		//On vérifie que la combinaison n'est pas nulle
		if (combinaison == null) {
			log.warn("Objet obligatoire Combinaison manquant lors " 
					+ "de la création d'un objet Combinaison");
			throw new RequiredObjectIsNullException(
					"Combinaison", "création", "Combinaison");
		}
		//On vérifie que le champ1 n'est pas nul
		if (champ1 == null) {
			log.warn("Objet obligatoire Champ1 manquant lors " 
					+ "de la création d'un objet Combinaison");
			throw new RequiredObjectIsNullException(
					"Combinaison", "création", "Champ1");
		}
		//On vérifie que le champ2 n'est pas nul
		if (champ2 == null) {
			log.warn("Objet obligatoire Champ2 manquant lors " 
					+ "de la création d'un objet Combinaison");
			throw new RequiredObjectIsNullException(
					"Combinaison", "création", "Champ2");
		}
		...
		BeanValidator.validateObject(combinaison,
				new Validator[] { combinaisonValidator });
	 ...
	 */
	@Override
	public void updateObjectManager(Combinaison combinaison, Champ champ1,
			Champ champ2) {
		//On vérifie que la combinaison n'est pas nulle
		if (combinaison == null) {
			log.warn("Objet obligatoire Combinaison manquant lors " 
					+ "de la modification d'un objet Combinaison");
			throw new RequiredObjectIsNullException(
					"Combinaison", "modification", "Combinaison");
		}
		//On vérifie que le champ1 n'est pas nul
		if (champ1 == null) {
			log.warn("Objet obligatoire Champ1 manquant lors " 
					+ "de la modification d'un objet Combinaison");
			throw new RequiredObjectIsNullException(
					"Combinaison", "modification", "Champ1");
		}
		//On vérifie que le champ2 n'est pas nul
		if (champ2 == null) {
			log.warn("Objet obligatoire Champ2 manquant lors " 
					+ "de la modification d'un objet Combinaison");
			throw new RequiredObjectIsNullException(
					"Combinaison", "modification", "Champ2");
		}
		...
		Champ oldChamp1 = combinaison.getChamp1();
		combinaison.setChamp1(champ1);
		...
		Champ oldChamp2 = combinaison.getChamp2();
		combinaison.setChamp2(champ2);
		BeanValidator.validateObject(combinaison,
				new Validator[] { combinaisonValidator });
		combinaisonDao.updateObject(combinaison);
		
		if (oldChamp1 != null && oldChamp1.getChampId() != null
				&& !oldChamp1.equals(combinaison.getChamp1())) {
			champManager.removeObjectManager(oldChamp1);
		}
		if (oldChamp2 != null && oldChamp2.getChampId() != null
				&& !oldChamp2.equals(combinaison.getChamp2())) {
	 ...
	 */
	@Override
	public void removeObjectManager(Combinaison combinaison) {
		//On vérifie que la combinaison n'est pas nulle
		if (combinaison == null) {
			log.warn("Objet obligatoire Combinaison manquant lors " 
					+ "de la suppression d'un objet Combinaison");
			throw new RequiredObjectIsNullException(
					"Combinaison", "suppression", "Combinaison");
		}
		//On vérifie que la combinaison est en BDD
		if (findByIdManager(combinaison.getCombinaisonId()) == null) {
			throw new SearchedObjectIdNotExistException("Combinaison",
	 ...
	 */
	@Override
	public Combinaison findByIdManager(Integer idCombinaison) {
		...
		if (idCombinaison == null) {
			log.warn("Objet obligatoire identifiant manquant lors de la " 
					+ "recherche par l'identifiant d'un objet Combinaison");
			throw new RequiredObjectIsNullException(
					"Combinaison", "recherche par identifiant", "identifiant");
		}
