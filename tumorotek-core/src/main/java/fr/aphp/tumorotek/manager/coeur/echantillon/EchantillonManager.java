...
public interface EchantillonManager {
	 ...
	 * @return Liste d'Echantillons.
	 */
	List<Echantillon> findByDateStockAfterDateWithBanqueManager(
											Date date, List<Banque> banque);
	 ...
	 * @return Liste d'Echantillons.
	 */
	List<Echantillon> findByPrelevementAndStatutManager(Prelevement p,
			ObjetStatut statut);
	 ...
	 * @return Liste d'Echantillons.
	 */
	List<Echantillon> findByCodeLikeWithBanqueManager(String code, 
			Banque banque, boolean exactMatch);
	 ...
	 * @return Liste d'Echantillons.
	 */
	List<Integer> findByCodeLikeBothSideWithBanqueReturnIdsManager(
			String code, 
	 ...
	 * @version 2.0.10
	 */
	List<Integer> findByPatientNomReturnIdsManager(
			String nom, List<Banque> banks, boolean exactMatch);
	 ...
	 * @version 2.1
	 */
	List<Integer> findByCodeInListManager(
			List<String> criteres, List<Banque> banques, List<String> notfounds);
	 ...
	 */
	List<Integer> findByPatientNomOrNipInListManager(
	 ...
	 * @return Liste de codes.
	 */
	List<String> findAllCodesForMultiBanquesAndStockesManager(
			List<Banque> banques);
	 ...
	 */
	List<Integer> findAfterDateCreationReturnIdsManager(
			Calendar date, 
			List<Banque> banques);
	 ...
	 * @return Liste d'Echantillon.
	 */
	List<Echantillon> findAfterDateModificationManager(
			Calendar date, 
			Banque banque);
	 ...
	 * @return Liste d'Echantillons.
	 */
	List<Echantillon> findLastCreationManager(List<Banque> banques, 
														int nbResults);
	 ...
	 * @since 2.0.11
	 */
	void createObjectWithCrAnapathManager(Echantillon echantillon, Banque banque, 
			Prelevement prelevement, Collaborateur collaborateur, 
			ObjetStatut statut, Emplacement emplacement, 
			EchantillonType type, 
			List<CodeAssigne> codesAssigne, 
	 ...
	 * dans le file system
	 */
	void updateObjectManager(Echantillon echantillon, Banque banque, 
			Prelevement prelevement, Collaborateur collaborateur, 
			ObjetStatut statut, Emplacement emplacement, 
			EchantillonType type, 
			List<CodeAssigne> codesAssigne, 
	 ...
	 */
	void removeObjectManager(Echantillon echantillon, String comments, 
	 ...
	 * @version 2.0.10.6
	 */
	 List<CodeAssigne> createOrUpdateCodesAssignesManager(Echantillon 
			 												echantillon,
											List<CodeAssigne> codes,
											//CodeAssigne codeToExport,
											boolean isOrgane,
											Utilisateur usr, 
											EchantillonJdbcSuite ijdbcSuite)
											throws SQLException;
	  ...
	  * @return path
	  */
	 String writeCrAnapathFilePath(String baseDir, Banque bank, 
			 											Fichier file);
	 ...
	 * @param liste des fichiers à supprimer après transaction
	 */
	void removeObjectCascadeManager(Echantillon echantillon, String comments, 
								Utilisateur user,  List<File> filesToDelete);
	 ...
	 * dans le file system
	 */
	void updateMultipleObjectsManager(List<Echantillon> echantillonsToUpdate,
			List<Echantillon> baseEchantillons,
			List<CodeAssigne> codeOrganes,
			List<CodeAssigne> codesToDelete,
	 ...
	 */
	List<Echantillon> updateCodeEchantillonsManager(
	 ...
	 */
	void saveEchantillonEmplacementManager(
	 ...
	 */
	void updateObjectWithNonConformitesManager(Echantillon echantillon,
			Banque banque, Prelevement prelevement,
			Collaborateur collaborateur, ObjetStatut statut,
			Emplacement emplacement, EchantillonType type,
			List<CodeAssigne> codes, List<CodeAssigne> codesToDelete,
			Unite quantite, EchanQualite qualite, ModePrepa preparation,
			Fichier anapath, InputStream anapathStream, Reservation reserv,
			List<AnnotationValeur> listAnnoToCreateOrUpdate,
			List<AnnotationValeur> listAnnoToDelete, Utilisateur utilisateur,
			boolean doValidation, List<OperationType> operations,
			String baseDir, List<NonConformite> noconfsTraitement,
	 ...
	 * @since 2.0.10
	 */
	void createObjectWithNonConformitesManager(Echantillon echantillon,
			Banque banque, Prelevement prelevement,
			Collaborateur collaborateur, ObjetStatut statut,
			Emplacement emplacement, EchantillonType type,
			List<CodeAssigne> codes, Unite quantite, EchanQualite qualite,
			ModePrepa preparation, Fichier anapath, InputStream anapathStream,
			Reservation reserv,
			List<AnnotationValeur> listAnnoToCreateOrUpdate,
			Utilisateur utilisateur, boolean doValidation, String baseDir,
	 ...
	 * @version 2.0.10.6
	 */
	Integer prepareObjectJDBCManager(EchantillonJdbcSuite jdbcSuite, 
			Echantillon echantillon, Banque banque,
			Prelevement prelevement, Collaborateur collaborateur,
			ObjetStatut statut, Emplacement emplacement, EchantillonType type,
			Unite quantite, EchanQualite qualite, ModePrepa preparation,
			List<CodeAssigne> codes,
			List<AnnotationValeur> listAnnoToCreateOrUpdate,
			List<NonConformite> noconfsTrait, List<NonConformite> noconfsCess,
			Utilisateur utilisateur, boolean doValidation, boolean isImport)
					throws SQLException;
	 ...
	 * @since 2.0.12
	 */
	void removeListFromIdsManager(List<Integer> ids, String comment,
			Utilisateur u);
