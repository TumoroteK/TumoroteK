...
public class NatureManagerImpl implements NatureManager {
	...
	private Log log = LogFactory.getLog(NatureManager.class);
	...
	public void setNatureValidator(NatureValidator natVal) {
	...
	public void updateObjectManager(Object obj) {
		...
		if (!findDoublonManager(obj)) {
			...
			log.warn("Doublon lors modification objet Nature "
					+ obj.toString());
...
//	}
	...
	@Override
	public List<Nature> findByNatureLikeManager(String nature, 
											boolean exactMatch) {
		if (!exactMatch) {
			nature = nature + "%";
		}
		log.debug("Recherche Nature par nature: " 
				+ nature + " exactMatch " + String.valueOf(exactMatch));
	...
	public void removeObjectManager(Object obj) {
		if (obj != null) {
			if (!isUsedObjectManager(obj)) {
				...
				log.warn("Suppression objet Nature " + obj.toString()
	...
	public boolean isUsedObjectManager(Object o) {
		Nature nature = natureDao.mergeObject((Nature) o);
	...
	public boolean findDoublonManager(Object o) {
		if (o != null) {
			...
			if (nature.getNatureId() == null) {
				...
				return natureDao.findByExcludedId(
						nature.getNatureId()).contains(nature);
			}
		} else {
			return false;
		}
