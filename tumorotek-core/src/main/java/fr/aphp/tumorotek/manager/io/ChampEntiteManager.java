...
public interface ChampEntiteManager {
		 ...
		 * @return Liste d'Entité.
		 */
		List<ChampEntite> findByEntiteAndNomManager(
		 ...
		 */
		List<ChampEntite> findByEntiteAndImportManager(
				Entite entite, Boolean canImport);
		 ...
		 * @return Liste de ChampEntites.
		 */
		List<ChampEntite> findByEntiteImportAndIsNullableManager(
				Entite entite, Boolean canImport,
				Boolean isNullable);
}
