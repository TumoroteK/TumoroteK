...
public class CoordonneeValidator implements Validator
{
   ...
   public void validate(final Object target, final Errors errors){
      ...
      final Coordonnee coord = (Coordonnee) target;
      // adresse valide
      if(coord.getAdresse() != null){
         if(coord.getAdresse().matches(ValidationUtilities.ONLYSPACESREGEXP)){
      ...
      // cp valide
      if(coord.getCp() != null){
         if(coord.getCp().matches(ValidationUtilities.ONLYSPACESREGEXP)){
            errors.rejectValue("cp", "coordonnee.cp.empty");
         }
         if(!coord.getCp().matches(ValidationUtilities.MOTREGEXP)){
      ...
      if(coord.getVille() != null){
         if(coord.getVille().matches(ValidationUtilities.ONLYSPACESREGEXP)){
            errors.rejectValue("ville", "coordonnee.ville.empty");
         }
         if(!coord.getVille().matches(ValidationUtilities.MOTREGEXP)){
      ...
      if(coord.getPays() != null){
         if(coord.getPays().matches(ValidationUtilities.ONLYSPACESREGEXP)){
            errors.rejectValue("pays", "coordonnee.pays.empty");
         }
         if(!coord.getPays().matches(ValidationUtilities.MOTREGEXP)){
      ...
      if(coord.getTel() != null){
         if(coord.getTel().matches(ValidationUtilities.ONLYSPACESREGEXP)){
            errors.rejectValue("tel", "coordonnee.tel.empty");
         }
         if(!coord.getTel().matches(ValidationUtilities.CODEREGEXP)){
      ...
      if(coord.getFax() != null){
         if(coord.getFax().matches(ValidationUtilities.ONLYSPACESREGEXP)){
            errors.rejectValue("fax", "coordonnee.fax.empty");
         }
         if(!coord.getFax().matches(ValidationUtilities.CODEREGEXP)){
      ...
      if(coord.getMail() != null){
         if(coord.getMail().matches(ValidationUtilities.ONLYSPACESREGEXP)){
            errors.rejectValue("mail", "coordonnee.mail.empty");
         }
         if(!coord.getMail().matches(ValidationUtilities.MAILREGEXP)){
