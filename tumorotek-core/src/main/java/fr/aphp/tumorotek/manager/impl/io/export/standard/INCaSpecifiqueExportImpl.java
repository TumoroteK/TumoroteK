...
public class INCaSpecifiqueExportImpl implements IncaSpecifiqueExport
{
   ...
   @Override
   public String getQuestAntTabac(final Connection con, final Patient patient, final Banque bank){
      String bool = ExportCatalogueManagerImpl.fetchItemAsString(con,
         "SELECT ANNOTATION_VALEUR.BOOL FROM ANNOTATION_VALEUR, " + "CHAMP_ANNOTATION, TABLE_ANNOTATION"
            + " WHERE ANNOTATION_VALEUR.OBJET_ID=" + patient.getPatientId().toString() + " AND CHAMP_ANNOTATION.NOM like '069%' "
   ...
   @Override
   public String getQuestFamilial(final Connection con, final Patient patient, final Banque bank){
      String bool = ExportCatalogueManagerImpl.fetchItemAsString(con,
         "SELECT ANNOTATION_VALEUR.BOOL FROM ANNOTATION_VALEUR, " + "CHAMP_ANNOTATION, TABLE_ANNOTATION"
            + " WHERE ANNOTATION_VALEUR.OBJET_ID=" + patient.getPatientId().toString() + " AND CHAMP_ANNOTATION.NOM like '070%' "
            + "AND CHAMP_ANNOTATION.CHAMP_ANNOTATION_ID=" + "ANNOTATION_VALEUR.CHAMP_ANNOTATION_ID"
            + " AND CHAMP_ANNOTATION.TABLE_ANNOTATION_ID=" + "TABLE_ANNOTATION.TABLE_ANNOTATION_ID "
            + "AND TABLE_ANNOTATION.ENTITE_ID=1 " + "AND ANNOTATION_VALEUR.BANQUE_ID=" + bank.getBanqueId().toString(),
         null, true, null, "");
   ...
   @Override
   public String getQuestPro(final Connection con, final Patient patient, final Banque bank){
      String bool = ExportCatalogueManagerImpl.fetchItemAsString(con,
         "SELECT ANNOTATION_VALEUR.BOOL FROM ANNOTATION_VALEUR, " + "CHAMP_ANNOTATION, TABLE_ANNOTATION"
            + " WHERE ANNOTATION_VALEUR.OBJET_ID=" + patient.getPatientId().toString() + " AND CHAMP_ANNOTATION.NOM like '071%' "
            + "AND CHAMP_ANNOTATION.CHAMP_ANNOTATION_ID=" + "ANNOTATION_VALEUR.CHAMP_ANNOTATION_ID"
            + " AND CHAMP_ANNOTATION.TABLE_ANNOTATION_ID=" + "TABLE_ANNOTATION.TABLE_ANNOTATION_ID "
            + "AND TABLE_ANNOTATION.ENTITE_ID=1 " + "AND ANNOTATION_VALEUR.BANQUE_ID=" + bank.getBanqueId().toString(),
         null, true, null, "");
   ...
   @Override
   public String getRadioNaif(final Connection con, final Echantillon echantillon){
      String bool = ExportCatalogueManagerImpl.fetchItemAsString(con,
         "SELECT ANNOTATION_VALEUR.BOOL FROM " + "ANNOTATION_VALEUR, CHAMP_ANNOTATION, TABLE_ANNOTATION "
            + "WHERE ANNOTATION_VALEUR.OBJET_ID=" + echantillon.getEchantillonId().toString()
            + " AND CHAMP_ANNOTATION.NOM like '072%' " + "AND CHAMP_ANNOTATION.CHAMP_ANNOTATION_ID="
   ...
   @Override
   public String getChimioNaif(final Connection con, final Echantillon echantillon){
      String bool = ExportCatalogueManagerImpl.fetchItemAsString(con,
         "SELECT ANNOTATION_VALEUR.BOOL FROM " + "ANNOTATION_VALEUR, CHAMP_ANNOTATION, TABLE_ANNOTATION "
            + "WHERE ANNOTATION_VALEUR.OBJET_ID=" + echantillon.getEchantillonId().toString()
            + " AND CHAMP_ANNOTATION.NOM like '073%' " + "AND CHAMP_ANNOTATION.CHAMP_ANNOTATION_ID="
            + "ANNOTATION_VALEUR.CHAMP_ANNOTATION_ID" + " AND CHAMP_ANNOTATION.TABLE_ANNOTATION_ID="
            + "TABLE_ANNOTATION.TABLE_ANNOTATION_ID " + "AND TABLE_ANNOTATION.ENTITE_ID=3",
         null, true, null, "");
   ...
   @Override
   public String getStatutTabac(final Connection con, final Patient patient, final Banque bank){
      return ExportCatalogueManagerImpl.fetchItemAsString(con,
         "SELECT ITEM.LABEL FROM ITEM, ANNOTATION_VALEUR, " + "CHAMP_ANNOTATION, TABLE_ANNOTATION"
            + " WHERE ANNOTATION_VALEUR.OBJET_ID=" + patient.getPatientId().toString() + " AND CHAMP_ANNOTATION.NOM like '074%' "
   ...
   @Override
   public String getNPA(final Connection con, final Patient patient, final Banque bank){
      return ExportCatalogueManagerImpl.fetchItemAsString(con,
         "SELECT ANNOTATION_VALEUR.TEXTE FROM ANNOTATION_VALEUR, " + "CHAMP_ANNOTATION, TABLE_ANNOTATION"
            + " WHERE ANNOTATION_VALEUR.OBJET_ID=" + patient.getPatientId().toString() + " AND CHAMP_ANNOTATION.NOM like '075%' "
            + "AND CHAMP_ANNOTATION.CHAMP_ANNOTATION_ID=" + "ANNOTATION_VALEUR.CHAMP_ANNOTATION_ID"
            + " AND CHAMP_ANNOTATION.TABLE_ANNOTATION_ID=" + "TABLE_ANNOTATION.TABLE_ANNOTATION_ID "
            + "AND TABLE_ANNOTATION.ENTITE_ID=1 " + "AND ANNOTATION_VALEUR.BANQUE_ID=" + bank.getBanqueId().toString(),
         null, true, null, "");
