...
public interface TerminaleManager {
	 ...
	 * @return Liste de Terminales.
	 */
	List<Terminale> findByEnceinteAndNomManager(Enceinte enceinte,
			String nom);
	 ...
	 * @return True s'il existe des doublons.
	 */
	Boolean findDoublonWithoutTwoTerminalesManager(
	 ...
	 */
	List<String> getCodesColonnesManager(Terminale terminale, 
			Integer numLigne);
	 ...
	 */
	void createObjectManager(Terminale terminale, 
			Enceinte enceinte, TerminaleType terminaleType,
	 ...
	 */
	List<Terminale> createMultiObjetcsManager(Enceinte enceinte,
	 ...
	 * @version 2.0.10
	 */
	List<Terminale> createMultiVisotubesManager(Enceinte enceinte,
			Terminale terminale, Integer number, Integer firstPosition,
	 ...
	 * @version 2.0.10
	 */
	void updateObjectManager(Terminale terminale, 
			Enceinte enceinte, TerminaleType terminaleType,
			Banque banque, Entite entite,
			TerminaleNumerotation terminaleNumerotation,
	 ...
	 */
	void removeObjectManager(Terminale terminale, String comments, 
												Utilisateur user);
	 ...
	 */
	void echangerDeuxTerminalesManager(
			Terminale terminale1, Terminale terminale2, 
			Utilisateur utilisateur);
	 ...
	 */
	void updateNumerotationForMultiTerminales(
			List<Terminale> terminales,
			TerminaleNumerotation numrotation,
			Utilisateur utilisateur);
	 ...
	 */
	Map<TKStockableObject, Emplacement> getTkObjectsAndEmplacementsManager(
			Terminale term);
