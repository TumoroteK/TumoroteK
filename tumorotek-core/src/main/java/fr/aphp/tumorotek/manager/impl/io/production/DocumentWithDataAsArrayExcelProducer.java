 ...
 * et fournit la fonctionnalité pour produire des documents Excel à partir d'une liste d'objets {@link DocumentWithDataAsArray}.
 *
 ...
 * dans les objets {@link DocumentWithDataAsArray}. Elle est conçue pour être utilisée dans des scénarios où les données
 * doivent être exportées ou transformées en format de feuille de calcul.</p>
 *
 * <p><b>Exemple d'utilisation :</b></p>
 * <pre>{@code
 * List<DocumentWithDataAsArray> data = ...; // Préparez vos données
 * OutputStreamData output = new OutputStreamData();
 * DocumentWithDataAsArrayExcelProducer producer = new DocumentWithDataAsArrayExcelProducer();
...
public class DocumentWithDataAsArrayExcelProducer implements DocumentProducer {
    ...
    @Override
    public void produce(List<DocumentWithDataAsArray> listDocumentWithDataAsArray, OutputStreamData outputStreamData){
