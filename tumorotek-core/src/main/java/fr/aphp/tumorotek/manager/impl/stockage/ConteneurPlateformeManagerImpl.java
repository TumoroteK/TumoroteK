...
public class ConteneurPlateformeManagerImpl implements ConteneurPlateformeManager {

	private ConteneurPlateformeDao conteneurPlateformeDao;

	public void setConteneurPlateformeDao(ConteneurPlateformeDao c) {
		this.conteneurPlateformeDao = c;
	}

	@Override
	public void removeObjectManager(ConteneurPlateforme cp) {
		conteneurPlateformeDao.removeObject(cp.getPk());
	}
