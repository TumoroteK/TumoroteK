...
public class BadFileFormatException extends TKException {
	...
	private List<ImportColonne> colonnes = new ArrayList<ImportColonne>();
	
	public BadFileFormatException() {
		super();
	}
	
	public BadFileFormatException(List<ImportColonne> cols) {
		super();
		this.colonnes = cols;
	}

	public List<ImportColonne> getColonnes() {
		return colonnes;
	}

	public void setColonnes(List<ImportColonne> cols) {
		this.colonnes = cols;
	}
