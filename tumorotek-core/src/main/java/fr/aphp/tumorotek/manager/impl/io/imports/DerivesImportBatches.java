...
public class DerivesImportBatches {
	...
	private Hashtable<ProdDerive, Row> importRow = 
			new Hashtable<ProdDerive, Row>();
	private Hashtable<ProdDerive, List<AnnotationValeur>> annoVals = 
				new Hashtable<ProdDerive, List<AnnotationValeur>>();
	private Hashtable<ProdDerive, Emplacement> emplacements = 
				new Hashtable<ProdDerive, Emplacement>();
	private Hashtable<ProdDerive, List<NonConformite>> ncfsTrait = 
				new Hashtable<ProdDerive, List<NonConformite>>();
	private Hashtable<ProdDerive, List<NonConformite>> ncfsCess =
				new Hashtable<ProdDerive, List<NonConformite>>();
	
	public DerivesImportBatches(TKAnnotableObject parent, Float transfoQte, 
			String observations, Calendar dateSortie) {
		super();
		this.parent = parent;
	...
	public void setParent(TKAnnotableObject parent) {
		this.parent = parent;
	}
	...
	public void setTransfoQte(Float transfoQte) {
		this.transfoQte = transfoQte;
	}
	...
	public void setTransfoQteUnite(Unite transfoQteUnite) {
	...
	public void setAnnoVals(Hashtable<ProdDerive, List<AnnotationValeur>> annoVals) {
	...
	public void setEmplacements(Hashtable<ProdDerive, Emplacement> emplacements) {
	...
	public void setNcfsTrait(Hashtable<ProdDerive, List<NonConformite>> ncfsTrait) {
	...
	public void setNcfsCess(Hashtable<ProdDerive, List<NonConformite>> ncfsCess) {
	...
	public void setImportRow(Hashtable<ProdDerive, Row> importRow) {
	...
	public boolean equals(Object obj) {
		...
		DerivesImportBatches test = (DerivesImportBatches) obj;
		return ((this.parent == test.parent || (this.parent != null 
				&& this.parent.equals(test.parent))) 
			&& (this.transfoQte == test.transfoQte 
				|| (this.transfoQte != null 
				&& this.transfoQte.equals(test.transfoQte)))
			...
			&& (this.dateSortie == test.dateSortie 
				...
				&& this.dateSortie.equals(test.dateSortie)))
		);
	}
