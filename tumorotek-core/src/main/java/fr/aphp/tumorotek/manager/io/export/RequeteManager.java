...
public interface RequeteManager {
	 ...
	 */
	Requete copyRequeteManager(Requete requete, Utilisateur copieur,
			Banque banque);
	 ...
	 */
	void createObjectManager(Requete requete,
	 ...
	 */
	void updateObjectManager(Requete requete,
			Groupement groupement, Utilisateur createur);
	 ...
	 */
	List<Requete> findByIntituleAndUtilisateurManager(
