...
public class TKAnnotableObjectDuo
{
   ...
   public void setFirstObj(final TKAnnotableObject f){
      this.firstObj = f;
   }

   public void setSecondObj(final TKAnnotableObject s){
      this.secondObj = s;
   }
   ...
   public List<AnnotationValeur> getFirstAnnoVals(){
      ...
      for(final List<AnnotationValeur> annoAr : getFirstAnnoValsMap().values()){
         vals.addAll(annoAr);
      }
      return vals;
   }
   ...
   public List<AnnotationValeur> getSecondAnnoVals(){
      final List<AnnotationValeur> vals = new ArrayList<>();
      for(final List<AnnotationValeur> annoAr : getSecondAnnoValsMap().values()){
         vals.addAll(annoAr);
      }
      return vals;
   }
