 ...
 *
 */
public class ObjectStatutException extends TKException
{
   ...
   public ObjectStatutException(final String en, final String op){
      super();
      this.entite = en;
      this.operation = op;
   }
   ...
   public String getMessage(){
      return this.entite + ": statut de l'objet incompatible avec l'opération, " + this.operation;
   }
