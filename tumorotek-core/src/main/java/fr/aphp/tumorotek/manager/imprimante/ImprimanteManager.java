...
public interface ImprimanteManager {
	 ...
	 * @return Liste de Imprimantes.
	 */
	List<Imprimante> findByNomAndPlateformeManager(
	 ...
	 */
	void createObjectManager(Imprimante imprimante, 
			Plateforme plateforme,
			ImprimanteApi imprimanteApi);
	 ...
	 * @param imprimanteApi ImprimanteApi de l'Imprimante.
	 */
	void updateObjectManager(Imprimante imprimante, 
			Plateforme plateforme,
			ImprimanteApi imprimanteApi);
