 ...
 * mais au format d'une date sans heure (date qui correspond à un jour)
 * 
 * @since 2.3.1.0 (TK-538)
 * @author chuet
 *
 */
public class ImportChampAnnotationTraitementForDateJour extends ImportChampAnnotationTraitementForDate
{
   private final Logger log = LoggerFactory.getLogger(ImportChampAnnotationTraitementForDateJour.class);
   
   public ImportChampAnnotationTraitementForDateJour(Integer champAnnotationId, int indexColonne, ImportColonne importColonne) {
      super(champAnnotationId, indexColonne, importColonne);
      //surcharge du reader du parent : 
      setImportChampAnnotationReader(ImportChampAnnotationReaderFactory.getDateJourReader());
   }
