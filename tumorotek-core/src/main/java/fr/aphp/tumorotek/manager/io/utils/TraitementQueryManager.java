...
public interface TraitementQueryManager {
	 ...
	 */
	List<Object> findObjetByCritereManager(Critere critere,
			List<Banque> banks, Object value,
			String jdbcDialect);
	 ...
	 * @return Liste d'objets correspondant au critère
	 */
	List<Object> findObjetByCritereWithBanquesManager(
			Critere critere, List<Banque> banques,
			Object value, boolean idSearch);
	
	List<Integer> findObjetByCriteresWithBanquesManager(
			List<Critere> critere, List<Banque> banques,
			List<Object> values);
	 ...
	 * @return Liste d'objets correspondant au critère.
	 */
	List<Object> findObjetByCritereWithBanquesDeriveVersionManager(
			Critere critere, List<Banque> banques,
			Object value,
			boolean searchForDerives, boolean idSearch);
	
	List<Integer> findObjetByCriteresWithBanquesDeriveVersionManager(
			List<Critere> criteres, List<Banque> banques,
			List<Object> values,
	 ...
	 * @version 2.0.13
	 */
	List<Integer> findObjetByCritereInListWithBanquesManager(
			Critere critere, List<Banque> banques,
			List<Object> values, boolean cumulative);
	 ...
	 * @return Liste d'objets correspondant au critère.
	 */
	List<Integer> findPrelevementsByNbEchantillonsWithBanquesManager(
	 ...
	 */
	List<Integer> findPrelevementsByAgePatientWithBanquesManager(
	...
	List<Integer> findObjetByCritereOnCodesWithBanquesManager(
			Critere critere, List<Banque> banques, 
			List<String> codes, List<String> libelles, 
			String value, boolean isMorpho);
	
	List<Integer> findObjetByCritereOnCodesWithBanquesDerivesVersionManager(
			List<Banque> banques, 
			List<String> codes, List<String> libelles, 
	 ...
	 * @version 2.0.13
	 */
	List<Integer> findEchantillonsByRequeteBiocapManager(
			String dbms, List<Banque> banques,
			List<Service> services,
			Calendar dateInf,
			Calendar dateSup,
			Integer age, ObjetStatut statut);
	 ...
	 * @return Liste d'objets correspondant au critère.
	 */
	List<Integer> findPrelevementsByMedecinsManager(Collaborateur collab, 
													List<Banque> banques);
	 ...
	 */
	List<Integer> findObjetIdsFromNonConformiteNomManager(String nom,
	 ...
	 */
	List<Integer> findFileUploadedManager(Champ fileChp, Entite target,
