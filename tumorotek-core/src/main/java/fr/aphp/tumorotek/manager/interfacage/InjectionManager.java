...
public interface InjectionManager {
	 ...
	 */
	Object extractValueForOneThesaurus(ChampEntite champEntite,
	 ...
	 * @return Un Item.
	 */
	Object extractValueForOneAnnotationThesaurus(
	 ...
	 */
	AnnotationValeur setPropertyValueForAnnotationValeur(Object value,
	 ...
	 */
	void injectValeurExterneInObject(Object obj, Banque banque,
	 ...
	 */
	void injectBlocExterneInObject(Object obj, Banque banque,
	 ...
	 * @param banque Banque.
	 */
	ResultatInjection injectDossierManager(DossierExterne dossier,
			Banque banque);
}
