...
public interface ProdDeriveManager {
	 ...
	 * @return Liste de ProdDerive.
	 */
	List<ProdDerive> findByCodeOrLaboWithBanqueManager(
	 ...
	 * @return Liste de ProdDerive.
	 */
	List<Integer> findByCodeOrLaboBothSideWithBanqueReturnIdsManager(
	 ...
	 */
	List<ProdDerive> findByParentAndTypeManager(
			Object parent, String type);
	 ...
	 * @return Liste de ProdDerive.
	 */
	List<ProdDerive> findAfterDateModificationManager(
	 ...
	 * @return Liste de ProdDerive.
	 */
	List<ProdDerive> findLastCreationManager(List<Banque> banques, 
														int nbResults);
	 ...
	 * dans le file system
	 */
	void createObjectManager(ProdDerive prodDerive, Banque banque,
	 ...
	 * dans le file system
	 */
	void updateObjectManager(ProdDerive prodDerive, Banque banque,
			ProdType type, ObjetStatut statut, Collaborateur collab,
			Emplacement emplacement, Unite volumeUnite, Unite concUnite,
			Unite quantiteUnite, ModePrepaDerive modePrepaDerive,
			ProdQualite qualite, Transformation transfo,
	 ...
	 * dans le file system
	 */
	void updateMultipleObjectsManager(List<ProdDerive> prodDerives,
	 ...
	 */
	void removeObjectManager(ProdDerive prodDerive, String comments, 
	 ...
	 * @param liste des fichiers à supprimer après transaction
	 */
	void removeObjectCascadeManager(ProdDerive derive, String comments, 
								Utilisateur user, List<File> filesToDelete);
	 ...
	 * @since 2.0.12
	 */
	void createDeriveListWithAnnotsManager(List<ProdDerive> listDerives,
			Banque banque, Transformation transfo, Utilisateur utilisateur,
			List<AnnotationValeur> listAnnotations, String baseDir,
	 ...
	 */
	  ...
	  */
	 List<ProdDerive> findByParentManager(TKAnnotableObject parent, 
			 									boolean recursive);
	  ...
	  * @param coll
	  */
	void findRecursiveDerivesManager(List<ProdDerive> drvs,
	 ...
	 */
	void removeObjectCascadeManager(Transformation transformation,
	 ...
	 */
	void updateObjectWithNonConformitesManager(ProdDerive prodDerive,
			Banque banque, ProdType type, ObjetStatut statut,
			Collaborateur collab, Emplacement emplacement, Unite volumeUnite,
			Unite concUnite, Unite quantiteUnite,
			ModePrepaDerive modePrepaDerive, ProdQualite qualite,
			Transformation transfo,
			List<AnnotationValeur> listAnnoToCreateOrUpdate,
			List<AnnotationValeur> listAnnoToDelete, Reservation reservation,
	 ...
	 * @since 2.0.10
	 */
	void createObjectWithNonConformitesManager(ProdDerive prodDerive,
			Banque banque, ProdType type, ObjetStatut statut,
			Collaborateur collab, Emplacement emplacement, Unite volumeUnite,
			Unite concUnite, Unite quantiteUnite,
			ModePrepaDerive modePrepaDerive, ProdQualite qualite,
	 ...
	 * @since 2.0.12
	 */
	void createProdDerivesManager(List<ProdDerive> derives, Banque b,
			Utilisateur u, TKAnnotableObject parent,
			Hashtable<ProdDerive, List<AnnotationValeur>> valeurs,
			Hashtable<ProdDerive, Emplacement> empls, 
			Float qteMax, Unite uniteTransfo,
			Calendar dateS, String retourObservations, String baseDir,
			boolean isImport, 
