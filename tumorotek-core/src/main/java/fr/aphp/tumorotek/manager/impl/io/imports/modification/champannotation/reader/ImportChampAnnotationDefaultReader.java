...
/**
 * classe qui lit une cellule d'un fichier d'import qui correspond à une chaîne de caractère
 * 
 * @since 2.3.1.0 (TK-538)
 * @author chuet
 *
 */
public class ImportChampAnnotationDefaultReader implements ImportChampAnnotationReader
{
   @Override
   public String read(Cell cell, FormulaEvaluator formulaEvaluator) throws ExcelIllegalContentTypeException { 
      return ExcelUtility.readAlphanumContent(cell, formulaEvaluator, true);
   }
}
