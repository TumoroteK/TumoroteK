...
public interface ChampLigneEtiquetteManager {
	 ...
	 */
	List<ChampLigneEtiquette> findByLigneEtiquetteManager(
	 ...
	 * @return Liste de ChampLigneEtiquettes.
	 */
	List<ChampLigneEtiquette> findByLigneEtiquetteAndEntiteManager(
			LigneEtiquette ligneEtiquette,
			Entite entite);
	 ...
	 * @param champ Champ.
	 */
	void validateObjectManager(ChampLigneEtiquette champLigneEtiquette, 
			LigneEtiquette ligneEtiquette,
			Entite entite,
			Champ champ,
			String operation);
	 ...
	 * @param champ Champ.
	 */
	void createObjectManager(ChampLigneEtiquette champLigneEtiquette, 
			LigneEtiquette ligneEtiquette,
			Entite entite,
			Champ champ);
	 ...
	 * @param champ Champ.
	 */
	void updateObjectManager(ChampLigneEtiquette champLigneEtiquette, 
			LigneEtiquette ligneEtiquette,
			Entite entite,
			Champ champ);
