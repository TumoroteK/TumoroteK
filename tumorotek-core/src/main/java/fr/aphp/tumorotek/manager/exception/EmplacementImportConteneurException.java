 ...
 *
 */
public class EmplacementImportConteneurException extends TKException
{

   private static final long serialVersionUID = 8025460498347186777L;

   public EmplacementImportConteneurException(){
      super();
   }

   @Override
   public String getMessage(){
      return "import.emplacement.conteneur.ambiguous";
   }
