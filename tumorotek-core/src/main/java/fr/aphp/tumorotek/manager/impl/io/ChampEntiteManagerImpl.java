...
public class ChampEntiteManagerImpl implements ChampEntiteManager {
	 ...
	 */
	@Override
	public ChampEntite findByIdManager(Integer id) {
		//On vérifie que l'identifiant n'est pas nul
		if (id == null) {
			log.warn("Objet obligatoire identifiant manquant lors de la " 
					+ "recherche par l'identifiant d'un objet ChampEntite");
			throw new RequiredObjectIsNullException(
					"ChampEntite", "recherche par identifiant", "identifiant");
		}
	 ...
	 */
	@Override
	public List<ChampEntite> findByEntiteManager(Entite entite) {
	...
	@Override
	public List<ChampEntite> findByEntiteAndNomManager(
			Entite entite, String nom) {
		...
		if (entite != null && nom != null) {
			...
			return new ArrayList<ChampEntite>();
		}
	}


	@Override
	public List<ChampEntite> findByEntiteAndImportManager(Entite entite,
			Boolean canImport) {
	...
	@Override
	public List<ChampEntite> findByEntiteImportAndIsNullableManager(
			Entite entite, Boolean canImport, Boolean isNullable) {
		if (entite != null && canImport != null && isNullable != null) {
			return champEntiteDao.findByEntiteImportObligatoire(
					entite, canImport, isNullable);
		} else {
			return new ArrayList<ChampEntite>();
		}
	}
