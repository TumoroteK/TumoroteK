...
public interface ObjetNonConformeManager {
	 ...
	 */
	List<ObjetNonConforme> findByObjetManager(
			Object obj);
	 ...
	 * @return Liste d'ObjetNonConformes.
	 */
	List<ObjetNonConforme> findByObjetAndTypeManager(
	 ...
	 */
	void createUpdateOrRemoveObjectManager(Object obj,
	 ...
	 */
	void createUpdateOrRemoveListObjectManager(Object obj,
