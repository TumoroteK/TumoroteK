...
public interface ImportManager {
	 ...
	 */
	Hashtable<String, Integer> initColumnsHeadersManager(Row row) 
												throws HeaderException;
	 ...
	 */
	Hashtable<Entite, List<ImportColonne>> initImportColonnesManager(
	 ...
	 * @return Hashtable.
	 */
	Hashtable<String, Object> extractValuesForOneThesaurus(
	 ...
	 * @return Hashtable.
	 */
	Hashtable<String, Object> extractValuesForOneAnnotationThesaurus(
	 ...
	 * @return Hashtable.
	 */
	Hashtable<Object, Hashtable<String, Object>> generateThesaurusHashtable(
			ImportTemplate importTemplate);
	 ...
	 * @return Hashtable.
	 */
	Hashtable<ChampAnnotation, Hashtable<String, Object>> 
	 ...
	 * @param obj Objet.
	 */
	void setPropertyValueForObject(Object value,
	 ...
	 */
	void setPropertyValueForAnnotationValeur(
			Object value,
			ChampAnnotation annotation,
			AnnotationValeur annoValeur,
			ImportColonne colonne);
	 ...
	 * de l'import.
	 */
	void setPropertyForImportColonne(Object obj,
			ImportColonne colonne,
			Row row,
	 ...
	 */
	boolean setCodeAssigneForEchantillon(Echantillon echan,
			ImportColonne colonne,
			Row row,
			ImportProperties properties);
	 ...
	 */
	boolean setRisquesForPrelevement(Prelevement prlvt,
			ImportColonne colonne,
			Row row,
			ImportProperties properties);
	 ...
	 * @version 2.0.13.2
	 */
	List<AnnotationValeur> setPropertyForAnnotationColonne(
			ImportColonne colonne,
			Row row,
			ImportProperties properties);
	 ...
	 */
	TKAnnotableObjectDuo setAllPropertiesForPatient(Row row, 
			ImportProperties properties);
	 ...
	 * @return Maladie.
	 */
	Maladie setAllPropertiesForMaladie(Row row, 
			ImportProperties properties,
			Patient patient);
	 ...
	 */
	TKAnnotableObjectDuo setAllPropertiesForPrelevement(Row row, 
			ImportProperties properties,
			Maladie maladie);
	 ...
	 * @return Echantillon.
	 */
	Echantillon setAllPropertiesForEchantillon(Row row, 
			ImportProperties properties,
			Prelevement prlvt);
	 ...
	 * @return ProdDerive.
	 */
	ProdDerive setAllPropertiesForProdDerive(Row row, 
			ImportProperties properties);
	 ...
	 * @return 
	 */
	void saveObjectsRowManager(Row row, List<Object> objects, 
	 ...
	 */
	ImportHistorique importFileManager(
			ImportTemplate importTemplate,
			Utilisateur utilisateur,
			InputStream fis);
	 ...
	 * @return
	 */
	List<String> extractListOfStringFromExcelFile(InputStream fis, 
													boolean fixNulls);
	...
	ImportHistorique importFileManager(ImportTemplate importTemplate,
			Utilisateur utilisateur, Sheet sheet);
	 ...
	 */
	List<NonConformite> setNonConformites(TKAnnotableObject obj, ImportColonne colonne,
	 ...
	 * @version 2.0.12
	 */
	void addToDeriveBatchesManager(Row row, ProdDerive derive, 
	 ...
	 * @version 2.0.12
	 */
	void saveDeriveBatchesManager(List<DerivesImportBatches> batches,
