...
public interface TableAnnotationManager {
	 ...
	 */
	void createOrUpdateObjectManager(TableAnnotation table,
...
//	boolean isUsedObjectManager(Patient patient);
	 ...
	 */
	void removeObjectManager(TableAnnotation table, String comments, 
	 ...
	 */
	Set<TableAnnotationBanque> getTableAnnotationBanquesManager(
	 ...
	 * @return Liste de TableAnnotation.
	 */
	List<TableAnnotation> findByEntiteAndBanqueManager(Entite entite, 
																Banque bank);
	 ...
	 * @return Liste de TableAnnotation.
	 */
	List<TableAnnotation> findByEntiteBanqueAndCatalogueManager(Entite entite, 
																Banque bank,
															String catalogue);
	 ...
	 * @return Liste de TableAnnotation.
	 */
	List<TableAnnotation> findByEntiteAndPlateformeManager(Entite entite, 
															Plateforme pf);
...
//																boolean up);
	 ...
	 * @param base directory pour créer dossier sytème associé.
	 */
	void createOrUpdateChampsManager(TableAnnotation tab,
											List<ChampAnnotation> champs, 
														Utilisateur usr,
														Banque current,
														String baseDir);
	 ...
	 * @version 2.0.10
	 */
	List<TableAnnotation> findByBanquesManager(List<Banque> banks, 
													boolean catalogue);
