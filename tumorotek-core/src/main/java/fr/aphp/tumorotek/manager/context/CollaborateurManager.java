...
public interface CollaborateurManager {
	 ...
	 * @return Liste de Collaborateurs.
	 */
	List<Collaborateur> findByServicesAndArchiveManager(Service service,
			boolean archive);
	 ...
	 * @return Liste de Collaborateurs.
	 */
	List<Collaborateur> findByPrenomLikeManager(String prenom, 
														boolean exactMatch);
	 ...
	 */
	void createObjectManager(Collaborateur collaborateur, Titre titre,
	 ...
	 */
	void updateObjectManager(Collaborateur collaborateur, Titre titre,
			Etablissement etablissement, Specialite specialite, 
			List<Service> services, List<Coordonnee> coordonnees,
			Utilisateur utilisateur,
	 ...
	 * objets.
	 */
	void removeObjectManager(Collaborateur collab, String comments, 
															Utilisateur user);
	 ...
	 * @param Utilisateur réalisant la suppression.
	 */
	void removeObjectCascadeManager(Collaborateur collab, Service service, 
	 ...
	 */
	void fusionCollaborateurManager(int idActif, int idPassif, String comments,
			Utilisateur user);
