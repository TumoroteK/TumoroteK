...
public class RequiredObjectIsNullException extends TKException {
	...
	public RequiredObjectIsNullException(String en, String op, String obj) {
		super();
		this.entite = en;
		this.operation = op;
	...
	public void setRequiredObject(String obj) {
		this.requiredObject = obj;
	}
	
	public String getMessage() {
		return this.entite + ": " + requiredObject + " est null lors de "
