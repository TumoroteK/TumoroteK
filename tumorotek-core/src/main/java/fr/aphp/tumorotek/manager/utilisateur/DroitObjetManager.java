...
public interface DroitObjetManager {
	 ...
	 */
	List<OperationType> getOperationsByProfilEntiteManager(
	 ...
	 * @return Liste ordonnée de DroitObjets.
	 */
	List<DroitObjet> findByProfilOperationManager(
			Profil profil, OperationType type);
	 ...
	 */
	Boolean findDoublonManager(Profil profil, Entite entite, 
			OperationType type);
	 ...
	 * @param type OperationType du DroitObjet.
	 */
	void validateObjectManager(Profil profil, Entite entite, 
			OperationType type);
	 ...
	 * @param type OperationType du DroitObjet.
	 */
	void createObjectManager(DroitObjet droitObjet, Profil profil, 
			Entite entite, 
			OperationType type);
	 ...
	 */
	Boolean hasProfilOperationOnEntitesManager(Profil profil,
