...
public interface ExportCatalogueManager {
	 ...
	 */
	void exportEchansCatalogueManager(List<Echantillon> echans, 
	 ...
	 * @param utilisateur
	 */
	void addExportDataIntoRow(Connection conn, Object obj, 
	 ...
	 */
	void printDataIntoRow(Object obj, int index, int nbRow, 
												List<String> values);
}
