...
/**
 *
 * Interface pour le manager du bean de domaine Specialite.
...
public interface SpecialiteManager extends CrudManager<Specialite>, TKThesaurusManager<Specialite>
{
    ...
    */
   List<Specialite> findAllObjectsManager();
    ...
    * @return Liste de Specialites.
    */
   List<Specialite> findByNomLikeManager(String nom, boolean exactMatch);
