...
public interface CommonUtilsManager {
	 ...
	 * @return le code
	 */
	public abstract CodeCommon findCodeByTableCodageAndIdManager(
			Integer codeId, TableCodage table);
	 ...
	 */
	public abstract TableCodage getTableCodageFromCodeCommonManager(
			CodeCommon code);
