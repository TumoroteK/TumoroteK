...
public interface ProfilUtilisateurManager {
	 ...
	 */
	List<ProfilUtilisateur> findByUtilisateurProfilManager(
	 ...
	 * @return Liste ordonnée de ProfilUtilisateurs.
	 */
	List<ProfilUtilisateur> findByUtilisateurBanqueManager(
	 ...
	 * @return Liste ordonnée de ProfilUtilisateurs.
	 */
	List<ProfilUtilisateur> findByBanqueProfilManager(
			Banque banque, Profil profil);
	 ...
	 * @param profil Profil du ProfilUtilisateur.
	 */
	void createObjectManager(ProfilUtilisateur profilUtilisateur, 
