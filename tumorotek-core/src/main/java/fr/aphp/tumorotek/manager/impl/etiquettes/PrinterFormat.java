...
public final class PrinterFormat {
	...
	public static String formaterHeure(int heure, int min) {
		String heureStr = "";
		String minStr = "";
		if (heure > -1 && min > -1) {
			if (heure < 10) {
	...
	public static String formaterDelai(float delai) {
		String delaiStr = "";
		String heureDelaiStr = "";
		String minDelaiStr = "";
		if (delai > -1) {
			int delaiRound = Math.round(delai);
			if (delaiRound > 59) {
				int heureDelai = delaiRound / 60;
				int minDelai = delaiRound - (heureDelai * 60);
	...
	public static String extraireCodePrelevement(String codeEchantillon) {
		String codePrelevement = "";
		StringTokenizer str = new StringTokenizer(codeEchantillon, ".");
	...
	public static String extraireNumeroTube(String codeEchantillon) {
		String codePrelevement = "";
		String numeroTube = "";
		StringTokenizer str = new StringTokenizer(codeEchantillon, ".");
	...
	public static String formaterUnite(String unite) {
