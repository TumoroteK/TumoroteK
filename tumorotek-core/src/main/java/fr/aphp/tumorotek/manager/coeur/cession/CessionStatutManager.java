...
/**
 *
 * Interface pour le manager du bean de domaine CessionStatut.
 ...
 *
 */
public interface CessionStatutManager
{
    ...
    */
   CessionStatut findByIdManager(Integer cessionStatutId);

   /**
    * Recherche tous les CessionStatut présents dans la base.
    * @return Liste de CessionStatuts.
    */
   List<CessionStatut> findAllObjectsManager();
    ...
    * @return Liste de CessionStatuts.
    */
   List<CessionStatut> findByStatutLikeManager(String statut, boolean exactMatch);
