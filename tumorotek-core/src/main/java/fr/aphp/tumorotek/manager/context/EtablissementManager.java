...
public interface EtablissementManager {
	 ...
	 * @return Liste ordonnéev de Services.
	 */
	List<Service> getActiveServicesWithOrderManager(
	 ...
	 */
	List<Collaborateur> getCollaborateursWithOrderManager(
			Etablissement etablissement);
	 ...
	 * @return Liste d'Etablissements.
	 */
	List<Etablissement> findByFinessLikeManager(
			String finess, boolean exactMatch);
	 ...
	 */
	void createObjectManager(Etablissement etablissement, 
	 ...
	 */
	void updateObjectManager(Etablissement etablissement, 
			Coordonnee coordonnee, Categorie categorie,
			Utilisateur utilisateur,
	 ...
	 * contrats.
	 */
	void removeObjectManager(Etablissement etablissement, String comments, 
			Utilisateur user);
	 ...
	 * @param Utilisateur réalisant la suppression.
	 */
	void removeObjectCascadeManager(Etablissement etablissement, 
	 ...
	 */
	void fusionEtablissementManager(int idActif, int idPassif, String comments,
			Utilisateur user);
