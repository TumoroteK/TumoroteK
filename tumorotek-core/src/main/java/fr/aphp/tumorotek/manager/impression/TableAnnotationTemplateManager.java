...
public interface TableAnnotationTemplateManager {
	 ...
	 * @return Liste de TableAnnotationTemplates.
	 */
	List<TableAnnotationTemplate> findByExcludedPKManager(
	 ...
	 * @param tableAnnotation TableAnnotation du TableAnnotationTemplate.
	 */
	void createObjectManager(TableAnnotationTemplate tableAnnotationTemplate, 
			Template template,
			TableAnnotation tableAnnotation);
	 ...
	 * @param tableAnnotation TableAnnotation du TableAnnotationTemplate.
	 */
	void updateObjectManager(TableAnnotationTemplate tableAnnotationTemplate, 
			Template template,
			TableAnnotation tableAnnotation);
