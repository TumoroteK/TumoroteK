...
public interface XmlUtils {
	 ...
	 * @param ligne Ligne à ajouter.
	 */
	void addLigneDeuxColonnesParagraphe(Element parent, 
	 ...
	 */
	void addHautDePage(Element parent, String legende,
	 ...
	 */
	void createModelisation(Element elt, Terminale boite, 
	 ...
	 * @param elements Elements a prendre dans la boite.
	 */
	void addListeElements(Element elt, 
			List<String> elements, String titreListe);
	 ...
	 */
	void createContenu(Element elt, Terminale boite, 
	 ...
	 * @param boite Terminale a modeliser.
	 */
	void addBoiteContenu(Element elt, 
			BoiteContenu boite, String adrImages,
			Hashtable<String, String> echantillonTypesCouleurs,
			String echantillonCouleur,
			Hashtable<String, String> prodDeriveTypesCouleurs,
			String prodDeriveCouleur);
	 ...
	 * @param couple Couple de valeurs à ajouter.
	 */
	void addCoupleAccordValeur(Element parent, 
	 ...
	 */
	void addValeursSignatures(Element parent, 
