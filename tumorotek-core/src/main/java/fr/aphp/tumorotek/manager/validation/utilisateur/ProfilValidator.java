...
public class ProfilValidator implements Validator
{
   ...
   public void validate(final Object target, final Errors errors){
      final Profil profil = (Profil) target;

      // nom non null
      ValidationUtils.rejectIfEmptyOrWhitespace(errors, "nom", "profil.nom.empty");
      //nom valide
      if(profil.getNom() != null){
         if(!profil.getNom().matches(ValidationUtilities.MOTREGEXP)){
