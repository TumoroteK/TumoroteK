...
public interface ChampAnnotationManager
{
    ...
    */
   String findAnnotationValeurManager(Object objet, ChampAnnotation champAnnotation);
    ...
    */
   List<AnnotationValeur> findAnnotationValeurByChampAnnotationManager(ChampAnnotation ca);
    ...
    */
   void createOrDeleteFileDirectoryManager(String baseDir, ChampAnnotation chp, boolean delete, List<Banque> banques);
    ...
    * @since 2.0.12
    */
   List<ChampAnnotation> findByImportTemplateAndEntiteManager(ImportTemplate ip, Entite e);
}
