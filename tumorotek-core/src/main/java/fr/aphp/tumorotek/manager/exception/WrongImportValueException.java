 ...
 *
 */
public class WrongImportValueException extends TKException {
	...
	public WrongImportValueException(ImportColonne col,
			String attendu) {
		super();
		this.colonne = col;
	...
	public void setValeurAttendue(String v) {
		this.valeurAttendue = v;
	}
	
	public String getMessage() {
		return this.colonne.getNom() + ": erreur de formatage, " 
			+ this.valeurAttendue + " attendu(e).";
	}
