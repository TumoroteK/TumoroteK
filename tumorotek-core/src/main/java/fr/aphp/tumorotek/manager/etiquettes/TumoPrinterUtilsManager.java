...
/**
 * Interface proposant les méthodes permettant de formater des données à
 * imprimer sur des étiquettes. Le 21/06/2011.
 *
 * @author Pierre Ventadour
 *
 */
public interface TumoPrinterUtilsManager
{
    ...
    * @param modele
    *            Modele de l'etiquette.
    * @return Lignes de l'étiquette
    */
   List<LigneEtiquette> extractDynData(TKStockableObject object, Modele modele);
    ...
    */
   Vector<String> extractStaticDataForMBio(TKStockableObject Obj);
