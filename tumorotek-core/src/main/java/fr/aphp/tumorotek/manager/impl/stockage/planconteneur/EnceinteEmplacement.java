 ...
 * permettant de suivre le nombre d'éléments enfants au dernier niveau de l'arborescence,
 * utilisé notamment pour calculer le "colspan" dans l'affichage des tableaux d'entêtes.
 * </p>
 *
 * <ul>
