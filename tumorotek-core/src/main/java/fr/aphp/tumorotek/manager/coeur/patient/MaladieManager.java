...
public interface MaladieManager {
	 ...
	 */
	void createOrUpdateObjectManager(Maladie maladie,
								Patient patient,
	 ...
	 */
	void removeObjectManager(Maladie maladie, String comments, 
											Utilisateur user);
	 ...
	 */
	List<Maladie> 
		findByLibelleLikeManager(String libelle, boolean exactMatch);
	 ...
	 */
	List<Maladie> 
		findByCodeLikeManager(String code, boolean exactMatch);
