...
/**
 * traitement d'import qui correspond à un champ d'annotation dont la valeur est stockée dans le champ TEXTE de la table ANNOTATION_VALEUR
 * 
 * @since 2.3.1.0 (TK-538)
 * @author chuet
 *
 */
public class ImportChampAnnotationTraitementForTexte extends AbstractImportChampAnnotationTraitement
{

   private final Logger log = LoggerFactory.getLogger(ImportChampAnnotationTraitementForTexte.class);
   
   private static final EAnnotationValeurInfoColonne ANNOTATION_VALEUR__INFO_COLONNE = EAnnotationValeurInfoColonne.INFO_TEXTE;

   public ImportChampAnnotationTraitementForTexte(Integer champAnnotationId, int indexColonne, ImportColonne importColonne) {
