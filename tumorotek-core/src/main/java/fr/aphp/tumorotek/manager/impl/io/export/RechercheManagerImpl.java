...
public class RechercheManagerImpl implements RechercheManager
{
   ...
   private final Logger log = LoggerFactory.getLogger(RechercheManager.class);
    ...
    *            est le bean Dao.
    */
   public void setRechercheDao(final RechercheDao recDao){
    ...
    *            est le bean Manager
    */
   public void setRequeteManager(final RequeteManager rManager){
    ...
    *            est le bean Manager
    */
   public void setAffichageManager(final AffichageManager aManager){
    ...
    */
   public void setRechercheValidator(final RechercheValidator validator){
   ...
   private void updateBanques(final Recherche recherche, final List<Banque> banques){
      ...
      final Iterator<Banque> it = rec.getBanques().iterator();
   ...
   @Override
   public List<Recherche> findByBanqueInLIstManager(final List<Banque> banques){
      final List<Integer> bksIds = new ArrayList<>();
      if(banques != null){
         for(int i = 0; i < banques.size(); i++){
