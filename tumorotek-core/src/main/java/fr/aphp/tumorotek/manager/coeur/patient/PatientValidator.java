...
/**
 *
 * Interface pour le validator du bean de domaine Patient.
 * Interface créée le 17/12/10, contrairement aux autres validators,
 * pour beneficier injection dependances (ref vers patiententManager)
 *
 * @author Mathieu Barthelemy
 * @version 2.0
 *
 */
public interface PatientValidator extends Validator
{
    ...
    * @return Errors
    */
   Errors checkDateNaissanceCoherence(Patient patient);
