...
public interface ImportColonneManager {
	 ...
	 * @return Liste d'ImportColonnes.
	 */
	List<ImportColonne> findByTemplateAndEntiteManager(
	 ...
	 * @return Liste d'ImportColonnes.
	 */
	List<ImportColonne> findByTemplateAndAnnotationEntiteManager(
			ImportTemplate importTemplate,
			Entite entite);
	 ...
	 * @return Liste d'ImportColonnes.
	 */
	List<ImportColonne> findByTemplateAndDataTypeManager(
			ImportTemplate importTemplate,
			DataType dataType);
	 ...
	 * @return Liste d'ImportColonnes.
	 */
	List<ImportColonne> findByTemplateAndThesaurusManager(
			ImportTemplate importTemplate);
	 ...
	 * @version 2.0.13.2
	 */
	List<ImportColonne> findByTemplateAndAnnotationThesaurusManager(
			ImportTemplate importTemplate);
	 ...
	 * @param champ Champ.
	 */
	void validateObjectManager(ImportColonne importColonne, 
	 ...
	 * @param champ Champ.
	 */
	void createObjectManager(ImportColonne importColonne, 
			ImportTemplate template,
			Champ champ);
	 ...
	 * @param champ Champ.
	 */
	void updateObjectManager(ImportColonne importColonne, 
			ImportTemplate template,
			Champ champ);
