...
public class InvalidParentException extends TKException {
	...
	public InvalidParentException(String ent, String op,
			boolean allParentsNull) {
		this.entite = ent;
		this.operation = op;
	...
	public void setAllParentsAreNull(Boolean allParents) {
	...
	public String getMessage() {
		...
		if (allParentsAreNull) {
			return this.entite + ": tous les parents "
				+ " de cette entité sont nulls lors de "
				+ "l'opération de " + this.operation + "";
		} else {
			return this.entite + ": plusieurs parents "
