...
public interface IncaReportManager {
	 ...
	 * @return
	 */
	List<Long> countSamplesManager(Calendar cal1, Calendar cal2, 
															Integer interv, 
															List<Banque> banks,
															boolean cumulative);
	 ...
	 * @return
	 */
	List<Long> countSamplesExtManager(Calendar cal1, Calendar cal2, 
														Integer interv, 
														List<Banque> banks, 
													List<Etablissement> exts);
	 ...
	 * @return
	 */
	List<Long> countEchansByCessTypesManager(CessionType cType, Date d1, 
													Date d2, Integer interv,
													List<Banque> banks);
	 ...
	 */
	List<Long> countsPrelsAndAssociatesByCimManager(CimMaster code, 
								String value,
	 ...
	 * @return compte
	 */
	List<Long> countPrelevedByDatesManager(Calendar cal1, 
								Calendar cal2,
								Integer interv, List<Banque> banks,
								boolean cumulative, boolean datePrel);
	 ...
	 * @return compte
	 */
	List<Long> countPrelevedByDatesExtManager(Calendar cal1, 
								Calendar cal2,
								Integer interv, List<Banque> banks,
	 ...
	 * @return compte
	 */
	List<Long> countEclConsentByDatesManager(List<ConsentType> types, 
													Calendar cal1, 
													Calendar cal2, 
													Integer interv,
												List<Banque> banks);
