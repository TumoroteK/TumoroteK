...
public class ImportProperties {
	 ...
	 */
	private Hashtable<String, Integer> colonnesHeaders = 
		new Hashtable<String, Integer>();
	/**
	 * Hashtable contenant la liste des colonnes en fct de leur entité.
	 */
	private Hashtable<Entite, List<ImportColonne>> colonnesForEntites = 
		new Hashtable<Entite, List<ImportColonne>>();
	/**
	 * Hashtable contenant les valeurs des thésaurus en fct de leur
	 * ebtité.
	 */
	private Hashtable<Object, Hashtable<String, Object>> thesaurusValues =
	 ...
	 */
	private Hashtable<ChampAnnotation, Hashtable<String, Object>>
		annotationThesaurusValues = 
			new Hashtable<ChampAnnotation, Hashtable<String, Object>>();
	/**
	 * Hashtable contenant les AnnotationsValeurs à enregistrer en fct
	 * de l'entité.
	 */
	private Hashtable<Entite, List<AnnotationValeur>> annotationsEntite = 
		new Hashtable<Entite, List<AnnotationValeur>>();
	private Banque banque;
	private FormulaEvaluator evaluator;
	
	private List<ImportColonne> subDerivesCols = new ArrayList<ImportColonne>();
	...
	public void setImportTemplate(ImportTemplate i) {
	...
	public void setColonnesHeaders(Hashtable<String, Integer> c) {
	...
	public void setColonnesForEntites(
			Hashtable<Entite, List<ImportColonne>> c) {
	...
	public void setThesaurusValues(
			Hashtable<Object, Hashtable<String, Object>> t) {
	...
	public Hashtable<ChampAnnotation, Hashtable<String, Object>> 
		getAnnotationThesaurusValues() {
		return annotationThesaurusValues;
	}

	public void setAnnotationThesaurusValues(
			Hashtable<ChampAnnotation, Hashtable<String, Object>> aValues) {
	...
	public void setAnnotationsEntite(
			Hashtable<Entite, List<AnnotationValeur>> aEntite) {
	...
	public void setEvaluator(FormulaEvaluator ev) {
		this.evaluator = ev;
	}
