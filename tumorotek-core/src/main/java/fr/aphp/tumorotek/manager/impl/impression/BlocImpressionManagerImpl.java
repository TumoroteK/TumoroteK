...
public class BlocImpressionManagerImpl implements BlocImpressionManager {
	...
	private Log log = LogFactory.getLog(BlocImpressionManager.class);
	...
	@Override
	public BlocImpression findByIdManager(Integer blocImpressionId) {
