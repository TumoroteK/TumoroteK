...
/**
 *
 * Interface pour le manager du bean de domaine ModePrepaDerive.
 ...
 *
 */
public interface ModePrepaDeriveManager extends PfDependantTKThesaurusManager<ModePrepaDerive>
{

   /**
    * Recherche un mode de préparation dont l'identifiant est
    * passé en paramètre.
    * @param modePrepaDeriveId Identifiant du mode de préparation
    * que l'on recherche.
    * @return Un ModePrepaDerive.
    */
   @Override
   ModePrepaDerive findByIdManager(Integer modePrepaDeriveId);
