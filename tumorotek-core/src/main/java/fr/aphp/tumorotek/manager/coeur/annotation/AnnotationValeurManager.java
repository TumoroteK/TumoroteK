...
public interface AnnotationValeurManager {
	 ...
	 */
	void createOrUpdateObjectManager(AnnotationValeur valeur,
	 ...
	 */
	List<AnnotationValeur> createAnnotationValeurListManager(
	 ...
	 */
	List<AnnotationValeur> findByChampAndObjetManager(ChampAnnotation champ, 
														TKAnnotableObject obj);
	 ...
	 * @return Liste de AnnotationValeur.
	 */
	List<AnnotationValeur> findByTableAndBanqueManager(TableAnnotation table, 
																Banque bank);
	 ...
	 */
	void removeAnnotationValeurListManager(List<AnnotationValeur> valeurs, 
			List<File> filesToDelete);
	 ...
	 * @version 2.0.10.6
	 */
	void prepareAnnotationValeurListJDBCManager(EchantillonJdbcSuite jdbcSuite, 
			List<AnnotationValeur> valeurs,
	 ...
	 * @version 2.0.12
	 */
	void createFileBatchForTKObjectsManager(List<? extends TKAnnotableObject> objs,
			Fichier file, InputStream stream, ChampAnnotation champ,
			Banque banque,
			Utilisateur u, String baseDir, List<File> filesCreated);
