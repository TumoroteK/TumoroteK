...
public interface BlocExterneManager {
	 ...
	 */
	List<BlocExterne> findByDossierExterneManager(
	 ...
	 * @return Liste de BlocExterne.
	 */
	List<BlocExterne> findByDossierExterneAndEntiteManager(
	 ...
	 */
	void validateBlocExterneManager(BlocExterne blocExterne,
			DossierExterne dossierExterne);
	 ...
	 */
	void createObjectManager(BlocExterne blocExterne,
			DossierExterne dossierExterne,
