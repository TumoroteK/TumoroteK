...
public interface TKAnnotableDuoManager
{
    ...
    */
   List<TKAnnotableObjectPropertyDuo> compareObjectsDuoManager(TKAnnotableObjectDuo duo, List<ChampEntite> chpEntites,
    ...
    */
   Boolean mergeDuoObjectsManager(TKAnnotableObjectDuo duo, List<TKAnnotableObjectPropertyDuo> propDuos);
