...
public interface CederObjetManager {
	 ...
	 */
	List<Cession> getAllCessionsByStatutAndObjetManager(
	 ...
	 */
	void validateObjectManager(CederObjet cederObjet, Cession cession,
	 ...
	 * @param quantiteUnite Unite de quantité du CederObjet.
	 */
	void createObjectManager(CederObjet cederObjet, Cession cession,
			Entite entite, Unite quantiteUnite);
	 ...
	 * @param quantiteUnite Unite de quantité du CederObjet.
	 */
	void updateObjectManager(CederObjet cederObjet, Cession cession,
			Entite entite, Unite quantiteUnite);
