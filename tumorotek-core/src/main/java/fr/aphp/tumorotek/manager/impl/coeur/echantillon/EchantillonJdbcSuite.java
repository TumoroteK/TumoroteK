...
public class EchantillonJdbcSuite
{
   ...
   public void setMaxEchantillonId(final Integer eId){
   ...
   public void setMaxAnnotationValeurId(final Integer vId){
   ...
   public void setMaxCodeAssigneId(final Integer cId){
   ...
   public void setMaxObjetNonConformeId(final Integer ocId){
   ...
   public void setPstmt(final PreparedStatement p){
      this.pstmt = p;
   }
   ...
   public void setPstmtAnno(final PreparedStatement p){
      this.pstmtAnno = p;
   }
   ...
   public void setPstmtCd(final PreparedStatement p){
      this.pstmtCd = p;
   }
   ...
   public void setPstmtNc(final PreparedStatement p){
      this.pstmtNc = p;
   }
   ...
   public void setPstmtOp(final PreparedStatement p){
      this.pstmtOp = p;
   }
