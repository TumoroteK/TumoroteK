...
public class BoiteImpression {
	...
	public BoiteImpression(Terminale b, List<String> e,
			List<String> i, String legendeP,
			String legendeS, String legendeV, String n,
			List<Integer> p, String titreIs,
			String titreL, String titreM) {
		super();
		this.boite = b;
		this.elements = e;
		this.instructions = i;
	...
	public void setBoite(Terminale b) {
		this.boite = b;
	}
	...
	public void setTitreModelisation(String titre) {
	...
	public void setTitreInstructions(String titre) {
	...
	public void setInstructions(List<String> i) {
		this.instructions = i;
	}
	...
	public void setTitreListe(String titre) {
	...
	public void setPositions(List<Integer> p) {
		this.positions = p;
	}
	...
	public void setLegendeVide(String legende) {
	...
	public void setLegendePris(String legende) {
	...
	public void setLegendeSelectionne(String legende) {
	...
	public boolean equals(Object obj) {
		...
		BoiteImpression test = (BoiteImpression) obj;
		return ((this.boite == test.getBoite() || (this.boite != null 
				&& this.boite.equals(test.getBoite()))));
	}
	...
	public void setTitreIntermediaire(String titre) {
	...
	public void setSeparateur(Boolean sep) {
		this.separateur = sep;
	}
}
