...
public interface CodeUtilisateurManager {
	 ...
	 */
	List<CodeUtilisateur> findByCodeLikeManager(String code, 
									boolean exactMatch, List<Banque> bank);
	 ...
	 */
	List<CodeUtilisateur> findByLibelleLikeManager(String libelle, 
														boolean exactMatch,
														List<Banque> bank);
	 ...
	 * @return une liste de codes CodeUtilisateur.
	 */
	List<CodeUtilisateur> 
		findByUtilisateurAndBanqueManager(Utilisateur u, Banque b);
	 ...
	 */
	void createOrUpdateManager(CodeUtilisateur code, CodeDossier dos, 
	 ...
	 */
	Set<CodeCommon> getTranscodesManager(CodeUtilisateur code, 
	 ...
	 */
	List<CodeUtilisateur> findByTranscodageManager(CodeCommon code, 
													List<Banque> banks);
