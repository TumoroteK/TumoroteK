...
public class MvFichier
{
   ...
   public MvFichier(final Path _a, final Path _d){
      this.fromPath = _a;
      this.toPath = _d;
   }
   ...
   public void setFromPath(final Path _a){
      this.fromPath = _a;
   }
   ...
   public void setToPath(final Path _d){
      this.toPath = _d;
   }
   ...
   public boolean equals(final Object obj){
      ...
      final MvFichier test = (MvFichier) obj;
