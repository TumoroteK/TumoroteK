<xsl:stylesheet version="1.0"
	...
	<xsl:template match="LigneCoordonnees">
		<tr>
			...
			<td>
				<table align="center" valign="bottom" cellspacing="0"
					cellpadding="2" border="0pt solid #00227c">
					<tr height="16">
						<xsl:apply-templates select="Coordonnee" />
					</tr>
				</table>
