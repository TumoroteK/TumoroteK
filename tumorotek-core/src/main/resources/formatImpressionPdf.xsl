...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="HautDePage">
		<!-- <fo:block text-align="left" font-size="10pt" font-weight="bold" font-style="italic" 
			color="#00227c"> <xsl:value-of select="text()"/> </fo:block> -->
				...
				<fo:table-row>
					<fo:table-cell border="0">
						<fo:block text-align="left" font-size="10pt"
							font-weight="bold" font-style="italic" color="#00227c">
							<xsl:value-of select="text()" />
						</fo:block>
					</fo:table-cell>
					<fo:table-cell border="0">
	...
	<xsl:template match="TitreParagraphe">
		<fo:block text-align="left" space-before.optimum="15pt"
			space-after.optimum="6pt" font-size="12pt" font-weight="bold"
			color="#00227c" background-color="#ecf4fb"
	...
	<xsl:template match="TitreSousParagraphe">
		<fo:block text-align="left" space-before.optimum="3pt"
			space-after.optimum="4pt" font-size="10pt" font-weight="bold"
			color="#00227c" border-bottom="1pt solid #00227c" end-indent="40pt">
			<xsl:value-of select="text()" />
		</fo:block>
	</xsl:template>
	...
	<xsl:template match="NomColonne">
		<fo:table-cell border="1pt solid #FFFFFF"
			background-color="#1E62BB" padding="5pt">
	...
	<xsl:template match="Cellule">
		<fo:table-cell border="1pt solid #FFFFFF"
			background-color="#d2d8f3" padding="3pt">
			<fo:block>
				<xsl:value-of select="text()" />
			</fo:block>
		</fo:table-cell>
