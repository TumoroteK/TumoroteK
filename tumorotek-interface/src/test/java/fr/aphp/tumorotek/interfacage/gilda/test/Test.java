...
//		patientSipManager.createOrUpdatePatientInTempTableManager(pSip3, 6);
    ...
    public void testAlors() throws Exception {
    	...
    	GildaMessage mes1 = new GildaMessage(); //newPatByModif.dat
    	mes1.getEntete().setNumEvt(new Long(201119235655L));
    	GildaMessage mes2 = new GildaMessage(); //newPat.dat
    	mes2.getEntete().setNumEvt(new Long(201119236618L));
    	GildaMessage mes3 = new GildaMessage(); //jaxb_error.dat
    	mes3.getEntete().setNumEvt(new Long(201119999L));
    	GildaMessage mes4 = new GildaMessage(); // systemPat.dat
    	mes4.getEntete().setNumEvt(new Long(1666));
    	GildaMessage mes5 = new GildaMessage(); // systemPatException.dat
    	mes5.getEntete().setNumEvt(new Long(1213));
    	GildaMessage mes6 = new GildaMessage(); //newPatByModif2.dat
    	mes6.getEntete().setNumEvt(new Long(201119235658L));
    	GildaMessage mes7 = new GildaMessage(); //fusion1.dat
    	mes7.getEntete().setNumEvt(new Long(1231234));
    	GildaMessage mes8 = new GildaMessage(); //fusion2.dat
    	mes8.getEntete().setNumEvt(new Long(12312345));
    	GildaMessage mes9 = new GildaMessage(); //fusion3.dat
    	mes9.getEntete().setNumEvt(new Long(2468));
    	GildaMessage mes10 = new GildaMessage(); //fusion4.dat
    	mes10.getEntete().setNumEvt(new Long(101));
    	mockBeans
    		.expectedBodiesReceivedInAnyOrder(mes1, mes2, mes4, 
    							mes5, mes6, mes7, mes8, mes9, mes10);
    	mockHandle.expectedBodiesReceivedInAnyOrder(mes1, mes2, mes4, 
				mes5, mes6, mes7, mes8, mes9, mes10);
    	...
    	List<Exchange> list = mockHandle.getReceivedExchanges();
        for (Exchange exchange : list) {
            Message in = exchange.getIn();
            GildaMessage.Entete entete = ((GildaMessage) in.getBody())
            												.getEntete();
            GildaMessage.Id id = ((GildaMessage) in.getBody()).getId();
            if (entete.getCodeEvt().equals("CID")) {
	            ...
	            assertTrue(id.getDateNaissance()
