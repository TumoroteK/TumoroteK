...
public class InclusionProcessor implements Processor
{
   ...
   public void setPatientHandler(final PatientHandler pr){
      this.patientHandler = pr;
   }

   @Override
   public void process(final Exchange exchange) throws Exception{
      final CreateRequest request = exchange.getIn().getBody(CreateRequest.class);

      final Iterator<StudySubjectType> it = request.getStudySubject().iterator();
