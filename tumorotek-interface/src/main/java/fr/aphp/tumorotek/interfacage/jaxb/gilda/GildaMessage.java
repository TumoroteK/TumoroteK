...
public class GildaMessage implements SipMessage {
	...
	public void setEntete(GildaMessage.Entete en) {
		this.entete = en;
	}
	...
	public void setId(GildaMessage.Id i) {
		this.id = i;
	}
	...
	public void setFid(GildaMessage.FId f) {
		this.fid = f;
	}
	...
	public static class Entete {
		...
		public void setCodeEvt(String c) {
			this.codeEvt = c;
		}
		...
		public void setTypeMes(Integer t) {
			this.typeMes = t;
		}
		...
		public boolean equals(Object obj) {
			return getNumEvt()
				.equals(((GildaMessage.Entete) obj).getNumEvt());
		}
