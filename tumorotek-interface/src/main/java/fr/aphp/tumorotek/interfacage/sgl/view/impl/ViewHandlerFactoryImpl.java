...
public class ViewHandlerFactoryImpl implements ViewHandlerFactory
{
   ...
   private ViewHandler daVinciViewHandler;

   public void setDaVinciViewHandler(final ViewHandler dv){
      this.daVinciViewHandler = dv;
   }
   ...
   public DossierExterne sendQuery(final Emetteur _e, final String sglNumDos){
      ...
      if(_e.getLogiciel().getNom().equals("DAVINCI")){
         return daVinciViewHandler.sendQuery(_e, sglNumDos);
      }
      return null;
