...
@XmlType(name = "formulaire", propOrder = {
	    "identifiant",
	    "patient",
	    "venue",
	    "dateValeur",
...
public class Formulaire {
     ...
     */
    public Formulaire(Prelevement prel, Boolean testMessage, Integer nbEchans) {
    	if (prel.getPrelevementId() != null) {
    		setIdentifiant(prel.getPrelevementId().toString());
    	}
    	patient = new Formulaire.Patient();
    	if (prel.getMaladie() != null 
    			&& prel.getMaladie().getPatient().getNip() != null) {
    	...
    	Rubrique rb1 = new Rubrique();
		rb1.setCodRub("LST_TYPPRELVT1");
		if (prel.getBanque() != null) {
			if (prel.getBanque().getNom() != null 
					&& prel.getBanque().getNom().matches(".*Biothèque Sein.*")) {
		...
		// date prélèvement
		Rubrique rb2 = new Rubrique();
		rb2.setCodRub("DAT_PRLVT_TUMO2");
		if (prel.getDatePrelevement() != null) {
			rb2.getValeurs().add(new SimpleDateFormat("yyyy-MM-dd")
					.format(prel.getDatePrelevement().getTime()));	
		} else {
			rb2.getValeurs().add("");
		}
		getRubriques().add(rb2);
		// nature
		Rubrique rb3 = new Rubrique();
	...
	public void setPatient(Formulaire.Patient p) {
		this.patient = p;
	}
	...
	public void setVenue(Formulaire.Venue v) {
		this.venue = v;
	}
	...
	public void setDateValeur(Formulaire.DateValeur d) {
		this.dateValeur = d;
	}
	...
	public void setCodForm(Integer c) {
		this.codForm = c;
	}
	...
	public void setLibForm(String c) {
		this.libForm = c;
	}
	...
	public void setRubriques(List<Rubrique> rbs) {
		this.rubriques = rbs;
	}
	...
	public static class Patient {
		...
		public boolean equals(Object obj) {
			return getIpp()
				.equals(((Formulaire.Patient) obj).getIpp());
		}
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "dateValeur", propOrder = {
		"date",
		"heure"
	}) 
	public static class DateValeur {
	    ...
	    public DateValeur(Date dateComplete) {
	...
	private String addTrailingZeros(String str, int total) {
		if (str != null) {
			int adds = total - str.length();
