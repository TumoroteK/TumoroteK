...
public class ActionPatient
{
   ...
   public void setPatientElimine(final Patient p){
   ...
   public boolean equals(final Object obj){
      ...
      boolean res = getPatient().equals(((ActionPatient) obj).getPatient());

      if(action.equals("fusion")){
         res = res && getPatientElimine().equals(((ActionPatient) obj).getPatientElimine());
      }
   ...
   public void setMelbase(final ActionPatient.Venue v){
      this.venue = v;
   }

   @XmlAccessorType(XmlAccessType.FIELD)
   @XmlType(name = "", propOrder = {"identifiant"})
   public static class Venue
   {
      ...
      public void setIdentifiant(final ActionPatient.Venue.Identifiant id){
         this.identifiant = id;
      }

      @XmlAccessorType(XmlAccessType.FIELD)
      @XmlType(name = "", propOrder = {"emetteur"})
      public static class Identifiant
      {
         ...
         public void setEmetteur(final ActionPatient.Venue.Identifiant.Emetteur emet){
            this.emetteur = emet;
         }

         @XmlAccessorType(XmlAccessType.FIELD)
         @XmlType(name = "", propOrder = {"valeur"})
         public static class Emetteur
         {
            ...
            public void setValeur(final ActionPatient.Venue.Identifiant.Emetteur.Valeur v){
               this.valeur = v;
            }
