...
public class HprimMessage implements SipMessage {
	...
	public void setEntete(EnteteMessage e) {
		this.entete = e;
	}
	...
	public void setEvenementPatient(EvenementPatient e) {
    ...
    public String getAction() {
    	if (getEvenementPatient() != null 
				&& getEvenementPatient().getActionPatient() != null) {
    ...
    public String getVenueEmetteurValeur() {
    	if (getEvenementPatient() != null 
			...
			&& getEvenementPatient().getActionPatient().getVenue()
										.getIdentifiant() != null 
			&& getEvenementPatient().getActionPatient().getVenue()
									.getIdentifiant().getEmetteur() != null 
			&& getEvenementPatient().getActionPatient().getVenue()
						.getIdentifiant().getEmetteur().getValeur() != null) {
    		return getEvenementPatient().getActionPatient().getVenue()
					.getIdentifiant().getEmetteur().getValeur().getValue();
    	}
    	return null;
    }
    ...
    public String toString() {
        return "Message[" + getEntete().getNumEvt() 
        		+ " nip: " + getNip() + "]";
    }
    ...
    public PatientSip toPatientSip() {
    	if (getPatient() != null) {
			PatientSip sip = new PatientSip();
			sip.setNip(getNip());
			sip.setNom(getPatient().getPersonnePhysique().getNom());
			sip.setNomNaissance(getPatient()
								.getPersonnePhysique().getNomPatro());
			sip.setPrenom(getPatient().getPersonnePhysique().getPrenom());
			sip.setSexe(getPatient().getPersonnePhysique().getSexe());
			sip.setDateNaissance(getPatient().getPersonnePhysique()
													.getDateNaissance());
			
			// numero de sejour
			String nda = getVenueEmetteurValeur();
			if (nda != null) {
    ...
    public PatientSip toPatientPassif() {
		...
		if (getEvenementPatient() != null 
				&& getEvenementPatient().getFusionPatient() != null
				&& getEvenementPatient().getFusionPatient().getPatientElimine() != null) {
			PersonnePhysique personne = getEvenementPatient()
				.getFusionPatient().getPatientElimine().getPersonnePhysique();
			sipP = new PatientSip();
			sipP.setNip(getEvenementPatient().getFusionPatient()
										.getPatientElimine().getNip());
	...
	public static class Entete {
		...
		public boolean equals(Object obj) {
			return getNumEvt()
				.equals(((HprimMessage.Entete) obj).getNumEvt());
		}
	...
	public static class Id {
		...
		public void setNomPatro(String np) {
			this.nomPatro = np;
		}
		...
		public void setEtatPatient(String eP) {
			this.etatPatient = eP;
		}
	}    
	...
	public static class FId {
		...
		public void setPrenomP(String p) {
			this.prenomP = p;
		}
		...
		public void setDateNaissanceP(Date dN) {
		...
		public void setDateNaissanceA(Date dN) {
