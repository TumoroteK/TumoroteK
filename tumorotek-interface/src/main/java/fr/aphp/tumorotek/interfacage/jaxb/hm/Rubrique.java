 ...
 * Mappe l'élément rubrique d'un message DME envoyé à HopitalManager.
 * Date: 29/09/2014
 *
...
@XmlType(name = "rubrique", propOrder = {"codRub", "valeurs"})
public class Rubrique
{
   ...
   public void setCodRub(final String c){
      this.codRub = c;
   }
   ...
   public void setValeurs(final List<String> v){
      this.valeurs = v;
   }
